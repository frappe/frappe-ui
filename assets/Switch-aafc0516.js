import { ay as defineComponent, aQ as computed, c2 as ue, c3 as ce, c4 as oe, c5 as de, aB as openBlock, aC as createBlock, aD as withCtx, aF as createBaseVNode, aW as normalizeClass, aM as createTextVNode, aN as toDisplayString, aH as createCommentVNode, aE as createVNode, c6 as withKeys, aX as withModifiers } from "./vendor-a9e775f7.js";
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const switchGroupClasses = computed(() => {
      ...
      if (switchType.value === 1) {
        classes.push(
          "group items-center space-x-3 cursor-pointer rounded focus-visible:bg-surface-gray-2 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-400"
        );
        classes.push(
