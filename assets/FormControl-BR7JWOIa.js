import { ay as defineComponent, aU as computed, aB as openBlock, aG as createElementBlock, aM as createTextVNode, aN as toDisplayString, aK as Fragment, aF as createBaseVNode, aH as createCommentVNode, aQ as normalizeClass, cH as useAttrs, aC as createBlock, cI as createSlots, aD as withCtx, aX as renderSlot, aL as mergeProps, aR as normalizeProps, aS as guardReactiveProps } from "./vendor-BwqQEq2n.js";
import { C as Checkbox, u as useId } from "./Checkbox-CJaRrfja.js";
import { T as TextInput } from "./TextInput-CdmLNDOr.js";
import { S as Select } from "./Select-DQ2PWr0X.js";
import { T as Textarea } from "./Textarea-DGe-m0z7.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { id, props, attrs, controlAttrs, labelClasses, descriptionClasses, TextInput, Select, Textarea, Checkbox, Autocomplete, FormLabel };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
