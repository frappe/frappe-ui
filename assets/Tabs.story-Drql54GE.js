import { aC as defineComponent, bi as h, az as openBlock, aH as createBlock, aP as withCtx, aM as createVNode, aI as normalizeClass, aB as createBaseVNode, aA as createElementBlock, aT as Fragment, aS as renderList, aG as renderSlot, aU as mergeProps, aJ as resolveDynamicComponent, aK as createCommentVNode, aQ as createTextVNode, aL as toDisplayString, cv as TabsContent_default, cw as TabsIndicator_default, cx as TabsList_default, cy as TabsRoot_default, cz as TabsTrigger_default, ay as markRaw, aR as reactive, aO as resolveComponent } from "./vendor-Ciyd-VkX.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  props: {
    ...
    vertical: { type: null, required: false }
  },
  setup(__props, { expose: __expose }) {
    __expose();
    const props = __props;
    const Btn = h("button");
    const __returned__ = { props, indicatorXCss, indicatorYCss, Btn, get TabsContent() {
...
const _hoisted_1$4 = { class: "flex flex-col flex-1 grow" };
  ...
  return openBlock(), createBlock($setup["TabsRoot"], {
    ...
    default: withCtx(() => [
      createVNode($setup["TabsList"], {
        class: normalizeClass(["relative flex data-[orientation=vertical]:flex-col p-1 border-b data-[orientation=vertical]:border-r", { "overflow-auto": !$setup.props.vertical }])
      }, {
        default: withCtx(() => [
                ...
                default: withCtx(() => [
                  renderSlot(_ctx.$slots, "tab-item", mergeProps({ ref_for: true }, { tab }), () => [
                    (openBlock(), createBlock(resolveDynamicComponent(tab.route ? "router-link" : $setup.Btn), {
                      to: tab.route,
                      class: normalizeClass(["flex items-center gap-1.5 text-base text-ink-gray-5 duration-300 ease-in-out hover:text-ink-gray-9 p-2.5 data-[state=active]:text-ink-gray-9", { "py-2.5": $setup.props.vertical }])
                    }, {
                      default: withCtx(() => [
      ...
      (openBlock(true), createElementBlock(
        ...
        null,
        renderList($setup.props.tabs, (tab, i) => {
          return openBlock(), createBlock($setup["TabsContent"], { value: i }, {
            default: withCtx(() => [
    ...
    _: 3
    /* FORWARDED */
  }, 8, ["as", "orientation", "default-value"]);
}
