const __resolved__virtual_storySource_srcComponentsAutocompleteAutocompleteStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsAutocompleteAutocompleteStoryVue as default
};
