import{ak as u,b9 as y,b3 as x,ae as T,p as I,bf as i,E as a,aG as t,D as S,o as l,bg as $,bh as m,bj as f,b7 as R}from"./framework.CZ-ntRvv.js";import{bB as B,au as V,_ as b,at as z}from"./theme.CiUynss1.js";import{u as A,z as C,x as F,P as H,H as L,g as N,h as O,S as o,c as U,q,w as D,d as j,O as K,a as M,A as P,b as E,F as W,m as G,p as Y,n as J,B as Q,I as X,j as Z,o as ee,U as te,R as se,y as ae}from"./kits.BhZDgdJY.js";import"./codemirror.C6qLgMOw.js";const oe={class:"sticky top-0 z-10 border-b bg-surface-base"},ne={class:"overflow-x-auto px-2 py-1"},ie={class:"px-4 pb-40 pt-4"},re=["onKeydown"],ue={__name:"ComposeMobile",setup(le){const w=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[A.configure({mention:{items:w}})],v=[H,L,N,O,o,U,q,D,o,j,K,o,M,P,E,W,o,G,Y,J,Q,X,Z,o,ee,o,te,se],p={light:"/recipes/compose-dashboard-light.png",dark:"/recipes/compose-dashboard-dark.png"},h=B(),d=u("Design review: new onboarding flow"),r=u(`
