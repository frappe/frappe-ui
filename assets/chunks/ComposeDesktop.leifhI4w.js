import{aj as m,a9 as T,a5 as I,b8 as S,b1 as $,ad as B,r as O,D as e,be as r,aE as t,o as l,B as R,bf as D,bg as f,bi as b,b6 as F}from"./framework.CK2aBVEu.js";import{bp as w,a1 as U,U as V,J as g,b3 as A,a0 as C}from"./theme.DTyCdtT9.js";import{u as H,z as L,x as N,P as z,H as q,g as E,h as M,S as o,c as j,q as K,w as P,d as W,O as J,a as Y,A as G,b as Q,F as X,m as Z,p as ee,n as te,B as se,I as ae,j as oe,o as ne,U as re,R as ie,y as le}from"./kits.BVwiOvkt.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const pe={class:"h-screen w-full bg-surface-base text-ink-gray-9"},de={class:"flex shrink-0 items-center space-x-2"},ce={class:"w-full overflow-x-auto"},he={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ue=["onKeydown"],_e={__name:"ComposeDesktop",setup(me){const v=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],_=[H.configure({mention:{items:v}})],x=[z,q,E,M,o,j,K,P,o,W,J,o,Y,G,Q,X,o,Z,ee,te,se,ae,oe,o,ne,o,re,ie],p={light:"/recipes/compose-dashboard-light.png",dark:"/recipes/compose-dashboard-dark.png"},d=m(w()),c=m("Design review: new onboarding flow"),i=m(`
