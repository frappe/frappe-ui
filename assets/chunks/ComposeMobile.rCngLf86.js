import{aj as u,b8 as y,b2 as x,ad as T,p as I,be as i,D as a,aF as t,B as S,o as l,bf as $,bg as m,bi as f,b6 as B}from"./framework.79nw0c7c.js";import{bB as R,au as F,_ as b,at as V}from"./theme.Dxx4dB62.js";import{u as z,z as A,x as C,P as H,H as L,g as N,h as O,S as o,c as U,q,w as D,d as j,O as K,a as M,A as P,b as E,F as W,m as Y,p as G,n as J,B as Q,I as X,j as Z,o as ee,U as te,R as se,y as ae}from"./kits.D517CR-b.js";import"./codemirror.C6qLgMOw.js";const oe={class:"sticky top-0 z-10 border-b bg-surface-base"},ne={class:"overflow-x-auto px-2 py-1"},ie={class:"px-4 pb-40 pt-4"},re=["onKeydown"],ue={__name:"ComposeMobile",setup(le){const w=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[z.configure({mention:{items:w}})],v=[H,L,N,O,o,U,q,D,o,j,K,o,M,P,E,W,o,Y,G,J,Q,X,Z,o,ee,o,te,se],p={light:"/recipes/compose-dashboard-light.png",dark:"/recipes/compose-dashboard-dark.png"},h=R(),d=u("Design review: new onboarding flow"),r=u(`
