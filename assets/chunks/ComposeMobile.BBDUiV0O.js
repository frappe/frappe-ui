import{b0 as k,ab as _,p as x,bd as n,D as o,aC as e,B as y,o as i,be as T,bf as h,bh as c,b5 as I,ah as u}from"./framework.BnB0ou-I.js";import{aw as S,x as m,av as B}from"./theme.YsvSYJRL.js";import{u as R,z,x as F,P as V,H as $,g as A,h as C,S as a,c as H,q as L,w as N,d as O,O as q,a as U,A as D,b as K,F as M,m as P,p as j,n as W,B as E,I as Y,j as G,o as J,U as Q,R as X,y as Z}from"./kits.C5RlFRcZ.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const ee={class:"sticky top-0 z-10 border-b bg-surface-base"},te={class:"overflow-x-auto px-2 py-1"},se={class:"px-4 pb-40 pt-4"},oe=["onKeydown"],de={__name:"ComposeMobile",setup(ae){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[R.configure({mention:{items:f}})],b=[V,$,A,C,a,H,L,N,a,O,q,a,U,D,K,M,a,P,j,W,E,Y,G,a,J,a,Q,X],r=u("Design review: new onboarding flow"),d=u(`
...
`),g=async l=>({file_url:URL.createObjectURL(l),file_name:l.name}),{textarea:v}=k({input:r});return(l,t)=>(_(),x(e(B),null,{default:n(()=>[o(e(z),{modelValue:d.value,"onUpdate:modelValue":t[1]||(t[1]=s=>d.value=s),extensions:w,"upload-function":g,placeholder:"Type '/' for commands or select text to format"},{default:n(({editor:s})=>[o(e(S),{title:"New discussion"},{prefix:n(()=>[o(e(m),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),suffix:n(()=>[o(e(m),{variant:"solid"},{default:n(()=>[...t[2]||(t[2]=[y("Publish",-1)])]),_:1})]),_:1}),i("div",ee,[i("div",te,[o(e(F),{editor:s,items:b},null,8,["editor"])])]),i("div",se,[T(i("textarea",{ref_key:"titleTextarea",ref:v,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":t[0]||(t[0]=p=>r.value=p),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[h(c(p=>s.commands.focus(),["prevent"]),["enter"]),h(c(p=>s.commands.focus(),["prevent"]),["down"])]},null,40,oe),[[I,r.value]]),o(e(Z),{editor:s,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{de as default};
