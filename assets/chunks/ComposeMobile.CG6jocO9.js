import{ak as u,b9 as y,b3 as x,ae as T,p as I,bf as i,E as a,aG as t,D as S,o as l,bg as $,bh as m,bj as f,b7 as R}from"./framework.CZ-ntRvv.js";import{bz as z,au as B,K as b,at as V}from"./theme.Wgqf_FK0.js";import{u as A,z as C,x as F,P as H,H as L,g as N,h as O,S as o,c as U,q,w as D,d as K,O as j,a as M,A as P,b as E,F as W,m as G,p as Y,n as J,B as Q,I as X,j as Z,o as ee,U as te,R as se,y as ae}from"./kits.MwrfCR4A.js";import"./codemirror.C6qLgMOw.js";const oe={class:"sticky top-0 z-10 border-b bg-surface-base"},ne={class:"overflow-x-auto px-2 py-1"},ie={class:"px-4 pb-40 pt-4"},re=["onKeydown"],ue={__name:"ComposeMobile",setup(le){const w=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[A.configure({mention:{items:w}})],v=[H,L,N,O,o,U,q,D,o,K,j,o,M,P,E,W,o,G,Y,J,Q,X,Z,o,ee,o,te,se],p={light:"/recipes/compose-dashboard-light.png",dark:"/recipes/compose-dashboard-dark.png"},h=z(),d=u("Design review: new onboarding flow"),r=u(`
...
`);y(h,(n,e)=>{r.value=r.value.replace(p[e],p[n])});const k=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:_}=x({input:d});return(n,e)=>(T(),I(t(V),null,{default:i(()=>[a(t(C),{modelValue:r.value,"onUpdate:modelValue":e[1]||(e[1]=s=>r.value=s),extensions:g,"upload-function":k,placeholder:"Type '/' for commands or select text to format"},{default:i(({editor:s})=>[a(t(B),{title:"New discussion"},{prefix:i(()=>[a(t(b),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),suffix:i(()=>[a(t(b),{variant:"solid"},{default:i(()=>[...e[2]||(e[2]=[S("Publish",-1)])]),_:1})]),_:1}),l("div",oe,[l("div",ne,[a(t(F),{editor:s,items:v},null,8,["editor"])])]),l("div",ie,[$(l("textarea",{ref_key:"titleTextarea",ref:_,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":e[0]||(e[0]=c=>d.value=c),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[m(f(c=>s.commands.focus(),["prevent"]),["enter"]),m(f(c=>s.commands.focus(),["prevent"]),["down"])]},null,40,re),[[R,d.value]]),a(t(ae),{editor:s,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{ue as default};
