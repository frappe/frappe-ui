import{ak as m,b9 as k,b3 as y,ae as T,r as I,E as e,bf as r,aG as t,o as l,D as S,bg as $,bh as u,bj as f,b7 as R}from"./framework.CZ-ntRvv.js";import{bB as B,a1 as D,U as V,_ as b,b4 as A,a0 as C}from"./theme.RDyHBhXA.js";import{u as F,z as H,x as L,P as N,H as O,g as U,h as z,S as o,c as q,q as j,w as E,d as K,O as P,a as M,A as W,b as G,F as Y,m as J,p as Q,n as X,B as Z,I as ee,j as te,o as se,U as ae,R as oe,y as ne}from"./kits.BlkbeTtf.js";import"./codemirror.C6qLgMOw.js";const re={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ie={class:"flex shrink-0 items-center space-x-2"},le={class:"w-full overflow-x-auto"},pe={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},de=["onKeydown"],be={__name:"ComposeDesktop",setup(ce){const w=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[F.configure({mention:{items:w}})],v=[N,O,U,z,o,q,j,E,o,K,P,o,M,W,G,Y,o,J,Q,X,Z,ee,te,o,se,o,ae,oe],p={light:"/recipes/compose-dashboard-light.png",dark:"/recipes/compose-dashboard-dark.png"},h=B(),d=m("Design review: new onboarding flow"),i=m(`
