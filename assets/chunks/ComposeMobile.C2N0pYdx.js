import{aj as m,a9 as T,a5 as I,b8 as S,b1 as $,ad as B,p as O,be as r,D as o,aE as t,B as R,o as l,bf as F,bg as f,bi as b,b6 as N}from"./framework.CK2aBVEu.js";import{bt as w,aw as V,N as g,av as z}from"./theme.uzJu4e57.js";import{u as A,z as C,x as H,P as L,H as U,g as M,h as q,S as a,c as D,q as j,w as E,d as K,O as P,a as W,A as Y,b as G,F as J,m as Q,p as X,n as Z,B as ee,I as te,j as se,o as oe,U as ae,R as ne,y as re}from"./kits.C37L0eUa.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const ie={class:"sticky top-0 z-10 border-b bg-surface-base"},le={class:"overflow-x-auto px-2 py-1"},pe={class:"px-4 pb-40 pt-4"},de=["onKeydown"],we={__name:"ComposeMobile",setup(ce){const v=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],k=[A.configure({mention:{items:v}})],_=[L,U,M,q,a,D,j,E,a,K,P,a,W,Y,G,J,a,Q,X,Z,ee,te,se,a,oe,a,ae,ne],p={light:"/recipes/compose-dashboard-light.png",dark:"/recipes/compose-dashboard-dark.png"},d=m(w()),c=m("Design review: new onboarding flow"),i=m(`
