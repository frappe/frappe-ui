import{b2 as v,ad as _,p as y,bg as n,D as o,aE as e,B as x,o as i,bh as T,bi as h,bk as c,b8 as I,aj as u}from"./framework.CWIjRn0F.js";import{b9 as S,aq as m,b8 as B}from"./theme.BfYrdCgi.js";import{r as R,w as F,u as V,P as $,H as z,f as A,g as H,S as a,c as L,p as N,t as O,d as q,O as C,a as U,A as D,b as K,F as M,l as P,o as j,m as E,B as W,I as Y,i as G,n as J,U as Q,R as X,v as Z}from"./kits.DkE2XU25.js";const ee={class:"sticky top-0 z-10 border-b bg-surface-base"},te={class:"overflow-x-auto px-2 py-1"},se={class:"px-4 pb-40 pt-4"},oe=["onKeydown"],le={__name:"ComposeMobile",setup(ae){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[R.configure({mention:{items:f}})],b=[$,z,A,H,a,L,N,O,a,q,C,a,U,D,K,M,a,P,j,E,W,Y,G,a,J,a,Q,X],r=u("Design review: new onboarding flow"),d=u(`
