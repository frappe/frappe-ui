import{b3 as x,ad as v,r as k,D as e,bh as n,aE as t,o as i,B as y,bi as T,bj as c,bl as h,b9 as I,aj as m}from"./framework.Ch9esD0-.js";import{aK as S,au as $,aq as u,bG as R,aJ as B}from"./theme.CGhaQYZa.js";import{r as D,w as F,u as V,P as A,H,f as L,g as N,S as o,c as O,p as q,t as z,d as C,O as U,a as K,A as j,b as P,F as E,l as M,o as W,m as G,B as J,I as Y,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.BPJ8dkP4.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[D.configure({mention:{items:f}})],b=[A,H,L,N,o,O,q,z,o,C,U,o,K,j,P,E,o,M,W,G,J,Y,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
