...
import { L as Link$2 } from "./link-DeVku6cN.js";
import { E as ErrorMessage } from "./ErrorMessage-1JiLCaT9.js";
import { S as Select } from "./Select-B01Owbl8.js";
import { _ as __unplugin_components_1$1 } from "./Dialog-C3s0Ru1s.js";
const _hoisted_1$$ = {
...
const commands = {
  ...
  FontColor: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./FontColor-BZhPSqap.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0))
  },
  Blockquote: {
    label: "Blockquote",
    icon: DoubleQuotes,
  ...
  Link: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertLink-BYWAjlE_.js"), true ? __vite__mapDeps([6,2,3]) : void 0))
  },
  Image: {
    label: "Image",
    icon: Image$2,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertImage-BR-HdnV7.js"), true ? __vite__mapDeps([7,2,3,4,5,8,9,10,11,12,13,14,1,15,16,17,18,19]) : void 0))
  },
  Video: {
    label: "Video",
    icon: Video$1,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertVideo-D8g1nBtO.js"), true ? __vite__mapDeps([20,2,3]) : void 0))
  },
  Iframe: {
    label: "Embed",
    icon: GalleryVertical,
    isActive: (editor) => editor.isActive("iframe"),
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertIframe-BJ49y3ZE.js"), true ? __vite__mapDeps([21,2,3,22,19,5,11,4,23,13,8,9,10,12,14,1,15,16,17,18]) : void 0))
  },
  Undo: {
    label: "Undo",
    icon: ArrowGoBack,
