import { ay as defineComponent, az as ref, cl as useRouter, bG as useAttrs, aW as computed, d0 as DropdownMenuRoot_default, d1 as DropdownMenuTrigger_default, d2 as DropdownMenuPortal_default, d3 as DropdownMenuContent_default, d4 as DropdownMenuLabel_default, d5 as DropdownMenuItem_default, d6 as DropdownMenuSub_default, d7 as DropdownMenuSubTrigger_default, d8 as DropdownMenuSubContent_default, aB as openBlock, aC as createBlock, aD as withCtx, aE as createVNode, aZ as renderSlot, aS as normalizeProps, aL as mergeProps, aM as createTextVNode, aN as toDisplayString, aR as normalizeClass, aG as createElementBlock, aK as Fragment, aJ as renderList, aH as createCommentVNode, bx as resolveDynamicComponent, aF as createBaseVNode } from "./vendor-BV3M7NtT.js";
import { B as Button } from "./Button-dDpoWu7r.js";
import { F as FeatherIcon } from "./FeatherIcon--7PqYfXQ.js";
import { S as Switch } from "./Switch-DcgE_6LX.js";
                          ...
                          (openBlock(true), createElementBlock(
                            ...
                            renderList(group.items, (item) => {
                              return openBlock(), createElementBlock(
                                ...
                                [
                                  item.switch ? (openBlock(), createBlock($setup["Switch"], {
                                    key: 0,
                                    class: "!px-2 !py-0 h-7",
                                    label: item.label,
                                  ...
                                  }, null, 8, ["label", "icon", "onChange"])) : (openBlock(), createBlock($setup["DropdownMenuItem"], {
                                    key: 1,
                                    "as-child": "",
                                                              ...
                                                              (openBlock(true), createElementBlock(
                                                                ...
                                                                renderList(submenuGroup.items, (subItem) => {
                                                                  return openBlock(), createElementBlock(
                                                                    ...
                                                                    [
                                                                      subItem.switch ? (openBlock(), createBlock($setup["Switch"], {
                                                                        key: 0,
                                                                        class: "!px-2 !py-0 h-7",
                                                                        label: subItem.label,
                                                                        "label-classes": "font-normal cursor-pointer",
