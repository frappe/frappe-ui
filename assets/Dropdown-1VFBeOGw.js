...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { toggleState, router, attrs, props, close, handleItemClick, normalizeDropdownItem, getIconColor, getTextColor, getBackgroundColor, getSubmenuBackgroundColor, processOptionsIntoGroups, getSubmenuGroups, filterOptions, cssClasses, groups, contentSide, contentAlign, get DropdownMenuRoot() {
      return _sfc_main$1;
