import { ay as defineComponent, az as ref, bs as watch, aB as openBlock, aG as createElementBlock, aN as toDisplayString, aH as createCommentVNode, aF as createBaseVNode, aK as Fragment, aJ as renderList, aE as createVNode, aW as normalizeClass } from "./vendor-f3e53e4e.js";
...
const _hoisted_2 = {
  key: 0,
  class: "block text-xs text-text-icons-gray-5"
};
        ...
        renderList($props.rating_from, (index) => {
          return openBlock(), createElementBlock("div", {
            ...
            createVNode($setup["FeatherIcon"], {
              name: "star",
              class: normalizeClass(["fill-gray-400 text-text-icons-gray-1 stroke-1 mr-1", $setup.iconClasses(index)]),
