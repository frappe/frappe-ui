import { ay as defineComponent, cq as useRouter, aU as computed, cO as ge, cP as Se, cQ as Me, cR as be, aB as openBlock, aC as createBlock, aD as withCtx, aE as createVNode, aX as renderSlot, aR as normalizeProps, aL as mergeProps, aM as createTextVNode, aN as toDisplayString, aQ as normalizeClass, aG as createElementBlock, aK as Fragment, aJ as renderList, aH as createCommentVNode, bd as resolveDynamicComponent, aF as createBaseVNode } from "./vendor-Dgw--ntF.js";
      ...
      createVNode($setup["Popover"], {
        ...
        body: withCtx(() => [
          createVNode($setup["MenuItems"], {
            class: normalizeClass(["mt-2 min-w-40 divide-y divide-outline-gray-modals rounded-lg bg-surface-modal shadow-2xl ring-1 ring-black ring-opacity-5 focus:outline-none", {
...
const Dropdown = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/Dropdown/Dropdown.vue"]]);
export {
  Dropdown as D
};
