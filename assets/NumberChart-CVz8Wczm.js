import { ay as defineComponent, az as ref, b1 as onMounted, co as init, bT as onBeforeUnmount, bb as watch, aB as openBlock, aG as createElementBlock, b3 as withDirectives, bw as vShow, aF as createBaseVNode, aN as toDisplayString, aK as Fragment, aW as computed, aC as createBlock, aQ as normalizeClass, aH as createCommentVNode } from "./vendor-ChKKKszV.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { d as debounce } from "./debounce-CRCtzhPg.js";
import { d as dayjs } from "./dayjs-BGcB0k8t.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const props = __props;
    const error = ref("");
    const __returned__ = { props, error, get formatValue() {
      return formatValue;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
const _hoisted_2 = { class: "truncate text-sm font-medium" };
const _hoisted_3 = { class: "flex-1 flex-shrink-0 truncate text-[24px] font-semibold leading-10" };
const _hoisted_4 = { class: "" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    {
      class: normalizeClass(["flex max-h-[140px] items-center gap-2 overflow-hidden bg-white px-6 pt-5", $props.config.delta ? "pb-6" : "pb-3"])
    },
    [
        ...
        $props.config.delta ? (openBlock(), createElementBlock(
          "div",
          {
            ...
            class: normalizeClass(["flex items-center gap-0.5 text-xs font-medium", [
              $props.config.negativeIsBetter ? $props.config.delta >= 0 ? "text-red-500" : "text-green-500" : $props.config.delta >= 0 ? "text-green-500" : "text-red-500"
            ]])
          },
          [
            createBaseVNode(
