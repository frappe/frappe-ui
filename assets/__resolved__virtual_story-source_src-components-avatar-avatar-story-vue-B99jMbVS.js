const __resolved__virtual_storySource_srcComponentsAvatarAvatarStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsAvatarAvatarStoryVue as default
};
