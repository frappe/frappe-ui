const __resolved__virtual_storySource_srcComponentsBadgeBadgeStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsBadgeBadgeStoryVue as default
};
