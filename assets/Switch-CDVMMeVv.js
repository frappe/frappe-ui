import { ay as defineComponent, aU as computed, cU as ue, cV as ce, cW as oe, cX as de, aB as openBlock, aC as createBlock, aD as withCtx, aF as createBaseVNode, aQ as normalizeClass, aM as createTextVNode, aN as toDisplayString, aH as createCommentVNode, aE as createVNode, bN as withKeys, aY as withModifiers } from "./vendor-CV72Nr6d.js";
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const switchCircleClasses = computed(() => {
      return [
        ...
        props.size === "md" ? props.modelValue ? "ltr:translate-x-3 rtl:-translate-x-3" : "translate-x-0" : props.modelValue ? "ltr:translate-x-2.5 rtl:-translate-x-2.5" : "translate-x-0"
      ];
    });
