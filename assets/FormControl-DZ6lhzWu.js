import { ay as defineComponent, aU as computed, aB as openBlock, aG as createElementBlock, aM as createTextVNode, aN as toDisplayString, aK as Fragment, aF as createBaseVNode, aH as createCommentVNode, aQ as normalizeClass, cH as mergeModels, cI as useModel, cJ as useAttrs, aC as createBlock, cK as createSlots, aD as withCtx, aX as renderSlot, aL as mergeProps, aR as normalizeProps, aS as guardReactiveProps, aZ as normalizeStyle } from "./vendor-B4ZrTvhS.js";
import { C as Checkbox, u as useId } from "./Checkbox-DN1H7p1U.js";
import { T as TextInput } from "./TextInput-C7CBHcT7.js";
import { S as Select } from "./Select-BUJMxHIK.js";
import { T as Textarea } from "./Textarea-B5xOUiR9.js";
import { A as Autocomplete } from "./Autocomplete-D6w7BKpP.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { id, props, model, attrs, controlAttrs, descriptionClasses, TextInput, Select, Textarea, Checkbox, Autocomplete, FormLabel };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
  ...
  return $props.type != "checkbox" ? (openBlock(), createElementBlock(
    ...
    [
      ...
      $props.type === "select" ? (openBlock(), createBlock($setup["Select"], mergeProps({
        key: 1,
        id: $setup.id
      }, { ...$setup.controlAttrs, size: $props.size }, {
        ...
        key: 4,
        id: $setup.id
      }, { ...$setup.controlAttrs, type: $props.type, size: $props.size, required: $props.required }, {
        modelValue: $setup.model,
