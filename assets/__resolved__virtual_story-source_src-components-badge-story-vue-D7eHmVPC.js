const __resolved__virtual_storySource_srcComponentsBadgeStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsBadgeStoryVue as default
};
