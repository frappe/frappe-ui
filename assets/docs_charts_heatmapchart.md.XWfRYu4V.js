import{_ as k}from"./chunks/PropsTable.F4IQc_Je.js";import{_ as b}from"./chunks/SlotsTable.Deg_pnUG.js";import{_ as g}from"./chunks/EmitsTable.RLTEV3Aq.js";import"./chunks/theme.BREKhljD.js";import{_ as y}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.CWOd3bAg.js";import{I as w,ad as d,r as u,D as l,aE as h,ao as v,A as x,be as c,o as s,B as a}from"./chunks/framework.CK2aBVEu.js";import"./chunks/useChart.CN8HDRXM.js";import"./chunks/tokens.sRDpcKPc.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/usePlotKeyboard.CAiqHl1V.js";import"./chunks/axisChartCommon.DxkGeg5G.js";import"./chunks/format.DB3I3pe8.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.DS9sY8K6.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.ADPseGKR.js";import"./chunks/installLabelLayout.CtJbv4Ya.js";import"./chunks/axisAlignTicks.qxmfj9iW.js";import"./chunks/labelLayoutHelper.CvP7VAad.js";import"./chunks/dataStackHelper.C7KPYwph.js";import"./chunks/labelGuideHelper.BXCthyw_.js";import"./chunks/createSeriesData.ZujH2GCn.js";import"./chunks/VisualMapping.DKpk_lPn.js";const z={class:"h-72 w-full"},j=w({__name:"HeatmapDemand",setup(m){const i=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],r=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],o=[8,52,38,34,20,15,20,9],n=r.flatMap((e,p)=>e.map((t,f)=>({day:_[p],hour:i[f],deviation:Math.round((t-o[f])/o[f]*100)})));return(e,p)=>(d(),u("div",z,[l(h(y),{data:h(n),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:t=>`${t>0?"+":""}${t}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),C={class:"h-72 w-full"},S=w({__name:"HeatmapSignups",setup(m){const i=["Free","Pro","Team"],_=[[420,455,512,498,540,601],[86,92,104,118,131,147],[12,15,14,21,26,33]],r=i.flatMap((n,e)=>_[e].map((p,t)=>({plan:n,month:new Date(Date.UTC(2024,t,1)),signups:p}))),o=n=>n.toLocaleString("en-US",{month:"short",timeZone:"UTC"});return(n,e)=>(d(),u("div",C,[l(h(y),{data:h(r),x:"month",y:"plan",value:"signups","x-axis":{format:o},"show-values":"",title:"Signups by plan",subtitle:"First half of 2024"},null,8,["data","x-axis"])]))}}),O={class:"h-72 w-full"},A=w({__name:"HeatmapTickets",setup(m){const i=["9am","11am","1pm","3pm","5pm","7pm"],_=["Mon","Tue","Wed","Thu","Fri"],r=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],o=_.flatMap((n,e)=>i.map((p,t)=>({day:n,hour:p,tickets:r[e][t]})));return(n,e)=>(d(),u("div",O,[l(h(y),{data:h(o),x:"hour",y:"day",value:"tickets","show-values":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),Z=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmapchart.md","filePath":"docs/charts/heatmapchart.md","lastUpdated":0}'),R={name:"docs/charts/heatmapchart.md"},Q=Object.assign(R,{setup(m){const i=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
chart that fails to draw sets its own; this is for a failed request.`,required:!1,type:"string | null"},{name:"data",description:"One row per cell.",required:!0,type:"Record<string, any>[]"},{name:"x",description:"Row key holding the column a cell sits in.",required:!0,type:"string"},{name:"y",description:"Row key holding the row a cell sits in.",required:!0,type:"string"},{name:"value",description:"Row key holding the magnitude the cell is colored by.",required:!0,type:"string"},{name:"min",description:"Bottom of the color scale. Defaults to the smallest value in the data.",required:!1,type:"number"},{name:"max",description:"Top of the color scale. Defaults to the largest value in the data.",required:!1,type:"number"},{name:"xAxis",description:"The columns of the grid: the axis under it, and the tooltip head.",required:!1,type:"HeatmapAxisOptions"},{name:"yAxis",description:"The rows of the grid: the axis beside it, and the tooltip head.",required:!1,type:"HeatmapAxisOptions"},{name:"showValues",description:`Prints each cell's value inside it. A label that would collide with its
neighbour is dropped, so a grid too fine to carry numbers shows none.`,required:!1,type:"boolean"},{name:"format",description:"Prints every number the grid shows: the cells, the scale ends, the tooltip.",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Ramp cells are colored from. Defaults to `'sequential'`, which is what a\nmagnitude reads as; `'diverging'` is for signed data and centers on zero.",required:!1,type:"HeatmapPalette"},{name:"echartOptions",description:"Escape hatch: deep-merged into the echarts option the props built.",required:!1,type:"EchartOptionsOverride"}],_=[{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"},{name:"actions",description:"",type:"any"},{name:"tooltip",description:"Replaces the tooltip body. `items` holds the hovered cell alone.",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"}],r=[{name:"select",description:`A cell was selected, by click or by Enter on the keyboard cursor. Carries
both its categories and the row behind it.`,type:"[event: HeatmapCellEvent]"}];return(o,n)=>{const e=v("ComponentPreview"),p=v("ClientOnly");return d(),u("div",null,[n[4]||(n[4]=x('<h1 id="heatmapchart" tabindex="-1">HeatmapChart <a class="header-anchor" href="#heatmapchart" aria-label="Permalink to “HeatmapChart”">​</a></h1><p>Magnitude across two dimensions, a cell per pair.</p><h2 id="values-in-cells" tabindex="-1">Values in cells <a class="header-anchor" href="#values-in-cells" aria-label="Permalink to “Values in cells”">​</a></h2><p><code>x</code>, <code>y</code> and <code>value</code> name a cell&#39;s column, row and magnitude, so the data is one row per cell. <code>showValues</code> prints values inside the cells, dropping any label that would collide with its neighbour.</p>',4)),l(p,null,{default:c(()=>[l(e,{name:"Charts-HeatmapTickets","self-layout":""},{code:c(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"      show-values")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:c(()=>[l(S)]),_:1})]),_:1}),n[8]||(n[8]=s("h2",{id:"signed-data",tabindex:"-1"},[a("Signed data "),s("a",{class:"header-anchor",href:"#signed-data","aria-label":"Permalink to “Signed data”"},"​")],-1)),n[9]||(n[9]=s("p",null,[a("Signed data reads on the "),s("code",null,"diverging"),a(" ramp, centered on zero. "),s("code",null,"min"),a(" and "),s("code",null,"max"),a(" pin the scale so the colors mean the same thing across reloads.")],-1)),l(p,null,{default:c(()=>[l(e,{name:"Charts-HeatmapDemand","self-layout":""},{code:c(()=>[...n[2]||(n[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"HeatmapChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"    row"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," Record"),s("span",{class:"s_1jjt6x"},"<"),s("span",{class:"s_i592pt"},"string"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_i592pt"}," any"),s("span",{class:"s_1jjt6x"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  })"),s("span",{class:"s_50ecpt"}," =>"),s("span",{class:"s_i592pt"}," unknown")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:_}),l(g,{data:r})])}}});export{Z as __pageData,Q as default};
