const __resolved__virtual_storySource_srcComponentsCircularprogressbarStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcComponentsCircularprogressbarStoryVue as default
};
