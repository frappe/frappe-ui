import { ay as defineComponent, az as ref, cl as useRouter, bG as useAttrs, aW as computed, d2 as DropdownMenuRoot_default, d3 as DropdownMenuTrigger_default, d4 as DropdownMenuPortal_default, d5 as DropdownMenuContent_default, d6 as DropdownMenuLabel_default, d7 as DropdownMenuItem_default, d8 as DropdownMenuSub_default, d9 as DropdownMenuSubTrigger_default, da as DropdownMenuSubContent_default, aB as openBlock, aC as createBlock, aD as withCtx, aE as createVNode, aZ as renderSlot, aS as normalizeProps, aL as mergeProps, aM as createTextVNode, aN as toDisplayString, aR as normalizeClass, aG as createElementBlock, aK as Fragment, aJ as renderList, aH as createCommentVNode, bx as resolveDynamicComponent, aF as createBaseVNode } from "./vendor-CorAUDrP.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { toggleState, test, router, attrs, props, close, handleItemClick, normalizeDropdownItem, getIconColor, getTextColor, getBackgroundColor, getSubmenuBackgroundColor, processOptionsIntoGroups, getSubmenuGroups, filterOptions, groupHasIcons, cssClasses, groups, contentSide, contentAlign, get DropdownMenuRoot() {
