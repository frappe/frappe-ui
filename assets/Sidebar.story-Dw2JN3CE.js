import { aP as markRaw, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, aU as createStaticVNode, ay as defineComponent, aI as reactive, aA as resolveComponent, aC as createBlock, aD as withCtx, aE as createVNode } from "./vendor-DsK-IN2t.js";
import { L as Link, S as Sidebar } from "./Sidebar-Bkd6f8iQ.js";
import { S as Settings } from "./settings-Dub2aVDd.js";
...
const Notifications = markRaw({ name: "lucide-bell", render: render$a });
const _hoisted_1$a = {
...
const Deals = markRaw({ name: "lucide-briefcase", render: render$9 });
const _hoisted_1$9 = {
...
const Organizations = markRaw({ name: "lucide-building", render: render$8 });
const _hoisted_1$8 = {
...
const Tasks = markRaw({ name: "lucide-check-square", render: render$7 });
const _hoisted_1$7 = {
...
const Notes = markRaw({ name: "lucide-clipboard", render: render$6 });
const _hoisted_1$6 = {
...
const EmailTemplates = markRaw({ name: "lucide-mail", render: render$5 });
const _hoisted_1$5 = {
...
const Moon = markRaw({ name: "lucide-moon", render: render$4 });
const _hoisted_1$4 = {
...
const CallLogs = markRaw({ name: "lucide-phone", render: render$3 });
const _hoisted_1$3 = {
