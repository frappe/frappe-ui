const __resolved__virtual_storySource_srcComponentsTimepickerTimepickerStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsTimepickerTimepickerStoryVue as default
};
