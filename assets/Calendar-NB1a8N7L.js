import { aB as openBlock, aG as createElementBlock, aF as createBaseVNode, aE as createVNode, aH as createCommentVNode, aN as toDisplayString, az as ref, aI as reactive, bd as computed, c7 as inject, aC as createBlock, aD as withCtx, aQ as normalizeClass, a$ as onMounted, c8 as onBeforeUnmount, b8 as watch, c9 as useFloating, ca as offset, cb as flip, cc as shift, cd as autoUpdate, aL as mergeProps, ce as toHandlers, bf as withModifiers, aW as resolveDynamicComponent, aK as Fragment, be as normalizeStyle, aJ as renderList, aM as createTextVNode, bu as renderSlot, aR as normalizeProps, aS as guardReactiveProps, ba as onUnmounted, cf as provide } from "./vendor-CR9WeEaB.js";
import { _ as __unplugin_components_0$1 } from "./Button-Cj8gHUa_.js";
import { T as TabButtons } from "./TabButtons-DFadbYs5.js";
import { F as FeatherIcon } from "./FeatherIcon-C974xDkb.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { _ as __unplugin_components_2 } from "./Dialog-BO2CMQMN.js";
import { _ as __unplugin_components_0 } from "./FormControl-4JX7SoXP.js";
import { E as ErrorMessage } from "./ErrorMessage-B0qjT730.js";
...
function formattedDuration(from_time, to_time, timeFormat) {
...
const _hoisted_1$6 = { class: "w-80 rounded bg-surface-modal text-ink-gray-8 p-4 shadow" };
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$6, [
    ...
    createBaseVNode("div", _hoisted_3$5, [
      ...
      createBaseVNode("div", _hoisted_5$4, [
        ...
        $props.calendarEvent.participant ? (openBlock(), createElementBlock("div", _hoisted_8$3, [
          createVNode($setup["FeatherIcon"], {
            name: "user",
            class: "h-4 w-4"
          }),
...
const _sfc_main$7 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { show, props, newEvent, isUpdated, colors, errorMessage, validateFields, validateStartEndTime, calendarActions, submitEvent, handleEventTime, computed, inject, reactive, ref, Dialog: __unplugin_components_2, FormControl: __unplugin_components_0, ErrorMessage, get Button() {
...
const _hoisted_2$4 = { class: "flex w-fit flex-col overflow-hidden whitespace-nowrap text-gray-800" };
const _hoisted_3$4 = { class: "text-ellipsis text-sm font-medium truncate" };
const _hoisted_4$4 = {
  key: 0,
  class: "text-ellipsis text-xs font-normal"
};
const _hoisted_5$3 = { key: 0 };
const _hoisted_6$3 = { class: "flex w-fit flex-col text-start overflow-hidden whitespace-nowrap text-gray-800" };
      ...
      $setup.activeView !== "Month" ? (openBlock(), createElementBlock(
        ...
        [
          createBaseVNode(
            ...
            [
              $setup.config.showIcon && $setup.eventIcons[$setup.props.event.type] ? (openBlock(), createElementBlock("div", _hoisted_1$4, [
              ...
              createBaseVNode("div", _hoisted_2$4, [
                ...
                !$setup.props.event.isFullDay ? (openBlock(), createElementBlock(
                  ...
                  toDisplayString($setup.formattedDuration(
                    $setup.updatedEvent.from_time,
                    $setup.updatedEvent.to_time,
...
const _hoisted_2$3 = { class: "grid w-full grid-cols-7 py-2" };
const _hoisted_3$3 = { class: "text-center text-base text-ink-gray-5" };
const _hoisted_4$3 = ["onDrop", "onDblclick"];
const _hoisted_5$2 = { class: "flex gap-1 w-full flex-col items-center text-xs text-right" };
const _hoisted_6$2 = {
  key: 1,
    ...
    createBaseVNode(
      "div",
      {
        class: normalizeClass(["grid w-full flex-1 grid-cols-7 border-outline-gray-1", [
          ...
          $props.config.noBorder ? "border-t-[0.5px]" : "border-[0.5px]"
        ]])
      },
      [
        (openBlock(true), createElementBlock(
          ...
          renderList($props.currentMonthDates, (date) => {
            ...
            return openBlock(), createElementBlock("div", {
              ...
              createBaseVNode(
                "div",
                {
                  class: normalizeClass(["flex justify-center font-normal", $setup.currentMonthDate(date) ? "text-gray-700" : "text-gray-200"])
                },
                [
                    ...
                    $setup.currentMonthDate(date) ? (openBlock(), createElementBlock(
                      "span",
                      {
                        ...
                        class: normalizeClass(["z-10 w-full flex justify-between items-center", [
                          date.toDateString() === (/* @__PURE__ */ new Date()).toDateString() ? "py-0.5 px-1" : "py-1 px-2"
                        ]])
                      },
                      [
                        ...
                        createBaseVNode(
                          ...
                          {
                            class: normalizeClass([
                              date.toDateString() === (/* @__PURE__ */ new Date()).toDateString() ? "bg-surface-gray-7 text-ink-white rounded-sm p-[2px]" : "bg-surface-white text-ink-gray-6"
                            ])
                          },
...
const _hoisted_6$1 = { class: "grid w-16 grid-cols-1" };
const _hoisted_7$1 = { class: "flex w-full flex-col" };
const _hoisted_8 = { class: "grid w-full grid-cols-7" };
const _hoisted_9 = ["data-date-attr"];
const _hoisted_10 = {
  key: 1,
  class: "w-full"
};
...
const _hoisted_14 = ["data-time-attr", "onDblclick"];
            ...
            return openBlock(), createElementBlock(
              "span",
              {
                class: normalizeClass([
                  ...
                  $setup.isToday(date) ? "font-semibold text-ink-gray-8" : "font-normal"
                ])
              },
              [
          ...
          createBaseVNode("div", _hoisted_7$1, [
              ...
              (openBlock(true), createElementBlock(
                ...
                renderList($props.weeklyDates, (date, idx) => {
                  ...
                  return openBlock(), createElementBlock("div", null, [
                    createBaseVNode("div", {
                      class: normalizeClass(["flex w-full flex-col gap-1 border-b-[1px] border-r-[1px] border-outline-gray-1 transition-all", [
                        idx === 0 && "relative border-l-[1px]",
                        $props.config.noBorder && idx === $props.weeklyDates.length - 1 && "border-r-0"
                      ]]),
                      ref_for: true,
                      ref: "allDayCells",
                      "data-date-attr": date
                      ...
                      !$setup.isCollapsed ? (openBlock(), createElementBlock("div", _hoisted_10, [
                        (openBlock(true), createElementBlock(
                          Fragment,
                          null,
            ...
            createBaseVNode("div", _hoisted_12, [
              ...
              (openBlock(true), createElementBlock(
                ...
                renderList($props.weeklyDates, (date, idx) => {
                  return openBlock(), createElementBlock("div", {
                    class: normalizeClass(["relative w-full border-r-[1px] border-outline-gray-1", [
                      ...
                      renderList($setup.timeArray, (time, i) => {
                        return openBlock(), createElementBlock("div", {
                          ...
                          createBaseVNode(
                            "div",
                            {
                              class: normalizeClass(["border-outline-gray-1 w-full border-b-[1px]", i === $setup.timeArray.length - 1 && "border-b-0"]),
                              style: normalizeStyle({ height: `${$setup.hourHeight}px` })
                            },
                            null,
                            6
...
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const calendarActions = inject("calendarActions");
    const __returned__ = { props, timedEvents, fullDayEvents, gridRef, hourHeight, minuteHeight, timeArray, calendarActions, computed, inject, onMounted, ref, CalendarEvent, CalendarTimeMarker, get parseDate() {
      return parseDate;
    }, get parseDateWithDay() {
      return parseDateWithDay;
    }, get twelveHoursFormat() {
...
const _hoisted_2$1 = { class: "pb-2 text-base font-semibold text-ink-gray-8" };
const _hoisted_3$1 = { class: "h-full overflow-hidden" };
const _hoisted_4$1 = { class: "grid h-full w-16 grid-cols-1" };
const _hoisted_5 = { class: "grid h-full w-full grid-cols-1 pb-2" };
const _hoisted_6 = { class: "calendar-column relative border-r-[1px] border-l-[1px] border-outline-gray-1" };
const _hoisted_7 = ["data-time-attr", "onDblclick"];
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({ parseDateWithDay: $setup.parseDateWithDay, currentDate: $props.currentDate, fullDay: _ctx.fullDay })), () => [
      createBaseVNode(
        "p",
        _hoisted_2$1,
          ...
          createBaseVNode("div", _hoisted_5, [
            createBaseVNode("div", _hoisted_6, [
              ...
              (openBlock(true), createElementBlock(
                Fragment,
                null,
                renderList($setup.timeArray, (time) => {
                  return openBlock(), createElementBlock("div", {
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    __expose({ reloadEvents });
    const __returned__ = { props, emit, defaultConfig, overrideConfig, get activeView() {
      return activeView;
    }, set activeView(v) {
      activeView = v;
    }, updateActiveView, handleShortcuts, parseEvents, events, reloadEvents, showEventModal, newEvent, openNewEventModal, createNewEvent, updateEventState, deleteEvent, openModal, handleCellDblClick, actionOptions, get enabledModes() {
      return enabledModes;
    }, set enabledModes(v) {
      enabledModes = v;
    }, get currentYear() {
...
const _hoisted_3 = { class: "text-lg font-medium text-ink-gray-8" };
