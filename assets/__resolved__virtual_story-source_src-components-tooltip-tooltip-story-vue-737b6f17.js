const __resolved__virtual_storySource_srcComponentsTooltipTooltipStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsTooltipTooltipStoryVue as default
};
