const __resolved__virtual_storySource_srcComponentsMultiselectMultiselectStoryVue = `<script setup lang="ts">
import { ref } from "vue";
...
`;
export {
  __resolved__virtual_storySource_srcComponentsMultiselectMultiselectStoryVue as default
};
