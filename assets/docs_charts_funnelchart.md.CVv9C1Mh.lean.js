import{_ as v}from"./chunks/PropsTable.CXj9JGTi.js";import{_ as b}from"./chunks/SlotsTable.CQYOAPqo.js";import{_ as g}from"./chunks/EmitsTable.CTqsR7yI.js";import"./chunks/theme.BYW2lfJq.js";import{_ as m}from"./chunks/FunnelChart.vue_vue_type_script_setup_true_lang.DnX1xyrN.js";import{I as k,ad as i,r as _,o as s,D as l,aE as w,F as f,B as a,au as o,aj as z,ao as y,be as p}from"./chunks/framework.CK2aBVEu.js";import"./chunks/format.DIYVl2rQ.js";import"./chunks/tokens.BM8zXaRy.js";import"./chunks/axisChartCommon.coY72BeL.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.DBzLy9DG.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.BiTZXETE.js";const x={class:"flex h-96 w-full flex-col gap-2"},j={class:"min-h-0 flex-1"},C={class:"text-p-sm text-ink-gray-5"},S=k({__name:"FunnelDeals",setup(h){const t=[{stage:"Leads",count:563},{stage:"Qualified",count:385},{stage:"Quotation sent",count:291},{stage:"Ready to close",count:191},{stage:"Won",count:39}],e=z(null);return(c,r)=>(i(),_("div",x,[s("div",j,[l(w(m),{data:t,category:"stage",value:"count","show-percentages":!1,title:"Deal pipeline",subtitle:"Open deals by stage, this quarter",onSelect:r[0]||(r[0]=n=>e.value=n)})]),s("p",C,[e.value?(i(),_(f,{key:0},[a(" Selected "+o(e.value.label)+" · "+o(e.value.value)+" · index "+o(e.value.index),1)],64)):(i(),_(f,{key:1},[a("Select a stage.")],64))])]))}}),O={class:"h-80 w-full"},R=k({__name:"FunnelStages",setup(h){const t=[{stage:"Visited the store",people:106200},{stage:"Viewed a plan",people:38400},{stage:"Started checkout",people:9860},{stage:"Entered payment details",people:3410},{stage:"Active subscription",people:2560}],e=c=>new Intl.NumberFormat("en-US",{notation:"compact"}).format(c);return(c,r)=>(i(),_("div",O,[l(w(m),{data:t,category:"stage",value:"people",format:e,title:"Store visit to subscription",subtitle:"July 2026"})]))}}),W=JSON.parse('{"title":"FunnelChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/funnelchart.md","filePath":"docs/charts/funnelchart.md","lastUpdated":0}'),A={name:"docs/charts/funnelchart.md"},M=Object.assign(A,{setup(h){const t=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
chart that fails to draw sets its own; this is for a failed request.`,required:!1,type:"string | null"},{name:"data",description:"One row per stage, in process order. Rows are drawn as they arrive.",required:!0,type:"Record<string, any>[]"},{name:"category",description:"Row key holding the stage name.",required:!0,type:"string"},{name:"value",description:"Row key holding how many reached the stage.",required:!0,type:"string"},{name:"showPercentages",description:"Prints each stage's share of the first stage. On by default.",required:!1,type:"boolean",default:"true"},{name:"format",description:"Prints every number the funnel shows: the stage values and the tooltip.",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'sequential'` reversed, so color darkens as the funnel narrows.",required:!1,type:"ChartPalette"}],e=[{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"},{name:"actions",description:"",type:"any"},{name:"tooltip",description:"Replaces the tooltip body. `stage` carries the two conversion rates the\ndefault body prints under the value.",type:"{ label?: string | undefined; items: ChartTooltipItem[]; stage?: FunnelStage | undefined; }"}],c=[{name:"select",description:`A stage was selected, by click or by Enter on the keyboard cursor. Carries
its position in the funnel and the row behind it; the whole column is the
hit area, not just the shape it draws.`,type:"[event: FunnelStageEvent]"}];return(r,n)=>{const u=y("ComponentPreview"),d=y("ClientOnly");return i(),_("div",null,[n[3]||(n[3]=s("h1",{id:"funnelchart",tabindex:"-1"},[a("FunnelChart "),s("a",{class:"header-anchor",href:"#funnelchart","aria-label":"Permalink to “FunnelChart”"},"​")],-1)),n[4]||(n[4]=s("p",null,"Stage-to-stage drop-off, drawn as plain SVG.",-1)),n[5]||(n[5]=s("h2",{id:"stages",tabindex:"-1"},[a("Stages "),s("a",{class:"header-anchor",href:"#stages","aria-label":"Permalink to “Stages”"},"​")],-1)),n[6]||(n[6]=s("p",null,[a("One row per stage, drawn in row order. Percentages are each stage's share of the first, which is what a funnel is read for. "),s("code",null,"format"),a(" runs on the counts.")],-1)),l(d,null,{default:p(()=>[l(u,{name:"Charts-FunnelStages","self-layout":""},{code:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:p(()=>[l(R)]),_:1})]),_:1}),n[7]||(n[7]=s("h2",{id:"counts-and-clicks",tabindex:"-1"},[a("Counts and clicks "),s("a",{class:"header-anchor",href:"#counts-and-clicks","aria-label":"Permalink to “Counts and clicks”"},"​")],-1)),n[8]||(n[8]=s("p",null,[a("Turn the percentages off with "),s("code",null,"showPercentages: false"),a(" when the absolute counts are the point. "),s("code",null,"select"),a(" reports the stage and its row.")],-1)),l(d,null,{default:p(()=>[l(u,{name:"Charts-FunnelDeals","self-layout":""},{code:p(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"        :show-percentages"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"false"),s("span",{class:"s_w1p9wo"},'"')]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_6am9cx"},"        Selected {{ stage.label }} · {{ stage.value }} · index {{ stage.index }}")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"      </"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"    row"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," Record"),s("span",{class:"s_1jjt6x"},"<"),s("span",{class:"s_i592pt"},"string"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_i592pt"}," any"),s("span",{class:"s_1jjt6x"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  })"),s("span",{class:"s_50ecpt"}," =>"),s("span",{class:"s_i592pt"}," unknown")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:e}),l(g,{data:c})])}}});export{W as __pageData,M as default};
