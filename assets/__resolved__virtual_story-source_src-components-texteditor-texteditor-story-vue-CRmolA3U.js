const __resolved__virtual_storySource_srcComponentsTexteditorTexteditorStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsTexteditorTexteditorStoryVue as default
};
