import { az as ref, aQ as computed, aR as useDebounceFn, aS as inject, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, aT as renderSlot, aU as normalizeProps, aV as guardReactiveProps, aN as toDisplayString, aW as normalizeClass, aL as mergeProps, aH as createCommentVNode, aC as createBlock, aX as withModifiers, aK as Fragment, aJ as renderList, aY as normalizeStyle, aA as resolveComponent, aE as createVNode, aM as createTextVNode, ay as defineComponent, aZ as Node, a_ as mergeAttributes, a$ as nodeInputRule, b0 as Plugin, b1 as Mention, b2 as VueRenderer, b3 as tippy, aD as withCtx, b4 as resolveDynamicComponent, b5 as withDirectives, b6 as vShow, Z as defineAsyncComponent, _ as __vitePreload, b7 as BubbleMenu, b8 as FloatingMenu, b9 as showdown, ba as EditorContent, bb as computed$1, bc as Editor, bd as StarterKit, be as Table$1, bf as TableRow, bg as TableHeader, bh as TableCell, bi as Typography, bj as TextAlign, bk as TextStyle, bl as Color, bm as Highlight, bn as Link$1, bo as Placeholder, bp as DOMParser, bq as Transition, br as useSlots, aI as reactive, bs as watch, bt as provide, bu as onMounted, bv as onBeforeUnmount, bw as lt, bx as it, by as rt, bz as ut, bA as ye, bB as Ge, bC as je, bD as createPopper, bE as nextTick, aP as h, bF as set, bG as get } from "./vendor-ff760363.js";
import { A as Avatar } from "./Avatar-275b4fa0.js";
import { B as Badge } from "./Badge-b72f2d39.js";
import { L as LoadingIndicator, B as Button } from "./Button-1d9c794b.js";
import { F as FeatherIcon } from "./FeatherIcon-9c46386e.js";
import { C as Checkbox } from "./Checkbox-185d8ed3.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { A as Autocomplete } from "./Autocomplete-adb07502.js";
import "./Breadcrumbs-4eccad0a.js";
import "./DateRangePicker-f940f2a4.js";
import { D as Dialog } from "./Dialog-4bafa913.js";
import "./Dropdown-b9370ca1.js";
import "./ErrorMessage-b567f058.js";
import "./FileUploader-59526497.js";
import { F as FormControl } from "./FormControl-d05dcba9.js";
import "./Progress-cc7f81b9.js";
import { P as Popover } from "./Popover-31ec707d.js";
import "./Rating-cd50fa1c.js";
import "./Select-6c682405.js";
import "./Spinner-09477bc4.js";
import "./Switch-95beb185.js";
import { T as TabButtons } from "./Calendar-6e1dfa04.js";
import "./Tabs-b7d3ba38.js";
import "./TextInput-efbd944a.js";
import "./Textarea-75fa0e2a.js";
import { T as Tooltip } from "./Tooltip-f232eaa6.js";
import "./CircularProgressBar-7c4f26a7.js";
import "./Tree-c8b87f99.js";
...
const _hoisted_1$F = { class: "truncate" };
const _hoisted_2$7 = {
  ref: "resizer",
  ...
  return openBlock(), createElementBlock(
    ...
    [
      createBaseVNode(
        "div",
        {
          class: normalizeClass(["flex items-center space-x-2 truncate text-sm text-gray-600", _ctx.$attrs.class])
        },
        [
...
_sfc_main$Z.__file = "src/components/ListView/ListHeaderItem.vue";
const ListHeaderItem = /* @__PURE__ */ _export_sfc(_sfc_main$Z, [["render", _sfc_render$K], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListHeaderItem.vue"]]);
const _sfc_main$Y = {
  __name: "ListHeader",
  emits: ["columnWidthUpdated"],
  setup(__props, { expose: __expose, emit: __emit }) {
...
_sfc_main$Y.__file = "src/components/ListView/ListHeader.vue";
const ListHeader = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [["render", _sfc_render$J], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListHeader.vue"]]);
const _sfc_main$X = {
  name: "Alert",
  props: {
    title: String,
...
_sfc_main$X.__file = "src/components/Alert.vue";
const _sfc_main$W = {
  name: "Loading",
  props: {
    text: {
...
const _hoisted_1$E = { class: "flex items-center text-base text-gray-500" };
...
_sfc_main$W.__file = "src/components/LoadingText.vue";
const LoadingText = /* @__PURE__ */ _export_sfc(_sfc_main$W, [["render", _sfc_render$I], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/LoadingText.vue"]]);
const _sfc_main$V = {
  name: "Card",
  props: {
    title: {
...
_sfc_main$V.__file = "src/components/Card.vue";
const _sfc_main$U = {
  name: "ConfirmDialog",
  props: {
    title: {
...
_sfc_main$U.__file = "src/components/ConfirmDialog.vue";
const dialogs = ref([]);
const _sfc_main$T = {
  __name: "Dialogs",
...
_sfc_main$T.__file = "src/components/Dialogs.vue";
...
_sfc_main$S.__file = "src/components/Divider.vue";
const _sfc_main$R = {};
_sfc_main$R.__file = "src/components/GreenCheckIcon.vue";
const _sfc_main$Q = {
  props: ["to"],
  computed: {
    attributes() {
...
_sfc_main$Q.__file = "src/components/Link.vue";
const _sfc_main$P = {
  name: "ListItem",
...
_sfc_main$P.__file = "src/components/ListItem.vue";
const _sfc_main$O = {
  name: "Resource",
  props: ["options"],
  resources: {
...
_sfc_main$O.__file = "src/components/Resource.vue";
...
function _sfc_render$H(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    $props.items.length ? (openBlock(), createElementBlock("div", _hoisted_1$D, [
      (openBlock(true), createElementBlock(
        Fragment,
        null,
...
_sfc_main$N.__file = "src/components/TextEditor/MentionList.vue";
const MentionList = /* @__PURE__ */ _export_sfc(_sfc_main$N, [["render", _sfc_render$H], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/MentionList.vue"]]);
...
const _hoisted_1$C = { class: "inline-flex bg-white px-1 py-1" };
...
_sfc_main$M.__file = "src/components/TextEditor/Menu.vue";
const Menu = /* @__PURE__ */ _export_sfc(_sfc_main$M, [["render", _sfc_render$G], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/Menu.vue"]]);
const _sfc_main$L = {};
const _hoisted_1$B = {
...
_sfc_main$L.__file = "src/components/TextEditor/icons/h-1.vue";
const H1 = /* @__PURE__ */ _export_sfc(_sfc_main$L, [["render", _sfc_render$F], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/h-1.vue"]]);
const _sfc_main$K = {};
const _hoisted_1$A = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$K.__file = "src/components/TextEditor/icons/h-2.vue";
const H2 = /* @__PURE__ */ _export_sfc(_sfc_main$K, [["render", _sfc_render$E], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/h-2.vue"]]);
const _sfc_main$J = {};
const _hoisted_1$z = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$J.__file = "src/components/TextEditor/icons/h-3.vue";
const H3 = /* @__PURE__ */ _export_sfc(_sfc_main$J, [["render", _sfc_render$D], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/h-3.vue"]]);
const _sfc_main$I = {};
const _hoisted_1$y = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$I.__file = "src/components/TextEditor/icons/h-4.vue";
const H4 = /* @__PURE__ */ _export_sfc(_sfc_main$I, [["render", _sfc_render$C], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/h-4.vue"]]);
const _sfc_main$H = {};
const _hoisted_1$x = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$H.__file = "src/components/TextEditor/icons/h-5.vue";
const H5 = /* @__PURE__ */ _export_sfc(_sfc_main$H, [["render", _sfc_render$B], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/h-5.vue"]]);
const _sfc_main$G = {};
const _hoisted_1$w = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$G.__file = "src/components/TextEditor/icons/h-6.vue";
const H6 = /* @__PURE__ */ _export_sfc(_sfc_main$G, [["render", _sfc_render$A], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/h-6.vue"]]);
const _sfc_main$F = {};
const _hoisted_1$v = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$F.__file = "src/components/TextEditor/icons/text.vue";
const Text = /* @__PURE__ */ _export_sfc(_sfc_main$F, [["render", _sfc_render$z], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/text.vue"]]);
const _sfc_main$E = {};
const _hoisted_1$u = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$E.__file = "src/components/TextEditor/icons/bold.vue";
const Bold = /* @__PURE__ */ _export_sfc(_sfc_main$E, [["render", _sfc_render$y], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/bold.vue"]]);
const _sfc_main$D = {};
const _hoisted_1$t = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$D.__file = "src/components/TextEditor/icons/italic.vue";
const Italic = /* @__PURE__ */ _export_sfc(_sfc_main$D, [["render", _sfc_render$x], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/italic.vue"]]);
const _sfc_main$C = {};
const _hoisted_1$s = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$C.__file = "src/components/TextEditor/icons/underline.vue";
const Underline = /* @__PURE__ */ _export_sfc(_sfc_main$C, [["render", _sfc_render$w], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/underline.vue"]]);
const _sfc_main$B = {};
const _hoisted_1$r = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$B.__file = "src/components/TextEditor/icons/align-center.vue";
const AlignCenter = /* @__PURE__ */ _export_sfc(_sfc_main$B, [["render", _sfc_render$v], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/align-center.vue"]]);
const _sfc_main$A = {};
const _hoisted_1$q = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$A.__file = "src/components/TextEditor/icons/align-left.vue";
const AlignLeft = /* @__PURE__ */ _export_sfc(_sfc_main$A, [["render", _sfc_render$u], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/align-left.vue"]]);
const _sfc_main$z = {};
const _hoisted_1$p = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$z.__file = "src/components/TextEditor/icons/align-right.vue";
const AlignRight = /* @__PURE__ */ _export_sfc(_sfc_main$z, [["render", _sfc_render$t], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/align-right.vue"]]);
const _sfc_main$y = {};
const _hoisted_1$o = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$y.__file = "src/components/TextEditor/icons/font-color.vue";
const FontColor = /* @__PURE__ */ _export_sfc(_sfc_main$y, [["render", _sfc_render$s], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/font-color.vue"]]);
const _sfc_main$x = {};
const _hoisted_1$n = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$x.__file = "src/components/TextEditor/icons/list-ordered.vue";
const ListOrdered = /* @__PURE__ */ _export_sfc(_sfc_main$x, [["render", _sfc_render$r], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/list-ordered.vue"]]);
const _sfc_main$w = {};
const _hoisted_1$m = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$w.__file = "src/components/TextEditor/icons/list-unordered.vue";
const ListUnordered = /* @__PURE__ */ _export_sfc(_sfc_main$w, [["render", _sfc_render$q], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/list-unordered.vue"]]);
const _sfc_main$v = {};
const _hoisted_1$l = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$v.__file = "src/components/TextEditor/icons/double-quotes-r.vue";
const DoubleQuotes = /* @__PURE__ */ _export_sfc(_sfc_main$v, [["render", _sfc_render$p], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/double-quotes-r.vue"]]);
const _sfc_main$u = {};
const _hoisted_1$k = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$u.__file = "src/components/TextEditor/icons/code-view.vue";
const CodeView = /* @__PURE__ */ _export_sfc(_sfc_main$u, [["render", _sfc_render$o], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/code-view.vue"]]);
const _sfc_main$t = {};
const _hoisted_1$j = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$t.__file = "src/components/TextEditor/icons/link.vue";
const Link = /* @__PURE__ */ _export_sfc(_sfc_main$t, [["render", _sfc_render$n], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/link.vue"]]);
const _sfc_main$s = {};
const _hoisted_1$i = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$s.__file = "src/components/TextEditor/icons/image-add-line.vue";
const Image = /* @__PURE__ */ _export_sfc(_sfc_main$s, [["render", _sfc_render$m], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/image-add-line.vue"]]);
const _sfc_main$r = {};
const _hoisted_1$h = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$r.__file = "src/components/TextEditor/icons/video-add-line.vue";
const Video = /* @__PURE__ */ _export_sfc(_sfc_main$r, [["render", _sfc_render$l], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/video-add-line.vue"]]);
const _sfc_main$q = {};
const _hoisted_1$g = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$q.__file = "src/components/TextEditor/icons/arrow-go-back-line.vue";
const ArrowGoBack = /* @__PURE__ */ _export_sfc(_sfc_main$q, [["render", _sfc_render$k], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/arrow-go-back-line.vue"]]);
const _sfc_main$p = {};
const _hoisted_1$f = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$p.__file = "src/components/TextEditor/icons/arrow-go-forward-line.vue";
const ArrowGoForward = /* @__PURE__ */ _export_sfc(_sfc_main$p, [["render", _sfc_render$j], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/arrow-go-forward-line.vue"]]);
const _sfc_main$o = {};
const _hoisted_1$e = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$o.__file = "src/components/TextEditor/icons/separator.vue";
const Separator = /* @__PURE__ */ _export_sfc(_sfc_main$o, [["render", _sfc_render$i], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/separator.vue"]]);
const _sfc_main$n = {};
const _hoisted_1$d = {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
_sfc_main$n.__file = "src/components/TextEditor/icons/table-2.vue";
const Table = /* @__PURE__ */ _export_sfc(_sfc_main$n, [["render", _sfc_render$h], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/icons/table-2.vue"]]);
const commands = {
  Paragraph: {
    label: "Paragraph",
    icon: Text,
  ...
  FontColor: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./FontColor-5061b9c9.js"), true ? ["assets/FontColor-5061b9c9.js","assets/Popover-31ec707d.js","assets/vendor-ff760363.js","assets/_plugin-vue_export-helper-cc2b3d55.js","assets/Autocomplete-adb07502.js","assets/Button-1d9c794b.js","assets/FeatherIcon-9c46386e.js","assets/Avatar-275b4fa0.js","assets/Badge-b72f2d39.js","assets/Breadcrumbs-4eccad0a.js","assets/Dropdown-b9370ca1.js","assets/Checkbox-185d8ed3.js","assets/DateRangePicker-f940f2a4.js","assets/TextInput-efbd944a.js","assets/debounce-d11286cd.js","assets/Dialog-4bafa913.js","assets/ErrorMessage-b567f058.js","assets/FileUploader-59526497.js","assets/FormControl-d05dcba9.js","assets/Select-6c682405.js","assets/Textarea-75fa0e2a.js","assets/Progress-cc7f81b9.js","assets/Rating-cd50fa1c.js","assets/Spinner-09477bc4.js","assets/Switch-95beb185.js","assets/Calendar-6e1dfa04.js","assets/Tabs-b7d3ba38.js","assets/Tooltip-f232eaa6.js","assets/CircularProgressBar-7c4f26a7.js","assets/Tree-c8b87f99.js"] : void 0))
  },
  Blockquote: {
    label: "Blockquote",
    icon: DoubleQuotes,
  ...
  Link: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertLink-c9b9cbf4.js"), true ? ["assets/InsertLink-c9b9cbf4.js","assets/Dialog-4bafa913.js","assets/vendor-ff760363.js","assets/Button-1d9c794b.js","assets/FeatherIcon-9c46386e.js","assets/_plugin-vue_export-helper-cc2b3d55.js","assets/FormControl-d05dcba9.js","assets/Checkbox-185d8ed3.js","assets/TextInput-efbd944a.js","assets/debounce-d11286cd.js","assets/Select-6c682405.js","assets/Textarea-75fa0e2a.js","assets/Autocomplete-adb07502.js","assets/Popover-31ec707d.js"] : void 0))
  },
  Image: {
    label: "Image",
    icon: Image,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertImage-a29d4bb9.js"), true ? ["assets/InsertImage-a29d4bb9.js","assets/Dialog-4bafa913.js","assets/vendor-ff760363.js","assets/Button-1d9c794b.js","assets/FeatherIcon-9c46386e.js","assets/_plugin-vue_export-helper-cc2b3d55.js","assets/Avatar-275b4fa0.js","assets/Badge-b72f2d39.js","assets/Checkbox-185d8ed3.js","assets/Autocomplete-adb07502.js","assets/Popover-31ec707d.js","assets/Breadcrumbs-4eccad0a.js","assets/Dropdown-b9370ca1.js","assets/DateRangePicker-f940f2a4.js","assets/TextInput-efbd944a.js","assets/debounce-d11286cd.js","assets/ErrorMessage-b567f058.js","assets/FileUploader-59526497.js","assets/FormControl-d05dcba9.js","assets/Select-6c682405.js","assets/Textarea-75fa0e2a.js","assets/Progress-cc7f81b9.js","assets/Rating-cd50fa1c.js","assets/Spinner-09477bc4.js","assets/Switch-95beb185.js","assets/Calendar-6e1dfa04.js","assets/Tabs-b7d3ba38.js","assets/Tooltip-f232eaa6.js","assets/CircularProgressBar-7c4f26a7.js","assets/Tree-c8b87f99.js"] : void 0))
  },
  Video: {
    label: "Video",
    icon: Video,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertVideo-15ee4aa5.js"), true ? ["assets/InsertVideo-15ee4aa5.js","assets/Button-1d9c794b.js","assets/vendor-ff760363.js","assets/FeatherIcon-9c46386e.js","assets/_plugin-vue_export-helper-cc2b3d55.js","assets/Dialog-4bafa913.js","assets/FileUploader-59526497.js"] : void 0))
  },
  Undo: {
    label: "Undo",
    icon: ArrowGoBack,
...
_sfc_main$m.__file = "src/components/TextEditor/TextEditorFixedMenu.vue";
const TextEditorFixedMenu = /* @__PURE__ */ _export_sfc(_sfc_main$m, [["render", _sfc_render$g], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/TextEditorFixedMenu.vue"]]);
const _sfc_main$l = {
...
_sfc_main$l.__file = "src/components/TextEditor/TextEditorBubbleMenu.vue";
const TextEditorBubbleMenu = /* @__PURE__ */ _export_sfc(_sfc_main$l, [["render", _sfc_render$f], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/TextEditorBubbleMenu.vue"]]);
const _sfc_main$k = {
...
const _hoisted_1$c = ["onClick", "title"];
const _hoisted_2$4 = {
  key: 1,
  class: "inline-block h-4 min-w-[1rem] text-sm leading-4"
};
...
_sfc_main$k.__file = "src/components/TextEditor/TextEditorFloatingMenu.vue";
const TextEditorFloatingMenu = /* @__PURE__ */ _export_sfc(_sfc_main$k, [["render", _sfc_render$e], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TextEditor/TextEditorFloatingMenu.vue"]]);
...
_sfc_main$j.__file = "src/components/TextEditor/TextEditor.vue";
const _sfc_main$i = {
  __name: "ListEmptyState",
  setup(__props, { expose: __expose }) {
    __expose();
    const list = inject("list");
    const __returned__ = { list, inject, Button };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
...
const _hoisted_3$3 = { class: "mt-1 text-base text-gray-600" };
...
_sfc_main$i.__file = "src/components/ListView/ListEmptyState.vue";
const ListEmptyState = /* @__PURE__ */ _export_sfc(_sfc_main$i, [["render", _sfc_render$d], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListEmptyState.vue"]]);
const _sfc_main$h = {
  __name: "ListRows",
  setup(__props, { expose: __expose }) {
    __expose();
...
_sfc_main$h.__file = "src/components/ListView/ListRows.vue";
const ListRows = /* @__PURE__ */ _export_sfc(_sfc_main$h, [["render", _sfc_render$c], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListRows.vue"]]);
const _sfc_main$g = {};
const _hoisted_1$9 = {
  xmlns: "http://www.w3.org/2000/svg",
  fill: "none",
...
_sfc_main$g.__file = "src/icons/DownSolid.vue";
const DownSolid = /* @__PURE__ */ _export_sfc(_sfc_main$g, [["render", _sfc_render$b], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/icons/DownSolid.vue"]]);
const _sfc_main$f = {
      ...
      createBaseVNode("div", _hoisted_1$8, [
        createBaseVNode("button", {
          ...
          createVNode($setup["DownSolid"], {
            class: normalizeClass(["h-4 w-4 text-gray-900 transition-transform duration-200", [$props.group.collapsed ? "-rotate-90" : ""]])
          }, null, 8, ["class"])
        ]),
        renderSlot(_ctx.$slots, "default", {}, () => [
...
_sfc_main$f.__file = "src/components/ListView/ListGroupHeader.vue";
const ListGroupHeader = /* @__PURE__ */ _export_sfc(_sfc_main$f, [["render", _sfc_render$a], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListGroupHeader.vue"]]);
const _sfc_main$e = {
...
_sfc_main$e.__file = "src/components/ListView/ListGroupRows.vue";
const ListGroupRows = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["render", _sfc_render$9], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListGroupRows.vue"]]);
const _sfc_main$d = {
  __name: "ListGroups",
  setup(__props, { expose: __expose }) {
    __expose();
...
_sfc_main$d.__file = "src/components/ListView/ListGroups.vue";
const ListGroups = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$8], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListGroups.vue"]]);
const _sfc_main$c = /* @__PURE__ */ Object.assign({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { list, get selectedText() {
      ...
      selectedText = v;
    }, Checkbox, Button, computed, inject };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
const _hoisted_2$1 = { class: "flex flex-1 justify-between border-r border-gray-300 text-gray-900" };
    ...
    default: withCtx(() => [
      $setup.list.selections.size ? (openBlock(), createElementBlock("div", _hoisted_1$5, [
        createBaseVNode(
          "div",
          {
            class: normalizeClass(["flex min-w-[596px] items-center space-x-3 rounded-lg bg-white px-4 py-2 shadow-2xl", _ctx.$attrs.class])
          },
          [
            renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps({
              ...
              createBaseVNode("div", _hoisted_5, [
                createVNode($setup["Button"], {
                  class: normalizeClass(["w- text-gray-700", $setup.list.allRowsSelected ? "cursor-not-allowed" : ""]),
...
_sfc_main$c.__file = "src/components/ListView/ListSelectBanner.vue";
const ListSelectBanner = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["render", _sfc_render$7], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListSelectBanner.vue"]]);
...
_sfc_main$b.__file = "src/components/ListView/ListView.vue";
const ListView = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$6], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListView/ListView.vue"]]);
const _sfc_main$a = {
  __name: "ListFooter",
  props: {
    modelValue: {
...
_sfc_main$a.__file = "src/components/ListView/ListFooter.vue";
const _sfc_main$9 = {
  name: "Toast",
  props: {
    position: {
...
_sfc_main$9.__file = "src/components/Toast.vue";
ref([]);
const _sfc_main$8 = {
...
_sfc_main$8.__file = "src/components/CommandPalette/CommandPalette.vue";
const _sfc_main$7 = {
...
_sfc_main$7.__file = "src/components/CommandPalette/CommandPaletteItem.vue";
const _sfc_main$6 = {};
const _hoisted_1$3 = {
  width: "16",
  height: "17",
...
_sfc_main$6.__file = "src/components/ListFilter/FilterIcon.vue";
const FilterIcon = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$5], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListFilter/FilterIcon.vue"]]);
const _sfc_main$5 = {
...
_sfc_main$5.__file = "src/components/ListFilter/NestedPopover.vue";
const NestedPopover = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$4], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListFilter/NestedPopover.vue"]]);
const _sfc_main$4 = {
...
_sfc_main$4.__file = "src/components/ListFilter/SearchComplete.vue";
const SearchComplete = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$3], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/ListFilter/SearchComplete.vue"]]);
const _sfc_main$3 = {
  __name: "ListFilter",
  props: {
    modelValue: {
...
_sfc_main$3.__file = "src/components/ListFilter/ListFilter.vue";
          ...
          createBaseVNode(
            "div",
            {
              class: normalizeClass(["grid items-center space-x-4 rounded px-2", [
                $setup.isSelected ? "bg-gray-100" : "",
                $setup.isHoverable ? $setup.isSelected ? "hover:bg-gray-200" : "hover:bg-gray-50" : ""
              ]]),
              style: normalizeStyle({
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { state, simple_columns, simple_rows, group_columns, grouped_rows, custom_columns, custom_rows, reactive, h, ref, Avatar, Badge, Button, FeatherIcon, ListHeader, ListHeaderItem, ListRow, ListRowItem, ListRows, ListGroups, ListSelectBanner, ListView };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
};
const _hoisted_1 = { class: "flex gap-2" };
const _hoisted_2 = { class: "text-base font-medium leading-6 text-gray-900" };
const _hoisted_3 = {
  key: 1,
