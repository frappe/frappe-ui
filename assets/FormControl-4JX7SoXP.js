import { ay as defineComponent, bR as useAttrs, bd as computed, aB as openBlock, aG as createElementBlock, aQ as normalizeClass, aM as createTextVNode, aN as toDisplayString, aH as createCommentVNode, aC as createBlock, co as createSlots, aD as withCtx, bu as renderSlot, aL as mergeProps, aR as normalizeProps, aS as guardReactiveProps } from "./vendor-CR9WeEaB.js";
import { C as Checkbox, u as useId } from "./Checkbox-C8ksOq9s.js";
import { T as TextInput } from "./TextInput-BRug5pck.js";
import { S as Select } from "./Select-DpA4DjRY.js";
import { T as Textarea } from "./Textarea-BeHxPnjk.js";
import { A as Autocomplete } from "./Autocomplete-Cyp5pag8.js";
  ...
  return $props.type != "checkbox" ? (openBlock(), createElementBlock(
    ...
    [
      ...
      $props.type === "select" ? (openBlock(), createBlock($setup["Select"], mergeProps({
        ...
        key: 4,
        id: $setup.id
      }, { ...$setup.controlAttrs, type: $props.type, size: $props.size, required: $props.required }), createSlots({
        _: 2
        /* DYNAMIC */
      }, [
        _ctx.$slots.prefix ? {
...
const __unplugin_components_0 = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/FormControl.vue"]]);
export {
