import { aB as openBlock, aG as createElementBlock, aF as createBaseVNode, az as ref, bb as watch, aW as computed, aC as createBlock, aD as withCtx, aE as createVNode, aH as createCommentVNode, aN as toDisplayString, aK as Fragment, aJ as renderList, aR as normalizeClass, a_ as withModifiers, cn as DialogTitle_default, co as DialogDescription_default, aI as reactive, aY as inject, a$ as normalizeStyle, b1 as onMounted, bU as onBeforeUnmount, cp as useFloating, cq as offset, cr as flip, cs as shift, ct as autoUpdate, aL as mergeProps, cu as toHandlers, bx as resolveDynamicComponent, aM as createTextVNode, bd as onUnmounted, bV as provide, bl as nextTick, aZ as renderSlot, aS as normalizeProps, aT as guardReactiveProps } from "./vendor-2CZqcq_N.js";
import { B as Button, _ as __unplugin_components_0 } from "./Button-L9MLNqBl.js";
import { T as TabButtons } from "./TabButtons-E0mPD8Ck.js";
import { d as dayjs } from "./dayjs-Bgw3aVwt.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { _ as __unplugin_components_1 } from "./Popover-TtdecaZK.js";
import { F as FeatherIcon } from "./FeatherIcon-5kA3siwp.js";
import { _ as __unplugin_components_1$1 } from "./Dialog-BGSaUxEs.js";
import { F as FormControl } from "./FormControl-Y_IfBKpo.js";
import { E as ErrorMessage } from "./ErrorMessage-BA2VHuQZ.js";
...
const _sfc_main$9 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, view, currentYear, currentMonth, selected, initFromValue, months, displayLabel, monthStart, weeks, selectDate, selectMonth, selectYear, prev, next, cycleView, yearRangeStart, yearRange, ref, computed, watch, get Popover() {
...
const _hoisted_1$7 = { class: "w-fit min-w-60 select-none text-base text-ink-gray-9 rounded-lg bg-surface-modal shadow-2xl ring-1 ring-black ring-opacity-5 mt-2" };
const _hoisted_2$7 = { class: "flex items-center justify-between p-2 pb-0 gap-1" };
const _hoisted_3$6 = { key: 0 };
const _hoisted_4$6 = { key: 1 };
const _hoisted_5$5 = { key: 2 };
const _hoisted_6$5 = { class: "flex items-center" };
const _hoisted_7$5 = { class: "p-2" };
const _hoisted_8$3 = { key: 0 };
const _hoisted_9$2 = { class: "flex items-center text-xs font-medium uppercase text-ink-gray-4 mb-1" };
const _hoisted_10$2 = ["onClick"];
const _hoisted_11$2 = { class: "grid grid-cols-3 gap-1" };
const _hoisted_12$2 = ["onClick"];
const _hoisted_13$1 = { class: "grid grid-cols-3 gap-1" };
  ...
  return openBlock(), createBlock($setup["Popover"], {
    ...
    body: withCtx(({ togglePopover }) => [
      createBaseVNode("div", _hoisted_1$7, [
        createCommentVNode(" Navigation / Label "),
        createBaseVNode("div", _hoisted_2$7, [
          ...
          createBaseVNode("div", _hoisted_6$5, [
            ...
            createVNode($setup["Button"], {
              ...
              label: "Today",
              onClick: () => {
                $setup.selectDate($setup.dayjs().toDate());
                togglePopover();
              }
            }, null, 8, ["onClick"]),
            createVNode($setup["Button"], {
        ...
        createBaseVNode("div", _hoisted_7$5, [
          ...
          $setup.view === "date" ? (openBlock(), createElementBlock("div", _hoisted_8$3, [
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList(week, (dateObj) => {
                      return openBlock(), createElementBlock("div", {
                        key: dateObj.key,
                        class: normalizeClass(["flex h-8 w-8 items-center justify-center rounded cursor-pointer text-sm", [
                        ...
                        onClick: () => {
                          $setup.selectDate(dateObj.date);
                          togglePopover();
                        }
                      }, toDisplayString(dateObj.date.date()), 11, _hoisted_10$2);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
                ...
                (openBlock(), createElementBlock(
                  ...
                  renderList($setup.months, (m, i) => {
                    return createBaseVNode("div", {
                      key: m,
                      class: normalizeClass(["py-2 text-sm rounded cursor-pointer text-center hover:bg-surface-gray-2", {
                        "bg-surface-gray-6 text-ink-white hover:bg-surface-gray-6": i === $setup.currentMonth
                      }]),
                      onClick: ($event) => $setup.selectMonth(i)
                    }, toDisplayString(m.slice(0, 3)), 11, _hoisted_12$2);
                  }),
                  64
                  /* STABLE_FRAGMENT */
                ))
...
_sfc_main$9.__file = "src/components/Calendar/DateMonthYearPicker.vue";
const DateMonthYearPicker = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/Calendar/DateMonthYearPicker.vue"]]);
const _sfc_main$8 = {
...
const _hoisted_1$6 = { class: "flex flex-row-reverse gap-2" };
const _hoisted_2$6 = { class: "flex flex-col gap-5" };
const _hoisted_3$5 = { class: "flex justify-between text-xl font-semibold" };
const _hoisted_4$5 = { class: "flex flex-col gap-4" };
const _hoisted_5$4 = { class: "flex items-center gap-2" };
const _hoisted_6$4 = { class: "text-sm font-normal" };
const _hoisted_7$4 = {
  key: 0,
  ...
  return openBlock(), createElementBlock("div", {
    ...
    createBaseVNode("div", _hoisted_2$6, [
      ...
      createBaseVNode("div", _hoisted_4$5, [
        ...
        $props.calendarEvent.participant ? (openBlock(), createElementBlock("div", _hoisted_7$4, [
          createVNode($setup["FeatherIcon"], {
            name: "user",
            class: "h-4 w-4"
          }),
...
const Dialog = __unplugin_components_1$1;
  ...
  setup(__props, { expose: __expose }) {
    ...
    function color(color2) {
      if (!(color2 == null ? void 0 : color2.startsWith("#"))) {
        return colorMap[color2] || colorMap["green"];
      }
...
const _hoisted_1$4 = { class: "relative flex h-full select-none items-start gap-2 overflow-hidden" };
const _hoisted_2$4 = { key: 0 };
const _hoisted_3$4 = { class: "flex w-fit flex-col gap-0.5 overflow-hidden" };
const _hoisted_4$4 = { class: "relative flex h-full select-none items-start gap-2 overflow-hidden" };
const _hoisted_5$3 = { key: 0 };
const _hoisted_6$3 = { class: "flex w-fit flex-col text-start overflow-hidden whitespace-nowrap" };
const _hoisted_7$3 = { class: "text-sm font-medium truncate" };
          ...
          createBaseVNode(
            ...
            [
              ...
              createBaseVNode("div", _hoisted_1$4, [
                $setup.config.showIcon && $setup.eventIcons[$setup.props.event.type] ? (openBlock(), createElementBlock("div", _hoisted_2$4, [
                ...
                createBaseVNode("div", _hoisted_3$4, [
                  createBaseVNode(
                    ...
                    {
                      ref: "eventTitleRef",
                      class: normalizeClass(["text-sm font-medium", $setup.lineClampClass])
                    },
          ...
          createBaseVNode(
            ...
            [
              ...
              createBaseVNode("div", _hoisted_4$4, [
                $setup.config.showIcon && $setup.eventIcons[$setup.props.event.type] ? (openBlock(), createElementBlock("div", _hoisted_5$3, [
                  $setup.eventIcons[$setup.props.event.type] ? (openBlock(), createBlock(resolveDynamicComponent($setup.eventIcons[$setup.props.event.type]), {
                    key: 0,
...
const CalendarEvent = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$6], ["__scopeId", "data-v-ee68fbdc"], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/Calendar/CalendarEvent.vue"]]);
const _sfc_main$5 = {
...
const _hoisted_2$3 = { class: "grid w-full grid-cols-7" };
const _hoisted_3$3 = { class: "inline-flex items-center justify-center text-base text-ink-gray-6 h-8" };
const _hoisted_4$3 = ["onDrop", "onClick"];
const _hoisted_5$2 = { class: "flex gap-0.5 w-full flex-col items-center text-xs text-right" };
...
const _hoisted_1$2 = { class: "flex flex-1 flex-col overflow-y-auto" };
const _hoisted_2$2 = { class: "flex border-b-[1px]" };
const _hoisted_3$2 = { class: "grid w-full grid-cols-7" };
const _hoisted_4$2 = ["onClick"];
const _hoisted_5$1 = {
  key: 0,
  class: "inline-flex items-center justify-center bg-surface-gray-7 text-ink-white rounded size-[25px]"
};
const _hoisted_6$1 = { class: "flex justify-center items-start py-0.5 w-20 text-base text-ink-gray-6 text-center" };
const _hoisted_7$1 = { class: "grid w-full grid-cols-7 overflow-hidden" };
...
const _hoisted_1$1 = { class: "flex flex-col flex-1 overflow-y-auto" };
const _hoisted_2$1 = { class: "flex justify-center items-start pt-[3px] w-20 text-base text-ink-gray-6 text-center" };
const _hoisted_3$1 = ["data-date-attr"];
const _hoisted_4$1 = { class: "h-full overflow-hidden" };
const _hoisted_5 = { class: "grid h-full w-20 grid-cols-1" };
const _hoisted_6 = { class: "grid h-full w-full grid-cols-1 pb-2" };
const _hoisted_7 = ["data-time-attr", "onClick"];
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, defaultConfig, overrideConfig, get activeView() {
      ...
      return dayjs;
    }, DayIcon, WeekIcon, MonthIcon, DateMonthYearPicker, CalendarMonthly, CalendarWeekly, CalendarDaily, NewEventModal, get useEventModal() {
    ...
    renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({
      ...
      createBaseVNode("div", _hoisted_2, [
        ...
        createBaseVNode("div", _hoisted_3, [
          createVNode($setup["DateMonthYearPicker"], {
            modelValue: $setup.selectedMonthDate,
            formatter: () => $setup.currentMonthYear,
