import { aK as markRaw, aD as openBlock, aL as createElementBlock, aI as createBaseVNode, ay as _export_sfc, az as defineComponent, aM as mergeModels, aN as useModel, aO as computed, aP as renderSlot, aE as createBlock, aQ as normalizeClass, aR as resolveDynamicComponent, aS as createCommentVNode, aJ as toDisplayString, aH as createVNode, aA as ref, aC as resolveComponent, aF as withCtx, aT as createTextVNode } from "./vendor-DDczFkrz.js";
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  emits: /* @__PURE__ */ mergeModels(["dismiss"], ["update:modelValue"]),
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const props = __props;
    const __returned__ = { visible, emit, dismissAlert, classes, icon, props, get LucideX() {
      return LucideX;
    } };
