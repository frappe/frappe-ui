const __resolved__virtual_storySource_srcComponentsComboboxComboboxStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsComboboxComboboxStoryVue as default
};
