...
const commands = {
  ...
  FontColor: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./FontColor-Bc0x3-XD.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0))
  },
  Blockquote: {
    label: "Blockquote",
    icon: DoubleQuotes,
  ...
  Link: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertLink-wdvGltes.js"), true ? __vite__mapDeps([6,2,3]) : void 0))
  },
  Image: {
    label: "Image",
    icon: Image$2,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertImage-a_wrAwQv.js"), true ? __vite__mapDeps([7,2,3,4,5,8,9,10,11,12,13,1,14,15,16,17]) : void 0))
  },
  Video: {
    label: "Video",
    icon: Video$1,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertVideo-xJ0-995G.js"), true ? __vite__mapDeps([18,2,3]) : void 0))
  },
  Iframe: {
    label: "Embed",
    icon: GalleryVertical,
    isActive: (editor) => editor.isActive("iframe"),
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertIframe-DbPOkZ8l.js"), true ? __vite__mapDeps([19,2,3,20,17,5,10,4,21,12,8,9,11,13,1,14,15,16]) : void 0))
  },
  Undo: {
    label: "Undo",
    icon: ArrowGoBack,
