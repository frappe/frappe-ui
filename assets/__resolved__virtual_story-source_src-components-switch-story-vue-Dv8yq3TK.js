const __resolved__virtual_storySource_srcComponentsSwitchStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsSwitchStoryVue as default
};
