import{_ as v}from"./chunks/PropsTable.CdVl1Sdm.js";import{_ as g}from"./chunks/SlotsTable.Dra6Fan0.js";import{_ as b}from"./chunks/EmitsTable.DhveA4pK.js";import"./chunks/theme.CaQ7ZXrm.js";import{_ as m}from"./chunks/FunnelChart.vue_vue_type_script_setup_true_lang.BYBdraTE.js";import{J as k,ae as i,r,o as s,E as l,aG as w,F as d,D as a,aw as y,ak as z,ap as f,B as x,bf as p}from"./chunks/framework.CZ-ntRvv.js";import"./chunks/format.9CiYcFxf.js";import"./chunks/tokens.rU4hPjXc.js";import"./chunks/axisChartCommon.yXWQRveU.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.B-k8CAYg.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.cl749VzL.js";const j={class:"flex h-96 w-full flex-col gap-2"},C={class:"min-h-0 flex-1"},S={class:"text-p-sm text-ink-gray-5"},O=k({__name:"FunnelDeals",setup(o){const t=[{stage:"Leads",count:563},{stage:"Qualified",count:385},{stage:"Quotation sent",count:291},{stage:"Ready to close",count:191},{stage:"Won",count:39}],e=z(null);return(c,_)=>(i(),r("div",j,[s("div",C,[l(w(m),{data:t,category:"stage",value:"count",title:"Deal pipeline",subtitle:"Open deals by stage, this quarter",onSelect:_[0]||(_[0]=n=>e.value=n)})]),s("p",S,[e.value?(i(),r(d,{key:0},[a(" Selected "+y(e.value.label)+" · "+y(e.value.value),1)],64)):(i(),r(d,{key:1},[a("Select a stage.")],64))])]))}}),A={class:"h-80 w-full"},R=k({__name:"FunnelStages",setup(o){const t=[{stage:"Visited the store",people:106200},{stage:"Viewed a plan",people:38400},{stage:"Started checkout",people:9860},{stage:"Entered payment details",people:3410},{stage:"Active subscription",people:2560}],e=c=>new Intl.NumberFormat("en-US",{notation:"compact"}).format(c);return(c,_)=>(i(),r("div",A,[l(w(m),{data:t,category:"stage",value:"people",format:e,title:"Store visit to subscription",subtitle:"July 2026"})]))}}),W=JSON.parse('{"title":"FunnelChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/funnelchart.md","filePath":"docs/charts/funnelchart.md","lastUpdated":0}'),T={name:"docs/charts/funnelchart.md"},M=Object.assign(T,{setup(o){const t=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
