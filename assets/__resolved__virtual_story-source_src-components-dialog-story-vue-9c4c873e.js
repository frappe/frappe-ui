const __resolved__virtual_storySource_srcComponentsDialogStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsDialogStoryVue as default
};
