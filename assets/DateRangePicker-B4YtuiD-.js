import { a_ as markRaw, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, az as ref, aU as computed, ay as defineComponent, bx as onMounted, aC as createBlock, aD as withCtx, aE as createVNode, aL as mergeProps, cA as createSlots, aQ as normalizeClass, aH as createCommentVNode, aN as toDisplayString, aK as Fragment, aJ as renderList } from "./vendor-DosKO8o-.js";
import { _ as __unplugin_components_0 } from "./Button-D8peh-Cz.js";
import { _ as __unplugin_components_1 } from "./Popover-BHKar1jK.js";
import { F as FeatherIcon } from "./FeatherIcon--miOfd0O.js";
import { T as TextInput } from "./TextInput-cgKOgDRE.js";
import { d as dayjs, a as dayjsLocal, b as dayjsSystem } from "./dayjs-CF00ui8e.js";
...
const LucideCalendar = markRaw({ name: "lucide-calendar", render });
    ...
    target: withCtx(({ togglePopover }) => [
      createVNode($setup["TextInput"], mergeProps({
        ...
        !$props.hideIcon ? {
          name: "prefix",
          fn: withCtx(() => [
            createVNode($setup["LucideCalendar"], { class: "size-4" })
          ]),
          key: "0"
        } : void 0
