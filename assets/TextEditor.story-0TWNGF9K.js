...
import { L as Link$2 } from "./link-BrykjAk2.js";
import { E as ErrorMessage } from "./ErrorMessage-rgu2V8yn.js";
import { S as Select } from "./Select-rF-Ftj4X.js";
import { _ as __unplugin_components_1$1 } from "./Dialog-Ch6gkeBC.js";
const _hoisted_1$$ = {
...
const commands = {
  ...
  FontColor: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./FontColor-CSmU__wZ.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0))
  },
  Blockquote: {
    label: "Blockquote",
    icon: DoubleQuotes,
  ...
  Link: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertLink-CTse_OrR.js"), true ? __vite__mapDeps([5,2]) : void 0))
  },
  Image: {
    label: "Image",
    icon: Image$2,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertImage-CJesIt4F.js"), true ? __vite__mapDeps([6,2,3,4,7,8,9,10,11,12,13,1,14,15,16,17,18]) : void 0))
  },
  Video: {
    label: "Video",
    icon: Video$1,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertVideo-CXvYF4zc.js"), true ? __vite__mapDeps([19,2]) : void 0))
  },
  Iframe: {
    label: "Embed",
    icon: GalleryVertical,
    isActive: (editor) => editor.isActive("iframe"),
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertIframe-IVRTJ3Vb.js"), true ? __vite__mapDeps([20,2,21,18,4,10,3,22,12,7,8,9,11,13,1,14,15,16,17]) : void 0))
  },
  Undo: {
    label: "Undo",
    icon: ArrowGoBack,
