...
import { _ as __unplugin_components_1$1 } from "./Dialog-_HbeHbjI.js";
const _hoisted_1$10 = {
...
const commands = {
  ...
  FontColor: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./FontColor-2HL-3wFB.js"), true ? __vite__mapDeps([0,1,2,3,4,5]) : void 0))
  },
  Blockquote: {
    label: "Blockquote",
    icon: DoubleQuotes,
  ...
  Link: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertLink-3Yr5cH9K.js"), true ? __vite__mapDeps([6,2,3]) : void 0))
  },
  Image: {
    label: "Image",
    icon: Image$2,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertImage-DMnzdkq0.js"), true ? __vite__mapDeps([7,2,3,4,5,8,9,10,11,12,13,1,14,15,16,17]) : void 0))
  },
  Video: {
    label: "Video",
    icon: Video$1,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertVideo-CsUsnl-B.js"), true ? __vite__mapDeps([18,2,3]) : void 0))
  },
  Iframe: {
    label: "Embed",
    icon: GalleryVertical,
    isActive: (editor) => editor.isActive("iframe"),
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertIframe-ub4uFQge.js"), true ? __vite__mapDeps([19,2,3,20,17,5,10,4,21,12,8,9,11,13,1,14,15,16]) : void 0))
  },
  Undo: {
    label: "Undo",
    icon: ArrowGoBack,
