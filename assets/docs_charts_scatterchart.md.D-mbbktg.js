import{_ as xs}from"./chunks/PropsTable.-kaOPTvh.js";import{_ as js}from"./chunks/SlotsTable.DmPybdQS.js";import{_ as zs}from"./chunks/EmitsTable.NihfVewo.js";import"./chunks/theme.RDyHBhXA.js";import{_ as $,dy as Cs,z as Ss,G as As,a as Ts,P as Ps,aq as Os,b8 as Ds,b9 as Rs,b as Ls,dN as Es,cX as Is,dO as Bs}from"./chunks/useChart.LdbtNSJH.js";import{u as Ns}from"./chunks/usePlotKeyboard.BClhA5nu.js";import{t as M,c as Ms,D as Fs,B as J,A as Vs,e as qs,u as $s}from"./chunks/axisChartCommon.C8jcTdHg.js";import{a as R,d as Hs}from"./chunks/format.BQTSxjEi.js";import{p as Ws,j as os,C as Gs,c as Us,d as Ys,u as Ks,k as Zs}from"./chunks/tokens.D4EpKDGJ.js";import{p as _s,a as Xs,d as Js,b as Qs,j as sa}from"./chunks/referenceLines.UorTTDOV.js";import{t as aa,p as na}from"./chunks/hiddenSeries.BGnbo1Bl.js";import{_ as ea}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.COff-_ZT.js";import{_ as la}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.5NqNSt8u.js";import{_ as ta}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CZg-hQ3P.js";import{c as pa}from"./chunks/createSeriesData.g5P9WBsV.js";import{a as ca,i as ia,c as ra}from"./chunks/installLabelLayout.BgSk7cvt.js";import{J as L,aV as oa,b9 as Q,l as x,ae as P,p as _a,A as ss,bf as g,ao as C,a2 as as,M as ns,E as k,o as s,$ as ha,aG as T,aw as da,Z as es,ak as F,ah as ls,r as E,ap as ts,B as V,D as a}from"./chunks/framework.CZ-ntRvv.js";import"./chunks/dataStackHelper.Cx3nHaaN.js";import"./chunks/axisAlignTicks.DIB2X55U.js";import"./chunks/labelLayoutHelper.Dc3OGal5.js";import"./chunks/labelGuideHelper.6FW0qtgC.js";var ua=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n.hasSymbolVisual=!0,n}return e.prototype.getInitialData=function(n,l){return pa(null,this,{useEncodeDefaulter:!0})},e.prototype.getProgressive=function(){var n=this.option.progressive;return n??(this.option.large?5e3:this.get("progressive"))},e.prototype.getProgressiveThreshold=function(){var n=this.option.progressiveThreshold;return n??(this.option.large?1e4:this.get("progressiveThreshold"))},e.prototype.brushSelector=function(n,l,c){return c.point(l.getItemLayout(n))},e.prototype.getZLevelKey=function(){return this.getData().count()>this.getProgressiveThreshold()?this.id:""},e.type="series.scatter",e.dependencies=["grid","polar","geo","singleAxis","calendar","matrix"],e.defaultOption={coordinateSystem:"cartesian2d",z:2,legendHoverLink:!0,symbolSize:10,large:!1,largeThreshold:2e3,itemStyle:{opacity:.8},emphasis:{scale:!0},clip:!0,select:{itemStyle:{borderColor:Cs.color.primary}},universalTransition:{divideShape:"clone"}},e})(Ss),hs=4,ya=(function(){function t(){}return t})(),fa=(function(t){$(e,t);function e(n){var l=t.call(this,n)||this;return l._off=0,l.hoverDataIdx=-1,l}return e.prototype.getDefaultShape=function(){return new ya},e.prototype.reset=function(){this.notClear=!1,this._off=0},e.prototype.beforeBrush=function(n){n&&!n.contentRetained&&this.reset()},e.prototype.buildPath=function(n,l){var c=l.points,p=l.size,o=this.symbolProxy,_=o.shape,h=n.getContext?n.getContext():n,d=h&&p[0]<hs,u=this.softClipShape,y;if(d){this._ctx=h;return}for(this._ctx=null,y=this._off;y<c.length;){var v=c[y++],b=c[y++];isNaN(v)||isNaN(b)||u&&!u.contain(v,b)||(_.x=v-p[0]/2,_.y=b-p[1]/2,_.width=p[0],_.height=p[1],o.buildPath(n,_,!0))}this.incremental&&(this._off=y,this.notClear=!0)},e.prototype.afterBrush=function(){var n=this.shape,l=n.points,c=n.size,p=this._ctx,o=this.softClipShape,_;if(p){for(_=this._off;_<l.length;){var h=l[_++],d=l[_++];isNaN(h)||isNaN(d)||o&&!o.contain(h,d)||p.fillRect(h-c[0]/2,d-c[1]/2,c[0],c[1])}this.incremental&&(this._off=_,this.notClear=!0)}},e.prototype.findDataIndex=function(n,l){for(var c=this.shape,p=c.points,o=c.size,_=Math.max(o[0],4),h=Math.max(o[1],4),d=p.length/2-1;d>=0;d--){var u=d*2,y=p[u]-_/2,v=p[u+1]-h/2;if(n>=y&&l>=v&&n<=y+_&&l<=v+h)return d}return-1},e.prototype.contain=function(n,l){var c=this.transformCoordToLocal(n,l),p=this.getBoundingRect();if(n=c[0],l=c[1],p.contain(n,l)){var o=this.hoverDataIdx=this.findDataIndex(n,l);return o>=0}return this.hoverDataIdx=-1,!1},e.prototype.getBoundingRect=function(){var n=this._rect;if(!n){for(var l=this.shape,c=l.points,p=l.size,o=p[0],_=p[1],h=1/0,d=1/0,u=-1/0,y=-1/0,v=0;v<c.length;){var b=c[v++],O=c[v++];h=Math.min(b,h),u=Math.max(b,u),d=Math.min(O,d),y=Math.max(O,y)}n=this._rect=new Ts(h-o/2,d-_/2,u-h+o,y-d+_)}return n},e})(Ps),ma=(function(){function t(){this.group=new As}return t.prototype.updateData=function(e,n){this._clear(),this._data=e;var l=this._create();l.setShape({points:e.getLayout("points")}),this._setCommon(l,e,n)},t.prototype.updateLayout=function(e){var n=this._data;if(n){var l=n.getLayout("points");this.group.eachChild(function(c){if(c.startIndex!=null){var p=(c.endIndex-c.startIndex)*2,o=c.startIndex*4*2;l=new Float32Array(l.buffer,o,p)}c.setShape("points",l),c.reset(),c.stopAnimation()})}},t.prototype.incrementalPrepareUpdate=function(e){this._clear()},t.prototype.incrementalUpdate=function(e,n,l,c){var p=this._newAdded[0],o=n.getLayout("points"),_=p&&p.shape.points;if(_&&_.length<2e4){var h=_.length,d=new Float32Array(h+o.length);d.set(_),d.set(o,h),p.endIndex=e.end,p.setShape({points:d})}else{this._newAdded=[];var u=this._create();u.startIndex=e.start,u.endIndex=e.end,u.incremental=l,u.setShape({points:o}),this._setCommon(u,n,c)}},t.prototype.eachRendered=function(e){this._newAdded[0]&&e(this._newAdded[0])},t.prototype._create=function(){var e=new fa({cursor:"default"});return e.ignoreCoarsePointer=!0,this.group.add(e),this._newAdded.push(e),e},t.prototype._setCommon=function(e,n,l){var c=n.hostModel;l=l||{};var p=n.getVisual("symbolSize");e.setShape("size",p instanceof Array?p:[p,p]),e.softClipShape=l.clipShape||null,e.symbolProxy=Os(n.getVisual("symbol"),0,0,0,0),e.setColor=e.symbolProxy.setColor;var o=e.shape.size[0]<hs;e.useStyle(c.getModel("itemStyle").getItemStyle(o?["color","shadowBlur","shadowColor"]:["color"]));var _=n.getVisual("style"),h=_&&_.fill;h&&e.setColor(h);var d=Ds(e);d.seriesIndex=c.seriesIndex,e.on("mousemove",function(u){d.dataIndex=null;var y=e.hoverDataIdx;y>=0&&(d.dataIndex=y+(e.startIndex||0))})},t.prototype.remove=function(){this._clear()},t.prototype._clear=function(){this._newAdded=[],this.group.removeAll()},t})(),wa=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n}return e.prototype.render=function(n,l,c){var p=n.getData(),o=this._updateSymbolDraw(p,n);o.updateData(p,q(n)),this._finished=!0},e.prototype.incrementalPrepareRender=function(n,l,c){var p=n.getData(),o=this._updateSymbolDraw(p,n);o.incrementalPrepareUpdate(p),this._finished=!1},e.prototype.incrementalRender=function(n,l,c){this._symbolDraw.incrementalUpdate(n,l.getData(),Rs(l),q(l)),this._finished=n.end===l.getData().count()},e.prototype.updateTransform=function(n,l,c){var p=n.getData();if(this.group.dirty(),this._finished){var o=_s("").reset(n,l,c);o.progress&&o.progress({start:0,end:p.count(),count:p.count()},p),this._symbolDraw.updateLayout(q(n))}else return{update:!0}},e.prototype.eachRendered=function(n){this._symbolDraw&&this._symbolDraw.eachRendered(n)},e.prototype._updateSymbolDraw=function(n,l){var c=this._symbolDraw,p=l.pipelineContext,o=p.large;return(!c||o!==this._isLargeDraw)&&(c&&c.remove(),c=this._symbolDraw=o?new ma:new Xs,this._isLargeDraw=o,this.group.removeAll()),this.group.add(c.group),c},e.prototype.remove=function(n,l){this._symbolDraw&&this._symbolDraw.remove(!0),this._symbolDraw=null},e.prototype.dispose=function(){},e.type="scatter",e})(Ls);function q(t){return{clipShape:Js(t)}}function va(t){Es(ca),t.registerSeriesModel(ua),t.registerChartView(wa),t.registerLayout(_s("scatter"))}const ga="categorical",A=10,ps=35,cs=.75,is="6%";function ds(t,{tokens:e}){const n=t.data??[],l=[],c=new Map,p=[];for(const h of n){const d=M(h[t.xColumn]),u=M(h[t.yColumn]);if(d===null||u===null)continue;const y=ka(t,h);let v=c.get(y);v||(v=[],l.push(y),c.set(y,v));const b=t.sizeColumn?M(h[t.sizeColumn]):null;b!==null&&p.push(b),v.push({x:d,y:u,size:b,label:xa(t,h),row:h})}const o=ja(p,!!t.sizeColumn),_=Ws(t.palette,e,l.length,ga);return l.map((h,d)=>({name:h,label:R(h),color:_[d],points:c.get(h).map(u=>({...u,symbolSize:o(u.size)}))}))}const ba="(Blank)";function ka(t,e){if(!t.splitByColumn)return t.yColumn;const n=e[t.splitByColumn];return n==null||n===""?ba:String(n)}function xa(t,e){if(!t.labelColumn)return;const n=e[t.labelColumn];return n==null?void 0:String(n)}function ja(t,e){if(!e)return()=>A;const n=za(t);return l=>l===null?A:n(l)}function za(t){let e=1/0,n=-1/0;for(const c of t)c<e&&(e=c),c>n&&(n=c);if(e===n){const c=(A+ps)/2;return()=>c}const l=ps-A;return c=>A+(c-e)/(n-e)*l}function Ca(t,e){const{tokens:n,hiddenSeries:l=[],format:c}=e,p=t.dir==="rtl",_=ds(t,e).filter(u=>!l.includes(u.name)),h=Aa(t),d={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:Gs},grid:Ms({horizontal:!1,isRTL:p,labelGutter:0}),xAxis:rs(t.xAxis,n,{horizontal:!0,isRTL:p,format:c?.x,name:t.xAxis?.title}),yAxis:rs(t.yAxis,n,{horizontal:!1,isRTL:p,format:c?.y}),series:[..._.map(u=>Ta(u,{tokens:n,isRTL:p,showLabels:h})),...Qs(Sa(t),{tokens:n,horizontal:!1,hasSecondaryValueAxis:!1,hasCategoryAxis:!1,hostSeriesType:"scatter"})]};return os(d,t.echartOptions)}function Sa(t){const e=t.referenceLines;return e?.filter(n=>n.axis==="y2").length,e}function Aa(t){return t.showDataLabels?!!t.labelColumn:!1}function Ta(t,e){const{tokens:n,isRTL:l,showLabels:c}=e;return{type:"scatter",name:t.name,data:t.points.map(p=>({value:[p.x,p.y],symbolSize:p.symbolSize,...c?{name:p.label??""}:{}})),symbol:"circle",itemStyle:{color:t.color,opacity:cs,borderWidth:0},emphasis:{focus:"series",blurScope:"coordinateSystem"},blur:{itemStyle:{opacity:cs*J},label:{opacity:J}},...c?{label:{show:!0,position:l?"left":"right",color:n.dataLabel,fontSize:Fs,formatter:p=>String(p?.name??"")},labelLayout:{hideOverlap:!0}}:{}}}function rs(t,e,n){const{horizontal:l,isRTL:c,format:p,name:o}=n,_=os({scale:!0,boundaryGap:[is,is],...o?{name:R(o),nameLocation:"end",nameGap:8,nameTextStyle:{color:e.axisTitle,fontSize:Vs}}:{},...p?{axisLabel:{formatter:h=>p(Number(h))}}:{}},t?.echartOptions);return qs({...t,echartOptions:_},e,{horizontal:l,isRTL:c})}const Pa=["aria-label"],Oa={class:"sr-only",role:"status"},H=L({__name:"ScatterChart",props:es({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},x:{},y:{},size:{},splitBy:{},hiddenSeries:{},label:{},showDataLabels:{type:Boolean},xAxis:{},yAxis:{},palette:{},referenceLines:{},format:{type:Function},echartOptions:{}},{hiddenSeries:{default:()=>[]},hiddenSeriesModifiers:{}}),emits:es(["update:hiddenSeries","select"],["update:hiddenSeries"]),setup(t,{expose:e,emit:n}){Is([va,ia,sa,ra]);const l=t,c=oa(t,"hiddenSeries"),p=n,o=F(),_=x(()=>l.dir??Ys()),h=x(()=>l.xAxis?.format??l.format),d=x(()=>l.yAxis?.format??l.format),u=x(()=>({data:l.data,xColumn:l.x,yColumn:l.y,sizeColumn:l.size,splitByColumn:l.splitBy,labelColumn:l.label,showDataLabels:l.showDataLabels,xAxis:y(l.xAxis),yAxis:y(l.yAxis),referenceLines:l.referenceLines,palette:l.palette,dir:_.value,echartOptions:l.echartOptions}));function y(i){if(i)return{title:i.title,min:i.min,max:i.max,echartOptions:i.echartOptions}}const{tokens:v}=Ks(o),b=x(()=>ds(u.value,{tokens:v.value})),O=x(()=>b.value.every(i=>!i.points.length)),us=x(()=>l.yAxis?.title?R(l.yAxis.title):void 0),W=x(()=>{try{return{option:Ca(u.value,{tokens:v.value,hiddenSeries:c.value,format:{x:h.value,y:d.value}}),error:null}}catch(i){return{option:void 0,error:i?.message??String(i)}}}),ys=x(()=>W.value.error),z=ls({x:0,y:0}),f=ls({open:!1,x:0,y:0,label:void 0,items:[],rows:[]}),{chart:G,dispatch:D}=Bs({container:o,option:()=>W.value.option,events:{mouseover:i=>fs(i),mouseout:()=>f.open=!1,click:i=>{const r=U(i);r&&p("select",{name:r.series.name,x:r.point.x,y:r.point.y,size:r.point.size,label:r.point.label,row:r.point.row})}},onZrEvents:{mousemove:i=>{z.x=i.event?.clientX??z.x,z.y=i.event?.clientY??z.y,f.open&&(f.x=z.x,f.y=z.y)},globalout:()=>f.open=!1}});function U(i){const r=b.value.find(m=>m.name===i?.seriesName),w=r?.points[i?.dataIndex];return r&&w?{series:r,point:w}:void 0}function fs(i){const r=U(i);if(!r){f.open=!1;return}Y(r,z.x,z.y)}function Y(i,r,w){const{series:m,point:j}=i,ks=[j.label,l.splitBy?m.label:void 0].filter(Boolean).join(" · ");f.label=ks||void 0,f.items=[I(l.x,j.x,h.value,m.color),I(l.y,j.y,d.value,m.color),...l.size&&j.size!==null?[I(l.size,j.size,l.format,m.color)]:[]],f.rows=[j.row],f.x=r,f.y=w,f.open=!0}function I(i,r,w,m){return{name:i,label:R(i),color:m,value:r,formattedValue:w?w(r):Hs(r),kind:"series"}}const K=x(()=>b.value.map(i=>({name:i.name,label:i.label,color:i.color,hidden:c.value.includes(i.name)})));function ms(i){c.value=aa(c.value,i,b.value.length)}const Z=F(null);function ws(i){Z.value=i}Q(Z,(i,r)=>{r&&D({type:"downplay",seriesName:r}),i&&!c.value.includes(i)&&D({type:"highlight",seriesName:i})});const B=F(""),S=x(()=>b.value.filter(i=>!c.value.includes(i.name)).flatMap((i,r)=>i.points.map((w,m)=>({entry:i,point:w,seriesIndex:r,dataIndex:m}))));function vs(i,r){const w=o.value;if(!w)return;const m=w.getBoundingClientRect(),j=G.value?.convertToPixel({gridIndex:0},[i,r]);return!j||j.some(N=>typeof N!="number"||isNaN(N))?{x:m.left+m.width/2,y:m.top+m.height/2}:{x:m.left+j[0],y:m.top+j[1]}}function gs(i){const r=S.value[i];if(!r)return;const w=vs(r.point.x,r.point.y);D({type:"highlight",seriesIndex:r.seriesIndex,dataIndex:r.dataIndex}),Y({series:r.entry,point:r.point},w?.x??z.x,w?.y??z.y),B.value=Zs(f.label,f.items.map(m=>({label:m.label,value:m.formattedValue})))}function X(i){const r=i===null?void 0:S.value[i];r&&D({type:"downplay",seriesIndex:r.seriesIndex,dataIndex:r.dataIndex})}$s({plot:o,data:()=>S.value,close:()=>{f.open=!1}});const bs=Ns({marks:()=>S.value,key:i=>`${i.entry.name} ${i.point.x} ${i.point.y}`,move:(i,r)=>{X(r),gs(i)},activate:i=>{const r=S.value[i];r&&p("select",{name:r.entry.name,x:r.point.x,y:r.point.y,size:r.point.size,label:r.point.label,row:r.point.row})},clear:i=>{X(i),f.open=!1,B.value=""}}).attrs;return Q(()=>b.value.map(i=>i.name),i=>{c.value=na(c.value,i)}),e({chart:x(()=>G.value)}),(i,r)=>(P(),_a(ea,{title:t.title,subtitle:t.subtitle,"y-axis-title":us.value,loading:t.loading,error:t.error||ys.value,empty:O.value,dir:_.value},ss({default:g(()=>[s("div",ha({ref_key:"plotEl",ref:o,class:"h-full w-full rounded-2 focus-visible:focus-ring",dir:"ltr",role:"img","aria-label":T(Us)(t.title,t.subtitle)},T(bs)),null,16,Pa),s("span",Oa,da(B.value),1),k(ta,{open:f.open,x:f.x,y:f.y,label:f.label,items:f.items,rows:f.rows,dir:_.value},ss({_:2},[i.$slots.tooltip?{name:"default",fn:g(w=>[C(i.$slots,"tooltip",as(ns(w)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","rows","dir"])]),_:2},[i.$slots.actions?{name:"actions",fn:g(()=>[C(i.$slots,"actions")]),key:"0"}:void 0,i.$slots["title-suffix"]?{name:"title-suffix",fn:g(()=>[C(i.$slots,"title-suffix")]),key:"1"}:void 0,i.$slots.loading?{name:"loading",fn:g(()=>[C(i.$slots,"loading")]),key:"2"}:void 0,i.$slots.error?{name:"error",fn:g(w=>[C(i.$slots,"error",as(ns(w)))]),key:"3"}:void 0,i.$slots.empty?{name:"empty",fn:g(()=>[C(i.$slots,"empty")]),key:"4"}:void 0,K.value.length>1?{name:"legend",fn:g(()=>[k(la,{items:K.value,onChange:ms,onHighlight:ws},null,8,["items"])]),key:"5"}:void 0]),1032,["title","subtitle","y-axis-title","loading","error","empty","dir"]))}}),Da={class:"h-80 w-full"},Ra=L({__name:"ScatterQuadrants",setup(t){const e=[{product:"Payroll",growth:34,margin:62},{product:"Invoicing",growth:12,margin:71},{product:"CRM",growth:41,margin:48},{product:"Helpdesk",growth:27,margin:55},{product:"Inventory",growth:8,margin:44},{product:"Insights",growth:52,margin:39},{product:"Field service",growth:6,margin:58},{product:"Point of sale",growth:19,margin:33}],n=l=>`${l}%`;return(l,c)=>(P(),E("div",Da,[k(T(H),{data:e,x:"growth",y:"margin",label:"product","show-data-labels":"","x-axis":{title:"Growth",format:n},"y-axis":{title:"Margin",format:n},"reference-lines":[{value:25,axis:"x",label:"Median growth",dashed:!0},{value:50,axis:"y",label:"Median margin",dashed:!0}],title:"Growth against margin",subtitle:"Median lines divide the plot into four"},null,8,["x-axis","y-axis"])]))}}),La={class:"h-96 w-full"},Ea=L({__name:"ScatterMarkets",setup(t){const e=[{market:"Germany",arpu:61,retention:88,seats:14200,region:"EMEA"},{market:"France",arpu:54,retention:82,seats:9100,region:"EMEA"},{market:"UAE",arpu:72,retention:79,seats:2600,region:"EMEA"},{market:"Nigeria",arpu:21,retention:74,seats:4800,region:"EMEA"},{market:"India",arpu:18,retention:91,seats:38400,region:"APAC"},{market:"Japan",arpu:68,retention:94,seats:7300,region:"APAC"},{market:"Australia",arpu:59,retention:85,seats:5200,region:"APAC"},{market:"Singapore",arpu:77,retention:81,seats:1900,region:"APAC"},{market:"United States",arpu:74,retention:87,seats:41500,region:"Americas"},{market:"Canada",arpu:63,retention:89,seats:8600,region:"Americas"},{market:"Brazil",arpu:26,retention:71,seats:12800,region:"Americas"},{market:"Mexico",arpu:31,retention:76,seats:6400,region:"Americas"}];return(n,l)=>(P(),E("div",La,[k(T(H),{data:e,x:"arpu",y:"retention",size:"seats","split-by":"region",label:"market","x-axis":{title:"ARPU",format:c=>`$${c}`},"y-axis":{title:"Retention",format:c=>`${c}%`},title:"Revenue per seat against retention",subtitle:"Bubble size is the number of seats"},null,8,["x-axis","y-axis"])]))}}),Ia={class:"h-80 w-full"},Ba=L({__name:"ScatterSpend",setup(t){const e=[{account:"Acme",spend:4200,revenue:12400},{account:"Globex",spend:9100,revenue:24200},{account:"Initech",spend:2200,revenue:3100},{account:"Umbrella",spend:7400,revenue:9600},{account:"Soylent",spend:5600,revenue:18800},{account:"Hooli",spend:12800,revenue:21400},{account:"Vehement",spend:1800,revenue:6200},{account:"Massive Dynamic",spend:10400,revenue:34600},{account:"Stark",spend:6800,revenue:7400},{account:"Wayne",spend:3100,revenue:11200}],n=l=>`$${new Intl.NumberFormat("en-US").format(l)}`;return(l,c)=>(P(),E("div",Ia,[k(T(H),{data:e,x:"spend",y:"revenue",label:"account","x-axis":{title:"Acquisition spend"},"y-axis":{title:"Revenue"},format:n,title:"Spend against revenue",subtitle:"Ten largest accounts, last quarter"})]))}}),cn=JSON.parse('{"title":"ScatterChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/scatterchart.md","filePath":"docs/charts/scatterchart.md","lastUpdated":0}'),Na={name:"docs/charts/scatterchart.md"},rn=Object.assign(Na,{setup(t){const e=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),k(js,{data:n}),k(zs,{data:l})])}}});export{cn as __pageData,rn as default};
