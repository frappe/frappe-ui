const __resolved__virtual_storySource_srcComponentsProgressStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsProgressStoryVue as default
};
