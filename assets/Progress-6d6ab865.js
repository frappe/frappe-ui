import { ay as defineComponent, bb as computed, aB as openBlock, aG as createElementBlock, aN as toDisplayString, aK as Fragment, aH as createCommentVNode, aF as createBaseVNode, aT as renderSlot, aY as normalizeStyle, aJ as renderList, aW as normalizeClass } from "./vendor-0ab666a3.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const indicatorContainerClasses = computed(() => {
      ...
      const layoutClasses = props.intervals ? "flex space-x-1" : "relative bg-gray-100";
...
const _hoisted_5 = { class: "text-base font-medium text-gray-500" };
          ...
          (openBlock(true), createElementBlock(
            ...
            renderList($props.intervalCount, (index) => {
              return openBlock(), createElementBlock(
                "div",
                {
                  class: normalizeClass(["h-full w-full", index <= $setup.filledIntervalCount ? "bg-gray-900" : "bg-gray-100"])
                },
                null,
                2
                /* CLASS */
