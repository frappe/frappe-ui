  ...
  return openBlock(), createBlock($setup["SelectRoot"], {
    ...
    default: withCtx(() => [
      createVNode($setup["SelectTrigger"], {
        class: normalizeClass(["inline-flex items-center gap-2 outline-none text-base text-ink-gray-7 data-[placeholder]:text-ink-gray-4 data-[disabled]:text-ink-gray-4", $setup.selectClasses]),
