const __resolved__virtual_storySource_srcComponentsChartsChartsStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsChartsChartsStoryVue as default
};
