const __resolved__virtual_storySource_srcComponentsPopoverStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsPopoverStoryVue as default
};
