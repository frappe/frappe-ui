const __resolved__virtual_storySource_srcComponentsAutocompleteStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsAutocompleteStoryVue as default
};
