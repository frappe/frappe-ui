import { ay as defineComponent, ck as useRouter, aW as computed, cY as _sfc_main$1, cZ as _sfc_main$2, c_ as _sfc_main$3, c$ as _sfc_main$4, d0 as _sfc_main$5, d1 as _sfc_main$6, d2 as _sfc_main$7, d3 as _sfc_main$8, d4 as _sfc_main$9, aB as openBlock, aC as createBlock, aD as withCtx, aE as createVNode, aZ as renderSlot, aR as normalizeProps, aL as mergeProps, aM as createTextVNode, aN as toDisplayString, aQ as normalizeClass, aG as createElementBlock, aK as Fragment, aJ as renderList, aH as createCommentVNode, bv as resolveDynamicComponent, aF as createBaseVNode } from "./vendor-Z2iXF7DR.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { router, props, handleItemClick, normalizeDropdownItem, processOptionsIntoGroups, getSubmenuGroups, filterOptions, cssClasses, groups, contentSide, contentAlign, get DropdownMenuRoot() {
      return _sfc_main$1;
  ...
  return openBlock(), createBlock($setup["DropdownMenuRoot"], null, {
    default: withCtx(({ open }) => [
      createVNode(
        ...
        {
          default: withCtx(() => [
            _ctx.$slots.default ? renderSlot(_ctx.$slots, "default", normalizeProps(mergeProps({ key: 0 }, { open })), void 0, true) : (openBlock(), createBlock(
              $setup["Button"],
              mergeProps({
                key: 1,
                active: false
