import { aA as resolveComponent, aB as openBlock, aG as createElementBlock, aN as toDisplayString, aH as createCommentVNode, aF as createBaseVNode, aC as createBlock, aW as normalizeClass, aL as mergeProps, aK as Fragment, aJ as renderList, bR as DateTime, az as ref, aQ as computed, ay as defineComponent, bu as onMounted, aD as withCtx, aE as createVNode } from "./vendor-62757db6.js";
import { B as Button } from "./Button-4f0e5e90.js";
import { P as Popover } from "./Popover-e3e5664f.js";
import { F as FeatherIcon } from "./FeatherIcon-1ee45aa8.js";
import { T as TextInput } from "./TextInput-6c1cdfaa.js";
...
function getDateValue(date) {
  if (!date || date.toString() === "Invalid Date")
    return "";
  return luxonDate(date).set({ hours: 0, minutes: 0, seconds: 0, milliseconds: 0 }).toFormat("yyyy-MM-dd");
}
...
function convertToUserTimezone(date, format = "yyyy-MM-dd HH:mm:ss") {
  var _a, _b;
  if (!date)
    return "";
  const systemTimeZone = ((_a = window.timezone) == null ? void 0 : _a.system) || null;
  const userTimeZone = ((_b = window.timezone) == null ? void 0 : _b.user) || null;
...
function convertToSystemTimezone(date, format = "yyyy-MM-dd HH:mm:ss") {
  var _a, _b;
  if (!date)
    return "";
  const systemTimeZone = ((_a = window.timezone) == null ? void 0 : _a.system) || null;
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function selectDate(date, isNow = false) {
      var _a;
      if (isNow && ((_a = window.timezone) == null ? void 0 : _a.user)) {
    ...
    const __returned__ = { props, emit, currentYear, currentMonth, today, datesAsWeeks, formattedMonth, prevMonth, nextMonth, marginClass, dateValue, selectDate, selectCurrentMonthYear, Input, get Button() {
      return Button;
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    function selectDate(date, isTimeChange = false, isNow = false) {
      ...
      if (!isTimeChange) {
        ...
        } else if (isNow && ((_a = window.timezone) == null ? void 0 : _a.user)) {
          currentDate = currentDate.setZone(window.timezone.user);
          date = luxonDate(date).set({
    ...
    onMounted(() => selectCurrentMonthYear());
    const __returned__ = { props, emit, currentYear, currentMonth, today, datesAsWeeks, formattedMonth, prevMonth, nextMonth, marginClass, hour, minute, second, dateValue, changeTime, selectDate, toValue, twoDigit, updateDate, selectCurrentMonthYear, Input, get Button() {
      return Button;
    }, Popover, FeatherIcon, TextInput, get getDate() {
      return getDate;
    } };
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    onMounted(() => selectCurrentMonthYear());
    const __returned__ = { props, emit, currentYear, currentMonth, today, datesAsWeeks, formattedMonth, prevMonth, nextMonth, marginClass, dateValue, fromDate, toDate, handleDateClick, swapDatesIfNecessary, selectDates, selectCurrentMonthYear, isInRange, formatDates, clearDates, Input, get Button() {
      return Button;
