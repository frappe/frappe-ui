import { aT as markRaw, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, ay as defineComponent, aY as inject, aC as createBlock, aD as withCtx, aQ as normalizeClass, aZ as renderSlot, aN as toDisplayString, aE as createVNode, cg as useRouter, bv as resolveDynamicComponent, aH as createCommentVNode, az as ref, aK as Fragment, aJ as renderList, bg as Transition, bU as provide, cR as useBreakpoints, cS as watchEffect, cT as breakpointsTailwind } from "./vendor-ChKKKszV.js";
import { L as LucideChevronDown } from "./chevron-down-Dj6Yn6fA.js";
import { D as Dropdown } from "./Dropdown-D7gppseh.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { _ as __unplugin_components_0$1 } from "./Button-Dy2DgMgb.js";
import { _ as __unplugin_components_0$2 } from "./Tooltip-iDjKfPdM.js";
const _hoisted_1$6 = {
...
const __unplugin_components_0 = markRaw({ name: "lucide-chevron-right", render: render$2 });
const _hoisted_1$5 = {
...
const _hoisted_1$4 = { class: "w-8 h-8 rounded bg-surface-gray-4 flex items-center justify-center text-ink-gray-7" };
const _hoisted_2$2 = { class: "text-base font-medium text-ink-gray-8 leading-none" };
const _hoisted_3$2 = { class: "mt-1 text-sm text-ink-gray-6 leading-none" };
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, isCollapsed, router, handleClick, Button: __unplugin_components_0$1, Tooltip: __unplugin_components_0$2 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, isSidebarCollapsed, isCollapsed, SidebarItem };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_LucideChevronRight = __unplugin_components_0;
    ...
    $setup.props.label ? (openBlock(), createElementBlock(
      ...
      [
        ...
        $setup.props.collapsible ? (openBlock(), createElementBlock("div", _hoisted_2, [
          !$setup.isSidebarCollapsed ? (openBlock(), createBlock(_component_LucideChevronRight, {
            key: 0,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, isCollapsed, breakpoints, isMobile, SidebarHeader, SidebarItem, get LucidePanelRightOpen() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    {
      class: normalizeClass(["flex h-full flex-col flex-shrink-0 overflow-y-auto border-r border-outline-gray-1 bg-surface-menu-bar transition-all duration-300 ease-in-out p-2", $setup.isCollapsed ? "w-12" : "w-60"])
    },
    [
      $setup.props.header ? (openBlock(), createBlock($setup["SidebarHeader"], {
        key: 0,
        isCollapsed: $setup.isCollapsed,
        title: $setup.props.header.title,
        subtitle: $setup.props.header.subtitle,
        "menu-items": $setup.props.header.menuItems
      }, null, 8, ["isCollapsed", "title", "subtitle", "menu-items"])) : createCommentVNode("v-if", true),
      (openBlock(true), createElementBlock(
        Fragment,
        null,
      ...
      createBaseVNode("div", _hoisted_1, [
        renderSlot(_ctx.$slots, "footer-items"),
        createVNode($setup["SidebarItem"], {
          label: $setup.isCollapsed ? "Expand" : "Collapse",
          isCollapsed: $setup.isCollapsed,
          onClick: _cache[0] || (_cache[0] = ($event) => $setup.isCollapsed = !$setup.isCollapsed)
        }, {
          icon: withCtx(() => [
            createVNode($setup["LucidePanelRightOpen"], {
              class: normalizeClass(["size-4 text-ink-gray-6 duration-300 ease-in-out", { "rotate-180": $setup.isCollapsed }])
            }, null, 8, ["class"])
          ]),
          _: 1
          /* STABLE */
