const __resolved__virtual_storySource_srcComponentsErrormessageStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsErrormessageStoryVue as default
};
