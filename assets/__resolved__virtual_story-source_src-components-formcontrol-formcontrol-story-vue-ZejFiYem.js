const __resolved__virtual_storySource_srcComponentsFormcontrolFormcontrolStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsFormcontrolFormcontrolStoryVue as default
};
