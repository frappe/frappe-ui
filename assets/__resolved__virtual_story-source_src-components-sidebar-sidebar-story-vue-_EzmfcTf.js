const __resolved__virtual_storySource_srcComponentsSidebarSidebarStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsSidebarSidebarStoryVue as default
};
