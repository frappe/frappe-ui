const __resolved__virtual_storySource_srcComponentsCalendarCalendarStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcComponentsCalendarCalendarStoryVue as default
};
