import{ar as De,a0 as Te,a1 as Re,a2 as Ze,aS as Ue}from"./chunks/theme.pCNutjff.js";import{y as Oe,a1 as h,o as u,l as r,u as d,an as l,aI as a,af as v,m as H,F as Ie,a8 as Ge,a6 as We,j as Ee,aa as Ne,s as V}from"./chunks/framework.B6jTn2VX.js";const Xe=`
<svg
...
`;const vf=Object.freeze(Object.defineProperty({__proto__:null,AArrowDown:Xe,AArrowUp:Ke,ALargeSmall:Je,Accessibility:Qe,Activity:$e,ActivitySquare:p0,AirVent:Ye,Airplay:to,AlarmCheck:A,AlarmClock:oo,AlarmClockCheck:A,AlarmClockMinus:z,AlarmClockOff:eo,AlarmClockPlus:b,AlarmMinus:z,AlarmPlus:b,AlarmSmoke:so,Album:ro,AlertCircle:r2,AlertOctagon:It,AlertTriangle:fe,AlignCenter:ge,AlignCenterHorizontal:io,AlignCenterVertical:no,AlignEndHorizontal:lo,AlignEndVertical:ho,AlignHorizontalDistributeCenter:co,AlignHorizontalDistributeEnd:ao,AlignHorizontalDistributeStart:wo,AlignHorizontalJustifyCenter:po,AlignHorizontalJustifyEnd:uo,AlignHorizontalJustifyStart:go,AlignHorizontalSpaceAround:vo,AlignHorizontalSpaceBetween:xo,AlignJustify:ve,AlignLeft:y,AlignRight:ue,AlignStartHorizontal:ko,AlignStartVertical:Mo,AlignVerticalDistributeCenter:fo,AlignVerticalDistributeEnd:mo,AlignVerticalDistributeStart:Co,AlignVerticalJustifyCenter:Bo,AlignVerticalJustifyEnd:jo,AlignVerticalJustifyStart:yo,AlignVerticalSpaceAround:Ho,AlignVerticalSpaceBetween:Vo,Ambulance:Ao,Ampersand:zo,Ampersands:bo,Amphora:Lo,Anchor:So,Angry:_o,Annoyed:qo,Antenna:Po,Anvil:Fo,Aperture:Do,AppWindow:To,AppWindowMac:Ro,Apple:Zo,Archive:Io,ArchiveRestore:Uo,ArchiveX:Oo,AreaChart:W,Armchair:Wo,ArrowBigDown:Eo,ArrowBigDownDash:Go,ArrowBigLeft:Xo,ArrowBigLeftDash:No,ArrowBigRight:Jo,ArrowBigRightDash:Ko,ArrowBigUp:$o,ArrowBigUpDash:Qo,ArrowDown:h1,ArrowDown01:Yo,ArrowDown10:t1,ArrowDownAZ:L,ArrowDownAz:L,ArrowDownCircle:i2,ArrowDownFromLine:e1,ArrowDownLeft:o1,ArrowDownLeftFromCircle:l2,ArrowDownLeftFromSquare:x0,ArrowDownLeftSquare:u0,ArrowDownNarrowWide:s1,ArrowDownRight:r1,ArrowDownRightFromCircle:h2,ArrowDownRightFromSquare:m0,ArrowDownRightSquare:g0,ArrowDownSquare:v0,ArrowDownToDot:i1,ArrowDownToLine:n1,ArrowDownUp:l1,ArrowDownWideNarrow:S,ArrowDownZA:_,ArrowDownZa:_,ArrowLeft:w1,ArrowLeftCircle:n2,ArrowLeftFromLine:a1,ArrowLeftRight:d1,ArrowLeftSquare:k0,ArrowLeftToLine:c1,ArrowRight:v1,ArrowRightCircle:c2,ArrowRightFromLine:p1,ArrowRightLeft:u1,ArrowRightSquare:C0,ArrowRightToLine:g1,ArrowUp:H1,ArrowUp01:k1,ArrowUp10:x1,ArrowUpAZ:q,ArrowUpAz:q,ArrowUpCircle:w2,ArrowUpDown:M1,ArrowUpFromDot:m1,ArrowUpFromLine:f1,ArrowUpLeft:C1,ArrowUpLeftFromCircle:a2,ArrowUpLeftFromSquare:M0,ArrowUpLeftSquare:B0,ArrowUpNarrowWide:P,ArrowUpRight:B1,ArrowUpRightFromCircle:d2,ArrowUpRightFromSquare:f0,ArrowUpRightSquare:j0,ArrowUpSquare:y0,ArrowUpToLine:j1,ArrowUpWideNarrow:y1,ArrowUpZA:F,ArrowUpZa:F,ArrowsUpFromLine:V1,Asterisk:A1,AsteriskSquare:H0,Astroid:b1,AtSign:z1,Atom:L1,AudioLines:S1,AudioWaveform:_1,Award:q1,Axe:P1,Axis3D:D,Axis3d:D,Baby:F1,Backpack:D1,Badge:Y1,BadgeAlert:T1,BadgeCent:R1,BadgeCheck:T,BadgeDollarSign:Z1,BadgeEuro:U1,BadgeHelp:R,BadgeIndianRupee:O1,BadgeInfo:I1,BadgeJapaneseYen:G1,BadgeMinus:E1,BadgePercent:W1,BadgePlus:N1,BadgePoundSterling:X1,BadgeQuestionMark:R,BadgeRussianRuble:K1,BadgeSwissFranc:J1,BadgeTurkishLira:Q1,BadgeX:$1,BaggageClaim:ts,Balloon:es,Ban:os,Banana:ss,Bandage:rs,Banknote:hs,BanknoteArrowDown:is,BanknoteArrowUp:ns,BanknoteX:ls,BarChart:Y,BarChart2:t2,BarChart3:$,BarChart4:J,BarChartBig:K,BarChartHorizontal:X,BarChartHorizontalBig:E,Barcode:as,Barrel:ds,Baseline:ws,Bath:cs,Battery:Ms,BatteryCharging:ps,BatteryFull:us,BatteryLow:gs,BatteryMedium:vs,BatteryPlus:ks,BatteryWarning:xs,Beaker:ms,Bean:Cs,BeanOff:fs,Bed:Hs,BedDouble:Bs,BedSingle:js,Beef:Vs,BeefOff:ys,Beer:As,BeerOff:zs,Bell:Ds,BellCheck:bs,BellDot:Ls,BellElectric:qs,BellMinus:Ss,BellOff:_s,BellPlus:Ps,BellRing:Fs,BetweenHorizonalEnd:U,BetweenHorizonalStart:Z,BetweenHorizontalEnd:U,BetweenHorizontalStart:Z,BetweenVerticalEnd:Ts,BetweenVerticalStart:Rs,BicepsFlexed:Zs,Bike:Us,Binary:Os,Binoculars:Is,Biohazard:Gs,Bird:Ws,Birdhouse:Es,Bitcoin:Ns,Blend:Xs,Blender:Ks,Blinds:Js,Blocks:Qs,Bluetooth:or,BluetoothConnected:Ys,BluetoothOff:$s,BluetoothSearching:tr,Bold:er,Bolt:sr,Bomb:rr,Bone:ir,Book:br,BookA:nr,BookAlert:lr,BookAudio:hr,BookCheck:ar,BookCopy:dr,BookDashed:O,BookDown:cr,BookHeadphones:wr,BookHeart:pr,BookImage:gr,BookKey:ur,BookLock:vr,BookMarked:kr,BookMinus:xr,BookOpen:fr,BookOpenCheck:Mr,BookOpenText:mr,BookPlus:Cr,BookSearch:Br,BookTemplate:O,BookText:jr,BookType:yr,BookUp:Vr,BookUp2:Hr,BookUser:Ar,BookX:zr,Bookmark:Fr,BookmarkCheck:Lr,BookmarkMinus:Sr,BookmarkOff:_r,BookmarkPlus:qr,BookmarkX:Pr,BoomBox:Dr,Bot:Zr,BotMessageSquare:Tr,BotOff:Rr,BottleWine:Ur,BowArrow:Ir,Box:Or,BoxSelect:R0,Boxes:Gr,Braces:I,Brackets:Wr,Brain:Kr,BrainCircuit:Er,BrainCog:Nr,BrickWall:Qr,BrickWallFire:Xr,BrickWallShield:Jr,Briefcase:ei,BriefcaseBusiness:$r,BriefcaseConveyorBelt:Yr,BriefcaseMedical:ti,BringToFront:oi,Broccoli:ni,Brush:ri,BrushCleaning:si,Bubbles:ii,Bug:di,BugOff:li,BugPlay:hi,Building:ai,Building2:ci,Bus:pi,BusFront:wi,Cable:gi,CableCar:ui,Cake:ki,CakeSlice:vi,Calculator:xi,Calendar:Ri,Calendar1:Mi,CalendarArrowDown:mi,CalendarArrowUp:fi,CalendarCheck:Bi,CalendarCheck2:Ci,CalendarClock:ji,CalendarCog:yi,CalendarDays:Hi,CalendarFold:Vi,CalendarHeart:Ai,CalendarMinus:bi,CalendarMinus2:zi,CalendarOff:Li,CalendarPlus:Si,CalendarPlus2:_i,CalendarRange:qi,CalendarSearch:Pi,CalendarSync:Fi,CalendarX:Ti,CalendarX2:Di,Calendars:Zi,Camera:Oi,CameraOff:Ui,CandlestickChart:N,Candy:Wi,CandyCane:Ii,CandyOff:Gi,Cannabis:Ni,CannabisOff:Ei,Captions:G,CaptionsOff:Xi,Car:Qi,CarFront:Ki,CarTaxiFront:Ji,Caravan:$i,CardSim:Yi,Carrot:en,CaseLower:tn,CaseSensitive:on,CaseUpper:sn,CassetteTape:nn,Cast:rn,Castle:ln,Cat:hn,Cctv:an,CctvOff:dn,ChartArea:W,ChartBar:X,ChartBarBig:E,ChartBarDecreasing:cn,ChartBarIncreasing:wn,ChartBarStacked:pn,ChartCandlestick:N,ChartColumn:$,ChartColumnBig:K,ChartColumnDecreasing:un,ChartColumnIncreasing:J,ChartColumnStacked:gn,ChartGantt:vn,ChartLine:Q,ChartNetwork:kn,ChartNoAxesColumn:t2,ChartNoAxesColumnDecreasing:xn,ChartNoAxesColumnIncreasing:Y,ChartNoAxesCombined:Mn,ChartNoAxesGantt:e2,ChartPie:o2,ChartScatter:s2,ChartSpline:mn,Check:Bn,CheckCheck:fn,CheckCircle:p2,CheckCircle2:u2,CheckLine:Cn,CheckSquare:b0,CheckSquare2:L0,ChefHat:jn,Cherry:yn,ChessBishop:Hn,ChessKing:Vn,ChessKnight:An,ChessPawn:zn,ChessQueen:bn,ChessRook:Ln,ChevronDown:Sn,ChevronDownCircle:g2,ChevronDownSquare:S0,ChevronFirst:_n,ChevronLast:qn,ChevronLeft:Pn,ChevronLeftCircle:v2,ChevronLeftSquare:_0,ChevronRight:Fn,ChevronRightCircle:k2,ChevronRightSquare:q0,ChevronUp:Dn,ChevronUpCircle:x2,ChevronUpSquare:P0,ChevronsDown:Rn,ChevronsDownUp:Tn,ChevronsLeft:On,ChevronsLeftRight:Un,ChevronsLeftRightEllipsis:Zn,ChevronsRight:Gn,ChevronsRightLeft:In,ChevronsUp:En,ChevronsUpDown:Wn,Church:Nn,Cigarette:Kn,CigaretteOff:Xn,Circle:dl,CircleAlert:r2,CircleArrowDown:i2,CircleArrowLeft:n2,CircleArrowOutDownLeft:l2,CircleArrowOutDownRight:h2,CircleArrowOutUpLeft:a2,CircleArrowOutUpRight:d2,CircleArrowRight:c2,CircleArrowUp:w2,CircleCheck:u2,CircleCheckBig:p2,CircleChevronDown:g2,CircleChevronLeft:v2,CircleChevronRight:k2,CircleChevronUp:x2,CircleDashed:Jn,CircleDivide:M2,CircleDollarSign:Qn,CircleDot:Yn,CircleDotDashed:$n,CircleEllipsis:tl,CircleEqual:el,CircleFadingArrowUp:ol,CircleFadingPlus:sl,CircleGauge:m2,CircleHelp:k,CircleMinus:f2,CircleOff:rl,CircleParking:B2,CircleParkingOff:C2,CirclePause:j2,CirclePercent:y2,CirclePile:il,CirclePlay:H2,CirclePlus:V2,CirclePoundSterling:nl,CirclePower:A2,CircleQuestionMark:k,CircleSlash:ll,CircleSlash2:z2,CircleSlashed:z2,CircleSmall:hl,CircleStar:al,CircleStop:b2,CircleUser:L2,CircleUserRound:S2,CircleX:_2,CircuitBoard:cl,Citrus:wl,Clapperboard:pl,Clipboard:Bl,ClipboardCheck:ul,ClipboardClock:gl,ClipboardCopy:vl,ClipboardEdit:P2,ClipboardList:kl,ClipboardMinus:xl,ClipboardPaste:Ml,ClipboardPen:P2,ClipboardPenLine:q2,ClipboardPlus:ml,ClipboardSignature:q2,ClipboardType:fl,ClipboardX:Cl,Clock:Ol,Clock1:yl,Clock10:jl,Clock11:Hl,Clock12:Vl,Clock2:Al,Clock3:bl,Clock4:zl,Clock5:Ll,Clock6:Sl,Clock7:_l,Clock8:ql,Clock9:Pl,ClockAlert:Fl,ClockArrowDown:Tl,ClockArrowUp:Dl,ClockCheck:Rl,ClockFading:Zl,ClockPlus:Ul,ClosedCaption:Il,Cloud:lh,CloudAlert:Gl,CloudBackup:El,CloudCheck:Wl,CloudCog:Nl,CloudDownload:F2,CloudDrizzle:Xl,CloudFog:Kl,CloudHail:Jl,CloudLightning:Ql,CloudMoon:Yl,CloudMoonRain:$l,CloudOff:th,CloudRain:oh,CloudRainWind:eh,CloudSnow:sh,CloudSun:ih,CloudSunRain:rh,CloudSync:nh,CloudUpload:D2,Cloudy:hh,Clover:ah,Club:dh,Code:ch,Code2:T2,CodeSquare:F0,CodeXml:T2,Coffee:wh,Cog:ph,Coins:uh,Columns:R2,Columns2:R2,Columns3:Z2,Columns3Cog:x,Columns4:gh,ColumnsSettings:x,Combine:vh,Command:xh,Compass:kh,Component:Mh,Computer:mh,ConciergeBell:fh,Cone:Ch,Construction:Bh,Contact:jh,Contact2:U2,ContactRound:U2,Container:yh,Contrast:Hh,Cookie:Ah,CookingPot:Vh,Copy:Ph,CopyCheck:zh,CopyMinus:bh,CopyPlus:Lh,CopySlash:_h,CopyX:Sh,Copyleft:qh,Copyright:Fh,CornerDownLeft:Dh,CornerDownRight:Th,CornerLeftDown:Rh,CornerLeftUp:Zh,CornerRightDown:Uh,CornerRightUp:Oh,CornerUpLeft:Ih,CornerUpRight:Wh,Cpu:Gh,CreativeCommons:Nh,CreditCard:Eh,Croissant:Xh,Crop:Kh,Cross:Jh,Crosshair:Qh,Crown:$h,Cuboid:Yh,CupSoda:ta,CurlyBraces:I,Currency:ea,Cylinder:sa,Dam:oa,Database:la,DatabaseBackup:ra,DatabaseSearch:ia,DatabaseZap:na,DecimalsArrowLeft:ha,DecimalsArrowRight:aa,Delete:da,Dessert:ca,Diameter:wa,Diamond:ga,DiamondMinus:pa,DiamondPercent:O2,DiamondPlus:ua,Dice1:va,Dice2:ka,Dice3:xa,Dice4:Ma,Dice5:ma,Dice6:fa,Dices:Ca,Diff:Ba,Disc:Va,Disc2:ja,Disc3:ya,DiscAlbum:Ha,Divide:Aa,DivideCircle:M2,DivideSquare:Z0,Dna:ba,DnaOff:za,Dock:La,Dog:Sa,DollarSign:_a,Donut:qa,DoorClosed:Fa,DoorClosedLocked:Pa,DoorOpen:Da,Dot:Ta,DotSquare:U0,Download:Ra,DownloadCloud:F2,DraftingCompass:Ua,Drama:Za,Drill:Oa,Drone:Ia,Droplet:Wa,DropletOff:Ga,Droplets:Ea,Drum:Na,Drumstick:Xa,Dumbbell:Ka,Ear:Ja,EarOff:Qa,Earth:I2,EarthLock:$a,Eclipse:td,Edit:p,Edit2:e0,Edit3:t0,Egg:ed,EggFried:od,EggOff:Ya,Ellipse:sd,Ellipsis:W2,EllipsisVertical:G2,Equal:nd,EqualApproximately:rd,EqualNot:id,EqualSquare:O0,Eraser:hd,EthernetPort:ld,Euro:ad,EvCharger:cd,Expand:dd,ExternalLink:wd,Eye:gd,EyeClosed:pd,EyeOff:ud,Factory:vd,Fan:kd,FastForward:xd,Feather:Md,Fence:md,FerrisWheel:fd,File:Jd,FileArchive:Cd,FileAudio:M,FileAudio2:M,FileAxis3D:E2,FileAxis3d:E2,FileBadge:N2,FileBadge2:N2,FileBarChart:J2,FileBarChart2:Q2,FileBox:Bd,FileBraces:K2,FileBracesCorner:X2,FileChartColumn:Q2,FileChartColumnIncreasing:J2,FileChartLine:$2,FileChartPie:tt,FileCheck:jd,FileCheck2:Y2,FileCheckCorner:Y2,FileClock:yd,FileCode:Hd,FileCode2:et,FileCodeCorner:et,FileCog:ot,FileCog2:ot,FileDiff:Vd,FileDigit:Ad,FileDown:zd,FileEdit:lt,FileExclamationPoint:st,FileHeadphone:M,FileHeart:bd,FileImage:Ld,FileInput:Sd,FileJson:K2,FileJson2:X2,FileKey:rt,FileKey2:rt,FileLineChart:$2,FileLock:it,FileLock2:it,FileMinus:_d,FileMinus2:nt,FileMinusCorner:nt,FileMusic:qd,FileOutput:Pd,FilePen:lt,FilePenLine:ht,FilePieChart:tt,FilePlay:at,FilePlus:Fd,FilePlus2:dt,FilePlusCorner:dt,FileQuestion:ct,FileQuestionMark:ct,FileScan:Dd,FileSearch:Td,FileSearch2:wt,FileSearchCorner:wt,FileSignal:pt,FileSignature:ht,FileSliders:Rd,FileSpreadsheet:Zd,FileStack:Ud,FileSymlink:Od,FileTerminal:Id,FileText:Gd,FileType:Wd,FileType2:ut,FileTypeCorner:ut,FileUp:Nd,FileUser:Ed,FileVideo:at,FileVideo2:gt,FileVideoCamera:gt,FileVolume:Xd,FileVolume2:pt,FileWarning:st,FileX:Kd,FileX2:vt,FileXCorner:vt,Files:Qd,Film:$d,Filter:mt,FilterX:ft,Fingerprint:kt,FingerprintPattern:kt,FireExtinguisher:Yd,Fish:oc,FishOff:ec,FishSymbol:tc,FishingHook:rc,FishingRod:sc,Flag:hc,FlagOff:ic,FlagTriangleLeft:nc,FlagTriangleRight:lc,Flame:dc,FlameKindling:ac,Flashlight:wc,FlashlightOff:cc,FlaskConical:uc,FlaskConicalOff:pc,FlaskRound:gc,FlipHorizontal:A0,FlipHorizontal2:vc,FlipVertical:z0,FlipVertical2:kc,Flower:Mc,Flower2:xc,Focus:mc,FoldHorizontal:fc,FoldVertical:Cc,Folder:Qc,FolderArchive:Bc,FolderBookmark:jc,FolderCheck:yc,FolderClock:Hc,FolderClosed:Vc,FolderCode:Ac,FolderCog:xt,FolderCog2:xt,FolderDot:zc,FolderDown:bc,FolderEdit:Mt,FolderGit:_c,FolderGit2:Lc,FolderHeart:Sc,FolderInput:qc,FolderKanban:Pc,FolderKey:Fc,FolderLock:Dc,FolderMinus:Tc,FolderOpen:Zc,FolderOpenDot:Rc,FolderOutput:Uc,FolderPen:Mt,FolderPlus:Oc,FolderRoot:Gc,FolderSearch:Wc,FolderSearch2:Ic,FolderSymlink:Ec,FolderSync:Nc,FolderTree:Xc,FolderUp:Kc,FolderX:Jc,Folders:$c,Footprints:Yc,ForkKnife:Se,ForkKnifeCrossed:Le,Forklift:t4,Form:e4,FormInput:s0,Forward:o4,Frame:s4,Frown:r4,Fuel:i4,Fullscreen:n4,FunctionSquare:I0,Funnel:mt,FunnelPlus:l4,FunnelX:ft,GalleryHorizontal:a4,GalleryHorizontalEnd:h4,GalleryThumbnails:c4,GalleryVertical:p4,GalleryVerticalEnd:d4,Gamepad:u4,Gamepad2:w4,GamepadDirectional:g4,GanttChart:e2,GanttChartSquare:B,Gauge:k4,GaugeCircle:m2,Gavel:v4,Gem:x4,GeorgianLari:M4,Ghost:m4,Gift:f4,GitBranch:j4,GitBranchMinus:C4,GitBranchPlus:B4,GitCommit:Ct,GitCommitHorizontal:Ct,GitCommitVertical:y4,GitCompare:V4,GitCompareArrows:H4,GitFork:A4,GitGraph:z4,GitMerge:b4,GitMergeConflict:S4,GitPullRequest:D4,GitPullRequestArrow:L4,GitPullRequestClosed:_4,GitPullRequestCreate:q4,GitPullRequestCreateArrow:P4,GitPullRequestDraft:F4,GlassWater:T4,Glasses:R4,Globe:I4,Globe2:I2,GlobeLock:Z4,GlobeOff:U4,GlobeX:O4,Goal:G4,Gpu:E4,Grab:Vt,GraduationCap:W4,Grape:N4,Grid:m,Grid2X2:Ht,Grid2X2Check:Bt,Grid2X2Plus:jt,Grid2X2X:yt,Grid2x2:Ht,Grid2x2Check:Bt,Grid2x2Plus:jt,Grid2x2X:yt,Grid3X3:m,Grid3x2:X4,Grid3x3:m,Grip:Q4,GripHorizontal:K4,GripVertical:J4,Group:$4,Guitar:Y4,Ham:tw,Hamburger:ew,Hammer:ow,Hand:hw,HandCoins:sw,HandFist:rw,HandGrab:Vt,HandHeart:iw,HandHelping:At,HandMetal:nw,HandPlatter:lw,Handbag:aw,Handshake:dw,HardDrive:pw,HardDriveDownload:cw,HardDriveUpload:ww,HardHat:uw,Hash:gw,HatGlasses:vw,Haze:kw,Hd:mw,HdmiPort:xw,Heading:Hw,Heading1:Mw,Heading2:Cw,Heading3:fw,Heading4:Bw,Heading5:jw,Heading6:yw,HeadphoneOff:Vw,Headphones:Aw,Headset:zw,Heart:Tw,HeartCrack:bw,HeartHandshake:Lw,HeartMinus:Sw,HeartOff:_w,HeartPlus:qw,HeartPulse:Pw,HeartX:Fw,Heater:Dw,Helicopter:Rw,HelpCircle:k,HelpingHand:At,Hexagon:Zw,Highlighter:Ow,History:Uw,Home:zt,Hop:Gw,HopOff:Iw,Hospital:Ew,Hotel:Ww,Hourglass:Nw,House:zt,HouseHeart:Xw,HousePlug:Kw,HousePlus:Jw,HouseWifi:Qw,IceCream:Lt,IceCream2:bt,IceCreamBowl:bt,IceCreamCone:Lt,IdCard:Yw,IdCardLanyard:$w,Image:lp,ImageDown:tp,ImageMinus:ep,ImageOff:sp,ImagePlay:op,ImagePlus:ip,ImageUp:rp,ImageUpscale:np,Images:hp,Import:ap,Inbox:cp,Indent:C,IndentDecrease:f,IndentIncrease:C,IndianRupee:dp,Infinity:wp,Info:pp,Inspect:K0,InspectionPanel:up,Italic:vp,IterationCcw:gp,IterationCw:kp,JapaneseYen:xp,Joystick:Mp,Kanban:mp,KanbanSquare:W0,KanbanSquareDashed:D0,Kayak:fp,Key:jp,KeyRound:Cp,KeySquare:Bp,Keyboard:Vp,KeyboardMusic:yp,KeyboardOff:Hp,Lamp:Sp,LampCeiling:Ap,LampDesk:bp,LampFloor:zp,LampWallDown:_p,LampWallUp:Lp,LandPlot:qp,Landmark:Pp,Languages:Fp,Laptop:Tp,Laptop2:St,LaptopMinimal:St,LaptopMinimalCheck:Dp,Lasso:Zp,LassoSelect:Rp,Laugh:Up,Layers:_t,Layers2:Op,Layers3:_t,LayersMinus:Ip,LayersPlus:Gp,Layout:Yt,LayoutDashboard:Wp,LayoutGrid:Ep,LayoutList:Np,LayoutPanelLeft:Xp,LayoutPanelTop:Jp,LayoutTemplate:Kp,Leaf:Qp,LeafyGreen:$p,Lectern:Yp,LensConcave:tu,LensConvex:su,LetterText:ke,Library:ou,LibraryBig:eu,LibrarySquare:G0,LifeBuoy:ru,Ligature:nu,Lightbulb:lu,LightbulbOff:iu,LineChart:Q,LineDotRightHorizontal:hu,LineSquiggle:du,LineStyle:au,Link:pu,Link2:cu,Link2Off:wu,List:Su,ListCheck:uu,ListChecks:gu,ListChevronsDownUp:vu,ListChevronsUpDown:ku,ListCollapse:xu,ListEnd:mu,ListFilter:fu,ListFilterPlus:Mu,ListIndentDecrease:f,ListIndentIncrease:C,ListMinus:Cu,ListMusic:Bu,ListOrdered:yu,ListPlus:ju,ListRestart:Hu,ListStart:Vu,ListTodo:Au,ListTree:zu,ListVideo:bu,ListX:Lu,Loader:qu,Loader2:qt,LoaderCircle:qt,LoaderPinwheel:_u,Locate:Du,LocateFixed:Pu,LocateOff:Fu,LocationEdit:Tt,Lock:Ru,LockKeyhole:Tu,LockKeyholeOpen:Pt,LockOpen:Ft,LogIn:Zu,LogOut:Uu,Logs:Ou,Lollipop:Iu,Luggage:Wu,MSquare:E0,Magnet:Gu,Mail:Yu,MailCheck:Eu,MailMinus:Nu,MailOpen:Xu,MailPlus:Ku,MailQuestion:Dt,MailQuestionMark:Dt,MailSearch:$u,MailWarning:Ju,MailX:Qu,Mailbox:tg,Mails:eg,Map:xg,MapMinus:og,MapPin:gg,MapPinCheck:sg,MapPinCheckInside:rg,MapPinHouse:ig,MapPinMinus:lg,MapPinMinusInside:ng,MapPinOff:hg,MapPinPen:Tt,MapPinPlus:dg,MapPinPlusInside:ag,MapPinSearch:cg,MapPinX:pg,MapPinXInside:wg,MapPinned:ug,MapPlus:vg,Mars:Mg,MarsStroke:kg,Martini:mg,Maximize:Cg,Maximize2:fg,Medal:Bg,Megaphone:yg,MegaphoneOff:jg,Meh:Hg,MemoryStick:Vg,Menu:Ag,MenuSquare:N0,Merge:zg,MessageCircle:Zg,MessageCircleCheck:bg,MessageCircleCode:Lg,MessageCircleDashed:Sg,MessageCircleHeart:_g,MessageCircleMore:Pg,MessageCircleOff:qg,MessageCirclePlus:Fg,MessageCircleQuestion:Rt,MessageCircleQuestionMark:Rt,MessageCircleReply:Dg,MessageCircleWarning:Tg,MessageCircleX:Rg,MessageSquare:s3,MessageSquareCheck:Ug,MessageSquareCode:Ig,MessageSquareDashed:Og,MessageSquareDiff:Gg,MessageSquareDot:Wg,MessageSquareHeart:Eg,MessageSquareLock:Ng,MessageSquareMore:Xg,MessageSquareOff:Kg,MessageSquarePlus:Jg,MessageSquareQuote:Qg,MessageSquareReply:$g,MessageSquareShare:Yg,MessageSquareText:t3,MessageSquareWarning:e3,MessageSquareX:o3,MessagesSquare:r3,Metronome:i3,Mic:l3,Mic2:Zt,MicOff:n3,MicVocal:Zt,Microchip:h3,Microscope:a3,Microwave:d3,Milestone:c3,Milk:p3,MilkOff:w3,Minimize:g3,Minimize2:u3,Minus:v3,MinusCircle:f2,MinusSquare:X0,MirrorRectangular:k3,MirrorRound:x3,Monitor:S3,MonitorCheck:M3,MonitorCloud:m3,MonitorCog:f3,MonitorDot:C3,MonitorDown:B3,MonitorOff:j3,MonitorPause:y3,MonitorPlay:H3,MonitorSmartphone:V3,MonitorSpeaker:A3,MonitorStop:z3,MonitorUp:b3,MonitorX:L3,Moon:_3,MoonStar:q3,MoreHorizontal:W2,MoreVertical:G2,Motorbike:P3,Mountain:D3,MountainSnow:F3,Mouse:E3,MouseLeft:T3,MouseOff:R3,MousePointer:G3,MousePointer2:U3,MousePointer2Off:Z3,MousePointerBan:O3,MousePointerClick:I3,MousePointerSquareDashed:T0,MouseRight:W3,Move:iv,Move3D:Ut,Move3d:Ut,MoveDiagonal:X3,MoveDiagonal2:N3,MoveDown:J3,MoveDownLeft:K3,MoveDownRight:$3,MoveHorizontal:Q3,MoveLeft:Y3,MoveRight:tv,MoveUp:ov,MoveUpLeft:ev,MoveUpRight:sv,MoveVertical:rv,Music:av,Music2:nv,Music3:hv,Music4:lv,Navigation:pv,Navigation2:cv,Navigation2Off:dv,NavigationOff:wv,Network:uv,Newspaper:gv,Nfc:vv,NonBinary:kv,Notebook:fv,NotebookPen:xv,NotebookTabs:Mv,NotebookText:mv,NotepadText:Bv,NotepadTextDashed:Cv,Nut:yv,NutOff:jv,Octagon:Vv,OctagonAlert:It,OctagonMinus:Hv,OctagonPause:Ot,OctagonX:Gt,Omega:Av,Option:zv,Orbit:bv,Origami:Lv,Outdent:f,Package:Rv,Package2:Sv,PackageCheck:_v,PackageMinus:qv,PackageOpen:Pv,PackagePlus:Fv,PackageSearch:Dv,PackageX:Tv,PaintBucket:Zv,PaintRoller:Uv,Paintbrush:Ov,Paintbrush2:Wt,PaintbrushVertical:Wt,Palette:Iv,Palmtree:me,Panda:Gv,PanelBottom:Nv,PanelBottomClose:Wv,PanelBottomDashed:Et,PanelBottomInactive:Et,PanelBottomOpen:Ev,PanelLeft:Jt,PanelLeftClose:Nt,PanelLeftDashed:Kt,PanelLeftInactive:Kt,PanelLeftOpen:Xt,PanelLeftRightDashed:Xv,PanelRight:Qv,PanelRightClose:Kv,PanelRightDashed:Qt,PanelRightInactive:Qt,PanelRightOpen:Jv,PanelTop:e5,PanelTopBottomDashed:$v,PanelTopClose:Yv,PanelTopDashed:$t,PanelTopInactive:$t,PanelTopOpen:t5,PanelsLeftBottom:o5,PanelsLeftRight:Z2,PanelsRightBottom:s5,PanelsTopBottom:n0,PanelsTopLeft:Yt,Paperclip:r5,Parentheses:i5,ParkingCircle:B2,ParkingCircleOff:C2,ParkingMeter:n5,ParkingSquare:Q0,ParkingSquareOff:J0,PartyPopper:l5,Pause:h5,PauseCircle:j2,PauseOctagon:Ot,PawPrint:d5,PcCase:a5,Pen:e0,PenBox:p,PenLine:t0,PenOff:w5,PenSquare:p,PenTool:c5,Pencil:v5,PencilLine:p5,PencilOff:u5,PencilRuler:g5,Pentagon:x5,Percent:k5,PercentCircle:y2,PercentDiamond:O2,PercentSquare:Y0,PersonStanding:M5,PhilippinePeso:m5,Phone:V5,PhoneCall:f5,PhoneForwarded:C5,PhoneIncoming:B5,PhoneMissed:j5,PhoneOff:y5,PhoneOutgoing:H5,Pi:A5,PiSquare:$0,Piano:z5,Pickaxe:b5,PictureInPicture:S5,PictureInPicture2:L5,PieChart:o2,PiggyBank:_5,Pilcrow:F5,PilcrowLeft:q5,PilcrowRight:P5,PilcrowSquare:te,Pill:T5,PillBottle:D5,Pin:Z5,PinOff:R5,Pipette:U5,Pizza:O5,Plane:W5,PlaneLanding:I5,PlaneTakeoff:G5,Play:E5,PlayCircle:H2,PlaySquare:oe,Plug:X5,Plug2:N5,PlugZap:o0,PlugZap2:o0,Plus:K5,PlusCircle:V2,PlusSquare:ee,PocketKnife:J5,Podcast:Q5,Pointer:Y5,PointerOff:$5,Popcorn:tk,Popsicle:ek,PoundSterling:ok,Power:rk,PowerCircle:A2,PowerOff:sk,PowerSquare:se,Presentation:ik,Printer:hk,PrinterCheck:nk,PrinterX:lk,Projector:ak,Proportions:dk,Puzzle:ck,Pyramid:wk,QrCode:pk,Quote:uk,Rabbit:gk,Radar:vk,Radiation:kk,Radical:xk,Radio:Ck,RadioOff:Mk,RadioReceiver:mk,RadioTower:fk,Radius:Bk,Rainbow:jk,Rat:yk,Ratio:Hk,Receipt:Fk,ReceiptCent:Vk,ReceiptEuro:Ak,ReceiptIndianRupee:zk,ReceiptJapaneseYen:bk,ReceiptPoundSterling:Lk,ReceiptRussianRuble:Sk,ReceiptSwissFranc:_k,ReceiptText:qk,ReceiptTurkishLira:Pk,RectangleCircle:Dk,RectangleEllipsis:s0,RectangleGoggles:Zk,RectangleHorizontal:Tk,RectangleVertical:Rk,Recycle:Uk,Redo:Gk,Redo2:Ok,RedoDot:Ik,RefreshCcw:Ek,RefreshCcwDot:Wk,RefreshCw:Kk,RefreshCwOff:Nk,Refrigerator:Xk,Regex:Jk,RemoveFormatting:Qk,Repeat:e6,Repeat1:$k,Repeat2:Yk,RepeatOff:t6,Replace:s6,ReplaceAll:o6,Reply:i6,ReplyAll:r6,Rewind:n6,Ribbon:l6,Road:h6,Rocket:a6,RockingChair:d6,RollerCoaster:c6,Rose:w6,Rotate3D:r0,Rotate3d:r0,RotateCcw:g6,RotateCcwKey:p6,RotateCcwSquare:u6,RotateCw:k6,RotateCwSquare:v6,Route:M6,RouteOff:x6,Router:m6,Rows:i0,Rows2:i0,Rows3:n0,Rows4:f6,Rss:C6,Ruler:B6,RulerDimensionLine:j6,RussianRuble:y6,Sailboat:H6,Salad:A6,Sandwich:V6,Satellite:b6,SatelliteDish:z6,SaudiRiyal:L6,Save:q6,SaveAll:S6,SaveOff:_6,Scale:P6,Scale3D:l0,Scale3d:l0,Scaling:F6,Scan:W6,ScanBarcode:D6,ScanEye:T6,ScanFace:R6,ScanHeart:Z6,ScanLine:U6,ScanQrCode:O6,ScanSearch:I6,ScanText:G6,ScatterChart:s2,School:E6,School2:Be,Scissors:X6,ScissorsLineDashed:N6,ScissorsSquare:re,ScissorsSquareDashedBottom:V0,Scooter:K6,ScreenShare:$6,ScreenShareOff:J6,Scroll:Y6,ScrollText:Q6,Search:r8,SearchAlert:o8,SearchCheck:t8,SearchCode:e8,SearchSlash:s8,SearchX:n8,Section:i8,Send:h8,SendHorizonal:h0,SendHorizontal:h0,SendToBack:l8,SeparatorHorizontal:a8,SeparatorVertical:d8,Server:u8,ServerCog:c8,ServerCrash:w8,ServerOff:p8,Settings:v8,Settings2:g8,Shapes:k8,Share:M8,Share2:x8,Sheet:m8,Shell:f8,ShelvingUnit:C8,Shield:q8,ShieldAlert:j8,ShieldBan:B8,ShieldCheck:y8,ShieldClose:d0,ShieldCog:V8,ShieldCogCorner:H8,ShieldEllipsis:A8,ShieldHalf:z8,ShieldMinus:L8,ShieldOff:b8,ShieldPlus:S8,ShieldQuestion:a0,ShieldQuestionMark:a0,ShieldUser:_8,ShieldX:d0,Ship:F8,ShipWheel:P8,Shirt:D8,ShoppingBag:T8,ShoppingBasket:Z8,ShoppingCart:R8,Shovel:U8,ShowerHead:O8,Shredder:I8,Shrimp:W8,Shrink:G8,Shrub:E8,Shuffle:N8,Sidebar:Jt,SidebarClose:Nt,SidebarOpen:Xt,Sigma:X8,SigmaSquare:ie,Signal:$8,SignalHigh:J8,SignalLow:K8,SignalMedium:Q8,SignalZero:Y8,Signature:t7,Signpost:s7,SignpostBig:e7,Siren:o7,SkipBack:r7,SkipForward:i7,Skull:n7,Slash:l7,SlashSquare:ne,Slice:h7,Sliders:c0,SlidersHorizontal:a7,SlidersVertical:c0,Smartphone:w7,SmartphoneCharging:d7,SmartphoneNfc:c7,Smile:u7,SmilePlus:p7,Snail:g7,Snowflake:v7,SoapDispenserDroplet:k7,Sofa:x7,SolarPanel:M7,SortAsc:P,SortDesc:S,Soup:m7,Space:C7,Spade:f7,Sparkle:B7,Sparkles:w0,Speaker:j7,Speech:y7,SpellCheck:V7,SpellCheck2:H7,Spline:b7,SplinePointer:A7,Split:z7,SplitSquareHorizontal:le,SplitSquareVertical:he,Spool:L7,SportShoe:S7,Spotlight:q7,SprayCan:_7,Sprout:P7,Square:X7,SquareActivity:p0,SquareArrowDown:v0,SquareArrowDownLeft:u0,SquareArrowDownRight:g0,SquareArrowLeft:k0,SquareArrowOutDownLeft:x0,SquareArrowOutDownRight:m0,SquareArrowOutUpLeft:M0,SquareArrowOutUpRight:f0,SquareArrowRight:C0,SquareArrowRightEnter:F7,SquareArrowRightExit:D7,SquareArrowUp:y0,SquareArrowUpLeft:B0,SquareArrowUpRight:j0,SquareAsterisk:H0,SquareBottomDashedScissors:V0,SquareCenterlineDashedHorizontal:A0,SquareCenterlineDashedVertical:z0,SquareChartGantt:B,SquareCheck:L0,SquareCheckBig:b0,SquareChevronDown:S0,SquareChevronLeft:_0,SquareChevronRight:q0,SquareChevronUp:P0,SquareCode:F0,SquareDashed:R0,SquareDashedBottom:R7,SquareDashedBottomCode:T7,SquareDashedKanban:D0,SquareDashedMousePointer:T0,SquareDashedText:j,SquareDashedTopSolid:Z7,SquareDivide:Z0,SquareDot:U0,SquareEqual:O0,SquareFunction:I0,SquareGanttChart:B,SquareKanban:W0,SquareLibrary:G0,SquareM:E0,SquareMenu:N0,SquareMinus:X0,SquareMousePointer:K0,SquareParking:Q0,SquareParkingOff:J0,SquarePause:U7,SquarePen:p,SquarePercent:Y0,SquarePi:$0,SquarePilcrow:te,SquarePlay:oe,SquarePlus:ee,SquarePower:se,SquareRadical:I7,SquareRoundCorner:O7,SquareScissors:re,SquareSigma:ie,SquareSlash:ne,SquareSplitHorizontal:le,SquareSplitVertical:he,SquareSquare:G7,SquareStack:W7,SquareStar:E7,SquareStop:N7,SquareTerminal:ae,SquareUser:ce,SquareUserRound:de,SquareX:we,SquaresExclude:K7,SquaresIntersect:J7,SquaresSubtract:Q7,SquaresUnite:$7,Squircle:Y7,SquircleDashed:ex,Squirrel:tx,Stamp:ox,Star:rx,StarHalf:sx,StarOff:ix,Stars:w0,StepBack:nx,StepForward:lx,Stethoscope:hx,Sticker:ax,StickyNote:gx,StickyNoteCheck:dx,StickyNoteMinus:cx,StickyNoteOff:wx,StickyNotePlus:px,StickyNoteX:ux,StickyNotes:vx,Stone:kx,StopCircle:b2,Store:xx,StretchHorizontal:Mx,StretchVertical:mx,Strikethrough:fx,Subscript:Bx,Subtitles:G,Sun:Vx,SunDim:Cx,SunMedium:jx,SunMoon:yx,SunSnow:Hx,Sunrise:Ax,Sunset:zx,Superscript:bx,SwatchBook:Lx,SwissFranc:Sx,SwitchCamera:_x,Sword:qx,Swords:Px,Syringe:Fx,Table:Wx,Table2:Dx,TableCellsMerge:Zx,TableCellsSplit:Tx,TableColumnsSplit:Rx,TableConfig:x,TableOfContents:Ux,TableProperties:Ox,TableRowsSplit:Ix,Tablet:Ex,TabletSmartphone:Gx,Tablets:Nx,Tag:Xx,Tags:Kx,Tally1:Jx,Tally2:Yx,Tally3:Qx,Tally4:$x,Tally5:t9,Tangent:e9,Target:o9,Telescope:s9,Tent:i9,TentTree:r9,Terminal:n9,TerminalSquare:ae,TestTube:l9,TestTube2:pe,TestTubeDiagonal:pe,TestTubes:h9,Text:y,TextAlignCenter:ge,TextAlignEnd:ue,TextAlignJustify:ve,TextAlignStart:y,TextCursor:d9,TextCursorInput:a9,TextInitial:ke,TextQuote:c9,TextSearch:w9,TextSelect:j,TextSelection:j,TextWrap:xe,Theater:p9,Thermometer:v9,ThermometerSnowflake:u9,ThermometerSun:g9,ThumbsDown:k9,ThumbsUp:x9,Ticket:y9,TicketCheck:M9,TicketMinus:m9,TicketPercent:f9,TicketPlus:C9,TicketSlash:B9,TicketX:j9,Tickets:V9,TicketsPlane:H9,Timeline:A9,Timer:b9,TimerOff:z9,TimerReset:L9,ToggleLeft:S9,ToggleRight:_9,Toilet:q9,ToolCase:P9,Toolbox:F9,Tornado:D9,Torus:T9,Touchpad:Z9,TouchpadOff:R9,TowelRack:U9,TowerControl:O9,ToyBrick:I9,Tractor:G9,TrafficCone:W9,Train:Me,TrainFront:N9,TrainFrontTunnel:E9,TrainTrack:X9,TramFront:Me,Transgender:K9,Trash:Q9,Trash2:J9,TreeDeciduous:$9,TreePalm:me,TreePine:Y9,Trees:tM,TrendingDown:eM,TrendingUp:sM,TrendingUpDown:oM,Triangle:nM,TriangleAlert:fe,TriangleDashed:rM,TriangleRight:iM,Trophy:lM,Truck:hM,TruckElectric:aM,TurkishLira:dM,Turntable:cM,Turtle:pM,Tv:uM,Tv2:Ce,TvMinimal:Ce,TvMinimalPlay:wM,Type:gM,TypeOutline:vM,Umbrella:xM,UmbrellaOff:kM,Underline:MM,Undo:CM,Undo2:mM,UndoDot:fM,UnfoldHorizontal:BM,UnfoldVertical:jM,Ungroup:yM,University:Be,Unlink:VM,Unlink2:HM,Unlock:Ft,UnlockKeyhole:Pt,Unplug:AM,Upload:zM,UploadCloud:D2,Usb:bM,User:GM,User2:ze,UserCheck:LM,UserCheck2:je,UserCircle:L2,UserCircle2:S2,UserCog:SM,UserCog2:ye,UserKey:_M,UserLock:qM,UserMinus:PM,UserMinus2:He,UserPen:FM,UserPlus:DM,UserPlus2:Ae,UserRound:ze,UserRoundCheck:je,UserRoundCog:ye,UserRoundKey:TM,UserRoundMinus:He,UserRoundPen:RM,UserRoundPlus:Ae,UserRoundSearch:ZM,UserRoundX:Ve,UserSearch:UM,UserSquare:ce,UserSquare2:de,UserStar:OM,UserX:IM,UserX2:Ve,Users:WM,Users2:be,UsersRound:be,Utensils:Se,UtensilsCrossed:Le,UtilityPole:EM,Van:NM,Variable:XM,Vault:KM,VectorSquare:QM,Vegan:JM,VenetianMask:$M,Venus:tm,VenusAndMars:YM,Verified:T,Vibrate:om,VibrateOff:em,Video:rm,VideoOff:sm,Videotape:im,View:nm,Voicemail:lm,Volleyball:hm,Volume:pm,Volume1:am,Volume2:dm,VolumeOff:cm,VolumeX:wm,Vote:gm,Wallet:vm,Wallet2:_e,WalletCards:um,WalletMinimal:_e,Wallpaper:km,Wand:xm,Wand2:qe,WandSparkles:qe,Warehouse:Mm,WashingMachine:mm,Watch:fm,Waves:Pe,WavesArrowDown:Cm,WavesArrowUp:Bm,WavesHorizontal:Pe,WavesLadder:jm,WavesVertical:ym,Waypoints:Hm,Webcam:Vm,Webhook:bm,WebhookOff:Am,Weight:Lm,WeightTilde:zm,Wheat:_m,WheatOff:Sm,WholeWord:qm,Wifi:Om,WifiCog:Pm,WifiHigh:Fm,WifiLow:Dm,WifiOff:Rm,WifiPen:Tm,WifiSync:Zm,WifiZero:Um,Wind:Im,WindArrowDown:Gm,Wine:Em,WineOff:Wm,Workflow:Nm,Worm:Xm,WrapText:xe,Wrench:Qm,X:Jm,XCircle:_2,XLineTop:Km,XOctagon:Gt,XSquare:we,Zap:Ym,ZapOff:$m,ZodiacAquarius:tf,ZodiacAries:of,ZodiacCancer:ef,ZodiacCapricorn:sf,ZodiacGemini:rf,ZodiacLeo:nf,ZodiacLibra:lf,ZodiacOphiuchus:hf,ZodiacPisces:af,ZodiacSagittarius:df,ZodiacScorpio:cf,ZodiacTaurus:wf,ZodiacVirgo:pf,ZoomIn:uf,ZoomOut:gf},Symbol.toStringTag,{value:"Module"})),kf={class:"flex flex-col gap-4"},xf={class:"flex items-center justify-between gap-3"},Mf={class:"text-p-sm shrink-0 text-ink-gray-5"},mf={class:"h-[450px] overflow-auto"},ff={class:"grid grid-cols-[repeat(auto-fill,56px)] gap-1 justify-center"},Cf={class:"flex size-14 items-center justify-center rounded text-ink-gray-7 hover:bg-surface-gray-2"},Bf=["innerHTML"],jf={key:1,class:"p-6 text-p-sm text-ink-gray-5"},yf=Oe({__name:"LucideGallery",setup(Fe){const c=new Map;for(const e of Object.values(vf)){if(typeof e!="string")continue;const t=e.match(/lucide lucide-([\w-]+)/);if(!t)continue;const o=t[1];if(c.has(o))continue;const w=e.replace(/stroke-width="[^"]+"/g,'stroke-width="1.5"');c.set(o,w)}const s=[...c.entries()].map(([e,t])=>({name:e,svg:t})).sort((e,t)=>e.name.localeCompare(t.name)),i=We(""),g=Ee(()=>{const e=i.value.trim().toLowerCase();if(!e)return s;const t=[],o=[],w=[];for(const n of s)n.name===e?t.push(n):n.name.startsWith(e)?o.push(n):n.name.includes(e)&&w.push(n);return[...t,...o,...w]});return(e,t)=>(h(),u("div",kf,[r("div",xf,[d(l(De),{modelValue:i.value,"onUpdate:modelValue":t[0]||(t[0]=o=>i.value=o),placeholder:"Search icons…",class:"w-full"},{prefix:a(()=>[...t[1]||(t[1]=[r("span",{class:"lucide-search size-4 text-ink-gray-5"},null,-1)])]),suffix:a(()=>[r("span",Mf,v(g.value.length)+" of "+v(l(s).length),1)]),_:1},8,["modelValue"])]),r("div",mf,[g.value.length>0?(h(),H(l(Te),{key:0,"delay-duration":300,"skip-delay-duration":1e3},{default:a(()=>[r("div",ff,[(h(!0),u(Ie,null,Ge(g.value,o=>(h(),H(l(Re),{key:o.name},{default:a(()=>[d(l(Ze),{"as-child":""},{default:a(()=>[r("div",Cf,[r("span",{class:"size-6 [&>svg]:size-full",innerHTML:o.svg},null,8,Bf)])]),_:2},1024),d(l(Ue),{text:o.name},null,8,["text"])]),_:2},1024))),128))])]),_:1})):(h(),u("p",jf,' No icons match "'+v(i.value)+'". ',1))])]))}}),zf=JSON.parse('{"title":"Icons","description":"","frontmatter":{},"headers":[],"relativePath":"docs/other/icons.md","filePath":"docs/other/icons.md","lastUpdated":1778762569000}'),Hf={name:"docs/other/icons.md"},bf=Object.assign(Hf,{setup(Fe){return(c,s)=>{const i=Ne("ClientOnly");return h(),u("div",null,[s[0]||(s[0]=V('<h1 id="icons" tabindex="-1">Icons <a class="header-anchor" href="#icons" aria-label="Permalink to “Icons”">​</a></h1><p>Frappe UI ships with the full <a href="https://lucide.dev" target="_blank" rel="noreferrer">Lucide</a> icon set. There are three ways to use an icon in your templates. Pick the first one that fits — they all render the same icon, but the recommended path keeps your code simpler and your bundle smaller.</p><h2 id="browse-all-icons" tabindex="-1">Browse all icons <a class="header-anchor" href="#browse-all-icons" aria-label="Permalink to “Browse all icons”">​</a></h2><p>Every icon below is keyed by its kebab-case name — use that name directly as <code>lucide-&lt;name&gt;</code> in the Tailwind class form, or import it from <code>~icons/lucide/&lt;name&gt;</code>.</p>',4)),d(i,null,{default:a(()=>[d(yf)]),_:1}),s[1]||(s[1]=V(`<h2 id="recommended-class-based-icons" tabindex="-1">Recommended: class-based icons <a class="header-anchor" href="#recommended-class-based-icons" aria-label="Permalink to “Recommended: class-based icons”">​</a></h2><p>Every Lucide icon is exposed as a Tailwind utility class named <code>lucide-&lt;icon-name&gt;</code>. Drop it on any element and size/tint it with the usual utilities:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span>
