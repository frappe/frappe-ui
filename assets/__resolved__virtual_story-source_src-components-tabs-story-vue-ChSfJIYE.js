const __resolved__virtual_storySource_srcComponentsTabsStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsTabsStoryVue as default
};
