const __resolved__virtual_storySource_srcComponentsTextinputTextinputStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsTextinputTextinputStoryVue as default
};
