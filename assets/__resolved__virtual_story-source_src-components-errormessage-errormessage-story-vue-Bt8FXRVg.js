const __resolved__virtual_storySource_srcComponentsErrormessageErrormessageStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsErrormessageErrormessageStoryVue as default
};
