const __resolved__virtual_storySource_srcComponentsDatepickerStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsDatepickerStoryVue as default
};
