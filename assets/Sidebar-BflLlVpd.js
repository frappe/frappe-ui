import { aP as markRaw, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, ay as defineComponent, aY as inject, aC as createBlock, aD as withCtx, aR as normalizeClass, aZ as renderSlot, aN as toDisplayString, bx as resolveDynamicComponent, aE as createVNode, cl as useRouter, aH as createCommentVNode, az as ref, aK as Fragment, aJ as renderList, bg as Transition, cY as useStorage, bV as provide, cZ as useBreakpoints, c_ as watchEffect, c$ as breakpointsTailwind, aS as normalizeProps, aT as guardReactiveProps } from "./vendor-BkoGa0PW.js";
import { L as LucideChevronDown } from "./chevron-down-CoUWYXFD.js";
import { D as Dropdown } from "./Dropdown-iLdaDs3A.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { B as Button, _ as __unplugin_components_0$1 } from "./Button-BRQsvy8b.js";
const _hoisted_1$6 = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    {
      class: normalizeClass(["flex h-full flex-col flex-shrink-0 overflow-y-auto overflow-x-hidden border-r border-outline-gray-1 bg-surface-menu-bar transition-all duration-300 ease-in-out p-2", $setup.isCollapsed ? "w-12" : "w-60"])
    },
    [
      ...
      createBaseVNode("div", _hoisted_1, [
        renderSlot(_ctx.$slots, "footer-items", normalizeProps(guardReactiveProps({ isCollapsed: $setup.isCollapsed, isMobile: $setup.isMobile }))),
