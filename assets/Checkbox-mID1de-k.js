import { ay as _export_sfc, az as defineComponent, bK as useAttrs, aO as computed, aD as openBlock, aL as createElementBlock, aI as createBaseVNode, aW as mergeProps, aQ as normalizeClass, aJ as toDisplayString, aS as createCommentVNode } from "./vendor-CZBDvwVw.js";
  ...
  return openBlock(), createElementBlock(
    ...
    [
      createBaseVNode("input", mergeProps({
        class: ["rounded-sm mt-[1px] bg-surface-white", $setup.inputClasses],
        type: "checkbox",
