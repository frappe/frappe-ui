import { aB as openBlock, aG as createElementBlock, aF as createBaseVNode, az as ref, bb as watch, aW as computed, aC as createBlock, aD as withCtx, aE as createVNode, aH as createCommentVNode, aN as toDisplayString, aK as Fragment, aJ as renderList, aR as normalizeClass, a_ as withModifiers, cn as _sfc_main$d, co as _sfc_main$e, aI as reactive, aY as inject, a$ as normalizeStyle, b1 as onMounted, bU as onBeforeUnmount, cp as useFloating, cq as offset, cr as flip, cs as shift, ct as autoUpdate, aL as mergeProps, cu as toHandlers, bx as resolveDynamicComponent, aM as createTextVNode, aZ as renderSlot, aS as normalizeProps, aT as guardReactiveProps, bd as onUnmounted, bV as provide, bl as nextTick } from "./vendor-Dk0c65vB.js";
import { B as Button, _ as __unplugin_components_0 } from "./Button-CLC7qZNJ.js";
...
import { _ as __unplugin_components_1$1 } from "./Dialog-BExLj_74.js";
    ...
    body: withCtx(({ togglePopover }) => [
      createBaseVNode("div", _hoisted_1$7, [
        ...
        createBaseVNode("div", _hoisted_7$5, [
          ...
          $setup.view === "date" ? (openBlock(), createElementBlock("div", _hoisted_8$4, [
...
const _hoisted_8$3 = { class: "text-sm font-normal" };
const _hoisted_9$1 = {
  key: 1,
  class: "flex items-center gap-2"
};
...
Dialog.Title = _sfc_main$d;
Dialog.Description = _sfc_main$e;
const _sfc_main$7 = {
...
const _hoisted_8$1 = ["data-date-attr", "onClick"];
...
const _hoisted_2$1 = { class: "pb-2 text-base text-ink-gray-6" };
const _hoisted_3$1 = { class: "flex justify-center items-start pt-[3px] w-20 text-base text-ink-gray-6 text-center" };
const _hoisted_4$1 = ["data-date-attr"];
const _hoisted_5 = { class: "h-full overflow-hidden" };
const _hoisted_6 = { class: "grid h-full w-20 grid-cols-1" };
const _hoisted_7 = { class: "grid h-full w-full grid-cols-1 pb-2" };
const _hoisted_8 = ["data-time-attr", "onClick"];
  ...
  return openBlock(), createElementBlock("div", _hoisted_1$1, [
    renderSlot(_ctx.$slots, "header", normalizeProps(guardReactiveProps({ parseDateWithDay: $setup.parseDateWithDay, currentDate: $props.currentDate, fullDay: _ctx.fullDay })), () => [
      createBaseVNode(
        "p",
        _hoisted_2$1,
        toDisplayString($setup.parseDateWithDay($props.currentDate)),
        1
        /* TEXT */
      )
    ]),
