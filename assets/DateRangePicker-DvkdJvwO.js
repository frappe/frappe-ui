import { az as ref, aW as computed, ay as defineComponent, b1 as onMounted, aB as openBlock, aC as createBlock, aD as withCtx, aF as createBaseVNode, aG as createElementBlock, aN as toDisplayString, aH as createCommentVNode, aE as createVNode, aL as mergeProps, cJ as createSlots, aZ as renderSlot, aS as normalizeProps, aT as guardReactiveProps, aR as normalizeClass, aK as Fragment, aJ as renderList } from "./vendor-DsK-IN2t.js";
import { B as Button } from "./Button-CcSMnls4.js";
import { F as FeatherIcon } from "./FeatherIcon-C9yoy05s.js";
import { _ as __unplugin_components_1 } from "./Popover-BpTdW25u.js";
import { T as TextInput } from "./TextInput-COLEyMmV.js";
import { d as dayjs, a as dayjsLocal, b as dayjsSystem } from "./dayjs-DagzzoWu.js";
...
const _hoisted_1$2 = { class: "flex flex-col space-y-1.5" };
const _hoisted_2$2 = {
  key: 0,
  class: "block text-xs text-ink-gray-5"
};
const _hoisted_3$2 = { class: "flex items-center p-1 text-ink-gray-4" };
const _hoisted_4$2 = { class: "flex-1 text-center text-base font-medium text-ink-gray-6" };
const _hoisted_5$2 = { class: "flex items-center justify-center gap-1 p-1" };
const _hoisted_6$2 = { class: "flex flex-col items-center justify-center p-1 text-ink-gray-8" };
const _hoisted_7$2 = { class: "flex items-center text-xs uppercase" };
const _hoisted_8$2 = ["onClick"];
const _hoisted_9$2 = { class: "flex justify-end p-1" };
      ...
      createBaseVNode("div", _hoisted_1$2, [
        ...
        createVNode($setup["TextInput"], mergeProps({
          ...
          _ctx.$slots.suffix ? {
            name: "suffix",
            fn: withCtx(() => [
              renderSlot(_ctx.$slots, "suffix", normalizeProps(guardReactiveProps({ togglePopover })))
            ]),
            key: "1"
          } : void 0
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList(week, (date) => {
                      ...
                      }, toDisplayString(date.getDate()), 11, _hoisted_8$2);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
...
const _hoisted_1$1 = { class: "flex flex-col space-y-1.5" };
const _hoisted_2$1 = {
  key: 0,
  class: "block text-xs text-ink-gray-5"
};
const _hoisted_3$1 = { class: "flex items-center p-1 text-ink-gray-4" };
const _hoisted_4$1 = { class: "flex-1 text-center text-base font-medium text-ink-gray-6" };
const _hoisted_5$1 = { class: "flex items-center justify-center gap-1 p-1" };
const _hoisted_6$1 = { class: "flex flex-col items-center justify-center p-1 text-ink-gray-8" };
const _hoisted_7$1 = { class: "flex items-center text-xs uppercase" };
const _hoisted_8$1 = ["onClick"];
const _hoisted_9$1 = { class: "flex items-center justify-around gap-2 p-1" };
const _hoisted_10 = { class: "flex flex-col items-center justify-center" };
...
const _hoisted_13 = { class: "slider flex min-h-4 items-center justify-center" };
const _hoisted_14 = { class: "flex justify-end p-1" };
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList(week, (date) => {
                      ...
                      }, toDisplayString(date.getDate()), 11, _hoisted_8$1);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
...
const _hoisted_1 = { class: "flex flex-col space-y-1.5" };
const _hoisted_2 = {
  key: 0,
  class: "block text-xs text-ink-gray-5"
};
const _hoisted_3 = { class: "flex items-center p-1 text-ink-gray-4" };
const _hoisted_4 = { class: "flex-1 text-center text-base font-medium text-ink-gray-6" };
const _hoisted_5 = { class: "flex items-center justify-center gap-1 p-1" };
const _hoisted_6 = { class: "flex flex-col items-center justify-center p-1 text-ink-gray-8" };
const _hoisted_7 = { class: "flex items-center text-xs uppercase" };
const _hoisted_8 = ["onClick"];
const _hoisted_9 = { class: "flex justify-end space-x-1 p-1" };
                ...
                return openBlock(), createElementBlock("div", {
                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList(week, (date) => {
                      ...
                      }, toDisplayString(date.getDate()), 11, _hoisted_8);
                    }),
                    128
                    /* KEYED_FRAGMENT */
                  ))
