import { ay as defineComponent, az as ref, bt as computed, aB as openBlock, aG as createElementBlock, aQ as normalizeClass, bm as renderSlot, aK as Fragment, aM as createTextVNode, aN as toDisplayString, aF as createBaseVNode, aH as createCommentVNode } from "./vendor-CMwIBljF.js";
  ...
  return openBlock(), createElementBlock(
    ...
    [
      $props.image && !$setup.imgFetchError ? (openBlock(), createElementBlock("img", {
        ...
        {
          key: 1,
          class: normalizeClass(["flex h-full w-full items-center justify-center bg-surface-gray-2 uppercase text-ink-gray-5", [$setup.labelClasses, $setup.shapeClasses]])
        },
        [
