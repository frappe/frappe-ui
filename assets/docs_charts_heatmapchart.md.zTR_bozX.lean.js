import{_ as k}from"./chunks/PropsTable.-kaOPTvh.js";import{_ as b}from"./chunks/SlotsTable.DmPybdQS.js";import{_ as g}from"./chunks/EmitsTable.NihfVewo.js";import"./chunks/theme.RDyHBhXA.js";import{_ as f}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.BygCGdcN.js";import{J as w,ae as d,r as u,E as l,aG as h,ap as v,B as x,bf as t,o as s,D as a}from"./chunks/framework.CZ-ntRvv.js";import"./chunks/useChart.LdbtNSJH.js";import"./chunks/tokens.D4EpKDGJ.js";import"./chunks/usePlotKeyboard.BClhA5nu.js";import"./chunks/axisChartCommon.C8jcTdHg.js";import"./chunks/format.BQTSxjEi.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.COff-_ZT.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CZg-hQ3P.js";import"./chunks/installLabelLayout.BgSk7cvt.js";import"./chunks/axisAlignTicks.DIB2X55U.js";import"./chunks/labelLayoutHelper.Dc3OGal5.js";import"./chunks/dataStackHelper.Cx3nHaaN.js";import"./chunks/labelGuideHelper.6FW0qtgC.js";import"./chunks/createSeriesData.g5P9WBsV.js";import"./chunks/VisualMapping.Dsm7AXcL.js";const z={class:"h-72 w-full"},j=w({__name:"HeatmapDemand",setup(y){const i=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],r=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],o=[8,52,38,34,20,15,20,9],n=r.flatMap((e,p)=>e.map((c,m)=>({day:_[p],hour:i[m],deviation:Math.round((c-o[m])/o[m]*100)})));return(e,p)=>(d(),u("div",z,[l(h(f),{data:h(n),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:c=>`${c>0?"+":""}${c}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),C={class:"h-72 w-full"},S=w({__name:"HeatmapSignups",setup(y){const i=["Free","Pro","Team"],_=[[420,455,512,498,540,601],[86,92,104,118,131,147],[12,15,14,21,26,33]],r=i.flatMap((n,e)=>_[e].map((p,c)=>({plan:n,month:new Date(Date.UTC(2024,c,1)),signups:p}))),o=n=>n.toLocaleString("en-US",{month:"short",timeZone:"UTC"});return(n,e)=>(d(),u("div",C,[l(h(f),{data:h(r),x:"month",y:"plan",value:"signups","x-axis":{format:o},"show-data-labels":"",title:"Signups by plan",subtitle:"First half of 2024"},null,8,["data","x-axis"])]))}}),O={class:"h-72 w-full"},T=w({__name:"HeatmapTickets",setup(y){const i=["9am","11am","1pm","3pm","5pm","7pm"],_=["Mon","Tue","Wed","Thu","Fri"],r=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],o=_.flatMap((n,e)=>i.map((p,c)=>({day:n,hour:p,tickets:r[e][c]})));return(n,e)=>(d(),u("div",O,[l(h(f),{data:h(o),x:"hour",y:"day",value:"tickets","show-data-labels":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),J=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmapchart.md","filePath":"docs/charts/heatmapchart.md","lastUpdated":0}'),A={name:"docs/charts/heatmapchart.md"},Z=Object.assign(A,{setup(y){const i=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:_}),l(g,{data:r})])}}});export{J as __pageData,Z as default};
