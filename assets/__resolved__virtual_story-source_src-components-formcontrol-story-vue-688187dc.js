const __resolved__virtual_storySource_srcComponentsFormcontrolStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsFormcontrolStoryVue as default
};
