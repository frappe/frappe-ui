...
import { C as Checkbox } from "./Checkbox-Bayxwx_M.js";
import { az as ref, bB as computed, cn as useDebounceFn, bP as inject, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, bu as renderSlot, aR as normalizeProps, aS as guardReactiveProps, aN as toDisplayString, aQ as normalizeClass, aL as mergeProps, aH as createCommentVNode, aC as createBlock, bJ as withModifiers, aK as Fragment, aJ as renderList, bx as normalizeStyle, ay as defineComponent, aA as resolveComponent, aE as createVNode, aM as createTextVNode, b4 as resolveDynamicComponent, aD as withCtx, bw as Transition, bz as useSlots, aI as reactive, bD as watch, bZ as provide, bQ as onMounted, bR as onBeforeUnmount, bF as lt, bG as it, bH as rt, bI as ut, co as ye, cp as Ge, cq as je, bv as createPopper, bE as nextTick, a$ as withDirectives, b5 as vShow, aP as h, cr as set, cs as get, ct as setMany, cu as del, cv as keys, cw as toValue, cx as createFetch } from "./vendor-Byfcg700.js";
import { A as Autocomplete } from "./Autocomplete-CbhML8LQ.js";
import "./Avatar-OXGcS8zj.js";
import "./Badge-ySDg-mVe.js";
import "./Breadcrumbs-DoOaGPWC.js";
import { L as LoadingIndicator, B as Button } from "./Button-CfOEJSFW.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-1tPrXgE0.js";
import { g as getConfig } from "./DateRangePicker-OggEx7qQ.js";
import { D as Dialog } from "./Dialog-D1Ikpe3I.js";
import "./Dropdown-FOPELI1_.js";
import "./ErrorMessage-ClMQphj0.js";
import { F as FeatherIcon } from "./FeatherIcon-Byqt9m8O.js";
import "./FileUploader-BHnhoUtx.js";
import { F as FormControl } from "./FormControl-BH5_at9S.js";
import { d as debounce } from "./debounce-CRCtzhPg.js";
import "./Progress-CVkE2XK6.js";
import "./Popover-aDMCkEgi.js";
import "./Rating-CkAZDNNC.js";
import "./Select-BAcHvCD2.js";
import "./Spinner-NvylNvuk.js";
import "./Switch-CZx2Yq2u.js";
import { T as TabButtons } from "./TabButtons-CPICuM5C.js";
import "./Tabs-BgZ58Ldi.js";
import "./TextInput-C6ABP4P5.js";
import "./Textarea-SfGKbkVE.js";
import "./TextEditor-CwwhGHfF.js";
import { T as Tooltip } from "./Tooltip-CZLW7msK.js";
import "./Calendar-BWJkcAgy.js";
import "./CircularProgressBar-BcpfZzGj.js";
import "./Tree-BRrra8Pl.js";
...
const _sfc_main$2 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const trialTitle = computed(() => {
      return trialEndDays.value > 1 ? "Trial ends in " + trialEndDays.value + " days" : "Trial ends tomorrow";
    });
    createResource({
    ...
    const __returned__ = { props, trialEndDays, showBanner, baseEndpoint, siteName, trialTitle, trialMessage, calculateTrialEndDays, upgradePlan, LightningIcon, FeatherIcon, get Button() {
      return Button;
    }, get createResource() {
