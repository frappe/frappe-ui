import { ay as defineComponent, az as ref, aQ as computed, aB as openBlock, aG as createElementBlock, aW as normalizeClass, aT as renderSlot, aK as Fragment, aM as createTextVNode, aN as toDisplayString, aF as createBaseVNode, aH as createCommentVNode } from "./vendor-1978956c.js";
  ...
  return openBlock(), createElementBlock(
    ...
    [
      $props.image && !$setup.imgFetchError ? (openBlock(), createElementBlock("img", {
        ...
        {
          key: 1,
          class: normalizeClass(["flex h-full w-full items-center justify-center bg-gray-100 uppercase text-gray-600", [$setup.labelClasses, $setup.shapeClasses]])
        },
        [
