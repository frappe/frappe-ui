import { a_ as markRaw, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, az as ref, aU as computed, ay as defineComponent, bi as onMounted, aC as createBlock, aD as withCtx, aE as createVNode, aL as mergeProps, aQ as normalizeClass, aH as createCommentVNode, aN as toDisplayString, aK as Fragment, aJ as renderList } from "./vendor-BwqQEq2n.js";
import { _ as __unplugin_components_0$1 } from "./Button-yPEdW5mK.js";
...
import { d as dayjs, a as dayjsLocal, b as dayjsSystem } from "./dayjs-D4hExSqd.js";
...
const __unplugin_components_0 = markRaw({ name: "lucide-calendar", render });
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    }, Popover: __unplugin_components_1, FeatherIcon, TextInput, get getDate() {
      return getDate;
    }, get getDateValue() {
      return getDateValue;
    } };
...
function _sfc_render$2(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_LucideCalendar = __unplugin_components_0;
  return openBlock(), createBlock($setup["Popover"], {
    ...
    target: withCtx(({ togglePopover }) => [
      createVNode($setup["TextInput"], mergeProps({
        ...
        prefix: withCtx(() => [
          createVNode(_component_LucideCalendar, { class: "size-4" })
        ]),
        _: 2
        /* DYNAMIC */
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    onMounted(() => selectCurrentMonthYear());
    const __returned__ = { props, emit, currentYear, currentMonth, today, datesAsWeeks, formattedMonth, prevMonth, nextMonth, marginClass, dateValue, fromDate, toDate, handleDateClick, swapDatesIfNecessary, selectDates, selectCurrentMonthYear, isInRange, formatDates, clearDates, get Button() {
      return __unplugin_components_0$1;
    }, Popover: __unplugin_components_1, FeatherIcon, TextInput, get getDateValue() {
      return getDateValue;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
