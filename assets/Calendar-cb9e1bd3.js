import { bJ as he, bK as Oe, bL as ke, aA as resolveComponent, aB as openBlock, aC as createBlock, aD as withCtx, aF as createBaseVNode, aG as createElementBlock, aK as Fragment, aJ as renderList, aW as normalizeClass, aH as createCommentVNode, b5 as withDirectives, aE as createVNode, aM as createTextVNode, aN as toDisplayString, b6 as vShow, az as ref, aI as reactive, aQ as computed, aS as inject, bu as onMounted, bv as onBeforeUnmount, bs as watch, bM as useFloating, bN as offset, bO as flip, bP as shift, bQ as autoUpdate, aL as mergeProps, bR as toHandlers, aX as withModifiers, b4 as resolveDynamicComponent, aY as normalizeStyle, bS as onUnmounted, bt as provide, aT as renderSlot, aU as normalizeProps, aV as guardReactiveProps } from "./vendor-d3f1bbba.js";
import { B as Button } from "./Button-254389e1.js";
import { F as FeatherIcon } from "./FeatherIcon-832de258.js";
import { _ as _export_sfc } from "./_plugin-vue_export-helper-cc2b3d55.js";
import { D as Dialog } from "./Dialog-8f577e38.js";
import { F as FormControl } from "./FormControl-669fd900.js";
import { E as ErrorMessage } from "./ErrorMessage-02f51dfc.js";
const _sfc_main$9 = {
  name: "TabButtons",
  props: {
    buttons: {
...
const _hoisted_1$7 = { class: "flex space-x-1 rounded bg-gray-100 p-0.5 text-sm" };
...
_sfc_main$9.__file = "src/components/TabButtons.vue";
const TabButtons = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__file", "/home/runner/work/frappe-ui/frappe-ui/src/components/TabButtons.vue"]]);
...
const _hoisted_1$6 = { class: "w-80 rounded bg-white p-4 shadow" };
...
const _sfc_main$7 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { show, props, newEvent, isUpdated, colors, errorMessage, validateFields, validateStartEndTime, calendarActions, submitEvent, handleEventTime, computed, inject, reactive, ref, Dialog, FormControl, ErrorMessage, Button, get calculateDiff() {
  ...
  setup(__props, { expose: __expose }) {
    ...
    function handleRepositionMouseDown(e) {
      ...
      function mousemove(e2) {
        ...
        if (!props.event.isFullDay)
          handleVerticalMovement(e2.clientY, prevY, rect);
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$3, [
    ...
    createBaseVNode(
      "div",
      {
        class: normalizeClass(["grid w-full flex-1 grid-cols-7 border-l-[1px] border-t-[1px]", $props.currentMonthDates.length > 35 ? "grid-rows-6" : "grid-rows-5"])
      },
      [
        (openBlock(true), createElementBlock(
          Fragment,
                  ...
                  createBaseVNode("div", _hoisted_5$2, [
                    $setup.currentMonthDate(date) ? (openBlock(), createElementBlock(
                      "span",
                      {
                        key: 0,
                        class: normalizeClass([
                          "z-10 w-full bg-white py-1 text-center",
...
const CalendarTimeMarker_vue_vue_type_style_index_0_scoped_d36ad733_lang = "";
const _sfc_main$3 = {
...
const CalendarWeekly_vue_vue_type_style_index_0_lang = "";
const _sfc_main$2 = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = { props, gridRef, allDayCells, showCollapsable, isCollapsed, hourHeight, minuteHeight, timedEvents, fullDayEvents, isToday, calendarActions, redundantCellHeight, getCellHeight, getFullDayEventsInCurrentWeek, getFullDayEventsCount, setFullDayEventsHeight, ref, onMounted, watch, computed, inject, CalendarEvent, CalendarTimeMarker, get twentyFourHoursFormat() {
      ...
      return parseDate;
    }, Button, ShowMoreCalendarEvent, get useCalendarData() {
      return useCalendarData;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    onMounted(() => {
      if (!overrideConfig.enableShortcuts)
        return;
