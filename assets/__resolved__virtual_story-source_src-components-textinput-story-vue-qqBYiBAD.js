const __resolved__virtual_storySource_srcComponentsTextinputStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsTextinputStoryVue as default
};
