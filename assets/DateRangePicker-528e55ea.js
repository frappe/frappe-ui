import { aA as resolveComponent, aB as openBlock, aG as createElementBlock, aN as toDisplayString, aH as createCommentVNode, aF as createBaseVNode, aC as createBlock, aW as normalizeClass, aL as mergeProps, aK as Fragment, aJ as renderList, az as ref, aQ as computed, ay as defineComponent, bu as onMounted, aD as withCtx, aE as createVNode } from "./vendor-257495bd.js";
import { B as Button } from "./Button-124b7fe6.js";
import { P as Popover } from "./Popover-9c8f0d6a.js";
import { F as FeatherIcon } from "./FeatherIcon-a704fda0.js";
import { T as TextInput } from "./TextInput-bd1dffce.js";
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, currentYear, currentMonth, today, datesAsWeeks, formattedMonth, prevMonth, nextMonth, dateValue, selectDate, selectCurrentMonthYear, Input, Button, Popover, FeatherIcon, TextInput, get getDate() {
      return getDate;
    }, get getDateValue() {
      return getDateValue;
    } };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    onMounted(() => selectCurrentMonthYear());
    const __returned__ = { props, emit, currentYear, currentMonth, today, datesAsWeeks, formattedMonth, prevMonth, nextMonth, hour, minute, second, dateValue, changeTime, selectDate, toValue, twoDigit, updateDate, selectCurrentMonthYear, Input, Button, Popover, FeatherIcon, TextInput, get getDate() {
      return getDate;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    onMounted(() => selectCurrentMonthYear());
    const __returned__ = { props, emit, currentYear, currentMonth, today, datesAsWeeks, formattedMonth, prevMonth, nextMonth, dateValue, fromDate, toDate, handleDateClick, swapDatesIfNecessary, selectDates, selectCurrentMonthYear, isInRange, formatDates, clearDates, Input, Button, Popover, FeatherIcon, TextInput, get getDateValue() {
      return getDateValue;
    } };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
