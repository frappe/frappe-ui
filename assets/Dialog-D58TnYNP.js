import { aP as markRaw, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, ay as defineComponent, aW as computed, aI as reactive, cU as _sfc_main$1, cV as _sfc_main$2, cW as _sfc_main$3, cX as _sfc_main$4, co as _sfc_main$5, cp as _sfc_main$6, cY as _sfc_main$7, aC as createBlock, aD as withCtx, aE as createVNode, aR as normalizeClass, aZ as renderSlot, aH as createCommentVNode, aN as toDisplayString, aS as normalizeProps, aT as guardReactiveProps, aK as Fragment, aJ as renderList, aL as mergeProps, aM as createTextVNode } from "./vendor-DmART1uI.js";
import { B as Button } from "./Button-CKLaiXOF.js";
...
const LucideX = markRaw({ name: "lucide-x", render });
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, actions, isOpen, handleOpenChange, close, icon, dialogPositionClasses, dialogIconBgClasses, dialogIconClasses, get DialogRoot() {
      return _sfc_main$1;
    }, get DialogPortal() {
      return _sfc_main$2;
    }, get DialogOverlay() {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  const _component_LucideX = LucideX;
              ...
              createBaseVNode(
                ...
                [
                  createVNode($setup["DialogContent"], {
                    class: normalizeClass(["my-8 inline-block w-full transform overflow-hidden rounded-xl bg-surface-modal text-left align-middle shadow-xl dialog-content", {
                                    ...
                                    createVNode($setup["DialogClose"], { "as-child": "" }, {
                                      default: withCtx(() => [
                                        createVNode($setup["Button"], {
                                          ...
                                          icon: withCtx(() => [
                                            createVNode(_component_LucideX, { class: "h-4 w-4 text-ink-gray-9" })
                                          ]),
                                          _: 1
                                          /* STABLE */
                                        })
