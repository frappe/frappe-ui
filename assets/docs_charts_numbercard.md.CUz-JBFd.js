import{_ as z}from"./chunks/PropsTable.CdVl1Sdm.js";import{_ as j}from"./chunks/SlotsTable.Dra6Fan0.js";import{K as C}from"./chunks/theme.CaQ7ZXrm.js";import{_ as y}from"./chunks/NumberCard.vue_vue_type_script_setup_true_lang.iBti9GnB.js";import{J as k,ae as t,r as _,F as g,an as b,E as e,aG as r,$ as x,a2 as S,M as O,bf as p,o as s,aw as T,p as P,ak as A,ap as w,B as f,D as a}from"./chunks/framework.CZ-ntRvv.js";import"./chunks/format.9CiYcFxf.js";import"./chunks/tokens.rU4hPjXc.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.BdQYGdjw.js";const R={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},D=k({__name:"NumberSparklines",setup(m){const l=[{title:"Signups",value:1284,delta:12.5,deltaSuffix:"%",deltaCaption:"vs last month",sparkline:{data:[842,906,971,1044,1123,1018,1067,1142,1196,1218,1247,1284]}},{title:"Orders shipped",value:2560,sparkline:{data:[1786,1852,1921,2094,2274,2064,2120,2222,2292,2378,2452,2560],type:"bar"}},{title:"Pipeline",value:1845e4,prefix:"$",format:i=>new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1}).format(i),sparkline:{data:[12.4,13.1,13.9,15.2,16,15.1,15.8,16.4,17.1,17.6,18,18.45]}},{title:"Storage used",value:61,suffix:"%",color:"#f59e0b",sparkline:{data:[42,44,46,49,51,52,54,56,57,59,60,61],color:"#f59e0b"}}];return(i,u)=>(t(),_("div",R,[(t(),_(g,null,b(l,v=>e(r(y),x({key:v.title},{ref_for:!0},v),null,16)),64))]))}}),E={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},N={type:"button",class:"-mx-1 flex h-5 min-w-0 items-center gap-1 rounded-sm px-1 text-sm text-ink-gray-5 outline-none hover:bg-surface-gray-2 hover:text-ink-gray-7 focus-visible:ring-2 focus-visible:ring-outline-gray-3"},L={class:"truncate"},F=k({__name:"NumberKpis",setup(m){const o=[{title:"Net revenue",value:220200,target:25e4,prefix:"$",format:l=>new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1}).format(l),delta:5.1,deltaSuffix:"%",sparkline:{data:[144500,150700,157400,172700,188600,171700,177100,186700,193600,202100,209500,220200]}},{title:"Monthly churn",value:2.1,suffix:"%",format:l=>l.toFixed(1),delta:-.4,deltaSuffix:"pts",deltaCaption:"vs last month",negativeIsBetter:!0},{title:"Orders shipped",value:2560},{title:"Refunds",value:null}],n=A("last month"),c=["last month","last quarter","last year"].map(l=>({label:`vs ${l}`,onClick:()=>n.value=l}));return(l,i)=>(t(),_("div",E,[e(r(y),S(O(o[0])),{caption:p(()=>[e(r(C),{options:r(c),placement:"left"},{default:p(()=>[s("button",N,[s("span",L,"vs "+T(n.value),1),i[0]||(i[0]=s("span",{class:"lucide-chevron-down size-3.5 shrink-0","aria-hidden":"true"},null,-1))])]),_:1},8,["options"])]),_:1},16),(t(!0),_(g,null,b(o.slice(1),u=>(t(),P(r(y),x({key:u.title},{ref_for:!0},u),null,16))),128))]))}}),G=JSON.parse('{"title":"NumberCard","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/numbercard.md","filePath":"docs/charts/numbercard.md","lastUpdated":0}'),I={name:"docs/charts/numbercard.md"},K=Object.assign(I,{setup(m){const h=[{name:"title",description:`Heads the card. Left out, the chart draws no header row at all.
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:p(()=>[e(F)]),_:1})]),_:1}),n[4]||(n[4]=f('<h2 id="sparklines" tabindex="-1">Sparklines <a class="header-anchor" href="#sparklines" aria-label="Permalink to “Sparklines”">​</a></h2><p><code>sparkline</code> adds a trend across the bottom of the card: shape only, with no axes to read against. <code>type</code> names the mark the way every other chart does. <code>area</code>, the default, suits a continuous reading; <code>line</code> draws the stroke alone; <code>bar</code> suits a reading the eye counts in periods.</p>',2)),e(l,null,{default:p(()=>[e(c,{name:"Charts-NumberSparklines","self-layout":""},{code:p(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"NumberCard"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"NumberCardProps"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:p(()=>[e(D)]),_:1})]),_:1}),n[5]||(n[5]=f('<p><code>color</code> prints the reading in an ink you name, for a card standing for a series that is drawn in that color elsewhere on the page — the storage card above is printed in the color of the trend under it. It is one color for one mark, the way <code>seriesConfig[key].color</code> names a series&#39; own. It does not restyle the card, and the delta keeps the tone that says which way the number moved.</p><h2 id="the-title-row" tabindex="-1">The title row <a class="header-anchor" href="#the-title-row" aria-label="Permalink to “The title row”">​</a></h2><p><code>#actions</code> goes at the end of the row and <code>#title-suffix</code> right after the title text. Neither adds height to the row: both centre on the title, so the number stays where it is. The card&#39;s title is smaller than a chart&#39;s and <code>#title-suffix</code> renders in it, so the same mark sized in <code>em</code> comes out smaller here than on a <code>ChartContainer</code>.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2>',4)),e(z,{name:"NumberCard",data:h},{code:p(()=>[...n[2]||(n[2]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),e(j,{data:d})])}}});export{G as __pageData,K as default};
