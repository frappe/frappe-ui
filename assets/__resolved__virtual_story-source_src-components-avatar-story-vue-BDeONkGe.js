const __resolved__virtual_storySource_srcComponentsAvatarStoryVue = `<script setup lang="ts">
...
`;
export {
  __resolved__virtual_storySource_srcComponentsAvatarStoryVue as default
};
