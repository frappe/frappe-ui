const __resolved__virtual_storySource_srcComponentsCircularprogressbarCircularprogressbarStoryVue = `<template>
...
`;
export {
  __resolved__virtual_storySource_srcComponentsCircularprogressbarCircularprogressbarStoryVue as default
};
