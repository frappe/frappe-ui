import { ay as defineComponent, bG as useAttrs, aW as computed, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, aL as mergeProps, aR as normalizeClass, aN as toDisplayString, aH as createCommentVNode } from "./vendor-ZKdfit2u.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const inputClasses = computed(() => {
      let baseClasses = props.disabled ? "border-outline-gray-2 bg-surface-menu-bar text-ink-gray-3" : "border-outline-gray-4 text-ink-gray-9 hover:border-outline-gray-5 focus:ring-offset-0 focus:border-outline-gray-8 active:border-outline-gray-6 transition";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    {
      class: normalizeClass(["inline-flex space-x-2 rounded transition bg-surface-white", {
