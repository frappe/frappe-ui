import{a9 as Ne,aV as Ke,aW as Je,bu as H}from"./chunks/theme.DszW0fKS.js";import{J as Qe,ae as l,r as p,o as r,E as y,aG as c,bf as a,aw as g,p as V,F as $e,an as Ye,ak as t1,l as e1,ap as o1,B as A}from"./chunks/framework.CZ-ntRvv.js";const s1=`
<svg
...
`;const Uo=`
<svg
  class="lucide lucide-audio-lines-x"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const vl=`
<svg
  class="lucide lucide-circle-euro"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const N2=`
<svg
  class="lucide lucide-face-grinning"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const K2=`
<svg
  class="lucide lucide-face-expressionless"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const J2=`
<svg
  class="lucide lucide-face-neutral"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const Q2=`
<svg
  class="lucide lucide-face-slightly-frowning"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const gu=`
<svg
  class="lucide lucide-layers-arrow-up"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const Mu=`
<svg
  class="lucide lucide-layout-freeform"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const F3=`
<svg
  class="lucide lucide-mic-audio-lines"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const Nt=`
<svg
  class="lucide lucide-mic-signal"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const S8=`
<svg
  class="lucide lucide-scan-square"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const m7=`
<svg
  class="lucide lucide-shield-keyhole"
  xmlns="http://www.w3.org/2000/svg"
  width="24"
  height="24"
  viewBox="0 0 24 24"
...
`;const xC=Object.freeze(Object.defineProperty({__proto__:null,AArrowDown:s1,AArrowUp:r1,ALargeSmall:n1,Accessibility:i1,Activity:l1,ActivitySquare:B0,Ad:h1,AirVent:a1,Airplay:d1,AlarmCheck:b,AlarmClock:w1,AlarmClockCheck:b,AlarmClockMinus:z,AlarmClockOff:c1,AlarmClockPlus:L,AlarmMinus:z,AlarmPlus:L,AlarmSmoke:p1,Album:u1,AlertCircle:i2,AlertOctagon:Qt,AlertTriangle:Le,AlignCenter:je,AlignCenterHorizontal:v1,AlignCenterVertical:g1,AlignEndHorizontal:k1,AlignEndVertical:x1,AlignHorizontalDistributeCenter:M1,AlignHorizontalDistributeEnd:m1,AlignHorizontalDistributeStart:f1,AlignHorizontalJustifyCenter:C1,AlignHorizontalJustifyEnd:B1,AlignHorizontalJustifyStart:y1,AlignHorizontalSpaceAround:j1,AlignHorizontalSpaceBetween:H1,AlignJustify:He,AlignLeft:j,AlignRight:ye,AlignStartHorizontal:V1,AlignStartVertical:A1,AlignVerticalDistributeCenter:b1,AlignVerticalDistributeEnd:z1,AlignVerticalDistributeStart:S1,AlignVerticalJustifyCenter:L1,AlignVerticalJustifyEnd:_1,AlignVerticalJustifyStart:q1,AlignVerticalSpaceAround:P1,AlignVerticalSpaceBetween:F1,Ambulance:D1,Ampersand:T1,Ampersands:R1,Amphora:Z1,Anchor:U1,Angle:I1,Angry:X2,Annoyed:K2,Antenna:O1,Anvil:G1,Aperture:W1,AppWindow:X1,AppWindowMac:E1,Apple:N1,Archive:Q1,ArchiveRestore:K1,ArchiveX:J1,AreaChart:E,Armchair:$1,ArrowBigDown:to,ArrowBigDownDash:Y1,ArrowBigLeft:oo,ArrowBigLeftDash:eo,ArrowBigRight:ro,ArrowBigRightDash:so,ArrowBigUp:no,ArrowBigUpDash:io,ArrowDown:ko,ArrowDown01:lo,ArrowDown10:ho,ArrowDownAZ:S,ArrowDownAz:S,ArrowDownCircle:n2,ArrowDownFromLine:ao,ArrowDownLeft:co,ArrowDownLeftFromCircle:h2,ArrowDownLeftFromSquare:A0,ArrowDownLeftSquare:j0,ArrowDownNarrowWide:wo,ArrowDownRight:po,ArrowDownRightFromCircle:a2,ArrowDownRightFromSquare:b0,ArrowDownRightSquare:y0,ArrowDownSquare:H0,ArrowDownToDot:uo,ArrowDownToLine:go,ArrowDownUp:vo,ArrowDownWideNarrow:_,ArrowDownZA:q,ArrowDownZa:q,ArrowLeft:fo,ArrowLeftCircle:l2,ArrowLeftFromLine:xo,ArrowLeftRight:Mo,ArrowLeftSquare:V0,ArrowLeftToLine:mo,ArrowRight:yo,ArrowRightCircle:w2,ArrowRightFromLine:Co,ArrowRightLeft:Bo,ArrowRightSquare:S0,ArrowRightToLine:jo,ArrowUp:Po,ArrowUp01:Ho,ArrowUp10:Vo,ArrowUpAZ:P,ArrowUpAz:P,ArrowUpCircle:p2,ArrowUpDown:Ao,ArrowUpFromDot:bo,ArrowUpFromLine:zo,ArrowUpLeft:Lo,ArrowUpLeftFromCircle:d2,ArrowUpLeftFromSquare:z0,ArrowUpLeftSquare:_0,ArrowUpNarrowWide:F,ArrowUpRight:So,ArrowUpRightFromCircle:c2,ArrowUpRightFromSquare:L0,ArrowUpRightSquare:q0,ArrowUpSquare:P0,ArrowUpToLine:_o,ArrowUpWideNarrow:qo,ArrowUpZA:D,ArrowUpZa:D,ArrowsUpFromLine:Fo,Asterisk:Do,AsteriskSquare:F0,Astroid:To,AtSign:Ro,Atom:Zo,AudioLines:Oo,AudioLinesX:Uo,AudioWaveform:Io,Award:Go,Axe:Wo,Axis3D:T,Axis3d:T,Baby:Eo,Backpack:Xo,Badge:ds,BadgeAlert:Ko,BadgeCent:No,BadgeCheck:R,BadgeDollarSign:Jo,BadgeEuro:Qo,BadgeHelp:Z,BadgeIndianRupee:$o,BadgeInfo:Yo,BadgeJapaneseYen:ts,BadgeMinus:es,BadgePercent:os,BadgePlus:rs,BadgePoundSterling:ss,BadgeQuestionMark:Z,BadgeRussianRuble:is,BadgeSwissFranc:ns,BadgeTurkishLira:ls,BadgeX:hs,BaggageClaim:as,Balloon:cs,Ban:ws,Banana:ps,Bandage:us,Banknote:Ms,BanknoteArrowDown:gs,BanknoteArrowUp:vs,BanknoteCheck:ks,BanknoteX:xs,BarChart:t2,BarChart2:e2,BarChart3:$,BarChart4:Q,BarChartBig:J,BarChartHorizontal:N,BarChartHorizontalBig:X,Barcode:ms,Barrel:fs,Baseline:Cs,Bath:Bs,Battery:zs,BatteryCharging:js,BatteryFull:ys,BatteryLow:Hs,BatteryMedium:Vs,BatteryPlus:As,BatteryWarning:bs,Beaker:Ls,Bean:_s,BeanOff:Ss,Bed:Fs,BedDouble:qs,BedSingle:Ps,Beef:Ts,BeefOff:Ds,Beer:Zs,BeerOff:Rs,Bell:Ns,BellCheck:Us,BellDot:Os,BellElectric:Is,BellMinus:Gs,BellOff:Ws,BellPlus:Es,BellRing:Xs,BetweenHorizonalEnd:U,BetweenHorizonalStart:O,BetweenHorizontalEnd:U,BetweenHorizontalStart:O,BetweenVerticalEnd:Ks,BetweenVerticalStart:Js,BicepsFlexed:Qs,Bike:$s,Binary:Ys,Binoculars:tr,Biohazard:er,Bird:or,Birdhouse:sr,Bitcoin:rr,Blend:ir,Blender:nr,Blinds:lr,Blocks:hr,Bluetooth:wr,BluetoothConnected:ar,BluetoothOff:dr,BluetoothSearching:cr,Bold:pr,Bolt:ur,Bomb:gr,Bone:kr,BoneFracture:vr,Book:Or,BookA:xr,BookAlert:Mr,BookAudio:mr,BookCheck:fr,BookCopy:Cr,BookDashed:I,BookDown:Br,BookHeadphones:jr,BookHeart:yr,BookImage:Hr,BookKey:Vr,BookLock:Ar,BookMarked:br,BookMinus:zr,BookOpen:_r,BookOpenCheck:Lr,BookOpenText:Sr,BookPlus:qr,BookSearch:Pr,BookTemplate:I,BookText:Fr,BookType:Dr,BookUp:Rr,BookUp2:Tr,BookUser:Zr,BookX:Ur,Bookmark:Nr,BookmarkCheck:Ir,BookmarkMinus:Gr,BookmarkOff:Wr,BookmarkPlus:Er,BookmarkX:Xr,BoomBox:Kr,Bot:$r,BotMessageSquare:Jr,BotOff:Qr,BottleWine:Yr,BowArrow:ti,Box:ei,BoxSelect:K0,Boxes:oi,Braces:G,Brackets:si,Brain:ni,BrainCircuit:ri,BrainCog:ii,BrickWall:ai,BrickWallFire:li,BrickWallShield:hi,Briefcase:wi,BriefcaseBusiness:di,BriefcaseConveyorBelt:ci,BriefcaseMedical:pi,BringToFront:ui,Broccoli:gi,Broom:ki,BroomSparkles:vi,Brush:Mi,BrushCleaning:xi,Bubbles:mi,Bug:Bi,BugOff:fi,BugPlay:Ci,Building:yi,Building2:ji,Bus:Vi,BusFront:Hi,Cable:bi,CableCar:Ai,Cake:Li,CakeSlice:zi,Calculator:Si,Calendar:Yi,Calendar1:_i,CalendarArrowDown:qi,CalendarArrowUp:Pi,CalendarCheck:Di,CalendarCheck2:Fi,CalendarClock:Ti,CalendarCog:Ri,CalendarDays:Zi,CalendarFold:Ui,CalendarHeart:Oi,CalendarMinus:Gi,CalendarMinus2:Ii,CalendarOff:Wi,CalendarPlus:Xi,CalendarPlus2:Ei,CalendarRange:Ni,CalendarSearch:Ki,CalendarSync:Ji,CalendarX:$i,CalendarX2:Qi,Calendars:tn,Camera:on,CameraOff:en,CandlestickChart:K,Candy:hn,CandyCane:sn,CandyOff:rn,Cannabis:ln,CannabisOff:nn,Captions:W,CaptionsOff:an,Car:wn,CarFront:dn,CarTaxiFront:cn,Caravan:pn,CardSim:gn,Carrot:un,CaseLower:vn,CaseSensitive:kn,CaseUpper:xn,CassetteTape:Mn,Cast:mn,Castle:Bn,Cat:fn,Cctv:Cn,CctvOff:jn,ChartArea:E,ChartBar:N,ChartBarBig:X,ChartBarDecreasing:yn,ChartBarIncreasing:Hn,ChartBarStacked:Vn,ChartCandlestick:K,ChartColumn:$,ChartColumnBig:J,ChartColumnDecreasing:An,ChartColumnIncreasing:Q,ChartColumnStacked:bn,ChartGantt:zn,ChartLine:Y,ChartNetwork:Ln,ChartNoAxesColumn:e2,ChartNoAxesColumnDecreasing:Sn,ChartNoAxesColumnIncreasing:t2,ChartNoAxesCombined:_n,ChartNoAxesGantt:o2,ChartPie:s2,ChartScatter:r2,ChartSpline:qn,Check:Dn,CheckCheck:Fn,CheckCircle:u2,CheckCircle2:g2,CheckLine:Pn,CheckSquare:Z0,CheckSquare2:U0,ChefHat:Tn,Cherry:Rn,ChessBishop:Zn,ChessKing:Un,ChessKnight:On,ChessPawn:In,ChessQueen:Gn,ChessRook:Wn,ChevronDown:En,ChevronDownCircle:v2,ChevronDownSquare:O0,ChevronFirst:Xn,ChevronLast:Nn,ChevronLeft:Jn,ChevronLeftCircle:k2,ChevronLeftSquare:I0,ChevronRight:Kn,ChevronRightCircle:x2,ChevronRightSquare:W0,ChevronUp:Qn,ChevronUpCircle:M2,ChevronUpSquare:G0,ChevronsDown:Yn,ChevronsDownUp:$n,ChevronsLeft:el,ChevronsLeftRight:ol,ChevronsLeftRightEllipsis:tl,ChevronsRight:rl,ChevronsRightLeft:sl,ChevronsUp:nl,ChevronsUpDown:il,Church:ll,Cigarette:al,CigaretteOff:hl,Circle:yl,CircleAlert:i2,CircleArrowDown:n2,CircleArrowLeft:l2,CircleArrowOutDownLeft:h2,CircleArrowOutDownRight:a2,CircleArrowOutUpLeft:d2,CircleArrowOutUpRight:c2,CircleArrowRight:w2,CircleArrowUp:p2,CircleCheck:g2,CircleCheckBig:u2,CircleChevronDown:v2,CircleChevronLeft:k2,CircleChevronRight:x2,CircleChevronUp:M2,CircleDashed:dl,CircleDivide:m2,CircleDollarSign:cl,CircleDot:pl,CircleDotDashed:wl,CircleEllipsis:ul,CircleEqual:gl,CircleEuro:vl,CircleFadingArrowUp:kl,CircleFadingPlus:xl,CircleGauge:f2,CircleHelp:v,CircleMinus:C2,CircleOff:Ml,CircleParking:y2,CircleParkingOff:B2,CirclePause:j2,CirclePercent:H2,CirclePile:ml,CirclePlay:V2,CirclePlus:A2,CirclePoundSterling:fl,CirclePower:b2,CircleQuestionMark:v,CircleSlash:Cl,CircleSlash2:z2,CircleSlashed:z2,CircleSmall:Bl,CircleStar:jl,CircleStop:L2,CircleUser:_2,CircleUserRound:S2,CircleX:q2,CircuitBoard:Hl,Citrus:Vl,Clapperboard:Al,Clipboard:Tl,ClipboardCheck:bl,ClipboardClock:zl,ClipboardCopy:Ll,ClipboardEdit:F2,ClipboardList:Sl,ClipboardMinus:_l,ClipboardPaste:ql,ClipboardPen:F2,ClipboardPenLine:P2,ClipboardPlus:Pl,ClipboardSignature:P2,ClipboardType:Fl,ClipboardX:Dl,Clock:ih,Clock1:Rl,Clock10:Zl,Clock11:Ul,Clock12:Ol,Clock2:Il,Clock3:Gl,Clock4:Wl,Clock5:El,Clock6:Xl,Clock7:Nl,Clock8:Kl,Clock9:Jl,ClockAlert:Ql,ClockArrowDown:$l,ClockArrowLeft:Yl,ClockArrowRight:th,ClockArrowUp:eh,ClockCheck:oh,ClockFading:sh,ClockPlus:rh,ClosedCaption:nh,Cloud:jh,CloudAlert:lh,CloudBackup:hh,CloudCheck:ah,CloudCog:dh,CloudDownload:D2,CloudDrizzle:ch,CloudFog:wh,CloudHail:ph,CloudLightning:uh,CloudMoon:vh,CloudMoonRain:gh,CloudOff:kh,CloudRain:Mh,CloudRainWind:xh,CloudSnow:mh,CloudSun:Ch,CloudSunRain:fh,CloudSync:Bh,CloudUpload:T2,Cloudy:yh,Clover:Hh,Club:Vh,Code:Ah,Code2:R2,CodeSquare:E0,CodeXml:R2,Coffee:bh,Cog:zh,Coins:Lh,Columns:Z2,Columns2:Z2,Columns3:U2,Columns3Cog:k,Columns4:Sh,ColumnsSettings:k,Combine:_h,Command:qh,Compass:Ph,Component:Fh,Computer:Dh,ConciergeBell:Th,Cone:Rh,Construction:Zh,Contact:Uh,Contact2:O2,ContactRound:O2,Container:Oh,Contrast:Ih,Cookie:Gh,CookingPot:Wh,Copy:Qh,CopyCheck:Eh,CopyMinus:Xh,CopyPlus:Nh,CopySlash:Kh,CopyX:Jh,Copyleft:$h,Copyright:Yh,CornerDownLeft:ta,CornerDownRight:ea,CornerLeftDown:oa,CornerLeftUp:sa,CornerRightDown:ra,CornerRightUp:ia,CornerUpLeft:la,CornerUpRight:na,Cpu:ha,CreativeCommons:aa,CreditCard:da,Croissant:ca,Crop:wa,Cross:pa,Crosshair:ua,Crown:ga,Cuboid:va,CupSoda:ka,CurlyBraces:G,Currency:xa,Cylinder:Ma,Dam:ma,Database:za,DatabaseArrowDown:fa,DatabaseArrowUp:Ca,DatabaseBackup:Ba,DatabaseCheck:ja,DatabaseMinus:ya,DatabasePlus:Ha,DatabaseSearch:Va,DatabaseX:Aa,DatabaseZap:ba,DecimalsArrowLeft:La,DecimalsArrowRight:Sa,Delete:_a,Dessert:qa,Diameter:Pa,Diamond:Ta,DiamondMinus:Fa,DiamondPercent:I2,DiamondPlus:Da,Dice1:Ra,Dice2:Ua,Dice3:Za,Dice4:Oa,Dice5:Ia,Dice6:Ga,Dices:Wa,Diff:Ea,Disc:Qa,Disc2:Xa,Disc3:Na,DiscAlbum:Ka,Divide:Ja,DivideCircle:m2,DivideSquare:J0,Dna:Ya,DnaOff:$a,Dock:td,Dog:ed,DollarSign:od,Donut:sd,DoorClosed:id,DoorClosedLocked:rd,DoorOpen:nd,Dot:ld,DotSquare:Q0,Download:hd,DownloadCloud:D2,DraftingCompass:ad,Drama:dd,Drill:cd,Drone:wd,Droplet:ud,DropletOff:pd,Droplets:gd,Drum:vd,Drumstick:kd,Dumbbell:xd,Ear:md,EarOff:Md,Earth:G2,EarthLock:fd,Eclipse:Cd,Edit:w,Edit2:d0,Edit3:a0,Egg:yd,EggFried:Bd,EggOff:jd,Eject:Hd,Ellipse:Vd,Ellipsis:E2,EllipsisVertical:W2,Equal:zd,EqualApproximately:Ad,EqualNot:bd,EqualSquare:$0,Eraser:Ld,EthernetPort:Sd,Euro:_d,EvCharger:qd,Expand:Pd,ExternalLink:Fd,Eye:Zd,EyeClosed:Dd,EyeDashed:Td,EyeOff:Rd,FaceAngry:X2,FaceExpressionless:K2,FaceGrinning:N2,FaceNeutral:J2,FaceSlightlyFrowning:Q2,FaceSlightlySmiling:Y2,FaceSlightlySmilingPlus:$2,Factory:Ud,Fan:Od,FastForward:Id,Feather:Wd,Fence:Gd,FerrisWheel:Ed,File:fc,FileArchive:Xd,FileAudio:x,FileAudio2:x,FileAxis3D:tt,FileAxis3d:tt,FileBadge:et,FileBadge2:et,FileBarChart:rt,FileBarChart2:it,FileBox:Nd,FileBraces:st,FileBracesCorner:ot,FileChartColumn:it,FileChartColumnIncreasing:rt,FileChartLine:nt,FileChartPie:lt,FileCheck:Kd,FileCheck2:ht,FileCheckCorner:ht,FileClock:Jd,FileCode:Qd,FileCode2:at,FileCodeCorner:at,FileCog:dt,FileCog2:dt,FileDiff:$d,FileDigit:Yd,FileDown:tc,FileEdit:vt,FileExclamationPoint:ct,FileHeadphone:x,FileHeart:ec,FileImage:oc,FileInput:sc,FileJson:st,FileJson2:ot,FileKey:wt,FileKey2:wt,FileLineChart:nt,FileLock:pt,FileLock2:pt,FileMinus:rc,FileMinus2:ut,FileMinusCorner:ut,FileMusic:ic,FileOutput:nc,FilePen:vt,FilePenLine:gt,FilePieChart:lt,FilePlay:kt,FilePlus:lc,FilePlus2:xt,FilePlusCorner:xt,FileQuestion:Mt,FileQuestionMark:Mt,FileScan:hc,FileSearch:ac,FileSearch2:mt,FileSearchCorner:mt,FileSignal:ft,FileSignature:gt,FileSliders:dc,FileSpreadsheet:cc,FileStack:wc,FileSymlink:pc,FileTerminal:uc,FileText:gc,FileType:vc,FileType2:Ct,FileTypeCorner:Ct,FileUp:kc,FileUser:xc,FileVideo:kt,FileVideo2:Bt,FileVideoCamera:Bt,FileVolume:Mc,FileVolume2:ft,FileWarning:ct,FileX:mc,FileX2:jt,FileXCorner:jt,Files:Cc,Film:Bc,Filter:At,FilterX:bt,Fingerprint:yt,FingerprintPattern:yt,FireExtinguisher:jc,Fish:Vc,FishOff:yc,FishSymbol:Hc,FishingHook:bc,FishingRod:Ac,Flag:_c,FlagOff:zc,FlagTriangleLeft:Lc,FlagTriangleRight:Sc,Flame:Pc,FlameKindling:qc,Flashlight:Dc,FlashlightOff:Fc,FlaskConical:Rc,FlaskConicalOff:Tc,FlaskRound:Zc,FlipHorizontal:T0,FlipHorizontal2:Uc,FlipVertical:R0,FlipVertical2:Oc,Flower:Gc,Flower2:Ic,Focus:Wc,FoldHorizontal:Ec,FoldVertical:Xc,Folder:C4,FolderArchive:Nc,FolderBookmark:Kc,FolderCheck:Jc,FolderClock:Qc,FolderClosed:$c,FolderCode:Yc,FolderCog:Ht,FolderCog2:Ht,FolderDot:t4,FolderDown:e4,FolderEdit:Vt,FolderGit:s4,FolderGit2:o4,FolderHeart:r4,FolderInput:i4,FolderKanban:n4,FolderKey:l4,FolderLock:h4,FolderMinus:a4,FolderOpen:c4,FolderOpenDot:d4,FolderOutput:w4,FolderPen:Vt,FolderPlus:p4,FolderRoot:u4,FolderSearch:v4,FolderSearch2:g4,FolderSymlink:k4,FolderSync:x4,FolderTree:M4,FolderUp:m4,FolderX:f4,Folders:B4,Footprints:j4,ForkKnife:Oe,ForkKnifeCrossed:Ue,Forklift:y4,Form:H4,FormInput:w0,Forward:V4,Frame:A4,Frown:Q2,Fuel:b4,Fullscreen:z4,FunctionSquare:Y0,Funnel:At,FunnelPlus:L4,FunnelX:bt,GalleryHorizontal:S4,GalleryHorizontalEnd:_4,GalleryThumbnails:q4,GalleryVertical:F4,GalleryVerticalEnd:P4,Gamepad:T4,Gamepad2:D4,GamepadDirectional:R4,GanttChart:o2,GanttChartSquare:C,Gauge:Z4,GaugeCircle:f2,Gavel:U4,Gem:O4,GeorgianLari:I4,Ghost:G4,Gift:W4,GitBranch:N4,GitBranchMinus:E4,GitBranchPlus:X4,GitCommit:zt,GitCommitHorizontal:zt,GitCommitVertical:K4,GitCompare:Q4,GitCompareArrows:J4,GitFork:$4,GitGraph:Y4,GitMerge:ew,GitMergeConflict:tw,GitPullRequest:lw,GitPullRequestArrow:ow,GitPullRequestClosed:sw,GitPullRequestCreate:iw,GitPullRequestCreateArrow:rw,GitPullRequestDraft:nw,GlassWater:cw,Glasses:hw,Globe:uw,Globe2:G2,GlobeCheck:aw,GlobeLock:dw,GlobeOff:ww,GlobeX:pw,Goal:vw,Gpu:gw,Grab:Pt,GraduationCap:kw,Grape:xw,Grid:M,Grid2X2:_t,Grid2X2Check:Lt,Grid2X2Plus:St,Grid2X2X:qt,Grid2x2:_t,Grid2x2Check:Lt,Grid2x2Plus:St,Grid2x2X:qt,Grid3X3:M,Grid3x2:Mw,Grid3x3:M,Grip:Cw,GripHorizontal:mw,GripVertical:fw,Group:jw,Guitar:Bw,Ham:yw,Hamburger:Hw,Hammer:Vw,Hand:_w,HandCoins:Aw,HandFist:bw,HandGrab:Pt,HandHeart:zw,HandHelping:Ft,HandMetal:Lw,HandPlatter:Sw,Handbag:qw,Handshake:Pw,HardDrive:Tw,HardDriveDownload:Fw,HardDriveUpload:Dw,HardHat:Rw,Hash:Zw,HatGlasses:Uw,Haze:Ow,Hd:Iw,HdmiPort:Gw,Heading:$w,Heading1:Ww,Heading2:Ew,Heading3:Xw,Heading4:Nw,Heading5:Kw,Heading6:Jw,HeadphoneOff:Qw,Headphones:Yw,Headset:tp,Heart:hp,HeartCrack:ep,HeartHandshake:op,HeartMinus:rp,HeartOff:sp,HeartPlus:np,HeartPulse:ip,HeartX:lp,Heater:ap,Helicopter:dp,HelpCircle:v,HelpingHand:Ft,Hexagon:cp,Highlighter:wp,History:u0,Home:Dt,Hop:up,HopOff:pp,Hospital:vp,Hotel:gp,Hourglass:kp,House:Dt,HouseHeart:xp,HousePlug:Mp,HousePlus:mp,HouseWifi:fp,IceCream:Rt,IceCream2:Tt,IceCreamBowl:Tt,IceCreamCone:Rt,IdCard:Cp,IdCardLanyard:Bp,Image:zp,ImageDown:jp,ImageMinus:yp,ImageOff:Hp,ImagePlay:Vp,ImagePlus:Ap,ImageUp:bp,ImageUpscale:Lp,Images:Sp,Import:_p,Inbox:qp,Indent:f,IndentDecrease:m,IndentIncrease:f,IndianRupee:Pp,Infinity:Fp,Info:Dp,Inspect:ie,InspectionPanel:Tp,Italic:Zp,IterationCcw:Rp,IterationCw:Up,JapaneseYen:Op,Joystick:Ip,Kanban:Gp,KanbanSquare:te,KanbanSquareDashed:X0,Kayak:Wp,Key:Np,KeyRound:Ep,KeySquare:Xp,Keyboard:Qp,KeyboardMusic:Kp,KeyboardOff:Jp,Lamp:su,LampCeiling:$p,LampDesk:Yp,LampFloor:tu,LampWallDown:eu,LampWallUp:ou,LandPlot:ru,Landmark:iu,Languages:nu,Laptop:hu,Laptop2:Zt,LaptopMinimal:Zt,LaptopMinimalCheck:lu,Lasso:du,LassoSelect:au,Laugh:N2,LayerArrowDown:wu,LayerArrowUp:cu,Layers:Ut,Layers2:pu,Layers3:Ut,LayersArrowDown:uu,LayersArrowUp:gu,LayersMinus:vu,LayersPlus:ku,Layout:h0,LayoutDashboard:xu,LayoutFreeform:Mu,LayoutGrid:mu,LayoutList:fu,LayoutPanelLeft:Bu,LayoutPanelTop:Cu,LayoutTemplate:ju,Leaf:yu,LeafyGreen:Hu,Lectern:Vu,LensConcave:Au,LensConvex:zu,LetterText:Ve,Library:Lu,LibraryBig:bu,LibrarySquare:ee,LifeBuoy:_u,Ligature:Su,Lightbulb:Pu,LightbulbOff:qu,LineChart:Y,LineDotRightHorizontal:Fu,LineSquiggle:Du,LineStyle:Tu,Link:Uu,Link2:Zu,Link2Off:Ru,List:hg,ListCheck:Ou,ListChecks:Iu,ListChevronsDownUp:Gu,ListChevronsUpDown:Wu,ListCollapse:Eu,ListEnd:Xu,ListFilter:Ku,ListFilterPlus:Nu,ListIndentDecrease:m,ListIndentIncrease:f,ListMinus:Ju,ListMusic:Qu,ListOrdered:$u,ListPlus:Yu,ListRestart:tg,ListSortAscending:eg,ListSortDescending:og,ListStart:sg,ListTodo:rg,ListTree:ng,ListVideo:ig,ListX:lg,Loader:dg,Loader2:Ot,LoaderCircle:Ot,LoaderPinwheel:ag,Locate:pg,LocateFixed:cg,LocateOff:wg,LocationEdit:Et,Lock:gg,LockKeyhole:ug,LockKeyholeOpen:It,LockOpen:Gt,LogIn:vg,LogOut:kg,Logs:xg,Lollipop:Mg,Luggage:mg,MSquare:se,Magnet:fg,Mail:zg,MailBadge:Cg,MailCheck:Bg,MailMinus:jg,MailOpen:yg,MailPlus:Hg,MailQuestion:Wt,MailQuestionMark:Wt,MailSearch:Vg,MailWarning:Ag,MailX:bg,Mailbox:Lg,Mails:_g,Map:Ng,MapMinus:Sg,MapPin:Wg,MapPinCheck:Pg,MapPinCheckInside:qg,MapPinHouse:Fg,MapPinMinus:Tg,MapPinMinusInside:Dg,MapPinOff:Rg,MapPinPen:Et,MapPinPlus:Ug,MapPinPlusInside:Zg,MapPinSearch:Og,MapPinX:Gg,MapPinXInside:Ig,MapPinned:Xg,MapPlus:Eg,Mars:Kg,MarsStroke:Jg,Martini:Qg,Maximize:Yg,Maximize2:$g,Medal:t3,Megaphone:e3,MegaphoneOff:o3,Meh:J2,MemoryStick:s3,Menu:r3,MenuSquare:oe,Merge:i3,MessageCircle:v3,MessageCircleCheck:n3,MessageCircleCode:l3,MessageCircleDashed:h3,MessageCircleHeart:a3,MessageCircleMore:d3,MessageCircleOff:w3,MessageCirclePlus:c3,MessageCircleQuestion:Xt,MessageCircleQuestionMark:Xt,MessageCircleReply:p3,MessageCircleWarning:u3,MessageCircleX:g3,MessageSquare:_3,MessageSquareCheck:k3,MessageSquareCode:M3,MessageSquareDashed:x3,MessageSquareDiff:m3,MessageSquareDot:f3,MessageSquareHeart:C3,MessageSquareLock:B3,MessageSquareMore:j3,MessageSquareOff:y3,MessageSquarePlus:H3,MessageSquareQuote:V3,MessageSquareReply:A3,MessageSquareShare:b3,MessageSquareText:z3,MessageSquareWarning:S3,MessageSquareX:L3,MessagesSquare:q3,Metronome:P3,Mic:T3,Mic2:Kt,MicAudioLines:F3,MicOff:D3,MicSignal:Nt,MicVocal:Kt,Microchip:Z3,Microscope:R3,Microwave:U3,Milestone:O3,Milk:G3,MilkOff:I3,Minimize:W3,Minimize2:E3,Minus:N3,MinusCircle:C2,MinusSquare:re,MirrorRectangular:X3,MirrorRound:K3,Monitor:av,MonitorCheck:J3,MonitorCloud:Q3,MonitorCog:$3,MonitorDot:Y3,MonitorDown:tv,MonitorOff:ev,MonitorPause:ov,MonitorPlay:sv,MonitorSmartphone:rv,MonitorSpeaker:iv,MonitorStop:nv,MonitorUp:lv,MonitorX:hv,Moon:wv,MoonStar:dv,MoreHorizontal:E2,MoreVertical:W2,Mosque:cv,Motorbike:pv,Mountain:gv,MountainSnow:uv,Mouse:jv,MouseLeft:vv,MouseOff:xv,MousePointer:Cv,MousePointer2:Mv,MousePointer2Off:kv,MousePointerBan:mv,MousePointerClick:fv,MousePointerSquareDashed:N0,MouseRight:Bv,Move:Dv,Move3D:Jt,Move3d:Jt,MoveDiagonal:Hv,MoveDiagonal2:yv,MoveDown:bv,MoveDownLeft:Vv,MoveDownRight:Av,MoveHorizontal:zv,MoveLeft:Lv,MoveRight:Sv,MoveUp:Pv,MoveUpLeft:_v,MoveUpRight:qv,MoveVertical:Fv,Music:Uv,Music2:Tv,Music3:Rv,Music4:Zv,Navigation:Wv,Navigation2:Iv,Navigation2Off:Ov,NavigationOff:Gv,Network:Ev,Newspaper:Xv,Nfc:Nv,NonBinary:Kv,Notebook:Yv,NotebookPen:Jv,NotebookTabs:$v,NotebookText:Qv,NotepadText:e5,NotepadTextDashed:t5,Nut:s5,NutOff:o5,Octagon:i5,OctagonAlert:Qt,OctagonMinus:r5,OctagonPause:$t,OctagonX:Yt,Omega:n5,Option:l5,Orbit:h5,Origami:a5,Outdent:m,Package:k5,Package2:d5,PackageCheck:c5,PackageMinus:w5,PackageOpen:p5,PackagePlus:u5,PackageSearch:g5,PackageX:v5,PaintBucket:x5,PaintRoller:M5,Paintbrush:m5,Paintbrush2:t0,PaintbrushVertical:t0,Palette:f5,Palmtree:ze,Panda:C5,PanelBottom:y5,PanelBottomClose:B5,PanelBottomDashed:e0,PanelBottomInactive:e0,PanelBottomOpen:j5,PanelLeft:i0,PanelLeftClose:o0,PanelLeftDashed:s0,PanelLeftInactive:s0,PanelLeftOpen:r0,PanelLeftRightDashed:H5,PanelRight:b5,PanelRightClose:V5,PanelRightDashed:n0,PanelRightInactive:n0,PanelRightOpen:A5,PanelTop:_5,PanelTopBottomDashed:z5,PanelTopClose:L5,PanelTopDashed:l0,PanelTopInactive:l0,PanelTopOpen:S5,PanelsLeftBottom:q5,PanelsLeftRight:U2,PanelsRightBottom:P5,PanelsTopBottom:v0,PanelsTopLeft:h0,PaperBag:F5,Paperclip:D5,Parasol:T5,Parentheses:R5,ParkingCircle:y2,ParkingCircleOff:B2,ParkingMeter:Z5,ParkingSquare:le,ParkingSquareOff:ne,PartyPopper:U5,Pause:O5,PauseCircle:j2,PauseOctagon:$t,PawPrint:I5,PcCase:G5,Pen:d0,PenBox:w,PenLine:a0,PenOff:W5,PenSquare:w,PenTool:E5,Pencil:Q5,PencilLine:X5,PencilOff:N5,PencilRuler:K5,PencilSparkles:J5,Pentagon:$5,Percent:Y5,PercentCircle:H2,PercentDiamond:I2,PercentSquare:he,PersonStanding:tk,Phi:ek,PhilippinePeso:ok,Phone:ak,PhoneCall:sk,PhoneForwarded:rk,PhoneIncoming:ik,PhoneMissed:nk,PhoneOff:lk,PhoneOutgoing:hk,Pi:dk,PiSquare:ae,Piano:wk,Pickaxe:ck,PictureInPicture:uk,PictureInPicture2:pk,PieChart:s2,PiggyBank:gk,Pilcrow:xk,PilcrowLeft:vk,PilcrowRight:kk,PilcrowSquare:de,Pill:mk,PillBottle:Mk,Pin:Ck,PinOff:fk,Pipette:Bk,Pizza:jk,Plane:Vk,PlaneLanding:yk,PlaneTakeoff:Hk,Play:bk,PlayCircle:V2,PlayOff:Ak,PlaySquare:we,Plug:Lk,Plug2:zk,PlugZap:c0,PlugZap2:c0,Plus:Sk,PlusCircle:A2,PlusSquare:ce,PocketKnife:_k,Podcast:Nt,Podium:qk,Pointer:Fk,PointerOff:Pk,Popcorn:Dk,Popsicle:Tk,PoundSterling:Rk,Power:Uk,PowerCircle:b2,PowerOff:Zk,PowerSquare:pe,Presentation:Ok,Printer:Ek,PrinterCheck:Ik,PrinterX:Gk,Projector:Wk,Proportions:Xk,Puzzle:Nk,Pyramid:Kk,QrCode:Jk,Quote:Qk,Rabbit:$k,Radar:Yk,Radiation:t6,Radical:e6,Radio:i6,RadioOff:o6,RadioReceiver:s6,RadioTower:r6,Radius:n6,Rainbow:l6,Rat:h6,Ratio:a6,Receipt:M6,ReceiptCent:d6,ReceiptEuro:c6,ReceiptIndianRupee:w6,ReceiptJapaneseYen:p6,ReceiptPoundSterling:u6,ReceiptRussianRuble:g6,ReceiptSwissFranc:v6,ReceiptText:k6,ReceiptTurkishLira:x6,RectangleCircle:m6,RectangleEllipsis:w0,RectangleGoggles:f6,RectangleHorizontal:C6,RectangleVertical:B6,Recycle:j6,Redo:V6,Redo2:y6,RedoDot:H6,RefreshCcw:b6,RefreshCcwDot:A6,RefreshCw:L6,RefreshCwOff:z6,Refrigerator:S6,Regex:_6,RemoveFormatting:q6,Repeat:T6,Repeat1:P6,Repeat2:F6,RepeatOff:D6,Replace:R6,ReplaceAll:Z6,Reply:O6,ReplyAll:U6,Rewind:I6,Ribbon:G6,Road:W6,Rocket:E6,RockingChair:X6,RollerCoaster:N6,Rose:K6,Rotate3D:p0,Rotate3d:p0,RotateCcw:$6,RotateCcwClock:u0,RotateCcwKey:J6,RotateCcwSquare:Q6,RotateCw:e8,RotateCwFadingClock:Y6,RotateCwSquare:t8,Route:s8,RouteOff:o8,Router:r8,Rows:g0,Rows2:g0,Rows3:v0,Rows4:i8,Rss:n8,Ruler:h8,RulerDimensionLine:l8,RussianRuble:a8,Sailboat:d8,Salad:c8,Sandwich:w8,Satellite:u8,SatelliteDish:p8,SaudiRiyal:g8,Save:f8,SaveAll:v8,SaveCheck:k8,SaveOff:x8,SavePen:M8,SavePlus:m8,Scale:C8,Scale3D:k0,Scale3d:k0,Scaling:B8,Scan:q8,ScanBarcode:j8,ScanBox:y8,ScanEye:H8,ScanFace:V8,ScanHeart:A8,ScanLine:b8,ScanQrCode:z8,ScanSearch:L8,ScanSquare:S8,ScanText:_8,ScatterChart:r2,School:P8,School2:_e,Scissors:D8,ScissorsLineDashed:F8,ScissorsSquare:ue,ScissorsSquareDashedBottom:D0,Scooter:T8,ScreenShare:Z8,ScreenShareOff:R8,Scroll:O8,ScrollText:U8,Search:N8,SearchAlert:I8,SearchCheck:G8,SearchCode:W8,SearchSlash:E8,SearchX:X8,Section:K8,Send:Q8,SendHorizonal:x0,SendHorizontal:x0,SendToBack:J8,SeparatorHorizontal:$8,SeparatorVertical:Y8,Server:r7,ServerCog:t7,ServerCrash:e7,ServerOff:o7,ServerPlus:s7,Settings:n7,Settings2:i7,Shapes:l7,Share:h7,Share2:a7,Sheet:d7,Shell:c7,ShelvingUnit:w7,Shield:H7,ShieldAlert:p7,ShieldBan:u7,ShieldCheck:g7,ShieldClose:m0,ShieldCog:k7,ShieldCogCorner:v7,ShieldEllipsis:x7,ShieldHalf:M7,ShieldKeyhole:m7,ShieldLock:f7,ShieldMinus:C7,ShieldOff:B7,ShieldPlus:j7,ShieldQuestion:M0,ShieldQuestionMark:M0,ShieldUser:y7,ShieldX:m0,Ship:A7,ShipWheel:V7,Shirt:b7,ShoppingBag:z7,ShoppingBasket:L7,ShoppingCart:S7,Shovel:_7,ShowerHead:q7,Shredder:P7,Shrimp:F7,Shrink:D7,Shrub:T7,Shuffle:R7,Sidebar:i0,SidebarClose:o0,SidebarOpen:r0,Sigma:Z7,SigmaSquare:ge,Signal:E7,SignalHigh:U7,SignalLow:O7,SignalMedium:I7,SignalZero:G7,Signature:W7,Signpost:N7,SignpostBig:X7,Siren:K7,SkipBack:J7,SkipForward:Q7,Skull:$7,Slash:Y7,SlashSquare:ve,Slice:t9,Sliders:f0,SlidersHorizontal:e9,SlidersVertical:f0,Smartphone:r9,SmartphoneCharging:o9,SmartphoneNfc:s9,Smile:Y2,SmilePlus:$2,Snail:i9,Snowflake:n9,SoapDispenserDroplet:l9,Sofa:h9,SolarPanel:a9,SortAsc:F,SortDesc:_,Soup:c9,Space:d9,Spade:w9,Sparkle:p9,Sparkles:C0,Speaker:u9,Speech:g9,SpellCheck:k9,SpellCheck2:v9,Spline:m9,SplinePointer:x9,Split:M9,SplitSquareHorizontal:ke,SplitSquareVertical:xe,Spool:f9,SportShoe:C9,Spotlight:j9,SprayCan:B9,Sprout:y9,Square:R9,SquareActivity:B0,SquareArrowDown:H0,SquareArrowDownLeft:j0,SquareArrowDownRight:y0,SquareArrowLeft:V0,SquareArrowOutDownLeft:A0,SquareArrowOutDownRight:b0,SquareArrowOutUpLeft:z0,SquareArrowOutUpRight:L0,SquareArrowRight:S0,SquareArrowRightEnter:H9,SquareArrowRightExit:V9,SquareArrowUp:P0,SquareArrowUpLeft:_0,SquareArrowUpRight:q0,SquareAsterisk:F0,SquareBottomDashedScissors:D0,SquareCenterlineDashedHorizontal:T0,SquareCenterlineDashedVertical:R0,SquareChartGantt:C,SquareCheck:U0,SquareCheckBig:Z0,SquareChevronDown:O0,SquareChevronLeft:I0,SquareChevronRight:W0,SquareChevronUp:G0,SquareCode:E0,SquareDashed:K0,SquareDashedBottom:b9,SquareDashedBottomCode:A9,SquareDashedKanban:X0,SquareDashedMousePointer:N0,SquareDashedText:B,SquareDashedTopSolid:z9,SquareDivide:J0,SquareDot:Q0,SquareEqual:$0,SquareFunction:Y0,SquareGanttChart:C,SquareKanban:te,SquareLibrary:ee,SquareM:se,SquareMenu:oe,SquareMinus:re,SquareMousePointer:ie,SquareOff:L9,SquareParking:le,SquareParkingOff:ne,SquarePause:S9,SquarePen:w,SquarePercent:he,SquarePi:ae,SquarePilcrow:de,SquarePlay:we,SquarePlus:ce,SquarePower:pe,SquareRadical:_9,SquareRoundCorner:q9,SquareScissors:ue,SquareSigma:ge,SquareSlash:ve,SquareSplitHorizontal:ke,SquareSplitVertical:xe,SquareSquare:P9,SquareStack:F9,SquareStar:D9,SquareStop:T9,SquareTerminal:Me,SquareUser:fe,SquareUserRound:me,SquareX:Ce,SquaresExclude:Z9,SquaresIntersect:U9,SquaresSubtract:O9,SquaresUnite:I9,Squircle:W9,SquircleDashed:G9,Squirrel:E9,Stamp:X9,Star:tx,StarCheck:N9,StarHalf:K9,StarMinus:J9,StarOff:Q9,StarPlus:$9,StarX:Y9,Stars:C0,StepBack:ex,StepForward:ox,Stethoscope:sx,Sticker:rx,StickyNote:ax,StickyNoteCheck:ix,StickyNoteMinus:nx,StickyNoteOff:lx,StickyNotePlus:hx,StickyNoteX:dx,StickyNotes:cx,Stone:wx,StopCircle:L2,Store:px,StretchHorizontal:ux,StretchVertical:gx,Strikethrough:vx,Subscript:kx,Subtitles:W,Summary:xx,Sun:Bx,SunDim:Mx,SunMedium:mx,SunMoon:fx,SunSnow:Cx,Sunrise:jx,Sunset:yx,Superscript:Hx,SwatchBook:Vx,SwissFranc:Ax,SwitchCamera:bx,Sword:zx,Swords:Sx,Syringe:Lx,Table:Zx,Table2:_x,TableCellsMerge:qx,TableCellsSplit:Px,TableColumnsSplit:Fx,TableConfig:k,TableOfContents:Dx,TableProperties:Tx,TableRowsSplit:Rx,Tablet:Ux,TabletSmartphone:Ox,Tablets:Ix,Tag:Ex,TagPlus:Gx,TagX:Wx,Tags:Xx,Tally1:Nx,Tally2:Kx,Tally3:Jx,Tally4:Qx,Tally5:$x,Tangent:Yx,Target:tM,Telescope:oM,Tent:sM,TentTree:eM,Terminal:rM,TerminalSquare:Me,TestTube:iM,TestTube2:Be,TestTubeDiagonal:Be,TestTubes:nM,Text:j,TextAlignCenter:je,TextAlignEnd:ye,TextAlignJustify:He,TextAlignStart:j,TextCursor:hM,TextCursorInput:lM,TextInitial:Ve,TextQuote:aM,TextSearch:dM,TextSelect:B,TextSelection:B,TextWrap:Ae,Theater:cM,Thermometer:uM,ThermometerSnowflake:wM,ThermometerSun:pM,ThumbsDown:gM,ThumbsUp:vM,Ticket:BM,TicketCheck:kM,TicketMinus:xM,TicketPercent:MM,TicketPlus:mM,TicketSlash:fM,TicketX:CM,Tickets:yM,TicketsPlane:jM,Timeline:HM,Timer:bM,TimerOff:VM,TimerReset:AM,ToggleLeft:zM,ToggleRight:LM,Toilet:SM,ToolCase:_M,Toolbox:qM,Tornado:PM,Torus:FM,Touchpad:TM,TouchpadOff:DM,TowelRack:RM,TowerControl:ZM,ToyBrick:UM,Tractor:OM,TrafficCone:GM,Train:be,TrainFront:WM,TrainFrontTunnel:IM,TrainTrack:EM,TramFront:be,Transgender:XM,Trash:KM,Trash2:NM,TreeDeciduous:JM,TreePalm:ze,TreePine:QM,Trees:YM,TrendingDown:$M,TrendingUp:em,TrendingUpDown:tm,Triangle:im,TriangleAlert:Le,TriangleDashed:om,TriangleRight:sm,Trophy:rm,Truck:lm,TruckElectric:nm,TurkishLira:hm,Turntable:am,Turtle:cm,Tv:wm,Tv2:Se,TvMinimal:Se,TvMinimalPlay:dm,Type:um,TypeOutline:pm,Umbrella:km,UmbrellaOff:gm,Underline:vm,Undo:mm,Undo2:xm,UndoDot:Mm,UnfoldHorizontal:fm,UnfoldVertical:Cm,Ungroup:Bm,University:_e,Unlink:ym,Unlink2:jm,Unlock:Gt,UnlockKeyhole:It,Unplug:Hm,Upload:Vm,UploadCloud:T2,Usb:Am,User:Gm,User2:Re,UserCheck:bm,UserCheck2:qe,UserCircle:_2,UserCircle2:S2,UserCog:zm,UserCog2:Pe,UserKey:Lm,UserLock:Sm,UserMinus:_m,UserMinus2:Fe,UserPen:qm,UserPlus:Pm,UserPlus2:De,UserRound:Re,UserRoundArrowLeft:Fm,UserRoundCheck:qe,UserRoundCog:Pe,UserRoundKey:Dm,UserRoundMinus:Fe,UserRoundPen:Tm,UserRoundPlus:De,UserRoundSearch:Rm,UserRoundX:Te,UserSearch:Zm,UserShield:Um,UserSquare:fe,UserSquare2:me,UserStar:Om,UserX:Im,UserX2:Te,Users:Wm,Users2:Ze,UsersRound:Ze,Utensils:Oe,UtensilsCrossed:Ue,UtilityPole:Em,Van:Xm,Variable:Km,Vault:Nm,VectorSquare:Jm,Vegan:Qm,VenetianMask:$m,Venus:tf,VenusAndMars:Ym,Verified:R,Vibrate:of,VibrateOff:ef,Video:rf,VideoOff:sf,Videotape:nf,View:lf,Voicemail:hf,Volleyball:df,Volume:uf,Volume1:cf,Volume2:af,VolumeOff:wf,VolumeX:pf,Vote:gf,Wallet:kf,Wallet2:Ie,WalletCards:vf,WalletMinimal:Ie,Wallpaper:xf,Wand:Mf,Wand2:Ge,WandSparkles:Ge,Warehouse:mf,WashingMachine:ff,Watch:Cf,Waves:We,WavesArrowDown:Bf,WavesArrowUp:jf,WavesHorizontal:We,WavesLadder:yf,WavesVertical:Hf,Waypoints:Vf,Webcam:bf,WebcamOff:Af,Webhook:zf,WebhookOff:Lf,Weight:_f,WeightTilde:Sf,Wheat:Pf,WheatOff:qf,WholeWord:Ff,Wifi:Gf,WifiCog:Df,WifiHigh:Tf,WifiLow:Rf,WifiOff:Zf,WifiPen:Uf,WifiSync:Of,WifiZero:If,Wind:Ef,WindArrowDown:Wf,Wine:Nf,WineOff:Xf,Workflow:Kf,Worm:Jf,WrapText:Ae,Wrench:$f,WrenchOff:Qf,X:tC,XCircle:q2,XLineTop:Yf,XOctagon:Yt,XSquare:Ce,Zap:oC,ZapOff:eC,ZodiacAquarius:sC,ZodiacAries:rC,ZodiacCancer:iC,ZodiacCapricorn:nC,ZodiacGemini:lC,ZodiacLeo:hC,ZodiacLibra:aC,ZodiacOphiuchus:dC,ZodiacPisces:cC,ZodiacSagittarius:wC,ZodiacScorpio:pC,ZodiacTaurus:uC,ZodiacVirgo:gC,ZoomIn:vC,ZoomOut:kC},Symbol.toStringTag,{value:"Module"})),MC={class:"flex flex-col gap-4"},mC={class:"flex items-center justify-between gap-3"},fC={class:"text-p-sm shrink-0 text-ink-gray-5"},CC={class:"h-[450px] overflow-auto"},BC={class:"grid grid-cols-[repeat(auto-fill,56px)] gap-1 justify-center"},jC=["onClick"],yC=["innerHTML"],HC={key:1,class:"p-6 text-p-sm text-ink-gray-5"},VC=Qe({__name:"LucideGallery",setup(Ee){const d=new Map;for(const t of Object.values(xC)){if(typeof t!="string")continue;const e=t.match(/lucide lucide-([\w-]+)/);if(!e)continue;const o=e[1];if(d.has(o))continue;const h=t.replace(/stroke-width="[^"]+"/g,'stroke-width="1.5"');d.set(o,h)}const s=[...d.entries()].map(([t,e])=>({name:t,svg:e})).sort((t,e)=>t.name.localeCompare(e.name)),i=t1("");async function Xe(t){try{await navigator.clipboard.writeText(t),H.success(`Copied "${t}"`)}catch{H.error("Failed to copy")}}const u=e1(()=>{const t=i.value.trim().toLowerCase();if(!t)return s;const e=[],o=[],h=[];for(const n of s)n.name===t?e.push(n):n.name.startsWith(t)?o.push(n):n.name.includes(t)&&h.push(n);return[...e,...o,...h]});return(t,e)=>(l(),p("div",MC,[r("div",mC,[y(c(Ne),{modelValue:i.value,"onUpdate:modelValue":e[0]||(e[0]=o=>i.value=o),placeholder:"Search icons…",class:"w-full"},{prefix:a(()=>[...e[1]||(e[1]=[r("span",{class:"lucide-search size-4 text-ink-gray-5"},null,-1)])]),suffix:a(()=>[r("span",fC,g(u.value.length)+" of "+g(c(s).length),1)]),_:1},8,["modelValue"])]),r("div",CC,[u.value.length>0?(l(),V(c(Je),{key:0,"hover-delay":300,"skip-delay":1e3},{default:a(()=>[r("div",BC,[(l(!0),p($e,null,Ye(u.value,o=>(l(),V(c(Ke),{key:o.name,text:o.name},{default:a(()=>[r("div",{class:"flex size-14 cursor-pointer items-center justify-center rounded-4 text-ink-gray-7 hover:bg-surface-gray-2",onClick:h=>Xe(o.name)},[r("span",{class:"size-6 [&>svg]:size-full",innerHTML:o.svg},null,8,yC)],8,jC)]),_:2},1032,["text"]))),128))])]),_:1})):(l(),p("p",HC,' No icons match "'+g(i.value)+'". ',1))])]))}}),LC=JSON.parse('{"title":"Icons","description":"","frontmatter":{},"headers":[],"relativePath":"docs/other/icons.md","filePath":"docs/other/icons.md","lastUpdated":1789434589000}'),AC={name:"docs/other/icons.md"},SC=Object.assign(AC,{setup(Ee){return(d,s)=>{const i=o1("ClientOnly");return l(),p("div",null,[s[0]||(s[0]=A('<h1 id="icons" tabindex="-1">Icons <a class="header-anchor" href="#icons" aria-label="Permalink to “Icons”">​</a></h1><p>Frappe UI ships with the full <a href="https://lucide.dev" target="_blank" rel="noreferrer">Lucide</a> icon set. There are three ways to use an icon in your templates. Pick the first one that fits — they all render the same icon, but the recommended path keeps your code simpler and your bundle smaller.</p><h2 id="browse-all-icons" tabindex="-1">Browse all icons <a class="header-anchor" href="#browse-all-icons" aria-label="Permalink to “Browse all icons”">​</a></h2><p>Every icon below is keyed by its kebab-case name — use that name directly as <code>lucide-&lt;name&gt;</code> in the Tailwind class form, or import it from <code>~icons/lucide/&lt;name&gt;</code>.</p>',4)),y(i,null,{default:a(()=>[y(VC)]),_:1}),s[1]||(s[1]=A(`<h2 id="recommended-class-based-icons" tabindex="-1">Recommended: class-based icons <a class="header-anchor" href="#recommended-class-based-icons" aria-label="Permalink to “Recommended: class-based icons”">​</a></h2><p>Every Lucide icon is exposed as a Tailwind utility class named <code>lucide-&lt;icon-name&gt;</code>. Drop it on any element and size/tint it with the usual utilities:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_1uuh8p">span</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-menu size-4 text-ink-gray-7</span><span class="s_w1p9wo">&quot;</span><span class="s_28rvie"> /</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_1uuh8p">span</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-chevron-down size-3</span><span class="s_w1p9wo">&quot;</span><span class="s_28rvie"> /</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_1uuh8p">span</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-circle-check size-5 text-ink-green-5</span><span class="s_w1p9wo">&quot;</span><span class="s_28rvie"> /</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><p>No imports, no component registration, no auto-import magic. Icon names match Lucide&#39;s own kebab-case names — search them at <a href="https://lucide.dev/icons" target="_blank" rel="noreferrer">lucide.dev/icons</a>.</p><h3 id="how-it-works" tabindex="-1">How it works <a class="header-anchor" href="#how-it-works" aria-label="Permalink to “How it works”">​</a></h3><p>A Tailwind plugin (<code>tailwind/iconPackPlugin.js</code>) reads every SVG from the <code>lucide-static</code> package at build time and registers each one as a Tailwind component class via <code>matchComponents</code>. The generated rule sets <code>mask-image</code> to a data-URI of the icon&#39;s SVG and <code>background-color</code> to <code>currentColor</code>, so the icon paints in whatever color the element inherits and crops to whatever size you give it.</p><p>Tailwind&#39;s JIT only emits CSS for classes it can find as literal strings in your source — so even though ~1800 icons are registered, only the ones you actually use end up in the output bundle. That&#39;s why a dynamic class like <code>\`lucide-\${name}\`</code> produces no CSS: the JIT scanner can&#39;t see what to emit.</p><h3 id="sizing-and-color" tabindex="-1">Sizing and color <a class="header-anchor" href="#sizing-and-color" aria-label="Permalink to “Sizing and color”">​</a></h3><p>The icon defaults to <code>1em × 1em</code> (it scales with surrounding text) and uses <code>currentColor</code>, so any <code>text-*</code> utility tints it.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1th9sy">&lt;!-- Inherits the parent&#39;s text color and font-size --&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">div</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">flex items-center gap-1 text-base text-ink-gray-7</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_6am9cx">  &lt;span class=&quot;lucide-info&quot; /&gt; heads up</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">div</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_1th9sy">&lt;!-- Or set both explicitly --&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">span</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-info size-5 text-ink-blue-5</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span></code></pre></div><p>Icons render as <code>display: block</code> (matching Tailwind&#39;s preflight default for <code>&lt;svg&gt;</code>), so put them inside a flex container — <code>flex</code> / <code>inline-flex</code> / <code>grid</code> — when you want them to sit next to text.</p><h3 id="always-write-the-full-class-name" tabindex="-1">Always write the full class name <a class="header-anchor" href="#always-write-the-full-class-name" aria-label="Permalink to “Always write the full class name”">​</a></h3><p>Tailwind only generates CSS for classes it can find as complete strings in your source. <strong>Do not</strong> build the icon class dynamically:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1th9sy">&lt;!-- ❌ Won&#39;t render — Tailwind cannot see this class --&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">span</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;\`</span><span class="s_2575z4">lucide-</span><span class="s_20l85h">\${</span><span class="s_22m8k2">name</span><span class="s_20l85h">}</span><span class="s_w1p9wo">\`&quot;</span><span class="s_1zd9e2"> /&gt;</span></span></code></pre></div><p>Instead, list each option as a complete literal:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1th9sy">&lt;!-- ✅ Both classes are statically visible --&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">span</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">open</span><span class="s_50ecpt"> ?</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">lucide-chevron-down</span><span class="s_w1p9wo">&#39;</span><span class="s_50ecpt"> :</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">lucide-chevron-right</span><span class="s_w1p9wo">&#39;&quot;</span><span class="s_1zd9e2"> /&gt;</span></span></code></pre></div><p>If your icon name is genuinely data-driven (e.g. coming from an API or a config object built at runtime), use the import-based approach below.</p><h2 id="opt-in-icons-lucide-imports" tabindex="-1">Opt-in: <code>~icons/lucide/*</code> imports <a class="header-anchor" href="#opt-in-icons-lucide-imports" aria-label="Permalink to “Opt-in: ~icons/lucide/* imports”">​</a></h2><div class="warning custom-block"><p class="custom-block-title">Turn the plugin on first</p><p>This form needs <code>lucideIcons: true</code> on the frappe-ui Vite plugin. It is <strong>off by default</strong>, because frappe-ui itself draws every icon from a class name and needs nothing from Vite.</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1th9sy">// vite.config.js</span></span>
<span class="line"><span class="s_indoxt">frappeui</span><span class="s_13ahmt">({</span><span class="s_r4oegk"> lucideIcons</span><span class="s_1jjt6x">:</span><span class="s_40mev6"> true</span><span class="s_13ahmt"> })</span></span></code></pre></div><p>Without it, an import fails the build and a <code>&lt;LucideMenu /&gt;</code> tag renders nothing with only a &quot;Failed to resolve component&quot; warning in development.</p></div><p>The plugin resolves <code>~icons/lucide/&lt;name&gt;</code> to a Vue component. Useful when you need an actual SVG node — for example, when the icon name is dynamic, or when something downstream expects a component reference rather than a class string.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">script</span><span class="s_1i4ay4"> setup</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_edvzsf">import</span><span class="s_4q1z3w"> LucideMenu</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">~icons/lucide/menu</span><span class="s_w1p9wo">&#39;</span></span>
<span class="line"><span class="s_edvzsf">import</span><span class="s_4q1z3w"> LucideChevronDown</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">~icons/lucide/chevron-down</span><span class="s_w1p9wo">&#39;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">script</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_wac0bt">LucideMenu</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">size-4</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_wac0bt">LucideChevronDown</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">size-3</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><p>You can also pass the imported component into props that accept a component reference:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">Button</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">icon-left</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">LucideMenu</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span></code></pre></div><h3 id="how-it-works-1" tabindex="-1">How it works <a class="header-anchor" href="#how-it-works-1" aria-label="Permalink to “How it works”">​</a></h3><p><code>~icons/lucide/*</code> is a virtual module backed by a Vite plugin (<code>vite/lucideIcons.js</code>). When Vite resolves an import like <code>~icons/lucide/menu</code>, the plugin reads the matching SVG from <code>lucide-static</code> and synthesizes a small Vue component that renders the icon as an inline <code>&lt;svg&gt;</code> element. The component is bundled into your JS like any other module, so each icon you import adds a few hundred bytes to the bundle.</p><h2 id="opt-in-auto-imported-lucidename" tabindex="-1">Opt-in: auto-imported <code>&lt;LucideName /&gt;</code> <a class="header-anchor" href="#opt-in-auto-imported-lucidename" aria-label="Permalink to “Opt-in: auto-imported &lt;LucideName /&gt;”">​</a></h2><p>With <code>lucideIcons: true</code>, every Lucide icon is also available as a global Vue component named <code>&lt;Lucide&lt;PascalName&gt; /&gt;</code> — no import needed.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_wac0bt">LucideMenu</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">size-4</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_wac0bt">LucideChevronDown</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">size-3</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><p>This is functionally identical to the <code>~icons/lucide/*</code> import form; pick whichever reads better in context.</p><h3 id="how-it-works-2" tabindex="-1">How it works <a class="header-anchor" href="#how-it-works-2" aria-label="Permalink to “How it works”">​</a></h3><p><code>unplugin-vue-components</code> scans your templates and, when it sees a tag like <code>&lt;LucideMenu /&gt;</code>, automatically inserts an import for <code>~icons/lucide/menu</code> at compile time. From there it&#39;s the same path as the manual-import form above — a virtual-module Vue component rendered as an inline <code>&lt;svg&gt;</code>.</p><h2 id="which-one-should-i-use" tabindex="-1">Which one should I use? <a class="header-anchor" href="#which-one-should-i-use" aria-label="Permalink to “Which one should I use?”">​</a></h2><table tabindex="0"><thead><tr><th>Situation</th><th>Use</th></tr></thead><tbody><tr><td>Static icon in a template</td><td>Class — <code>lucide-menu</code></td></tr><tr><td>Icon name from props/data with a known set</td><td>Class — list each literal</td></tr><tr><td>Passing an icon as a prop value</td><td>Class — the props accept the string</td></tr><tr><td>Icon name truly dynamic (loops, API data)</td><td><code>~icons/lucide/*</code> import (<code>lucideIcons: true</code>)</td></tr><tr><td>Inside an <code>&lt;svg&gt;</code> (need real SVG children)</td><td><code>~icons/lucide/*</code> import (<code>lucideIcons: true</code>)</td></tr><tr><td>Quick prototyping in a template</td><td><code>&lt;LucideName /&gt;</code> auto-import (<code>lucideIcons: true</code>)</td></tr></tbody></table><p>The class form is the right answer in most components you write, and it is the only form that needs no build configuration.</p><h2 id="using-icons-in-frappe-ui-components" tabindex="-1">Using icons in Frappe UI components <a class="header-anchor" href="#using-icons-in-frappe-ui-components" aria-label="Permalink to “Using icons in Frappe UI components”">​</a></h2><p>Most Frappe UI components that take an icon accept either a <code>lucide-*</code> class string, a Vue component reference, or a slot. The class string is the recommended form — keep using imports when the icon is genuinely dynamic or you need a real SVG node.</p><h3 id="button" tabindex="-1">Button <a class="header-anchor" href="#button" aria-label="Permalink to “Button”">​</a></h3><p><code>Button</code> exposes <code>iconLeft</code>, <code>iconRight</code>, and <code>icon</code> props, plus matching <code>prefix</code> / <code>suffix</code> / <code>icon</code> slots. All three props accept a <code>lucide-*</code> class string or a component reference.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1th9sy">&lt;!-- ✅ Class form (recommended) --&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">Button</span><span class="s_1i4ay4"> icon-left</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-plus</span><span class="s_w1p9wo">&quot;</span><span class="s_1i4ay4"> label</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">New task</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">Button</span><span class="s_1i4ay4"> icon-right</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-arrow-right</span><span class="s_w1p9wo">&quot;</span><span class="s_1i4ay4"> label</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">Continue</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">Button</span><span class="s_1i4ay4"> icon</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-settings</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span><span class="s_1th9sy">  &lt;!-- icon-only --&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_1th9sy">&lt;!-- Component form — for dynamic icons or pass-through cases --&gt;</span></span>
...
<span class="line"><span class="s_edvzsf">import</span><span class="s_4q1z3w"> LucidePlus</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">~icons/lucide/plus</span><span class="s_w1p9wo">&#39;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">script</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">Button</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">icon-left</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">LucidePlus</span><span class="s_w1p9wo">&quot;</span><span class="s_1i4ay4"> label</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">New task</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_1th9sy">&lt;!-- Slot form — when you need full control over the icon markup --&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">Button</span><span class="s_1i4ay4"> label</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">New task</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_6am9cx">  &lt;template #prefix&gt;</span></span>
<span class="line"><span class="s_6am9cx">    &lt;span class=&quot;lucide-plus size-4&quot; /&gt;</span></span>
<span class="line"><span class="s_6am9cx">  &lt;/template&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">Button</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><h3 id="dropdown" tabindex="-1">Dropdown <a class="header-anchor" href="#dropdown" aria-label="Permalink to “Dropdown”">​</a></h3><p><code>Dropdown</code> items take an <code>icon</code> field on each option. It accepts the same shapes as <code>Button.iconLeft</code>:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">script</span><span class="s_1i4ay4"> setup</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_252irl">const</span><span class="s_295sjd"> options</span><span class="s_2ekfrt"> =</span><span class="s_13ahmt"> [</span></span>
<span class="line"><span class="s_13ahmt">  {</span><span class="s_r4oegk"> label</span><span class="s_1jjt6x">:</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">Profile</span><span class="s_w1p9wo">&#39;</span><span class="s_1jjt6x">,</span><span class="s_r4oegk">  icon</span><span class="s_1jjt6x">:</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">lucide-user</span><span class="s_w1p9wo">&#39;</span><span class="s_1jjt6x">,</span><span class="s_indoxt">     onClick</span><span class="s_1jjt6x">:</span><span class="s_13ahmt"> ()</span><span class="s_50ecpt"> =&gt;</span><span class="s_13ahmt"> {}</span><span class="s_13ahmt"> }</span><span class="s_1jjt6x">,</span></span>
<span class="line"><span class="s_13ahmt">  {</span><span class="s_r4oegk"> label</span><span class="s_1jjt6x">:</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">Settings</span><span class="s_w1p9wo">&#39;</span><span class="s_1jjt6x">,</span><span class="s_r4oegk"> icon</span><span class="s_1jjt6x">:</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">lucide-settings</span><span class="s_w1p9wo">&#39;</span><span class="s_1jjt6x">,</span><span class="s_indoxt"> onClick</span><span class="s_1jjt6x">:</span><span class="s_13ahmt"> ()</span><span class="s_50ecpt"> =&gt;</span><span class="s_13ahmt"> {}</span><span class="s_13ahmt"> }</span><span class="s_1jjt6x">,</span></span>
<span class="line"><span class="s_13ahmt">  {</span><span class="s_r4oegk"> label</span><span class="s_1jjt6x">:</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">Sign out</span><span class="s_w1p9wo">&#39;</span><span class="s_1jjt6x">,</span><span class="s_r4oegk"> icon</span><span class="s_1jjt6x">:</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">lucide-log-out</span><span class="s_w1p9wo">&#39;</span><span class="s_1jjt6x">,</span><span class="s_indoxt">  onClick</span><span class="s_1jjt6x">:</span><span class="s_13ahmt"> ()</span><span class="s_50ecpt"> =&gt;</span><span class="s_13ahmt"> {}</span><span class="s_13ahmt"> }</span><span class="s_1jjt6x">,</span></span>
<span class="line"><span class="s_13ahmt">]</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">script</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_wac0bt">Dropdown</span><span class="s_1i4ay4"> :options</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">options</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">    &lt;</span><span class="s_1uuh8p">Button</span><span class="s_1i4ay4"> icon-left</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-circle-user</span><span class="s_w1p9wo">&quot;</span><span class="s_1i4ay4"> label</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">Account</span><span class="s_w1p9wo">&quot;</span><span class="s_28rvie"> /</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;/</span><span class="s_wac0bt">Dropdown</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><p>Because each option&#39;s <code>icon</code> is a complete literal string in your source, Tailwind&#39;s JIT picks it up correctly. If you build an options array dynamically — say, from a server response — and the icon names aren&#39;t known at build time, fall back to importing components:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">script</span><span class="s_1i4ay4"> setup</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_edvzsf">import</span><span class="s_4q1z3w"> LucideUser</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">~icons/lucide/user</span><span class="s_w1p9wo">&#39;</span></span>
<span class="line"><span class="s_edvzsf">import</span><span class="s_4q1z3w"> LucideSettings</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">~icons/lucide/settings</span><span class="s_w1p9wo">&#39;</span></span>
<span class="line"></span>
<span class="line"><span class="s_252irl">const</span><span class="s_295sjd"> options</span><span class="s_2ekfrt"> =</span><span class="s_indoxt"> computed</span><span class="s_13ahmt">(()</span><span class="s_50ecpt"> =&gt;</span></span>
<span class="line"><span class="s_22m8k2">  serverItems</span><span class="s_1jjt6x">.</span><span class="s_11933w">value</span><span class="s_1jjt6x">.</span><span class="s_indoxt">map</span><span class="s_13ahmt">((</span><span class="s_fsg3al">item</span><span class="s_13ahmt">)</span><span class="s_50ecpt"> =&gt;</span><span class="s_13ahmt"> ({</span></span>
<span class="line"><span class="s_r4oegk">    label</span><span class="s_1jjt6x">:</span><span class="s_22m8k2"> item</span><span class="s_1jjt6x">.</span><span class="s_11933w">label</span><span class="s_1jjt6x">,</span></span>
<span class="line"><span class="s_r4oegk">    icon</span><span class="s_1jjt6x">:</span><span class="s_22m8k2"> item</span><span class="s_1jjt6x">.</span><span class="s_11933w">kind</span><span class="s_50ecpt"> ===</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">user</span><span class="s_w1p9wo">&#39;</span><span class="s_50ecpt"> ?</span><span class="s_22m8k2"> LucideUser</span><span class="s_50ecpt"> :</span><span class="s_22m8k2"> LucideSettings</span><span class="s_1jjt6x">,</span></span>
<span class="line"><span class="s_indoxt">    onClick</span><span class="s_1jjt6x">:</span><span class="s_13ahmt"> ()</span><span class="s_50ecpt"> =&gt;</span><span class="s_indoxt"> open</span><span class="s_13ahmt">(</span><span class="s_22m8k2">item</span><span class="s_13ahmt">)</span><span class="s_1jjt6x">,</span></span>
<span class="line"><span class="s_13ahmt">  }))</span><span class="s_1jjt6x">,</span></span>
<span class="line"><span class="s_13ahmt">)</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">script</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><h3 id="other-components" tabindex="-1">Other components <a class="header-anchor" href="#other-components" aria-label="Permalink to “Other components”">​</a></h3><p><code>TextInput</code>, <code>FormControl</code>, <code>Tabs</code>, <code>Tooltip</code>, <code>Alert</code>, <code>Sidebar</code> and similar components either accept an <code>icon</code> prop of the same shape (some add <code>iconLeft</code> / <code>iconRight</code>) or expose a slot where you can drop a <code>&lt;span class=&quot;lucide-...&quot; /&gt;</code> directly. Check each component&#39;s reference page for the exact prop names — the icon API conventions are consistent across the library.</p>`,46))])}}});export{LC as __pageData,SC as default};
