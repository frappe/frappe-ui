import { aP as markRaw, aB as openBlock, aG as createElementBlock, aF as createBaseVNode, ay as defineComponent, az as ref, bb as watch, aW as computed, cx as ComboboxAnchor_default, cy as ComboboxContent_default, cz as ComboboxEmpty_default, cA as ComboboxGroup_default, cB as ComboboxInput_default, cC as ComboboxItem_default, cD as ComboboxItemIndicator_default, cE as ComboboxLabel_default, cF as ComboboxPortal_default, cG as ComboboxRoot_default, cH as ComboboxTrigger_default, cI as ComboboxViewport_default, aE as createVNode, aD as withCtx, aR as normalizeClass, aC as createBlock, aH as createCommentVNode, a_ as withModifiers, aM as createTextVNode, aN as toDisplayString, aK as Fragment, aJ as renderList, aQ as h } from "./vendor-2CZqcq_N.js";
import { L as LucideChevronDown } from "./chevron-down-DJWHmpM2.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const __returned__ = { props, emit, searchTerm, internalModelValue, isOpen, userHasTyped, onUpdateModelValue, isGroup, getLabel, getValue, isDisabled, getIcon, allOptionsFlat, getDisplayValue, selectedOption, selectedOptionIcon, RenderIcon, filterFunction, filteredOptions, handleInputChange, handleOpenChange, handleFocus, handleBlur, handleClick, reset, get ComboboxAnchor() {
