import { ay as _export_sfc, az as defineComponent, aO as computed, aD as openBlock, aL as createElementBlock, aQ as normalizeClass, aP as renderSlot, aS as createCommentVNode, aT as createTextVNode, aJ as toDisplayString } from "./vendor-D15NXqv8.js";
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock(
    "div",
    {
      class: normalizeClass(["inline-flex select-none items-center gap-1 rounded-full whitespace-nowrap", $setup.classes])
    },
    [
