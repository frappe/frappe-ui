...
const commands = {
  ...
  FontColor: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./FontColor-Eal_NZle.js"), true ? __vite__mapDeps([0,1,2,3,4]) : void 0))
  },
  Blockquote: {
    label: "Blockquote",
    icon: DoubleQuotes,
  ...
  Link: {
    ...
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertLink-DHhP7FYc.js"), true ? __vite__mapDeps([5,2]) : void 0))
  },
  Image: {
    label: "Image",
    icon: Image$2,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertImage-DNGkWyCI.js"), true ? __vite__mapDeps([6,2,3,4,7,8,9,10,11,12,13,1,14,15,16,17,18]) : void 0))
  },
  Video: {
    label: "Video",
    icon: Video$1,
    isActive: (editor) => false,
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertVideo-CXshO9zR.js"), true ? __vite__mapDeps([19,2]) : void 0))
  },
  Iframe: {
    label: "Embed",
    icon: GalleryVertical,
    isActive: (editor) => editor.isActive("iframe"),
    component: defineAsyncComponent(() => __vitePreload(() => import("./InsertIframe-Beg98UQc.js"), true ? __vite__mapDeps([20,2,21,18,4,10,3,22,12,7,8,9,11,13,1,14,15,16,17]) : void 0))
  },
  Undo: {
    label: "Undo",
    icon: ArrowGoBack,
