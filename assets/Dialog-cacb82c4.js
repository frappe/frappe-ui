import { ay as defineComponent, az as ref, bs as watch, aQ as computed, bU as Ge, bV as Ve, bW as Ye, bX as he, bY as Se, aB as openBlock, aC as createBlock, aD as withCtx, aE as createVNode, aF as createBaseVNode, aW as normalizeClass, aT as renderSlot, aG as createElementBlock, aH as createCommentVNode, aN as toDisplayString, aU as normalizeProps, aV as guardReactiveProps, aK as Fragment, aJ as renderList, aL as mergeProps, aM as createTextVNode } from "./vendor-16a9e5ef.js";
import { B as Button } from "./Button-59794029.js";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const icon = computed(() => {
      var _a;
      if (!((_a = props.options) == null ? void 0 : _a.icon))
        return null;
    ...
    const __returned__ = { props, emit, dialogActions, open, close, icon, dialogPositionClasses, dialogIconBgClasses, dialogIconClasses, get DialogPanel() {
      return Ge;
    }, get DialogTitle() {
      return Ve;
    }, get HDialog() {
                  ...
                  createVNode($setup["DialogPanel"], {
                    ...
                    default: withCtx(() => [
                      renderSlot(_ctx.$slots, "body", {}, () => [
                        ...
                        $setup.dialogActions.length || _ctx.$slots.actions ? (openBlock(), createElementBlock("div", _hoisted_9, [
                          renderSlot(_ctx.$slots, "actions", normalizeProps(guardReactiveProps({ close: $setup.close })), () => [
                            createBaseVNode("div", _hoisted_10, [
                              (openBlock(true), createElementBlock(
                                Fragment,
                                null,
                                renderList($setup.dialogActions, (action) => {
