                  ...
                  (openBlock(true), createElementBlock(
                    ...
                    renderList($setup.selectOptions, (option) => {
                      return openBlock(), createBlock($setup["SelectItem"], {
                        ...
                        key: option.value,
                        value: option.value,
                        class: normalizeClass([[$setup.sizeClasses, $setup.paddingClasses, $setup.fontSizeClasses], "text-base text-ink-gray-9 flex items-center relative data-[highlighted]:bg-surface-gray-2 border-0 [data-state=checked]:bg-surface-gray-2 data-[disabled]:text-ink-gray-4 select-none"])
                      }, {
                        default: withCtx(() => [
                          createVNode(
