const __resolved__virtual_storySource_srcComponentsDropdownStoryVue = `<script setup lang="ts">
import { h } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsDropdownStoryVue as default
};
