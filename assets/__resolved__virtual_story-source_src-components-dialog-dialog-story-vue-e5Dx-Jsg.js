const __resolved__virtual_storySource_srcComponentsDialogDialogStoryVue = `<script setup lang="ts">
import { ref } from 'vue'
...
`;
export {
  __resolved__virtual_storySource_srcComponentsDialogDialogStoryVue as default
};
