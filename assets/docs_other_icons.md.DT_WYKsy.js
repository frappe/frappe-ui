import{aQ as Re,ai as Ze,aj as Ue,bG as Oe,ah as Ie,cH as H}from"./chunks/theme.D92gZXHH.js";import{y as Ge,a2 as h,o as u,l as r,u as c,ap as l,aK as a,ah as v,m as V,F as We,a9 as Ee,a7 as Ne,j as Xe,ab as Ke,s as A}from"./chunks/framework.DcLbpmlC.js";const Je=`
<svg
...
`;const xf=Object.freeze(Object.defineProperty({__proto__:null,AArrowDown:Je,AArrowUp:Qe,ALargeSmall:$e,Accessibility:Ye,Activity:to,ActivitySquare:u0,AirVent:eo,Airplay:oo,AlarmCheck:z,AlarmClock:ro,AlarmClockCheck:z,AlarmClockMinus:b,AlarmClockOff:so,AlarmClockPlus:L,AlarmMinus:b,AlarmPlus:L,AlarmSmoke:io,Album:no,AlertCircle:i2,AlertOctagon:Gt,AlertTriangle:Ce,AlignCenter:ve,AlignCenterHorizontal:lo,AlignCenterVertical:ho,AlignEndHorizontal:ao,AlignEndVertical:co,AlignHorizontalDistributeCenter:po,AlignHorizontalDistributeEnd:wo,AlignHorizontalDistributeStart:uo,AlignHorizontalJustifyCenter:go,AlignHorizontalJustifyEnd:vo,AlignHorizontalJustifyStart:ko,AlignHorizontalSpaceAround:xo,AlignHorizontalSpaceBetween:mo,AlignJustify:ke,AlignLeft:y,AlignRight:ge,AlignStartHorizontal:Mo,AlignStartVertical:fo,AlignVerticalDistributeCenter:Bo,AlignVerticalDistributeEnd:Co,AlignVerticalDistributeStart:jo,AlignVerticalJustifyCenter:yo,AlignVerticalJustifyEnd:Ho,AlignVerticalJustifyStart:Vo,AlignVerticalSpaceAround:Ao,AlignVerticalSpaceBetween:zo,Ambulance:bo,Ampersand:Lo,Ampersands:So,Amphora:_o,Anchor:qo,Angry:Po,Annoyed:Fo,Antenna:Do,Anvil:To,Aperture:Ro,AppWindow:Zo,AppWindowMac:Uo,Apple:Oo,Archive:Wo,ArchiveRestore:Io,ArchiveX:Go,AreaChart:E,Armchair:No,ArrowBigDown:Xo,ArrowBigDownDash:Eo,ArrowBigLeft:Jo,ArrowBigLeftDash:Ko,ArrowBigRight:$o,ArrowBigRightDash:Qo,ArrowBigUp:t1,ArrowBigUpDash:Yo,ArrowDown:d1,ArrowDown01:e1,ArrowDown10:o1,ArrowDownAZ:S,ArrowDownAz:S,ArrowDownCircle:n2,ArrowDownFromLine:s1,ArrowDownLeft:r1,ArrowDownLeftFromCircle:h2,ArrowDownLeftFromSquare:M0,ArrowDownLeftSquare:g0,ArrowDownNarrowWide:i1,ArrowDownRight:n1,ArrowDownRightFromCircle:a2,ArrowDownRightFromSquare:f0,ArrowDownRightSquare:v0,ArrowDownSquare:k0,ArrowDownToDot:l1,ArrowDownToLine:h1,ArrowDownUp:a1,ArrowDownWideNarrow:_,ArrowDownZA:q,ArrowDownZa:q,ArrowLeft:u1,ArrowLeftCircle:l2,ArrowLeftFromLine:c1,ArrowLeftRight:w1,ArrowLeftSquare:x0,ArrowLeftToLine:p1,ArrowRight:x1,ArrowRightCircle:w2,ArrowRightFromLine:g1,ArrowRightLeft:v1,ArrowRightSquare:B0,ArrowRightToLine:k1,ArrowUp:A1,ArrowUp01:M1,ArrowUp10:m1,ArrowUpAZ:P,ArrowUpAz:P,ArrowUpCircle:p2,ArrowUpDown:f1,ArrowUpFromDot:C1,ArrowUpFromLine:B1,ArrowUpLeft:j1,ArrowUpLeftFromCircle:d2,ArrowUpLeftFromSquare:m0,ArrowUpLeftSquare:j0,ArrowUpNarrowWide:F,ArrowUpRight:y1,ArrowUpRightFromCircle:c2,ArrowUpRightFromSquare:C0,ArrowUpRightSquare:y0,ArrowUpSquare:H0,ArrowUpToLine:H1,ArrowUpWideNarrow:V1,ArrowUpZA:D,ArrowUpZa:D,ArrowsUpFromLine:z1,Asterisk:b1,AsteriskSquare:V0,Astroid:S1,AtSign:L1,Atom:_1,AudioLines:q1,AudioWaveform:P1,Award:F1,Axe:D1,Axis3D:T,Axis3d:T,Baby:T1,Backpack:R1,Badge:es,BadgeAlert:Z1,BadgeCent:U1,BadgeCheck:R,BadgeDollarSign:O1,BadgeEuro:I1,BadgeHelp:Z,BadgeIndianRupee:G1,BadgeInfo:W1,BadgeJapaneseYen:E1,BadgeMinus:X1,BadgePercent:N1,BadgePlus:K1,BadgePoundSterling:J1,BadgeQuestionMark:Z,BadgeRussianRuble:Q1,BadgeSwissFranc:$1,BadgeTurkishLira:Y1,BadgeX:ts,BaggageClaim:os,Balloon:ss,Ban:rs,Banana:is,Bandage:ns,Banknote:ds,BanknoteArrowDown:ls,BanknoteArrowUp:hs,BanknoteX:as,BarChart:t2,BarChart2:e2,BarChart3:Y,BarChart4:Q,BarChartBig:J,BarChartHorizontal:K,BarChartHorizontalBig:N,Barcode:cs,Barrel:ws,Baseline:us,Bath:ps,Battery:fs,BatteryCharging:gs,BatteryFull:vs,BatteryLow:ks,BatteryMedium:xs,BatteryPlus:Ms,BatteryWarning:ms,Beaker:Cs,Bean:js,BeanOff:Bs,Bed:As,BedDouble:ys,BedSingle:Hs,Beef:zs,BeefOff:Vs,Beer:bs,BeerOff:Ls,Bell:Rs,BellCheck:Ss,BellDot:_s,BellElectric:Fs,BellMinus:qs,BellOff:Ps,BellPlus:Ds,BellRing:Ts,BetweenHorizonalEnd:O,BetweenHorizonalStart:U,BetweenHorizontalEnd:O,BetweenHorizontalStart:U,BetweenVerticalEnd:Zs,BetweenVerticalStart:Us,BicepsFlexed:Os,Bike:Is,Binary:Gs,Binoculars:Ws,Biohazard:Es,Bird:Ns,Birdhouse:Xs,Bitcoin:Ks,Blend:Js,Blender:Qs,Blinds:$s,Blocks:Ys,Bluetooth:rr,BluetoothConnected:er,BluetoothOff:tr,BluetoothSearching:or,Bold:sr,Bolt:ir,Bomb:nr,Bone:lr,Book:Sr,BookA:hr,BookAlert:ar,BookAudio:dr,BookCheck:cr,BookCopy:wr,BookDashed:I,BookDown:pr,BookHeadphones:ur,BookHeart:gr,BookImage:kr,BookKey:vr,BookLock:xr,BookMarked:Mr,BookMinus:mr,BookOpen:Br,BookOpenCheck:fr,BookOpenText:Cr,BookPlus:jr,BookSearch:yr,BookTemplate:I,BookText:Hr,BookType:Vr,BookUp:zr,BookUp2:Ar,BookUser:br,BookX:Lr,Bookmark:Tr,BookmarkCheck:_r,BookmarkMinus:qr,BookmarkOff:Pr,BookmarkPlus:Fr,BookmarkX:Dr,BoomBox:Rr,Bot:Or,BotMessageSquare:Zr,BotOff:Ur,BottleWine:Ir,BowArrow:Wr,Box:Gr,BoxSelect:Z0,Boxes:Er,Braces:G,Brackets:Nr,Brain:Qr,BrainCircuit:Xr,BrainCog:Kr,BrickWall:Yr,BrickWallFire:Jr,BrickWallShield:$r,Briefcase:si,BriefcaseBusiness:ti,BriefcaseConveyorBelt:ei,BriefcaseMedical:oi,BringToFront:ri,Broccoli:hi,Brush:ni,BrushCleaning:ii,Bubbles:li,Bug:wi,BugOff:ai,BugPlay:di,Building:ci,Building2:pi,Bus:gi,BusFront:ui,Cable:ki,CableCar:vi,Cake:Mi,CakeSlice:xi,Calculator:mi,Calendar:Ui,Calendar1:fi,CalendarArrowDown:Ci,CalendarArrowUp:Bi,CalendarCheck:yi,CalendarCheck2:ji,CalendarClock:Hi,CalendarCog:Vi,CalendarDays:Ai,CalendarFold:zi,CalendarHeart:bi,CalendarMinus:Si,CalendarMinus2:Li,CalendarOff:_i,CalendarPlus:qi,CalendarPlus2:Pi,CalendarRange:Fi,CalendarSearch:Di,CalendarSync:Ti,CalendarX:Zi,CalendarX2:Ri,Calendars:Oi,Camera:Gi,CameraOff:Ii,CandlestickChart:X,Candy:Ni,CandyCane:Wi,CandyOff:Ei,Cannabis:Ki,CannabisOff:Xi,Captions:W,CaptionsOff:Ji,Car:Yi,CarFront:Qi,CarTaxiFront:$i,Caravan:tn,CardSim:en,Carrot:sn,CaseLower:on,CaseSensitive:rn,CaseUpper:nn,CassetteTape:hn,Cast:ln,Castle:an,Cat:dn,Cctv:cn,CctvOff:wn,ChartArea:E,ChartBar:K,ChartBarBig:N,ChartBarDecreasing:pn,ChartBarIncreasing:un,ChartBarStacked:gn,ChartCandlestick:X,ChartColumn:Y,ChartColumnBig:J,ChartColumnDecreasing:vn,ChartColumnIncreasing:Q,ChartColumnStacked:kn,ChartGantt:xn,ChartLine:$,ChartNetwork:Mn,ChartNoAxesColumn:e2,ChartNoAxesColumnDecreasing:mn,ChartNoAxesColumnIncreasing:t2,ChartNoAxesCombined:fn,ChartNoAxesGantt:o2,ChartPie:s2,ChartScatter:r2,ChartSpline:Cn,Check:yn,CheckCheck:Bn,CheckCircle:u2,CheckCircle2:g2,CheckLine:jn,CheckSquare:L0,CheckSquare2:S0,ChefHat:Hn,Cherry:Vn,ChessBishop:An,ChessKing:zn,ChessKnight:bn,ChessPawn:Ln,ChessQueen:Sn,ChessRook:_n,ChevronDown:qn,ChevronDownCircle:v2,ChevronDownSquare:_0,ChevronFirst:Pn,ChevronLast:Fn,ChevronLeft:Dn,ChevronLeftCircle:k2,ChevronLeftSquare:q0,ChevronRight:Tn,ChevronRightCircle:x2,ChevronRightSquare:P0,ChevronUp:Rn,ChevronUpCircle:M2,ChevronUpSquare:F0,ChevronsDown:Un,ChevronsDownUp:Zn,ChevronsLeft:Gn,ChevronsLeftRight:In,ChevronsLeftRightEllipsis:On,ChevronsRight:En,ChevronsRightLeft:Wn,ChevronsUp:Xn,ChevronsUpDown:Nn,Church:Kn,Cigarette:Qn,CigaretteOff:Jn,Circle:wl,CircleAlert:i2,CircleArrowDown:n2,CircleArrowLeft:l2,CircleArrowOutDownLeft:h2,CircleArrowOutDownRight:a2,CircleArrowOutUpLeft:d2,CircleArrowOutUpRight:c2,CircleArrowRight:w2,CircleArrowUp:p2,CircleCheck:g2,CircleCheckBig:u2,CircleChevronDown:v2,CircleChevronLeft:k2,CircleChevronRight:x2,CircleChevronUp:M2,CircleDashed:$n,CircleDivide:m2,CircleDollarSign:Yn,CircleDot:el,CircleDotDashed:tl,CircleEllipsis:ol,CircleEqual:sl,CircleFadingArrowUp:rl,CircleFadingPlus:il,CircleGauge:f2,CircleHelp:k,CircleMinus:C2,CircleOff:nl,CircleParking:j2,CircleParkingOff:B2,CirclePause:y2,CirclePercent:H2,CirclePile:ll,CirclePlay:V2,CirclePlus:A2,CirclePoundSterling:hl,CirclePower:z2,CircleQuestionMark:k,CircleSlash:al,CircleSlash2:b2,CircleSlashed:b2,CircleSmall:dl,CircleStar:cl,CircleStop:L2,CircleUser:S2,CircleUserRound:_2,CircleX:q2,CircuitBoard:pl,Citrus:ul,Clapperboard:gl,Clipboard:yl,ClipboardCheck:vl,ClipboardClock:kl,ClipboardCopy:xl,ClipboardEdit:F2,ClipboardList:Ml,ClipboardMinus:ml,ClipboardPaste:fl,ClipboardPen:F2,ClipboardPenLine:P2,ClipboardPlus:Cl,ClipboardSignature:P2,ClipboardType:Bl,ClipboardX:jl,Clock:Gl,Clock1:Vl,Clock10:Hl,Clock11:Al,Clock12:zl,Clock2:bl,Clock3:Sl,Clock4:Ll,Clock5:_l,Clock6:ql,Clock7:Pl,Clock8:Fl,Clock9:Dl,ClockAlert:Tl,ClockArrowDown:Zl,ClockArrowUp:Rl,ClockCheck:Ul,ClockFading:Ol,ClockPlus:Il,ClosedCaption:Wl,Cloud:ah,CloudAlert:El,CloudBackup:Xl,CloudCheck:Nl,CloudCog:Kl,CloudDownload:D2,CloudDrizzle:Jl,CloudFog:Ql,CloudHail:$l,CloudLightning:Yl,CloudMoon:eh,CloudMoonRain:th,CloudOff:oh,CloudRain:rh,CloudRainWind:sh,CloudSnow:ih,CloudSun:lh,CloudSunRain:nh,CloudSync:hh,CloudUpload:T2,Cloudy:dh,Clover:ch,Club:wh,Code:ph,Code2:R2,CodeSquare:D0,CodeXml:R2,Coffee:uh,Cog:gh,Coins:vh,Columns:Z2,Columns2:Z2,Columns3:U2,Columns3Cog:x,Columns4:kh,ColumnsSettings:x,Combine:xh,Command:mh,Compass:Mh,Component:fh,Computer:Ch,ConciergeBell:Bh,Cone:jh,Construction:yh,Contact:Hh,Contact2:O2,ContactRound:O2,Container:Vh,Contrast:Ah,Cookie:bh,CookingPot:zh,Copy:Dh,CopyCheck:Lh,CopyMinus:Sh,CopyPlus:_h,CopySlash:Ph,CopyX:qh,Copyleft:Fh,Copyright:Th,CornerDownLeft:Rh,CornerDownRight:Zh,CornerLeftDown:Uh,CornerLeftUp:Oh,CornerRightDown:Ih,CornerRightUp:Gh,CornerUpLeft:Wh,CornerUpRight:Nh,Cpu:Eh,CreativeCommons:Kh,CreditCard:Xh,Croissant:Jh,Crop:Qh,Cross:$h,Crosshair:Yh,Crown:ta,Cuboid:ea,CupSoda:oa,CurlyBraces:G,Currency:sa,Cylinder:ia,Dam:ra,Database:aa,DatabaseBackup:na,DatabaseSearch:la,DatabaseZap:ha,DecimalsArrowLeft:da,DecimalsArrowRight:ca,Delete:wa,Dessert:pa,Diameter:ua,Diamond:ka,DiamondMinus:ga,DiamondPercent:I2,DiamondPlus:va,Dice1:xa,Dice2:Ma,Dice3:ma,Dice4:fa,Dice5:Ca,Dice6:Ba,Dices:ja,Diff:ya,Disc:za,Disc2:Ha,Disc3:Va,DiscAlbum:Aa,Divide:ba,DivideCircle:m2,DivideSquare:U0,Dna:Sa,DnaOff:La,Dock:_a,Dog:qa,DollarSign:Pa,Donut:Fa,DoorClosed:Ta,DoorClosedLocked:Da,DoorOpen:Ra,Dot:Za,DotSquare:O0,Download:Ua,DownloadCloud:D2,DraftingCompass:Ia,Drama:Oa,Drill:Ga,Drone:Wa,Droplet:Na,DropletOff:Ea,Droplets:Xa,Drum:Ka,Drumstick:Ja,Dumbbell:Qa,Ear:$a,EarOff:Ya,Earth:G2,EarthLock:td,Eclipse:od,Edit:p,Edit2:o0,Edit3:e0,Egg:sd,EggFried:rd,EggOff:ed,Ellipse:id,Ellipsis:E2,EllipsisVertical:W2,Equal:hd,EqualApproximately:nd,EqualNot:ld,EqualSquare:I0,Eraser:dd,EthernetPort:ad,Euro:cd,EvCharger:pd,Expand:wd,ExternalLink:ud,Eye:kd,EyeClosed:gd,EyeOff:vd,Factory:xd,Fan:Md,FastForward:md,Feather:fd,Fence:Cd,FerrisWheel:Bd,File:$d,FileArchive:jd,FileAudio:M,FileAudio2:M,FileAxis3D:N2,FileAxis3d:N2,FileBadge:X2,FileBadge2:X2,FileBarChart:Q2,FileBarChart2:$2,FileBox:yd,FileBraces:J2,FileBracesCorner:K2,FileChartColumn:$2,FileChartColumnIncreasing:Q2,FileChartLine:Y2,FileChartPie:et,FileCheck:Hd,FileCheck2:tt,FileCheckCorner:tt,FileClock:Vd,FileCode:Ad,FileCode2:ot,FileCodeCorner:ot,FileCog:st,FileCog2:st,FileDiff:zd,FileDigit:bd,FileDown:Ld,FileEdit:ht,FileExclamationPoint:rt,FileHeadphone:M,FileHeart:Sd,FileImage:_d,FileInput:qd,FileJson:J2,FileJson2:K2,FileKey:it,FileKey2:it,FileLineChart:Y2,FileLock:nt,FileLock2:nt,FileMinus:Pd,FileMinus2:lt,FileMinusCorner:lt,FileMusic:Fd,FileOutput:Dd,FilePen:ht,FilePenLine:at,FilePieChart:et,FilePlay:dt,FilePlus:Td,FilePlus2:ct,FilePlusCorner:ct,FileQuestion:wt,FileQuestionMark:wt,FileScan:Rd,FileSearch:Zd,FileSearch2:pt,FileSearchCorner:pt,FileSignal:ut,FileSignature:at,FileSliders:Ud,FileSpreadsheet:Od,FileStack:Id,FileSymlink:Gd,FileTerminal:Wd,FileText:Ed,FileType:Nd,FileType2:gt,FileTypeCorner:gt,FileUp:Kd,FileUser:Xd,FileVideo:dt,FileVideo2:vt,FileVideoCamera:vt,FileVolume:Jd,FileVolume2:ut,FileWarning:rt,FileX:Qd,FileX2:kt,FileXCorner:kt,Files:Yd,Film:tc,Filter:ft,FilterX:Ct,Fingerprint:xt,FingerprintPattern:xt,FireExtinguisher:ec,Fish:rc,FishOff:sc,FishSymbol:oc,FishingHook:nc,FishingRod:ic,Flag:dc,FlagOff:lc,FlagTriangleLeft:hc,FlagTriangleRight:ac,Flame:wc,FlameKindling:cc,Flashlight:uc,FlashlightOff:pc,FlaskConical:vc,FlaskConicalOff:gc,FlaskRound:kc,FlipHorizontal:z0,FlipHorizontal2:xc,FlipVertical:b0,FlipVertical2:Mc,Flower:fc,Flower2:mc,Focus:Cc,FoldHorizontal:Bc,FoldVertical:jc,Folder:Yc,FolderArchive:yc,FolderBookmark:Hc,FolderCheck:Vc,FolderClock:Ac,FolderClosed:zc,FolderCode:bc,FolderCog:Mt,FolderCog2:Mt,FolderDot:Lc,FolderDown:Sc,FolderEdit:mt,FolderGit:Pc,FolderGit2:_c,FolderHeart:qc,FolderInput:Fc,FolderKanban:Dc,FolderKey:Tc,FolderLock:Rc,FolderMinus:Zc,FolderOpen:Oc,FolderOpenDot:Uc,FolderOutput:Ic,FolderPen:mt,FolderPlus:Gc,FolderRoot:Ec,FolderSearch:Nc,FolderSearch2:Wc,FolderSymlink:Xc,FolderSync:Kc,FolderTree:Jc,FolderUp:Qc,FolderX:$c,Folders:t4,Footprints:e4,ForkKnife:_e,ForkKnifeCrossed:Se,Forklift:o4,Form:s4,FormInput:r0,Forward:r4,Frame:i4,Frown:n4,Fuel:l4,Fullscreen:h4,FunctionSquare:G0,Funnel:ft,FunnelPlus:a4,FunnelX:Ct,GalleryHorizontal:c4,GalleryHorizontalEnd:d4,GalleryThumbnails:p4,GalleryVertical:g4,GalleryVerticalEnd:w4,Gamepad:v4,Gamepad2:u4,GamepadDirectional:k4,GanttChart:o2,GanttChartSquare:B,Gauge:M4,GaugeCircle:f2,Gavel:x4,Gem:m4,GeorgianLari:f4,Ghost:C4,Gift:B4,GitBranch:H4,GitBranchMinus:j4,GitBranchPlus:y4,GitCommit:Bt,GitCommitHorizontal:Bt,GitCommitVertical:V4,GitCompare:z4,GitCompareArrows:A4,GitFork:b4,GitGraph:L4,GitMerge:S4,GitMergeConflict:q4,GitPullRequest:R4,GitPullRequestArrow:_4,GitPullRequestClosed:P4,GitPullRequestCreate:F4,GitPullRequestCreateArrow:D4,GitPullRequestDraft:T4,GlassWater:Z4,Glasses:U4,Globe:W4,Globe2:G2,GlobeLock:O4,GlobeOff:I4,GlobeX:G4,Goal:E4,Gpu:X4,Grab:At,GraduationCap:N4,Grape:K4,Grid:m,Grid2X2:Vt,Grid2X2Check:jt,Grid2X2Plus:yt,Grid2X2X:Ht,Grid2x2:Vt,Grid2x2Check:jt,Grid2x2Plus:yt,Grid2x2X:Ht,Grid3X3:m,Grid3x2:J4,Grid3x3:m,Grip:Y4,GripHorizontal:Q4,GripVertical:$4,Group:tw,Guitar:ew,Ham:ow,Hamburger:sw,Hammer:rw,Hand:dw,HandCoins:iw,HandFist:nw,HandGrab:At,HandHeart:lw,HandHelping:zt,HandMetal:hw,HandPlatter:aw,Handbag:cw,Handshake:ww,HardDrive:gw,HardDriveDownload:pw,HardDriveUpload:uw,HardHat:vw,Hash:kw,HatGlasses:xw,Haze:Mw,Hd:Cw,HdmiPort:mw,Heading:Aw,Heading1:fw,Heading2:jw,Heading3:Bw,Heading4:yw,Heading5:Hw,Heading6:Vw,HeadphoneOff:zw,Headphones:bw,Headset:Lw,Heart:Zw,HeartCrack:Sw,HeartHandshake:_w,HeartMinus:qw,HeartOff:Pw,HeartPlus:Fw,HeartPulse:Dw,HeartX:Tw,Heater:Rw,Helicopter:Uw,HelpCircle:k,HelpingHand:zt,Hexagon:Ow,Highlighter:Gw,History:Iw,Home:bt,Hop:Ew,HopOff:Ww,Hospital:Xw,Hotel:Nw,Hourglass:Kw,House:bt,HouseHeart:Jw,HousePlug:Qw,HousePlus:$w,HouseWifi:Yw,IceCream:St,IceCream2:Lt,IceCreamBowl:Lt,IceCreamCone:St,IdCard:ep,IdCardLanyard:tp,Image:ap,ImageDown:op,ImageMinus:sp,ImageOff:ip,ImagePlay:rp,ImagePlus:lp,ImageUp:np,ImageUpscale:hp,Images:dp,Import:cp,Inbox:pp,Indent:C,IndentDecrease:f,IndentIncrease:C,IndianRupee:wp,Infinity:up,Info:gp,Inspect:J0,InspectionPanel:vp,Italic:xp,IterationCcw:kp,IterationCw:Mp,JapaneseYen:mp,Joystick:fp,Kanban:Cp,KanbanSquare:E0,KanbanSquareDashed:T0,Kayak:Bp,Key:Hp,KeyRound:jp,KeySquare:yp,Keyboard:zp,KeyboardMusic:Vp,KeyboardOff:Ap,Lamp:qp,LampCeiling:bp,LampDesk:Sp,LampFloor:Lp,LampWallDown:Pp,LampWallUp:_p,LandPlot:Fp,Landmark:Dp,Languages:Tp,Laptop:Zp,Laptop2:_t,LaptopMinimal:_t,LaptopMinimalCheck:Rp,Lasso:Op,LassoSelect:Up,Laugh:Ip,Layers:qt,Layers2:Gp,Layers3:qt,LayersMinus:Wp,LayersPlus:Ep,Layout:t0,LayoutDashboard:Np,LayoutGrid:Xp,LayoutList:Kp,LayoutPanelLeft:Jp,LayoutPanelTop:$p,LayoutTemplate:Qp,Leaf:Yp,LeafyGreen:tu,Lectern:eu,LensConcave:ou,LensConvex:iu,LetterText:xe,Library:ru,LibraryBig:su,LibrarySquare:W0,LifeBuoy:nu,Ligature:hu,Lightbulb:au,LightbulbOff:lu,LineChart:$,LineDotRightHorizontal:du,LineSquiggle:wu,LineStyle:cu,Link:gu,Link2:pu,Link2Off:uu,List:qu,ListCheck:vu,ListChecks:ku,ListChevronsDownUp:xu,ListChevronsUpDown:Mu,ListCollapse:mu,ListEnd:Cu,ListFilter:Bu,ListFilterPlus:fu,ListIndentDecrease:f,ListIndentIncrease:C,ListMinus:ju,ListMusic:yu,ListOrdered:Vu,ListPlus:Hu,ListRestart:Au,ListStart:zu,ListTodo:bu,ListTree:Lu,ListVideo:Su,ListX:_u,Loader:Fu,Loader2:Pt,LoaderCircle:Pt,LoaderPinwheel:Pu,Locate:Ru,LocateFixed:Du,LocateOff:Tu,LocationEdit:Rt,Lock:Uu,LockKeyhole:Zu,LockKeyholeOpen:Ft,LockOpen:Dt,LogIn:Ou,LogOut:Iu,Logs:Gu,Lollipop:Wu,Luggage:Nu,MSquare:N0,Magnet:Eu,Mail:eg,MailCheck:Xu,MailMinus:Ku,MailOpen:Ju,MailPlus:Qu,MailQuestion:Tt,MailQuestionMark:Tt,MailSearch:tg,MailWarning:$u,MailX:Yu,Mailbox:og,Mails:sg,Map:mg,MapMinus:rg,MapPin:kg,MapPinCheck:ig,MapPinCheckInside:ng,MapPinHouse:lg,MapPinMinus:ag,MapPinMinusInside:hg,MapPinOff:dg,MapPinPen:Rt,MapPinPlus:wg,MapPinPlusInside:cg,MapPinSearch:pg,MapPinX:gg,MapPinXInside:ug,MapPinned:vg,MapPlus:xg,Mars:fg,MarsStroke:Mg,Martini:Cg,Maximize:jg,Maximize2:Bg,Medal:yg,Megaphone:Vg,MegaphoneOff:Hg,Meh:Ag,MemoryStick:zg,Menu:bg,MenuSquare:X0,Merge:Lg,MessageCircle:Og,MessageCircleCheck:Sg,MessageCircleCode:_g,MessageCircleDashed:qg,MessageCircleHeart:Pg,MessageCircleMore:Dg,MessageCircleOff:Fg,MessageCirclePlus:Tg,MessageCircleQuestion:Zt,MessageCircleQuestionMark:Zt,MessageCircleReply:Rg,MessageCircleWarning:Zg,MessageCircleX:Ug,MessageSquare:i3,MessageSquareCheck:Ig,MessageSquareCode:Wg,MessageSquareDashed:Gg,MessageSquareDiff:Eg,MessageSquareDot:Ng,MessageSquareHeart:Xg,MessageSquareLock:Kg,MessageSquareMore:Jg,MessageSquareOff:Qg,MessageSquarePlus:$g,MessageSquareQuote:Yg,MessageSquareReply:t3,MessageSquareShare:e3,MessageSquareText:o3,MessageSquareWarning:s3,MessageSquareX:r3,MessagesSquare:n3,Metronome:l3,Mic:a3,Mic2:Ut,MicOff:h3,MicVocal:Ut,Microchip:d3,Microscope:c3,Microwave:w3,Milestone:p3,Milk:g3,MilkOff:u3,Minimize:k3,Minimize2:v3,Minus:x3,MinusCircle:C2,MinusSquare:K0,MirrorRectangular:M3,MirrorRound:m3,Monitor:q3,MonitorCheck:f3,MonitorCloud:C3,MonitorCog:B3,MonitorDot:j3,MonitorDown:y3,MonitorOff:H3,MonitorPause:V3,MonitorPlay:A3,MonitorSmartphone:z3,MonitorSpeaker:b3,MonitorStop:L3,MonitorUp:S3,MonitorX:_3,Moon:P3,MoonStar:F3,MoreHorizontal:E2,MoreVertical:W2,Motorbike:D3,Mountain:R3,MountainSnow:T3,Mouse:X3,MouseLeft:Z3,MouseOff:U3,MousePointer:E3,MousePointer2:I3,MousePointer2Off:O3,MousePointerBan:G3,MousePointerClick:W3,MousePointerSquareDashed:R0,MouseRight:N3,Move:lv,Move3D:Ot,Move3d:Ot,MoveDiagonal:J3,MoveDiagonal2:K3,MoveDown:$3,MoveDownLeft:Q3,MoveDownRight:tv,MoveHorizontal:Y3,MoveLeft:ev,MoveRight:ov,MoveUp:rv,MoveUpLeft:sv,MoveUpRight:iv,MoveVertical:nv,Music:cv,Music2:hv,Music3:dv,Music4:av,Navigation:gv,Navigation2:pv,Navigation2Off:wv,NavigationOff:uv,Network:vv,Newspaper:kv,Nfc:xv,NonBinary:Mv,Notebook:Bv,NotebookPen:mv,NotebookTabs:fv,NotebookText:Cv,NotepadText:yv,NotepadTextDashed:jv,Nut:Vv,NutOff:Hv,Octagon:zv,OctagonAlert:Gt,OctagonMinus:Av,OctagonPause:It,OctagonX:Wt,Omega:bv,Option:Lv,Orbit:Sv,Origami:_v,Outdent:f,Package:Uv,Package2:qv,PackageCheck:Pv,PackageMinus:Fv,PackageOpen:Dv,PackagePlus:Tv,PackageSearch:Rv,PackageX:Zv,PaintBucket:Ov,PaintRoller:Iv,Paintbrush:Gv,Paintbrush2:Et,PaintbrushVertical:Et,Palette:Wv,Palmtree:fe,Panda:Ev,PanelBottom:Kv,PanelBottomClose:Nv,PanelBottomDashed:Nt,PanelBottomInactive:Nt,PanelBottomOpen:Xv,PanelLeft:Qt,PanelLeftClose:Xt,PanelLeftDashed:Jt,PanelLeftInactive:Jt,PanelLeftOpen:Kt,PanelLeftRightDashed:Jv,PanelRight:Yv,PanelRightClose:Qv,PanelRightDashed:$t,PanelRightInactive:$t,PanelRightOpen:$v,PanelTop:s5,PanelTopBottomDashed:t5,PanelTopClose:e5,PanelTopDashed:Yt,PanelTopInactive:Yt,PanelTopOpen:o5,PanelsLeftBottom:r5,PanelsLeftRight:U2,PanelsRightBottom:i5,PanelsTopBottom:l0,PanelsTopLeft:t0,Paperclip:n5,Parentheses:l5,ParkingCircle:j2,ParkingCircleOff:B2,ParkingMeter:h5,ParkingSquare:$0,ParkingSquareOff:Q0,PartyPopper:a5,Pause:d5,PauseCircle:y2,PauseOctagon:It,PawPrint:w5,PcCase:c5,Pen:o0,PenBox:p,PenLine:e0,PenOff:u5,PenSquare:p,PenTool:p5,Pencil:x5,PencilLine:g5,PencilOff:v5,PencilRuler:k5,Pentagon:m5,Percent:M5,PercentCircle:H2,PercentDiamond:I2,PercentSquare:te,PersonStanding:f5,PhilippinePeso:C5,Phone:z5,PhoneCall:B5,PhoneForwarded:j5,PhoneIncoming:y5,PhoneMissed:H5,PhoneOff:V5,PhoneOutgoing:A5,Pi:b5,PiSquare:Y0,Piano:L5,Pickaxe:S5,PictureInPicture:q5,PictureInPicture2:_5,PieChart:s2,PiggyBank:P5,Pilcrow:T5,PilcrowLeft:F5,PilcrowRight:D5,PilcrowSquare:ee,Pill:Z5,PillBottle:R5,Pin:O5,PinOff:U5,Pipette:I5,Pizza:G5,Plane:N5,PlaneLanding:W5,PlaneTakeoff:E5,Play:X5,PlayCircle:V2,PlaySquare:se,Plug:J5,Plug2:K5,PlugZap:s0,PlugZap2:s0,Plus:Q5,PlusCircle:A2,PlusSquare:oe,PocketKnife:$5,Podcast:Y5,Pointer:ek,PointerOff:tk,Popcorn:ok,Popsicle:sk,PoundSterling:rk,Power:nk,PowerCircle:z2,PowerOff:ik,PowerSquare:re,Presentation:lk,Printer:dk,PrinterCheck:hk,PrinterX:ak,Projector:ck,Proportions:wk,Puzzle:pk,Pyramid:uk,QrCode:gk,Quote:vk,Rabbit:kk,Radar:xk,Radiation:Mk,Radical:mk,Radio:jk,RadioOff:fk,RadioReceiver:Ck,RadioTower:Bk,Radius:yk,Rainbow:Hk,Rat:Vk,Ratio:Ak,Receipt:Tk,ReceiptCent:zk,ReceiptEuro:bk,ReceiptIndianRupee:Lk,ReceiptJapaneseYen:Sk,ReceiptPoundSterling:_k,ReceiptRussianRuble:qk,ReceiptSwissFranc:Pk,ReceiptText:Fk,ReceiptTurkishLira:Dk,RectangleCircle:Rk,RectangleEllipsis:r0,RectangleGoggles:Ok,RectangleHorizontal:Zk,RectangleVertical:Uk,Recycle:Ik,Redo:Ek,Redo2:Gk,RedoDot:Wk,RefreshCcw:Xk,RefreshCcwDot:Nk,RefreshCw:Qk,RefreshCwOff:Kk,Refrigerator:Jk,Regex:$k,RemoveFormatting:Yk,Repeat:s6,Repeat1:t6,Repeat2:e6,RepeatOff:o6,Replace:i6,ReplaceAll:r6,Reply:l6,ReplyAll:n6,Rewind:h6,Ribbon:a6,Road:d6,Rocket:c6,RockingChair:w6,RollerCoaster:p6,Rose:u6,Rotate3D:i0,Rotate3d:i0,RotateCcw:k6,RotateCcwKey:g6,RotateCcwSquare:v6,RotateCw:M6,RotateCwSquare:x6,Route:f6,RouteOff:m6,Router:C6,Rows:n0,Rows2:n0,Rows3:l0,Rows4:B6,Rss:j6,Ruler:y6,RulerDimensionLine:H6,RussianRuble:V6,Sailboat:A6,Salad:b6,Sandwich:z6,Satellite:S6,SatelliteDish:L6,SaudiRiyal:_6,Save:F6,SaveAll:q6,SaveOff:P6,Scale:D6,Scale3D:h0,Scale3d:h0,Scaling:T6,Scan:N6,ScanBarcode:R6,ScanEye:Z6,ScanFace:U6,ScanHeart:O6,ScanLine:I6,ScanQrCode:G6,ScanSearch:W6,ScanText:E6,ScatterChart:r2,School:X6,School2:je,Scissors:J6,ScissorsLineDashed:K6,ScissorsSquare:ie,ScissorsSquareDashedBottom:A0,Scooter:Q6,ScreenShare:t8,ScreenShareOff:$6,Scroll:e8,ScrollText:Y6,Search:n8,SearchAlert:r8,SearchCheck:o8,SearchCode:s8,SearchSlash:i8,SearchX:h8,Section:l8,Send:d8,SendHorizonal:a0,SendHorizontal:a0,SendToBack:a8,SeparatorHorizontal:c8,SeparatorVertical:w8,Server:v8,ServerCog:p8,ServerCrash:u8,ServerOff:g8,Settings:x8,Settings2:k8,Shapes:M8,Share:f8,Share2:m8,Sheet:C8,Shell:B8,ShelvingUnit:j8,Shield:F8,ShieldAlert:H8,ShieldBan:y8,ShieldCheck:V8,ShieldClose:c0,ShieldCog:z8,ShieldCogCorner:A8,ShieldEllipsis:b8,ShieldHalf:L8,ShieldMinus:_8,ShieldOff:S8,ShieldPlus:q8,ShieldQuestion:d0,ShieldQuestionMark:d0,ShieldUser:P8,ShieldX:c0,Ship:T8,ShipWheel:D8,Shirt:R8,ShoppingBag:Z8,ShoppingBasket:O8,ShoppingCart:U8,Shovel:I8,ShowerHead:G8,Shredder:W8,Shrimp:N8,Shrink:E8,Shrub:X8,Shuffle:K8,Sidebar:Qt,SidebarClose:Xt,SidebarOpen:Kt,Sigma:J8,SigmaSquare:ne,Signal:t7,SignalHigh:$8,SignalLow:Q8,SignalMedium:Y8,SignalZero:e7,Signature:o7,Signpost:i7,SignpostBig:s7,Siren:r7,SkipBack:n7,SkipForward:l7,Skull:h7,Slash:a7,SlashSquare:le,Slice:d7,Sliders:w0,SlidersHorizontal:c7,SlidersVertical:w0,Smartphone:u7,SmartphoneCharging:w7,SmartphoneNfc:p7,Smile:v7,SmilePlus:g7,Snail:k7,Snowflake:x7,SoapDispenserDroplet:M7,Sofa:m7,SolarPanel:f7,SortAsc:F,SortDesc:_,Soup:C7,Space:j7,Spade:B7,Sparkle:y7,Sparkles:p0,Speaker:H7,Speech:V7,SpellCheck:z7,SpellCheck2:A7,Spline:S7,SplinePointer:b7,Split:L7,SplitSquareHorizontal:he,SplitSquareVertical:ae,Spool:_7,SportShoe:q7,Spotlight:F7,SprayCan:P7,Sprout:D7,Square:J7,SquareActivity:u0,SquareArrowDown:k0,SquareArrowDownLeft:g0,SquareArrowDownRight:v0,SquareArrowLeft:x0,SquareArrowOutDownLeft:M0,SquareArrowOutDownRight:f0,SquareArrowOutUpLeft:m0,SquareArrowOutUpRight:C0,SquareArrowRight:B0,SquareArrowRightEnter:T7,SquareArrowRightExit:R7,SquareArrowUp:H0,SquareArrowUpLeft:j0,SquareArrowUpRight:y0,SquareAsterisk:V0,SquareBottomDashedScissors:A0,SquareCenterlineDashedHorizontal:z0,SquareCenterlineDashedVertical:b0,SquareChartGantt:B,SquareCheck:S0,SquareCheckBig:L0,SquareChevronDown:_0,SquareChevronLeft:q0,SquareChevronRight:P0,SquareChevronUp:F0,SquareCode:D0,SquareDashed:Z0,SquareDashedBottom:U7,SquareDashedBottomCode:Z7,SquareDashedKanban:T0,SquareDashedMousePointer:R0,SquareDashedText:j,SquareDashedTopSolid:O7,SquareDivide:U0,SquareDot:O0,SquareEqual:I0,SquareFunction:G0,SquareGanttChart:B,SquareKanban:E0,SquareLibrary:W0,SquareM:N0,SquareMenu:X0,SquareMinus:K0,SquareMousePointer:J0,SquareParking:$0,SquareParkingOff:Q0,SquarePause:I7,SquarePen:p,SquarePercent:te,SquarePi:Y0,SquarePilcrow:ee,SquarePlay:se,SquarePlus:oe,SquarePower:re,SquareRadical:W7,SquareRoundCorner:G7,SquareScissors:ie,SquareSigma:ne,SquareSlash:le,SquareSplitHorizontal:he,SquareSplitVertical:ae,SquareSquare:E7,SquareStack:N7,SquareStar:X7,SquareStop:K7,SquareTerminal:de,SquareUser:we,SquareUserRound:ce,SquareX:pe,SquaresExclude:Q7,SquaresIntersect:$7,SquaresSubtract:Y7,SquaresUnite:tx,Squircle:ex,SquircleDashed:sx,Squirrel:ox,Stamp:rx,Star:nx,StarHalf:ix,StarOff:lx,Stars:p0,StepBack:hx,StepForward:ax,Stethoscope:dx,Sticker:cx,StickyNote:kx,StickyNoteCheck:wx,StickyNoteMinus:px,StickyNoteOff:ux,StickyNotePlus:gx,StickyNoteX:vx,StickyNotes:xx,Stone:Mx,StopCircle:L2,Store:mx,StretchHorizontal:fx,StretchVertical:Cx,Strikethrough:Bx,Subscript:yx,Subtitles:W,Sun:zx,SunDim:jx,SunMedium:Hx,SunMoon:Vx,SunSnow:Ax,Sunrise:bx,Sunset:Lx,Superscript:Sx,SwatchBook:_x,SwissFranc:qx,SwitchCamera:Px,Sword:Fx,Swords:Dx,Syringe:Tx,Table:Nx,Table2:Rx,TableCellsMerge:Ox,TableCellsSplit:Zx,TableColumnsSplit:Ux,TableConfig:x,TableOfContents:Ix,TableProperties:Gx,TableRowsSplit:Wx,Tablet:Xx,TabletSmartphone:Ex,Tablets:Kx,Tag:Jx,Tags:Qx,Tally1:$x,Tally2:e9,Tally3:Yx,Tally4:t9,Tally5:o9,Tangent:s9,Target:r9,Telescope:i9,Tent:l9,TentTree:n9,Terminal:h9,TerminalSquare:de,TestTube:a9,TestTube2:ue,TestTubeDiagonal:ue,TestTubes:d9,Text:y,TextAlignCenter:ve,TextAlignEnd:ge,TextAlignJustify:ke,TextAlignStart:y,TextCursor:w9,TextCursorInput:c9,TextInitial:xe,TextQuote:p9,TextSearch:u9,TextSelect:j,TextSelection:j,TextWrap:Me,Theater:g9,Thermometer:x9,ThermometerSnowflake:v9,ThermometerSun:k9,ThumbsDown:M9,ThumbsUp:m9,Ticket:V9,TicketCheck:f9,TicketMinus:C9,TicketPercent:B9,TicketPlus:j9,TicketSlash:y9,TicketX:H9,Tickets:z9,TicketsPlane:A9,Timeline:b9,Timer:S9,TimerOff:L9,TimerReset:_9,ToggleLeft:q9,ToggleRight:P9,Toilet:F9,ToolCase:D9,Toolbox:T9,Tornado:R9,Torus:Z9,Touchpad:O9,TouchpadOff:U9,TowelRack:I9,TowerControl:G9,ToyBrick:W9,Tractor:E9,TrafficCone:N9,Train:me,TrainFront:K9,TrainFrontTunnel:X9,TrainTrack:J9,TramFront:me,Transgender:Q9,Trash:Y9,Trash2:$9,TreeDeciduous:tM,TreePalm:fe,TreePine:eM,Trees:oM,TrendingDown:sM,TrendingUp:iM,TrendingUpDown:rM,Triangle:hM,TriangleAlert:Ce,TriangleDashed:nM,TriangleRight:lM,Trophy:aM,Truck:dM,TruckElectric:cM,TurkishLira:wM,Turntable:pM,Turtle:gM,Tv:vM,Tv2:Be,TvMinimal:Be,TvMinimalPlay:uM,Type:kM,TypeOutline:xM,Umbrella:mM,UmbrellaOff:MM,Underline:fM,Undo:jM,Undo2:CM,UndoDot:BM,UnfoldHorizontal:yM,UnfoldVertical:HM,Ungroup:VM,University:je,Unlink:zM,Unlink2:AM,Unlock:Dt,UnlockKeyhole:Ft,Unplug:bM,Upload:LM,UploadCloud:T2,Usb:SM,User:EM,User2:be,UserCheck:_M,UserCheck2:ye,UserCircle:S2,UserCircle2:_2,UserCog:qM,UserCog2:He,UserKey:PM,UserLock:FM,UserMinus:DM,UserMinus2:Ve,UserPen:TM,UserPlus:RM,UserPlus2:ze,UserRound:be,UserRoundCheck:ye,UserRoundCog:He,UserRoundKey:ZM,UserRoundMinus:Ve,UserRoundPen:UM,UserRoundPlus:ze,UserRoundSearch:OM,UserRoundX:Ae,UserSearch:IM,UserSquare:we,UserSquare2:ce,UserStar:GM,UserX:WM,UserX2:Ae,Users:NM,Users2:Le,UsersRound:Le,Utensils:_e,UtensilsCrossed:Se,UtilityPole:XM,Van:KM,Variable:JM,Vault:QM,VectorSquare:YM,Vegan:$M,VenetianMask:tm,Venus:om,VenusAndMars:em,Verified:R,Vibrate:rm,VibrateOff:sm,Video:nm,VideoOff:im,Videotape:lm,View:hm,Voicemail:am,Volleyball:dm,Volume:gm,Volume1:cm,Volume2:wm,VolumeOff:pm,VolumeX:um,Vote:km,Wallet:xm,Wallet2:qe,WalletCards:vm,WalletMinimal:qe,Wallpaper:Mm,Wand:mm,Wand2:Pe,WandSparkles:Pe,Warehouse:fm,WashingMachine:Cm,Watch:Bm,Waves:Fe,WavesArrowDown:jm,WavesArrowUp:ym,WavesHorizontal:Fe,WavesLadder:Hm,WavesVertical:Vm,Waypoints:Am,Webcam:zm,Webhook:Sm,WebhookOff:bm,Weight:_m,WeightTilde:Lm,Wheat:Pm,WheatOff:qm,WholeWord:Fm,Wifi:Gm,WifiCog:Dm,WifiHigh:Tm,WifiLow:Rm,WifiOff:Um,WifiPen:Zm,WifiSync:Om,WifiZero:Im,Wind:Wm,WindArrowDown:Em,Wine:Xm,WineOff:Nm,Workflow:Km,Worm:Jm,WrapText:Me,Wrench:Ym,X:$m,XCircle:q2,XLineTop:Qm,XOctagon:Wt,XSquare:pe,Zap:ef,ZapOff:tf,ZodiacAquarius:of,ZodiacAries:rf,ZodiacCancer:sf,ZodiacCapricorn:nf,ZodiacGemini:lf,ZodiacLeo:hf,ZodiacLibra:af,ZodiacOphiuchus:df,ZodiacPisces:cf,ZodiacSagittarius:wf,ZodiacScorpio:pf,ZodiacTaurus:uf,ZodiacVirgo:gf,ZoomIn:vf,ZoomOut:kf},Symbol.toStringTag,{value:"Module"})),Mf={class:"flex flex-col gap-4"},mf={class:"flex items-center justify-between gap-3"},ff={class:"text-p-sm shrink-0 text-ink-gray-5"},Cf={class:"h-[450px] overflow-auto"},Bf={class:"grid grid-cols-[repeat(auto-fill,56px)] gap-1 justify-center"},jf=["onClick"],yf=["innerHTML"],Hf={key:1,class:"p-6 text-p-sm text-ink-gray-5"},Vf=Ge({__name:"LucideGallery",setup(De){const w=new Map;for(const t of Object.values(xf)){if(typeof t!="string")continue;const e=t.match(/lucide lucide-([\w-]+)/);if(!e)continue;const o=e[1];if(w.has(o))continue;const d=t.replace(/stroke-width="[^"]+"/g,'stroke-width="1.5"');w.set(o,d)}const s=[...w.entries()].map(([t,e])=>({name:t,svg:e})).sort((t,e)=>t.name.localeCompare(e.name)),i=Ne("");async function Te(t){try{await navigator.clipboard.writeText(t),H.success(`Copied "${t}"`)}catch{H.error("Failed to copy")}}const g=Xe(()=>{const t=i.value.trim().toLowerCase();if(!t)return s;const e=[],o=[],d=[];for(const n of s)n.name===t?e.push(n):n.name.startsWith(t)?o.push(n):n.name.includes(t)&&d.push(n);return[...e,...o,...d]});return(t,e)=>(h(),u("div",Mf,[r("div",mf,[c(l(Re),{modelValue:i.value,"onUpdate:modelValue":e[0]||(e[0]=o=>i.value=o),placeholder:"Search icons…",class:"w-full"},{prefix:a(()=>[...e[1]||(e[1]=[r("span",{class:"lucide-search size-4 text-ink-gray-5"},null,-1)])]),suffix:a(()=>[r("span",ff,v(g.value.length)+" of "+v(l(s).length),1)]),_:1},8,["modelValue"])]),r("div",Cf,[g.value.length>0?(h(),V(l(Ie),{key:0,"delay-duration":300,"skip-delay-duration":1e3},{default:a(()=>[r("div",Bf,[(h(!0),u(We,null,Ee(g.value,o=>(h(),V(l(Ze),{key:o.name},{default:a(()=>[c(l(Ue),{"as-child":""},{default:a(()=>[r("div",{class:"flex size-14 cursor-pointer items-center justify-center rounded text-ink-gray-7 hover:bg-surface-gray-2",onClick:d=>Te(o.name)},[r("span",{class:"size-6 [&>svg]:size-full",innerHTML:o.svg},null,8,yf)],8,jf)]),_:2},1024),c(l(Oe),{text:o.name},null,8,["text"])]),_:2},1024))),128))])]),_:1})):(h(),u("p",Hf,' No icons match "'+v(i.value)+'". ',1))])]))}}),Lf=JSON.parse('{"title":"Icons","description":"","frontmatter":{},"headers":[],"relativePath":"docs/other/icons.md","filePath":"docs/other/icons.md","lastUpdated":1778762569000}'),Af={name:"docs/other/icons.md"},Sf=Object.assign(Af,{setup(De){return(w,s)=>{const i=Ke("ClientOnly");return h(),u("div",null,[s[0]||(s[0]=A('<h1 id="icons" tabindex="-1">Icons <a class="header-anchor" href="#icons" aria-label="Permalink to “Icons”">​</a></h1><p>Frappe UI ships with the full <a href="https://lucide.dev" target="_blank" rel="noreferrer">Lucide</a> icon set. There are three ways to use an icon in your templates. Pick the first one that fits — they all render the same icon, but the recommended path keeps your code simpler and your bundle smaller.</p><h2 id="browse-all-icons" tabindex="-1">Browse all icons <a class="header-anchor" href="#browse-all-icons" aria-label="Permalink to “Browse all icons”">​</a></h2><p>Every icon below is keyed by its kebab-case name — use that name directly as <code>lucide-&lt;name&gt;</code> in the Tailwind class form, or import it from <code>~icons/lucide/&lt;name&gt;</code>.</p>',4)),c(i,null,{default:a(()=>[c(Vf)]),_:1}),s[1]||(s[1]=A(`<h2 id="recommended-class-based-icons" tabindex="-1">Recommended: class-based icons <a class="header-anchor" href="#recommended-class-based-icons" aria-label="Permalink to “Recommended: class-based icons”">​</a></h2><p>Every Lucide icon is exposed as a Tailwind utility class named <code>lucide-&lt;icon-name&gt;</code>. Drop it on any element and size/tint it with the usual utilities:</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span>
...
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_1uuh8p">span</span><span class="s_1i4ay4"> class</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">lucide-circle-check size-5 text-ink-green-6</span><span class="s_w1p9wo">&quot;</span><span class="s_28rvie"> /</span><span class="s_1zd9e2">&gt;</span></span>
...
<span class="line"><span class="s_13ahmt">)</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">script</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><h3 id="other-components" tabindex="-1">Other components <a class="header-anchor" href="#other-components" aria-label="Permalink to “Other components”">​</a></h3><p><code>Input</code>, <code>FormControl</code>, <code>Tabs</code>, <code>Tooltip</code>, <code>Alert</code>, <code>Sidebar</code> and similar components either accept the same <code>icon</code> / <code>iconLeft</code> / <code>iconRight</code> props or expose a slot where you can drop a <code>&lt;span class=&quot;lucide-...&quot; /&gt;</code> directly. Check each component&#39;s reference page for the exact prop names — the icon API conventions are consistent across the library.</p>`,45))])}}});export{Lf as __pageData,Sf as default};
