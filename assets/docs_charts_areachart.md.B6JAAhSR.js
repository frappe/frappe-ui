...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(z)]),_:1})]),_:1}),n[7]||(n[7]=y('<h2 id="context-in-the-tooltip" tabindex="-1">Context in the tooltip <a class="header-anchor" href="#context-in-the-tooltip" aria-label="Permalink to “Context in the tooltip”">​</a></h2><p><code>tooltipColumns</code> names columns that show only in the tooltip. They get no mark, no legend entry, no color and no place on the value axis. See <a href="/docs/charts/linechart#context-in-the-tooltip">LineChart</a>.</p><h2 id="hiding-a-series" tabindex="-1">Hiding a series <a class="header-anchor" href="#hiding-a-series" aria-label="Permalink to “Hiding a series”">​</a></h2><p>A chart with more than one series draws a legend under the plot. Press an entry to hide that band. The stack closes the gap, and a normalized stack recomputes the shares over the bands that are left. Bind <code>v-model:hiddenSeries</code> to control that list yourself. See <a href="/docs/charts/barchart#hiding-a-series">BarChart</a>.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2>',5)),l(k,{name:"AreaChart",data:t},{code:e(()=>[...n[2]||(n[2]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
