import{_ as g}from"./chunks/PropsTable.3n4Crbpk.js";import{_ as v}from"./chunks/SlotsTable.rsmqxUkq.js";import{_ as k}from"./chunks/EmitsTable.q1YK7PNp.js";import"./chunks/theme.CQQjjnMp.js";import{_ as i}from"./chunks/LineChart.vue_vue_type_script_setup_true_lang.MmdBRVKK.js";import{J as y,ae as o,r as h,o as s,E as l,aG as _,$ as f,ap as j,B as w,bf as e,D as a}from"./chunks/framework.BT_M0EDZ.js";import"./chunks/useChart.C2MpexyS.js";import"./chunks/tokens.Bj1HYr8i.js";import"./chunks/axisChartOptions.BT8onmdi.js";import"./chunks/createSeriesData.DXjBnhRK.js";import"./chunks/dataStackHelper.Bsu6FMsY.js";import"./chunks/referenceLines.BANe6SWh.js";import"./chunks/installLabelLayout.DYuEAO6s.js";import"./chunks/axisAlignTicks.F8QZZCTI.js";import"./chunks/labelLayoutHelper.Bxf08c8B.js";import"./chunks/labelGuideHelper.BbLqtgdL.js";import"./chunks/axisChartCommon.CKy1oENi.js";import"./chunks/format.CVA-1DHd.js";import"./chunks/sectorHelper.QdvUpWP4.js";import"./chunks/usePlotKeyboard.C7fPLxta.js";import"./chunks/hiddenSeries.BGnbo1Bl.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.C6utIcwa.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.BCBfMlfU.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.j9fYDBye.js";const x={class:"grid w-full gap-4 sm:grid-cols-2"},b={class:"h-72"},z={class:"h-72"},C=y({__name:"LineGaps",setup(d){const c={data:[{week:"2026-05-11",share:8.2},{week:"2026-05-18",share:9.1},{week:"2026-05-25",share:9.8},{week:"2026-06-01",share:null},{week:"2026-06-08",share:null},{week:"2026-06-15",share:11.4},{week:"2026-06-22",share:12},{week:"2026-06-29",share:12.9},{week:"2026-07-06",share:13.4},{week:"2026-07-13",share:14.1},{week:"2026-07-20",share:15.2},{week:"2026-07-27",share:16}],x:"week",y:"share",xAxis:{type:"time",timeGrain:"week"},yAxis:{title:"Share of orders (%)"},seriesConfig:{share:{label:"In-app checkout",showDataPoints:!0}}};return(r,t)=>(o(),h("div",x,[s("div",b,[l(_(i),f(c,{title:"In-app checkout",subtitle:"Share of orders, weekly"}),null,16)]),s("div",z,[l(_(i),f(c,{"connect-nulls":"",title:"In-app checkout",subtitle:"Same series with connectNulls"}),null,16)])]))}}),S={class:"h-80 w-full"},A=y({__name:"LineTooltipColumns",setup(d){const p=[{month:"2025-08-01",conversion_rate:2.9,orders:1540,aov:68.4},{month:"2025-09-01",conversion_rate:3.1,orders:1682,aov:71.2},{month:"2025-10-01",conversion_rate:3.4,orders:1910,aov:69.8},{month:"2025-11-01",conversion_rate:4.1,orders:2604,aov:74.5},{month:"2025-12-01",conversion_rate:3.8,orders:2471,aov:81.3},{month:"2026-01-01",conversion_rate:2.8,orders:1489,aov:63.9},{month:"2026-02-01",conversion_rate:3,orders:1603,aov:66.1},{month:"2026-03-01",conversion_rate:3.3,orders:1855,aov:70.7},{month:"2026-04-01",conversion_rate:3.5,orders:1994,aov:73.2},{month:"2026-05-01",conversion_rate:3.6,orders:2088,aov:75.6},{month:"2026-06-01",conversion_rate:3.4,orders:1962,aov:72.8},{month:"2026-07-01",conversion_rate:3.7,orders:2205,aov:78.1}];return(c,r)=>(o(),h("div",S,[l(_(i),{data:p,x:"month",y:"conversion_rate","x-axis":{type:"time",timeGrain:"month"},"y-axis":{title:"Conversion rate",format:t=>`${t}%`},"series-config":{conversion_rate:{label:"Conversion rate"}},"tooltip-columns":[{name:"orders",label:"Orders"},{name:"aov",label:"Average order value",format:t=>`$${t}`}],title:"Checkout conversion",subtitle:"Hover a month: the count and the basket behind the rate"},null,8,["y-axis","tooltip-columns"])]))}}),T={class:"h-80 w-full"},P=y({__name:"LineThresholds",setup(d){const p=[{day:"2026-07-06",p95:412,errors:.9},{day:"2026-07-07",p95:398,errors:.7},{day:"2026-07-08",p95:445,errors:1.1},{day:"2026-07-09",p95:612,errors:2.4},{day:"2026-07-10",p95:704,errors:3.1},{day:"2026-07-11",p95:538,errors:1.6},{day:"2026-07-12",p95:461,errors:1},{day:"2026-07-13",p95:388,errors:.6}];return(c,r)=>(o(),h("div",T,[l(_(i),{data:p,x:"day",y:"p95",y2:"errors","x-axis":{type:"time",timeGrain:"day"},"y-axis":{title:"p95 latency",format:t=>`${t} ms`},"y2-axis":{title:"Error rate",format:t=>`${t}%`},palette:"categorical","series-config":{errors:{label:"Errors"}},"reference-lines":[{value:500,label:"SLA",dashed:!0},{value:2,axis:"y2",label:"Error budget",dashed:!0},{value:"2026-07-09",axis:"x",label:"Release 4.2"}],title:"Latency and errors",subtitle:"API gateway, last eight days"},null,8,["y-axis","y2-axis"])]))}}),O={class:"h-80 w-full"},R=y({__name:"LineFilledSeries",setup(d){const p=[{week:"2026-05-04",signups:1240,plan:1100},{week:"2026-05-11",signups:1385,plan:1150},{week:"2026-05-18",signups:1302,plan:1200},{week:"2026-05-25",signups:1467,plan:1250},{week:"2026-06-01",signups:1590,plan:1300},{week:"2026-06-08",signups:1521,plan:1350},{week:"2026-06-15",signups:1688,plan:1400},{week:"2026-06-22",signups:1744,plan:1450}];return(c,r)=>(o(),h("div",O,[l(_(i),{data:p,x:"week",y:["signups","plan"],"x-axis":{type:"time",timeGrain:"week"},"y-axis":{title:"Signups"},palette:"categorical","series-config":{signups:{type:"area"},plan:{dashed:!0}},title:"Signups against plan",subtitle:"The reading carries a fill; the plan stays a line"})]))}}),D={class:"h-80 w-full"},L=y({__name:"LineDualAxis",setup(d){const p=[{month:"2025-08-01",revenue:144500,target:14e4,attainment:103.2},{month:"2025-09-01",revenue:150700,target:148e3,attainment:101.8},{month:"2025-10-01",revenue:157400,target:155e3,attainment:101.5},{month:"2025-11-01",revenue:172700,target:175e3,attainment:98.7},{month:"2025-12-01",revenue:188600,target:195e3,attainment:96.7},{month:"2026-01-01",revenue:171700,target:178e3,attainment:96.5},{month:"2026-02-01",revenue:177100,target:18e4,attainment:98.4},{month:"2026-03-01",revenue:186700,target:185e3,attainment:100.9},{month:"2026-04-01",revenue:193600,target:19e4,attainment:101.9},{month:"2026-05-01",revenue:202100,target:198e3,attainment:102.1},{month:"2026-06-01",revenue:209500,target:206e3,attainment:101.7},{month:"2026-07-01",revenue:220200,target:215e3,attainment:102.4}];return(c,r)=>(o(),h("div",D,[l(_(i),{data:p,x:"month",y:["revenue","target"],y2:"attainment","x-axis":{type:"time",timeGrain:"month"},"y-axis":{title:"Revenue ($)"},"y2-axis":{title:"Attainment (%)",min:90,max:110},palette:"categorical","series-config":{target:{dashed:!0},attainment:{label:"Attainment"}},title:"Revenue against target",subtitle:"Committed plan vs actuals, last 12 months"})]))}}),E={class:"grid w-full gap-4 sm:grid-cols-2"},q={class:"h-72"},B={class:"h-72"},I=y({__name:"LineNumericAxis",setup(d){const c={data:[{discount:0,conversion:2.1},{discount:5,conversion:3.4},{discount:10,conversion:4.6},{discount:15,conversion:5.1},{discount:40,conversion:6},{discount:60,conversion:6.2}],x:"discount",y:"conversion",xAxis:{title:"Discount (%)"},yAxis:{title:"Conversion (%)"},seriesConfig:{conversion:{label:"Conversion",showDataPoints:!0}}};return(r,t)=>(o(),h("div",E,[s("div",q,[l(_(i),f(c,{title:"Conversion by discount",subtitle:"Discounts as categories"}),null,16)]),s("div",B,[l(_(i),f(c,{"x-axis":{title:"Discount (%)",type:"value"},title:"Conversion by discount",subtitle:"Discounts on a numeric axis"}),null,16)])]))}}),F={class:"h-80 w-full"},N=y({__name:"LineTrend",setup(d){const p=[{month:"2025-08-01",mobile:41200,desktop:26800},{month:"2025-09-01",mobile:43100,desktop:27400},{month:"2025-10-01",mobile:45600,desktop:28200},{month:"2025-11-01",mobile:52400,desktop:31900},{month:"2025-12-01",mobile:58200,desktop:34100},{month:"2026-01-01",mobile:47800,desktop:29600},{month:"2026-02-01",mobile:49300,desktop:30200},{month:"2026-03-01",mobile:52100,desktop:31400},{month:"2026-04-01",mobile:54600,desktop:32300},{month:"2026-05-01",mobile:57200,desktop:33500},{month:"2026-06-01",mobile:59800,desktop:34600},{month:"2026-07-01",mobile:63400,desktop:36100}];return(c,r)=>(o(),h("div",F,[l(_(i),{data:p,x:"month",y:["mobile","desktop"],"x-axis":{type:"time",timeGrain:"month",title:"Month"},"y-axis":{title:"Sessions"},palette:"categorical","series-config":{mobile:{smooth:!0},desktop:{dashed:!0,smooth:!0}},title:"Sessions by device",subtitle:"Store sessions, last 12 months"})]))}}),hs=JSON.parse('{"title":"LineChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/linechart.md","filePath":"docs/charts/linechart.md","lastUpdated":0}'),V={name:"docs/charts/linechart.md"},ds=Object.assign(V,{setup(d){const p=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(v,{data:c}),l(k,{data:r})])}}});export{hs as __pageData,ds as default};
