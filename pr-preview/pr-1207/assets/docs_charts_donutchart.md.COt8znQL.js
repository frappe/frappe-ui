import{_ as v}from"./chunks/PropsTable.3n4Crbpk.js";import{_ as k}from"./chunks/SlotsTable.rsmqxUkq.js";import{_ as z}from"./chunks/EmitsTable.q1YK7PNp.js";import"./chunks/theme.CQQjjnMp.js";import{_ as y}from"./chunks/DonutChart.vue_vue_type_script_setup_true_lang.CxJC5-Pi.js";import{J as f,ae as i,r,E as l,aG as m,o as s,F as w,D as a,aw as u,ak as x,ap as g,B as b,bf as p}from"./chunks/framework.BT_M0EDZ.js";import"./chunks/useChart.C2MpexyS.js";import"./chunks/tokens.Bj1HYr8i.js";import"./chunks/hiddenSeries.BGnbo1Bl.js";import"./chunks/axisChartCommon.CKy1oENi.js";import"./chunks/format.CVA-1DHd.js";import"./chunks/usePlotKeyboard.C7fPLxta.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.C6utIcwa.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.BCBfMlfU.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.j9fYDBye.js";import"./chunks/LegendVisualProvider.UZmg_G2b.js";import"./chunks/labelGuideHelper.BbLqtgdL.js";import"./chunks/labelLayoutHelper.Bxf08c8B.js";import"./chunks/sectorHelper.QdvUpWP4.js";const j={class:"h-80 w-full"},C=f({__name:"DonutHalf",setup(o){const c=[{plan:"Starter",subscriptions:1180},{plan:"Plus",subscriptions:962},{plan:"Pro",subscriptions:418}];return(e,t)=>(i(),r("div",j,[l(m(y),{data:c,category:"plan",value:"subscriptions",variant:"half",palette:"sequential","show-data-labels":"",title:"Plan mix",subtitle:"Active subscriptions, July 2026"})]))}}),S={class:"flex h-96 w-full flex-col gap-2"},O={class:"min-h-0 flex-1"},A={class:"text-p-sm text-ink-gray-5"},T=f({__name:"DonutOthers",setup(o){const c=[{channel:"Organic search",sessions:39900},{channel:"Paid social",sessions:21400},{channel:"Email",sessions:16800},{channel:"Direct",sessions:14700},{channel:"Referral & affiliate",sessions:8900},{channel:"Marketplace",sessions:4500},{channel:"Events",sessions:3110},{channel:"Print",sessions:1490}],e=x(null);return(t,_)=>(i(),r("div",S,[s("div",O,[l(m(y),{data:c,category:"channel",value:"sessions","max-slices":4,"center-label":"sessions",title:"Traffic by channel",subtitle:"Sessions in July 2026",onSelect:_[0]||(_[0]=n=>e.value=n)})]),s("p",A,[e.value?(i(),r(w,{key:0},[a(" Selected "+u(e.value.label)+" · "+u(Math.round(e.value.percent))+"% · "+u(e.value.rows.length)+" row(s) behind it ",1)],64)):(i(),r(w,{key:1},[a("Select a slice — Others carries every row it groups.")],64))])]))}}),P={class:"h-80 w-full"},D=f({__name:"DonutShare",setup(o){const c=[{type:"Attachments",gigabytes:812},{type:"Backups",gigabytes:604},{type:"Images",gigabytes:337},{type:"Logs",gigabytes:149},{type:"Everything else",gigabytes:62}],e=t=>t>=1024?`${(t/1024).toFixed(1)} TB`:`${t} GB`;return(t,_)=>(i(),r("div",P,[l(m(y),{data:c,category:"type",value:"gigabytes","center-label":"stored",format:e,title:"Storage by file type",subtitle:"Across every workspace"})]))}}),Z=JSON.parse('{"title":"DonutChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/donutchart.md","filePath":"docs/charts/donutchart.md","lastUpdated":0}'),R={name:"docs/charts/donutchart.md"},ss=Object.assign(R,{setup(o){const c=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
