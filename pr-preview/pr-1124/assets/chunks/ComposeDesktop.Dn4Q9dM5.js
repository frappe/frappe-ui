import{aj as m,a9 as T,a5 as I,b8 as S,b1 as $,ad as B,r as O,D as e,be as r,aE as t,o as l,B as R,bf as D,bg as f,bi as b,b6 as F}from"./framework.CqMRH6Je.js";import{br as w,a3 as N,X as V,N as g,b4 as A,a2 as C}from"./theme.BZeDYaBu.js";import{u as H,z as L,x as U,P as z,H as q,g as E,h as M,S as o,c as j,q as K,w as P,d as W,O as X,a as Y,A as G,b as J,F as Q,m as Z,p as ee,n as te,B as se,I as ae,j as oe,o as ne,U as re,R as ie,y as le}from"./kits.bY_2ajfR.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const pe={class:"h-screen w-full bg-surface-base text-ink-gray-9"},de={class:"flex shrink-0 items-center space-x-2"},ce={class:"w-full overflow-x-auto"},he={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ue=["onKeydown"],_e={__name:"ComposeDesktop",setup(me){const v=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],_=[H.configure({mention:{items:v}})],x=[z,q,E,M,o,j,K,P,o,W,X,o,Y,G,J,Q,o,Z,ee,te,se,ae,oe,o,ne,o,re,ie],p={light:"/pr-preview/pr-1124/recipes/compose-dashboard-light.png",dark:"/pr-preview/pr-1124/recipes/compose-dashboard-dark.png"},d=m(w()),c=m("Design review: new onboarding flow"),i=m(`
...
`);let h;T(()=>{h=new MutationObserver(()=>{d.value=w()}),h.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}),I(()=>h?.disconnect()),S(d,(n,s)=>{i.value=i.value.replace(p[s],p[n])});const k=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:y}=$({input:c});return(n,s)=>(B(),O("div",pe,[e(t(C),null,{default:r(()=>[e(t(L),{modelValue:i.value,"onUpdate:modelValue":s[1]||(s[1]=a=>i.value=a),extensions:_,"upload-function":k,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:a})=>[e(t(N),null,{default:r(()=>[e(t(V),{items:[{label:"Drafts"},{label:"New discussion"}]}),l("div",de,[e(t(g),{variant:"ghost",icon:"lucide-trash-2",label:"Delete draft"}),e(t(g),{variant:"solid"},{default:r(()=>[...s[2]||(s[2]=[R("Publish",-1)])]),_:1})])]),_:1}),e(t(A),{class:"flex h-10 items-center border-b bg-surface-base px-3 sm:px-5"},{default:r(()=>[l("div",ce,[e(t(U),{editor:a,items:x},null,8,["editor"])])]),_:2},1024),l("div",he,[D(l("textarea",{ref_key:"titleTextarea",ref:y,class:"mt-1 w-full resize-none border-0 bg-transparent px-0 py-0.5 text-4xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":s[0]||(s[0]=u=>c.value=u),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[f(b(u=>a.commands.focus(),["prevent"]),["enter"]),f(b(u=>a.commands.focus(),["prevent"]),["down"])]},null,40,ue),[[F,c.value]]),e(t(le),{editor:a,class:"prose-v3 -mx-2 min-h-[calc(100vh-200px)] max-w-[unset] overflow-auto px-2 pb-40"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1})]))}};export{_e as default};
