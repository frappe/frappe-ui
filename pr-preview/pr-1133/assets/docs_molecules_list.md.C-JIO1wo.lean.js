import{_ as C}from"./chunks/PropsTable.DMuDnY5h.js";import{_ as z}from"./chunks/SlotsTable.CdLhas_H.js";import{_ as $}from"./chunks/EmitsTable.BUOl3ZAR.js";import{_ as R,a as S,b as w}from"./chunks/ListCell.vue_vue_type_script_setup_true_lang.BzY-Bg5b.js";import{_ as A}from"./chunks/ListRows.vue_vue_type_script_setup_true_lang.BmweHu8D.js";import{I as q,ad as f,r as x,D as n,aE as p,be as l,o as s,au as i,p as F,B as a,a0 as g,aj as j,l as W,F as M,am as I,q as U,ao as B,A as v}from"./chunks/framework.BJT_XZV3.js";import{W as P,N as V,P as Q}from"./chunks/theme.DEXxiiko.js";import{_ as E,a as H}from"./chunks/ListHeaderCell.vue_vue_type_script_setup_true_lang.F8NbVGUj.js";import{_ as D}from"./chunks/ListHeaderCellSort.vue_vue_type_script_setup_true_lang.QBa0sGUL.js";const K={class:"h-72 w-full overflow-y-auto rounded-4 border"},Y={class:"text-sm text-ink-gray-4"},X={class:"truncate text-base text-ink-gray-8"},Z={class:"text-sm text-ink-gray-5"},ss=q({__name:"Virtual",setup(k){const u=Array.from({length:1e3},(d,c)=>({id:String(c+1),title:`Task ${c+1}`,status:c%3===0?"Done":c%3===1?"In progress":"Backlog"}));return(d,c)=>(f(),x("div",K,[n(p(R),{columns:["3rem","minmax(0,1fr)","6rem"],"row-height":44,class:"px-2"},{default:l(()=>[n(p(A),{items:p(u),virtual:""},{default:l(({item:_})=>[n(p(S),null,{default:l(()=>[n(p(w),null,{default:l(()=>[s("span",Y,"#"+i(_.id),1)]),_:2},1024),n(p(w),null,{default:l(()=>[s("span",X,i(_.title),1)]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("span",Z,i(_.status),1)]),_:2},1024)]),_:2},1024)]),_:1},8,["items"])]),_:1})]))}}),as={class:"ml-3 min-w-0"},ns={class:"truncate text-base text-ink-gray-8"},ls={class:"mt-0.5 truncate text-sm text-ink-gray-5"},es={class:"text-base text-ink-gray-7"},ps={class:"text-base text-ink-gray-6"},cs=q({__name:"Responsive",setup(k){const u=[{name:"Rosa Diaz",email:"rosa@example.com",role:"Admin",since:"2021-06"},{name:"Jake Peralta",email:"jake@example.com",role:"Member",since:"2022-01"},{name:"Amy Santiago",email:"amy@example.com",role:"Admin",since:"2020-11"},{name:"Terry Jeffords",email:"terry@example.com",role:"Member",since:"2023-03"}];return(d,c)=>(f(),F(p(R),{class:"w-full list-row-px-3",columns:{base:["minmax(0,1fr)","6.5rem"],md:["minmax(0,1fr)","7rem","6rem"],lg:["minmax(0,2fr)","9rem","8rem"]},"row-height":56},{default:l(()=>[n(p(E),null,{default:l(()=>[n(p(H),null,{default:l(()=>[...c[0]||(c[0]=[a("Member",-1)])]),_:1}),n(p(H),{class:"max-md:hidden"},{default:l(()=>[...c[1]||(c[1]=[a("Role",-1)])]),_:1}),n(p(H),{class:"justify-end"},{default:l(()=>[...c[2]||(c[2]=[a("Member since",-1)])]),_:1})]),_:1}),n(p(A),{items:u},{default:l(({item:_,value:h})=>[n(p(S),{value:h},{default:l(()=>[n(p(w),null,{default:l(()=>[n(p(P),{label:_.name,size:"xl"},null,8,["label"]),s("div",as,[s("div",ns,i(_.name),1),s("div",ls,i(_.email),1)])]),_:2},1024),n(p(w),{class:"max-md:hidden"},{default:l(()=>[s("span",es,i(_.role),1)]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("span",ps,i(_.since),1)]),_:2},1024)]),_:2},1032,["value"])]),_:1})]),_:1}))}}),ts={class:"ml-3 min-w-0"},is={class:"truncate text-base text-ink-gray-8"},_s={class:"mt-0.5 truncate text-sm text-ink-gray-5"},os={class:"text-base text-ink-gray-7"},rs={class:"text-base text-ink-gray-6"},ds=q({__name:"Columns",setup(k){const u=[{name:"Rosa Diaz",email:"rosa@example.com",role:"Admin",since:"2021-06"},{name:"Jake Peralta",email:"jake@example.com",role:"Member",since:"2022-01"},{name:"Amy Santiago",email:"amy@example.com",role:"Admin",since:"2020-11"},{name:"Terry Jeffords",email:"terry@example.com",role:"Member",since:"2023-03"},{name:"Raymond Holt",email:"holt@example.com",role:"Guest",since:"2024-08"}],d=j("Rosa Diaz");function c(m){return m?m==="asc"?"lucide-arrow-up":"lucide-arrow-down":"lucide-arrow-up-down"}const _=j("name"),h=j("asc");function y(m,o="asc"){_.value===m?h.value=h.value==="asc"?"desc":"asc":(_.value=m,h.value=o)}function t(m){return _.value===m?h.value:null}const b=W(()=>{const m=h.value==="desc"?-1:1;return[...u].sort((o,r)=>m*o[_.value].localeCompare(r[_.value]))});return(m,o)=>(f(),F(p(R),{active:d.value,"onUpdate:active":o[3]||(o[3]=r=>d.value=r),class:"w-full list-row-px-3",columns:["minmax(0,1fr)","7rem","8rem"],"row-height":56},{default:l(()=>[n(p(E),null,{default:l(()=>[n(p(D),{direction:t("name"),onClick:o[0]||(o[0]=r=>y("name"))},{suffix:l(({direction:r})=>[s("span",{class:g(["block size-3.5",c(r)])},null,2)]),default:l(()=>[o[4]||(o[4]=a(" Member ",-1))]),_:1},8,["direction"]),n(p(D),{direction:t("role"),onClick:o[1]||(o[1]=r=>y("role"))},{suffix:l(({direction:r})=>[s("span",{class:g(["block size-3.5",c(r)])},null,2)]),default:l(()=>[o[5]||(o[5]=a(" Role ",-1))]),_:1},8,["direction"]),n(p(D),{direction:t("since"),class:"justify-end",onClick:o[2]||(o[2]=r=>y("since","desc"))},{suffix:l(({direction:r})=>[s("span",{class:g(["block size-3.5",c(r)])},null,2)]),default:l(()=>[o[6]||(o[6]=a(" Member since ",-1))]),_:1},8,["direction"])]),_:1}),n(p(A),{items:b.value},{default:l(({item:r,value:T})=>[n(p(S),{value:T},{default:l(()=>[n(p(w),null,{default:l(()=>[n(p(P),{label:r.name,size:"xl"},null,8,["label"]),s("div",ts,[s("div",is,i(r.name),1),s("div",_s,i(r.email),1)])]),_:2},1024),n(p(w),null,{default:l(()=>[s("span",os,i(r.role),1)]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("span",rs,i(r.since),1)]),_:2},1024)]),_:2},1032,["value"])]),_:1},8,["items"])]),_:1},8,["active"]))}}),hs={class:"w-full"},ws={class:"mb-2 flex h-7 items-center justify-end text-sm text-ink-gray-5"},ms=["aria-label","onClick"],us={class:"truncate text-base text-ink-gray-8"},ys={class:"text-sm text-ink-gray-5"},fs=q({__name:"RowActions",setup(k){const u=[{id:"1",title:"Q3 launch brief",icon:"lucide-file-text",updated:"2 h"},{id:"2",title:"Hiring pipeline",icon:"lucide-file-spreadsheet",updated:"5 h"},{id:"3",title:"Onboarding flow",icon:"lucide-file-image",updated:"1 d"},{id:"4",title:"Retention report",icon:"lucide-file-chart-column",updated:"3 d"},{id:"5",title:"Support playbook",icon:"lucide-file-text",updated:"6 d"}],d=j(),c=j(["2"]);function _(h){c.value=c.value.includes(h)?c.value.filter(y=>y!==h):[...c.value,h]}return(h,y)=>(f(),x("div",hs,[s("div",ws,[s("span",null,i(c.value.length)+" starred "+i(d.value?` · Opened: ${d.value}`:" · Click a row to open it"),1)]),n(p(R),{class:"list-row-px-3","row-height":48},{default:l(()=>[(f(),x(M,null,I(u,t=>n(p(S),{key:t.id,class:"active:bg-surface-gray-2 sm:rounded-[10px] sm:hover:bg-surface-gray-1"},{default:l(()=>[n(p(w),null,{default:l(()=>[s("span",{class:g([t.icon,"size-4 text-ink-gray-5"]),"aria-hidden":"true"},null,2)]),_:2},1024),n(p(w),null,{default:l(()=>[s("button",{type:"button",class:"absolute inset-0 sm:rounded-[10px]","aria-label":`Open ${t.title}`,onClick:b=>d.value=t.title},null,8,ms),s("span",us,i(t.title),1)]),_:2},1024),n(p(w),{class:"justify-end gap-3"},{default:l(()=>[s("span",ys,i(t.updated),1),n(p(V),{class:"relative",variant:"ghost",label:c.value.includes(t.id)?`Unstar ${t.title}`:`Star ${t.title}`,"aria-pressed":c.value.includes(t.id),onClick:b=>_(t.id)},{icon:l(()=>[s("span",{class:g(["lucide-star size-4",c.value.includes(t.id)?"text-ink-gray-9":"text-ink-gray-4"]),"aria-hidden":"true"},null,2)]),_:2},1032,["label","aria-pressed","onClick"])]),_:2},1024)]),_:2},1024)),64))]),_:1})]))}}),zs={class:"w-full"},xs={class:"mb-2 flex h-7 items-center justify-end gap-3"},js={key:0,class:"text-sm text-ink-gray-5"},vs={class:"min-w-0"},gs={class:"mt-1 truncate text-base text-ink-gray-5"},ks={class:"flex flex-col items-end gap-1"},bs={class:"text-sm text-ink-gray-5"},Ls=q({__name:"Feed",setup(k){const u=[{name:"1",title:"Weekly sync notes",author:"Rosa Diaz",comment:"Sounds good, let us ship it on Monday",time:"2 h",comments:4,unread:!0},{name:"2",title:"Redesigning the onboarding flow",author:"Jake Peralta",comment:"I added the new mockups to the page",time:"5 h",comments:12,unread:!1},{name:"3",title:"Q3 hiring plan",author:"Amy Santiago",comment:"Two backend roles and one designer",time:"1 d",comments:7,unread:!0},{name:"4",title:"Incident review: search downtime",author:"Terry Jeffords",comment:"Root cause was the index rebuild",time:"2 d",comments:9,unread:!1},{name:"5",title:"Docs sprint retrospective",author:"Raymond Holt",comment:"Velocity was acceptable.",time:"4 d",comments:3,unread:!1}],d=j(!1),c=j([]);function _(){d.value=!d.value,c.value=[]}return(h,y)=>(f(),x("div",zs,[s("div",xs,[c.value.length?(f(),x("span",js,i(c.value.length)+" selected ",1)):U("",!0),n(p(V),{onClick:_},{default:l(()=>[a(i(d.value?"Done":"Select"),1)]),_:1})]),n(p(R),{selectable:d.value,selection:c.value,"onUpdate:selection":y[0]||(y[0]=t=>c.value=t),"row-height":60},{default:l(()=>[(f(),x(M,null,I(u,t=>n(p(S),{key:t.name,value:t.name,onClick:()=>{}},{default:l(()=>[n(p(w),null,{default:l(()=>[n(p(P),{label:t.author,size:"2xl"},null,8,["label"])]),_:2},1024),n(p(w),null,{default:l(()=>[s("div",vs,[s("div",{class:g(["truncate text-base text-ink-gray-8",t.unread&&"font-semibold"])},i(t.title),3),s("div",gs,i(t.author)+": "+i(t.comment),1)])]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("div",ks,[s("span",bs,i(t.time),1),n(p(Q),null,{default:l(()=>[a(i(t.comments),1)]),_:2},1024)])]),_:2},1024)]),_:2},1032,["value"])),64))]),_:1},8,["selectable","selection"])]))}}),Fs=JSON.parse('{"title":"List","description":"","frontmatter":{},"headers":[],"relativePath":"docs/molecules/list.md","filePath":"docs/molecules/list.md","lastUpdated":1782986620000}'),Cs={name:"docs/molecules/list.md"},Ms=Object.assign(Cs,{setup(k){const u=[{name:"columns",description:"Grid track sizes shared by the header and every row. Defaults to the feed\ntemplate `['auto', 'minmax(0,1fr)', 'auto']` (leading media, content,\ntrailing). Table-style lists must pass deterministic track sizes — `auto`\ntracks size independently per row, so independent row grids can't agree.\n\nPass an array for one template at every width, or an object keyed by\nbreakpoint for a template that changes with the viewport:\n`{ base: ['minmax(0,1fr)', '80px'], md: ['minmax(0,2fr)', '140px', '100px'] }`.\n`base` is required, each breakpoint replaces the whole template, and an\nomitted breakpoint keeps the one below it. Breakpoints are the consuming\napp's own Tailwind `screens`, resolved in CSS — so `md` here and `md:hidden`\non a cell switch at the same width. Changing the track count never hides a\ncell: pair it with matching visibility classes on the header and the rows.",required:!1,type:"ListColumns"},{name:"divider",description:"Divider treatment between rows: `inset` starts at the content column\n(the text edge), `full` spans all columns. Defaults to `inset` with the\ndefault feed template, `full` when `columns` is set.",required:!1,type:"ListDivider"},{name:"selectable",description:"Reveals the animated checkbox column and switches row click from\nnavigate to toggle. Selected values surface via `v-model:selection`.",required:!1,type:"boolean"},{name:"rowHeight",description:`Fixed row height in px. Required for virtualization; without it rows size
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:l(()=>[n(Ls)]),_:1}),e[11]||(e[11]=v("",2)),n(L,{name:"List-RowActions"},{code:l(()=>[...e[1]||(e[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ref"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_wac0bt"},"List"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:l(()=>[n(fs)]),_:1}),e[12]||(e[12]=v("",7)),n(L,{name:"List-Columns"},{code:l(()=>[...e[2]||(e[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_wac0bt"},"List"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:l(()=>[n(ds)]),_:1}),e[13]||(e[13]=v("",11)),n(L,{name:"List-Responsive"},{code:l(()=>[...e[3]||(e[3]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Avatar"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_4q1z3w"},"  List"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_4q1z3w"},"  ListRow"),s("span",{class:"s_1jjt6x"},",")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_wac0bt"},"ListRows"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_wac0bt"},"List"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:l(()=>[n(cs)]),_:1}),e[14]||(e[14]=v("",2)),n(J,null,{default:l(()=>[n(L,{name:"List-Virtual"},{code:l(()=>[...e[4]||(e[4]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
