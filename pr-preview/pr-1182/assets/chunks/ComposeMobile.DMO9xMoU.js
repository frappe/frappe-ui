import{aj as u,b8 as y,b2 as x,ad as T,p as I,be as r,D as a,aF as t,B as S,o as l,bf as $,bg as m,bi as f,b6 as R}from"./framework.DvMTvXpa.js";import{bC as B,au as C,_ as w,at as F}from"./theme.DmnjV7Jc.js";import{u as V,z,x as A,P as H,H as L,g as N,h as O,S as o,c as U,q,w as D,d as j,O as K,a as M,A as P,b as E,F as W,m as Y,p as G,n as J,B as Q,I as X,j as Z,o as ee,U as te,R as se,y as ae}from"./kits.DxTJ4BHn.js";import"./codemirror.C6qLgMOw.js";const oe={class:"sticky top-0 z-10 border-b bg-surface-base"},ne={class:"overflow-x-auto px-2 py-1"},re={class:"px-4 pb-40 pt-4"},ie=["onKeydown"],ue={__name:"ComposeMobile",setup(le){const b=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[V.configure({mention:{items:b}})],v=[H,L,N,O,o,U,q,D,o,j,K,o,M,P,E,W,o,Y,G,J,Q,X,Z,o,ee,o,te,se],p={light:"/pr-preview/pr-1182/recipes/compose-dashboard-light.png",dark:"/pr-preview/pr-1182/recipes/compose-dashboard-dark.png"},h=B(),d=u("Design review: new onboarding flow"),i=u(`
...
`);y(h,(n,e)=>{i.value=i.value.replace(p[e],p[n])});const _=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:k}=x({input:d});return(n,e)=>(T(),I(t(F),null,{default:r(()=>[a(t(z),{modelValue:i.value,"onUpdate:modelValue":e[1]||(e[1]=s=>i.value=s),extensions:g,"upload-function":_,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:s})=>[a(t(C),{title:"New discussion"},{prefix:r(()=>[a(t(w),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),suffix:r(()=>[a(t(w),{variant:"solid"},{default:r(()=>[...e[2]||(e[2]=[S("Publish",-1)])]),_:1})]),_:1}),l("div",oe,[l("div",ne,[a(t(A),{editor:s,items:v},null,8,["editor"])])]),l("div",re,[$(l("textarea",{ref_key:"titleTextarea",ref:k,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":e[0]||(e[0]=c=>d.value=c),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[m(f(c=>s.commands.focus(),["prevent"]),["enter"]),m(f(c=>s.commands.focus(),["prevent"]),["down"])]},null,40,ie),[[R,d.value]]),a(t(ae),{editor:s,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{ue as default};
