import{_ as k}from"./chunks/PropsTable.PWMr7FQu.js";import{_ as b}from"./chunks/SlotsTable.D8CiamXk.js";import{_ as g}from"./chunks/EmitsTable.DxQofdjR.js";import"./chunks/theme.B3rn8Zqw.js";import{_ as v}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.BoWF88uR.js";import{I as w,ad as u,r as m,D as l,aE as h,ao as y,A as z,be as c,o as s,B as a}from"./chunks/framework.CTAtDLoX.js";import"./chunks/useChart.Ck3agUCK.js";import"./chunks/tokens.BwADCglI.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/usePlotKeyboard.3H6wVMEG.js";import"./chunks/axisChartCommon.DTPFhfuu.js";import"./chunks/format.d9nxIfxn.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.CUVmRzYM.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.D0sefXn6.js";import"./chunks/installLabelLayout.Lfk_7c2i.js";import"./chunks/axisAlignTicks.DYZ7SL2t.js";import"./chunks/labelLayoutHelper.Cm56AfE4.js";import"./chunks/dataStackHelper.DCwM9zCT.js";import"./chunks/labelGuideHelper.CrOndS7p.js";import"./chunks/createSeriesData.v4u7KtYZ.js";import"./chunks/VisualMapping.DKDYjDpB.js";const x={class:"h-72 w-full"},j=w({__name:"HeatmapDemand",setup(f){const i=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],r=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],o=[8,52,38,34,20,15,20,9],n=r.flatMap((e,p)=>e.map((t,d)=>({day:_[p],hour:i[d],deviation:Math.round((t-o[d])/o[d]*100)})));return(e,p)=>(u(),m("div",x,[l(h(v),{data:h(n),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:t=>`${t>0?"+":""}${t}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),C={class:"h-72 w-full"},S=w({__name:"HeatmapTickets",setup(f){const i=["9am","11am","1pm","3pm","5pm","7pm"],_=["Mon","Tue","Wed","Thu","Fri"],r=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],o=_.flatMap((n,e)=>i.map((p,t)=>({day:n,hour:p,tickets:r[e][t]})));return(n,e)=>(u(),m("div",C,[l(h(v),{data:h(o),x:"hour",y:"day",value:"tickets","show-values":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),X=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmapchart.md","filePath":"docs/charts/heatmapchart.md","lastUpdated":0}'),O={name:"docs/charts/heatmapchart.md"},J=Object.assign(O,{setup(f){const i=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
chart that fails to draw sets its own; this is for a failed request.`,required:!1,type:"string | null"},{name:"data",description:"One row per cell.",required:!0,type:"Record<string, any>[]"},{name:"x",description:"Row key holding the column a cell sits in.",required:!0,type:"string"},{name:"y",description:"Row key holding the row a cell sits in.",required:!0,type:"string"},{name:"value",description:"Row key holding the magnitude the cell is colored by.",required:!0,type:"string"},{name:"min",description:"Bottom of the color scale. Defaults to the smallest value in the data.",required:!1,type:"number"},{name:"max",description:"Top of the color scale. Defaults to the largest value in the data.",required:!1,type:"number"},{name:"showValues",description:`Prints each cell's value inside it. A label that would collide with its
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:c(()=>[l(S)]),_:1})]),_:1}),n[4]||(n[4]=s("h2",{id:"signed-data",tabindex:"-1"},[a("Signed data "),s("a",{class:"header-anchor",href:"#signed-data","aria-label":"Permalink to “Signed data”"},"​")],-1)),n[5]||(n[5]=s("p",null,[a("Signed data reads on the "),s("code",null,"diverging"),a(" ramp, centered on zero. "),s("code",null,"min"),a(" and "),s("code",null,"max"),a(" pin the scale so the colors mean the same thing across reloads.")],-1)),l(p,null,{default:c(()=>[l(e,{name:"Charts-HeatmapDemand","self-layout":""},{code:c(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"HeatmapChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:_}),l(g,{data:r})])}}});export{X as __pageData,J as default};
