import{ak as u,ba as y,b4 as x,ae as T,p as I,bg as r,E as a,aH as t,D as S,o as l,bh as $,bi as m,bk as f,b8 as R}from"./framework.OsT58xVm.js";import{bB as B,au as H,_ as w,at as V}from"./theme.tSv350Ff.js";import{u as z,z as A,x as C,P as F,H as L,g as N,h as O,S as o,c as U,q,w as D,d as K,O as M,a as P,A as j,b as E,F as W,m as Y,p as G,n as J,B as Q,I as X,j as Z,o as ee,U as te,R as se,y as ae}from"./kits.CzWUvnua.js";import"./codemirror.C6qLgMOw.js";const oe={class:"sticky top-0 z-10 border-b bg-surface-base"},ne={class:"overflow-x-auto px-2 py-1"},re={class:"px-4 pb-40 pt-4"},ie=["onKeydown"],ue={__name:"ComposeMobile",setup(le){const b=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[z.configure({mention:{items:b}})],v=[F,L,N,O,o,U,q,D,o,K,M,o,P,j,E,W,o,Y,G,J,Q,X,Z,o,ee,o,te,se],p={light:"/pr-preview/pr-1196/recipes/compose-dashboard-light.png",dark:"/pr-preview/pr-1196/recipes/compose-dashboard-dark.png"},h=B(),d=u("Design review: new onboarding flow"),i=u(`
...
`);y(h,(n,e)=>{i.value=i.value.replace(p[e],p[n])});const k=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:_}=x({input:d});return(n,e)=>(T(),I(t(V),null,{default:r(()=>[a(t(A),{modelValue:i.value,"onUpdate:modelValue":e[1]||(e[1]=s=>i.value=s),extensions:g,"upload-function":k,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:s})=>[a(t(H),{title:"New discussion"},{prefix:r(()=>[a(t(w),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),suffix:r(()=>[a(t(w),{variant:"solid"},{default:r(()=>[...e[2]||(e[2]=[S("Publish",-1)])]),_:1})]),_:1}),l("div",oe,[l("div",ne,[a(t(C),{editor:s,items:v},null,8,["editor"])])]),l("div",re,[$(l("textarea",{ref_key:"titleTextarea",ref:_,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":e[0]||(e[0]=c=>d.value=c),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[m(f(c=>s.commands.focus(),["prevent"]),["enter"]),m(f(c=>s.commands.focus(),["prevent"]),["down"])]},null,40,ie),[[R,d.value]]),a(t(ae),{editor:s,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{ue as default};
