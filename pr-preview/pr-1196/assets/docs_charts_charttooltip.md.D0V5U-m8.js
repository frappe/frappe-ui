import{_ as g}from"./chunks/PropsTable.dh_8WeWB.js";import{_ as b}from"./chunks/SlotsTable.D_15tnSk.js";import"./chunks/theme.tSv350Ff.js";import{_ as x}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.GP6xhhwQ.js";import{_ as z}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CpnMEs_F.js";import{p as j,u as C}from"./chunks/tokens.DyGWur8M.js";import{_ as S}from"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.Dsu8g_Xb.js";import{J as T,ae as u,p as O,bg as t,E as p,aH as o,o as s,r as m,F as A,an as R,ax as P,a3 as E,ak as D,l as L,ah as q,ap as y,B as f,D as a}from"./chunks/framework.OsT58xVm.js";import"./chunks/format.DcxuY9_S.js";const B=["onMousemove"],I={class:"w-32 shrink-0 truncate text-p-xs text-ink-gray-5"},V=T({__name:"TooltipCustom",setup(w){const _=[{region:"India",signups:4820,trials:1240},{region:"Europe",signups:3610,trials:980},{region:"North America",signups:2970,trials:810},{region:"Southeast Asia",signups:1840,trials:470}],h=Math.max(..._.map(l=>l.signups)),d=D(),{tokens:e}=C(d),c=L(()=>j("categorical",e.value,2)),n=q({open:!1,x:0,y:0,label:"",items:[],rows:[]});function k(l,i){n.label=l.region,n.items=[{name:"signups",label:"Signups",color:c.value[0],value:l.signups,formattedValue:l.signups.toLocaleString(),kind:"series"},{name:"trials",label:"Trials started",color:c.value[1],value:l.trials,formattedValue:l.trials.toLocaleString(),percent:l.trials/l.signups*100,kind:"series"}],n.rows=[l],n.x=i.clientX,n.y=i.clientY,n.open=!0}return(l,i)=>(u(),O(o(S),{class:"h-72"},{default:t(()=>[p(o(x),{title:"Signups by region",subtitle:"Hover a bar — the tooltip is a component, not a canvas overlay"},{default:t(()=>[s("div",{ref_key:"plotEl",ref:d,class:"flex h-full w-full flex-col justify-center gap-2",onMouseleave:i[0]||(i[0]=r=>n.open=!1)},[(u(),m(A,null,R(_,r=>s("div",{key:r.region,class:"flex items-center gap-2",onMousemove:v=>k(r,v)},[s("span",I,P(r.region),1),s("span",{class:"h-5 rounded-2",style:E({width:`${r.signups/o(h)*100}%`,backgroundColor:c.value[0]})},null,4)],40,B)),64))],544),p(o(z),{open:n.open,x:n.x,y:n.y,label:n.label,items:n.items,rows:n.rows},null,8,["open","x","y","label","items","rows"])]),_:1})]),_:1}))}}),K=JSON.parse('{"title":"ChartTooltip","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/charttooltip.md","filePath":"docs/charts/charttooltip.md","lastUpdated":0}'),F={name:"docs/charts/charttooltip.md"},J=Object.assign(F,{setup(w){const _=[{name:"open",description:`Draws the tooltip. It is measured before it is placed, so it flips at the
