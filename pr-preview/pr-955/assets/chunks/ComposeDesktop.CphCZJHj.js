import{b2 as x,ad as k,r as v,D as e,bg as n,aE as t,o as i,B as y,bh as T,bi as c,bk as h,b8 as I,aj as m}from"./framework.DiMNwD3e.js";import{aO as S,ay as $,au as u,bN as N,aN as R}from"./theme.CDnaCnzD.js";import{r as B,w as D,u as F,P as O,H as V,f as A,g as H,S as o,c as L,p as z,t as C,d as U,O as q,a as K,A as P,b as j,F as E,l as M,o as W,m as Y,B as G,I as J,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.CbowYJX4.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[B.configure({mention:{items:f}})],b=[O,V,A,H,o,L,z,C,o,U,q,o,K,P,j,E,o,M,W,Y,G,J,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
