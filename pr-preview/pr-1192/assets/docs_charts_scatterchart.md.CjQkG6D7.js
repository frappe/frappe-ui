import{_ as xs}from"./chunks/PropsTable.CaCV4ivm.js";import{_ as js}from"./chunks/SlotsTable.DalUT-lF.js";import{_ as zs}from"./chunks/EmitsTable.mu7vqRGr.js";import{_ as Cs}from"./chunks/ExposedTable.DD_1GKda.js";import"./chunks/theme.Cn0SL0b1.js";import{_ as $,dy as Ss,z as As,G as Ts,a as Ps,P as Os,aq as Ds,b8 as Rs,b9 as Ls,b as Es,dN as Is,cX as Bs,dO as Ns}from"./chunks/useChart.B9mW07EI.js";import{u as Ms}from"./chunks/usePlotKeyboard.DXlMQe4y.js";import{t as M,c as Fs,D as Vs,B as J,A as qs,e as $s,u as Hs}from"./chunks/axisChartCommon.ClnENQIv.js";import{a as R,d as Ws}from"./chunks/format.B4q9Lzqm.js";import{p as Gs,j as os,C as Us,c as Ys,d as Ks,u as Zs,k as Xs}from"./chunks/tokens.Bn3CdON2.js";import{p as _s,a as Js,d as Qs,b as sa,j as aa}from"./chunks/referenceLines.CzOLVxGC.js";import{t as na,p as ea}from"./chunks/hiddenSeries.BGnbo1Bl.js";import{_ as la}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.DUFOnIGJ.js";import{_ as ta}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.DXNa8e6R.js";import{_ as pa}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.Be1JY7oX.js";import{c as ca}from"./chunks/createSeriesData.BjE6bBwW.js";import{a as ia,i as ra,c as oa}from"./chunks/installLabelLayout.CYV4hFxN.js";import{J as L,aV as _a,b9 as Q,l as x,ae as P,p as ha,A as ss,bf as b,ao as C,a2 as as,M as ns,E as g,o as s,$ as da,aG as T,aw as ua,Z as es,ak as F,ah as ls,r as E,ap as ts,B as V,D as a}from"./chunks/framework.oJ-53vW4.js";import"./chunks/dataStackHelper.Cc0-pMv2.js";import"./chunks/axisAlignTicks.DEh6rMrR.js";import"./chunks/labelLayoutHelper.BWqBNBYJ.js";import"./chunks/labelGuideHelper.KMGdLCR9.js";var ya=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n.hasSymbolVisual=!0,n}return e.prototype.getInitialData=function(n,l){return ca(null,this,{useEncodeDefaulter:!0})},e.prototype.getProgressive=function(){var n=this.option.progressive;return n??(this.option.large?5e3:this.get("progressive"))},e.prototype.getProgressiveThreshold=function(){var n=this.option.progressiveThreshold;return n??(this.option.large?1e4:this.get("progressiveThreshold"))},e.prototype.brushSelector=function(n,l,p){return p.point(l.getItemLayout(n))},e.prototype.getZLevelKey=function(){return this.getData().count()>this.getProgressiveThreshold()?this.id:""},e.type="series.scatter",e.dependencies=["grid","polar","geo","singleAxis","calendar","matrix"],e.defaultOption={coordinateSystem:"cartesian2d",z:2,legendHoverLink:!0,symbolSize:10,large:!1,largeThreshold:2e3,itemStyle:{opacity:.8},emphasis:{scale:!0},clip:!0,select:{itemStyle:{borderColor:Ss.color.primary}},universalTransition:{divideShape:"clone"}},e})(As),hs=4,fa=(function(){function t(){}return t})(),ma=(function(t){$(e,t);function e(n){var l=t.call(this,n)||this;return l._off=0,l.hoverDataIdx=-1,l}return e.prototype.getDefaultShape=function(){return new fa},e.prototype.reset=function(){this.notClear=!1,this._off=0},e.prototype.beforeBrush=function(n){n&&!n.contentRetained&&this.reset()},e.prototype.buildPath=function(n,l){var p=l.points,r=l.size,i=this.symbolProxy,h=i.shape,_=n.getContext?n.getContext():n,d=_&&r[0]<hs,u=this.softClipShape,y;if(d){this._ctx=_;return}for(this._ctx=null,y=this._off;y<p.length;){var v=p[y++],k=p[y++];isNaN(v)||isNaN(k)||u&&!u.contain(v,k)||(h.x=v-r[0]/2,h.y=k-r[1]/2,h.width=r[0],h.height=r[1],i.buildPath(n,h,!0))}this.incremental&&(this._off=y,this.notClear=!0)},e.prototype.afterBrush=function(){var n=this.shape,l=n.points,p=n.size,r=this._ctx,i=this.softClipShape,h;if(r){for(h=this._off;h<l.length;){var _=l[h++],d=l[h++];isNaN(_)||isNaN(d)||i&&!i.contain(_,d)||r.fillRect(_-p[0]/2,d-p[1]/2,p[0],p[1])}this.incremental&&(this._off=h,this.notClear=!0)}},e.prototype.findDataIndex=function(n,l){for(var p=this.shape,r=p.points,i=p.size,h=Math.max(i[0],4),_=Math.max(i[1],4),d=r.length/2-1;d>=0;d--){var u=d*2,y=r[u]-h/2,v=r[u+1]-_/2;if(n>=y&&l>=v&&n<=y+h&&l<=v+_)return d}return-1},e.prototype.contain=function(n,l){var p=this.transformCoordToLocal(n,l),r=this.getBoundingRect();if(n=p[0],l=p[1],r.contain(n,l)){var i=this.hoverDataIdx=this.findDataIndex(n,l);return i>=0}return this.hoverDataIdx=-1,!1},e.prototype.getBoundingRect=function(){var n=this._rect;if(!n){for(var l=this.shape,p=l.points,r=l.size,i=r[0],h=r[1],_=1/0,d=1/0,u=-1/0,y=-1/0,v=0;v<p.length;){var k=p[v++],O=p[v++];_=Math.min(k,_),u=Math.max(k,u),d=Math.min(O,d),y=Math.max(O,y)}n=this._rect=new Ps(_-i/2,d-h/2,u-_+i,y-d+h)}return n},e})(Os),wa=(function(){function t(){this.group=new Ts}return t.prototype.updateData=function(e,n){this._clear(),this._data=e;var l=this._create();l.setShape({points:e.getLayout("points")}),this._setCommon(l,e,n)},t.prototype.updateLayout=function(e){var n=this._data;if(n){var l=n.getLayout("points");this.group.eachChild(function(p){if(p.startIndex!=null){var r=(p.endIndex-p.startIndex)*2,i=p.startIndex*4*2;l=new Float32Array(l.buffer,i,r)}p.setShape("points",l),p.reset(),p.stopAnimation()})}},t.prototype.incrementalPrepareUpdate=function(e){this._clear()},t.prototype.incrementalUpdate=function(e,n,l,p){var r=this._newAdded[0],i=n.getLayout("points"),h=r&&r.shape.points;if(h&&h.length<2e4){var _=h.length,d=new Float32Array(_+i.length);d.set(h),d.set(i,_),r.endIndex=e.end,r.setShape({points:d})}else{this._newAdded=[];var u=this._create();u.startIndex=e.start,u.endIndex=e.end,u.incremental=l,u.setShape({points:i}),this._setCommon(u,n,p)}},t.prototype.eachRendered=function(e){this._newAdded[0]&&e(this._newAdded[0])},t.prototype._create=function(){var e=new ma({cursor:"default"});return e.ignoreCoarsePointer=!0,this.group.add(e),this._newAdded.push(e),e},t.prototype._setCommon=function(e,n,l){var p=n.hostModel;l=l||{};var r=n.getVisual("symbolSize");e.setShape("size",r instanceof Array?r:[r,r]),e.softClipShape=l.clipShape||null,e.symbolProxy=Ds(n.getVisual("symbol"),0,0,0,0),e.setColor=e.symbolProxy.setColor;var i=e.shape.size[0]<hs;e.useStyle(p.getModel("itemStyle").getItemStyle(i?["color","shadowBlur","shadowColor"]:["color"]));var h=n.getVisual("style"),_=h&&h.fill;_&&e.setColor(_);var d=Rs(e);d.seriesIndex=p.seriesIndex,e.on("mousemove",function(u){d.dataIndex=null;var y=e.hoverDataIdx;y>=0&&(d.dataIndex=y+(e.startIndex||0))})},t.prototype.remove=function(){this._clear()},t.prototype._clear=function(){this._newAdded=[],this.group.removeAll()},t})(),va=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n}return e.prototype.render=function(n,l,p){var r=n.getData(),i=this._updateSymbolDraw(r,n);i.updateData(r,q(n)),this._finished=!0},e.prototype.incrementalPrepareRender=function(n,l,p){var r=n.getData(),i=this._updateSymbolDraw(r,n);i.incrementalPrepareUpdate(r),this._finished=!1},e.prototype.incrementalRender=function(n,l,p){this._symbolDraw.incrementalUpdate(n,l.getData(),Ls(l),q(l)),this._finished=n.end===l.getData().count()},e.prototype.updateTransform=function(n,l,p){var r=n.getData();if(this.group.dirty(),this._finished){var i=_s("").reset(n,l,p);i.progress&&i.progress({start:0,end:r.count(),count:r.count()},r),this._symbolDraw.updateLayout(q(n))}else return{update:!0}},e.prototype.eachRendered=function(n){this._symbolDraw&&this._symbolDraw.eachRendered(n)},e.prototype._updateSymbolDraw=function(n,l){var p=this._symbolDraw,r=l.pipelineContext,i=r.large;return(!p||i!==this._isLargeDraw)&&(p&&p.remove(),p=this._symbolDraw=i?new wa:new Js,this._isLargeDraw=i,this.group.removeAll()),this.group.add(p.group),p},e.prototype.remove=function(n,l){this._symbolDraw&&this._symbolDraw.remove(!0),this._symbolDraw=null},e.prototype.dispose=function(){},e.type="scatter",e})(Es);function q(t){return{clipShape:Qs(t)}}function ga(t){Is(ia),t.registerSeriesModel(ya),t.registerChartView(va),t.registerLayout(_s("scatter"))}const ba="categorical",A=10,ps=35,cs=.75,is="6%";function ds(t,{tokens:e}){const n=t.data??[],l=[],p=new Map,r=[];for(const _ of n){const d=M(_[t.xColumn]),u=M(_[t.yColumn]);if(d===null||u===null)continue;const y=xa(t,_);let v=p.get(y);v||(v=[],l.push(y),p.set(y,v));const k=t.sizeColumn?M(_[t.sizeColumn]):null;k!==null&&r.push(k),v.push({x:d,y:u,size:k,label:ja(t,_),row:_})}const i=za(r,!!t.sizeColumn),h=Gs(t.palette,e,l.length,ba);return l.map((_,d)=>({name:_,label:R(_),color:h[d],points:p.get(_).map(u=>({...u,symbolSize:i(u.size)}))}))}const ka="(Blank)";function xa(t,e){if(!t.splitByColumn)return t.yColumn;const n=e[t.splitByColumn];return n==null||n===""?ka:String(n)}function ja(t,e){if(!t.labelColumn)return;const n=e[t.labelColumn];return n==null?void 0:String(n)}function za(t,e){if(!e)return()=>A;const n=Ca(t);return l=>l===null?A:n(l)}function Ca(t){let e=1/0,n=-1/0;for(const p of t)p<e&&(e=p),p>n&&(n=p);if(e===n){const p=(A+ps)/2;return()=>p}const l=ps-A;return p=>A+(p-e)/(n-e)*l}function Sa(t,e){const{tokens:n,hiddenSeries:l=[],format:p}=e,r=t.dir==="rtl",h=ds(t,e).filter(u=>!l.includes(u.name)),_=Ta(t),d={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:Us},grid:Fs({horizontal:!1,isRTL:r,labelGutter:0}),xAxis:rs(t.xAxis,n,{horizontal:!0,isRTL:r,format:p?.x,name:t.xAxis?.title}),yAxis:rs(t.yAxis,n,{horizontal:!1,isRTL:r,format:p?.y}),series:[...h.map(u=>Pa(u,{tokens:n,isRTL:r,showLabels:_})),...sa(Aa(t),{tokens:n,horizontal:!1,hasSecondaryValueAxis:!1,hasCategoryAxis:!1,hostSeriesType:"scatter"})]};return os(d,t.echartOptions)}function Aa(t){const e=t.referenceLines;return e?.filter(n=>n.axis==="y2").length,e}function Ta(t){return t.showDataLabels?!!t.labelColumn:!1}function Pa(t,e){const{tokens:n,isRTL:l,showLabels:p}=e;return{type:"scatter",name:t.name,data:t.points.map(r=>({value:[r.x,r.y],symbolSize:r.symbolSize,...p?{name:r.label??""}:{}})),symbol:"circle",itemStyle:{color:t.color,opacity:cs,borderWidth:0},emphasis:{focus:"series",blurScope:"coordinateSystem"},blur:{itemStyle:{opacity:cs*J},label:{opacity:J}},...p?{label:{show:!0,position:l?"left":"right",color:n.dataLabel,fontSize:Vs,formatter:r=>String(r?.name??"")},labelLayout:{hideOverlap:!0}}:{}}}function rs(t,e,n){const{horizontal:l,isRTL:p,format:r,name:i}=n,h=os({scale:!0,boundaryGap:[is,is],...i?{name:R(i),nameLocation:"end",nameGap:8,nameTextStyle:{color:e.axisTitle,fontSize:qs}}:{},...r?{axisLabel:{formatter:_=>r(Number(_))}}:{}},t?.echartOptions);return $s({...t,echartOptions:h},e,{horizontal:l,isRTL:p})}const Oa=["aria-label"],Da={class:"sr-only",role:"status"},H=L({__name:"ScatterChart",props:es({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},x:{},y:{},size:{},splitBy:{},hiddenSeries:{},label:{},showDataLabels:{type:Boolean},xAxis:{},yAxis:{},palette:{},referenceLines:{},format:{type:Function},echartOptions:{}},{hiddenSeries:{default:()=>[]},hiddenSeriesModifiers:{}}),emits:es(["update:hiddenSeries","select"],["update:hiddenSeries"]),setup(t,{expose:e,emit:n}){Bs([ga,ra,aa,oa]);const l=t,p=_a(t,"hiddenSeries"),r=n,i=F(),h=x(()=>l.dir??Ks()),_=x(()=>l.xAxis?.format??l.format),d=x(()=>l.yAxis?.format??l.format),u=x(()=>({data:l.data,xColumn:l.x,yColumn:l.y,sizeColumn:l.size,splitByColumn:l.splitBy,labelColumn:l.label,showDataLabels:l.showDataLabels,xAxis:y(l.xAxis),yAxis:y(l.yAxis),referenceLines:l.referenceLines,palette:l.palette,dir:h.value,echartOptions:l.echartOptions}));function y(c){if(c)return{title:c.title,min:c.min,max:c.max,echartOptions:c.echartOptions}}const{tokens:v}=Zs(i),k=x(()=>ds(u.value,{tokens:v.value})),O=x(()=>k.value.every(c=>!c.points.length)),us=x(()=>l.yAxis?.title?R(l.yAxis.title):void 0),W=x(()=>{try{return{option:Sa(u.value,{tokens:v.value,hiddenSeries:p.value,format:{x:_.value,y:d.value}}),error:null}}catch(c){return{option:void 0,error:c?.message??String(c)}}}),ys=x(()=>W.value.error),z=ls({x:0,y:0}),f=ls({open:!1,x:0,y:0,label:void 0,items:[],rows:[]}),{chart:G,dispatch:D}=Ns({container:i,option:()=>W.value.option,events:{mouseover:c=>fs(c),mouseout:()=>f.open=!1,click:c=>{const o=U(c);o&&r("select",{name:o.series.name,x:o.point.x,y:o.point.y,size:o.point.size,label:o.point.label,row:o.point.row})}},onZrEvents:{mousemove:c=>{z.x=c.event?.clientX??z.x,z.y=c.event?.clientY??z.y,f.open&&(f.x=z.x,f.y=z.y)},globalout:()=>f.open=!1}});function U(c){const o=k.value.find(m=>m.name===c?.seriesName),w=o?.points[c?.dataIndex];return o&&w?{series:o,point:w}:void 0}function fs(c){const o=U(c);if(!o){f.open=!1;return}Y(o,z.x,z.y)}function Y(c,o,w){const{series:m,point:j}=c,ks=[j.label,l.splitBy?m.label:void 0].filter(Boolean).join(" · ");f.label=ks||void 0,f.items=[I(l.x,j.x,_.value,m.color),I(l.y,j.y,d.value,m.color),...l.size&&j.size!==null?[I(l.size,j.size,l.format,m.color)]:[]],f.rows=[j.row],f.x=o,f.y=w,f.open=!0}function I(c,o,w,m){return{name:c,label:R(c),color:m,value:o,formattedValue:w?w(o):Ws(o),kind:"series"}}const K=x(()=>k.value.map(c=>({name:c.name,label:c.label,color:c.color,hidden:p.value.includes(c.name)})));function ms(c){p.value=na(p.value,c,k.value.length)}const Z=F(null);function ws(c){Z.value=c}Q(Z,(c,o)=>{o&&D({type:"downplay",seriesName:o}),c&&!p.value.includes(c)&&D({type:"highlight",seriesName:c})});const B=F(""),S=x(()=>k.value.filter(c=>!p.value.includes(c.name)).flatMap((c,o)=>c.points.map((w,m)=>({entry:c,point:w,seriesIndex:o,dataIndex:m}))));function vs(c,o){const w=i.value;if(!w)return;const m=w.getBoundingClientRect(),j=G.value?.convertToPixel({gridIndex:0},[c,o]);return!j||j.some(N=>typeof N!="number"||isNaN(N))?{x:m.left+m.width/2,y:m.top+m.height/2}:{x:m.left+j[0],y:m.top+j[1]}}function gs(c){const o=S.value[c];if(!o)return;const w=vs(o.point.x,o.point.y);D({type:"highlight",seriesIndex:o.seriesIndex,dataIndex:o.dataIndex}),Y({series:o.entry,point:o.point},w?.x??z.x,w?.y??z.y),B.value=Xs(f.label,f.items.map(m=>({label:m.label,value:m.formattedValue})))}function X(c){const o=c===null?void 0:S.value[c];o&&D({type:"downplay",seriesIndex:o.seriesIndex,dataIndex:o.dataIndex})}Hs({plot:i,data:()=>S.value,close:()=>{f.open=!1}});const bs=Ms({marks:()=>S.value,key:c=>`${c.entry.name} ${c.point.x} ${c.point.y}`,move:(c,o)=>{X(o),gs(c)},activate:c=>{const o=S.value[c];o&&r("select",{name:o.entry.name,x:o.point.x,y:o.point.y,size:o.point.size,label:o.point.label,row:o.point.row})},clear:c=>{X(c),f.open=!1,B.value=""}}).attrs;return Q(()=>k.value.map(c=>c.name),c=>{p.value=ea(p.value,c)}),e({chart:x(()=>G.value)}),(c,o)=>(P(),ha(la,{title:t.title,subtitle:t.subtitle,"y-axis-title":us.value,loading:t.loading,error:t.error||ys.value,empty:O.value,dir:h.value},ss({default:b(()=>[s("div",da({ref_key:"plotEl",ref:i,class:"h-full w-full rounded-2 focus-visible:focus-ring",dir:"ltr",role:"img","aria-label":T(Ys)(t.title,t.subtitle)},T(bs)),null,16,Oa),s("span",Da,ua(B.value),1),g(pa,{open:f.open,x:f.x,y:f.y,label:f.label,items:f.items,rows:f.rows,dir:h.value},ss({_:2},[c.$slots.tooltip?{name:"default",fn:b(w=>[C(c.$slots,"tooltip",as(ns(w)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","rows","dir"])]),_:2},[c.$slots.actions?{name:"actions",fn:b(()=>[C(c.$slots,"actions")]),key:"0"}:void 0,c.$slots["title-suffix"]?{name:"title-suffix",fn:b(()=>[C(c.$slots,"title-suffix")]),key:"1"}:void 0,c.$slots.loading?{name:"loading",fn:b(()=>[C(c.$slots,"loading")]),key:"2"}:void 0,c.$slots.error?{name:"error",fn:b(w=>[C(c.$slots,"error",as(ns(w)))]),key:"3"}:void 0,c.$slots.empty?{name:"empty",fn:b(()=>[C(c.$slots,"empty")]),key:"4"}:void 0,K.value.length>1?{name:"legend",fn:b(()=>[g(ta,{items:K.value,onChange:ms,onHighlight:ws},null,8,["items"])]),key:"5"}:void 0]),1032,["title","subtitle","y-axis-title","loading","error","empty","dir"]))}}),Ra={class:"h-80 w-full"},La=L({__name:"ScatterQuadrants",setup(t){const e=[{product:"Payroll",growth:34,margin:62},{product:"Invoicing",growth:12,margin:71},{product:"CRM",growth:41,margin:48},{product:"Helpdesk",growth:27,margin:55},{product:"Inventory",growth:8,margin:44},{product:"Insights",growth:52,margin:39},{product:"Field service",growth:6,margin:58},{product:"Point of sale",growth:19,margin:33}],n=l=>`${l}%`;return(l,p)=>(P(),E("div",Ra,[g(T(H),{data:e,x:"growth",y:"margin",label:"product","show-data-labels":"","x-axis":{title:"Growth",format:n},"y-axis":{title:"Margin",format:n},"reference-lines":[{value:25,axis:"x",label:"Median growth",dashed:!0},{value:50,axis:"y",label:"Median margin",dashed:!0}],title:"Growth against margin",subtitle:"Median lines divide the plot into four"},null,8,["x-axis","y-axis"])]))}}),Ea={class:"h-96 w-full"},Ia=L({__name:"ScatterMarkets",setup(t){const e=[{market:"Germany",arpu:61,retention:88,seats:14200,region:"EMEA"},{market:"France",arpu:54,retention:82,seats:9100,region:"EMEA"},{market:"UAE",arpu:72,retention:79,seats:2600,region:"EMEA"},{market:"Nigeria",arpu:21,retention:74,seats:4800,region:"EMEA"},{market:"India",arpu:18,retention:91,seats:38400,region:"APAC"},{market:"Japan",arpu:68,retention:94,seats:7300,region:"APAC"},{market:"Australia",arpu:59,retention:85,seats:5200,region:"APAC"},{market:"Singapore",arpu:77,retention:81,seats:1900,region:"APAC"},{market:"United States",arpu:74,retention:87,seats:41500,region:"Americas"},{market:"Canada",arpu:63,retention:89,seats:8600,region:"Americas"},{market:"Brazil",arpu:26,retention:71,seats:12800,region:"Americas"},{market:"Mexico",arpu:31,retention:76,seats:6400,region:"Americas"}];return(n,l)=>(P(),E("div",Ea,[g(T(H),{data:e,x:"arpu",y:"retention",size:"seats","split-by":"region",label:"market","x-axis":{title:"ARPU",format:p=>`$${p}`},"y-axis":{title:"Retention",format:p=>`${p}%`},title:"Revenue per seat against retention",subtitle:"Bubble size is the number of seats"},null,8,["x-axis","y-axis"])]))}}),Ba={class:"h-80 w-full"},Na=L({__name:"ScatterSpend",setup(t){const e=[{account:"Acme",spend:4200,revenue:12400},{account:"Globex",spend:9100,revenue:24200},{account:"Initech",spend:2200,revenue:3100},{account:"Umbrella",spend:7400,revenue:9600},{account:"Soylent",spend:5600,revenue:18800},{account:"Hooli",spend:12800,revenue:21400},{account:"Vehement",spend:1800,revenue:6200},{account:"Massive Dynamic",spend:10400,revenue:34600},{account:"Stark",spend:6800,revenue:7400},{account:"Wayne",spend:3100,revenue:11200}],n=l=>`$${new Intl.NumberFormat("en-US").format(l)}`;return(l,p)=>(P(),E("div",Ba,[g(T(H),{data:e,x:"spend",y:"revenue",label:"account","x-axis":{title:"Acquisition spend"},"y-axis":{title:"Revenue"},format:n,title:"Spend against revenue",subtitle:"Ten largest accounts, last quarter"})]))}}),on=JSON.parse('{"title":"ScatterChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/scatterchart.md","filePath":"docs/charts/scatterchart.md","lastUpdated":0}'),Ma={name:"docs/charts/scatterchart.md"},_n=Object.assign(Ma,{setup(t){const e=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),g(js,{data:n}),g(zs,{data:l}),g(Cs,{data:p})])}}});export{on as __pageData,_n as default};
