import{a2 as x,o as v,u as e,aK as n,ap as t,l as i,t as k,aL as y,aM as c,aO as h,aD as T,a7 as m}from"./framework.B7RHFLUW.js";import{cC as I,aJ as S,av as $,ar as u,bJ as R,aI as D}from"./theme.0thspEuu.js";import{r as F,w as L,u as O,P as V,H as A,f as B,g as C,S as o,c as H,p as N,t as z,d as U,O as q,a as K,A as M,b as P,F as j,l as E,o as J,m as W,B as Y,I as G,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.D4Yl9CUa.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[F.configure({mention:{items:f}})],b=[V,A,B,C,o,H,N,z,o,U,q,o,K,M,P,j,o,E,J,W,Y,G,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
