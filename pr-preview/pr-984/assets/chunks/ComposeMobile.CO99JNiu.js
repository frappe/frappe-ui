import{b4 as v,af as _,p as y,bi as n,D as o,aG as e,B as x,o as i,bj as T,bk as c,bm as h,ba as I,al as u}from"./framework.BW43aPUQ.js";import{bc as S,au as m,bb as B}from"./theme.CHqTr57c.js";import{r as R,w as F,u as V,P as $,H as z,f as A,g as H,S as a,c as L,p as N,t as O,d as C,O as U,a as q,A as D,b as K,F as M,l as P,o as j,m as W,B as E,I as G,i as Y,n as J,U as Q,R as X,v as Z}from"./kits.EydhvY2Z.js";const ee={class:"sticky top-0 z-10 border-b bg-surface-base"},te={class:"overflow-x-auto px-2 py-1"},se={class:"px-4 pb-40 pt-4"},oe=["onKeydown"],le={__name:"ComposeMobile",setup(ae){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[R.configure({mention:{items:f}})],b=[$,z,A,H,a,L,N,O,a,C,U,a,q,D,K,M,a,P,j,W,E,G,Y,a,J,a,Q,X],r=u("Design review: new onboarding flow"),d=u(`
