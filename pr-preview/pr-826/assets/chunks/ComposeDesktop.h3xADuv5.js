import{a3 as x,o as v,u as e,aL as n,aq as t,l as i,t as k,aM as y,aN as c,aP as h,aE as T,a8 as m}from"./framework.DVSKGVLN.js";import{cV as I,aJ as S,av as $,ar as u,bJ as R,aI as V}from"./theme.Bx5kAGcw.js";import{r as F,w as L,u as N,P as A,H as B,f as D,g as H,S as o,c as O,p as q,t as z,d as C,O as U,a as P,A as K,b as M,F as E,l as j,o as J,m as W,B as Y,I as G,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.BKERwR8d.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[F.configure({mention:{items:f}})],b=[A,B,D,H,o,O,q,z,o,C,U,o,P,K,M,E,o,j,J,W,Y,G,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
