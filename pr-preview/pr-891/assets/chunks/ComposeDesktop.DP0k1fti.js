import{b3 as x,ad as v,r as k,D as e,bh as n,aE as t,o as i,B as y,bi as T,bj as c,bl as h,b9 as I,aj as m}from"./framework.DyImIxk8.js";import{aK as S,au as $,aq as u,bG as R,aJ as B}from"./theme.CT_nAwtf.js";import{r as D,w as F,u as V,P as A,H,f as L,g as N,S as o,c as O,p as q,t as z,d as C,O as U,a as K,A as j,b as P,F as E,l as M,o as W,m as G,B as J,I as Y,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.BuCgOjpq.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[D.configure({mention:{items:f}})],b=[A,H,L,N,o,O,q,z,o,C,U,o,K,j,P,E,o,M,W,G,J,Y,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
...
`),g=async r=>({file_url:URL.createObjectURL(r),file_name:r.name}),{textarea:_}=x({input:l});return(r,s)=>(v(),k("div",se,[e(t(B),null,{default:n(()=>[e(t(F),{modelValue:d.value,"onUpdate:modelValue":s[1]||(s[1]=a=>d.value=a),extensions:w,"upload-function":g,placeholder:"Type '/' for commands or select text to format"},{default:n(({editor:a})=>[e(t(S),null,{default:n(()=>[e(t($),{items:[{label:"Drafts"},{label:"New discussion"}]}),i("div",ae,[e(t(u),{variant:"ghost",icon:"lucide-trash-2",label:"Delete draft"}),e(t(u),{variant:"solid"},{default:n(()=>[...s[2]||(s[2]=[y("Publish",-1)])]),_:1})])]),_:1}),e(t(R),{class:"flex h-10 items-center border-b bg-surface-base px-3 sm:px-5"},{default:n(()=>[i("div",oe,[e(t(V),{editor:a,items:b},null,8,["editor"])])]),_:2},1024),i("div",ne,[T(i("textarea",{ref_key:"titleTextarea",ref:_,class:"mt-1 w-full resize-none border-0 bg-transparent px-0 py-0.5 text-4xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":s[0]||(s[0]=p=>l.value=p),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[c(h(p=>a.commands.focus(),["prevent"]),["enter"]),c(h(p=>a.commands.focus(),["prevent"]),["down"])]},null,40,ie),[[I,l.value]]),e(t(te),{editor:a,class:"prose-v3 -mx-2 min-h-[calc(100vh-200px)] max-w-[unset] overflow-auto px-2 pb-40"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1})]))}};export{ce as default};
