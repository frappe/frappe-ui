import{_ as g}from"./chunks/PropsTable.CeZ6dqDq.js";import{_ as z}from"./chunks/SlotsTable.Db3t1QvL.js";import{y as x}from"./chunks/theme.MFjeaQqD.js";import{_ as u}from"./chunks/NumberCard.vue_vue_type_script_setup_true_lang.CGr8fCEM.js";import{I as v,ad as t,r,F as k,am as w,D as l,aE as _,Z as b,a1 as j,L as C,be as e,o as s,au as S,p as O,aj as P,ao as m,A as R,B as a}from"./chunks/framework.tIIPkKuP.js";import"./chunks/format.CpJOm8Qd.js";import"./chunks/tokens.Cw9vidg_.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.CHGBAwMN.js";const A={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},D=v({__name:"NumberSparklines",setup(f){const p=[{title:"Signups",value:1284,delta:12.5,deltaSuffix:"%",deltaCaption:"vs last month",sparkline:{data:[842,906,971,1044,1123,1018,1067,1142,1196,1218,1247,1284]}},{title:"Orders shipped",value:2560,sparkline:{data:[1786,1852,1921,2094,2274,2064,2120,2222,2292,2378,2452,2560],type:"bar"}},{title:"Pipeline",value:1845e4,prefix:"$",compact:!0,sparkline:{data:[12.4,13.1,13.9,15.2,16,15.1,15.8,16.4,17.1,17.6,18,18.45]}},{title:"Storage used",value:61,suffix:"%",color:"#f59e0b",sparkline:{data:[42,44,46,49,51,52,54,56,57,59,60,61],color:"#f59e0b"}}];return(c,d)=>(t(),r("div",A,[(t(),r(k,null,w(p,y=>l(_(u),b({key:y.title},{ref_for:!0},y),null,16)),64))]))}}),E={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},T={type:"button",class:"-mx-1 flex h-5 min-w-0 items-center gap-1 rounded-sm px-1 text-sm text-ink-gray-5 outline-none hover:bg-surface-gray-2 hover:text-ink-gray-7 focus-visible:ring-2 focus-visible:ring-outline-gray-3"},N={class:"truncate"},L=v({__name:"NumberKpis",setup(f){const i=[{title:"Net revenue",value:220200,prefix:"$",compact:!0,delta:5.1,deltaSuffix:"%",sparkline:{data:[144500,150700,157400,172700,188600,171700,177100,186700,193600,202100,209500,220200]}},{title:"Monthly churn",value:2.1,suffix:"%",precision:1,delta:-.4,deltaSuffix:"pts",deltaCaption:"vs last month",negativeIsBetter:!0},{title:"Orders shipped",value:2560},{title:"Refunds",value:null}],o=P("last month"),n=["last month","last quarter","last year"].map(p=>({label:`vs ${p}`,onClick:()=>o.value=p}));return(p,c)=>(t(),r("div",E,[l(_(u),j(C(i[0])),{caption:e(()=>[l(_(x),{options:_(n),placement:"left"},{default:e(()=>[s("button",T,[s("span",N,"vs "+S(o.value),1),c[0]||(c[0]=s("span",{class:"lucide-chevron-down size-3.5 shrink-0","aria-hidden":"true"},null,-1))])]),_:1},8,["options"])]),_:1},16),(t(!0),r(k,null,w(i.slice(1),d=>(t(),O(_(u),b({key:d.title},{ref_for:!0},d),null,16))),128))]))}}),$=JSON.parse('{"title":"NumberCard","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/numbercard.md","filePath":"docs/charts/numbercard.md","lastUpdated":0}'),q={name:"docs/charts/numbercard.md"},K=Object.assign(q,{setup(f){const h=[{name:"title",description:`Heads the card. Left out, the chart draws no header row at all.
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(z,{data:i})])}}});export{$ as __pageData,K as default};
