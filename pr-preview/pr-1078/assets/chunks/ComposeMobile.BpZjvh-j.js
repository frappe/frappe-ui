import{b1 as v,ad as _,p as x,be as n,D as o,aE as e,B as y,o as i,bf as T,bg as c,bi as h,b6 as I,aj as u}from"./framework.tIIPkKuP.js";import{an as S,x as m,am as B}from"./theme.B7MNwXrs.js";import{u as R,z,x as F,P as V,H as $,g as A,h as H,S as a,c as L,q as N,w as O,d as q,O as C,a as U,A as D,b as j,F as K,m as M,p as P,n as E,B as W,I as Y,j as G,o as J,U as Q,R as X,y as Z}from"./kits.DxrzdfGG.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const ee={class:"sticky top-0 z-10 border-b bg-surface-base"},te={class:"overflow-x-auto px-2 py-1"},se={class:"px-4 pb-40 pt-4"},oe=["onKeydown"],de={__name:"ComposeMobile",setup(ae){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[R.configure({mention:{items:f}})],b=[V,$,A,H,a,L,N,O,a,q,C,a,U,D,j,K,a,M,P,E,W,Y,G,a,J,a,Q,X],r=u("Design review: new onboarding flow"),d=u(`
