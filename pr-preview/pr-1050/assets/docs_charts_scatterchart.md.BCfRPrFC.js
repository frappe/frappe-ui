import{_ as vs}from"./chunks/PropsTable.1FSSKic4.js";import{_ as gs}from"./chunks/SlotsTable.DZTRCr_n.js";import{_ as ks}from"./chunks/EmitsTable.Do_wdo52.js";import{bm as bs,bg as xs,bh as js,br as zs}from"./chunks/theme.B0ErLTiK.js";import{r as Cs,u as Ss}from"./chunks/useChart.DGMc8AC9.js";import{u as As}from"./chunks/usePlotKeyboard.ORhk1mR_.js";import{t as B,c as Os,D as Ps,B as K,A as Rs,e as Ts}from"./chunks/axisChartCommon.B19qJ_gs.js";import{a as T,d as Es}from"./chunks/format.DCkvHwNc.js";import{c as Ds,C as Ls,u as Is}from"./chunks/tokens.CicM4eNQ.js";import{b as Ns,t as Bs,p as qs}from"./chunks/referenceLines.D_XuQt2j.js";import{b as cs,c as Fs,d as Ms,p as Vs}from"./chunks/utils.BIjrxRCb.js";import{_ as $s}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.B60cxBUm.js";import{_ as Hs}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.SpZ2Hb4o.js";import{_ as Gs}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.BzKrPzFe.js";import{I as E,aV as Ws,bb as X,l as v,ad as O,p as Us,z as Z,bh as m,an as C,a1 as Q,L as J,D as d,o as s,Z as Ys,aE as A,au as Ks,Y as ss,aj as q,ag as as,r as D,ao as ns,A as F,B as a}from"./chunks/framework.BLQjXmDz.js";const Xs="categorical",S=10,ls=35,es=.75,ps="6%";function is(l,{tokens:r}){const c=l.data??[],p=[],i=new Map,t=[];for(const u of c){const x=B(u[l.xColumn]),w=B(u[l.yColumn]);if(x===null||w===null)continue;const z=Qs(l,u);let j=i.get(z);j||(j=[],p.push(z),i.set(z,j));const g=l.sizeColumn?B(u[l.sizeColumn]):null;g!==null&&t.push(g),j.push({x,y:w,size:g,label:Js(l,u),row:u})}const f=sa(t,!!l.sizeColumn),y=Ds(l.palette,r,{fallback:Xs,count:p.length});return p.map((u,x)=>({name:u,label:T(u),color:y[x],points:i.get(u).map(w=>({...w,symbolSize:f(w.size)}))}))}const Zs="(Blank)";function Qs(l,r){if(!l.seriesColumn)return l.yColumn;const c=r[l.seriesColumn];return c==null||c===""?Zs:String(c)}function Js(l,r){if(!l.labelColumn)return;const c=r[l.labelColumn];return c==null?void 0:String(c)}function sa(l,r){if(!r)return()=>S;const c=aa(l);return p=>p===null?S:c(p)}function aa(l){let r=1/0,c=-1/0;for(const i of l)i<r&&(r=i),i>c&&(c=i);if(r===c){const i=(S+ls)/2;return()=>i}const p=ls-S;return i=>S+(i-r)/(c-r)*p}function na(l,r){const{tokens:c,hiddenSeries:p=[],format:i}=r,t=l.dir==="rtl",y=is(l,r).filter(w=>!p.includes(w.name)),u=ea(l),x={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:Ls},grid:Os({horizontal:!1,isRTL:t,labelGutter:0}),xAxis:ts(l.xAxis,c,{horizontal:!0,isRTL:t,format:i?.x,name:l.xAxis?.title}),yAxis:ts(l.yAxis,c,{horizontal:!1,isRTL:t,format:i?.y}),series:[...y.map(w=>pa(w,{tokens:c,isRTL:t,showLabels:u})),...Ns(la(l),{tokens:c,horizontal:!1,hasSecondaryValueAxis:!1,hasCategoryAxis:!1,hostSeriesType:"scatter"})]};return cs(x,l.echartOptions)}function la(l){const r=l.referenceLines;return r?.filter(c=>c.axis==="y2").length,r}function ea(l){return l.showDataLabels?!!l.labelColumn:!1}function pa(l,r){const{tokens:c,isRTL:p,showLabels:i}=r;return{type:"scatter",name:l.name,data:l.points.map(t=>({value:[t.x,t.y],symbolSize:t.symbolSize,...i?{name:t.label??""}:{}})),symbol:"circle",itemStyle:{color:l.color,opacity:es,borderWidth:0},emphasis:{focus:"series",blurScope:"coordinateSystem"},blur:{itemStyle:{opacity:es*K},label:{opacity:K}},...i?{label:{show:!0,position:p?"left":"right",color:c.dataLabel,fontSize:Ps,formatter:t=>String(t?.name??"")},labelLayout:{hideOverlap:!0}}:{}}}function ts(l,r,c){const{horizontal:p,isRTL:i,format:t,name:f}=c,y=cs({scale:!0,boundaryGap:[ps,ps],...f?{name:T(f),nameLocation:"end",nameGap:8,nameTextStyle:{color:r.axisTitle,fontSize:Rs}}:{},...t?{axisLabel:{formatter:u=>t(Number(u))}}:{}},l?.echartOptions);return Ts({...l,echartOptions:y},r,{horizontal:p,isRTL:i})}const ta=["aria-label"],ca={class:"sr-only",role:"status"},M=E({__name:"ScatterChart",props:ss({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},x:{},y:{},size:{},series:{},hiddenSeries:{},label:{},showDataLabels:{type:Boolean},xAxis:{},yAxis:{},palette:{},referenceLines:{},format:{type:Function},echartOptions:{}},{hiddenSeries:{default:()=>[]},hiddenSeriesModifiers:{}}),emits:ss(["select"],["update:hiddenSeries"]),setup(l,{expose:r,emit:c}){Cs([bs,xs,js,zs]);const p=l,i=Ws(l,"hiddenSeries"),t=c,f=q(),y=v(()=>p.dir??Ms()),u=v(()=>p.xAxis?.format??p.format),x=v(()=>p.yAxis?.format??p.format),w=v(()=>({data:p.data,xColumn:p.x,yColumn:p.y,sizeColumn:p.size,seriesColumn:p.series,labelColumn:p.label,showDataLabels:p.showDataLabels,xAxis:z(p.xAxis),yAxis:z(p.yAxis),referenceLines:p.referenceLines,palette:p.palette,dir:y.value,echartOptions:p.echartOptions}));function z(n){if(n)return{title:n.title,min:n.min,max:n.max,echartOptions:n.echartOptions}}const{tokens:j}=Is(f),g=v(()=>is(w.value,{tokens:j.value})),rs=v(()=>g.value.every(n=>!n.points.length)),_s=v(()=>p.yAxis?.title?T(p.yAxis.title):void 0),V=v(()=>{try{return{option:na(w.value,{tokens:j.value,hiddenSeries:i.value,format:{x:u.value,y:x.value}}),error:null}}catch(n){return{option:void 0,error:n?.message??String(n)}}}),os=v(()=>V.value.error),k=as({x:0,y:0}),o=as({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:$,dispatch:P}=Ss({container:f,option:()=>V.value.option,events:{mouseover:n=>hs(n),mouseout:()=>o.open=!1,click:n=>{const e=H(n);e&&t("select",{seriesName:e.series.name,x:e.point.x,y:e.point.y,size:e.point.size,label:e.point.label,row:e.point.row})}},onZrEvents:{mousemove:n=>{k.x=n.event?.clientX??k.x,k.y=n.event?.clientY??k.y,o.open&&(o.x=k.x,o.y=k.y)},globalout:()=>o.open=!1}});function H(n){const e=g.value.find(_=>_.name===n?.seriesName),h=e?.points[n?.dataIndex];return e&&h?{series:e,point:h}:void 0}function hs(n){const e=H(n);if(!e){o.open=!1;return}G(e,k.x,k.y)}function G(n,e,h){const{series:_,point:b}=n,ws=[b.label,p.series?_.label:void 0].filter(Boolean).join(" · ");o.label=ws||void 0,o.items=[L(p.x,b.x,u.value,_.color),L(p.y,b.y,x.value,_.color),...p.size&&b.size!==null?[L(p.size,b.size,p.format,_.color)]:[]],o.x=e,o.y=h,o.open=!0}function L(n,e,h,_){return{name:n,label:T(n),color:_,value:e,formattedValue:h?h(e):Es(e)}}const W=v(()=>g.value.map(n=>({name:n.name,label:n.label,color:n.color,hidden:i.value.includes(n.name)})));function us(n){i.value=Bs(i.value,n,g.value.length)}const U=q(null);function ds(n){U.value=n}X(U,(n,e)=>{e&&P({type:"downplay",seriesName:e}),n&&!i.value.includes(n)&&P({type:"highlight",seriesName:n})});const I=q(""),R=v(()=>g.value.filter(n=>!i.value.includes(n.name)).flatMap((n,e)=>n.points.map((h,_)=>({entry:n,point:h,seriesIndex:e,dataIndex:_}))));function ms(n,e){const h=f.value;if(!h)return;const _=h.getBoundingClientRect(),b=$.value?.convertToPixel({gridIndex:0},[n,e]);return!b||b.some(N=>typeof N!="number"||isNaN(N))?{x:_.left+_.width/2,y:_.top+_.height/2}:{x:_.left+b[0],y:_.top+b[1]}}function fs(n){const e=R.value[n];if(!e)return;const h=ms(e.point.x,e.point.y);P({type:"highlight",seriesIndex:e.seriesIndex,dataIndex:e.dataIndex}),G({series:e.entry,point:e.point},h?.x??k.x,h?.y??k.y),I.value=Vs(o.label,o.items.map(_=>({label:_.label,value:_.formattedValue})))}function Y(n){const e=n===null?void 0:R.value[n];e&&P({type:"downplay",seriesIndex:e.seriesIndex,dataIndex:e.dataIndex})}const ys=As({marks:()=>R.value,key:n=>`${n.entry.name} ${n.point.x} ${n.point.y}`,move:(n,e)=>{Y(e),fs(n)},activate:n=>{const e=R.value[n];e&&t("select",{seriesName:e.entry.name,x:e.point.x,y:e.point.y,size:e.point.size,label:e.point.label,row:e.point.row})},clear:n=>{Y(n),o.open=!1,I.value=""}}).attrs;return X(()=>g.value.map(n=>n.name),n=>{i.value=qs(i.value,n)}),r({chart:v(()=>$.value)}),(n,e)=>(O(),Us($s,{title:l.title,subtitle:l.subtitle,"plot-label":_s.value,loading:l.loading,error:l.error||os.value,empty:rs.value,dir:y.value},Z({default:m(()=>[s("div",Ys({ref_key:"plotEl",ref:f,class:"h-full w-full rounded-2 focus-visible:focus-ring",dir:"ltr",role:"img","aria-label":A(Fs)(l.title,l.subtitle)},A(ys)),null,16,ta),s("span",ca,Ks(I.value),1),d(Gs,{open:o.open,x:o.x,y:o.y,label:o.label,items:o.items,dir:y.value},Z({_:2},[n.$slots.tooltip?{name:"default",fn:m(h=>[C(n.$slots,"tooltip",Q(J(h)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[n.$slots.actions?{name:"actions",fn:m(()=>[C(n.$slots,"actions")]),key:"0"}:void 0,n.$slots.loading?{name:"loading",fn:m(()=>[C(n.$slots,"loading")]),key:"1"}:void 0,n.$slots.error?{name:"error",fn:m(h=>[C(n.$slots,"error",Q(J(h)))]),key:"2"}:void 0,n.$slots.empty?{name:"empty",fn:m(()=>[C(n.$slots,"empty")]),key:"3"}:void 0,W.value.length>1?{name:"legend",fn:m(()=>[d(Hs,{items:W.value,onChange:us,onHighlight:ds},null,8,["items"])]),key:"4"}:void 0]),1032,["title","subtitle","plot-label","loading","error","empty","dir"]))}}),ia={class:"h-80 w-full"},ra=E({__name:"ScatterQuadrants",setup(l){const r=[{product:"Payroll",growth:34,margin:62},{product:"Invoicing",growth:12,margin:71},{product:"CRM",growth:41,margin:48},{product:"Helpdesk",growth:27,margin:55},{product:"Inventory",growth:8,margin:44},{product:"Insights",growth:52,margin:39},{product:"Field service",growth:6,margin:58},{product:"Point of sale",growth:19,margin:33}],c=p=>`${p}%`;return(p,i)=>(O(),D("div",ia,[d(A(M),{data:r,x:"growth",y:"margin",label:"product","show-data-labels":"","x-axis":{title:"Growth",format:c},"y-axis":{title:"Margin",format:c},"reference-lines":[{value:25,axis:"x",label:"Median growth",dashed:!0},{value:50,axis:"y",label:"Median margin",dashed:!0}],title:"Growth against margin",subtitle:"Median lines divide the plot into four"},null,8,["x-axis","y-axis"])]))}}),_a={class:"h-96 w-full"},oa=E({__name:"ScatterMarkets",setup(l){const r=[{market:"Germany",arpu:61,retention:88,seats:14200,region:"EMEA"},{market:"France",arpu:54,retention:82,seats:9100,region:"EMEA"},{market:"UAE",arpu:72,retention:79,seats:2600,region:"EMEA"},{market:"Nigeria",arpu:21,retention:74,seats:4800,region:"EMEA"},{market:"India",arpu:18,retention:91,seats:38400,region:"APAC"},{market:"Japan",arpu:68,retention:94,seats:7300,region:"APAC"},{market:"Australia",arpu:59,retention:85,seats:5200,region:"APAC"},{market:"Singapore",arpu:77,retention:81,seats:1900,region:"APAC"},{market:"United States",arpu:74,retention:87,seats:41500,region:"Americas"},{market:"Canada",arpu:63,retention:89,seats:8600,region:"Americas"},{market:"Brazil",arpu:26,retention:71,seats:12800,region:"Americas"},{market:"Mexico",arpu:31,retention:76,seats:6400,region:"Americas"}];return(c,p)=>(O(),D("div",_a,[d(A(M),{data:r,x:"arpu",y:"retention",size:"seats",series:"region",label:"market","x-axis":{title:"ARPU",format:i=>`$${i}`},"y-axis":{title:"Retention",format:i=>`${i}%`},title:"Revenue per seat against retention",subtitle:"Bubble size is the number of seats"},null,8,["x-axis","y-axis"])]))}}),ha={class:"h-80 w-full"},ua=E({__name:"ScatterSpend",setup(l){const r=[{account:"Acme",spend:4200,revenue:12400},{account:"Globex",spend:9100,revenue:24200},{account:"Initech",spend:2200,revenue:3100},{account:"Umbrella",spend:7400,revenue:9600},{account:"Soylent",spend:5600,revenue:18800},{account:"Hooli",spend:12800,revenue:21400},{account:"Vehement",spend:1800,revenue:6200},{account:"Massive Dynamic",spend:10400,revenue:34600},{account:"Stark",spend:6800,revenue:7400},{account:"Wayne",spend:3100,revenue:11200}],c=p=>`$${new Intl.NumberFormat("en-US").format(p)}`;return(p,i)=>(O(),D("div",ha,[d(A(M),{data:r,x:"spend",y:"revenue",label:"account","x-axis":{title:"Acquisition spend"},"y-axis":{title:"Revenue"},format:c,title:"Spend against revenue",subtitle:"Ten largest accounts, last quarter"})]))}}),Ra=JSON.parse('{"title":"ScatterChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/scatterchart.md","filePath":"docs/charts/scatterchart.md","lastUpdated":0}'),da={name:"docs/charts/scatterchart.md"},Ta=Object.assign(da,{setup(l){const r=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),d(gs,{data:c}),d(ks,{data:p})])}}});export{Ra as __pageData,Ta as default};
