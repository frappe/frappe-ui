import{_ as w}from"./chunks/PropsTable.1FSSKic4.js";import{_ as b}from"./chunks/SlotsTable.DZTRCr_n.js";import{_ as g}from"./chunks/EmitsTable.Do_wdo52.js";import"./chunks/theme.B0ErLTiK.js";import{_ as m}from"./chunks/FunnelChart.vue_vue_type_script_setup_true_lang.C4meXjN5.js";import{I as k,ad as i,r as _,o as s,D as l,aE as v,F as f,B as a,au as o,aj as z,ao as y,bh as p}from"./chunks/framework.BLQjXmDz.js";import"./chunks/format.DCkvHwNc.js";import"./chunks/tokens.CicM4eNQ.js";import"./chunks/axisChartCommon.B19qJ_gs.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.B60cxBUm.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.BzKrPzFe.js";const x={class:"flex h-96 w-full flex-col gap-2"},j={class:"min-h-0 flex-1"},C={class:"text-p-sm text-ink-gray-5"},S=k({__name:"FunnelDeals",setup(h){const t=[{stage:"Leads",count:563},{stage:"Qualified",count:385},{stage:"Quotation sent",count:291},{stage:"Ready to close",count:191},{stage:"Won",count:39}],e=z(null);return(c,r)=>(i(),_("div",x,[s("div",j,[l(v(m),{data:t,category:"stage",value:"count","show-percentages":!1,title:"Deal pipeline",subtitle:"Open deals by stage, this quarter",onSelect:r[0]||(r[0]=n=>e.value=n)})]),s("p",C,[e.value?(i(),_(f,{key:0},[a(" Selected "+o(e.value.label)+" · "+o(e.value.value)+" · index "+o(e.value.index),1)],64)):(i(),_(f,{key:1},[a("Select a stage.")],64))])]))}}),O={class:"h-80 w-full"},R=k({__name:"FunnelStages",setup(h){const t=[{stage:"Visited the store",people:106200},{stage:"Viewed a plan",people:38400},{stage:"Started checkout",people:9860},{stage:"Entered payment details",people:3410},{stage:"Active subscription",people:2560}],e=c=>new Intl.NumberFormat("en-US",{notation:"compact"}).format(c);return(c,r)=>(i(),_("div",O,[l(v(m),{data:t,category:"stage",value:"people",format:e,title:"Store visit to subscription",subtitle:"July 2026"})]))}}),W=JSON.parse('{"title":"FunnelChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/funnelchart.md","filePath":"docs/charts/funnelchart.md","lastUpdated":0}'),A={name:"docs/charts/funnelchart.md"},G=Object.assign(A,{setup(h){const t=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:e}),l(g,{data:c})])}}});export{W as __pageData,G as default};
