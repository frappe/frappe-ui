import{_ as Hs}from"./chunks/PropsTable.zGCtZ84T.js";import{_ as Ws}from"./chunks/SlotsTable.C2-kp1vD.js";import{_ as Ys}from"./chunks/EmitsTable.D-X5LTDb.js";import"./chunks/theme.Bc6eFF0f.js";import{ag as k,aa as ts,H as Ks,an as Xs,bh as Us,bk as Zs,b9 as Js,b3 as us,bs as Os,Y,b$ as ds,V as Qs,e as sa,aW as aa,bR as na,u as fs,_ as is,aC as ys,aE as ms,cb as vs,ce as gs,co as ws,R as Rs,C as ea,ak as la,bc as ta,P as pa,b8 as ks,g as ca,aY as ia,c1 as ra,M as oa,a6 as bs,v as _a,aq as ha,aG as ua,aR as da,bX as fa,cw as ya}from"./chunks/useChart.B4oeRZde.js";import{u as ma}from"./chunks/usePlotKeyboard.ORhk1mR_.js";import{B as ps,D as va,t as ga}from"./chunks/axisChartCommon.C4PQGt72.js";import{d as Ps,a as wa}from"./chunks/format.DVGmfzNI.js";import{C as ka,c as ba,u as xa}from"./chunks/tokens.B1qgX3kC.js";import{b as za,c as ja,d as Ca,e as Sa,p as Da}from"./chunks/utils.BIjrxRCb.js";import{_ as Ea}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.B-BnrJzd.js";import{_ as La}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.76DR_vD0.js";import{c as Aa}from"./chunks/createSeriesData.D4zfld_h.js";import{V as Ia}from"./chunks/VisualMapping.BSXdlViE.js";import{I as rs,l as M,ad as U,p as Oa,z as xs,bh as D,an as G,a1 as zs,L as js,o as s,Z as Ra,aE as K,au as Pa,D as A,aj as Cs,ag as Ss,r as os,ao as Ds,A as Es,B as a}from"./chunks/framework.BLQjXmDz.js";import"./chunks/dataStackHelper.B_qSQlmK.js";var I=Us();function Ta(l){var n=l.mainData,e=l.datas;e||(e={main:n},l.datasAttr={main:"data"}),l.datas=l.mainData=null,Ts(n,e,l),k(e,function(t){k(n.TRANSFERABLE_METHODS,function(c){t.wrapMethod(c,ts(Va,l))})}),n.wrapMethod("cloneShallow",ts(Ba,l)),k(n.CHANGABLE_METHODS,function(t){n.wrapMethod(t,ts(Ma,l))}),Ks(e[n.dataType]===n)}function Va(l,n){if(qa(this)){var e=Xs({},I(this).datas);e[this.dataType]=n,Ts(n,e,l)}else _s(n,this.dataType,I(this).mainData,l);return n}function Ma(l,n){return l.struct&&l.struct.update(),n}function Ba(l,n){return k(I(n).datas,function(e,t){e!==n&&_s(e.cloneShallow(),t,n,l)}),n}function Fa(l){var n=I(this).mainData;return l==null||n==null?n:I(n).datas[l]}function Na(){var l=I(this).mainData;return l==null?[{data:l}]:Zs(Js(I(l).datas),function(n){return{type:n,data:I(l).datas[n]}})}function qa(l){return I(l).mainData===l}function Ts(l,n,e){I(l).datas={},k(n,function(t,c){_s(t,c,l,e)})}function _s(l,n,e,t){I(e).datas[n]=l,I(l).mainData=e,l.dataType=n,t.struct&&(l[t.structAttr]=t.struct,t.struct[t.datasAttr[n]]=l),l.getLinkedData=Fa,l.getLinkedDataAll=Na}function q(l){return"_EC_"+l}var Ga=(function(){function l(n){this.type="graph",this.nodes=[],this.edges=[],this._nodesMap={},this._edgesMap={},this._directed=n||!1}return l.prototype.isDirected=function(){return this._directed},l.prototype.addNode=function(n,e){n=n==null?""+e:""+n;var t=this._nodesMap;if(!t[q(n)]){var c=new B(n,e);return c.hostGraph=this,this.nodes.push(c),t[q(n)]=c,c}},l.prototype.getNodeByIndex=function(n){var e=this.data.getRawIndex(n);return this.nodes[e]},l.prototype.getNodeById=function(n){return this._nodesMap[q(n)]},l.prototype.addEdge=function(n,e,t){var c=this._nodesMap,p=this._edgesMap;if(us(n)&&(n=this.nodes[n]),us(e)&&(e=this.nodes[e]),n instanceof B||(n=c[q(n)]),e instanceof B||(e=c[q(e)]),!(!n||!e)){var r=n.id+"-"+e.id,i=new Vs(n,e,t);return i.hostGraph=this,this._directed&&(n.outEdges.push(i),e.inEdges.push(i)),n.edges.push(i),n!==e&&e.edges.push(i),this.edges.push(i),p[r]=i,i}},l.prototype.getEdgeByIndex=function(n){var e=this.edgeData.getRawIndex(n);return this.edges[e]},l.prototype.getEdge=function(n,e){n instanceof B&&(n=n.id),e instanceof B&&(e=e.id);var t=this._edgesMap;return this._directed?t[n+"-"+e]:t[n+"-"+e]||t[e+"-"+n]},l.prototype.eachNode=function(n,e){for(var t=this.nodes,c=t.length,p=0;p<c;p++)t[p].dataIndex>=0&&n.call(e,t[p],p)},l.prototype.eachEdge=function(n,e){for(var t=this.edges,c=t.length,p=0;p<c;p++)t[p].dataIndex>=0&&t[p].node1.dataIndex>=0&&t[p].node2.dataIndex>=0&&n.call(e,t[p],p)},l.prototype.breadthFirstTraverse=function(n,e,t,c){if(e instanceof B||(e=this._nodesMap[q(e)]),!!e){for(var p=t==="out"?"outEdges":t==="in"?"inEdges":"edges",r=0;r<this.nodes.length;r++)this.nodes[r].__visited=!1;if(!n.call(c,e,null))for(var i=[e];i.length;)for(var o=i.shift(),h=o[p],r=0;r<h.length;r++){var _=h[r],y=_.node1===o?_.node2:_.node1;if(!y.__visited){if(n.call(c,y,o))return;i.push(y),y.__visited=!0}}}},l.prototype.update=function(){for(var n=this.data,e=this.edgeData,t=this.nodes,c=this.edges,p=0,r=t.length;p<r;p++)t[p].dataIndex=-1;for(var p=0,r=n.count();p<r;p++)t[n.getRawIndex(p)].dataIndex=p;e.filterSelf(function(i){var o=c[e.getRawIndex(i)];return o.node1.dataIndex>=0&&o.node2.dataIndex>=0});for(var p=0,r=c.length;p<r;p++)c[p].dataIndex=-1;for(var p=0,r=e.count();p<r;p++)c[e.getRawIndex(p)].dataIndex=p},l.prototype.clone=function(){for(var n=new l(this._directed),e=this.nodes,t=this.edges,c=0;c<e.length;c++)n.addNode(e[c].id,e[c].dataIndex);for(var c=0;c<t.length;c++){var p=t[c];n.addEdge(p.node1.id,p.node2.id,p.dataIndex)}return n},l})(),B=(function(){function l(n,e){this.inEdges=[],this.outEdges=[],this.edges=[],this.dataIndex=-1,this.id=n??"",this.dataIndex=e??-1}return l.prototype.degree=function(){return this.edges.length},l.prototype.inDegree=function(){return this.inEdges.length},l.prototype.outDegree=function(){return this.outEdges.length},l.prototype.getModel=function(n){if(!(this.dataIndex<0)){var e=this.hostGraph,t=e.data.getItemModel(this.dataIndex);return t.getModel(n)}},l.prototype.getAdjacentDataIndices=function(){for(var n={edge:[],node:[]},e=0;e<this.edges.length;e++){var t=this.edges[e];t.dataIndex<0||(n.edge.push(t.dataIndex),n.node.push(t.node1.dataIndex,t.node2.dataIndex))}return n},l.prototype.getTrajectoryDataIndices=function(){for(var n=Y(),e=Y(),t=0;t<this.edges.length;t++){var c=this.edges[t];if(!(c.dataIndex<0)){n.set(c.dataIndex,!0);for(var p=[c.node1],r=[c.node2],i=0;i<p.length;){var o=p[i];i++,e.set(o.dataIndex,!0);for(var h=0;h<o.inEdges.length;h++)n.set(o.inEdges[h].dataIndex,!0),p.push(o.inEdges[h].node1)}for(i=0;i<r.length;){var _=r[i];i++,e.set(_.dataIndex,!0);for(var h=0;h<_.outEdges.length;h++)n.set(_.outEdges[h].dataIndex,!0),r.push(_.outEdges[h].node2)}}}return{edge:n.keys(),node:e.keys()}},l})(),Vs=(function(){function l(n,e,t){this.dataIndex=-1,this.node1=n,this.node2=e,this.dataIndex=t??-1}return l.prototype.getModel=function(n){if(!(this.dataIndex<0)){var e=this.hostGraph,t=e.edgeData.getItemModel(this.dataIndex);return t.getModel(n)}},l.prototype.getAdjacentDataIndices=function(){return{edge:[this.dataIndex],node:[this.node1.dataIndex,this.node2.dataIndex]}},l.prototype.getTrajectoryDataIndices=function(){var n=Y(),e=Y();n.set(this.dataIndex,!0);for(var t=[this.node1],c=[this.node2],p=0;p<t.length;){var r=t[p];p++,e.set(r.dataIndex,!0);for(var i=0;i<r.inEdges.length;i++)n.set(r.inEdges[i].dataIndex,!0),t.push(r.inEdges[i].node1)}for(p=0;p<c.length;){var o=c[p];p++,e.set(o.dataIndex,!0);for(var i=0;i<o.outEdges.length;i++)n.set(o.outEdges[i].dataIndex,!0),c.push(o.outEdges[i].node2)}return{edge:n.keys(),node:e.keys()}},l})();function Ms(l,n){return{getValue:function(e){var t=this[l][n];return t.getStore().get(t.getDimensionIndex(e||"value"),this.dataIndex)},setVisual:function(e,t){this.dataIndex>=0&&this[l][n].setItemVisual(this.dataIndex,e,t)},getVisual:function(e){return this[l][n].getItemVisual(this.dataIndex,e)},setLayout:function(e,t){this.dataIndex>=0&&this[l][n].setItemLayout(this.dataIndex,e,t)},getLayout:function(){return this[l][n].getItemLayout(this.dataIndex)},getGraphicEl:function(){return this[l][n].getItemGraphicEl(this.dataIndex)},getRawIndex:function(){return this[l][n].getRawIndex(this.dataIndex)}}}Os(B,Ms("hostGraph","data"));Os(Vs,Ms("hostGraph","edgeData"));function $a(l,n,e,t,c){for(var p=new Ga(t),r=0;r<l.length;r++)p.addNode(ds(l[r].id,l[r].name,r),r);for(var i=[],o=[],h=0,r=0;r<n.length;r++){var _=n[r],y=_.source,v=_.target;p.addEdge(y,v,h)&&(o.push(_),i.push(ds(Qs(_.id,null),y+" > "+v)),h++)}var f=e.get("coordinateSystem"),u;if(f==="cartesian2d"||f==="polar")u=Aa(l,e);else{var m=sa.get(f),w=m?m.dimensions||[]:[];aa(w,"value")<0&&w.concat(["value"]);var b=na(l,{coordDimensions:w,encodeDefine:e.getEncode()}).dimensions;u=new fs(b,e),u.initData(l)}var x=new fs(["value"],e);return x.initData(o,i),c&&c(u,x),Ta({mainData:u,struct:p,structAttr:"graph",datas:{node:u,edge:x},datasAttr:{node:"data",edge:"edgeData"}}),p.update(),p}var Ha=(function(){function l(){this.x1=0,this.y1=0,this.x2=0,this.y2=0,this.cpx1=0,this.cpy1=0,this.cpx2=0,this.cpy2=0,this.extent=0}return l})(),Wa=(function(l){is(n,l);function n(e){return l.call(this,e)||this}return n.prototype.getDefaultShape=function(){return new Ha},n.prototype.buildPath=function(e,t){var c=t.extent;e.moveTo(t.x1,t.y1),e.bezierCurveTo(t.cpx1,t.cpy1,t.cpx2,t.cpy2,t.x2,t.y2),t.orient==="vertical"?(e.lineTo(t.x2+c,t.y2),e.bezierCurveTo(t.cpx2+c,t.cpy2,t.cpx1+c,t.cpy1,t.x1+c,t.y1)):(e.lineTo(t.x2,t.y2+c),e.bezierCurveTo(t.cpx2,t.cpy2+c,t.cpx1,t.cpy1+c,t.x1,t.y1+c)),e.closePath()},n.prototype.highlight=function(){la(this)},n.prototype.downplay=function(){ta(this)},n})(pa),Ya=(function(l){is(n,l);function n(){var e=l!==null&&l.apply(this,arguments)||this;return e.type=n.type,e._focusAdjacencyDisabled=!1,e}return n.prototype.render=function(e,t,c){var p=this,r=e.getGraph(),i=this.group,o=e.layoutInfo,h=o.width,_=o.height,y=e.getData(),v=e.getData("edge"),f=e.get("orient");this._model=e,i.removeAll(),i.x=o.x,i.y=o.y,r.eachEdge(function(u){var m=new Wa,w=ys(m);w.dataIndex=u.dataIndex,w.seriesIndex=e.seriesIndex,w.dataType="edge";var b=u.getModel(),x=b.getModel("lineStyle"),z=x.get("curveness"),E=u.node1.getLayout(),j=u.node1.getModel(),L=j.get("localX"),S=j.get("localY"),O=u.node2.getLayout(),$=u.node2.getModel(),d=$.get("localX"),g=$.get("localY"),C=u.getLayout(),R,P,F,N,Z,J,Q,ss;m.shape.extent=Math.max(1,C.dy),m.shape.orient=f,f==="vertical"?(R=(L!=null?L*h:E.x)+C.sy,P=(S!=null?S*_:E.y)+E.dy,F=(d!=null?d*h:O.x)+C.ty,N=g!=null?g*_:O.y,Z=R,J=P*(1-z)+N*z,Q=F,ss=P*z+N*(1-z)):(R=(L!=null?L*h:E.x)+E.dx,P=(S!=null?S*_:E.y)+C.sy,F=d!=null?d*h:O.x,N=(g!=null?g*_:O.y)+C.ty,Z=R*(1-z)+F*z,J=P,Q=R*z+F*(1-z),ss=N),m.setShape({x1:R,y1:P,x2:F,y2:N,cpx1:Z,cpy1:J,cpx2:Q,cpy2:ss}),m.useStyle(x.getItemStyle()),Ls(m.style,f,u);var hs=""+b.get("value"),as=ms(b,"edgeLabel");vs(m,as,{labelFetcher:{getFormattedLabel:function(ls,H,Rn,qs,Gs,$s){return e.getFormattedLabel(ls,H,"edge",qs,ra(Gs,as.normal&&as.normal.get("formatter"),hs),$s)}},labelDataIndex:u.dataIndex,defaultText:hs}),m.setTextConfig({position:"inside"});var ns=b.getModel("emphasis");gs(m,b,"lineStyle",function(ls){var H=ls.getItemStyle();return Ls(H,f,u),H}),i.add(m),v.setItemGraphicEl(u.dataIndex,m);var es=ns.get("focus");ws(m,es==="adjacency"?u.getAdjacentDataIndices():es==="trajectory"?u.getTrajectoryDataIndices():es,ns.get("blurScope"),ns.get("disabled"))}),r.eachNode(function(u){var m=u.getLayout(),w=u.getModel(),b=w.get("localX"),x=w.get("localY"),z=w.getModel("emphasis"),E=w.get(["itemStyle","borderRadius"])||0,j=new Rs({shape:{x:b!=null?b*h:m.x,y:x!=null?x*_:m.y,width:m.dx,height:m.dy,r:E},style:w.getModel("itemStyle").getItemStyle(),z2:10});vs(j,ms(w),{labelFetcher:{getFormattedLabel:function(S,O){return e.getFormattedLabel(S,O,"node")}},labelDataIndex:u.dataIndex,defaultText:u.id}),j.disableLabelAnimation=!0,j.setStyle("fill",u.getVisual("color")),j.setStyle("decal",u.getVisual("style").decal),gs(j,w),i.add(j),y.setItemGraphicEl(u.dataIndex,j),ys(j).dataType="node";var L=z.get("focus");ws(j,L==="adjacency"?u.getAdjacentDataIndices():L==="trajectory"?u.getTrajectoryDataIndices():L,z.get("blurScope"),z.get("disabled"))}),y.eachItemGraphicEl(function(u,m){var w=y.getItemModel(m);w.get("draggable")&&(u.drift=function(b,x){p._focusAdjacencyDisabled=!0,this.shape.x+=b,this.shape.y+=x,this.dirty(),c.dispatchAction({type:"dragNode",seriesId:e.id,dataIndex:y.getRawIndex(m),localX:this.shape.x/h,localY:this.shape.y/_})},u.ondragend=function(){p._focusAdjacencyDisabled=!1},u.draggable=!0,u.cursor="move")}),!this._data&&e.isAnimationEnabled()&&i.setClipPath(Ka(i.getBoundingRect(),e,function(){i.removeClipPath()})),this._data=e.getData()},n.prototype.dispose=function(){},n.type="sankey",n})(ea);function Ls(l,n,e){switch(l.fill){case"source":l.fill=e.node1.getVisual("color"),l.decal=e.node1.getVisual("style").decal;break;case"target":l.fill=e.node2.getVisual("color"),l.decal=e.node2.getVisual("style").decal;break;case"gradient":var t=e.node1.getVisual("color"),c=e.node2.getVisual("color");ks(t)&&ks(c)&&(l.fill=new ca(0,0,+(n==="horizontal"),+(n==="vertical"),[{color:t,offset:0},{color:c,offset:1}]))}}function Ka(l,n,e){var t=new Rs({shape:{x:l.x-10,y:l.y-10,width:0,height:l.height+20}});return ia(t,{shape:{width:l.width+20}},n,e),t}var Xa=(function(l){is(n,l);function n(){var e=l!==null&&l.apply(this,arguments)||this;return e.type=n.type,e}return n.prototype.getInitialData=function(e,t){var c=e.edges||e.links||[],p=e.data||e.nodes||[],r=e.levels||[];this.levelModels=[];for(var i=this.levelModels,o=0;o<r.length;o++)r[o].depth!=null&&r[o].depth>=0&&(i[r[o].depth]=new oa(r[o],this,t));var h=$a(p,c,this,!0,_);return h.data;function _(y,v){y.wrapMethod("getItemModel",function(f,u){var m=f.parentModel,w=m.getData().getItemLayout(u);if(w){var b=w.depth,x=m.levelModels[b];x&&(f.parentModel=x)}return f}),v.wrapMethod("getItemModel",function(f,u){var m=f.parentModel,w=m.getGraph().getEdgeByIndex(u),b=w.node1.getLayout();if(b){var x=b.depth,z=m.levelModels[x];z&&(f.parentModel=z)}return f})}},n.prototype.setNodePosition=function(e,t){var c=this.option.data||this.option.nodes,p=c[e];p.localX=t[0],p.localY=t[1]},n.prototype.getGraph=function(){return this.getData().graph},n.prototype.getEdgeData=function(){return this.getGraph().edgeData},n.prototype.formatTooltip=function(e,t,c){function p(f){return isNaN(f)||f==null}if(c==="edge"){var r=this.getDataParams(e,c),i=r.data,o=r.value,h=i.source+" -- "+i.target;return bs("nameValue",{name:h,value:o,noValue:p(o)})}else{var _=this.getGraph().getNodeByIndex(e),y=_.getLayout().value,v=this.getDataParams(e,c).data.name;return bs("nameValue",{name:v!=null?v+"":null,value:y,noValue:p(y)})}},n.prototype.optionUpdated=function(){},n.prototype.getDataParams=function(e,t){var c=l.prototype.getDataParams.call(this,e,t);if(c.value==null&&t==="node"){var p=this.getGraph().getNodeByIndex(e),r=p.getLayout().value;c.value=r}return c},n.type="series.sankey",n.defaultOption={z:2,coordinateSystem:"view",left:"5%",top:"5%",right:"20%",bottom:"5%",orient:"horizontal",nodeWidth:20,nodeGap:8,draggable:!0,layoutIterations:32,label:{show:!0,position:"right",fontSize:12},edgeLabel:{show:!1,fontSize:12},levels:[],nodeAlign:"justify",lineStyle:{color:"#314656",opacity:.2,curveness:.5},emphasis:{label:{show:!0},lineStyle:{opacity:.5}},select:{itemStyle:{borderColor:"#212121"}},animationEasing:"linear",animationDuration:1e3},n})(_a);function Ua(l,n){l.eachSeriesByType("sankey",function(e){var t=e.get("nodeWidth"),c=e.get("nodeGap"),p=Za(e,n);e.layoutInfo=p;var r=p.width,i=p.height,o=e.getGraph(),h=o.nodes,_=o.edges;Qa(h);var y=ha(h,function(m){return m.getLayout().value===0}),v=y.length!==0?0:e.get("layoutIterations"),f=e.get("orient"),u=e.get("nodeAlign");Ja(h,_,t,c,r,i,v,f,u)})}function Za(l,n){return ua(l.getBoxLayoutParams(),{width:n.getWidth(),height:n.getHeight()})}function Ja(l,n,e,t,c,p,r,i,o){sn(l,n,e,c,p,i,o),ln(l,n,p,c,t,r,i),dn(l,i)}function Qa(l){k(l,function(n){var e=T(n.outEdges,X),t=T(n.inEdges,X),c=n.getValue()||0,p=Math.max(e,t,c);n.setLayout({value:p},!0)})}function sn(l,n,e,t,c,p,r){for(var i=[],o=[],h=[],_=[],y=0,v=0;v<n.length;v++)i[v]=1;for(var v=0;v<l.length;v++)o[v]=l[v].inEdges.length,o[v]===0&&h.push(l[v]);for(var f=-1;h.length;){for(var u=0;u<h.length;u++){var m=h[u],w=m.hostGraph.data.getRawDataItem(m.dataIndex),b=w.depth!=null&&w.depth>=0;b&&w.depth>f&&(f=w.depth),m.setLayout({depth:b?w.depth:y},!0),p==="vertical"?m.setLayout({dy:e},!0):m.setLayout({dx:e},!0);for(var x=0;x<m.outEdges.length;x++){var z=m.outEdges[x],E=n.indexOf(z);i[E]=0;var j=z.node2,L=l.indexOf(j);--o[L]===0&&_.indexOf(j)<0&&_.push(j)}}++y,h=_,_=[]}for(var v=0;v<i.length;v++)if(i[v]===1)throw new Error("Sankey is a DAG, the original data has cycle!");var S=f>y-1?f:y-1;r&&r!=="left"&&an(l,r,p,S);var O=p==="vertical"?(c-e)/S:(t-e)/S;en(l,O,p)}function Bs(l){var n=l.hostGraph.data.getRawDataItem(l.dataIndex);return n.depth!=null&&n.depth>=0}function an(l,n,e,t){if(n==="right"){for(var c=[],p=l,r=0;p.length;){for(var i=0;i<p.length;i++){var o=p[i];o.setLayout({skNodeHeight:r},!0);for(var h=0;h<o.inEdges.length;h++){var _=o.inEdges[h];c.indexOf(_.node1)<0&&c.push(_.node1)}}p=c,c=[],++r}k(l,function(y){Bs(y)||y.setLayout({depth:Math.max(0,t-y.getLayout().skNodeHeight)},!0)})}else n==="justify"&&nn(l,t)}function nn(l,n){k(l,function(e){!Bs(e)&&!e.outEdges.length&&e.setLayout({depth:n},!0)})}function en(l,n,e){k(l,function(t){var c=t.getLayout().depth*n;e==="vertical"?t.setLayout({y:c},!0):t.setLayout({x:c},!0)})}function ln(l,n,e,t,c,p,r){var i=tn(l,r);pn(i,n,e,t,c,r),cs(i,c,e,t,r);for(var o=1;p>0;p--)o*=.99,cn(i,o,r),cs(i,c,e,t,r),un(i,o,r),cs(i,c,e,t,r)}function tn(l,n){var e=[],t=n==="vertical"?"y":"x",c=da(l,function(p){return p.getLayout()[t]});return c.keys.sort(function(p,r){return p-r}),k(c.keys,function(p){e.push(c.buckets.get(p))}),e}function pn(l,n,e,t,c,p){var r=1/0;k(l,function(i){var o=i.length,h=0;k(i,function(y){h+=y.getLayout().value});var _=p==="vertical"?(t-(o-1)*c)/h:(e-(o-1)*c)/h;_<r&&(r=_)}),k(l,function(i){k(i,function(o,h){var _=o.getLayout().value*r;p==="vertical"?(o.setLayout({x:h},!0),o.setLayout({dx:_},!0)):(o.setLayout({y:h},!0),o.setLayout({dy:_},!0))})}),k(n,function(i){var o=+i.getValue()*r;i.setLayout({dy:o},!0)})}function cs(l,n,e,t,c){var p=c==="vertical"?"x":"y";k(l,function(r){r.sort(function(m,w){return m.getLayout()[p]-w.getLayout()[p]});for(var i,o,h,_=0,y=r.length,v=c==="vertical"?"dx":"dy",f=0;f<y;f++)o=r[f],h=_-o.getLayout()[p],h>0&&(i=o.getLayout()[p]+h,c==="vertical"?o.setLayout({x:i},!0):o.setLayout({y:i},!0)),_=o.getLayout()[p]+o.getLayout()[v]+n;var u=c==="vertical"?t:e;if(h=_-n-u,h>0){i=o.getLayout()[p]-h,c==="vertical"?o.setLayout({x:i},!0):o.setLayout({y:i},!0),_=i;for(var f=y-2;f>=0;--f)o=r[f],h=o.getLayout()[p]+o.getLayout()[v]+n-_,h>0&&(i=o.getLayout()[p]-h,c==="vertical"?o.setLayout({x:i},!0):o.setLayout({y:i},!0)),_=o.getLayout()[p]}})}function cn(l,n,e){k(l.slice().reverse(),function(t){k(t,function(c){if(c.outEdges.length){var p=T(c.outEdges,rn,e)/T(c.outEdges,X);if(isNaN(p)){var r=c.outEdges.length;p=r?T(c.outEdges,on,e)/r:0}if(e==="vertical"){var i=c.getLayout().x+(p-V(c,e))*n;c.setLayout({x:i},!0)}else{var o=c.getLayout().y+(p-V(c,e))*n;c.setLayout({y:o},!0)}}})})}function rn(l,n){return V(l.node2,n)*l.getValue()}function on(l,n){return V(l.node2,n)}function _n(l,n){return V(l.node1,n)*l.getValue()}function hn(l,n){return V(l.node1,n)}function V(l,n){return n==="vertical"?l.getLayout().x+l.getLayout().dx/2:l.getLayout().y+l.getLayout().dy/2}function X(l){return l.getValue()}function T(l,n,e){for(var t=0,c=l.length,p=-1;++p<c;){var r=+n(l[p],e);isNaN(r)||(t+=r)}return t}function un(l,n,e){k(l,function(t){k(t,function(c){if(c.inEdges.length){var p=T(c.inEdges,_n,e)/T(c.inEdges,X);if(isNaN(p)){var r=c.inEdges.length;p=r?T(c.inEdges,hn,e)/r:0}if(e==="vertical"){var i=c.getLayout().x+(p-V(c,e))*n;c.setLayout({x:i},!0)}else{var o=c.getLayout().y+(p-V(c,e))*n;c.setLayout({y:o},!0)}}})})}function dn(l,n){var e=n==="vertical"?"x":"y";k(l,function(t){t.outEdges.sort(function(c,p){return c.node2.getLayout()[e]-p.node2.getLayout()[e]}),t.inEdges.sort(function(c,p){return c.node1.getLayout()[e]-p.node1.getLayout()[e]})}),k(l,function(t){var c=0,p=0;k(t.outEdges,function(r){r.setLayout({sy:c},!0),c+=r.getLayout().dy}),k(t.inEdges,function(r){r.setLayout({ty:p},!0),p+=r.getLayout().dy})})}function fn(l){l.eachSeriesByType("sankey",function(n){var e=n.getGraph(),t=e.nodes,c=e.edges;if(t.length){var p=1/0,r=-1/0;k(t,function(i){var o=i.getLayout().value;o<p&&(p=o),o>r&&(r=o)}),k(t,function(i){var o=new Ia({type:"color",mappingMethod:"linear",dataExtent:[p,r],visual:n.get("color")}),h=o.mapValueToVisual(i.getLayout().value),_=i.getModel().get(["itemStyle","color"]);_!=null?(i.setVisual("color",_),i.setVisual("style",{fill:_})):(i.setVisual("color",h),i.setVisual("style",{fill:h}))})}c.length&&k(c,function(i){var o=i.getModel().get("lineStyle");i.setVisual("style",o)})})}function yn(l){l.registerChartView(Ya),l.registerSeriesModel(Xa),l.registerLayout(Ua),l.registerVisual(fn),l.registerAction({type:"dragNode",event:"dragnode",update:"update"},function(n,e){e.eachComponent({mainType:"series",subType:"sankey",query:n},function(t){t.setNodePosition(n.dataIndex,[n.localX,n.localY])})})}const mn="categorical",vn=12,gn=10,As=.4,wn=.1,W="5%",kn="10%",bn="(Blank)";function Fs(l,{tokens:n}){const e=l.data??[],t=[],c=new Set,p=new Map,r=_=>{c.has(_)||(c.add(_),t.push(_))},i=[];for(const _ of e){const y=Is(_[l.sourceColumn]),v=Is(_[l.targetColumn]),f=ga(_[l.valueColumn]);if(f===null||f<0||xn(p,v,y))continue;r(y),r(v);const u=p.get(y)??new Set;u.add(v),p.set(y,u),i.push({source:y,target:v,value:f,row:_})}const o=ba(l.palette,n,{fallback:mn,count:t.length}),h=new Map(t.map((_,y)=>[_,o[y]]));return{nodes:t.map(_=>({name:_,value:zn(_,i),color:h.get(_)})),links:i.map(_=>({..._,color:h.get(_.source)}))}}function xn(l,n,e){const t=[n],c=new Set;for(;t.length;){const p=t.pop();if(p===e)return!0;if(!c.has(p)){c.add(p);for(const r of l.get(p)??[])t.push(r)}}return!1}function zn(l,n){let e=0,t=0;for(const c of n)c.target===l&&(e+=c.value),c.source===l&&(t+=c.value);return Math.max(e,t)}function Is(l){return l==null||l===""?bn:String(l)}function jn(l,n){const{tokens:e,format:t}=n,c=Fs(l,n),p=l.orient==="vertical",r={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:ka},series:[{type:"sankey",name:l.valueColumn,orient:p?"vertical":"horizontal",nodeAlign:l.nodeAlign??"justify",top:W,bottom:W,left:W,right:p?W:kn,nodeWidth:vn,nodeGap:gn,draggable:!1,label:{show:!0,position:p?"top":"right",color:e.dataLabel,fontSize:va,formatter:i=>`${i.name} · ${Cn(Number(i.value),t)}`},emphasis:{focus:"adjacency"},blur:{itemStyle:{opacity:ps},lineStyle:{opacity:As*ps},label:{opacity:ps}},lineStyle:{color:"source",opacity:As,curveness:wn},data:c.nodes.map(i=>({name:i.name,value:i.value,itemStyle:{color:i.color,borderWidth:0}})),links:c.links.map(i=>({source:i.source,target:i.target,value:i.value}))}]};return za(r,l.echartOptions)}function Cn(l,n){return n?n(l):Ps(l,1,!0)}const Sn=["aria-label"],Dn={class:"sr-only",role:"status"},Ns=rs({__name:"SankeyChart",props:{title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},source:{},target:{},value:{},orient:{},nodeAlign:{},format:{type:Function},palette:{},echartOptions:{}},emits:["select"],setup(l,{expose:n,emit:e}){fa([yn]);const t=l,c=e,p=Cs(),r=M(()=>t.dir??Ca()),i=M(()=>({data:t.data,sourceColumn:t.source,targetColumn:t.target,valueColumn:t.value,orient:t.orient,nodeAlign:t.nodeAlign,palette:t.palette,echartOptions:t.echartOptions})),{tokens:o}=xa(p),h=M(()=>Fs(i.value,{tokens:o.value})),_=M(()=>!h.value.links.some(d=>d.value>0)),y=M(()=>{try{return{option:jn(i.value,{tokens:o.value,format:t.format}),error:null}}catch(d){return{option:void 0,error:d?.message??String(d)}}}),v=M(()=>y.value.error),f=Ss({x:0,y:0}),u=Ss({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:m,dispatch:w}=ya({container:p,option:()=>y.value.option,events:{mouseover:d=>x(d),mouseout:()=>u.open=!1,click:d=>{const g=b(d);g&&c("select",{source:g.source,target:g.target,value:g.value,row:g.row})}},onZrEvents:{mousemove:d=>{f.x=d.event?.clientX??f.x,f.y=d.event?.clientY??f.y,u.open&&(u.x=f.x,u.y=f.y)},globalout:()=>u.open=!1}});function b(d){if(d?.dataType==="edge")return h.value.links[d.dataIndex]}function x(d){const g=E(d);if(!g){u.open=!1;return}z(g,f.x,f.y)}function z(d,g,C){u.label=d.label,u.items=[{name:d.label,label:wa(t.value),color:d.color,value:d.value,formattedValue:t.format?t.format(d.value):Ps(d.value)}],u.x=g,u.y=C,u.open=!0}function E(d){const g=b(d);if(g)return{label:`${g.source} → ${g.target}`,color:g.color,value:g.value};const C=h.value.nodes[d?.dataIndex];if(!(d?.dataType!=="node"||!C))return{label:C.name,color:C.color,value:C.value}}const j=Cs("");function L(d){const g=h.value.links[d];if(!g)return;const C=Sa(p.value),R=`${g.source} → ${g.target}`;w({type:"highlight",seriesIndex:0,dataType:"edge",dataIndex:d}),z({label:R,color:g.color,value:g.value},C?.x??f.x,C?.y??f.y),j.value=Da(R,u.items.map(P=>({label:P.label,value:P.formattedValue})))}function S(d){d!==null&&w({type:"downplay",seriesIndex:0,dataType:"edge",dataIndex:d})}const $=ma({marks:()=>h.value.links,key:d=>`${d.source} ${d.target}`,move:(d,g)=>{S(g),L(d)},activate:d=>{const g=h.value.links[d];g&&c("select",{source:g.source,target:g.target,value:g.value,row:g.row})},clear:d=>{S(d),u.open=!1,j.value=""}}).attrs;return n({chart:M(()=>m.value)}),(d,g)=>(U(),Oa(Ea,{title:l.title,subtitle:l.subtitle,loading:l.loading,error:l.error||v.value,empty:_.value,dir:r.value},xs({default:D(()=>[s("div",Ra({ref_key:"plotEl",ref:p,class:"h-full w-full rounded-2 focus-visible:focus-ring",dir:"ltr",role:"img","aria-label":K(ja)(l.title,l.subtitle)},K($)),null,16,Sn),s("span",Dn,Pa(j.value),1),A(La,{open:u.open,x:u.x,y:u.y,label:u.label,items:u.items,dir:r.value},xs({_:2},[d.$slots.tooltip?{name:"default",fn:D(C=>[G(d.$slots,"tooltip",zs(js(C)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[d.$slots.actions?{name:"actions",fn:D(()=>[G(d.$slots,"actions")]),key:"0"}:void 0,d.$slots.loading?{name:"loading",fn:D(()=>[G(d.$slots,"loading")]),key:"1"}:void 0,d.$slots.error?{name:"error",fn:D(C=>[G(d.$slots,"error",zs(js(C)))]),key:"2"}:void 0,d.$slots.empty?{name:"empty",fn:D(()=>[G(d.$slots,"empty")]),key:"3"}:void 0]),1032,["title","subtitle","loading","error","empty","dir"]))}}),En={class:"h-96 w-full"},Ln=rs({__name:"SankeySpend",setup(l){const n=[{service:"Compute",team:"Product",amount:320},{service:"Compute",team:"Data",amount:180},{service:"Storage",team:"Product",amount:90},{service:"Storage",team:"Data",amount:240},{service:"Network",team:"Product",amount:60},{service:"Network",team:"Support",amount:40}],e=t=>`$${t}K`;return(t,c)=>(U(),os("div",En,[A(K(Ns),{data:n,source:"service",target:"team",value:"amount",orient:"vertical",format:e,title:"Infrastructure spend",subtitle:"Service to team, this month"})]))}}),An={class:"h-80 w-full"},In=rs({__name:"SankeySignups",setup(l){const n=[{from:"Organic search",to:"Free trial",users:4200},{from:"Paid ads",to:"Free trial",users:2600},{from:"Referral",to:"Free trial",users:1800},{from:"Partner",to:"Sales demo",users:900},{from:"Free trial",to:"Paid plan",users:2100},{from:"Free trial",to:"Lapsed",users:6500},{from:"Sales demo",to:"Paid plan",users:640},{from:"Sales demo",to:"Lapsed",users:260}];return(e,t)=>(U(),os("div",An,[A(K(Ns),{data:n,source:"from",target:"to",value:"users",title:"Signup flow",subtitle:"Acquisition channel to outcome, last quarter"})]))}}),Zn=JSON.parse('{"title":"SankeyChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/sankeychart.md","filePath":"docs/charts/sankeychart.md","lastUpdated":0}'),On={name:"docs/charts/sankeychart.md"},Jn=Object.assign(On,{setup(l){const n=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
chart that fails to draw sets its own; this is for a failed request.`,required:!1,type:"string | null"},{name:"data",description:"One row per flow, i.e. one band from a source node to a target node.",required:!0,type:"Record<string, any>[]"},{name:"source",description:"Row key holding the node a flow leaves.",required:!0,type:"string"},{name:"target",description:"Row key holding the node a flow arrives at.",required:!0,type:"string"},{name:"value",description:"Row key holding how much flows along the link.",required:!0,type:"string"},{name:"orient",description:"Defaults to `'horizontal'`: the flow runs left to right.",required:!1,type:"SankeyOrient"},{name:"nodeAlign",description:"Where a node sits along the flow. Defaults to `'justify'`.",required:!1,type:"SankeyNodeAlign"},{name:"format",description:"Prints every number the flow shows, i.e. what a band or node carries.",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'categorical'`: nodes are unrelated categories.",required:!1,type:"ChartPalette"},{name:"echartOptions",description:"Escape hatch: deep-merged into the echarts option the props built.",required:!1,type:"EchartOptionsOverride"}],e=[{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"},{name:"actions",description:"",type:"any"},{name:"tooltip",description:"Replaces the tooltip body. `items` holds the hovered band or node alone.",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"}],t=[{name:"select",description:`A band was selected, by click or by Enter on the keyboard cursor. Carries
its two nodes and the row behind it. A node emits nothing: it stands for
every row that passes through it, not one.`,type:"[event: SankeyLinkEvent]"}];return(c,p)=>{const r=Ds("ComponentPreview"),i=Ds("ClientOnly");return U(),os("div",null,[p[3]||(p[3]=Es('<h1 id="sankeychart" tabindex="-1">SankeyChart <a class="header-anchor" href="#sankeychart" aria-label="Permalink to “SankeyChart”">​</a></h1><p>A flow from one set of nodes to another, a band per row.</p><h2 id="flow-between-two-columns" tabindex="-1">Flow between two columns <a class="header-anchor" href="#flow-between-two-columns" aria-label="Permalink to “Flow between two columns”">​</a></h2><p><code>source</code>, <code>target</code> and <code>value</code> name the three columns a flow needs, so the data is one row per band. The nodes are the de-duplicated union of the source and target columns: a node that a row sends flow to and another row sends flow from sits between the two, which is how a multi-stage flow is drawn. <code>select</code> carries the row behind the band.</p>',4)),A(i,null,{default:D(()=>[A(r,{name:"Charts-SankeySignups","self-layout":""},{code:D(()=>[...p[0]||(p[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:D(()=>[A(In)]),_:1})]),_:1}),p[4]||(p[4]=Es('<h2 id="vertical-flow" tabindex="-1">Vertical flow <a class="header-anchor" href="#vertical-flow" aria-label="Permalink to “Vertical flow”">​</a></h2><p><code>orient=&quot;vertical&quot;</code> turns the flow downwards, which suits a tall card or a graph with few stages. <code>format</code> prints every value the chart shows, on the node labels and in the tooltip alike. <code>nodeAlign</code> decides where a node with nothing leaving it sits: <code>justify</code> pushes it to the far end, <code>left</code> and <code>right</code> pin it to the end they name.</p>',2)),A(i,null,{default:D(()=>[A(r,{name:"Charts-SankeySpend","self-layout":""},{code:D(()=>[...p[1]||(p[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"SankeyChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),A(Ws,{data:e}),A(Ys,{data:t})])}}});export{Zn as __pageData,Jn as default};
