import{_ as k}from"./chunks/PropsTable.1FSSKic4.js";import{_ as g}from"./chunks/SlotsTable.DZTRCr_n.js";import{_ as z}from"./chunks/EmitsTable.Do_wdo52.js";import"./chunks/theme.B0ErLTiK.js";import{_ as y}from"./chunks/DonutChart.vue_vue_type_script_setup_true_lang.DRp1gCYS.js";import{I as f,ad as i,r as _,D as l,aE as m,o as s,F as w,B as a,au as d,aj as x,ao as b,A as v,bh as p}from"./chunks/framework.BLQjXmDz.js";import"./chunks/useChart.DGMc8AC9.js";import"./chunks/tokens.CicM4eNQ.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/usePlotKeyboard.ORhk1mR_.js";import"./chunks/axisChartCommon.B19qJ_gs.js";import"./chunks/format.DCkvHwNc.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.B60cxBUm.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.SpZ2Hb4o.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.BzKrPzFe.js";const j={class:"h-80 w-full"},C=f({__name:"DonutHalf",setup(o){const c=[{plan:"Starter",subscriptions:1180},{plan:"Plus",subscriptions:962},{plan:"Pro",subscriptions:418}];return(e,t)=>(i(),_("div",j,[l(m(y),{data:c,category:"plan",value:"subscriptions",variant:"half",palette:"sequential","show-inline-labels":"",title:"Plan mix",subtitle:"Active subscriptions, July 2026"})]))}}),S={class:"flex h-96 w-full flex-col gap-2"},O={class:"min-h-0 flex-1"},D={class:"text-p-sm text-ink-gray-5"},A=f({__name:"DonutOthers",setup(o){const c=[{channel:"Organic search",sessions:39900},{channel:"Paid social",sessions:21400},{channel:"Email",sessions:16800},{channel:"Direct",sessions:14700},{channel:"Referral & affiliate",sessions:8900},{channel:"Marketplace",sessions:4500},{channel:"Events",sessions:3110},{channel:"Print",sessions:1490}],e=x(null);return(t,r)=>(i(),_("div",S,[s("div",O,[l(m(y),{data:c,category:"channel",value:"sessions","max-slices":4,"center-label":"sessions",title:"Traffic by channel",subtitle:"Sessions in July 2026",onSelect:r[0]||(r[0]=n=>e.value=n)})]),s("p",D,[e.value?(i(),_(w,{key:0},[a(" Selected "+d(e.value.name)+" · "+d(Math.round(e.value.percent))+"% · "+d(e.value.rows.length)+" row(s) behind it ",1)],64)):(i(),_(w,{key:1},[a("Select a slice — Others carries every row it groups.")],64))])]))}}),P={class:"h-80 w-full"},R=f({__name:"DonutShare",setup(o){const c=[{type:"Attachments",gigabytes:812},{type:"Backups",gigabytes:604},{type:"Images",gigabytes:337},{type:"Logs",gigabytes:149},{type:"Everything else",gigabytes:62}],e=t=>t>=1024?`${(t/1024).toFixed(1)} TB`:`${t} GB`;return(t,r)=>(i(),_("div",P,[l(m(y),{data:c,category:"type",value:"gigabytes","center-label":"stored",format:e,title:"Storage by file type",subtitle:"Across every workspace"})]))}}),U=JSON.parse('{"title":"DonutChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/donutchart.md","filePath":"docs/charts/donutchart.md","lastUpdated":0}'),E={name:"docs/charts/donutchart.md"},J=Object.assign(E,{setup(o){const c=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(g,{data:e}),l(z,{data:t})])}}});export{U as __pageData,J as default};
