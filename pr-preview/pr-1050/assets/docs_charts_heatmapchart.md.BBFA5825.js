import{_ as k}from"./chunks/PropsTable.1FSSKic4.js";import{_ as b}from"./chunks/SlotsTable.DZTRCr_n.js";import{_ as g}from"./chunks/EmitsTable.Do_wdo52.js";import"./chunks/theme.B0ErLTiK.js";import{_ as v}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.H0yT8PaF.js";import{I as w,ad as u,r as m,D as l,aE as h,ao as y,A as z,bh as c,o as s,B as a}from"./chunks/framework.BLQjXmDz.js";import"./chunks/useChart.DGMc8AC9.js";import"./chunks/tokens.CicM4eNQ.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/usePlotKeyboard.ORhk1mR_.js";import"./chunks/axisChartCommon.B19qJ_gs.js";import"./chunks/format.DCkvHwNc.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.B60cxBUm.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.BzKrPzFe.js";const x={class:"h-72 w-full"},j=w({__name:"HeatmapDemand",setup(f){const i=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],r=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],o=[8,52,38,34,20,15,20,9],n=r.flatMap((e,p)=>e.map((t,d)=>({day:_[p],hour:i[d],deviation:Math.round((t-o[d])/o[d]*100)})));return(e,p)=>(u(),m("div",x,[l(h(v),{data:h(n),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:t=>`${t>0?"+":""}${t}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),C={class:"h-72 w-full"},S=w({__name:"HeatmapTickets",setup(f){const i=["9am","11am","1pm","3pm","5pm","7pm"],_=["Mon","Tue","Wed","Thu","Fri"],r=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],o=_.flatMap((n,e)=>i.map((p,t)=>({day:n,hour:p,tickets:r[e][t]})));return(n,e)=>(u(),m("div",C,[l(h(v),{data:h(o),x:"hour",y:"day",value:"tickets","show-values":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),W=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmapchart.md","filePath":"docs/charts/heatmapchart.md","lastUpdated":0}'),O={name:"docs/charts/heatmapchart.md"},M=Object.assign(O,{setup(f){const i=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:_}),l(g,{data:r})])}}});export{W as __pageData,M as default};
