import{_ as ss}from"./chunks/PropsTable.1FSSKic4.js";import{_ as as}from"./chunks/SlotsTable.DZTRCr_n.js";import{_ as ns}from"./chunks/EmitsTable.Do_wdo52.js";import{bl as ls}from"./chunks/theme.B0ErLTiK.js";import{r as es,u as ps}from"./chunks/useChart.DGMc8AC9.js";import{u as ts}from"./chunks/usePlotKeyboard.ORhk1mR_.js";import{B as O,D as cs,t as is}from"./chunks/axisChartCommon.B19qJ_gs.js";import{d as M,a as rs}from"./chunks/format.DCkvHwNc.js";import{C as _s,c as os,u as hs}from"./chunks/tokens.CicM4eNQ.js";import{b as us,c as ds,d as fs,e as ys,p as ms}from"./chunks/utils.BIjrxRCb.js";import{_ as ws}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.B60cxBUm.js";import{_ as vs}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.BzKrPzFe.js";import{I as A,l as k,ad as C,p as ks,z as I,bh as f,an as g,a1 as F,L as q,o as s,Z as bs,aE as j,au as gs,D as m,aj as B,ag as V,r as P,ao as $,A as W,B as a}from"./chunks/framework.BLQjXmDz.js";const zs="categorical",xs=12,js=10,H=.4,Cs=.1,x="5%",Ss="10%",Os="(Blank)";function K(l,{tokens:r}){const h=l.data??[],p=[],o=new Set,e=new Map,y=_=>{o.has(_)||(o.add(_),p.push(_))},i=[];for(const _ of h){const w=G(_[l.sourceColumn]),b=G(_[l.targetColumn]),u=is(_[l.valueColumn]);if(u===null||u<0||As(e,b,w))continue;y(w),y(b);const c=e.get(w)??new Set;c.add(b),e.set(w,c),i.push({source:w,target:b,value:u,row:_})}const z=os(l.palette,r,{fallback:zs,count:p.length}),v=new Map(p.map((_,w)=>[_,z[w]]));return{nodes:p.map(_=>({name:_,value:Ps(_,i),color:v.get(_)})),links:i.map(_=>({..._,color:v.get(_.source)}))}}function As(l,r,h){const p=[r],o=new Set;for(;p.length;){const e=p.pop();if(e===h)return!0;if(!o.has(e)){o.add(e);for(const y of l.get(e)??[])p.push(y)}}return!1}function Ps(l,r){let h=0,p=0;for(const o of r)o.target===l&&(h+=o.value),o.source===l&&(p+=o.value);return Math.max(h,p)}function G(l){return l==null||l===""?Os:String(l)}function Rs(l,r){const{tokens:h,format:p}=r,o=K(l,r),e=l.orient==="vertical",y={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:_s},series:[{type:"sankey",name:l.valueColumn,orient:e?"vertical":"horizontal",nodeAlign:l.nodeAlign??"justify",top:x,bottom:x,left:x,right:e?x:Ss,nodeWidth:xs,nodeGap:js,draggable:!1,label:{show:!0,position:e?"top":"right",color:h.dataLabel,fontSize:cs,formatter:i=>`${i.name} · ${Ds(Number(i.value),p)}`},emphasis:{focus:"adjacency"},blur:{itemStyle:{opacity:O},lineStyle:{opacity:H*O},label:{opacity:O}},lineStyle:{color:"source",opacity:H,curveness:Cs},data:o.nodes.map(i=>({name:i.name,value:i.value,itemStyle:{color:i.color,borderWidth:0}})),links:o.links.map(i=>({source:i.source,target:i.target,value:i.value}))}]};return us(y,l.echartOptions)}function Ds(l,r){return r?r(l):M(l,1,!0)}const Es=["aria-label"],Ts={class:"sr-only",role:"status"},Y=A({__name:"SankeyChart",props:{title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},source:{},target:{},value:{},orient:{},nodeAlign:{},format:{type:Function},palette:{},echartOptions:{}},emits:["select"],setup(l,{expose:r,emit:h}){es([ls]);const p=l,o=h,e=B(),y=k(()=>p.dir??fs()),i=k(()=>({data:p.data,sourceColumn:p.source,targetColumn:p.target,valueColumn:p.value,orient:p.orient,nodeAlign:p.nodeAlign,palette:p.palette,echartOptions:p.echartOptions})),{tokens:z}=hs(e),v=k(()=>K(i.value,{tokens:z.value})),_=k(()=>!v.value.links.some(n=>n.value>0)),w=k(()=>{try{return{option:Rs(i.value,{tokens:z.value,format:p.format}),error:null}}catch(n){return{option:void 0,error:n?.message??String(n)}}}),b=k(()=>w.value.error),u=V({x:0,y:0}),c=V({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:U,dispatch:R}=ps({container:e,option:()=>w.value.option,events:{mouseover:n=>X(n),mouseout:()=>c.open=!1,click:n=>{const t=D(n);t&&o("select",{source:t.source,target:t.target,value:t.value,row:t.row})}},onZrEvents:{mousemove:n=>{u.x=n.event?.clientX??u.x,u.y=n.event?.clientY??u.y,c.open&&(c.x=u.x,c.y=u.y)},globalout:()=>c.open=!1}});function D(n){if(n?.dataType==="edge")return v.value.links[n.dataIndex]}function X(n){const t=Z(n);if(!t){c.open=!1;return}E(t,u.x,u.y)}function E(n,t,d){c.label=n.label,c.items=[{name:n.label,label:rs(p.value),color:n.color,value:n.value,formattedValue:p.format?p.format(n.value):M(n.value)}],c.x=t,c.y=d,c.open=!0}function Z(n){const t=D(n);if(t)return{label:`${t.source} → ${t.target}`,color:t.color,value:t.value};const d=v.value.nodes[n?.dataIndex];if(!(n?.dataType!=="node"||!d))return{label:d.name,color:d.color,value:d.value}}const S=B("");function J(n){const t=v.value.links[n];if(!t)return;const d=ys(e.value),L=`${t.source} → ${t.target}`;R({type:"highlight",seriesIndex:0,dataType:"edge",dataIndex:n}),E({label:L,color:t.color,value:t.value},d?.x??u.x,d?.y??u.y),S.value=ms(L,c.items.map(N=>({label:N.label,value:N.formattedValue})))}function T(n){n!==null&&R({type:"downplay",seriesIndex:0,dataType:"edge",dataIndex:n})}const Q=ts({marks:()=>v.value.links,key:n=>`${n.source} ${n.target}`,move:(n,t)=>{T(t),J(n)},activate:n=>{const t=v.value.links[n];t&&o("select",{source:t.source,target:t.target,value:t.value,row:t.row})},clear:n=>{T(n),c.open=!1,S.value=""}}).attrs;return r({chart:k(()=>U.value)}),(n,t)=>(C(),ks(ws,{title:l.title,subtitle:l.subtitle,loading:l.loading,error:l.error||b.value,empty:_.value,dir:y.value},I({default:f(()=>[s("div",bs({ref_key:"plotEl",ref:e,class:"h-full w-full rounded-2 focus-visible:focus-ring",dir:"ltr",role:"img","aria-label":j(ds)(l.title,l.subtitle)},j(Q)),null,16,Es),s("span",Ts,gs(S.value),1),m(vs,{open:c.open,x:c.x,y:c.y,label:c.label,items:c.items,dir:y.value},I({_:2},[n.$slots.tooltip?{name:"default",fn:f(d=>[g(n.$slots,"tooltip",F(q(d)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[n.$slots.actions?{name:"actions",fn:f(()=>[g(n.$slots,"actions")]),key:"0"}:void 0,n.$slots.loading?{name:"loading",fn:f(()=>[g(n.$slots,"loading")]),key:"1"}:void 0,n.$slots.error?{name:"error",fn:f(d=>[g(n.$slots,"error",F(q(d)))]),key:"2"}:void 0,n.$slots.empty?{name:"empty",fn:f(()=>[g(n.$slots,"empty")]),key:"3"}:void 0]),1032,["title","subtitle","loading","error","empty","dir"]))}}),Ls={class:"h-96 w-full"},Ns=A({__name:"SankeySpend",setup(l){const r=[{service:"Compute",team:"Product",amount:320},{service:"Compute",team:"Data",amount:180},{service:"Storage",team:"Product",amount:90},{service:"Storage",team:"Data",amount:240},{service:"Network",team:"Product",amount:60},{service:"Network",team:"Support",amount:40}],h=p=>`$${p}K`;return(p,o)=>(C(),P("div",Ls,[m(j(Y),{data:r,source:"service",target:"team",value:"amount",orient:"vertical",format:h,title:"Infrastructure spend",subtitle:"Service to team, this month"})]))}}),Is={class:"h-80 w-full"},Fs=A({__name:"SankeySignups",setup(l){const r=[{from:"Organic search",to:"Free trial",users:4200},{from:"Paid ads",to:"Free trial",users:2600},{from:"Referral",to:"Free trial",users:1800},{from:"Partner",to:"Sales demo",users:900},{from:"Free trial",to:"Paid plan",users:2100},{from:"Free trial",to:"Lapsed",users:6500},{from:"Sales demo",to:"Paid plan",users:640},{from:"Sales demo",to:"Lapsed",users:260}];return(h,p)=>(C(),P("div",Is,[m(j(Y),{data:r,source:"from",target:"to",value:"users",title:"Signup flow",subtitle:"Acquisition channel to outcome, last quarter"})]))}}),sa=JSON.parse('{"title":"SankeyChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/sankeychart.md","filePath":"docs/charts/sankeychart.md","lastUpdated":0}'),qs={name:"docs/charts/sankeychart.md"},aa=Object.assign(qs,{setup(l){const r=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
chart that fails to draw sets its own; this is for a failed request.`,required:!1,type:"string | null"},{name:"data",description:"One row per flow, i.e. one band from a source node to a target node.",required:!0,type:"Record<string, any>[]"},{name:"source",description:"Row key holding the node a flow leaves.",required:!0,type:"string"},{name:"target",description:"Row key holding the node a flow arrives at.",required:!0,type:"string"},{name:"value",description:"Row key holding how much flows along the link.",required:!0,type:"string"},{name:"orient",description:"Defaults to `'horizontal'`: the flow runs left to right.",required:!1,type:"SankeyOrient"},{name:"nodeAlign",description:"Where a node sits along the flow. Defaults to `'justify'`.",required:!1,type:"SankeyNodeAlign"},{name:"format",description:"Prints every number the flow shows, i.e. what a band or node carries.",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'categorical'`: nodes are unrelated categories.",required:!1,type:"ChartPalette"},{name:"echartOptions",description:"Escape hatch: deep-merged into the echarts option the props built.",required:!1,type:"EchartOptionsOverride"}],h=[{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"},{name:"actions",description:"",type:"any"},{name:"tooltip",description:"Replaces the tooltip body. `items` holds the hovered band or node alone.",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"}],p=[{name:"select",description:`A band was selected, by click or by Enter on the keyboard cursor. Carries
its two nodes and the row behind it. A node emits nothing: it stands for
every row that passes through it, not one.`,type:"[event: SankeyLinkEvent]"}];return(o,e)=>{const y=$("ComponentPreview"),i=$("ClientOnly");return C(),P("div",null,[e[3]||(e[3]=W('<h1 id="sankeychart" tabindex="-1">SankeyChart <a class="header-anchor" href="#sankeychart" aria-label="Permalink to “SankeyChart”">​</a></h1><p>A flow from one set of nodes to another, a band per row.</p><h2 id="flow-between-two-columns" tabindex="-1">Flow between two columns <a class="header-anchor" href="#flow-between-two-columns" aria-label="Permalink to “Flow between two columns”">​</a></h2><p><code>source</code>, <code>target</code> and <code>value</code> name the three columns a flow needs, so the data is one row per band. The nodes are the de-duplicated union of the source and target columns: a node that a row sends flow to and another row sends flow from sits between the two, which is how a multi-stage flow is drawn. <code>select</code> carries the row behind the band.</p>',4)),m(i,null,{default:f(()=>[m(y,{name:"Charts-SankeySignups","self-layout":""},{code:f(()=>[...e[0]||(e[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:f(()=>[m(Fs)]),_:1})]),_:1}),e[4]||(e[4]=W('<h2 id="vertical-flow" tabindex="-1">Vertical flow <a class="header-anchor" href="#vertical-flow" aria-label="Permalink to “Vertical flow”">​</a></h2><p><code>orient=&quot;vertical&quot;</code> turns the flow downwards, which suits a tall card or a graph with few stages. <code>format</code> prints every value the chart shows, on the node labels and in the tooltip alike. <code>nodeAlign</code> decides where a node with nothing leaving it sits: <code>justify</code> pushes it to the far end, <code>left</code> and <code>right</code> pin it to the end they name.</p>',2)),m(i,null,{default:f(()=>[m(y,{name:"Charts-SankeySpend","self-layout":""},{code:f(()=>[...e[1]||(e[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"SankeyChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),m(as,{data:h}),m(ns,{data:p})])}}});export{sa as __pageData,aa as default};
