import{_ as L}from"./chunks/PropsTable.vue_vue_type_script_setup_true_lang.BEZl6rQP.js";import{_ as R}from"./chunks/SlotsTable.vue_vue_type_script_setup_true_lang.D7WVhACa.js";import{_ as H}from"./chunks/EmitsTable.vue_vue_type_script_setup_true_lang.S_T_EtTv.js";import{n as c,o as T,p as O,g as C,_ as N}from"./chunks/theme.BaRPaen_.js";import{d as E,i as h,o as S,c as q,U as p,f as l,S as t,a as s,n as w,b as G,t as W,e as I,v as D,a6 as a,ag as K}from"./chunks/framework.hPdjLxPM.js";const J={class:"grid w-full max-w-3xl grid-cols-1 gap-6"},Q=["onClick"],X=["onClick"],Z=["onClick"],ss=["onClick"],as=["onClick"],ns=["onClick"],ls=["onClick"],ps=["onClick"],es=["onClick"],cs={class:"flex flex-col leading-tight"},ts={class:"text-ink-gray-9"},is=["onClick"],_s={class:"flex flex-col leading-tight"},rs={class:"text-ink-gray-9"},Y="w-full rounded px-2 py-1.5 text-left text-base hover:bg-surface-gray-2",os=E({__name:"Range",setup(U){const u=c().format("YYYY-MM-DD"),g=c().add(1,"year").format("YYYY-MM-DD"),z=h([]),x=h([]),v=h([c().subtract(29,"day").format("YYYY-MM-DD"),c().format("YYYY-MM-DD")]);function P(){const m=j(5);return[m,m.add(2,"day")]}function M(){const m=j(1);return[m,m.add(4,"day")]}function j(m){const e=c(),_=(m-e.day()+7)%7||7;return e.add(_,"day")}function y(m){return[c().subtract(m-1,"day"),c()]}const b=h([]),n=c().add(60,"day").format("YYYY-MM-DD");function o(m){const e=m.day();return e===0||e===6}const f=h([]),A=I(()=>f.value[0]?c(f.value[0]).format("ddd, MMM D"):""),V=I(()=>f.value[1]?c(f.value[1]).format("ddd, MMM D"):"");return(m,e)=>(S(),q("div",J,[p(l(T),{modelValue:z.value,"onUpdate:modelValue":e[0]||(e[0]=_=>z.value=_),label:"Time off",placeholder:"Pick your dates",min:l(u)},{prefix:t(()=>[...e[5]||(e[5]=[s("span",{class:"lucide-palmtree size-4 text-ink-gray-5","aria-hidden":"true"},null,-1)])]),actions:t(({setRange:_,close:d})=>[s("button",{type:"button",class:w(Y),onClick:()=>{_(P()),d()}}," Long weekend ",8,Q),s("button",{type:"button",class:w(Y),onClick:()=>{_(M()),d()}}," Next week ",8,X)]),_:1},8,["modelValue","min"]),p(l(T),{modelValue:x.value,"onUpdate:modelValue":e[1]||(e[1]=_=>x.value=_),label:"Check-in / Check-out",placeholder:"Select your stay","dual-pane":"",min:l(u),max:l(g)},{prefix:t(()=>[...e[6]||(e[6]=[s("span",{class:"lucide-hotel size-4 text-ink-gray-5","aria-hidden":"true"},null,-1)])]),_:1},8,["modelValue","min","max"]),p(l(T),{modelValue:v.value,"onUpdate:modelValue":e[2]||(e[2]=_=>v.value=_),label:"Report range",description:"Defaults to the last 30 days.",format:"MMM D",max:l(u)},{prefix:t(()=>[...e[7]||(e[7]=[s("span",{class:"lucide-chart-line size-4 text-ink-gray-5","aria-hidden":"true"},null,-1)])]),actions:t(({fromDate:_,toDate:d,setRange:i,clear:r,close:k})=>[s("button",{type:"button",class:w(Y),onClick:()=>{i([l(c)(),l(c)()]),k()}}," Today ",8,Z),s("button",{type:"button",class:w(Y),onClick:()=>{i(y(7)),k()}}," Last 7 days ",8,ss),s("button",{type:"button",class:w(Y),onClick:()=>{i(y(28)),k()}}," Last 4 weeks ",8,as),s("button",{type:"button",class:w(Y),onClick:()=>{i(y(90)),k()}}," Last 3 months ",8,ns),s("button",{type:"button",class:w(Y),onClick:()=>{i(y(365)),k()}}," Last 12 months ",8,ls),e[8]||(e[8]=s("hr",{class:"my-1 border-outline-gray-2"},null,-1)),_||d?(S(),q("button",{key:0,type:"button",class:w(Y),onClick:()=>{r(),k()}}," Clear ",8,ps)):G("",!0)]),_:1},8,["modelValue","max"]),p(l(T),{modelValue:b.value,"onUpdate:modelValue":e[3]||(e[3]=_=>b.value=_),label:"Sprint window",description:"Pick start and end. Weekends are skipped.",min:l(u),max:l(n),"is-date-unavailable":o},{prefix:t(()=>[...e[9]||(e[9]=[s("span",{class:"lucide-timer-reset size-4 text-ink-gray-5","aria-hidden":"true"},null,-1)])]),_:1},8,["modelValue","min","max"]),p(l(T),{modelValue:f.value,"onUpdate:modelValue":e[4]||(e[4]=_=>f.value=_),"dual-pane":"",min:l(u)},{trigger:t(({togglePopover:_,isOpen:d})=>[s("div",{class:w(["grid grid-cols-2 divide-x divide-outline-gray-2 rounded border bg-surface-white text-sm transition-colors",d?"border-outline-gray-4 ring-2 ring-outline-gray-2":"border-outline-gray-2 hover:border-outline-gray-3"])},[s("button",{type:"button",class:"flex items-center gap-2 rounded-l px-3 py-2 text-left hover:bg-surface-gray-1",onClick:_},[e[11]||(e[11]=s("span",{class:"lucide-plane-takeoff size-4 text-ink-gray-5","aria-hidden":"true"},null,-1)),s("div",cs,[e[10]||(e[10]=s("span",{class:"text-xs text-ink-gray-5"},"Depart",-1)),s("span",ts,W(A.value||"Add date"),1)])],8,es),s("button",{type:"button",class:"flex items-center gap-2 rounded-r px-3 py-2 text-left hover:bg-surface-gray-1",onClick:_},[e[13]||(e[13]=s("span",{class:"lucide-plane-landing size-4 text-ink-gray-5","aria-hidden":"true"},null,-1)),s("div",_s,[e[12]||(e[12]=s("span",{class:"text-xs text-ink-gray-5"},"Return",-1)),s("span",rs,W(V.value||"Add date"),1)])],8,is)],2)]),_:1},8,["modelValue","min"])]))}}),ds={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M16 14v2.2l1.6 1" /><path d="M16 2v4" /><path d="M21 7.5V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h3.5" /><path d="M3 10h5" /><path d="M8 2v4" /><circle cx="16" cy="16" r="6" />'})}},hs={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<rect width="20" height="8" x="2" y="2" rx="2" ry="2" /><rect width="20" height="8" x="2" y="14" rx="2" ry="2" /><line x1="6" x2="6.01" y1="6" y2="6" /><line x1="6" x2="6.01" y1="18" y2="18" />'})}},B={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M12 15v5s3.03-.55 4-2c1.08-1.62 0-5 0-5" /><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09" /><path d="M9 12a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.4 22.4 0 0 1-4 2z" /><path d="M9 12H4s.55-3.03 2-4c1.62-1.08 5 .05 5 .05" />'})}},us={class:"grid w-full max-w-2xl grid-cols-1 gap-6"},ms=["onClick"],ws=["onClick"],fs=["onClick"],F="w-full rounded px-2 py-1.5 text-left text-base hover:bg-surface-gray-2",ys=E({__name:"DateTime",setup(U){const u=c(),g=u.minute(u.minute()<30?30:60).second(0).format("YYYY-MM-DD HH:mm:ss"),z=h(g),x=u.format("YYYY-MM-DD HH:mm:ss"),v=h(""),P=c().add(1,"day").startOf("day").format("YYYY-MM-DD HH:mm:ss"),M=c().add(60,"day").endOf("day").format("YYYY-MM-DD HH:mm:ss"),j=h("");function y(){const b=c(),n=(5-b.day()+7)%7||7;return b.add(n,"day").hour(0).minute(0).second(0)}return(b,n)=>(S(),q("div",us,[p(l(O),{modelValue:z.value,"onUpdate:modelValue":n[0]||(n[0]=o=>z.value=o),label:"Meeting time",placeholder:"When should we meet?",min:l(x),format:"ddd, MMM D · h:mm A"},{prefix:t(()=>[p(l(ds),{class:"size-4 text-ink-gray-5"})]),_:1},8,["modelValue","min"]),p(l(O),{modelValue:v.value,"onUpdate:modelValue":n[1]||(n[1]=o=>v.value=o),label:"Maintenance window",description:"Must be scheduled at least 24 hours in advance.",placeholder:"Pick a low-traffic time",min:l(P),max:l(M)},{prefix:t(()=>[p(l(hs),{class:"size-4 text-ink-gray-5"})]),_:1},8,["modelValue","min","max"]),p(l(O),{modelValue:j.value,"onUpdate:modelValue":n[2]||(n[2]=o=>j.value=o),label:"Launch moment",placeholder:"When do we light the candle?",format:"MMMM D, YYYY [at] h:mm A",variant:"outline"},{prefix:t(()=>[p(l(B),{class:"size-4 text-ink-gray-5"})]),actions:t(({setDate:o,close:f})=>[s("button",{type:"button",class:w(F),onClick:()=>{o(l(c)().add(1,"day").hour(12).minute(0)),f()}}," High noon ",8,ms),s("button",{type:"button",class:w(F),onClick:()=>{o(y()),f()}}," Midnight Friday ",8,ws),s("button",{type:"button",class:w(F),onClick:()=>{o(l(c)().add(1,"day").hour(6).minute(15)),f()}}," Sunrise ",8,fs)]),_:1},8,["modelValue"])]))}}),ks={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M17.8 19.2 16 11l3.5-3.5C21 6 21.5 4 21 3c-1-.5-3 0-4.5 1.5L13 8 4.8 6.2c-.5-.1-.9.1-1.1.5l-.3.5c-.2.5-.1 1 .3 1.3L9 12l-2 3H4l-1 1 3 2 2 3 1-1v-3l3-2 3.5 5.3c.3.4.8.5 1.3.3l.5-.2c.4-.3.6-.7.5-1.2z" />'})}},gs={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M20 21v-8a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8" /><path d="M4 16s.5-1 2-1 2.5 2 4 2 2.5-2 4-2 2.5 2 4 2 2-1 2-1" /><path d="M2 21h20" /><path d="M7 8v3" /><path d="M12 8v3" /><path d="M17 8v3" /><path d="M7 4h.01" /><path d="M12 4h.01" /><path d="M17 4h.01" />'})}},zs={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M14 18V6a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v11a1 1 0 0 0 1 1h2" /><path d="M15 18H9" /><path d="M19 18h2a1 1 0 0 0 1-1v-3.65a1 1 0 0 0-.22-.624l-3.48-4.35A1 1 0 0 0 17.52 8H14" /><circle cx="17" cy="18" r="2" /><circle cx="7" cy="18" r="2" />'})}},xs={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M11 2v2" /><path d="M5 2v2" /><path d="M5 3H4a2 2 0 0 0-2 2v4a6 6 0 0 0 12 0V5a2 2 0 0 0-2-2h-1" /><path d="M8 15a6 6 0 0 0 12 0v-3" /><circle cx="20" cy="10" r="2" />'})}},vs={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M9 10h.01" /><path d="M15 10h.01" /><path d="M12 2a8 8 0 0 0-8 8v12l3-3 2.5 2.5L12 19l2.5 2.5L17 19l3 3V10a8 8 0 0 0-8-8z" />'})}},js={inheritAttrs:!1,render(){return D("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"1.5","stroke-linecap":"round","stroke-linejoin":"round",...this.$attrs,innerHTML:'<path d="M16 19h6" /><path d="M16 2v4" /><path d="M19 16v6" /><path d="M21 12.598V6a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h8.5" /><path d="M3 10h18" /><path d="M8 2v4" />'})}},bs={class:"grid w-full max-w-3xl grid-cols-1 gap-6 sm:grid-cols-2"},Ds=["onClick"],Ps=["onClick"],Ys={class:"flex flex-col gap-1.5 sm:col-span-2"},$="w-full rounded px-2 py-1.5 text-left text-base hover:bg-surface-gray-2",Ms=E({__name:"Examples",setup(U){const u=h(""),g=c().format("YYYY-MM-DD"),z=c().add(1,"year").format("YYYY-MM-DD"),x=h("1995-08-14"),v=c().subtract(120,"year").format("YYYY-MM-DD"),P=h("");function M(d){const i=d.day();return i===0||i===6}function j(d=c()){const i=(8-d.day())%7||7;return d.add(i,"day")}const y=h(""),b=c().add(30,"day").format("YYYY-MM-DD"),n=new Set([c().add(2,"day").format("YYYY-MM-DD"),c().add(5,"day").format("YYYY-MM-DD"),c().add(11,"day").format("YYYY-MM-DD"),c().add(18,"day").format("YYYY-MM-DD")]);function o(d){return n.has(d.format("YYYY-MM-DD"))}const f=h("");function A(d){return!(d.day()===5&&d.date()===13)}const V=h(""),m=c("1800-01-01").format("YYYY-MM-DD"),e=c("2300-12-31").format("YYYY-MM-DD"),_=h("");return(d,i)=>(S(),q("div",bs,[p(l(C),{modelValue:u.value,"onUpdate:modelValue":i[0]||(i[0]=r=>u.value=r),label:"Departure",placeholder:"When are you flying?",format:"ddd, MMM D",min:l(g),max:l(z)},{prefix:t(()=>[p(l(ks),{class:"size-4 text-ink-gray-5"})]),_:1},8,["modelValue","min","max"]),p(l(C),{modelValue:x.value,"onUpdate:modelValue":i[1]||(i[1]=r=>x.value=r),label:"Date of birth",placeholder:"MM/DD/YYYY",format:"MMM D, YYYY",min:l(v),max:l(g),clearable:!1},{prefix:t(()=>[p(l(gs),{class:"size-4 text-ink-gray-5"})]),_:1},8,["modelValue","min","max"]),p(l(C),{modelValue:P.value,"onUpdate:modelValue":i[2]||(i[2]=r=>P.value=r),label:"Delivery date",placeholder:"Weekdays only",min:l(g),"is-date-unavailable":M},{prefix:t(()=>[p(l(zs),{class:"size-4 text-ink-gray-5"})]),actions:t(({setDate:r,close:k})=>[s("button",{type:"button",class:w($),onClick:()=>{r(l(c)().add(1,"day")),k()}}," Tomorrow ",8,Ds),s("button",{type:"button",class:w($),onClick:()=>{r(j()),k()}}," Next Monday ",8,Ps)]),_:1},8,["modelValue","min"]),p(l(C),{modelValue:y.value,"onUpdate:modelValue":i[3]||(i[3]=r=>y.value=r),label:"Book appointment",description:"Next 30 days. Greyed-out slots are full.",placeholder:"Pick a slot",min:l(g),max:l(b),"is-date-unavailable":o},{prefix:t(()=>[p(l(xs),{class:"size-4 text-ink-gray-5"})]),_:1},8,["modelValue","min","max"]),p(l(C),{modelValue:f.value,"onUpdate:modelValue":i[4]||(i[4]=r=>f.value=r),label:"Spooky date",description:"Only Friday the 13ths qualify.",placeholder:"Pick if you dare",format:"dddd, MMM D, YYYY","is-date-unavailable":A},{prefix:t(()=>[p(l(vs),{class:"size-4 text-ink-gray-5"})]),_:1},8,["modelValue"]),p(l(C),{modelValue:V.value,"onUpdate:modelValue":i[5]||(i[5]=r=>V.value=r),label:"Time-travel destination",placeholder:"When to?",format:"[Stardate] YYYY.MM.DD",variant:"outline",min:l(m),max:l(e)},{prefix:t(()=>[p(l(B),{class:"size-4 text-ink-gray-5"})]),_:1},8,["modelValue","min","max"]),s("div",Ys,[i[7]||(i[7]=s("span",{class:"text-sm text-ink-gray-7"},"Task card affordance",-1)),p(l(C),{modelValue:_.value,"onUpdate:modelValue":i[6]||(i[6]=r=>_.value=r),format:"MMM D"},{trigger:t(({togglePopover:r,displayLabel:k})=>[p(l(N),{variant:_.value?"subtle":"ghost",onClick:r},{prefix:t(()=>[p(l(js),{class:"size-4"})]),default:t(()=>[a(" "+W(_.value?`Due ${k}`:"Add due date"),1)]),_:2},1032,["variant","onClick"])]),_:1},8,["modelValue"])])]))}}),As=JSON.parse('{"title":"DatePicker","description":"","frontmatter":{},"headers":[],"relativePath":"docs/components/datepicker.md","filePath":"docs/components/datepicker.md","lastUpdated":1779053387000}'),Cs={name:"docs/components/datepicker.md"},Ls=Object.assign(Cs,{setup(U){const u=[{name:"value",description:"Uncontrolled initial value for the picker.",required:!1,type:"string",default:'""',deprecated:"Use `modelValue` with `v-model` instead."},{name:"modelValue",description:"Controlled value for the picker.",required:!1,type:"string",default:'""'},{name:"side",description:"Preferred popover side relative to the trigger.",required:!1,type:"PopoverSide"},{name:"align",description:"Alignment of the popover along the trigger edge.",required:!1,type:"PopoverAlign"},{name:"offset",description:"Gap between the trigger and popover content in pixels.",required:!1,type:"number"},{name:"placement",description:"Preferred popover placement relative to the trigger.",required:!1,type:"DatePickerPlacement",deprecated:"Use `side` and `align` instead."},{name:"format",description:"Display format used for the input text.",required:!1,type:"string"},{name:"size",description:"Size of the trigger input.",required:!1,type:"InputSize"},{name:"variant",description:"Visual style variant passed through to the input.",required:!1,type:"InputVariant",default:'"subtle"'},{name:"placeholder",description:"Placeholder text shown when no value is selected.",required:!1,type:"string",default:'"Select date"'},{name:"open",description:"Controls popover open state (for controlled usage).",required:!1,type:"boolean"},{name:"openOnFocus",description:"Opens the popover when the input receives focus. Default: false.",required:!1,type:"boolean",default:"false"},{name:"openOnClick",description:"Opens the popover when the input is clicked. Default: true.",required:!1,type:"boolean",default:"true"},{name:"typeable",description:"Whether the trigger input accepts typed input. When `false` the user can\nstill open the popover and pick a date, but cannot type a date manually.\nDefault: `true`.",required:!1,type:"boolean",default:"true"},{name:"readonly",description:"Prevents manual typing while keeping the picker interactive.",required:!1,type:"boolean",default:"false",deprecated:"Use `typeable: false` instead."},{name:"disabled",description:"Disables the trigger input and calendar interactions.",required:!1,type:"boolean",default:"false"},{name:"clearable",description:"Shows clear and quick-action controls when enabled.",required:!1,type:"boolean",default:"true"},{name:"keepOpen",description:"Keeps the popover open after a date is selected. Default: false.",required:!1,type:"boolean"},{name:"autoClose",description:"Closes the popover after a value is picked.",required:!1,type:"boolean",default:"true",deprecated:"Use `keepOpen` instead (inverse semantics: `autoClose: false` → `keepOpen: true`)."},{name:"min",description:"Earliest selectable date. Accepts `YYYY-MM-DD` (or, for `DateTimePicker`,\n`YYYY-MM-DD HH:mm:ss` for second-level granularity).",required:!1,type:"string"},{name:"max",description:"Latest selectable date. Accepts `YYYY-MM-DD` (or, for `DateTimePicker`,\n`YYYY-MM-DD HH:mm:ss` for second-level granularity).",required:!1,type:"string"},{name:"isDateUnavailable",description:"Return true to prevent a date from being selected. Combined with `min`/`max`.",required:!1,type:"((date: Dayjs) => boolean)"},{name:"allowCustom",description:"Allows users to type custom date text into the input.",required:!1,type:"boolean",default:"true",deprecated:"Use `typeable: false` instead."},{name:"inputClass",description:"Additional classes applied to the trigger input.",required:!1,type:"string | string[] | Record<string, boolean>",deprecated:"Apply `class` directly to the DatePicker component element to control width."},{name:"label",description:"Label rendered above (or beside, for binary controls) the input.",required:!1,type:"string"},{name:"description",description:"Helper text rendered below the input.\nHidden when `error` is set.",required:!1,type:"string"},{name:"error",description:'Error message rendered below the input. When set, the control receives\n`aria-invalid="true"` and `data-state="invalid"`. May be either a string\nor an `Error` object whose `messages?: string[]` is rendered as stacked\nlines (with `Error.message` as the fallback).',required:!1,type:"string | FrappeUIError"},{name:"required",description:"Marks the field as required. Renders an asterisk next to the label and\nforwards `required` / `aria-required` to the underlying control.",required:!1,type:"boolean"},{name:"id",description:"HTML id of the underlying control. Auto-generated via `useId()` if omitted.",required:!1,type:"string"}],g=[{name:"trigger",description:"Custom trigger renderer for the picker.",type:"DatePickerTriggerSlotProps"},{name:"target",description:"Custom trigger renderer for the picker.",type:"DatePickerTriggerSlotProps",deprecated:"Use `#trigger` instead. `#target` remains as a back-compat alias through v1.x."},{name:"prefix",description:"Content rendered before the trigger input value.",type:"DatePickerTriggerSlotProps"},{name:"suffix",description:"Content rendered after the trigger input value.",type:"DatePickerTriggerSlotProps"},{name:"actions",description:`Sidebar rendered to the left of the calendar. Use for date shortcuts
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_wac0bt"},"DateTimePicker"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:t(()=>[p(ys)]),_:1}),n[10]||(n[10]=s("h2",{id:"date-range-picker",tabindex:"-1"},[a("Date Range Picker "),s("a",{class:"header-anchor",href:"#date-range-picker","aria-label":"Permalink to “Date Range Picker”"},"​")],-1)),p(o,{name:"DatePicker-Range",css:"grid *:w-fit justify-center !py-20 !gap-1"},{code:t(()=>[...n[2]||(n[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
