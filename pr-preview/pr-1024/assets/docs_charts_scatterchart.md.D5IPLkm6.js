import{_ as _s}from"./chunks/PropsTable.i28TYSLM.js";import{_ as os}from"./chunks/SlotsTable.DgfOKOZR.js";import{_ as hs}from"./chunks/EmitsTable.BuW0Bvpq.js";import{bm as us,bg as ds,bh as ms,br as fs}from"./chunks/theme.C3oYM1__.js";import{r as ys,u as ws}from"./chunks/useChart.CJ7vWVuk.js";import{t as D,c as vs,D as gs,B as F,A as ks,e as bs,_ as xs}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.JJzup8TE.js";import{b as S,m as ss,c as js,d as zs,i as Cs}from"./chunks/utils.CB3TBNW1.js";import{c as As,C as Ss,u as Os}from"./chunks/theme.CBjfubrx.js";import{b as Ps,t as Rs,p as Ts}from"./chunks/referenceLines.D2rwysEU.js";import{_ as Ds}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.CY3CkvFr.js";import{_ as Ls}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.qzZkpLNz.js";import{I as O,aV as Es,bb as V,l as w,ad as A,p as Is,z as $,bh as h,an as z,a1 as G,L as W,D as o,o as s,aE as P,Y as U,aj as H,ag as Y,r as R,ao as X,A as L,B as a}from"./chunks/framework.CBqXW8Fl.js";const Ns="categorical",C=10,K=35,Z=.75,Q="6%";function as(n,{theme:i}){const t=n.data??[],e=[],c=new Map,p=[];for(const _ of t){const v=D(_[n.xColumn]),y=D(_[n.yColumn]);if(v===null||y===null)continue;const j=Bs(n,_);let x=c.get(j);x||(x=[],e.push(j),c.set(j,x));const g=n.sizeColumn?D(_[n.sizeColumn]):null;g!==null&&p.push(g),x.push({x:v,y,size:g,label:Ms(n,_),row:_})}const m=Fs(p,!!n.sizeColumn),f=As(n.palette,i,{fallback:Ns,count:e.length});return e.map((_,v)=>({name:_,label:S(_),color:f[v],points:c.get(_).map(y=>({...y,symbolSize:m(y.size)}))}))}const qs="(Blank)";function Bs(n,i){if(!n.seriesColumn)return n.yColumn;const t=i[n.seriesColumn];return t==null||t===""?qs:String(t)}function Ms(n,i){if(!n.labelColumn)return;const t=i[n.labelColumn];return t==null?void 0:String(t)}function Fs(n,i){if(!i)return()=>C;const t=Vs(n);return e=>e===null?C:t(e)}function Vs(n){let i=1/0,t=-1/0;for(const c of n)c<i&&(i=c),c>t&&(t=c);if(i===t){const c=(C+K)/2;return()=>c}const e=K-C;return c=>C+(c-i)/(t-i)*e}function $s(n,i){const{theme:t,hiddenSeries:e=[],format:c}=i,p=n.dir==="rtl",f=as(n,i).filter(y=>!e.includes(y.name)),_=Ws(n),v={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:Ss},grid:vs({horizontal:!1,isRTL:p,labelGutter:0}),xAxis:J(n.xAxis,t,{horizontal:!0,isRTL:p,format:c?.x,name:n.xAxis?.title}),yAxis:J(n.yAxis,t,{horizontal:!1,isRTL:p,format:c?.y}),series:[...f.map(y=>Us(y,{theme:t,isRTL:p,showLabels:_})),...Ps(Gs(n),{theme:t,horizontal:!1,hasSecondaryValueAxis:!1,hasCategoryAxis:!1,hostSeriesType:"scatter"})]};return ss(v,n.echartOptions)}function Gs(n){const i=n.referenceLines;return i?.filter(t=>t.axis==="y2").length,i}function Ws(n){return n.showDataLabels?!!n.labelColumn:!1}function Us(n,i){const{theme:t,isRTL:e,showLabels:c}=i;return{type:"scatter",name:n.name,data:n.points.map(p=>({value:[p.x,p.y],symbolSize:p.symbolSize,...c?{name:p.label??""}:{}})),symbol:"circle",itemStyle:{color:n.color,opacity:Z,borderWidth:0},emphasis:{focus:"series",blurScope:"coordinateSystem"},blur:{itemStyle:{opacity:Z*F},label:{opacity:F}},...c?{label:{show:!0,position:e?"left":"right",color:t.dataLabel,fontSize:gs,formatter:p=>String(p?.name??"")},labelLayout:{hideOverlap:!0}}:{}}}function J(n,i,t){const{horizontal:e,isRTL:c,format:p,name:m}=t,f=ss({scale:!0,boundaryGap:[Q,Q],...m?{name:S(m),nameLocation:"end",nameGap:8,nameTextStyle:{color:i.axisTitle,fontSize:ks}}:{},...p?{axisLabel:{formatter:_=>p(Number(_))}}:{}},n?.echartOptions);return bs({...n,echartOptions:f},i,{horizontal:e,isRTL:c})}const Hs=["aria-label"],E=O({__name:"ScatterChart",props:U({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},x:{},y:{},size:{},series:{},label:{},showDataLabels:{type:Boolean},xAxis:{},yAxis:{},palette:{},referenceLines:{},format:{type:Function},echartOptions:{}},{hiddenSeries:{default:()=>[]},hiddenSeriesModifiers:{}}),emits:U(["pointClick"],["update:hiddenSeries"]),setup(n,{expose:i,emit:t}){ys([us,ds,ms,fs]);const e=n,c=Es(n,"hiddenSeries"),p=t,m=H(),f=w(()=>e.dir??zs()),_=w(()=>e.xAxis?.format??e.format),v=w(()=>e.yAxis?.format??e.format),y=w(()=>({data:e.data,xColumn:e.x,yColumn:e.y,sizeColumn:e.size,seriesColumn:e.series,labelColumn:e.label,showDataLabels:e.showDataLabels,xAxis:j(e.xAxis),yAxis:j(e.yAxis),referenceLines:e.referenceLines,palette:e.palette,dir:f.value,echartOptions:e.echartOptions}));function j(l){if(l)return{title:l.title,min:l.min,max:l.max,echartOptions:l.echartOptions}}const{theme:x}=Os(m),g=w(()=>as(y.value,{theme:x.value})),ns=w(()=>g.value.every(l=>!l.points.length)),ls=w(()=>e.yAxis?.title?S(e.yAxis.title):void 0),I=w(()=>{try{return{option:$s(y.value,{theme:x.value,hiddenSeries:c.value,format:{x:_.value,y:v.value}}),error:null}}catch(l){return{option:void 0,error:l?.message??String(l)}}}),es=w(()=>I.value.error),b=Y({x:0,y:0}),u=Y({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:ps,dispatch:N}=ws({container:m,option:()=>I.value.option,events:{mouseover:l=>ts(l),mouseout:()=>u.open=!1,click:l=>{const r=q(l);r&&p("pointClick",{seriesName:r.series.name,x:r.point.x,y:r.point.y,size:r.point.size,label:r.point.label,row:r.point.row})}},onZrEvents:{mousemove:l=>{b.x=l.event?.clientX??b.x,b.y=l.event?.clientY??b.y,u.open&&(u.x=b.x,u.y=b.y)},globalout:()=>u.open=!1}});function q(l){const r=g.value.find(k=>k.name===l?.seriesName),d=r?.points[l?.dataIndex];return r&&d?{series:r,point:d}:void 0}function ts(l){const r=q(l);if(!r){u.open=!1;return}const{series:d,point:k}=r,rs=[k.label,e.series?d.label:void 0].filter(Boolean).join(" · ");u.label=rs||void 0,u.items=[T(e.x,k.x,_.value,d.color),T(e.y,k.y,v.value,d.color),...e.size&&k.size!==null?[T(e.size,k.size,e.format,d.color)]:[]],u.x=b.x,u.y=b.y,u.open=!0}function T(l,r,d,k){return{name:l,label:S(l),color:k,value:r,formattedValue:d?d(r):Cs(r)}}const B=w(()=>g.value.map(l=>({name:l.name,label:l.label,color:l.color,hidden:c.value.includes(l.name)})));function cs(l){c.value=Rs(c.value,l,g.value.length)}const M=H(null);function is(l){M.value=l}return V(M,(l,r)=>{r&&N({type:"downplay",seriesName:r}),l&&!c.value.includes(l)&&N({type:"highlight",seriesName:l})}),V(()=>g.value.map(l=>l.name),l=>{c.value=Ts(c.value,l)}),i({chart:w(()=>ps.value)}),(l,r)=>(A(),Is(Ds,{title:n.title,subtitle:n.subtitle,"plot-label":ls.value,loading:n.loading,error:n.error||es.value,empty:ns.value,dir:f.value},$({default:h(()=>[s("div",{ref_key:"plotEl",ref:m,class:"h-full w-full",dir:"ltr",role:"img","aria-label":P(js)(n.title,n.subtitle)},null,8,Hs),o(xs,{open:u.open,x:u.x,y:u.y,label:u.label,items:u.items,dir:f.value},$({_:2},[l.$slots.tooltip?{name:"default",fn:h(d=>[z(l.$slots,"tooltip",G(W(d)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[l.$slots.actions?{name:"actions",fn:h(()=>[z(l.$slots,"actions")]),key:"0"}:void 0,l.$slots.loading?{name:"loading",fn:h(()=>[z(l.$slots,"loading")]),key:"1"}:void 0,l.$slots.error?{name:"error",fn:h(d=>[z(l.$slots,"error",G(W(d)))]),key:"2"}:void 0,l.$slots.empty?{name:"empty",fn:h(()=>[z(l.$slots,"empty")]),key:"3"}:void 0,B.value.length>1?{name:"legend",fn:h(()=>[o(Ls,{items:B.value,onChange:cs,onHighlight:is},null,8,["items"])]),key:"4"}:void 0]),1032,["title","subtitle","plot-label","loading","error","empty","dir"]))}}),Ys={class:"h-80 w-full"},Xs=O({__name:"ScatterQuadrants",setup(n){const i=[{product:"Payroll",growth:34,margin:62},{product:"Invoicing",growth:12,margin:71},{product:"CRM",growth:41,margin:48},{product:"Helpdesk",growth:27,margin:55},{product:"Inventory",growth:8,margin:44},{product:"Insights",growth:52,margin:39},{product:"Field service",growth:6,margin:58},{product:"Point of sale",growth:19,margin:33}],t=e=>`${e}%`;return(e,c)=>(A(),R("div",Ys,[o(P(E),{data:i,x:"growth",y:"margin",label:"product","show-data-labels":"","x-axis":{title:"Growth",format:t},"y-axis":{title:"Margin",format:t},"reference-lines":[{value:25,axis:"x",label:"Median growth",dashed:!0},{value:50,axis:"y",label:"Median margin",dashed:!0}],title:"Growth against margin",subtitle:"Median lines divide the plot into four"},null,8,["x-axis","y-axis"])]))}}),Ks={class:"h-96 w-full"},Zs=O({__name:"ScatterMarkets",setup(n){const i=[{market:"Germany",arpu:61,retention:88,seats:14200,region:"EMEA"},{market:"France",arpu:54,retention:82,seats:9100,region:"EMEA"},{market:"UAE",arpu:72,retention:79,seats:2600,region:"EMEA"},{market:"Nigeria",arpu:21,retention:74,seats:4800,region:"EMEA"},{market:"India",arpu:18,retention:91,seats:38400,region:"APAC"},{market:"Japan",arpu:68,retention:94,seats:7300,region:"APAC"},{market:"Australia",arpu:59,retention:85,seats:5200,region:"APAC"},{market:"Singapore",arpu:77,retention:81,seats:1900,region:"APAC"},{market:"United States",arpu:74,retention:87,seats:41500,region:"Americas"},{market:"Canada",arpu:63,retention:89,seats:8600,region:"Americas"},{market:"Brazil",arpu:26,retention:71,seats:12800,region:"Americas"},{market:"Mexico",arpu:31,retention:76,seats:6400,region:"Americas"}];return(t,e)=>(A(),R("div",Ks,[o(P(E),{data:i,x:"arpu",y:"retention",size:"seats",series:"region",label:"market","x-axis":{title:"ARPU",format:c=>`$${c}`},"y-axis":{title:"Retention",format:c=>`${c}%`},title:"Revenue per seat against retention",subtitle:"Bubble size is the number of seats"},null,8,["x-axis","y-axis"])]))}}),Qs={class:"h-80 w-full"},Js=O({__name:"ScatterSpend",setup(n){const i=[{account:"Acme",spend:4200,revenue:12400},{account:"Globex",spend:9100,revenue:24200},{account:"Initech",spend:2200,revenue:3100},{account:"Umbrella",spend:7400,revenue:9600},{account:"Soylent",spend:5600,revenue:18800},{account:"Hooli",spend:12800,revenue:21400},{account:"Vehement",spend:1800,revenue:6200},{account:"Massive Dynamic",spend:10400,revenue:34600},{account:"Stark",spend:6800,revenue:7400},{account:"Wayne",spend:3100,revenue:11200}],t=e=>`$${new Intl.NumberFormat("en-US").format(e)}`;return(e,c)=>(A(),R("div",Qs,[o(P(E),{data:i,x:"spend",y:"revenue",label:"account","x-axis":{title:"Acquisition spend"},"y-axis":{title:"Revenue"},format:t,title:"Spend against revenue",subtitle:"Ten largest accounts, last quarter"})]))}}),da=JSON.parse('{"title":"ScatterChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/scatterchart.md","filePath":"docs/charts/scatterchart.md","lastUpdated":0}'),sa={name:"docs/charts/scatterchart.md"},ma=Object.assign(sa,{setup(n){const i=[{name:"title",description:"",required:!1,type:"string"},{name:"subtitle",description:"",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"",required:!1,type:"boolean"},{name:"error",description:"",required:!1,type:"string | null"},{name:"data",description:"One row per point.",required:!0,type:"Record<string, any>[]"},{name:"x",description:"Row key holding the horizontal measure.",required:!0,type:"string"},{name:"y",description:"Row key holding the vertical measure.",required:!0,type:"string"},{name:"size",description:"Row key holding the magnitude each point is sized by.",required:!1,type:"string"},{name:"series",description:"Grouping column: one series per distinct value.",required:!1,type:"string"},{name:"label",description:"Row key holding the point's own name, which heads its tooltip.",required:!1,type:"string"},{name:"showDataLabels",description:`Prints the point's own name beside it, the way an axis series prints its
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  dir"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," ChartDir")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),o(os,{data:t}),o(hs,{data:e})])}}});export{da as __pageData,ma as default};
