import{a2 as k,m as _,aK as n,u as a,ap as e,t as y,l as i,aL as x,aM as c,aO as h,aD as T,a7 as u}from"./framework.D-3vrHUJ.js";import{cN as I,b7 as S,ar as m,b6 as R}from"./theme.B1oZYqDQ.js";import{r as B,w as F,u as L,P as N,H as O,f as V,g as $,S as o,c as z,p as A,t as H,d as C,O as U,a as q,A as D,b as K,F as M,l as P,o as j,m as W,B as E,I as Y,i as G,n as J,U as Q,R as X,v as Z}from"./kits.lDY7tsME.js";const ee={class:"sticky top-0 z-10 border-b bg-surface-base"},te={class:"overflow-x-auto px-2 py-1"},se={class:"px-4 pb-40 pt-4"},ae=["onKeydown"],le={__name:"ComposeMobile",setup(oe){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[B.configure({mention:{items:f}})],b=[N,O,V,$,o,z,A,H,o,C,U,o,q,D,K,M,o,P,j,W,E,Y,G,o,J,o,Q,X],r=u("Design review: new onboarding flow"),d=u(`
