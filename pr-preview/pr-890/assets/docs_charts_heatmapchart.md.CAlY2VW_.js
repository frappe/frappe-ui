import{_ as k}from"./chunks/PropsTable.BPfiE967.js";import{_ as b}from"./chunks/SlotsTable.BOU4Kd92.js";import{_ as z}from"./chunks/EmitsTable.C5sBqdF2.js";import"./chunks/theme.KezDSFDn.js";import{_ as v}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.CsKxMq6L.js";import{J as w,ad as d,r as f,D as l,aE as h,ao as y,A as g,bg as c,o as s,B as a}from"./chunks/framework.DK_yVzt8.js";import"./chunks/useChart.BOnnk8dS.js";import"./chunks/theme.BkqhApAl.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.D4rWOcY9.js";import"./chunks/utils.DD_zHYir.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.C5_ORtCO.js";const j={class:"h-72 w-full"},x=w({__name:"HeatmapDemand",setup(m){const i=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],_=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],r=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],o=[8,52,38,34,20,15,20,9],n=r.flatMap((p,e)=>p.map((t,u)=>({day:_[e],hour:i[u],deviation:Math.round((t-o[u])/o[u]*100)})));return(p,e)=>(d(),f("div",j,[l(h(v),{data:h(n),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:t=>`${t>0?"+":""}${t}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),C={class:"h-72 w-full"},O=w({__name:"HeatmapTickets",setup(m){const i=["9am","11am","1pm","3pm","5pm","7pm"],_=["Mon","Tue","Wed","Thu","Fri"],r=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],o=_.flatMap((n,p)=>i.map((e,t)=>({day:n,hour:e,tickets:r[p][t]})));return(n,p)=>(d(),f("div",C,[l(h(v),{data:h(o),x:"hour",y:"day",value:"tickets","show-values":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),B=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmapchart.md","filePath":"docs/charts/heatmapchart.md","lastUpdated":0}'),S={name:"docs/charts/heatmapchart.md"},F=Object.assign(S,{setup(m){const i=[{name:"title",description:"",required:!1,type:"string"},{name:"subtitle",description:"",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"",required:!1,type:"boolean"},{name:"error",description:"",required:!1,type:"string | null"},{name:"data",description:"One row per cell.",required:!0,type:"Record<string, any>[]"},{name:"x",description:"Row key holding the column a cell sits in.",required:!0,type:"string"},{name:"y",description:"Row key holding the row a cell sits in.",required:!0,type:"string"},{name:"value",description:"Row key holding the magnitude the cell is colored by.",required:!0,type:"string"},{name:"min",description:"",required:!1,type:"number"},{name:"max",description:"",required:!1,type:"number"},{name:"showValues",description:"",required:!1,type:"boolean"},{name:"format",description:"",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"",required:!1,type:"HeatmapPalette"},{name:"echartOptions",description:"",required:!1,type:"EchartOptionsOverride"}],_=[{name:"actions",description:"",type:"any"},{name:"tooltip",description:"",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"}],r=[{name:"cellClick",description:"",type:"[event: HeatmapCellEvent]"}];return(o,n)=>{const p=y("ComponentPreview"),e=y("ClientOnly");return d(),f("div",null,[n[3]||(n[3]=g('<h1 id="heatmapchart" tabindex="-1">HeatmapChart <a class="header-anchor" href="#heatmapchart" aria-label="Permalink to “HeatmapChart”">​</a></h1><p>Magnitude across two dimensions, a cell per pair.</p><h2 id="values-in-cells" tabindex="-1">Values in cells <a class="header-anchor" href="#values-in-cells" aria-label="Permalink to “Values in cells”">​</a></h2><p><code>x</code>, <code>y</code> and <code>value</code> name a cell&#39;s column, row and magnitude, so the data is one row per cell. <code>showValues</code> prints values inside the cells, dropping any label that would collide with its neighbour.</p>',4)),l(e,null,{default:c(()=>[l(p,{name:"Charts-HeatmapTickets","self-layout":""},{code:c(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  dir"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," ChartDir")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),n[7]||(n[7]=a()),l(b,{data:_}),n[8]||(n[8]=a()),l(z,{data:r})])}}});export{B as __pageData,F as default};
