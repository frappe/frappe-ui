import{_ as y}from"./chunks/PropsTable.DyYL1zBG.js";import{_ as x}from"./chunks/SlotsTable.C-cfu0qF.js";import{_ as k}from"./chunks/EmitsTable.BaYONb1K.js";import"./chunks/theme.DWD8wOjP.js";import{_ as w}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.ctg0UDxJ.js";import{J as v,ad as d,r as u,D as l,aE as h,ao as f,A as z,bg as c,o as s,B as a}from"./chunks/framework.DK_yVzt8.js";import"./chunks/useChart.CMsucG9S.js";import"./chunks/theme.CvdTDbOT.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CBkICHhM.js";import"./chunks/utils.B-1qB53H.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.offEPDxL.js";const b={class:"h-72 w-full"},g=v({__name:"HeatmapDemand",setup(j){const _=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],i=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],r=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],o=[8,52,38,34,20,15,20,9],n=r.flatMap((p,e)=>p.map((t,m)=>({day:i[e],hour:_[m],deviation:Math.round((t-o[m])/o[m]*100)})));return(p,e)=>(d(),u("div",b,[l(h(w),{data:h(n),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:t=>`${t>0?"+":""}${t}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),C={class:"h-72 w-full"},O=v({__name:"HeatmapTickets",setup(j){const _=["9am","11am","1pm","3pm","5pm","7pm"],i=["Mon","Tue","Wed","Thu","Fri"],r=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],o=i.flatMap((n,p)=>_.map((e,t)=>({day:n,hour:e,tickets:r[p][t]})));return(n,p)=>(d(),u("div",C,[l(h(w),{data:h(o),x:"hour",y:"day",value:"tickets","show-values":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),B=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmap-chart.md","filePath":"docs/charts/heatmap-chart.md","lastUpdated":1785774438000}'),P={name:"docs/charts/heatmap-chart.md"},F=Object.assign(P,{setup(j){const _=[{name:"title",description:"",required:!1,type:"string"},{name:"subtitle",description:"",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"",required:!1,type:"boolean"},{name:"error",description:"",required:!1,type:"string | null"},{name:"data",description:"One row per cell.",required:!0,type:"Record<string, any>[]"},{name:"x",description:"Row key holding the column a cell sits in.",required:!0,type:"string"},{name:"y",description:"Row key holding the row a cell sits in.",required:!0,type:"string"},{name:"value",description:"Row key holding the magnitude the cell is colored by.",required:!0,type:"string"},{name:"min",description:"",required:!1,type:"number"},{name:"max",description:"",required:!1,type:"number"},{name:"showValues",description:"",required:!1,type:"boolean"},{name:"format",description:"",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"",required:!1,type:"HeatmapPalette"},{name:"echartOptions",description:"",required:!1,type:"EchartOptionsOverride"}],i=[{name:"actions",description:"",type:"any"},{name:"tooltip",description:"",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"}],r=[{name:"cellClick",description:"",type:"[event: HeatmapCellEvent]"}];return(o,n)=>{const p=f("ComponentPreview"),e=f("ClientOnly");return d(),u("div",null,[n[3]||(n[3]=z('<h1 id="heatmapchart" tabindex="-1">HeatmapChart <a class="header-anchor" href="#heatmapchart" aria-label="Permalink to “HeatmapChart”">​</a></h1><p>Magnitude across two dimensions, a cell per pair.</p><h2 id="values-in-cells" tabindex="-1">Values in cells <a class="header-anchor" href="#values-in-cells" aria-label="Permalink to “Values in cells”">​</a></h2><p><code>x</code>, <code>y</code> and <code>value</code> name a cell&#39;s column, row and magnitude, so the data is one row per cell. <code>showValues</code> prints values inside the cells, dropping any label that would collide with its neighbour.</p>',4)),l(e,null,{default:c(()=>[l(p,{name:"Charts-HeatmapTickets","self-layout":""},{code:c(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:c(()=>[l(O)]),_:1})]),_:1}),n[4]||(n[4]=s("h2",{id:"signed-data",tabindex:"-1"},[a("Signed data "),s("a",{class:"header-anchor",href:"#signed-data","aria-label":"Permalink to “Signed data”"},"​")],-1)),n[5]||(n[5]=s("p",null,[a("Signed data reads on the "),s("code",null,"diverging"),a(" ramp, centered on zero. "),s("code",null,"min"),a(" and "),s("code",null,"max"),a(" pin the scale so the colors mean the same thing across reloads.")],-1)),l(e,null,{default:c(()=>[l(p,{name:"Charts-HeatmapDemand","self-layout":""},{code:c(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"HeatmapChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  dir"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," ChartDir")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),n[7]||(n[7]=a()),l(x,{data:i}),n[8]||(n[8]=a()),l(k,{data:r})])}}});export{B as __pageData,F as default};
