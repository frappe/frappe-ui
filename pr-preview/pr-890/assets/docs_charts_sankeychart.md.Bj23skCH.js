import{_ as G}from"./chunks/PropsTable.R4TDDmF5.js";import{_ as Y}from"./chunks/SlotsTable.D6wAs_t4.js";import{_ as H}from"./chunks/EmitsTable.DWMuH_Ml.js";import{bi as K}from"./chunks/theme.BjaQggVi.js";import{r as U,u as X}from"./chunks/useChart.B14zZjOQ.js";import{B as C,D as Z,t as J,_ as Q}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.3Iijmday.js";import{m as ss,i as q,c as as,d as ns,b as ls}from"./chunks/utils.DoICpy0e.js";import{C as es,c as ps,u as ts}from"./chunks/theme.hlV1lekG.js";import{_ as cs}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.7IbI7R-4.js";import{I as O,l as v,ad as j,p as is,z as R,bf as u,an as g,a1 as D,L as T,o as s,aE as S,D as y,aj as rs,ag as E,r as P,ao as L,A as N,B as a}from"./chunks/framework.Cl1-pdvY.js";const _s="categorical",os=12,hs=10,F=.4,us=.1,x="5%",ds="10%",fs="(Blank)";function B(n,{theme:i}){const h=n.data??[],l=[],o=new Set,e=new Map,d=r=>{o.has(r)||(o.add(r),l.push(r))},t=[];for(const r of h){const m=I(r[n.sourceColumn]),b=I(r[n.targetColumn]),f=J(r[n.valueColumn]);if(f===null||f<0||ys(e,b,m))continue;d(m),d(b);const _=e.get(m)??new Set;_.add(b),e.set(m,_),t.push({source:m,target:b,value:f,row:r})}const z=ps(n.palette,i,{fallback:_s,count:l.length}),k=new Map(l.map((r,m)=>[r,z[m]]));return{nodes:l.map(r=>({name:r,value:ms(r,t),color:k.get(r)})),links:t.map(r=>({...r,color:k.get(r.source)}))}}function ys(n,i,h){const l=[i],o=new Set;for(;l.length;){const e=l.pop();if(e===h)return!0;if(!o.has(e)){o.add(e);for(const d of n.get(e)??[])l.push(d)}}return!1}function ms(n,i){let h=0,l=0;for(const o of i)o.target===n&&(h+=o.value),o.source===n&&(l+=o.value);return Math.max(h,l)}function I(n){return n==null||n===""?fs:String(n)}function ws(n,i){const{theme:h,format:l}=i,o=B(n,i),e=n.orient==="vertical",d={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:es},series:[{type:"sankey",name:n.valueColumn,orient:e?"vertical":"horizontal",nodeAlign:n.nodeAlign??"justify",top:x,bottom:x,left:x,right:e?x:ds,nodeWidth:os,nodeGap:hs,draggable:!1,label:{show:!0,position:e?"top":"right",color:h.dataLabel,fontSize:Z,formatter:t=>`${t.name} · ${vs(Number(t.value),l)}`},emphasis:{focus:"adjacency"},blur:{itemStyle:{opacity:C},lineStyle:{opacity:F*C},label:{opacity:C}},lineStyle:{color:"source",opacity:F,curveness:us},data:o.nodes.map(t=>({name:t.name,value:t.value,itemStyle:{color:t.color,borderWidth:0}})),links:o.links.map(t=>({source:t.source,target:t.target,value:t.value}))}]};return ss(d,n.echartOptions)}function vs(n,i){return i?i(n):q(n,1,!0)}const ks=["aria-label"],V=O({__name:"SankeyChart",props:{title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},source:{},target:{},value:{},orient:{},nodeAlign:{},format:{type:Function},palette:{},echartOptions:{}},emits:["linkClick"],setup(n,{expose:i,emit:h}){U([K]);const l=n,o=h,e=rs(),d=v(()=>l.dir??ns()),t=v(()=>({data:l.data,sourceColumn:l.source,targetColumn:l.target,valueColumn:l.value,orient:l.orient,nodeAlign:l.nodeAlign,palette:l.palette,echartOptions:l.echartOptions})),{theme:z}=ts(e),k=v(()=>B(t.value,{theme:z.value})),r=v(()=>!k.value.links.some(p=>p.value>0)),m=v(()=>{try{return{option:ws(t.value,{theme:z.value,format:l.format}),error:null}}catch(p){return{option:void 0,error:p?.message??String(p)}}}),b=v(()=>m.value.error),f=E({x:0,y:0}),_=E({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:$}=X({container:e,option:()=>m.value.option,events:{mouseover:p=>W(p),mouseout:()=>_.open=!1,click:p=>{const c=A(p);c&&o("linkClick",{source:c.source,target:c.target,value:c.value,row:c.row})}},onZrEvents:{mousemove:p=>{f.x=p.event?.clientX??f.x,f.y=p.event?.clientY??f.y,_.open&&(_.x=f.x,_.y=f.y)},globalout:()=>_.open=!1}});function A(p){if(p?.dataType==="edge")return k.value.links[p.dataIndex]}function W(p){const c=M(p);if(!c){_.open=!1;return}_.label=c.label,_.items=[{name:c.label,label:ls(l.value),color:c.color,value:c.value,formattedValue:l.format?l.format(c.value):q(c.value)}],_.x=f.x,_.y=f.y,_.open=!0}function M(p){const c=A(p);if(c)return{label:`${c.source} → ${c.target}`,color:c.color,value:c.value};const w=k.value.nodes[p?.dataIndex];if(!(p?.dataType!=="node"||!w))return{label:w.name,color:w.color,value:w.value}}return i({chart:v(()=>$.value)}),(p,c)=>(j(),is(cs,{title:n.title,subtitle:n.subtitle,loading:n.loading,error:n.error||b.value,empty:r.value,dir:d.value},R({default:u(()=>[s("div",{ref_key:"plotEl",ref:e,class:"h-full w-full",dir:"ltr",role:"img","aria-label":S(as)(n.title,n.subtitle)},null,8,ks),y(Q,{open:_.open,x:_.x,y:_.y,label:_.label,items:_.items,dir:d.value},R({_:2},[p.$slots.tooltip?{name:"default",fn:u(w=>[g(p.$slots,"tooltip",D(T(w)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[p.$slots.actions?{name:"actions",fn:u(()=>[g(p.$slots,"actions")]),key:"0"}:void 0,p.$slots.loading?{name:"loading",fn:u(()=>[g(p.$slots,"loading")]),key:"1"}:void 0,p.$slots.error?{name:"error",fn:u(w=>[g(p.$slots,"error",D(T(w)))]),key:"2"}:void 0,p.$slots.empty?{name:"empty",fn:u(()=>[g(p.$slots,"empty")]),key:"3"}:void 0]),1032,["title","subtitle","loading","error","empty","dir"]))}}),bs={class:"h-96 w-full"},gs=O({__name:"SankeySpend",setup(n){const i=[{service:"Compute",team:"Product",amount:320},{service:"Compute",team:"Data",amount:180},{service:"Storage",team:"Product",amount:90},{service:"Storage",team:"Data",amount:240},{service:"Network",team:"Product",amount:60},{service:"Network",team:"Support",amount:40}],h=l=>`$${l}K`;return(l,o)=>(j(),P("div",bs,[y(S(V),{data:i,source:"service",target:"team",value:"amount",orient:"vertical",format:h,title:"Infrastructure spend",subtitle:"Service to team, this month"})]))}}),zs={class:"h-80 w-full"},xs=O({__name:"SankeySignups",setup(n){const i=[{from:"Organic search",to:"Free trial",users:4200},{from:"Paid ads",to:"Free trial",users:2600},{from:"Referral",to:"Free trial",users:1800},{from:"Partner",to:"Sales demo",users:900},{from:"Free trial",to:"Paid plan",users:2100},{from:"Free trial",to:"Lapsed",users:6500},{from:"Sales demo",to:"Paid plan",users:640},{from:"Sales demo",to:"Lapsed",users:260}];return(h,l)=>(j(),P("div",zs,[y(S(V),{data:i,source:"from",target:"to",value:"users",title:"Signup flow",subtitle:"Acquisition channel to outcome, last quarter"})]))}}),Ns=JSON.parse('{"title":"SankeyChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/sankeychart.md","filePath":"docs/charts/sankeychart.md","lastUpdated":0}'),js={name:"docs/charts/sankeychart.md"},Fs=Object.assign(js,{setup(n){const i=[{name:"title",description:"",required:!1,type:"string"},{name:"subtitle",description:"",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"",required:!1,type:"boolean"},{name:"error",description:"",required:!1,type:"string | null"},{name:"data",description:"One row per flow, i.e. one band from a source node to a target node.",required:!0,type:"Record<string, any>[]"},{name:"source",description:"Row key holding the node a flow leaves.",required:!0,type:"string"},{name:"target",description:"Row key holding the node a flow arrives at.",required:!0,type:"string"},{name:"value",description:"Row key holding how much flows along the link.",required:!0,type:"string"},{name:"orient",description:"Defaults to `'horizontal'`: the flow runs left to right.",required:!1,type:"SankeyOrient"},{name:"nodeAlign",description:"Where a node sits along the flow. Defaults to `'justify'`.",required:!1,type:"SankeyNodeAlign"},{name:"format",description:"",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'categorical'`: nodes are unrelated categories.",required:!1,type:"ChartPalette"},{name:"echartOptions",description:"",required:!1,type:"EchartOptionsOverride"}],h=[{name:"actions",description:"",type:"any"},{name:"tooltip",description:"",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"},{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"}],l=[{name:"linkClick",description:"",type:"[event: SankeyLinkEvent]"}];return(o,e)=>{const d=L("ComponentPreview"),t=L("ClientOnly");return j(),P("div",null,[e[3]||(e[3]=N('<h1 id="sankeychart" tabindex="-1">SankeyChart <a class="header-anchor" href="#sankeychart" aria-label="Permalink to “SankeyChart”">​</a></h1><p>A flow from one set of nodes to another, a band per row.</p><h2 id="flow-between-two-columns" tabindex="-1">Flow between two columns <a class="header-anchor" href="#flow-between-two-columns" aria-label="Permalink to “Flow between two columns”">​</a></h2><p><code>source</code>, <code>target</code> and <code>value</code> name the three columns a flow needs, so the data is one row per band. The nodes are the de-duplicated union of the source and target columns: a node that a row sends flow to and another row sends flow from sits between the two, which is how a multi-stage flow is drawn. <code>linkClick</code> carries the row behind the band.</p>',4)),y(t,null,{default:u(()=>[y(d,{name:"Charts-SankeySignups","self-layout":""},{code:u(()=>[...e[0]||(e[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:u(()=>[y(xs)]),_:1})]),_:1}),e[4]||(e[4]=N('<h2 id="vertical-flow" tabindex="-1">Vertical flow <a class="header-anchor" href="#vertical-flow" aria-label="Permalink to “Vertical flow”">​</a></h2><p><code>orient=&quot;vertical&quot;</code> turns the flow downwards, which suits a tall card or a graph with few stages. <code>format</code> prints every value the chart shows, on the node labels and in the tooltip alike. <code>nodeAlign</code> decides where a node with nothing leaving it sits: <code>justify</code> pushes it to the far end, <code>left</code> and <code>right</code> pin it to the end they name.</p>',2)),y(t,null,{default:u(()=>[y(d,{name:"Charts-SankeySpend","self-layout":""},{code:u(()=>[...e[1]||(e[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"SankeyChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  dir"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," ChartDir")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),y(Y,{data:h}),y(H,{data:l})])}}});export{Ns as __pageData,Fs as default};
