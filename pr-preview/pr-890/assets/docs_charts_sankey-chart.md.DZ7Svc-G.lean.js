import{_ as K}from"./chunks/PropsTable.DyYL1zBG.js";import{_ as G}from"./chunks/SlotsTable.C-cfu0qF.js";import{_ as M}from"./chunks/EmitsTable.BaYONb1K.js";import{cB as W}from"./chunks/theme.DWD8wOjP.js";import{r as Y,u as H}from"./chunks/useChart.BiXQ_ulW.js";import{B as x,D as U,t as X,_ as J}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CjfLxvgr.js";import{m as Z,i as F,c as Q,d as ss,b as as}from"./chunks/utils.Bl_yI88J.js";import{C as ns,c as ls,u as es}from"./chunks/theme.BkqhApAl.js";import{_ as ps}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.offEPDxL.js";import{J as C,l as y,ad as z,p as ts,z as A,bg as w,an as T,o as s,aE as S,D as m,a3 as cs,M as rs,aj as is,ag as D,r as P,ao as L,A as E,B as a}from"./chunks/framework.DK_yVzt8.js";const os="categorical",_s=12,us=10,q=.4,hs=.1,b="5%",ds="10%",ms="(Blank)";function N(l,{theme:r}){const u=l.data??[],e=[],_=new Set,n=new Map,h=i=>{_.has(i)||(_.add(i),e.push(i))},t=[];for(const i of u){const f=R(i[l.sourceColumn]),v=R(i[l.targetColumn]),d=X(i[l.valueColumn]);if(d===null||d<0||fs(n,v,f))continue;h(f),h(v);const o=n.get(f)??new Set;o.add(v),n.set(f,o),t.push({source:f,target:v,value:d,row:i})}const j=ls(l.palette,r,{fallback:os,count:e.length}),k=new Map(e.map((i,f)=>[i,j[f]]));return{nodes:e.map(i=>({name:i,value:ws(i,t),color:k.get(i)})),links:t.map(i=>({...i,color:k.get(i.source)}))}}function fs(l,r,u){const e=[r],_=new Set;for(;e.length;){const n=e.pop();if(n===u)return!0;if(!_.has(n)){_.add(n);for(const h of l.get(n)??[])e.push(h)}}return!1}function ws(l,r){let u=0,e=0;for(const _ of r)_.target===l&&(u+=_.value),_.source===l&&(e+=_.value);return Math.max(u,e)}function R(l){return l==null||l===""?ms:String(l)}function ys(l,r){const{theme:u,format:e}=r,_=N(l,r),n=l.orient==="vertical",h={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:ns},series:[{type:"sankey",name:l.valueColumn,orient:n?"vertical":"horizontal",nodeAlign:l.nodeAlign??"justify",top:b,bottom:b,left:b,right:n?b:ds,nodeWidth:_s,nodeGap:us,draggable:!1,label:{show:!0,position:n?"top":"right",color:u.dataLabel,fontSize:U,formatter:t=>`${t.name} · ${ks(Number(t.value),e)}`},emphasis:{focus:"adjacency"},blur:{itemStyle:{opacity:x},lineStyle:{opacity:q*x},label:{opacity:x}},lineStyle:{color:"source",opacity:q,curveness:hs},data:_.nodes.map(t=>({name:t.name,value:t.value,itemStyle:{color:t.color,borderWidth:0}})),links:_.links.map(t=>({source:t.source,target:t.target,value:t.value}))}]};return Z(h,l.echartOptions)}function ks(l,r){return r?r(l):F(l,1,!0)}const vs=["aria-label"],V=C({__name:"SankeyChart",props:{title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},source:{},target:{},value:{},orient:{},nodeAlign:{},format:{type:Function},palette:{},echartOptions:{}},emits:["linkClick"],setup(l,{expose:r,emit:u}){Y([W]);const e=l,_=u,n=is(),h=y(()=>e.dir??ss()),t=y(()=>({data:e.data,sourceColumn:e.source,targetColumn:e.target,valueColumn:e.value,orient:e.orient,nodeAlign:e.nodeAlign,palette:e.palette,echartOptions:e.echartOptions})),{theme:j}=es(n),k=y(()=>N(t.value,{theme:j.value})),i=y(()=>!k.value.links.some(p=>p.value>0)),f=y(()=>{try{return{option:ys(t.value,{theme:j.value,format:e.format}),error:null}}catch(p){return{option:void 0,error:p?.message??String(p)}}}),v=y(()=>f.value.error),d=D({x:0,y:0}),o=D({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:B}=H({container:n,option:()=>f.value.option,events:{mouseover:p=>I(p),mouseout:()=>o.open=!1,click:p=>{const c=O(p);c&&_("linkClick",{source:c.source,target:c.target,value:c.value,row:c.row})}},onZrEvents:{mousemove:p=>{d.x=p.event?.clientX??d.x,d.y=p.event?.clientY??d.y,o.open&&(o.x=d.x,o.y=d.y)},globalout:()=>o.open=!1}});function O(p){if(p?.dataType==="edge")return k.value.links[p.dataIndex]}function I(p){const c=$(p);if(!c){o.open=!1;return}o.label=c.label,o.items=[{name:c.label,label:as(e.value),color:c.color,value:c.value,formattedValue:e.format?e.format(c.value):F(c.value)}],o.x=d.x,o.y=d.y,o.open=!0}function $(p){const c=O(p);if(c)return{label:`${c.source} → ${c.target}`,color:c.color,value:c.value};const g=k.value.nodes[p?.dataIndex];if(!(p?.dataType!=="node"||!g))return{label:g.name,color:g.color,value:g.value}}return r({chart:y(()=>B.value)}),(p,c)=>(z(),ts(ps,{title:l.title,subtitle:l.subtitle,loading:l.loading,error:l.error||v.value,empty:i.value,dir:h.value},A({default:w(()=>[s("div",{ref_key:"plotEl",ref:n,class:"h-full w-full",dir:"ltr",role:"img","aria-label":S(Q)(l.title,l.subtitle)},null,8,vs),m(J,{open:o.open,x:o.x,y:o.y,label:o.label,items:o.items,dir:h.value},A({_:2},[p.$slots.tooltip?{name:"default",fn:w(g=>[T(p.$slots,"tooltip",cs(rs(g)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[p.$slots.actions?{name:"actions",fn:w(()=>[T(p.$slots,"actions")]),key:"0"}:void 0]),1032,["title","subtitle","loading","error","empty","dir"]))}}),gs={class:"h-96 w-full"},js=C({__name:"SankeySpend",setup(l){const r=[{service:"Compute",team:"Product",amount:320},{service:"Compute",team:"Data",amount:180},{service:"Storage",team:"Product",amount:90},{service:"Storage",team:"Data",amount:240},{service:"Network",team:"Product",amount:60},{service:"Network",team:"Support",amount:40}],u=e=>`$${e}K`;return(e,_)=>(z(),P("div",gs,[m(S(V),{data:r,source:"service",target:"team",value:"amount",orient:"vertical",format:u,title:"Infrastructure spend",subtitle:"Service to team, this month"})]))}}),bs={class:"h-80 w-full"},zs=C({__name:"SankeySignups",setup(l){const r=[{from:"Organic search",to:"Free trial",users:4200},{from:"Paid ads",to:"Free trial",users:2600},{from:"Referral",to:"Free trial",users:1800},{from:"Partner",to:"Sales demo",users:900},{from:"Free trial",to:"Paid plan",users:2100},{from:"Free trial",to:"Lapsed",users:6500},{from:"Sales demo",to:"Paid plan",users:640},{from:"Sales demo",to:"Lapsed",users:260}];return(u,e)=>(z(),P("div",bs,[m(S(V),{data:r,source:"from",target:"to",value:"users",title:"Signup flow",subtitle:"Acquisition channel to outcome, last quarter"})]))}}),Rs=JSON.parse('{"title":"SankeyChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/sankey-chart.md","filePath":"docs/charts/sankey-chart.md","lastUpdated":1786102036000}'),xs={name:"docs/charts/sankey-chart.md"},Fs=Object.assign(xs,{setup(l){const r=[{name:"title",description:"",required:!1,type:"string"},{name:"subtitle",description:"",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"",required:!1,type:"boolean"},{name:"error",description:"",required:!1,type:"string | null"},{name:"data",description:"One row per flow, i.e. one band from a source node to a target node.",required:!0,type:"Record<string, any>[]"},{name:"source",description:"Row key holding the node a flow leaves.",required:!0,type:"string"},{name:"target",description:"Row key holding the node a flow arrives at.",required:!0,type:"string"},{name:"value",description:"Row key holding how much flows along the link.",required:!0,type:"string"},{name:"orient",description:"Defaults to `'horizontal'`: the flow runs left to right.",required:!1,type:"SankeyOrient"},{name:"nodeAlign",description:"Where a node sits along the flow. Defaults to `'justify'`.",required:!1,type:"SankeyNodeAlign"},{name:"format",description:"",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'categorical'`: nodes are unrelated categories.",required:!1,type:"ChartPalette"},{name:"echartOptions",description:"",required:!1,type:"EchartOptionsOverride"}],u=[{name:"actions",description:"",type:"any"},{name:"tooltip",description:"",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"}],e=[{name:"linkClick",description:"",type:"[event: SankeyLinkEvent]"}];return(_,n)=>{const h=L("ComponentPreview"),t=L("ClientOnly");return z(),P("div",null,[n[3]||(n[3]=E("",4)),m(t,null,{default:w(()=>[m(h,{name:"Charts-SankeySignups","self-layout":""},{code:w(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:w(()=>[m(zs)]),_:1})]),_:1}),n[4]||(n[4]=E("",2)),m(t,null,{default:w(()=>[m(h,{name:"Charts-SankeySpend","self-layout":""},{code:w(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"SankeyChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  dir"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," ChartDir")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),n[8]||(n[8]=a()),m(G,{data:u}),n[9]||(n[9]=a()),m(M,{data:e})])}}});export{Rs as __pageData,Fs as default};
