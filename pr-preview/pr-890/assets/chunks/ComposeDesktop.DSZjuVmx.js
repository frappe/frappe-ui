import{b3 as x,ad as v,r as k,D as e,bh as n,aE as t,o as i,B as y,bi as T,bj as c,bl as h,b9 as I,aj as m}from"./framework.B8tHCIha.js";import{aQ as S,aA as $,au as u,bN as R,aP as A}from"./theme.D3lPyFkN.js";import{r as B,w as D,u as F,P as N,H as V,f as H,g as L,S as o,c as O,p as z,t as C,d as U,O as q,a as P,A as j,b as K,F as E,l as M,o as W,m as Q,B as Y,I as G,i as J,n as X,U as Z,R as ee,v as te}from"./kits.CP-2d3QM.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[B.configure({mention:{items:f}})],b=[N,V,H,L,o,O,z,C,o,U,q,o,P,j,K,E,o,M,W,Q,Y,G,J,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
