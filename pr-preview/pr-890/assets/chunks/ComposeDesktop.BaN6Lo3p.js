import{b3 as x,ad as v,r as k,D as e,bh as n,aE as t,o as i,B as y,bi as T,bj as c,bl as h,b9 as I,aj as m}from"./framework.nTtBrMOc.js";import{aL as S,av as $,aq as u,bG as R,aK as B}from"./theme.B26M0zWY.js";import{r as D,w as F,u as L,P as V,H as A,f as H,g as N,S as o,c as O,p as q,t as z,d as C,O as U,a as K,A as j,b as P,F as E,l as M,o as W,m as G,B as Y,I as J,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.C35f8BHN.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[D.configure({mention:{items:f}})],b=[V,A,H,N,o,O,q,z,o,C,U,o,K,j,P,E,o,M,W,G,Y,J,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
