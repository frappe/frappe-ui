import{b3 as k,ad as _,p as y,bh as n,D as o,aE as e,B as x,o as i,bi as T,bj as c,bl as h,b9 as I,aj as u}from"./framework.B8tHCIha.js";import{bd as S,aq as m,bc as B}from"./theme.CM4Ct6XY.js";import{r as R,w as F,u as V,P as $,H as z,f as A,g as H,S as a,c as L,p as N,t as O,d as q,O as C,a as U,A as D,b as j,F as K,l as M,o as P,m as E,B as W,I as Y,i as G,n as J,U as Q,R as X,v as Z}from"./kits.DjOPbP3T.js";const ee={class:"sticky top-0 z-10 border-b bg-surface-base"},te={class:"overflow-x-auto px-2 py-1"},se={class:"px-4 pb-40 pt-4"},oe=["onKeydown"],le={__name:"ComposeMobile",setup(ae){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[R.configure({mention:{items:f}})],b=[$,z,A,H,a,L,N,O,a,q,C,a,U,D,j,K,a,M,P,E,W,Y,G,a,J,a,Q,X],r=u("Design review: new onboarding flow"),d=u(`
...
`),g=async l=>({file_url:URL.createObjectURL(l),file_name:l.name}),{textarea:v}=k({input:r});return(l,t)=>(_(),y(e(B),null,{default:n(()=>[o(e(F),{modelValue:d.value,"onUpdate:modelValue":t[1]||(t[1]=s=>d.value=s),extensions:w,"upload-function":g,placeholder:"Type '/' for commands or select text to format"},{default:n(({editor:s})=>[o(e(S),{title:"New discussion"},{left:n(()=>[o(e(m),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),right:n(()=>[o(e(m),{variant:"solid"},{default:n(()=>[...t[2]||(t[2]=[x("Publish",-1)])]),_:1})]),_:1}),i("div",ee,[i("div",te,[o(e(V),{editor:s,items:b},null,8,["editor"])])]),i("div",se,[T(i("textarea",{ref_key:"titleTextarea",ref:v,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":t[0]||(t[0]=p=>r.value=p),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[c(h(p=>s.commands.focus(),["prevent"]),["enter"]),c(h(p=>s.commands.focus(),["prevent"]),["down"])]},null,40,oe),[[I,r.value]]),o(e(Z),{editor:s,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{le as default};
