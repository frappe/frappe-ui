import{b2 as x,ad as k,r as v,D as e,bg as n,aE as t,o as i,B as y,bh as T,bi as c,bk as h,b8 as I,aj as m}from"./framework.DK_yVzt8.js";import{aM as S,aA as $,au as u,bJ as R,aL as A}from"./theme.KezDSFDn.js";import{r as B,w as D,u as F,P as L,H as V,f as H,g as N,S as o,c as O,p as z,t as C,d as U,O as q,a as K,A as M,b as P,F as j,l as E,o as W,m as J,B as Y,I as G,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.BaLoz9_E.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[B.configure({mention:{items:f}})],b=[L,V,H,N,o,O,z,C,o,U,q,o,K,M,P,j,o,E,W,J,Y,G,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
