import{_ as $}from"./chunks/PropsTable.DYsTnVcS.js";import{_ as G}from"./chunks/SlotsTable.DhF1OoYE.js";import{_ as M}from"./chunks/EmitsTable.C8dteOiU.js";import{br as Y}from"./chunks/theme.x2PoBp4E.js";import{r as H,u as K}from"./chunks/useChart.CzmOt72H.js";import{B as j,D as U,t as X,_ as Z}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.BDDRK_uo.js";import{m as J,i as F,c as Q,d as ss,b as as}from"./chunks/utils.-OWkVJcb.js";import{C as ns,c as ls,u as es}from"./chunks/theme.hlV1lekG.js";import{_ as ps}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.CzlS87HW.js";import{I as C,l as w,ad as x,p as cs,z as A,bf as y,an as R,o as s,aE as O,D as f,a1 as ts,L as is,aj as rs,ag as D,r as S,ao as T,A as E,B as a}from"./chunks/framework.Cl1-pdvY.js";const _s="categorical",os=12,hs=10,L=.4,us=.1,z="5%",ds="10%",fs="(Blank)";function I(l,{theme:i}){const h=l.data??[],e=[],o=new Set,n=new Map,u=r=>{o.has(r)||(o.add(r),e.push(r))},c=[];for(const r of h){const m=N(r[l.sourceColumn]),k=N(r[l.targetColumn]),d=X(r[l.valueColumn]);if(d===null||d<0||ms(n,k,m))continue;u(m),u(k);const _=n.get(m)??new Set;_.add(k),n.set(m,_),c.push({source:m,target:k,value:d,row:r})}const g=ls(l.palette,i,{fallback:_s,count:e.length}),v=new Map(e.map((r,m)=>[r,g[m]]));return{nodes:e.map(r=>({name:r,value:ys(r,c),color:v.get(r)})),links:c.map(r=>({...r,color:v.get(r.source)}))}}function ms(l,i,h){const e=[i],o=new Set;for(;e.length;){const n=e.pop();if(n===h)return!0;if(!o.has(n)){o.add(n);for(const u of l.get(n)??[])e.push(u)}}return!1}function ys(l,i){let h=0,e=0;for(const o of i)o.target===l&&(h+=o.value),o.source===l&&(e+=o.value);return Math.max(h,e)}function N(l){return l==null||l===""?fs:String(l)}function ws(l,i){const{theme:h,format:e}=i,o=I(l,i),n=l.orient==="vertical",u={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:ns},series:[{type:"sankey",name:l.valueColumn,orient:n?"vertical":"horizontal",nodeAlign:l.nodeAlign??"justify",top:z,bottom:z,left:z,right:n?z:ds,nodeWidth:os,nodeGap:hs,draggable:!1,label:{show:!0,position:n?"top":"right",color:h.dataLabel,fontSize:U,formatter:c=>`${c.name} · ${vs(Number(c.value),e)}`},emphasis:{focus:"adjacency"},blur:{itemStyle:{opacity:j},lineStyle:{opacity:L*j},label:{opacity:j}},lineStyle:{color:"source",opacity:L,curveness:us},data:o.nodes.map(c=>({name:c.name,value:c.value,itemStyle:{color:c.color,borderWidth:0}})),links:o.links.map(c=>({source:c.source,target:c.target,value:c.value}))}]};return J(u,l.echartOptions)}function vs(l,i){return i?i(l):F(l,1,!0)}const ks=["aria-label"],q=C({__name:"SankeyChart",props:{title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},source:{},target:{},value:{},orient:{},nodeAlign:{},format:{type:Function},palette:{},echartOptions:{}},emits:["linkClick"],setup(l,{expose:i,emit:h}){H([Y]);const e=l,o=h,n=rs(),u=w(()=>e.dir??ss()),c=w(()=>({data:e.data,sourceColumn:e.source,targetColumn:e.target,valueColumn:e.value,orient:e.orient,nodeAlign:e.nodeAlign,palette:e.palette,echartOptions:e.echartOptions})),{theme:g}=es(n),v=w(()=>I(c.value,{theme:g.value})),r=w(()=>!v.value.links.some(p=>p.value>0)),m=w(()=>{try{return{option:ws(c.value,{theme:g.value,format:e.format}),error:null}}catch(p){return{option:void 0,error:p?.message??String(p)}}}),k=w(()=>m.value.error),d=D({x:0,y:0}),_=D({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:B}=K({container:n,option:()=>m.value.option,events:{mouseover:p=>V(p),mouseout:()=>_.open=!1,click:p=>{const t=P(p);t&&o("linkClick",{source:t.source,target:t.target,value:t.value,row:t.row})}},onZrEvents:{mousemove:p=>{d.x=p.event?.clientX??d.x,d.y=p.event?.clientY??d.y,_.open&&(_.x=d.x,_.y=d.y)},globalout:()=>_.open=!1}});function P(p){if(p?.dataType==="edge")return v.value.links[p.dataIndex]}function V(p){const t=W(p);if(!t){_.open=!1;return}_.label=t.label,_.items=[{name:t.label,label:as(e.value),color:t.color,value:t.value,formattedValue:e.format?e.format(t.value):F(t.value)}],_.x=d.x,_.y=d.y,_.open=!0}function W(p){const t=P(p);if(t)return{label:`${t.source} → ${t.target}`,color:t.color,value:t.value};const b=v.value.nodes[p?.dataIndex];if(!(p?.dataType!=="node"||!b))return{label:b.name,color:b.color,value:b.value}}return i({chart:w(()=>B.value)}),(p,t)=>(x(),cs(ps,{title:l.title,subtitle:l.subtitle,loading:l.loading,error:l.error||k.value,empty:r.value,dir:u.value},A({default:y(()=>[s("div",{ref_key:"plotEl",ref:n,class:"h-full w-full",dir:"ltr",role:"img","aria-label":O(Q)(l.title,l.subtitle)},null,8,ks),f(Z,{open:_.open,x:_.x,y:_.y,label:_.label,items:_.items,dir:u.value},A({_:2},[p.$slots.tooltip?{name:"default",fn:y(b=>[R(p.$slots,"tooltip",ts(is(b)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[p.$slots.actions?{name:"actions",fn:y(()=>[R(p.$slots,"actions")]),key:"0"}:void 0]),1032,["title","subtitle","loading","error","empty","dir"]))}}),bs={class:"h-96 w-full"},gs=C({__name:"SankeySpend",setup(l){const i=[{service:"Compute",team:"Product",amount:320},{service:"Compute",team:"Data",amount:180},{service:"Storage",team:"Product",amount:90},{service:"Storage",team:"Data",amount:240},{service:"Network",team:"Product",amount:60},{service:"Network",team:"Support",amount:40}],h=e=>`$${e}K`;return(e,o)=>(x(),S("div",bs,[f(O(q),{data:i,source:"service",target:"team",value:"amount",orient:"vertical",format:h,title:"Infrastructure spend",subtitle:"Service to team, this month"})]))}}),zs={class:"h-80 w-full"},xs=C({__name:"SankeySignups",setup(l){const i=[{from:"Organic search",to:"Free trial",users:4200},{from:"Paid ads",to:"Free trial",users:2600},{from:"Referral",to:"Free trial",users:1800},{from:"Partner",to:"Sales demo",users:900},{from:"Free trial",to:"Paid plan",users:2100},{from:"Free trial",to:"Lapsed",users:6500},{from:"Sales demo",to:"Paid plan",users:640},{from:"Sales demo",to:"Lapsed",users:260}];return(h,e)=>(x(),S("div",zs,[f(O(q),{data:i,source:"from",target:"to",value:"users",title:"Signup flow",subtitle:"Acquisition channel to outcome, last quarter"})]))}}),Ns=JSON.parse('{"title":"SankeyChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/sankeychart.md","filePath":"docs/charts/sankeychart.md","lastUpdated":0}'),js={name:"docs/charts/sankeychart.md"},Fs=Object.assign(js,{setup(l){const i=[{name:"title",description:"",required:!1,type:"string"},{name:"subtitle",description:"",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"",required:!1,type:"boolean"},{name:"error",description:"",required:!1,type:"string | null"},{name:"data",description:"One row per flow, i.e. one band from a source node to a target node.",required:!0,type:"Record<string, any>[]"},{name:"source",description:"Row key holding the node a flow leaves.",required:!0,type:"string"},{name:"target",description:"Row key holding the node a flow arrives at.",required:!0,type:"string"},{name:"value",description:"Row key holding how much flows along the link.",required:!0,type:"string"},{name:"orient",description:"Defaults to `'horizontal'`: the flow runs left to right.",required:!1,type:"SankeyOrient"},{name:"nodeAlign",description:"Where a node sits along the flow. Defaults to `'justify'`.",required:!1,type:"SankeyNodeAlign"},{name:"format",description:"",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'categorical'`: nodes are unrelated categories.",required:!1,type:"ChartPalette"},{name:"echartOptions",description:"",required:!1,type:"EchartOptionsOverride"}],h=[{name:"actions",description:"",type:"any"},{name:"tooltip",description:"",type:"{ label?: string | undefined; items: ChartTooltipItem[]; }"}],e=[{name:"linkClick",description:"",type:"[event: SankeyLinkEvent]"}];return(o,n)=>{const u=T("ComponentPreview"),c=T("ClientOnly");return x(),S("div",null,[n[3]||(n[3]=E('<h1 id="sankeychart" tabindex="-1">SankeyChart <a class="header-anchor" href="#sankeychart" aria-label="Permalink to “SankeyChart”">​</a></h1><p>A flow from one set of nodes to another, a band per row.</p><h2 id="flow-between-two-columns" tabindex="-1">Flow between two columns <a class="header-anchor" href="#flow-between-two-columns" aria-label="Permalink to “Flow between two columns”">​</a></h2><p><code>source</code>, <code>target</code> and <code>value</code> name the three columns a flow needs, so the data is one row per band. The nodes are the de-duplicated union of the source and target columns: a node that a row sends flow to and another row sends flow from sits between the two, which is how a multi-stage flow is drawn. <code>linkClick</code> carries the row behind the band.</p>',4)),f(c,null,{default:y(()=>[f(u,{name:"Charts-SankeySignups","self-layout":""},{code:y(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:y(()=>[f(xs)]),_:1})]),_:1}),n[4]||(n[4]=E('<h2 id="vertical-flow" tabindex="-1">Vertical flow <a class="header-anchor" href="#vertical-flow" aria-label="Permalink to “Vertical flow”">​</a></h2><p><code>orient=&quot;vertical&quot;</code> turns the flow downwards, which suits a tall card or a graph with few stages. <code>format</code> prints every value the chart shows, on the node labels and in the tooltip alike. <code>nodeAlign</code> decides where a node with nothing leaving it sits: <code>justify</code> pushes it to the far end, <code>left</code> and <code>right</code> pin it to the end they name.</p>',2)),f(c,null,{default:y(()=>[f(u,{name:"Charts-SankeySpend","self-layout":""},{code:y(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"SankeyChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  dir"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," ChartDir")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),n[8]||(n[8]=a()),f(G,{data:h}),n[9]||(n[9]=a()),f(M,{data:e})])}}});export{Ns as __pageData,Fs as default};
