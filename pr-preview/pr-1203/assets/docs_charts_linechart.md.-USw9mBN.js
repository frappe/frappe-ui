...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(F)]),_:1})]),_:1}),n[10]||(n[10]=s("h2",{id:"a-second-value-axis",tabindex:"-1"},[a("A second value axis "),s("a",{class:"header-anchor",href:"#a-second-value-axis","aria-label":"Permalink to “A second value axis”"},"​")],-1)),n[11]||(n[11]=s("p",null,[s("code",null,"y2"),a(" names the value column or columns measured against a second value axis, drawn opposite the primary — for a measure in another unit, like a rate against dollars. "),s("code",null,"y2Axis.min"),a(" / "),s("code",null,"max"),a(" pin that scale so the line reads as over or under plan rather than as its own trend. The axis is only drawn when "),s("code",null,"y2"),a(" names a column.")],-1)),l(m,null,{default:e(()=>[l(u,{name:"Charts-LineDualAxis","self-layout":""},{code:e(()=>[...n[2]||(n[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"LineChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(E)]),_:1})]),_:1}),n[12]||(n[12]=w('<p><code>y</code> and <code>y2</code> are one list read in order: every <code>y</code> column draws and takes its palette slot first, then every <code>y2</code> column. So the three column props pair with the three axis options — <code>x</code>/<code>xAxis</code>, <code>y</code>/<code>yAxis</code>, <code>y2</code>/<code>y2Axis</code> — and which scale a series is read against is which prop named it. A <code>y2</code> series draws as the chart component&#39;s own mark, and <code>seriesConfig[key].type</code> makes it a line among bars like any other series.</p><p><code>splitBy</code> splits <code>y</code> only. A <code>y2</code> column reads per category rather than per group, so it draws as one unsplit series beside the ones <code>splitBy</code> produced, and <code>maxSeries</code> caps only those.</p><h2 id="filling-one-series" tabindex="-1">Filling one series <a class="header-anchor" href="#filling-one-series" aria-label="Permalink to “Filling one series”">​</a></h2><p><code>seriesConfig[key].type</code> sets the mark a single series draws as, so one line of a <code>LineChart</code> carries a fill on <code>type: &#39;area&#39;</code> while the rest stay bare. There is no separate fill flag: an area <em>is</em> a filled line. The same key takes <code>&#39;bar&#39;</code>, which is what makes a combo chart.</p>',4)),l(m,null,{default:e(()=>[l(u,{name:"Charts-LineFilledSeries","self-layout":""},{code:e(()=>[...n[3]||(n[3]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"LineChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(O)]),_:1})]),_:1}),n[14]||(n[14]=w(`<p>A reference line is an annotation, not a series: it has no legend entry, it is never in the tooltip, and it cannot be switched off — which is what a threshold has to be to stay comparable. A line outside the range the plot covers is not drawn, because stretching the scale to fit a distant target would flatten the data it is meant to be read against; pin <code>yAxis.min</code> / <code>max</code> instead.</p><h2 id="context-in-the-tooltip" tabindex="-1">Context in the tooltip <a class="header-anchor" href="#context-in-the-tooltip" aria-label="Permalink to “Context in the tooltip”">​</a></h2><p><code>tooltipColumns</code> names columns that reach the tooltip and nothing else: no mark, no legend entry, no palette slot, no place on the value axis. Use it for a number that does not belong on the same scale, such as the order count behind a conversion rate.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">LineChart</span></span>
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(v,{data:c}),l(k,{data:r}),l(x,{data:t})])}}});export{ms as __pageData,ys as default};
