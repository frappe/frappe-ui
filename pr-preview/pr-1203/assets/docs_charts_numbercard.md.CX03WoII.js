import{_ as z}from"./chunks/PropsTable.BiOWUS0m.js";import{_ as j}from"./chunks/SlotsTable.BjGpxglL.js";import{N as C}from"./chunks/theme.DfPdRaGF.js";import{_ as f}from"./chunks/NumberCard.vue_vue_type_script_setup_true_lang.DYB3Vqcm.js";import{J as k,ae as t,r as _,F as g,an as b,E as e,aG as r,$ as x,a2 as S,M as T,bf as p,o as s,aw as O,p as A,ak as P,ap as w,B as y,D as a}from"./chunks/framework.DB21G0mT.js";import"./chunks/format.D71xb81m.js";import"./chunks/tokens.Cw_8PWQl.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.C33iBEJj.js";const R={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},D=k({__name:"NumberSparklines",setup(m){const l=[{title:"Signups",value:1284,delta:12.5,deltaSuffix:"%",deltaCaption:"vs last month",sparkline:{data:[842,906,971,1044,1123,1018,1067,1142,1196,1218,1247,1284]}},{title:"Orders shipped",value:2560,sparkline:{data:[1786,1852,1921,2094,2274,2064,2120,2222,2292,2378,2452,2560],type:"bar"}},{title:"Pipeline",value:1845e4,prefix:"$",format:i=>new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1}).format(i),sparkline:{data:[12.4,13.1,13.9,15.2,16,15.1,15.8,16.4,17.1,17.6,18,18.45]}},{title:"Storage used",value:61,suffix:"%",color:"#f59e0b",sparkline:{data:[42,44,46,49,51,52,54,56,57,59,60,61],color:"#f59e0b"}}];return(i,u)=>(t(),_("div",R,[(t(),_(g,null,b(l,v=>e(r(f),x({key:v.title},{ref_for:!0},v),null,16)),64))]))}}),E={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},N={type:"button",class:"-mx-1 flex h-5 min-w-0 items-center gap-1 rounded-sm px-1 text-sm text-ink-gray-5 outline-none hover:bg-surface-gray-2 hover:text-ink-gray-7 focus-visible:ring-2 focus-visible:ring-outline-gray-3"},L={class:"truncate"},B=k({__name:"NumberKpis",setup(m){const o=[{title:"Net revenue",value:220200,target:25e4,prefix:"$",format:l=>new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1}).format(l),delta:5.1,deltaSuffix:"%",sparkline:{data:[144500,150700,157400,172700,188600,171700,177100,186700,193600,202100,209500,220200]}},{title:"Monthly churn",value:2.1,suffix:"%",format:l=>l.toFixed(1),delta:-.4,deltaSuffix:"pts",deltaCaption:"vs last month",negativeIsBetter:!0},{title:"Orders shipped",value:2560},{title:"Refunds",value:null}],n=P("last month"),c=["last month","last quarter","last year"].map(l=>({label:`vs ${l}`,onClick:()=>n.value=l}));return(l,i)=>(t(),_("div",E,[e(r(f),S(T(o[0])),{caption:p(()=>[e(r(C),{options:r(c),placement:"left"},{default:p(()=>[s("button",N,[s("span",L,"vs "+O(n.value),1),i[0]||(i[0]=s("span",{class:"lucide-chevron-down size-3.5 shrink-0","aria-hidden":"true"},null,-1))])]),_:1},8,["options"])]),_:1},16),(t(!0),_(g,null,b(o.slice(1),u=>(t(),A(r(f),x({key:u.title},{ref_for:!0},u),null,16))),128))]))}}),G=JSON.parse('{"title":"NumberCard","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/numbercard.md","filePath":"docs/charts/numbercard.md","lastUpdated":0}'),F={name:"docs/charts/numbercard.md"},Y=Object.assign(F,{setup(m){const h=[{name:"title",description:`Heads the card. Left out, the chart draws no header row at all.
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),e(j,{data:d})])}}});export{G as __pageData,Y as default};
