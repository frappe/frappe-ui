import{ak as m,b9 as k,b3 as y,ae as T,r as I,E as e,bf as r,aG as t,o as l,D as S,bg as $,bh as u,bj as f,b7 as R}from"./framework.DB21G0mT.js";import{bz as D,a1 as V,U as z,_ as w,b2 as A,a0 as B}from"./theme.bTWfBd4s.js";import{u as C,z as F,x as H,P as L,H as N,g as O,h as U,S as o,c as q,q as j,w as E,d as K,O as P,a as M,A as W,b as G,F as Y,m as J,p as Q,n as X,B as Z,I as ee,j as te,o as se,U as ae,R as oe,y as ne}from"./kits.lYST2lA0.js";import"./codemirror.C6qLgMOw.js";const re={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ie={class:"flex shrink-0 items-center space-x-2"},le={class:"w-full overflow-x-auto"},pe={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},de=["onKeydown"],we={__name:"ComposeDesktop",setup(ce){const b=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[C.configure({mention:{items:b}})],v=[L,N,O,U,o,q,j,E,o,K,P,o,M,W,G,Y,o,J,Q,X,Z,ee,te,o,se,o,ae,oe],p={light:"/pr-preview/pr-1203/recipes/compose-dashboard-light.png",dark:"/pr-preview/pr-1203/recipes/compose-dashboard-dark.png"},h=D(),d=m("Design review: new onboarding flow"),i=m(`
...
`);k(h,(n,s)=>{i.value=i.value.replace(p[s],p[n])});const _=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:x}=y({input:d});return(n,s)=>(T(),I("div",re,[e(t(B),null,{default:r(()=>[e(t(F),{modelValue:i.value,"onUpdate:modelValue":s[1]||(s[1]=a=>i.value=a),extensions:g,"upload-function":_,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:a})=>[e(t(V),null,{default:r(()=>[e(t(z),{items:[{label:"Drafts"},{label:"New discussion"}]}),l("div",ie,[e(t(w),{variant:"ghost",icon:"lucide-trash-2",label:"Delete draft"}),e(t(w),{variant:"solid"},{default:r(()=>[...s[2]||(s[2]=[S("Publish",-1)])]),_:1})])]),_:1}),e(t(A),{class:"flex h-10 items-center border-b bg-surface-base px-3 sm:px-5"},{default:r(()=>[l("div",le,[e(t(H),{editor:a,items:v},null,8,["editor"])])]),_:2},1024),l("div",pe,[$(l("textarea",{ref_key:"titleTextarea",ref:x,class:"mt-1 w-full resize-none border-0 bg-transparent px-0 py-0.5 text-4xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":s[0]||(s[0]=c=>d.value=c),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[u(f(c=>a.commands.focus(),["prevent"]),["enter"]),u(f(c=>a.commands.focus(),["prevent"]),["down"])]},null,40,de),[[R,d.value]]),e(t(ne),{editor:a,class:"prose-v3 -mx-2 min-h-[calc(100vh-200px)] max-w-[unset] overflow-auto px-2 pb-40"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1})]))}};export{we as default};
