import{_ as m}from"./chunks/PropsTable.BiOWUS0m.js";import{_ as b}from"./chunks/SlotsTable.BjGpxglL.js";import{_ as x}from"./chunks/EmitsTable.BMP93B_8.js";import{aK as v,a4 as C,a6 as q,a7 as y,aL as E,aM as U,a3 as $,N as A,K as k}from"./chunks/theme.DfPdRaGF.js";import{J as j,ae as d,r as h,o as s,E as l,aG as p,p as F,aw as S,q as P,ak as u,bf as e,D as a,F as L,an as R,a1 as H,ap as N,B as I}from"./chunks/framework.DB21G0mT.js";const V={class:"grid w-full max-w-lg grid-cols-2 items-start gap-4"},G={class:"rounded-5 bg-surface-gray-1 p-3"},Y={class:"rounded-5 bg-surface-gray-1 p-3"},J={class:"rounded-5 bg-surface-gray-1 p-3"},Q={class:"rounded-5 bg-surface-gray-1 p-3"},X={key:0,class:"col-span-2 text-sm text-ink-gray-5"},Z=j({__name:"Card",setup(g){const i=u(!0),o=u("");return(w,c)=>(d(),h("div",V,[s("div",G,[l(p(v),{title:"Your trial ends soon!",description:"Upgrade to keep enjoying features.",action:{label:"Update now",onClick:()=>{o.value="Billing page opened"}}},null,8,["action"])]),s("div",Y,[i.value?(d(),F(p(v),{key:0,theme:"blue",dismissible:"",title:"New feature available",description:"Discover the new board view for your deals.",action:{label:"Explore now",onClick:({dismiss:t})=>(o.value="Board view opened",t())},onDismiss:c[0]||(c[0]=t=>i.value=!1)},null,8,["action"])):(d(),h("button",{key:1,class:"text-sm text-ink-gray-5 underline",onClick:c[1]||(c[1]=t=>i.value=!0)}," Bring the card back "))]),s("div",J,[l(p(v),{theme:"amber",title:"Storage is almost full",description:"Free up space or upgrade your plan.",action:{label:"Manage storage",onClick:()=>{o.value="Storage settings opened"}}},null,8,["action"])]),s("div",Q,[l(p(v),{theme:"red",title:"Payment failed",description:"Update your card to avoid interruption.",action:{label:"Fix billing",onClick:()=>{o.value="Card details opened"}}},null,8,["action"])]),o.value?(d(),h("p",X,S(o.value),1)):P("",!0)]))}}),ss={class:"flex h-[360px] w-fit overflow-hidden rounded-5 border"},as={class:"flex-1 overflow-y-auto px-2 pt-2"},ns=j({__name:"Section",setup(g){const i=u("leads"),o=u(!1);return(w,c)=>(d(),h("div",ss,[l(p(C),{collapsible:!1,width:"14rem"},{default:e(()=>[s("div",as,[l(p(q),null,{default:e(()=>[...c[5]||(c[5]=[a("Pipeline",-1)])]),_:1}),l(p(y),{label:"Leads",icon:"lucide-user-plus",active:i.value==="leads",onClick:c[0]||(c[0]=t=>i.value="leads")},null,8,["active"]),l(p(y),{label:"Deals",icon:"lucide-handshake",active:i.value==="deals",onClick:c[1]||(c[1]=t=>i.value="deals")},null,8,["active"]),l(p(E),{label:"Views",collapsible:"",collapsed:o.value,"onUpdate:collapsed":c[4]||(c[4]=t=>o.value=t)},{default:e(()=>[l(p(y),{label:"My Open Deals",icon:"lucide-flame",active:i.value==="my-open-deals",onClick:c[2]||(c[2]=t=>i.value="my-open-deals")},null,8,["active"]),l(p(y),{label:"Unassigned",icon:"lucide-circle-dashed",active:i.value==="unassigned",onClick:c[3]||(c[3]=t=>i.value="unassigned")},null,8,["active"])]),_:1},8,["collapsed"])])]),_:1})]))}}),ls={class:"flex h-[360px] w-fit overflow-hidden rounded-5 border"},es={class:"flex-1 overflow-y-auto px-2 pt-2"},ps={class:"mt-auto px-2 pb-2"},cs=j({__name:"Collapsed",setup(g){const i=u(!0),o=u("inbox"),w=[{id:"inbox",label:"Inbox",icon:"lucide-inbox"},{id:"starred",label:"Starred",icon:"lucide-star"},{id:"sent",label:"Sent",icon:"lucide-send"}];return(c,t)=>(d(),h("div",ls,[l(p(C),{collapsed:i.value,"onUpdate:collapsed":t[0]||(t[0]=_=>i.value=_)},{default:e(()=>[s("div",es,[l(p(q),{divider:""},{default:e(()=>[...t[1]||(t[1]=[a("Mail",-1)])]),_:1}),(d(),h(L,null,R(w,_=>l(p(y),{key:_.id,icon:_.icon,label:_.label,active:o.value===_.id,onClick:r=>o.value=_.id},null,8,["icon","label","active","onClick"])),64))]),s("div",ps,[l(p(U))])]),_:1},8,["collapsed"])]))}}),ts={class:"flex h-[560px] w-fit overflow-hidden rounded-5 border"},is={class:"flex h-7 items-center justify-between"},os={class:"flex items-center"},_s={class:"mt-0.5 space-y-0.5"},rs={class:"flex-1 truncate text-sm"},ds={class:"relative mr-1 flex size-7 shrink-0 items-center justify-end [@media(hover:none)]:w-auto [@media(hover:none)]:gap-1"},hs={key:0,class:"absolute right-1 text-xs text-ink-gray-5 transition-opacity group-hover/sidebar-item:opacity-0 group-focus-within/sidebar-item:opacity-0 [@media(hover:none)]:static [@media(hover:none)]:opacity-100"},us=j({__name:"Default",setup(g){const i=u("product"),o=u("Recent activity"),w=[{id:"product",title:"Product",icon:"lucide-rocket",unread:0},{id:"design",title:"Design",icon:"lucide-palette",unread:3},{id:"engineering",title:"Engineering",icon:"lucide-code",unread:12},{id:"marketing",title:"Marketing",icon:"lucide-megaphone",unread:0},{id:"sales",title:"Sales",icon:"lucide-trending-up",unread:1},{id:"support",title:"Customer Support",icon:"lucide-headphones",unread:0},{id:"people",title:"People & Culture",icon:"lucide-users",unread:0},{id:"finance",title:"Finance",icon:"lucide-wallet",unread:0},{id:"leadership",title:"Leadership",icon:"lucide-crown",unread:2},{id:"design-system",title:"Design System",icon:"lucide-component",unread:0},{id:"research",title:"User Research",icon:"lucide-microscope",unread:5},{id:"ops",title:"Operations",icon:"lucide-settings-2",unread:0},{id:"events",title:"Events",icon:"lucide-party-popper",unread:0},{id:"data",title:"Data & Analytics",icon:"lucide-database",unread:8},{id:"brand",title:"Brand",icon:"lucide-sparkles",unread:0},{id:"partnerships",title:"Partnerships",icon:"lucide-handshake",unread:0},{id:"security",title:"Security",icon:"lucide-shield",unread:0},{id:"onboarding",title:"Onboarding",icon:"lucide-graduation-cap",unread:0},{id:"random",title:"Random",icon:"lucide-shuffle",unread:0}],c=[{group:"Sort by",options:["Recent activity","Alphabetical"].map(t=>({label:t,icon:o.value===t?"lucide-check":null,onClick:()=>o.value=t}))}];return(t,_)=>(d(),h("div",ts,[l(p(C),{collapsible:!1,width:"14rem"},{default:e(()=>[_[1]||(_[1]=s("div",{class:"flex shrink-0 items-center p-2"},[s("button",{class:"flex h-8 w-full items-center gap-2 rounded-4 px-1 transition hover:bg-surface-gray-2"},[s("img",{src:"https://api.dicebear.com/9.x/glass/svg?seed=Lumen",alt:"",class:"size-6 shrink-0 rounded-4"}),s("span",{class:"flex-1 truncate text-left text-base text-ink-gray-8"},"Lumen Labs"),s("span",{class:"lucide-chevrons-up-down size-4 shrink-0 text-ink-gray-5"})])],-1)),l(p($),{class:"min-h-0 flex-1","viewport-class":"px-2 pt-0.5 pb-10"},{default:e(()=>[s("div",is,[l(p(q),null,{default:e(()=>[..._[0]||(_[0]=[a("Spaces",-1)])]),_:1}),s("div",os,[l(p(A),{options:c,align:"end"},{trigger:e(({open:r})=>[l(p(k),{variant:"ghost",size:"sm",icon:"lucide-arrow-up-down text-ink-gray-5",label:"Sort spaces",tooltip:"Sort spaces",active:r},null,8,["active"])]),_:1}),l(p(k),{variant:"ghost",size:"sm",icon:"lucide-plus text-ink-gray-5",label:"New space"})])]),s("div",_s,[(d(),h(L,null,R(w,r=>l(p(y),{key:r.id,icon:r.icon,active:i.value===r.id,onClick:f=>i.value=r.id},{suffix:e(()=>[s("div",ds,[r.unread>0?(d(),h("span",hs,S(r.unread),1)):P("",!0),l(p(A),{options:[{label:"Mark all as read"},{label:"Leave space"}],align:"start",side:"right"},{default:e(({open:f})=>[l(p(k),{variant:f?"subtle":"ghost",size:"xs",icon:"lucide-more-horizontal text-ink-gray-5",label:`${r.title} options`,class:H(["absolute right-0 -mr-0.5 opacity-0 group-hover/sidebar-item:opacity-100 group-focus-within/sidebar-item:opacity-100 [@media(hover:none)]:static [@media(hover:none)]:opacity-100",f?"opacity-100":""])},null,8,["variant","label","class"])]),_:2},1024)])]),default:e(()=>[s("span",rs,S(r.title),1)]),_:2},1032,["icon","active","onClick"])),64))])]),_:1})]),_:1})]))}}),vs=JSON.parse('{"title":"Sidebar","description":"","frontmatter":{},"headers":[],"relativePath":"docs/components/sidebar.md","filePath":"docs/components/sidebar.md","lastUpdated":1779053387000}'),ws={name:"docs/components/sidebar.md"},js=Object.assign(ws,{setup(g){const i=[{name:"collapsible",description:"Allows the sidebar to collapse. Default: `true`.",required:!1,type:"boolean",default:"true"},{name:"width",description:"Expanded width as a CSS length. Applied inline so apps can override it.",required:!1,type:"string",default:'"15rem"'},{name:"collapsedWidth",description:"Collapsed width as a CSS length.",required:!1,type:"string",default:'"3rem"'},{name:"ariaLabel",description:"Accessible name of the `<nav>` landmark. Default: `'Main'`. Give a second\nsidebar on the same page its own name, and translate it in a localised\napp — the library ships no translation layer.",required:!1,type:"string",default:'"Main"'},{name:"collapsed",description:"v-model. Whether the sidebar is collapsed. Left unset, it collapses automatically below the `sm` breakpoint.",required:!1,type:"boolean | null",default:"null"}],o=[{name:"default",description:"The sidebar body — header, scroll region, footer, all composed by the app.",type:"any"}],w=[{name:"update:collapsed",description:"Fired when the sidebar is collapsed or expanded.",type:"[value: boolean | null]"}],c=[{name:"label",description:"Row label. Used as the accessible name and the default slot fallback.",required:!1,type:"string"},{name:"accessKey",description:"`accesskey` attribute for a keyboard shortcut.",required:!1,type:"string"},{name:"icon",description:"Leading icon: a `lucide-*` class, an emoji, or a component. Any other\nstring renders nothing and warns in dev — put initials in the `#prefix`\nslot instead. Ignored when the `#prefix` slot is used.",required:!1,type:"string | Component"},{name:"suffix",description:"Trailing text. Ignored when the `#suffix` slot is used.",required:!1,type:"string"},{name:"route",description:"Navigation target. When set the row's main area renders as a router link;\notherwise it renders as a button. A click still invokes `onClick`.",required:!1,type:"RouteDestination"},{name:"href",description:"External URL. Used when `route` is absent; renders a native same-tab anchor.",required:!1,type:"string"},{name:"active",description:'Marks the row active (`data-state="active"`). When omitted, active state is\ninferred by matching `route` against the current route.',required:!1,type:"boolean"},{name:"onClick",description:"Click handler. Bound from `@click`.",required:!1,type:"((event: MouseEvent) => void)"}],t=[{name:"prefix",description:"Leading icon or avatar. Overrides the `icon` prop.",type:"any"},{name:"default",description:"The label region. Overrides the `label` prop; put inline adornments here.",type:"any"},{name:"suffix",description:"The trailing zone — a sibling of the link/button, not nested inside it. Overrides the `suffix` prop.",type:"any"}],_=[{name:"divider",description:"When true, collapses to a horizontal divider while the sidebar is collapsed\n(matches the previous `SidebarSection` label behavior).",required:!1,type:"boolean"}],r=[{name:"default",description:"The label text.",type:"any"}],f=[{name:"title",description:"Workspace or app title.",required:!0,type:"string"},{name:"subtitle",description:"Secondary line under the title, e.g. a domain or workspace slug.",required:!1,type:"string"},{name:"logo",description:"Leading logo: an image URL, or a component. Overridden by the `#prefix` slot.",required:!1,type:"string | Component"},{name:"showLogo",description:"Whether to render the leading logo/avatar box. Defaults to `true`. Set to\n`false` when workspace identity is already shown elsewhere (e.g. a left\nrail) to avoid a duplicate avatar; the title then sits flush-left. Best\npaired with a non-collapsing sidebar, since a collapsed header with no logo\nhas nothing to show.",required:!1,type:"boolean",default:"true"},{name:"menuItems",description:"Options rendered in the trigger's dropdown — the same shape `Dropdown` itself takes.",required:!1,type:"MenuOptions"}],T=[{name:"prefix",description:"Fills the default logo/initial box (a `size-7 overflow-hidden` frame — wide content clips). Falls back to the `logo` prop, then the title's first letter.",type:"any"}],D=[{name:"label",description:"Section label. Renders nothing when omitted (a label-less group).",required:!1,type:"string"},{name:"collapsible",description:"Whether clicking the label toggles the group's visibility.",required:!1,type:"boolean"},{name:"collapsed",description:"v-model. Whether the section is collapsed. Bind it to own the state (start a section collapsed, persist the choice); left unbound the section manages it internally, starting expanded.",required:!1,type:"boolean",default:"false"}],M=[{name:"default",description:"The group's rows — compose `SidebarItem` (or anything else) here.",type:"any"}],W=[{name:"update:collapsed",description:"Fired when the section is collapsed or expanded.",type:"[value: boolean]"}],O=[{name:"title",description:"Main heading text of the card. Optional when the `#title` slot is used",required:!1,type:"string"},{name:"description",description:"Supporting text below the title",required:!1,type:"string"},{name:"theme",description:"Color theme of the icon and the tinted action button; the white container never changes with theme",required:!1,type:"StatusTheme",default:'"gray"'},{name:"icon",description:"Icon next to the title: unset shows the theme's auto icon (gray shows the info glyph in black ink), `false` hides it, a `lucide-*` string or Component renders a custom theme-colored glyph",required:!1,type:"boolean | string | Component"},{name:"action",description:"The full-width tinted action button (`ButtonProps` plus `onClick({ dismiss })`)",required:!1,type:"AlertAction"},{name:"dismissible",description:"Shows the dismiss (×) button, which emits `dismiss`",required:!1,type:"boolean",default:"false"}],K=[{name:"prefix",description:"Overrides the icon area next to the title",type:"any"},{name:"title",description:"Rich title content (overrides the `title` prop)",type:"any"},{name:"description",description:"Rich description content (overrides the `description` prop)",type:"any"},{name:"actions",description:"Replaces the auto-rendered action button; receives `{ dismiss }`",type:"SidebarCardActionsSlotProps"}],B=[{name:"dismiss",description:"Fired when the user dismisses the card — the × button or the action's `context.dismiss()`. The parent owns hiding.",type:"[]"}];return(ms,n)=>{const z=N("ComponentPreview");return d(),h("div",null,[n[10]||(n[10]=s("h1",{id:"sidebar",tabindex:"-1"},[a("Sidebar "),s("a",{class:"header-anchor",href:"#sidebar","aria-label":"Permalink to “Sidebar”"},"​")],-1)),n[11]||(n[11]=s("p",null,[a("The wide navigation column of an app. You fill it with "),s("code",null,"SidebarItem"),a(", "),s("code",null,"SidebarSection"),a(" and your own markup.")],-1)),l(z,{name:"Sidebar-Default"},{code:e(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"// spaces with lucide icons, unread counts, and a hover-reveal")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"product"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Product"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-rocket"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"design"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Design"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-palette"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 3"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"engineering"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Engineering"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-code"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 12"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"marketing"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Marketing"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-megaphone"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"sales"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Sales"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-trending-up"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 1"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"support"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Customer Support"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-headphones"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"people"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"People & Culture"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-users"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"finance"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Finance"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-wallet"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"leadership"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Leadership"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-crown"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 2"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"design-system"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Design System"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-component"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"research"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"User Research"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-microscope"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 5"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"ops"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Operations"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-settings-2"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"events"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Events"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-party-popper"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"data"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Data & Analytics"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-database"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 8"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"brand"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Brand"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-sparkles"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"partnerships"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Partnerships"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-handshake"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"security"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Security"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-shield"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"onboarding"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Onboarding"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-graduation-cap"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," id"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"random"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Random"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," icon"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"lucide-shuffle"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," unread"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 0"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    <"),s("span",{class:"s_wac0bt"},"Sidebar"),s("span",{class:"s_1i4ay4"}," :collapsible"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"false"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1i4ay4"}," width"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"14rem"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"          <"),s("span",{class:"s_1uuh8p"},"img")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"            src"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"https://api.dicebear.com/9.x/glass/svg?seed=Lumen"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"            alt"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'""')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"            class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"size-6 shrink-0 rounded-4"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"          />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"          <"),s("span",{class:"s_1uuh8p"},"span"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"flex-1 truncate text-left text-base text-ink-gray-8"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"            >"),s("span",{class:"s_6am9cx"},"Lumen Labs"),s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"span")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"          >")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"          <"),s("span",{class:"s_1uuh8p"},"span")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"            class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"lucide-chevrons-up-down size-4 shrink-0 text-ink-gray-5"),s("span",{class:"s_w1p9wo"},'"')]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"        </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"        <"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"mt-0.5 space-y-0.5"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"          >")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"            <"),s("span",{class:"s_1uuh8p"},"span"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"flex-1 truncate text-sm"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">"),s("span",{class:"s_6am9cx"},"{{ space.title }}"),s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"span"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"                SidebarItem's root (`group/sidebar-item`). Where nothing can")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"                hover the trade never happens, so the cell widens and holds")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"                both side by side instead of one over the other.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"              -->")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"              <"),s("span",{class:"s_1uuh8p"},"div")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"                class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"relative mr-1 flex size-7 shrink-0 items-center justify-end [@media(hover:none)]:w-auto [@media(hover:none)]:gap-1"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"              >")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"                <"),s("span",{class:"s_1uuh8p"},"span")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"                  class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"absolute right-1 text-xs text-ink-gray-5 transition-opacity group-hover/sidebar-item:opacity-0 group-focus-within/sidebar-item:opacity-0 [@media(hover:none)]:static [@media(hover:none)]:opacity-100"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"                >")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_2575z4"},"                    { label: 'Mark all as read' },")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_2575z4"},"                    { label: 'Leave space' },")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"                      class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"absolute right-0 -mr-0.5 opacity-0 group-hover/sidebar-item:opacity-100 group-focus-within/sidebar-item:opacity-100 [@media(hover:none)]:static [@media(hover:none)]:opacity-100"),s("span",{class:"s_w1p9wo"},'"')]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(us)]),_:1}),n[12]||(n[12]=I(`<h2 id="anatomy" tabindex="-1">Anatomy <a class="header-anchor" href="#anatomy" aria-label="Permalink to “Anatomy”">​</a></h2><p><code>Sidebar</code> is a fixed-width column with one slot, and it owns collapsing. It has no layout slots and does not scroll, so lay out the header, the scrolling list and the footer yourself with flex classes.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">Sidebar</span><span class="s_1i4ay4"> v-model</span><span class="s_1jjt6x">:</span><span class="s_1i4ay4">collapsed</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">collapsed</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_6am9cx">  &lt;SidebarHeader title=&quot;Acme&quot; :menu-items=&quot;workspaceMenu&quot; /&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_6am9cx">  &lt;div class=&quot;flex-1 overflow-y-auto&quot;&gt;</span></span>
<span class="line"><span class="s_6am9cx">    &lt;SidebarItem label=&quot;Inbox&quot; icon=&quot;lucide-inbox&quot; route=&quot;/inbox&quot; /&gt;</span></span>
<span class="line"><span class="s_6am9cx">    &lt;SidebarLabel&gt;Projects&lt;/SidebarLabel&gt;</span></span>
<span class="line"><span class="s_6am9cx">    &lt;SidebarItem label=&quot;Website&quot; icon=&quot;lucide-globe&quot; route=&quot;/p/website&quot; /&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_6am9cx">    &lt;SidebarSection label=&quot;Archived&quot; collapsible&gt;</span></span>
<span class="line"><span class="s_6am9cx">      &lt;SidebarItem label=&quot;Q3 launch&quot; route=&quot;/p/q3&quot; /&gt;</span></span>
<span class="line"><span class="s_6am9cx">    &lt;/SidebarSection&gt;</span></span>
<span class="line"><span class="s_6am9cx">  &lt;/div&gt;</span></span>
<span class="line"></span>
<span class="line"><span class="s_6am9cx">  &lt;SidebarCard class=&quot;mt-auto&quot; title=&quot;Trial ends in 5 days&quot; :action=&quot;upgrade&quot; /&gt;</span></span>
<span class="line"><span class="s_6am9cx">  &lt;SidebarCollapseToggle /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">Sidebar</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><h2 id="examples" tabindex="-1">Examples <a class="header-anchor" href="#examples" aria-label="Permalink to “Examples”">​</a></h2><h3 id="collapsing-to-icons" tabindex="-1">Collapsing to icons <a class="header-anchor" href="#collapsing-to-icons" aria-label="Permalink to “Collapsing to icons”">​</a></h3><p>A collapsed sidebar shows only icons. <code>SidebarCollapseToggle</code> switches between the two widths, and <code>SidebarLabel divider</code> turns a section label into a line while collapsed.</p>`,6)),l(z,{name:"Sidebar-Collapsed"},{code:e(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ref"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_4q1z3w"},"  Sidebar"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_4q1z3w"},"  SidebarItem"),s("span",{class:"s_1jjt6x"},",")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_wac0bt"},"Sidebar"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(cs)]),_:1}),n[13]||(n[13]=s("h3",{id:"collapsible-sections",tabindex:"-1"},[a("Collapsible sections "),s("a",{class:"header-anchor",href:"#collapsible-sections","aria-label":"Permalink to “Collapsible sections”"},"​")],-1)),n[14]||(n[14]=s("p",null,[s("code",null,"SidebarSection"),a(" adds a label row that opens and closes the items under it.")],-1)),l(z,{name:"Sidebar-Section"},{code:e(()=>[...n[2]||(n[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ref"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_wac0bt"},"Sidebar"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(ns)]),_:1}),n[15]||(n[15]=s("h3",{id:"trial-notice",tabindex:"-1"},[a("Trial notice "),s("a",{class:"header-anchor",href:"#trial-notice","aria-label":"Permalink to “Trial notice”"},"​")],-1)),n[16]||(n[16]=s("p",null,[s("code",null,"SidebarCard"),a(" holds a notice at the foot of the sidebar: a trial ending, an upgrade offer, or a pointer to what is new.")],-1)),l(z,{name:"Sidebar-Card"},{code:e(()=>[...n[3]||(n[3]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ref"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(Z)]),_:1}),n[17]||(n[17]=I('<h2 id="behavior" tabindex="-1">Behavior <a class="header-anchor" href="#behavior" aria-label="Permalink to “Behavior”">​</a></h2><h3 id="collapse" tabindex="-1">Collapse <a class="header-anchor" href="#collapse" aria-label="Permalink to “Collapse”">​</a></h3><p>Bind <code>v-model:collapsed</code> to control collapsing. Left unbound, the sidebar collapses by itself below the <code>sm</code> breakpoint. <code>:collapsible=&quot;false&quot;</code> keeps it open. <code>width</code> and <code>collapsedWidth</code> take CSS lengths.</p><h3 id="items" tabindex="-1">Items <a class="header-anchor" href="#items" aria-label="Permalink to “Items”">​</a></h3><p><code>SidebarItem</code> is one row: a link or button, and a separate area after it for <code>#suffix</code>. The suffix sits beside the link rather than inside it, so a menu button there is valid HTML.</p><ul><li><code>#prefix</code> holds a leading icon or avatar. Without it, the <code>icon</code> prop is used: a <code>lucide-*</code> class, an emoji or a component. Any other string shows nothing and logs a warning in development, so put initials in <code>#prefix</code>.</li><li>The default slot holds the label, and falls back to the <code>label</code> prop.</li><li><code>#suffix</code> holds an unread count or an options menu.</li></ul><p><code>route</code> renders a router link and <code>href</code> a plain link. <code>route</code> wins when both are set, and a row with neither is a button. <code>active</code> marks the current row. Left unset, it is worked out by matching <code>route</code> against the current route.</p><h3 id="header" tabindex="-1">Header <a class="header-anchor" href="#header" aria-label="Permalink to “Header”">​</a></h3><p><code>SidebarHeader</code> is the 48px row at the top, level with <code>PageHeader</code>. It shows <code>title</code>, <code>subtitle</code>, and a square logo from <code>#prefix</code>, the <code>logo</code> prop, or the title&#39;s first letter. <code>:show-logo=&quot;false&quot;</code> removes the square. With <code>menuItems</code> the header opens a dropdown, which takes the same options as <code>Dropdown</code>. Without them it is plain text, and the logo and title stay in the same place.</p><h3 id="sections" tabindex="-1">Sections <a class="header-anchor" href="#sections" aria-label="Permalink to “Sections”">​</a></h3><p>Bind <code>v-model:collapsed</code> on a <code>SidebarSection</code> to start it closed or to remember the choice. Left unbound, it starts open and keeps its own state. For a group that never collapses, use <code>SidebarLabel</code> and <code>SidebarItem</code> without a section.</p><h3 id="card" tabindex="-1">Card <a class="header-anchor" href="#card" aria-label="Permalink to “Card”">​</a></h3><p><code>SidebarCard</code> does not hide itself. It emits <code>dismiss</code>, and the parent removes it. <code>action</code> takes <code>Button</code> props and an <code>onClick({ dismiss })</code> handler, the same shape as <code>Alert</code>&#39;s actions. <code>#prefix</code>, <code>#title</code>, <code>#description</code> and <code>#actions</code> replace each part.</p><h3 id="attributes" tabindex="-1">Attributes <a class="header-anchor" href="#attributes" aria-label="Permalink to “Attributes”">​</a></h3><p>Attributes on <code>SidebarItem</code> go to two places. <code>class</code>, <code>style</code> and event listeners go on the row, so a background or a drop target covers the <code>#suffix</code> area too. Every other attribute (<code>target</code>, <code>rel</code>, <code>id</code>, <code>title</code>, <code>data-*</code>, <code>aria-*</code>) goes on the link or button inside. Your <code>aria-label</code> replaces the one taken from the label.</p><h2 id="accessibility" tabindex="-1">Accessibility <a class="header-anchor" href="#accessibility" aria-label="Permalink to “Accessibility”">​</a></h2><p><code>Sidebar</code> renders a <code>&lt;nav&gt;</code> named &quot;Main&quot;. Set <code>ariaLabel</code> to rename it, when a page has a second sidebar or to translate it. It is the only landmark in the family, so keep your own wrappers as plain <code>div</code>s.</p><p><code>SidebarSection</code> marks its items as a group, named by its label. A collapsible section&#39;s toggle reports whether it is open.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2><h3 id="sidebar-1" tabindex="-1">Sidebar <a class="header-anchor" href="#sidebar-1" aria-label="Permalink to “Sidebar”">​</a></h3>',20)),l(m,{name:"Sidebar",data:i},{code:e(()=>[...n[4]||(n[4]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteDestination"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/route"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"MenuOptions"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Menu/types"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"/**")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Allows the sidebar to collapse. Default: `true`. */")]),a(`
...
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /**")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   * Accessible name of the `<nav>` landmark. Default: `'Main'`. Give a second")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   * sidebar on the same page its own name, and translate it in a localised")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   * app — the library ships no translation layer.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  ariaLabel"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," string")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /**")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   * Leading icon: a `lucide-*` class, an emoji, or a component. Any other")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   * string renders nothing and warns in dev — put initials in the `#prefix`")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   * slot instead. Ignored when the `#prefix` slot is used.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   */")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  route"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," RouteDestination")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** External URL. Used when `route` is absent; renders a native same-tab anchor. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  href"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," string")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /**")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},'   * Marks the row active (`data-state="active"`). When omitted, active state is')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   * inferred by matching `route` against the current route.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   */")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  menuItems"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," MenuOptions")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"/**")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:o}),l(x,{data:w}),n[18]||(n[18]=s("h3",{id:"sidebaritem",tabindex:"-1"},[a("SidebarItem "),s("a",{class:"header-anchor",href:"#sidebaritem","aria-label":"Permalink to “SidebarItem”"},"​")],-1)),l(m,{name:"SidebarItem",data:c},{code:e(()=>[...n[5]||(n[5]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteDestination"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/route"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"StatusTheme"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/statusIcon"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"MenuOptions"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Menu/types"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:t}),n[19]||(n[19]=s("h3",{id:"sidebarlabel",tabindex:"-1"},[a("SidebarLabel "),s("a",{class:"header-anchor",href:"#sidebarlabel","aria-label":"Permalink to “SidebarLabel”"},"​")],-1)),l(m,{name:"SidebarLabel",data:_},{code:e(()=>[...n[6]||(n[6]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteDestination"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/route"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"StatusTheme"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/statusIcon"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"MenuOptions"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Menu/types"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:r}),n[20]||(n[20]=s("h3",{id:"sidebarheader",tabindex:"-1"},[a("SidebarHeader "),s("a",{class:"header-anchor",href:"#sidebarheader","aria-label":"Permalink to “SidebarHeader”"},"​")],-1)),l(m,{name:"SidebarHeader",data:f},{code:e(()=>[...n[7]||(n[7]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteDestination"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/route"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"StatusTheme"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/statusIcon"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"MenuOptions"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Menu/types"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:T}),n[21]||(n[21]=s("h3",{id:"sidebarsection",tabindex:"-1"},[a("SidebarSection "),s("a",{class:"header-anchor",href:"#sidebarsection","aria-label":"Permalink to “SidebarSection”"},"​")],-1)),l(m,{name:"SidebarSection",data:D},{code:e(()=>[...n[8]||(n[8]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteDestination"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/route"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"StatusTheme"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/statusIcon"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"MenuOptions"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Menu/types"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:M}),l(x,{data:W}),n[22]||(n[22]=s("h3",{id:"sidebarcard",tabindex:"-1"},[a("SidebarCard "),s("a",{class:"header-anchor",href:"#sidebarcard","aria-label":"Permalink to “SidebarCard”"},"​")],-1)),l(m,{name:"SidebarCard",data:O},{code:e(()=>[...n[9]||(n[9]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteDestination"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/route"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"StatusTheme"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../shared/statusIcon"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"MenuOptions"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Menu/types"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:K}),l(x,{data:B})])}}});export{vs as __pageData,js as default};
