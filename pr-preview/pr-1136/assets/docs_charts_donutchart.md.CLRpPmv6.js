import{_ as k}from"./chunks/PropsTable.Rcxi3dJ5.js";import{_ as g}from"./chunks/SlotsTable.Rgp3pb3z.js";import{_ as z}from"./chunks/EmitsTable.HWzQSjRa.js";import"./chunks/theme.QMc3xPle.js";import{_ as y}from"./chunks/DonutChart.vue_vue_type_script_setup_true_lang.BEaIeHMU.js";import{I as f,ad as i,r as _,D as l,aE as m,o as s,F as w,B as a,au as d,aj as x,ao as b,A as v,be as p}from"./chunks/framework.jq2RwuxR.js";import"./chunks/useChart.BV8gYJN7.js";import"./chunks/tokens.DSrhDj9L.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/axisChartCommon.DSHZBavm.js";import"./chunks/format.6x7sQhL-.js";import"./chunks/usePlotKeyboard.CGHIm6ZC.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.kITeLaXo.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.B8ZBriLk.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CsMd9Ae3.js";import"./chunks/LegendVisualProvider.B-WrYb8w.js";import"./chunks/labelGuideHelper.CvGtvYqO.js";import"./chunks/labelLayoutHelper.4DZbZmCA.js";import"./chunks/sectorHelper.J4f5C7e9.js";const j={class:"h-80 w-full"},C=f({__name:"DonutHalf",setup(o){const c=[{plan:"Starter",subscriptions:1180},{plan:"Plus",subscriptions:962},{plan:"Pro",subscriptions:418}];return(e,t)=>(i(),_("div",j,[l(m(y),{data:c,category:"plan",value:"subscriptions",variant:"half",palette:"sequential","show-inline-labels":"",title:"Plan mix",subtitle:"Active subscriptions, July 2026"})]))}}),S={class:"flex h-96 w-full flex-col gap-2"},O={class:"min-h-0 flex-1"},A={class:"text-p-sm text-ink-gray-5"},D=f({__name:"DonutOthers",setup(o){const c=[{channel:"Organic search",sessions:39900},{channel:"Paid social",sessions:21400},{channel:"Email",sessions:16800},{channel:"Direct",sessions:14700},{channel:"Referral & affiliate",sessions:8900},{channel:"Marketplace",sessions:4500},{channel:"Events",sessions:3110},{channel:"Print",sessions:1490}],e=x(null);return(t,r)=>(i(),_("div",S,[s("div",O,[l(m(y),{data:c,category:"channel",value:"sessions","max-slices":4,"center-label":"sessions",title:"Traffic by channel",subtitle:"Sessions in July 2026",onSelect:r[0]||(r[0]=n=>e.value=n)})]),s("p",A,[e.value?(i(),_(w,{key:0},[a(" Selected "+d(e.value.name)+" · "+d(Math.round(e.value.percent))+"% · "+d(e.value.rows.length)+" row(s) behind it ",1)],64)):(i(),_(w,{key:1},[a("Select a slice — Others carries every row it groups.")],64))])]))}}),P={class:"h-80 w-full"},R=f({__name:"DonutShare",setup(o){const c=[{type:"Attachments",gigabytes:812},{type:"Backups",gigabytes:604},{type:"Images",gigabytes:337},{type:"Logs",gigabytes:149},{type:"Everything else",gigabytes:62}],e=t=>t>=1024?`${(t/1024).toFixed(1)} TB`:`${t} GB`;return(t,r)=>(i(),_("div",P,[l(m(y),{data:c,category:"type",value:"gigabytes","center-label":"stored",format:e,title:"Storage by file type",subtitle:"Across every workspace"})]))}}),Z=JSON.parse('{"title":"DonutChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/donutchart.md","filePath":"docs/charts/donutchart.md","lastUpdated":0}'),T={name:"docs/charts/donutchart.md"},ss=Object.assign(T,{setup(o){const c=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
chart that fails to draw sets its own; this is for a failed request.`,required:!1,type:"string | null"},{name:"data",description:'The rows to plot. One row is one slice, before the "Others" grouping.',required:!0,type:"Record<string, any>[]"},{name:"category",description:"Row key holding the slice name.",required:!0,type:"string"},{name:"value",description:"Row key holding the slice size.",required:!0,type:"string"},{name:"maxSlices",description:'How many slices the ring holds, "Others" included. Past that the ring keeps\nthe largest `maxSlices - 1` and sums the tail into a single "Others" slice,\nnamed `OTHERS_KEY`. Defaults to 9 — a ring stops being readable long before\nthe palette runs out.',required:!1,type:"number"},{name:"showInlineLabels",description:`Prints each slice's name and share beside the ring, and drops the readout
in the middle. Off by default: the legend says the same without the
leader lines.`,required:!1,type:"boolean"},{name:"centerLabel",description:"Caption under the total in the middle. Defaults to the `value` key.",required:!1,type:"string"},{name:"variant",description:"`'half'` draws the ring as a semicircle; only the geometry changes.",required:!1,type:"DonutVariant"},{name:"format",description:"Prints every number the ring shows: the readout, the tooltip, the labels.",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'categorical'`: slices are unrelated categories, not steps.",required:!1,type:"ChartPalette"},{name:"echartOptions",description:"Escape hatch: deep-merged into the echarts option the props built.",required:!1,type:"EchartOptionsOverride"}],e=[{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"},{name:"actions",description:"",type:"any"},{name:"center",description:`Replaces the readout in the middle of the ring. Reads the total, or the
hovered slice while one is hovered.`,type:"{ value: string; label: string; percent?: string | undefined; }"},{name:"tooltip",description:"Replaces the tooltip body. `items` holds the hovered slice alone.",type:"{ items: ChartTooltipItem[]; }"}],t=[{name:"select",description:`A slice was selected, by click or by Enter on the keyboard cursor. The
"Others" slice carries every row it grouped, so a caller can drill into
the tail as well as into a named slice.`,type:"[event: DonutSliceEvent]"}];return(r,n)=>{const h=b("ComponentPreview"),u=b("ClientOnly");return i(),_("div",null,[n[4]||(n[4]=v('<h1 id="donutchart" tabindex="-1">DonutChart <a class="header-anchor" href="#donutchart" aria-label="Permalink to “DonutChart”">​</a></h1><p>A ring that reads as share of a total.</p><h2 id="share-of-a-total" tabindex="-1">Share of a total <a class="header-anchor" href="#share-of-a-total" aria-label="Permalink to “Share of a total”">​</a></h2><p><code>category</code> and <code>value</code> name the two columns a ring needs. The middle prints the total, captioned by <code>centerLabel</code>. Hovering a slice swaps the readout to that slice&#39;s value, name and share.</p><p><code>format</code> runs on the numbers the readout and the tooltip print. The inline slice labels are shares, not values, so <code>format</code> does not reach them.</p>',5)),l(u,null,{default:p(()=>[l(h,{name:"Charts-DonutShare","self-layout":""},{code:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_6am9cx"},"        Selected {{ slice.name }} · {{ Math.round(slice.percent) }}% ·")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"      show-inline-labels")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"    row"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," Record"),s("span",{class:"s_1jjt6x"},"<"),s("span",{class:"s_i592pt"},"string"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_i592pt"}," any"),s("span",{class:"s_1jjt6x"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  })"),s("span",{class:"s_50ecpt"}," =>"),s("span",{class:"s_i592pt"}," unknown")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(g,{data:e}),l(z,{data:t})])}}});export{Z as __pageData,ss as default};
