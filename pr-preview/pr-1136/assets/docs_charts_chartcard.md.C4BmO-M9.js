import{_ as r}from"./chunks/PropsTable.Rcxi3dJ5.js";import{_ as o}from"./chunks/SlotsTable.Rgp3pb3z.js";import{_ as h}from"./chunks/CustomRadar.vue_vue_type_script_setup_true_lang.BiPWMZwS.js";import{ao as p,ad as d,r as u,A as f,D as l,be as e,o as s,B as a}from"./chunks/framework.jq2RwuxR.js";import"./chunks/theme.QMc3xPle.js";import"./chunks/useChart.BV8gYJN7.js";import"./chunks/tokens.DSrhDj9L.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.kITeLaXo.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.B8ZBriLk.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.Dc0kHplF.js";import"./chunks/LegendVisualProvider.B-WrYb8w.js";import"./chunks/axisAlignTicks.CZpDrqln.js";import"./chunks/labelLayoutHelper.4DZbZmCA.js";import"./chunks/dataStackHelper.D4o8khTS.js";const E=JSON.parse('{"title":"ChartCard","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/chartcard.md","filePath":"docs/charts/chartcard.md","lastUpdated":0}'),y={name:"docs/charts/chartcard.md"},L=Object.assign(y,{setup(m){const c=[{name:"card",description:"Draws the card surface: border, background, corner radius and padding. On\nby default. Set it to `false` for a chart the app has already placed inside\na card of its own, so a bordered box does not nest in a bordered box.",required:!1,type:"boolean",default:"true"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"}],t=[{name:"default",description:"The card's contents. The card supplies the surface and clips them.",type:"any"}];return(k,n)=>{const i=p("ComponentPreview"),_=p("ClientOnly");return d(),u("div",null,[n[2]||(n[2]=f('<h1 id="chartcard" tabindex="-1">ChartCard <a class="header-anchor" href="#chartcard" aria-label="Permalink to “ChartCard”">​</a></h1><p>The card surface a chart sits on. One panel among the panels an app puts on a page, so a plot you draw yourself takes the same border, background, radius and padding as the built-in charts beside it.</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_edvzsf">import</span><span class="s_13ahmt"> { </span><span class="s_4q1z3w">ChartCard</span><span class="s_13ahmt"> }</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">frappe-ui/charts</span><span class="s_w1p9wo">&#39;</span></span></code></pre></div><p>It is a box with one slot. Give it a height — a chart fills the box it is given, and a box with no height has none to fill.</p><h2 id="dropping-the-surface" tabindex="-1">Dropping the surface <a class="header-anchor" href="#dropping-the-surface" aria-label="Permalink to “Dropping the surface”">​</a></h2><p><code>card</code> draws the surface and is on by default. Set it to <code>false</code> for a chart the app has already placed inside a card of its own: the content renders with no border, background, radius or padding, so one bordered box does not nest in another. <code>NumberCard</code> takes the same prop for the same reason.</p><p>The box stays <code>relative</code> and clipping whatever <code>card</code> says. That part is structure: a plot draws inside the box and expects the box to hold it.</p><h2 id="direction" tabindex="-1">Direction <a class="header-anchor" href="#direction" aria-label="Permalink to “Direction”">​</a></h2><p><code>dir</code> forces the layout direction to <code>&#39;ltr&#39;</code> or <code>&#39;rtl&#39;</code>. It defaults to <code>document.documentElement.dir</code>, so an app that sets the direction once at the root needs nothing here.</p>',9)),l(_,null,{default:e(()=>[l(i,{name:"Charts-CustomRadar","self-layout":""},{code:e(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"    row"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," Record"),s("span",{class:"s_1jjt6x"},"<"),s("span",{class:"s_i592pt"},"string"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_i592pt"}," any"),s("span",{class:"s_1jjt6x"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  })"),s("span",{class:"s_50ecpt"}," =>"),s("span",{class:"s_i592pt"}," unknown")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(o,{data:t})])}}});export{E as __pageData,L as default};
