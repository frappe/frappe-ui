import{_ as o}from"./chunks/PropsTable.Rcxi3dJ5.js";import{_ as h}from"./chunks/EmitsTable.HWzQSjRa.js";import{_ as d}from"./chunks/CustomRadar.vue_vue_type_script_setup_true_lang.BiPWMZwS.js";import{ao as p,ad as u,r as f,A as t,D as l,be as e,o as s,B as a}from"./chunks/framework.jq2RwuxR.js";import"./chunks/theme.QMc3xPle.js";import"./chunks/useChart.BV8gYJN7.js";import"./chunks/tokens.DSrhDj9L.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.kITeLaXo.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.B8ZBriLk.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.Dc0kHplF.js";import"./chunks/LegendVisualProvider.B-WrYb8w.js";import"./chunks/axisAlignTicks.CZpDrqln.js";import"./chunks/labelLayoutHelper.4DZbZmCA.js";import"./chunks/dataStackHelper.D4o8khTS.js";const E=JSON.parse('{"title":"ChartLegend","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/chartlegend.md","filePath":"docs/charts/chartlegend.md","lastUpdated":0}'),y={name:"docs/charts/chartlegend.md"},L=Object.assign(y,{setup(m){const c=[{name:"items",description:"One entry per series, in the order they are drawn.",required:!0,type:"ChartLegendItem[]"}],i=[{name:"change",description:"An entry was pressed: the named series' visibility flipped.",type:"[name: string]"},{name:"highlight",description:"The highlighted series, or null when the highlight clears.",type:"[name: string | null]"}];return(k,n)=>{const _=p("ComponentPreview"),r=p("ClientOnly");return u(),f("div",null,[n[2]||(n[2]=t('<h1 id="chartlegend" tabindex="-1">ChartLegend <a class="header-anchor" href="#chartlegend" aria-label="Permalink to “ChartLegend”">​</a></h1><p>The row of series names under a plot. Each entry names one mark, shows the color it is drawn in, and switches it out of the chart when pressed.</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_edvzsf">import</span><span class="s_13ahmt"> { </span><span class="s_4q1z3w">ChartLegend</span><span class="s_13ahmt"> }</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">frappe-ui/charts</span><span class="s_w1p9wo">&#39;</span></span></code></pre></div><p>It holds no state. <code>items</code> is the whole input, and the two emits report what the reader did — the chart that owns the series decides what happens next. Put it in <code>ChartContainer</code>&#39;s <code>#legend</code> slot.</p>',4)),l(r,null,{default:e(()=>[l(_,{name:"Charts-CustomRadar","self-layout":""},{code:e(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(d)]),_:1})]),_:1}),n[3]||(n[3]=t('<h2 id="entries" tabindex="-1">Entries <a class="header-anchor" href="#entries" aria-label="Permalink to “Entries”">​</a></h2><p>One <code>ChartLegendItem</code> per series, in the order the series are drawn:</p><table tabindex="0"><thead><tr><th>Field</th><th>What it is</th></tr></thead><tbody><tr><td><code>name</code></td><td>Series identity, i.e. what <code>change</code> and <code>highlight</code> report.</td></tr><tr><td><code>label</code></td><td>The name as it should read.</td></tr><tr><td><code>color</code></td><td>The color the series is drawn in.</td></tr><tr><td><code>hidden</code></td><td>Whether the series is out of the chart right now.</td></tr><tr><td><code>hint</code></td><td>A muted note after the label, e.g. a donut slice&#39;s share.</td></tr></tbody></table><p>A hidden entry keeps its place in the row and dims: the swatch fades and the label grays. A series that left the row would take its own way back with it.</p><p>The row wraps and never scrolls. It takes the lines it needs and the plot gives up the height, which the chart&#39;s resize observer picks up. A legend that scrolls hides series names behind a gesture nobody makes.</p><h2 id="toggling" tabindex="-1">Toggling <a class="header-anchor" href="#toggling" aria-label="Permalink to “Toggling”">​</a></h2><p><code>change</code> carries the <code>name</code> of the entry that was pressed. Flip that series in your own hidden list and pass the new <code>items</code> back.</p><p>Every entry is a button. The visible text is the series label, but the accessible name says what the press does — &quot;Hide Signups&quot;, &quot;Show Signups&quot; — because a toggle state alone does not read as an action. <code>aria-pressed</code> carries the state itself.</p><h2 id="highlighting" tabindex="-1">Highlighting <a class="header-anchor" href="#highlighting" aria-label="Permalink to “Highlighting”">​</a></h2><p><code>highlight</code> carries the <code>name</code> under the pointer or the focus ring, and <code>null</code> when it leaves. Use it to raise that series in the plot and mute the rest. It fires on hover and on focus alike, so a reader on the keyboard gets the same reading as one on a mouse.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2>',11)),l(o,{name:"ChartLegend",data:c},{code:e(()=>[...n[1]||(n[1]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
