import{_ as xs}from"./chunks/PropsTable.Rcxi3dJ5.js";import{_ as js}from"./chunks/SlotsTable.Rgp3pb3z.js";import{_ as zs}from"./chunks/EmitsTable.HWzQSjRa.js";import"./chunks/theme.QMc3xPle.js";import{_ as $,dy as Cs,z as Ss,G as As,a as Os,P as Ps,aq as Ds,b8 as Rs,b9 as Ts,b as Ls,dN as Es,cX as Is,dO as Ns}from"./chunks/useChart.BV8gYJN7.js";import{u as Bs}from"./chunks/usePlotKeyboard.CGHIm6ZC.js";import{t as M,c as Ms,D as qs,B as Q,A as Fs,e as Vs,u as $s}from"./chunks/axisChartCommon.DSHZBavm.js";import{a as T,d as Hs}from"./chunks/format.6x7sQhL-.js";import{c as Gs,C as Us,u as Ws}from"./chunks/tokens.DSrhDj9L.js";import{p as os,a as Ys,d as Ks,b as Zs,t as Xs,j as Qs,k as Js}from"./chunks/referenceLines.D1_B4lBr.js";import{b as _s,c as sa,d as aa,p as na}from"./chunks/utils.BIjrxRCb.js";import{_ as ea}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.kITeLaXo.js";import{_ as la}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.B8ZBriLk.js";import{_ as ta}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CsMd9Ae3.js";import{c as pa}from"./chunks/createSeriesData.Cl88e17S.js";import{a as ca,i as ia,c as ra}from"./chunks/installLabelLayout.arYE5jfi.js";import{I as L,aT as oa,b8 as J,l as x,ad as P,p as _a,z as ss,be as k,an as S,a1 as as,L as ns,D as b,o as s,Z as ha,aE as O,au as ua,Y as es,aj as q,ag as ls,r as E,ao as ts,A as F,B as a}from"./chunks/framework.jq2RwuxR.js";import"./chunks/dataStackHelper.D4o8khTS.js";import"./chunks/axisAlignTicks.CZpDrqln.js";import"./chunks/labelLayoutHelper.4DZbZmCA.js";import"./chunks/labelGuideHelper.CvGtvYqO.js";var da=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n.hasSymbolVisual=!0,n}return e.prototype.getInitialData=function(n,l){return pa(null,this,{useEncodeDefaulter:!0})},e.prototype.getProgressive=function(){var n=this.option.progressive;return n??(this.option.large?5e3:this.get("progressive"))},e.prototype.getProgressiveThreshold=function(){var n=this.option.progressiveThreshold;return n??(this.option.large?1e4:this.get("progressiveThreshold"))},e.prototype.brushSelector=function(n,l,c){return c.point(l.getItemLayout(n))},e.prototype.getZLevelKey=function(){return this.getData().count()>this.getProgressiveThreshold()?this.id:""},e.type="series.scatter",e.dependencies=["grid","polar","geo","singleAxis","calendar","matrix"],e.defaultOption={coordinateSystem:"cartesian2d",z:2,legendHoverLink:!0,symbolSize:10,large:!1,largeThreshold:2e3,itemStyle:{opacity:.8},emphasis:{scale:!0},clip:!0,select:{itemStyle:{borderColor:Cs.color.primary}},universalTransition:{divideShape:"clone"}},e})(Ss),hs=4,fa=(function(){function t(){}return t})(),ma=(function(t){$(e,t);function e(n){var l=t.call(this,n)||this;return l._off=0,l.hoverDataIdx=-1,l}return e.prototype.getDefaultShape=function(){return new fa},e.prototype.reset=function(){this.notClear=!1,this._off=0},e.prototype.beforeBrush=function(n){n&&!n.contentRetained&&this.reset()},e.prototype.buildPath=function(n,l){var c=l.points,p=l.size,o=this.symbolProxy,_=o.shape,h=n.getContext?n.getContext():n,u=h&&p[0]<hs,d=this.softClipShape,f;if(u){this._ctx=h;return}for(this._ctx=null,f=this._off;f<c.length;){var v=c[f++],g=c[f++];isNaN(v)||isNaN(g)||d&&!d.contain(v,g)||(_.x=v-p[0]/2,_.y=g-p[1]/2,_.width=p[0],_.height=p[1],o.buildPath(n,_,!0))}this.incremental&&(this._off=f,this.notClear=!0)},e.prototype.afterBrush=function(){var n=this.shape,l=n.points,c=n.size,p=this._ctx,o=this.softClipShape,_;if(p){for(_=this._off;_<l.length;){var h=l[_++],u=l[_++];isNaN(h)||isNaN(u)||o&&!o.contain(h,u)||p.fillRect(h-c[0]/2,u-c[1]/2,c[0],c[1])}this.incremental&&(this._off=_,this.notClear=!0)}},e.prototype.findDataIndex=function(n,l){for(var c=this.shape,p=c.points,o=c.size,_=Math.max(o[0],4),h=Math.max(o[1],4),u=p.length/2-1;u>=0;u--){var d=u*2,f=p[d]-_/2,v=p[d+1]-h/2;if(n>=f&&l>=v&&n<=f+_&&l<=v+h)return u}return-1},e.prototype.contain=function(n,l){var c=this.transformCoordToLocal(n,l),p=this.getBoundingRect();if(n=c[0],l=c[1],p.contain(n,l)){var o=this.hoverDataIdx=this.findDataIndex(n,l);return o>=0}return this.hoverDataIdx=-1,!1},e.prototype.getBoundingRect=function(){var n=this._rect;if(!n){for(var l=this.shape,c=l.points,p=l.size,o=p[0],_=p[1],h=1/0,u=1/0,d=-1/0,f=-1/0,v=0;v<c.length;){var g=c[v++],D=c[v++];h=Math.min(g,h),d=Math.max(g,d),u=Math.min(D,u),f=Math.max(D,f)}n=this._rect=new Os(h-o/2,u-_/2,d-h+o,f-u+_)}return n},e})(Ps),ya=(function(){function t(){this.group=new As}return t.prototype.updateData=function(e,n){this._clear(),this._data=e;var l=this._create();l.setShape({points:e.getLayout("points")}),this._setCommon(l,e,n)},t.prototype.updateLayout=function(e){var n=this._data;if(n){var l=n.getLayout("points");this.group.eachChild(function(c){if(c.startIndex!=null){var p=(c.endIndex-c.startIndex)*2,o=c.startIndex*4*2;l=new Float32Array(l.buffer,o,p)}c.setShape("points",l),c.reset(),c.stopAnimation()})}},t.prototype.incrementalPrepareUpdate=function(e){this._clear()},t.prototype.incrementalUpdate=function(e,n,l,c){var p=this._newAdded[0],o=n.getLayout("points"),_=p&&p.shape.points;if(_&&_.length<2e4){var h=_.length,u=new Float32Array(h+o.length);u.set(_),u.set(o,h),p.endIndex=e.end,p.setShape({points:u})}else{this._newAdded=[];var d=this._create();d.startIndex=e.start,d.endIndex=e.end,d.incremental=l,d.setShape({points:o}),this._setCommon(d,n,c)}},t.prototype.eachRendered=function(e){this._newAdded[0]&&e(this._newAdded[0])},t.prototype._create=function(){var e=new ma({cursor:"default"});return e.ignoreCoarsePointer=!0,this.group.add(e),this._newAdded.push(e),e},t.prototype._setCommon=function(e,n,l){var c=n.hostModel;l=l||{};var p=n.getVisual("symbolSize");e.setShape("size",p instanceof Array?p:[p,p]),e.softClipShape=l.clipShape||null,e.symbolProxy=Ds(n.getVisual("symbol"),0,0,0,0),e.setColor=e.symbolProxy.setColor;var o=e.shape.size[0]<hs;e.useStyle(c.getModel("itemStyle").getItemStyle(o?["color","shadowBlur","shadowColor"]:["color"]));var _=n.getVisual("style"),h=_&&_.fill;h&&e.setColor(h);var u=Rs(e);u.seriesIndex=c.seriesIndex,e.on("mousemove",function(d){u.dataIndex=null;var f=e.hoverDataIdx;f>=0&&(u.dataIndex=f+(e.startIndex||0))})},t.prototype.remove=function(){this._clear()},t.prototype._clear=function(){this._newAdded=[],this.group.removeAll()},t})(),wa=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n}return e.prototype.render=function(n,l,c){var p=n.getData(),o=this._updateSymbolDraw(p,n);o.updateData(p,V(n)),this._finished=!0},e.prototype.incrementalPrepareRender=function(n,l,c){var p=n.getData(),o=this._updateSymbolDraw(p,n);o.incrementalPrepareUpdate(p),this._finished=!1},e.prototype.incrementalRender=function(n,l,c){this._symbolDraw.incrementalUpdate(n,l.getData(),Ts(l),V(l)),this._finished=n.end===l.getData().count()},e.prototype.updateTransform=function(n,l,c){var p=n.getData();if(this.group.dirty(),this._finished){var o=os("").reset(n,l,c);o.progress&&o.progress({start:0,end:p.count(),count:p.count()},p),this._symbolDraw.updateLayout(V(n))}else return{update:!0}},e.prototype.eachRendered=function(n){this._symbolDraw&&this._symbolDraw.eachRendered(n)},e.prototype._updateSymbolDraw=function(n,l){var c=this._symbolDraw,p=l.pipelineContext,o=p.large;return(!c||o!==this._isLargeDraw)&&(c&&c.remove(),c=this._symbolDraw=o?new ya:new Ys,this._isLargeDraw=o,this.group.removeAll()),this.group.add(c.group),c},e.prototype.remove=function(n,l){this._symbolDraw&&this._symbolDraw.remove(!0),this._symbolDraw=null},e.prototype.dispose=function(){},e.type="scatter",e})(Ls);function V(t){return{clipShape:Ks(t)}}function va(t){Es(ca),t.registerSeriesModel(da),t.registerChartView(wa),t.registerLayout(os("scatter"))}const ga="categorical",A=10,ps=35,cs=.75,is="6%";function us(t,{tokens:e}){const n=t.data??[],l=[],c=new Map,p=[];for(const h of n){const u=M(h[t.xColumn]),d=M(h[t.yColumn]);if(u===null||d===null)continue;const f=ka(t,h);let v=c.get(f);v||(v=[],l.push(f),c.set(f,v));const g=t.sizeColumn?M(h[t.sizeColumn]):null;g!==null&&p.push(g),v.push({x:u,y:d,size:g,label:xa(t,h),row:h})}const o=ja(p,!!t.sizeColumn),_=Gs(t.palette,e,{fallback:ga,count:l.length});return l.map((h,u)=>({name:h,label:T(h),color:_[u],points:c.get(h).map(d=>({...d,symbolSize:o(d.size)}))}))}const ba="(Blank)";function ka(t,e){if(!t.seriesColumn)return t.yColumn;const n=e[t.seriesColumn];return n==null||n===""?ba:String(n)}function xa(t,e){if(!t.labelColumn)return;const n=e[t.labelColumn];return n==null?void 0:String(n)}function ja(t,e){if(!e)return()=>A;const n=za(t);return l=>l===null?A:n(l)}function za(t){let e=1/0,n=-1/0;for(const c of t)c<e&&(e=c),c>n&&(n=c);if(e===n){const c=(A+ps)/2;return()=>c}const l=ps-A;return c=>A+(c-e)/(n-e)*l}function Ca(t,e){const{tokens:n,hiddenSeries:l=[],format:c}=e,p=t.dir==="rtl",_=us(t,e).filter(d=>!l.includes(d.name)),h=Aa(t),u={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:Us},grid:Ms({horizontal:!1,isRTL:p,labelGutter:0}),xAxis:rs(t.xAxis,n,{horizontal:!0,isRTL:p,format:c?.x,name:t.xAxis?.title}),yAxis:rs(t.yAxis,n,{horizontal:!1,isRTL:p,format:c?.y}),series:[..._.map(d=>Oa(d,{tokens:n,isRTL:p,showLabels:h})),...Zs(Sa(t),{tokens:n,horizontal:!1,hasSecondaryValueAxis:!1,hasCategoryAxis:!1,hostSeriesType:"scatter"})]};return _s(u,t.echartOptions)}function Sa(t){const e=t.referenceLines;return e?.filter(n=>n.axis==="y2").length,e}function Aa(t){return t.showDataLabels?!!t.labelColumn:!1}function Oa(t,e){const{tokens:n,isRTL:l,showLabels:c}=e;return{type:"scatter",name:t.name,data:t.points.map(p=>({value:[p.x,p.y],symbolSize:p.symbolSize,...c?{name:p.label??""}:{}})),symbol:"circle",itemStyle:{color:t.color,opacity:cs,borderWidth:0},emphasis:{focus:"series",blurScope:"coordinateSystem"},blur:{itemStyle:{opacity:cs*Q},label:{opacity:Q}},...c?{label:{show:!0,position:l?"left":"right",color:n.dataLabel,fontSize:qs,formatter:p=>String(p?.name??"")},labelLayout:{hideOverlap:!0}}:{}}}function rs(t,e,n){const{horizontal:l,isRTL:c,format:p,name:o}=n,_=_s({scale:!0,boundaryGap:[is,is],...o?{name:T(o),nameLocation:"end",nameGap:8,nameTextStyle:{color:e.axisTitle,fontSize:Fs}}:{},...p?{axisLabel:{formatter:h=>p(Number(h))}}:{}},t?.echartOptions);return Vs({...t,echartOptions:_},e,{horizontal:l,isRTL:c})}const Pa=["aria-label"],Da={class:"sr-only",role:"status"},H=L({__name:"ScatterChart",props:es({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},x:{},y:{},size:{},series:{},hiddenSeries:{},label:{},showDataLabels:{type:Boolean},xAxis:{},yAxis:{},palette:{},referenceLines:{},format:{type:Function},echartOptions:{}},{hiddenSeries:{default:()=>[]},hiddenSeriesModifiers:{}}),emits:es(["select"],["update:hiddenSeries"]),setup(t,{expose:e,emit:n}){Is([va,ia,Qs,ra]);const l=t,c=oa(t,"hiddenSeries"),p=n,o=q(),_=x(()=>l.dir??aa()),h=x(()=>l.xAxis?.format??l.format),u=x(()=>l.yAxis?.format??l.format),d=x(()=>({data:l.data,xColumn:l.x,yColumn:l.y,sizeColumn:l.size,seriesColumn:l.series,labelColumn:l.label,showDataLabels:l.showDataLabels,xAxis:f(l.xAxis),yAxis:f(l.yAxis),referenceLines:l.referenceLines,palette:l.palette,dir:_.value,echartOptions:l.echartOptions}));function f(i){if(i)return{title:i.title,min:i.min,max:i.max,echartOptions:i.echartOptions}}const{tokens:v}=Ws(o),g=x(()=>us(d.value,{tokens:v.value})),D=x(()=>g.value.every(i=>!i.points.length)),ds=x(()=>l.yAxis?.title?T(l.yAxis.title):void 0),G=x(()=>{try{return{option:Ca(d.value,{tokens:v.value,hiddenSeries:c.value,format:{x:h.value,y:u.value}}),error:null}}catch(i){return{option:void 0,error:i?.message??String(i)}}}),fs=x(()=>G.value.error),j=ls({x:0,y:0}),m=ls({open:!1,x:0,y:0,label:void 0,items:[]}),{chart:U,dispatch:R}=Ns({container:o,option:()=>G.value.option,events:{mouseover:i=>ms(i),mouseout:()=>m.open=!1,click:i=>{const r=W(i);r&&p("select",{seriesName:r.series.name,x:r.point.x,y:r.point.y,size:r.point.size,label:r.point.label,row:r.point.row})}},onZrEvents:{mousemove:i=>{j.x=i.event?.clientX??j.x,j.y=i.event?.clientY??j.y,m.open&&(m.x=j.x,m.y=j.y)},globalout:()=>m.open=!1}});function W(i){const r=g.value.find(y=>y.name===i?.seriesName),w=r?.points[i?.dataIndex];return r&&w?{series:r,point:w}:void 0}function ms(i){const r=W(i);if(!r){m.open=!1;return}Y(r,j.x,j.y)}function Y(i,r,w){const{series:y,point:z}=i,ks=[z.label,l.series?y.label:void 0].filter(Boolean).join(" · ");m.label=ks||void 0,m.items=[I(l.x,z.x,h.value,y.color),I(l.y,z.y,u.value,y.color),...l.size&&z.size!==null?[I(l.size,z.size,l.format,y.color)]:[]],m.x=r,m.y=w,m.open=!0}function I(i,r,w,y){return{name:i,label:T(i),color:y,value:r,formattedValue:w?w(r):Hs(r)}}const K=x(()=>g.value.map(i=>({name:i.name,label:i.label,color:i.color,hidden:c.value.includes(i.name)})));function ys(i){c.value=Xs(c.value,i,g.value.length)}const Z=q(null);function ws(i){Z.value=i}J(Z,(i,r)=>{r&&R({type:"downplay",seriesName:r}),i&&!c.value.includes(i)&&R({type:"highlight",seriesName:i})});const N=q(""),C=x(()=>g.value.filter(i=>!c.value.includes(i.name)).flatMap((i,r)=>i.points.map((w,y)=>({entry:i,point:w,seriesIndex:r,dataIndex:y}))));function vs(i,r){const w=o.value;if(!w)return;const y=w.getBoundingClientRect(),z=U.value?.convertToPixel({gridIndex:0},[i,r]);return!z||z.some(B=>typeof B!="number"||isNaN(B))?{x:y.left+y.width/2,y:y.top+y.height/2}:{x:y.left+z[0],y:y.top+z[1]}}function gs(i){const r=C.value[i];if(!r)return;const w=vs(r.point.x,r.point.y);R({type:"highlight",seriesIndex:r.seriesIndex,dataIndex:r.dataIndex}),Y({series:r.entry,point:r.point},w?.x??j.x,w?.y??j.y),N.value=na(m.label,m.items.map(y=>({label:y.label,value:y.formattedValue})))}function X(i){const r=i===null?void 0:C.value[i];r&&R({type:"downplay",seriesIndex:r.seriesIndex,dataIndex:r.dataIndex})}$s({plot:o,data:()=>C.value,close:()=>{m.open=!1}});const bs=Bs({marks:()=>C.value,key:i=>`${i.entry.name} ${i.point.x} ${i.point.y}`,move:(i,r)=>{X(r),gs(i)},activate:i=>{const r=C.value[i];r&&p("select",{seriesName:r.entry.name,x:r.point.x,y:r.point.y,size:r.point.size,label:r.point.label,row:r.point.row})},clear:i=>{X(i),m.open=!1,N.value=""}}).attrs;return J(()=>g.value.map(i=>i.name),i=>{c.value=Js(c.value,i)}),e({chart:x(()=>U.value)}),(i,r)=>(P(),_a(ea,{title:t.title,subtitle:t.subtitle,"plot-label":ds.value,loading:t.loading,error:t.error||fs.value,empty:D.value,dir:_.value},ss({default:k(()=>[s("div",ha({ref_key:"plotEl",ref:o,class:"h-full w-full rounded-2 focus-visible:focus-ring",dir:"ltr",role:"img","aria-label":O(sa)(t.title,t.subtitle)},O(bs)),null,16,Pa),s("span",Da,ua(N.value),1),b(ta,{open:m.open,x:m.x,y:m.y,label:m.label,items:m.items,dir:_.value},ss({_:2},[i.$slots.tooltip?{name:"default",fn:k(w=>[S(i.$slots,"tooltip",as(ns(w)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","dir"])]),_:2},[i.$slots.actions?{name:"actions",fn:k(()=>[S(i.$slots,"actions")]),key:"0"}:void 0,i.$slots.loading?{name:"loading",fn:k(()=>[S(i.$slots,"loading")]),key:"1"}:void 0,i.$slots.error?{name:"error",fn:k(w=>[S(i.$slots,"error",as(ns(w)))]),key:"2"}:void 0,i.$slots.empty?{name:"empty",fn:k(()=>[S(i.$slots,"empty")]),key:"3"}:void 0,K.value.length>1?{name:"legend",fn:k(()=>[b(la,{items:K.value,onChange:ys,onHighlight:ws},null,8,["items"])]),key:"4"}:void 0]),1032,["title","subtitle","plot-label","loading","error","empty","dir"]))}}),Ra={class:"h-80 w-full"},Ta=L({__name:"ScatterQuadrants",setup(t){const e=[{product:"Payroll",growth:34,margin:62},{product:"Invoicing",growth:12,margin:71},{product:"CRM",growth:41,margin:48},{product:"Helpdesk",growth:27,margin:55},{product:"Inventory",growth:8,margin:44},{product:"Insights",growth:52,margin:39},{product:"Field service",growth:6,margin:58},{product:"Point of sale",growth:19,margin:33}],n=l=>`${l}%`;return(l,c)=>(P(),E("div",Ra,[b(O(H),{data:e,x:"growth",y:"margin",label:"product","show-data-labels":"","x-axis":{title:"Growth",format:n},"y-axis":{title:"Margin",format:n},"reference-lines":[{value:25,axis:"x",label:"Median growth",dashed:!0},{value:50,axis:"y",label:"Median margin",dashed:!0}],title:"Growth against margin",subtitle:"Median lines divide the plot into four"},null,8,["x-axis","y-axis"])]))}}),La={class:"h-96 w-full"},Ea=L({__name:"ScatterMarkets",setup(t){const e=[{market:"Germany",arpu:61,retention:88,seats:14200,region:"EMEA"},{market:"France",arpu:54,retention:82,seats:9100,region:"EMEA"},{market:"UAE",arpu:72,retention:79,seats:2600,region:"EMEA"},{market:"Nigeria",arpu:21,retention:74,seats:4800,region:"EMEA"},{market:"India",arpu:18,retention:91,seats:38400,region:"APAC"},{market:"Japan",arpu:68,retention:94,seats:7300,region:"APAC"},{market:"Australia",arpu:59,retention:85,seats:5200,region:"APAC"},{market:"Singapore",arpu:77,retention:81,seats:1900,region:"APAC"},{market:"United States",arpu:74,retention:87,seats:41500,region:"Americas"},{market:"Canada",arpu:63,retention:89,seats:8600,region:"Americas"},{market:"Brazil",arpu:26,retention:71,seats:12800,region:"Americas"},{market:"Mexico",arpu:31,retention:76,seats:6400,region:"Americas"}];return(n,l)=>(P(),E("div",La,[b(O(H),{data:e,x:"arpu",y:"retention",size:"seats",series:"region",label:"market","x-axis":{title:"ARPU",format:c=>`$${c}`},"y-axis":{title:"Retention",format:c=>`${c}%`},title:"Revenue per seat against retention",subtitle:"Bubble size is the number of seats"},null,8,["x-axis","y-axis"])]))}}),Ia={class:"h-80 w-full"},Na=L({__name:"ScatterSpend",setup(t){const e=[{account:"Acme",spend:4200,revenue:12400},{account:"Globex",spend:9100,revenue:24200},{account:"Initech",spend:2200,revenue:3100},{account:"Umbrella",spend:7400,revenue:9600},{account:"Soylent",spend:5600,revenue:18800},{account:"Hooli",spend:12800,revenue:21400},{account:"Vehement",spend:1800,revenue:6200},{account:"Massive Dynamic",spend:10400,revenue:34600},{account:"Stark",spend:6800,revenue:7400},{account:"Wayne",spend:3100,revenue:11200}],n=l=>`$${new Intl.NumberFormat("en-US").format(l)}`;return(l,c)=>(P(),E("div",Ia,[b(O(H),{data:e,x:"spend",y:"revenue",label:"account","x-axis":{title:"Acquisition spend"},"y-axis":{title:"Revenue"},format:n,title:"Spend against revenue",subtitle:"Ten largest accounts, last quarter"})]))}}),cn=JSON.parse('{"title":"ScatterChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/scatterchart.md","filePath":"docs/charts/scatterchart.md","lastUpdated":0}'),Ba={name:"docs/charts/scatterchart.md"},rn=Object.assign(Ba,{setup(t){const e=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
