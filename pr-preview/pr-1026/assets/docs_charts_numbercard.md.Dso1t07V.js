import{_ as g}from"./chunks/PropsTable.Bny-eiOv.js";import{_ as z}from"./chunks/SlotsTable.C-210Jbo.js";import{y as j}from"./chunks/theme.nr2fAuPl.js";import{_ as u}from"./chunks/NumberCard.vue_vue_type_script_setup_true_lang.CUiQ0A2o.js";import{I as v,ad as t,r,F as w,am as k,D as l,aE as _,Z as b,a1 as x,L as C,bh as e,o as s,au as O,p as S,aj as P,ao as y,A as R,B as a}from"./chunks/framework.B7MDGj51.js";import"./chunks/utils.DoAG-xsc.js";import"./chunks/theme.DIeln2r2.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.BYvL0JI3.js";const D={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},A=v({__name:"NumberSparklines",setup(f){const p=[{title:"Signups",value:1284,delta:12.5,deltaSuffix:"%",deltaCaption:"vs last month",sparkline:{data:[842,906,971,1044,1123,1018,1067,1142,1196,1218,1247,1284]}},{title:"Orders shipped",value:2560,sparkline:{data:[1786,1852,1921,2094,2274,2064,2120,2222,2292,2378,2452,2560],type:"bar"}},{title:"Pipeline",value:1845e4,prefix:"$",compact:!0,sparkline:{data:[12.4,13.1,13.9,15.2,16,15.1,15.8,16.4,17.1,17.6,18,18.45]}},{title:"Storage used",value:61,suffix:"%",color:"#f59e0b",sparkline:{data:[42,44,46,49,51,52,54,56,57,59,60,61],color:"#f59e0b"}}];return(c,d)=>(t(),r("div",D,[(t(),r(w,null,k(p,m=>l(_(u),b({key:m.title},{ref_for:!0},m),null,16)),64))]))}}),N={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},T={type:"button",class:"-mx-1 flex h-5 min-w-0 items-center gap-1 rounded-sm px-1 text-sm text-ink-gray-5 outline-none hover:bg-surface-gray-2 hover:text-ink-gray-7 focus-visible:ring-2 focus-visible:ring-outline-gray-3"},E={class:"truncate"},q=v({__name:"NumberKpis",setup(f){const i=[{title:"Net revenue",value:220200,prefix:"$",compact:!0,delta:5.1,deltaSuffix:"%",sparkline:{data:[144500,150700,157400,172700,188600,171700,177100,186700,193600,202100,209500,220200]}},{title:"Monthly churn",value:2.1,suffix:"%",precision:1,delta:-.4,deltaSuffix:"pts",deltaCaption:"vs last month",negativeIsBetter:!0},{title:"Orders shipped",value:2560},{title:"Refunds",value:null}],o=P("last month"),n=["last month","last quarter","last year"].map(p=>({label:`vs ${p}`,onClick:()=>o.value=p}));return(p,c)=>(t(),r("div",N,[l(_(u),x(C(i[0])),{caption:e(()=>[l(_(j),{options:_(n),placement:"left"},{default:e(()=>[s("button",T,[s("span",E,"vs "+O(o.value),1),c[0]||(c[0]=s("span",{class:"lucide-chevron-down size-3.5 shrink-0","aria-hidden":"true"},null,-1))])]),_:1},8,["options"])]),_:1},16),(t(!0),r(w,null,k(i.slice(1),d=>(t(),S(_(u),b({key:d.title},{ref_for:!0},d),null,16))),128))]))}}),H=JSON.parse('{"title":"NumberCard","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/numbercard.md","filePath":"docs/charts/numbercard.md","lastUpdated":0}'),L={name:"docs/charts/numbercard.md"},K=Object.assign(L,{setup(f){const h=[{name:"title",description:"",required:!0,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"",required:!1,type:"boolean"},{name:"error",description:"",required:!1,type:"string | null"},{name:"value",description:"A string renders as given: the formatting props only apply to a number.",required:!0,type:"number | string | null"},{name:"color",description:`Ink the reading is printed in, e.g. the color of the series it summarizes
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  dir"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," ChartDir")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(z,{data:i})])}}});export{H as __pageData,K as default};
