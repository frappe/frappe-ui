import{aj as m,b7 as k,b1 as y,ad as T,r as I,D as e,bd as r,aE as t,o as l,B as S,be as $,bf as u,bh as f,b5 as R}from"./framework.iYff5nCS.js";import{bC as B,a1 as C,U as D,_ as w,b4 as V,a0 as A}from"./theme.iIGGzyJd.js";import{u as F,z as H,x as L,P as N,H as O,g as U,h as z,S as o,c as q,q as j,w as E,d as K,O as P,a as M,A as W,b as Y,F as G,m as J,p as Q,n as X,B as Z,I as ee,j as te,o as se,U as ae,R as oe,y as ne}from"./kits.BGmjTP-o.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const re={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ie={class:"flex shrink-0 items-center space-x-2"},le={class:"w-full overflow-x-auto"},pe={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},de=["onKeydown"],be={__name:"ComposeDesktop",setup(ce){const b=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],g=[F.configure({mention:{items:b}})],v=[N,O,U,z,o,q,j,E,o,K,P,o,M,W,Y,G,o,J,Q,X,Z,ee,te,o,se,o,ae,oe],p={light:"/pr-preview/pr-1165/recipes/compose-dashboard-light.png",dark:"/pr-preview/pr-1165/recipes/compose-dashboard-dark.png"},h=B(),d=m("Design review: new onboarding flow"),i=m(`
...
`);k(h,(n,s)=>{i.value=i.value.replace(p[s],p[n])});const _=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:x}=y({input:d});return(n,s)=>(T(),I("div",re,[e(t(A),null,{default:r(()=>[e(t(H),{modelValue:i.value,"onUpdate:modelValue":s[1]||(s[1]=a=>i.value=a),extensions:g,"upload-function":_,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:a})=>[e(t(C),null,{default:r(()=>[e(t(D),{items:[{label:"Drafts"},{label:"New discussion"}]}),l("div",ie,[e(t(w),{variant:"ghost",icon:"lucide-trash-2",label:"Delete draft"}),e(t(w),{variant:"solid"},{default:r(()=>[...s[2]||(s[2]=[S("Publish",-1)])]),_:1})])]),_:1}),e(t(V),{class:"flex h-10 items-center border-b bg-surface-base px-3 sm:px-5"},{default:r(()=>[l("div",le,[e(t(L),{editor:a,items:v},null,8,["editor"])])]),_:2},1024),l("div",pe,[$(l("textarea",{ref_key:"titleTextarea",ref:x,class:"mt-1 w-full resize-none border-0 bg-transparent px-0 py-0.5 text-4xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":s[0]||(s[0]=c=>d.value=c),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[u(f(c=>a.commands.focus(),["prevent"]),["enter"]),u(f(c=>a.commands.focus(),["prevent"]),["down"])]},null,40,de),[[R,d.value]]),e(t(ne),{editor:a,class:"prose-v3 -mx-2 min-h-[calc(100vh-200px)] max-w-[unset] overflow-auto px-2 pb-40"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1})]))}};export{be as default};
