import{b4 as x,ae as k,s as v,E as e,bi as n,aG as t,p as i,D as y,bj as T,bk as c,bm as h,ba as I,ak as m}from"./framework.B9LY74y4.js";import{aI as S,au as $,aq as u,bI as R,aH as D}from"./theme.etpjxPyK.js";import{r as F,w as H,u as V,P as A,H as B,f as L,g as N,S as o,c as O,p as q,t as z,d as C,O as U,a as K,A as P,b as j,F as E,l as M,o as W,m as G,B as Y,I as J,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.D21yg17z.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[F.configure({mention:{items:f}})],b=[A,B,L,N,o,O,q,z,o,C,U,o,K,P,j,E,o,M,W,G,Y,J,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
...
`),g=async r=>({file_url:URL.createObjectURL(r),file_name:r.name}),{textarea:_}=x({input:l});return(r,s)=>(k(),v("div",se,[e(t(D),null,{default:n(()=>[e(t(H),{modelValue:d.value,"onUpdate:modelValue":s[1]||(s[1]=a=>d.value=a),extensions:w,"upload-function":g,placeholder:"Type '/' for commands or select text to format"},{default:n(({editor:a})=>[e(t(S),null,{default:n(()=>[e(t($),{items:[{label:"Drafts"},{label:"New discussion"}]}),i("div",ae,[e(t(u),{variant:"ghost",icon:"lucide-trash-2",label:"Delete draft"}),e(t(u),{variant:"solid"},{default:n(()=>[...s[2]||(s[2]=[y("Publish",-1)])]),_:1})])]),_:1}),e(t(R),{class:"flex h-10 items-center border-b bg-surface-base px-3 sm:px-5"},{default:n(()=>[i("div",oe,[e(t(V),{editor:a,items:b},null,8,["editor"])])]),_:2},1024),i("div",ne,[T(i("textarea",{ref_key:"titleTextarea",ref:_,class:"mt-1 w-full resize-none border-0 bg-transparent px-0 py-0.5 text-4xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":s[0]||(s[0]=p=>l.value=p),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[c(h(p=>a.commands.focus(),["prevent"]),["enter"]),c(h(p=>a.commands.focus(),["prevent"]),["down"])]},null,40,ie),[[I,l.value]]),e(t(te),{editor:a,class:"prose-v3 -mx-2 min-h-[calc(100vh-200px)] max-w-[unset] overflow-auto px-2 pb-40"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1})]))}};export{ce as default};
