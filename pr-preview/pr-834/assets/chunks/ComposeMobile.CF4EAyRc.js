import{b4 as v,ae as _,q as y,bi as n,E as a,aG as e,D as x,p as i,bj as T,bk as c,bm as h,ba as I,ak as u}from"./framework.CwWwX6lD.js";import{b6 as S,aq as m,b5 as R}from"./theme.DonC2wEG.js";import{r as B,w as F,u as V,P as $,H as q,f as z,g as A,S as o,c as H,p as L,t as N,d as O,O as C,a as U,A as D,b as K,F as M,l as P,o as j,m as E,B as W,I as G,i as Y,n as J,U as Q,R as X,v as Z}from"./kits.CmSFXN5s.js";const ee={class:"sticky top-0 z-10 border-b bg-surface-base"},te={class:"overflow-x-auto px-2 py-1"},se={class:"px-4 pb-40 pt-4"},ae=["onKeydown"],le={__name:"ComposeMobile",setup(oe){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[B.configure({mention:{items:f}})],b=[$,q,z,A,o,H,L,N,o,O,C,o,U,D,K,M,o,P,j,E,W,G,Y,o,J,o,Q,X],r=u("Design review: new onboarding flow"),d=u(`
...
`),g=async l=>({file_url:URL.createObjectURL(l),file_name:l.name}),{textarea:k}=v({input:r});return(l,t)=>(_(),y(e(R),null,{default:n(()=>[a(e(F),{modelValue:d.value,"onUpdate:modelValue":t[1]||(t[1]=s=>d.value=s),extensions:w,"upload-function":g,placeholder:"Type '/' for commands or select text to format"},{default:n(({editor:s})=>[a(e(S),{title:"New discussion"},{left:n(()=>[a(e(m),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),right:n(()=>[a(e(m),{variant:"solid"},{default:n(()=>[...t[2]||(t[2]=[x("Publish",-1)])]),_:1})]),_:1}),i("div",ee,[i("div",te,[a(e(V),{editor:s,items:b},null,8,["editor"])])]),i("div",se,[T(i("textarea",{ref_key:"titleTextarea",ref:k,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":t[0]||(t[0]=p=>r.value=p),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[c(h(p=>s.commands.focus(),["prevent"]),["enter"]),c(h(p=>s.commands.focus(),["prevent"]),["down"])]},null,40,ae),[[I,r.value]]),a(e(Z),{editor:s,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{le as default};
