import{b4 as x,ae as k,s as v,E as e,bi as n,aG as t,p as i,D as y,bj as T,bk as c,bm as h,ba as I,ak as m}from"./framework.CwWwX6lD.js";import{aI as S,au as $,aq as u,bI as R,aH as D}from"./theme.DonC2wEG.js";import{r as F,w as H,u as V,P as A,H as B,f as L,g as N,S as o,c as O,p as q,t as z,d as C,O as U,a as K,A as P,b as j,F as E,l as M,o as W,m as G,B as Y,I as J,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.CmSFXN5s.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[F.configure({mention:{items:f}})],b=[A,B,L,N,o,O,q,z,o,C,U,o,K,P,j,E,o,M,W,G,Y,J,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
