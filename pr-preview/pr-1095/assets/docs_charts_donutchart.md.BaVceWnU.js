import{_ as k}from"./chunks/PropsTable.CgHuYdiO.js";import{_ as g}from"./chunks/SlotsTable.CzXL0ljF.js";import{_ as z}from"./chunks/EmitsTable.CrkKugJc.js";import"./chunks/theme.eIr5X8sK.js";import{_ as y}from"./chunks/DonutChart.vue_vue_type_script_setup_true_lang._YvCtx-3.js";import{I as f,ad as i,r as _,D as l,aE as m,o as s,F as w,B as a,au as d,aj as x,ao as b,A as v,be as p}from"./chunks/framework.ChwGEIqt.js";import"./chunks/useChart.ZFvx199Q.js";import"./chunks/tokens.D1xNffc1.js";import"./chunks/utils.BIjrxRCb.js";import"./chunks/usePlotKeyboard.E0m2Brvy.js";import"./chunks/axisChartCommon.aNDThTTy.js";import"./chunks/format.aT6v3Paz.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.6sFmoB16.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.CGGV-dfP.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.B1Busv-D.js";import"./chunks/LegendVisualProvider.BjJ0mWHK.js";import"./chunks/labelGuideHelper.Cs6mi6oL.js";import"./chunks/labelLayoutHelper.BccrYouW.js";import"./chunks/sectorHelper.Dxh2Yneh.js";const j={class:"h-80 w-full"},C=f({__name:"DonutHalf",setup(o){const c=[{plan:"Starter",subscriptions:1180},{plan:"Plus",subscriptions:962},{plan:"Pro",subscriptions:418}];return(e,t)=>(i(),_("div",j,[l(m(y),{data:c,category:"plan",value:"subscriptions",variant:"half",palette:"sequential","show-inline-labels":"",title:"Plan mix",subtitle:"Active subscriptions, July 2026"})]))}}),S={class:"flex h-96 w-full flex-col gap-2"},O={class:"min-h-0 flex-1"},D={class:"text-p-sm text-ink-gray-5"},A=f({__name:"DonutOthers",setup(o){const c=[{channel:"Organic search",sessions:39900},{channel:"Paid social",sessions:21400},{channel:"Email",sessions:16800},{channel:"Direct",sessions:14700},{channel:"Referral & affiliate",sessions:8900},{channel:"Marketplace",sessions:4500},{channel:"Events",sessions:3110},{channel:"Print",sessions:1490}],e=x(null);return(t,r)=>(i(),_("div",S,[s("div",O,[l(m(y),{data:c,category:"channel",value:"sessions","max-slices":4,"center-label":"sessions",title:"Traffic by channel",subtitle:"Sessions in July 2026",onSelect:r[0]||(r[0]=n=>e.value=n)})]),s("p",D,[e.value?(i(),_(w,{key:0},[a(" Selected "+d(e.value.name)+" · "+d(Math.round(e.value.percent))+"% · "+d(e.value.rows.length)+" row(s) behind it ",1)],64)):(i(),_(w,{key:1},[a("Select a slice — Others carries every row it groups.")],64))])]))}}),P={class:"h-80 w-full"},R=f({__name:"DonutShare",setup(o){const c=[{type:"Attachments",gigabytes:812},{type:"Backups",gigabytes:604},{type:"Images",gigabytes:337},{type:"Logs",gigabytes:149},{type:"Everything else",gigabytes:62}],e=t=>t>=1024?`${(t/1024).toFixed(1)} TB`:`${t} GB`;return(t,r)=>(i(),_("div",P,[l(m(y),{data:c,category:"type",value:"gigabytes","center-label":"stored",format:e,title:"Storage by file type",subtitle:"Across every workspace"})]))}}),Z=JSON.parse('{"title":"DonutChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/donutchart.md","filePath":"docs/charts/donutchart.md","lastUpdated":0}'),E={name:"docs/charts/donutchart.md"},ss=Object.assign(E,{setup(o){const c=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. A
