import{aj as u,a9 as T,a5 as I,b7 as S,b1 as $,ad as B,r as O,D as e,bd as r,aE as t,o as l,B as R,be as A,bf as b,bh as w,b5 as D}from"./framework.ThItcJMt.js";import{a1 as F,U,_ as g,b4 as V,a0 as H}from"./theme.DKvOXdfz.js";import{u as L,z as N,x as z,P as C,H as E,g as q,h as M,S as o,c as j,q as K,w as P,d as W,O as Y,a as G,A as J,b as Q,F as X,m as Z,p as ee,n as te,B as se,I as ae,j as oe,o as ne,U as re,R as ie,y as le}from"./kits.B2jcfZ3g.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const pe={class:"h-screen w-full bg-surface-base text-ink-gray-9"},de={class:"flex shrink-0 items-center space-x-2"},ce={class:"w-full overflow-x-auto"},he={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},me=["onKeydown"],_e={__name:"ComposeDesktop",setup(ue){const v=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],_=[L.configure({mention:{items:v}})],x=[C,E,q,M,o,j,K,P,o,W,Y,o,G,J,Q,X,o,Z,ee,te,se,ae,oe,o,ne,o,re,ie],p={light:"/pr-preview/pr-1154/recipes/compose-dashboard-light.png",dark:"/pr-preview/pr-1154/recipes/compose-dashboard-dark.png"},f=()=>document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light",d=u(f()),c=u("Design review: new onboarding flow"),i=u(`
...
`);let h;T(()=>{h=new MutationObserver(()=>{d.value=f()}),h.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}),I(()=>h?.disconnect()),S(d,(n,s)=>{i.value=i.value.replace(p[s],p[n])});const k=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:y}=$({input:c});return(n,s)=>(B(),O("div",pe,[e(t(H),null,{default:r(()=>[e(t(N),{modelValue:i.value,"onUpdate:modelValue":s[1]||(s[1]=a=>i.value=a),extensions:_,"upload-function":k,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:a})=>[e(t(F),null,{default:r(()=>[e(t(U),{items:[{label:"Drafts"},{label:"New discussion"}]}),l("div",de,[e(t(g),{variant:"ghost",icon:"lucide-trash-2",label:"Delete draft"}),e(t(g),{variant:"solid"},{default:r(()=>[...s[2]||(s[2]=[R("Publish",-1)])]),_:1})])]),_:1}),e(t(V),{class:"flex h-10 items-center border-b bg-surface-base px-3 sm:px-5"},{default:r(()=>[l("div",ce,[e(t(z),{editor:a,items:x},null,8,["editor"])])]),_:2},1024),l("div",he,[A(l("textarea",{ref_key:"titleTextarea",ref:y,class:"mt-1 w-full resize-none border-0 bg-transparent px-0 py-0.5 text-4xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":s[0]||(s[0]=m=>c.value=m),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[b(w(m=>a.commands.focus(),["prevent"]),["enter"]),b(w(m=>a.commands.focus(),["prevent"]),["down"])]},null,40,me),[[D,c.value]]),e(t(le),{editor:a,class:"prose-v3 -mx-2 min-h-[calc(100vh-200px)] max-w-[unset] overflow-auto px-2 pb-40"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1})]))}};export{_e as default};
