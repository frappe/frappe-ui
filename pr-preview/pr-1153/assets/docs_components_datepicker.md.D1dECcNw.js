...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_wac0bt"},"DateRangePicker"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:i(()=>[c(os)]),_:1}),l[11]||(l[11]=G(`<p>Picker trigger and action slots receive <code>{ open, disabled, setOpen, close }</code> alongside their date-specific fields. <code>DateTimePicker</code> uses <code>typeable</code> for both the date and time inputs.</p><h2 id="template-ref" tabindex="-1">Template ref <a class="header-anchor" href="#template-ref" aria-label="Permalink to “Template ref”">​</a></h2><p>All three pickers expose <code>{ open, close, focus }</code>. They render their own trigger, so a parent&#39;s script has no other handle on the panel. <code>open()</code> does nothing while the picker is disabled.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">script</span><span class="s_1i4ay4"> setup</span><span class="s_1i4ay4"> lang</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">ts</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_edvzsf">import</span><span class="s_13ahmt"> { </span><span class="s_4q1z3w">useTemplateRef</span><span class="s_13ahmt"> }</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">vue</span><span class="s_w1p9wo">&#39;</span></span>
<span class="line"></span>
<span class="line"><span class="s_252irl">const</span><span class="s_295sjd"> picker</span><span class="s_2ekfrt"> =</span><span class="s_indoxt"> useTemplateRef</span><span class="s_13ahmt">(</span><span class="s_w1p9wo">&#39;</span><span class="s_2575z4">picker</span><span class="s_w1p9wo">&#39;</span><span class="s_13ahmt">)</span></span>
...
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_wac0bt">DatePicker</span><span class="s_1i4ay4"> ref</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">picker</span><span class="s_w1p9wo">&quot;</span><span class="s_1i4ay4"> v-model</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">date</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2"> /&gt;</span></span>
<span class="line"><span class="s_1zd9e2">  &lt;</span><span class="s_1uuh8p">Button</span><span class="s_1i4ay4"> label</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">Pick a date</span><span class="s_w1p9wo">&quot;</span><span class="s_1i4ay4"> @click</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_2575z4">picker?.open()</span><span class="s_w1p9wo">&quot;</span><span class="s_28rvie"> /</span><span class="s_1zd9e2">&gt;</span></span>
<span class="line"><span class="s_1zd9e2">&lt;/</span><span class="s_1uuh8p">template</span><span class="s_1zd9e2">&gt;</span></span></code></pre></div><h2 id="styling-and-aria" tabindex="-1">Styling and ARIA <a class="header-anchor" href="#styling-and-aria" aria-label="Permalink to “Styling and ARIA”">​</a></h2><p>The input carries <code>data-slot=&quot;control&quot;</code> — <code>trigger</code> is reserved for <code>Select</code>, <code>Combobox</code> and <code>MultiSelect</code>. The default chevron carries <code>data-slot=&quot;chevron&quot;</code>. The input also carries <code>role=&quot;combobox&quot;</code>, <code>aria-haspopup=&quot;dialog&quot;</code> and <code>aria-expanded</code>, so a screen reader announces that the field opens a panel and whether that panel is open.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2><h3 id="datepicker-1" tabindex="-1">DatePicker <a class="header-anchor" href="#datepicker-1" aria-label="Permalink to “DatePicker”">​</a></h3>`,8)),c(R,{name:"DatePicker",data:r},{code:i(()=>[...l[3]||(l[3]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Dayjs"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"dayjs/esm"),s("span",{class:"s_w1p9wo"},"'")]),a(`
