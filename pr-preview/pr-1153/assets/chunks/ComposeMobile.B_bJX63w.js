import{aj as m,a9 as T,a5 as I,b7 as S,b1 as $,ad as B,p as O,bd as r,D as s,aE as t,B as R,o as l,be as A,bf as b,bh as w,b5 as F}from"./framework.BgCjhnaM.js";import{aw as N,N as g,av as V}from"./theme.5fcLihJ9.js";import{u as z,z as H,x as L,P as U,H as C,g as M,h as q,S as o,c as D,q as E,w as j,d as K,O as P,a as W,A as Y,b as G,F as J,m as Q,p as X,n as Z,B as ee,I as te,j as ae,o as se,U as oe,R as ne,y as re}from"./kits.D3NTuN72.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const ie={class:"sticky top-0 z-10 border-b bg-surface-base"},le={class:"overflow-x-auto px-2 py-1"},pe={class:"px-4 pb-40 pt-4"},de=["onKeydown"],we={__name:"ComposeMobile",setup(ce){const v=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],k=[z.configure({mention:{items:v}})],_=[U,C,M,q,o,D,E,j,o,K,P,o,W,Y,G,J,o,Q,X,Z,ee,te,ae,o,se,o,oe,ne],p={light:"/pr-preview/pr-1153/recipes/compose-dashboard-light.png",dark:"/pr-preview/pr-1153/recipes/compose-dashboard-dark.png"},f=()=>document.documentElement.getAttribute("data-theme")==="dark"?"dark":"light",d=m(f()),c=m("Design review: new onboarding flow"),i=m(`
...
`);let h;T(()=>{h=new MutationObserver(()=>{d.value=f()}),h.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}),I(()=>h?.disconnect()),S(d,(n,e)=>{i.value=i.value.replace(p[e],p[n])});const y=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:x}=$({input:c});return(n,e)=>(B(),O(t(V),null,{default:r(()=>[s(t(H),{modelValue:i.value,"onUpdate:modelValue":e[1]||(e[1]=a=>i.value=a),extensions:k,"upload-function":y,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:a})=>[s(t(N),{title:"New discussion"},{prefix:r(()=>[s(t(g),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),suffix:r(()=>[s(t(g),{variant:"solid"},{default:r(()=>[...e[2]||(e[2]=[R("Publish",-1)])]),_:1})]),_:1}),l("div",ie,[l("div",le,[s(t(L),{editor:a,items:_},null,8,["editor"])])]),l("div",pe,[A(l("textarea",{ref_key:"titleTextarea",ref:x,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":e[0]||(e[0]=u=>c.value=u),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[b(w(u=>a.commands.focus(),["prevent"]),["enter"]),b(w(u=>a.commands.focus(),["prevent"]),["down"])]},null,40,de),[[F,c.value]]),s(t(re),{editor:a,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{we as default};
