import{_ as z}from"./chunks/PropsTable.DDPB_Xkg.js";import{_ as b}from"./chunks/SlotsTable.D5riQZqL.js";import{_ as x}from"./chunks/EmitsTable.BXzXgBcI.js";import{ah as g,au as u,v as y,bE as m}from"./chunks/theme.CxyLdDW-.js";import{J as f,ad as _,p as w,bg as p,o as s,D as l,aE as c,B as a,aj as h,ao as v,r as j}from"./chunks/framework.BIOnMXKG.js";const k={class:"mt-2 flex flex-col justify-between sm:flex-row sm:items-center"},E={class:"mt-2 flex items-center justify-end space-x-2 sm:mt-0"},C=f({__name:"Comment",setup(r){const t=h(""),o=["Paragraph",["Heading 2","Heading 3","Heading 4"],"Separator","Bold","Italic","Separator","Bullet List","Numbered List","Separator","Link","Image"];return(i,e)=>(_(),w(c(m),{ref:"textEditor","editor-class":"prose-sm max-w-none min-h-[4rem]",content:t.value,onChange:e[0]||(e[0]=n=>t.value.value=n),"starterkit-options":{heading:{levels:[2,3,4]}},placeholder:"Write something amazing..."},{editor:p(({editor:n})=>[l(c(y),{class:"max-h-[50vh] overflow-y-auto border rounded-lg p-4",editor:n},null,8,["editor"])]),bottom:p(()=>[s("div",k,[l(c(g),{class:"-ml-1 overflow-x-auto",buttons:o}),s("div",E,[l(c(u),null,{default:p(()=>[...e[1]||(e[1]=[a("Cancel",-1)])]),_:1}),l(c(u),{variant:"solid"},{default:p(()=>[...e[2]||(e[2]=[a("Submit",-1)])]),_:1})])])]),_:1},8,["content"]))}}),T=f({__name:"Example",setup(r){const t=h(`
<div>
  <h2>Heading 2</h2>
  <p>
...
`);return(o,i)=>(_(),w(c(m),{"editor-class":"prose-sm min-h-[4rem] border rounded-b-lg border-t-0 p-2",content:t.value,placeholder:"Type something...",onChange:i[0]||(i[0]=e=>t.value.value=e),bubbleMenu:!0,"fixed-menu":!0},null,8,["content"]))}}),S=JSON.parse('{"title":"TextEditor","description":"","frontmatter":{},"headers":[],"relativePath":"docs/components/texteditor.md","filePath":"docs/components/texteditor.md","lastUpdated":1779053387000}'),q={name:"docs/components/texteditor.md"},O=Object.assign(q,{setup(r){const t=[{name:"content",description:"Initial editor content (HTML/string). `null` renders an empty editor",required:!1,type:"null | string",default:"null"},{name:"placeholder",description:"Placeholder text or dynamic placeholder resolver",required:!1,type:"(() => string) | string",default:'""'},{name:"editorClass",description:"Custom classes applied to the editor root",required:!1,type:"object | string | string[]",default:'"prose-sm"'},{name:"editable",description:"Toggles editability of the editor",required:!1,type:"boolean",default:"true"},{name:"autofocus",description:"Autofocus the editor on mount",required:!1,type:"boolean",default:"false"},{name:"bubbleMenu",description:"Enables bubble menu or provides custom bubble menu items",required:!1,type:"any[] | boolean",default:"false"},{name:"bubbleMenuOptions",description:"Configuration options for the bubble menu",required:!1,type:"object",default:"{}"},{name:"fixedMenu",description:"Enables fixed menu or provides custom fixed menu items",required:!1,type:"any[] | boolean",default:"false"},{name:"floatingMenu",description:"Enables floating menu or provides custom floating menu items",required:!1,type:"any[] | boolean",default:"false"},{name:"extensions",description:"Custom TipTap extensions",required:!1,type:"any[]",default:"[]"},{name:"starterkitOptions",description:"Options passed to TipTap StarterKit",required:!1,type:"any",default:"{}"},{name:"mentions",description:"Mention extension configuration",required:!1,type:"ConfigureMentionOptions",default:"null"},{name:"tags",description:"Tag / hashtag configuration",required:!1,type:"any[] | null",default:"null"},{name:"uploadFunction",description:"Async file upload handler (used for images, files, etc.)",required:!1,type:"((file: File) => Promise<UploadedFile>)"},{name:"uploadArgs",description:"Extra arguments passed to the upload function",required:!1,type:"object"}],o=[{name:"top",description:"",type:"{ editor: { contentComponent: null | { uid: number; type: FunctionalComponent<{}, {}, any, {}> | { ["},{name:"editor",description:"",type:"{ editor: { contentComponent: null | { uid: number; type: FunctionalComponent<{}, {}, any, {}> | { ["},{name:"bottom",description:"",type:"{ editor: { contentComponent: null | { uid: number; type: FunctionalComponent<{}, {}, any, {}> | { ["}],i=[{name:"blur",description:"",type:"[event: FocusEvent]"},{name:"change",description:"Fired after the value is committed.",type:"[content: string]"},{name:"focus",description:"",type:"[event: FocusEvent]"},{name:"transaction",description:"",type:"[editor: object]"}];return(e,n)=>{const d=v("ComponentPreview");return _(),j("div",null,[n[3]||(n[3]=s("h1",{id:"texteditor",tabindex:"-1"},[a("TextEditor "),s("a",{class:"header-anchor",href:"#texteditor","aria-label":"Permalink to “TextEditor”"},"​")],-1)),n[4]||(n[4]=s("p",null,[a("Deprecated: use the "),s("code",null,"frappe-ui/editor"),a(" subpath instead. The replacement API is "),s("code",null,"Editor"),a(" plus the editor kits and menu primitives documented on the Editor page.")],-1)),n[5]||(n[5]=s("p",null,"A rich text editor based on TipTap for creating and formatting content. Offers intuitive controls, styling options, and smooth editing experience.",-1)),n[6]||(n[6]=s("h2",{id:"default",tabindex:"-1"},[a("Default "),s("a",{class:"header-anchor",href:"#default","aria-label":"Permalink to “Default”"},"​")],-1)),l(d,{name:"TextEditor-Example"},{code:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:p(()=>[l(T)]),_:1}),n[7]||(n[7]=s("h2",{id:"comment-editor",tabindex:"-1"},[a("Comment Editor "),s("a",{class:"header-anchor",href:"#comment-editor","aria-label":"Permalink to “Comment Editor”"},"​")],-1)),l(d,{name:"TextEditor-Comment"},{code:p(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ref"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:o}),l(x,{data:i})])}}});export{S as __pageData,O as default};
