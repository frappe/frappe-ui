import{_ as o}from"./chunks/PropsTable.vue_vue_type_script_setup_true_lang.B0L99k5N.js";import{_ as r}from"./chunks/SlotsTable.vue_vue_type_script_setup_true_lang.Dz75aejz.js";import{ac as d}from"./chunks/theme.D8hzc4MV.js";import{d as h,o as t,c as i,b as e,e as m,E as j,ae as w,a as s,a6 as a,U as p}from"./chunks/framework.Bo3zwgXD.js";const u=h({__name:"Example",setup(_){const l=j({showIndentationGuides:!0,rowHeight:"25px",indentWidth:"15px",node:{name:"guest",label:"Guest",children:[{name:"downloads",label:"Downloads",children:[{name:"download.zip",label:"download.zip",children:[{name:"image.png",label:"image.png",children:[]}]}]},{name:"documents",label:"Documents",children:[{name:"somefile.txt",label:"somefile.txt",children:[]},{name:"somefile.pdf",label:"somefile.pdf",children:[]}]}]}});return(n,c)=>(t(),i("div",null,[e(m(d),{options:{showIndentationGuides:l.showIndentationGuides,rowHeight:l.rowHeight,indentWidth:l.indentWidth},nodeKey:"name",node:l.node},null,8,["options","node"])]))}}),g=JSON.parse('{"title":"Tree","description":"","frontmatter":{},"headers":[],"relativePath":"docs/components/tree.md","filePath":"docs/components/tree.md","lastUpdated":1768439812000}'),x={name:"docs/components/tree.md"},v=Object.assign(x,{setup(_){return(l,n)=>{const c=w("ComponentPreview");return t(),i("div",null,[n[2]||(n[2]=s("h1",{id:"tree",tabindex:"-1"},[a("Tree "),s("a",{class:"header-anchor",href:"#tree","aria-label":"Permalink to “Tree”"},"​")],-1)),n[3]||(n[3]=s("p",null,"Displays hierarchical data in a collapsible tree structure. Makes it easy to navigate nested items and manage complex relationships.",-1)),n[4]||(n[4]=s("h2",{id:"default",tabindex:"-1"},[a("Default "),s("a",{class:"header-anchor",href:"#default","aria-label":"Permalink to “Default”"},"​")],-1)),e(c,{name:"Tree-Example"},{code:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:p(()=>[e(u)]),_:1}),n[5]||(n[5]=s("h2",{id:"api-reference",tabindex:"-1"},[a("API Reference "),s("a",{class:"header-anchor",href:"#api-reference","aria-label":"Permalink to “API Reference”"},"​")],-1)),e(o,{name:"Tree",data:[{name:"node",description:`Root tree node to render.
Can contain nested children to form the tree structure.`,required:!0,type:"TreeNode"},{name:"nodeKey",description:`Unique key used to identify each node.
Usually an id-like property present on every node.`,required:!0,type:"string"},{name:"options",description:"Optional configuration for tree layout and behavior.",required:!1,type:"TreeOptions",default:`{
    rowHeight: "25px",
    indentWidth: "20px",
    showIndentationGuides: true,
    defaultCollapsed: true,
}`}]},{code:p(()=>[...n[1]||(n[1]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"export"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_euu481"}," TreeNode"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," {")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),e(r,{data:[{name:"node",description:"Slot to fully override how a tree node renders",type:"any"},{name:"icon",description:"Slot to override only the node expand/collapse icon",type:"any"},{name:"label",description:"Slot to override only the node label/content",type:"any"}]})])}}});export{g as __pageData,v as default};
