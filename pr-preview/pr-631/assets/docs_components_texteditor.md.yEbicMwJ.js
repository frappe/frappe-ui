import{_ as h}from"./chunks/PropsTable.vue_vue_type_script_setup_true_lang.ImaRUcB3.js";import{_ as z}from"./chunks/SlotsTable.vue_vue_type_script_setup_true_lang.Dz75aejz.js";import{_ as x}from"./chunks/EmitsTable.vue_vue_type_script_setup_true_lang.CWvQ1iCk.js";import{a4 as u,a5 as b,a as d,a6 as y}from"./chunks/theme.4h0R34f5.js";import{d as m,o as _,i as f,e as i,p as w,U as e,a as s,b as l,a6 as a,ae as g,c as v}from"./chunks/framework.Bo3zwgXD.js";const j=m({__name:"Example",setup(r){const t=w(`
<div>
  <h2>Heading 2</h2>
  <p>
...
`);return(n,c)=>(_(),f(i(u),{"editor-class":"prose-sm min-h-[4rem] border rounded-b-lg border-t-0 p-2",content:t.value,placeholder:"Type something...",onChange:c[0]||(c[0]=p=>t.value.value=p),bubbleMenu:!0,"fixed-menu":!0},null,8,["content"]))}}),k={class:"mt-2 flex flex-col justify-between sm:flex-row sm:items-center"},C={class:"mt-2 flex items-center justify-end space-x-2 sm:mt-0"},E=m({__name:"Comment",setup(r){const t=w(""),n=["Paragraph",["Heading 2","Heading 3","Heading 4"],"Separator","Bold","Italic","Separator","Bullet List","Numbered List","Separator","Link","Image"];return(c,p)=>(_(),f(i(u),{ref:"textEditor","editor-class":"prose-sm max-w-none min-h-[4rem]",content:t.value,onChange:p[0]||(p[0]=o=>t.value.value=o),"starterkit-options":{heading:{levels:[2,3,4]}},placeholder:"Write something amazing..."},{editor:e(({editor:o})=>[l(i(y),{class:"max-h-[50vh] overflow-y-auto border rounded-lg p-4",editor:o},null,8,["editor"])]),bottom:e(()=>[s("div",k,[l(i(b),{class:"-ml-1 overflow-x-auto",buttons:n}),s("div",C,[l(i(d),null,{default:e(()=>[...p[1]||(p[1]=[a("Cancel",-1)])]),_:1}),l(i(d),{variant:"solid"},{default:e(()=>[...p[2]||(p[2]=[a("Submit",-1)])]),_:1})])])]),_:1},8,["content"]))}}),I=JSON.parse('{"title":"TextEditor","description":"","frontmatter":{},"headers":[],"relativePath":"docs/components/texteditor.md","filePath":"docs/components/texteditor.md","lastUpdated":1768439812000}'),T={name:"docs/components/texteditor.md"},S=Object.assign(T,{setup(r){return(t,n)=>{const c=g("ComponentPreview");return _(),v("div",null,[n[3]||(n[3]=s("h1",{id:"texteditor",tabindex:"-1"},[a("TextEditor "),s("a",{class:"header-anchor",href:"#texteditor","aria-label":"Permalink to “TextEditor”"},"​")],-1)),n[4]||(n[4]=s("p",null,"A rich text editor based on TipTap for creating and formatting content. Offers intuitive controls, styling options, and smooth editing experience.",-1)),n[5]||(n[5]=s("h2",{id:"default",tabindex:"-1"},[a("Default "),s("a",{class:"header-anchor",href:"#default","aria-label":"Permalink to “Default”"},"​")],-1)),l(c,{name:"TextEditor-Example"},{code:e(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(j)]),_:1}),n[6]||(n[6]=s("h2",{id:"comment-editor",tabindex:"-1"},[a("Comment Editor "),s("a",{class:"header-anchor",href:"#comment-editor","aria-label":"Permalink to “Comment Editor”"},"​")],-1)),l(c,{name:"TextEditor-Comment"},{code:e(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ref"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(z,{data:[{name:"top",description:"",type:"{ editor: { contentComponent: { uid: number; type: FunctionalComponent<{}, {}, any, {}> | { [x: stri"},{name:"editor",description:"",type:"{ editor: { contentComponent: { uid: number; type: FunctionalComponent<{}, {}, any, {}> | { [x: stri"},{name:"bottom",description:"",type:"{ editor: { contentComponent: { uid: number; type: FunctionalComponent<{}, {}, any, {}> | { [x: stri"}]}),l(x,{data:[{name:"change",description:"",type:"[content: string]"},{name:"focus",description:"",type:"[event: FocusEvent]"},{name:"blur",description:"",type:"[event: FocusEvent]"},{name:"transaction",description:"",type:"[editor: object]"}]})])}}});export{I as __pageData,S as default};
