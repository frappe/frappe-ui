import{_ as ts}from"./chunks/PropsTable.CGAc7h40.js";import{_ as ps}from"./chunks/SlotsTable.CUNmAgfs.js";import{_ as cs}from"./chunks/EmitsTable.Bp11G1vJ.js";import{by as is}from"./chunks/theme.VPJp4lxG.js";import{t as rs,B as _s}from"./chunks/axisChartCommon.DcUM-Srx.js";import{b as H,d as os}from"./chunks/format.DrLjWwdn.js";import{p as hs}from"./chunks/hiddenSeries.BGnbo1Bl.js";import{p as ds,a as us,O as ys,d as fs,u as ms}from"./chunks/tokens.xQgu7ODm.js";import{_ as ws}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.vcyqpYBB.js";import{_ as vs}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.Gqah68sb.js";import{_ as gs}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CYshPEXp.js";import{J as O,aV as ks,b9 as bs,ae as g,p as zs,A as $,bf as h,ao as z,a2 as M,M as W,E as u,o as s,a1 as E,a3 as G,r as k,F as T,an as K,aG as A,Z as U,ak as D,l as v,ah as xs,aw as P,D as a,ap as Y,B as S}from"./chunks/framework.C2OQK7pm.js";const js=6,Cs=2,Ss="categorical",Ps=1.5;function Ts(p,{tokens:r,hiddenSlices:l=[]}){const e=As(p),_=ds(p.palette,r,e.length,Ss),t=e.reduce((y,c)=>l.includes(c.name)?y:y+c.value,0),i=e.map(y=>l.includes(y.name)||!t?0:y.value/t*100),d=Os(i);return e.map((y,c)=>({...y,color:_[c],hidden:l.includes(y.name),percent:i[c],width:d[c]}))}function Os(p,r=Ps){const l=p.map(i=>i>0&&i<r?r:i),_=l.reduce((i,d)=>i+d,0)-100;if(_<=0)return l;const t=l.reduce((i,d)=>i+Math.max(0,d-r),0);return _>=t?p:l.map(i=>{const d=Math.max(0,i-r);return i-d*(_/t)})}function As(p){const l=(p.data??[]).map(c=>({row:c,value:rs(c[p.valueColumn])})).filter(c=>c.value!==null&&c.value>=0),e=Math.max(Cs,p.maxSlices??js),_=l.length>e?e-1:l.length,t=Rs(l,_),i=new Set,d=[],y=[];return l.forEach((c,x)=>{if(!t.has(x)){y.push(c);return}const C=Es(c.row[p.categoryColumn]);d.push({name:Ds(C,i),label:C,value:c.value,rows:[c.row],isOthers:!1})}),y.length?[...d,{name:ys,label:us,value:y.reduce((c,x)=>c+x.value,0),rows:y.map(c=>c.row),isOthers:!0}]:d}function Rs(p,r){if(r>=p.length)return new Set(p.map((e,_)=>_));const l=p.map((e,_)=>({value:e.value,index:_}));return l.sort((e,_)=>_.value-e.value||e.index-_.index),new Set(l.slice(0,r).map(e=>e.index))}function Es(p){return p==null||p===""?"(Blank)":String(p)}function Ds(p,r){let l=p,e=2;for(;r.has(l);)l=`${p} (${e++})`;return r.add(l),l}const Bs=["data-size"],Ls=["data-state","aria-label","onMouseenter","onFocus","onClick"],qs=3,B=O({__name:"PercentageBarChart",props:U({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},category:{},value:{},maxSlices:{},size:{},hiddenSlices:{},format:{type:Function},palette:{}},{hiddenSlices:{default:()=>[]},hiddenSlicesModifiers:{}}),emits:U(["select"],["update:hiddenSlices"]),setup(p,{emit:r}){const l=p,e=ks(p,"hiddenSlices"),_=r,t=D(),i=v(()=>l.dir??fs()),d={sm:{track:"h-2",hovered:"h-2.5",radius:3},md:{track:"h-3",hovered:"h-3.5",radius:4}},y=v(()=>l.size??"sm"),c=v(()=>d[y.value]),x=is(),C=v(()=>!!(l.title||l.subtitle||x.actions)),X=v(()=>({data:l.data,categoryColumn:l.category,valueColumn:l.value,maxSlices:l.maxSlices,palette:l.palette,dir:i.value})),{tokens:J}=ms(t),R=v(()=>Ts(X.value,{tokens:J.value,hiddenSlices:e.value})),j=v(()=>R.value.filter(n=>!n.hidden&&n.width>0)),Z=v(()=>!j.value.length),b=D(null),L=v(()=>j.value.some(n=>n.name===b.value)?b.value:null),Q=n=>L.value!==null&&L.value!==n.name,f=xs({open:!1,x:0,y:0,items:[],rows:[]});function ss(n,m){q(n),I(m),f.open=!0}function as(n,m){q(n);const o=m.currentTarget.getBoundingClientRect();f.x=o.left+o.width/2,f.y=o.bottom,f.open=!0}function q(n){b.value=n.name,f.items=[{name:n.name,label:n.label,color:n.color,value:n.value,formattedValue:V(n.value),percent:n.percent,kind:"series"}],f.rows=n.rows}function I(n){f.open&&(f.x=n.clientX,f.y=n.clientY)}function F(){b.value=null,f.open=!1}function ns(n){_("select",{name:n.label,value:n.value,percent:n.percent,rows:n.rows})}function ls(n){return`${n.label}, ${V(n.value)}, ${H(n.percent)}`}function V(n){return l.format?l.format(n):os(n)}const N=v(()=>R.value.map(n=>({name:n.name,label:n.label,color:n.color,hidden:n.hidden,hint:n.hidden?void 0:H(n.percent)})));function es(n){const m=e.value;if(m.includes(n)){e.value=m.filter(w=>w!==n);return}j.value.some(w=>w.name===n)&&j.value.length<=1||(e.value=[...m,n])}return bs(()=>R.value.map(n=>n.name),n=>{e.value=hs(e.value,n)}),(n,m)=>(g(),zs(ws,{title:p.title,subtitle:p.subtitle,loading:p.loading,error:p.error,empty:Z.value,dir:i.value},$({default:h(()=>[s("div",{ref_key:"root",ref:t,class:E(["flex h-full w-full items-center",C.value&&"pt-2"])},[s("div",{"data-slot":"chart-track","data-size":y.value,class:E(["flex w-full items-center",c.value.track]),style:G({gap:`${qs}px`})},[(g(!0),k(T,null,K(j.value,o=>(g(),k("button",{key:o.name,type:"button","data-slot":"chart-slice","data-state":b.value===o.name?"active":void 0,class:E(["transition-[height,width,opacity] duration-150 focus-visible:focus-ring motion-reduce:transition-none",b.value===o.name?c.value.hovered:c.value.track]),style:G({width:`${o.width}%`,backgroundColor:o.color,borderRadius:`${c.value.radius}px`,opacity:Q(o)?A(_s):void 0}),"aria-label":ls(o),onMouseenter:w=>ss(o,w),onMousemove:m[0]||(m[0]=w=>I(w)),onMouseleave:F,onFocus:w=>as(o,w),onBlur:F,onClick:w=>ns(o)},null,46,Ls))),128))],14,Bs)],2),u(gs,{open:f.open,x:f.x,y:f.y,items:f.items,rows:f.rows,dir:i.value},$({_:2},[n.$slots.tooltip?{name:"default",fn:h(o=>[z(n.$slots,"tooltip",M(W(o)))]),key:"0"}:void 0]),1032,["open","x","y","items","rows","dir"])]),_:2},[n.$slots["title-suffix"]?{name:"title-suffix",fn:h(()=>[z(n.$slots,"title-suffix")]),key:"0"}:void 0,n.$slots.actions?{name:"actions",fn:h(()=>[z(n.$slots,"actions")]),key:"1"}:void 0,n.$slots.loading?{name:"loading",fn:h(()=>[z(n.$slots,"loading")]),key:"2"}:void 0,n.$slots.error?{name:"error",fn:h(o=>[z(n.$slots,"error",M(W(o)))]),key:"3"}:void 0,n.$slots.empty?{name:"empty",fn:h(()=>[z(n.$slots,"empty")]),key:"4"}:void 0,N.value.length>1?{name:"legend",fn:h(()=>[u(vs,{items:N.value,onChange:es,onHighlight:m[1]||(m[1]=o=>b.value=o)},null,8,["items"])]),key:"5"}:void 0]),1032,["title","subtitle","loading","error","empty","dir"]))}}),Is={class:"flex h-full min-h-52 w-full items-center justify-center"},Fs={class:"flex w-full max-w-md flex-col gap-8"},Vs={class:"text-p-xs text-ink-gray-5"},Ns=O({__name:"PercentageSizes",setup(p){const r=[{source:"Organic",sessions:4820},{source:"Referral",sessions:2140},{source:"Paid",sessions:980}],l=["sm","md"];return(e,_)=>(g(),k("div",Is,[s("div",Fs,[(g(),k(T,null,K(l,t=>s("div",{key:t,class:"flex flex-col gap-2"},[s("span",Vs,'size="'+P(t)+'"',1),u(A(B),{data:r,category:"source",value:"sessions",size:t},null,8,["size"])])),64))])]))}}),Hs={class:"flex h-full min-h-52 w-full items-center justify-center"},$s={class:"flex w-full max-w-lg flex-col gap-3"},Ms={class:"text-p-sm text-ink-gray-5"},Ws=O({__name:"PercentageStorage",setup(p){const r=[{site:"shop.example.com",gb:214},{site:"crm.example.com",gb:96},{site:"docs.example.com",gb:41},{site:"staging.example.com",gb:12},{site:"blog.example.com",gb:7},{site:"status.example.com",gb:3},{site:"links.example.com",gb:1}],l=_=>`${_} GB`,e=D(null);return(_,t)=>(g(),k("div",Hs,[s("div",$s,[u(A(B),{data:r,category:"site",value:"gb","max-slices":4,format:l,title:"Disk used",subtitle:"374 GB of 500 GB",onSelect:t[0]||(t[0]=i=>e.value=i)}),s("p",Ms,[e.value?(g(),k(T,{key:0},[a(" Selected "+P(e.value.name)+" · "+P(Math.round(e.value.percent))+"% · "+P(e.value.rows.length)+" site(s) behind it ",1)],64)):(g(),k(T,{key:1},[a(" Select a slice — Others carries every site it groups. ")],64))])])]))}}),Gs={class:"flex h-full min-h-52 w-full items-center justify-center"},Us={class:"w-full max-w-md"},Ys=O({__name:"PercentageTickets",setup(p){const r=[{state:"Open",tickets:128},{state:"Waiting on customer",tickets:64},{state:"Resolved",tickets:412}],l=e=>`${e.toLocaleString("en-US")} tickets`;return(e,_)=>(g(),k("div",Gs,[s("div",Us,[u(A(B),{data:r,category:"state",value:"tickets",format:l,title:"Support queue",subtitle:"604 tickets this week"})])]))}}),ia=JSON.parse('{"title":"PercentageBarChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/percentagebarchart.md","filePath":"docs/charts/percentagebarchart.md","lastUpdated":0}'),Ks={name:"docs/charts/percentagebarchart.md"},ra=Object.assign(Ks,{setup(p){const r=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
the chart cannot draw shows the empty state, not this one.`,required:!1,type:"string | null"},{name:"data",description:'The rows to draw. One row is one slice, before the "Others" grouping.',required:!0,type:"Record<string, any>[]"},{name:"category",description:"Row key holding the slice name.",required:!0,type:"string"},{name:"value",description:"Row key holding the slice size.",required:!0,type:"string"},{name:"maxSlices",description:'How many slices the bar holds, "Others" included. Past that it keeps the\nlargest `maxSlices - 1` and sums the tail into a single "Others" slice,\nnamed `OTHERS_KEY`. Same word and same behavior as `DonutChart`, so a\nbreakdown carries it across when it moves from the ring to the bar.\nDefaults to 6 — a track runs out of readable width sooner than a ring,\nwhich defaults to 9.',required:!1,type:"number"},{name:"size",description:"How thick the track is drawn: `'sm'` 8px, the default, for a strip under\nthe number it breaks down; `'md'` 12px where the breakdown is itself what\nthe card is about. The corner follows the thickness — the thinner track\ncannot carry the deeper one without rounding into capsules.",required:!1,type:'"sm" | "md"'},{name:"hiddenSlices",description:"Slices the legend has switched off, by name. Bind it with\n`v-model:hiddenSlices` to drive the legend from the app, or to keep what\na reader hid across a reload. Left unbound, the legend owns it.\n\n`DonutChart`'s word, because it is `DonutChart`'s mark: the two read the\nsame rows into the same parts and differ only in the shape they lay them\nout in. `spec/charts.md` records the ruling.",required:!1,type:"string[]",default:"[]"},{name:"format",description:"Prints every value the bar shows: the tooltip, and each slice's name.",required:!1,type:"ChartValueFormatter"},{name:"palette",description:"Defaults to `'categorical'`: the parts are unrelated, not steps of a ramp.",required:!1,type:"ChartPalette"}],l=[{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"},{name:"actions",description:"Controls at the top right of the card, e.g. a period Select or a Dropdown.",type:"any"},{name:"title-suffix",description:"A mark right after the title, on the same line. The title truncates\naround it and it keeps its width. It renders in the title's font size, so\ncontent sized in `em` is smaller on a NumberCard than on a chart.",type:"any"},{name:"tooltip",description:'Replaces the tooltip body. `items` holds the hovered slice alone. A\nnamed slice carries one row, and "Others" every row it collapsed.',type:"ChartTooltipSlotProps"}],e=[{name:"select",description:`A slice was selected, by click or by Enter on the keyboard. The "Others"
slice carries every row it grouped, so a caller can drill into the tail
as well as into a named part.`,type:"[event: PercentageBarSliceEvent]"},{name:"update:hiddenSlices",description:"Fired when the hidden slices changes.",type:"[value: string[]]"}];return(_,t)=>{const i=Y("ComponentPreview"),d=Y("ClientOnly");return g(),k("div",null,[t[4]||(t[4]=S('<h1 id="percentagebarchart" tabindex="-1">PercentageBarChart <a class="header-anchor" href="#percentagebarchart" aria-label="Permalink to “PercentageBarChart”">​</a></h1><p>One bar split into the parts that make up a total.</p><p>A single 100% stacked bar, also called a segmented bar. It is a ring unrolled, and it fits where a ring does not: a strip a few pixels tall under a number, splitting up the total above it. Use <code>DonutChart</code> when the breakdown fills the card, and this when the breakdown sits under something else. It is drawn as plain divs, with no echarts.</p><p>Three or four parts read at a glance. Past that the bar is still accurate, but the legend is doing the work, and <code>DonutChart</code> or <code>BarChart</code> gives each part a label of its own.</p><h2 id="parts-of-a-whole" tabindex="-1">Parts of a whole <a class="header-anchor" href="#parts-of-a-whole" aria-label="Permalink to “Parts of a whole”">​</a></h2><p><code>category</code> and <code>value</code> name the two columns the bar needs, the same pair <code>DonutChart</code> takes. One row is one slice, and each slice is as wide as its share of the total. <code>format</code> formats the numbers in the tooltip.</p><p>The parts are slices here for the same reason they are on the ring: the two charts read the same rows into the same parts, and only the shape they are laid out in differs. So a breakdown moves between the ring and the bar with its props intact — <code>maxSlices</code> and <code>hiddenSlices</code> mean the same thing in both.</p><p>Rows draw in the order you pass them. They are not sorted by size, because a breakdown is usually written in the order it is read, and sorting would break that order.</p>',8)),u(d,null,{default:h(()=>[u(i,{name:"Charts-PercentageTickets","self-layout":""},{code:h(()=>[...t[0]||(t[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"PercentageBarChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"      <"),s("span",{class:"s_wac0bt"},"PercentageBarChart")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:h(()=>[u(Ys)]),_:1})]),_:1}),t[5]||(t[5]=S('<h2 id="grouping-the-tail" tabindex="-1">Grouping the tail <a class="header-anchor" href="#grouping-the-tail" aria-label="Permalink to “Grouping the tail”">​</a></h2><p><code>maxSlices</code> limits how many slices the bar draws, and &quot;Others&quot; counts as one of them. So <code>maxSlices</code> of 4 draws three named slices plus &quot;Others&quot;, as in this example. It defaults to 6, where the ring defaults to 9: a track runs out of readable width sooner than a ring runs out of arc. If there are no more categories than the limit, the bar draws them all with no &quot;Others&quot; slice. <code>select</code> reports the data rows behind the slice, and for &quot;Others&quot; that is every grouped row.</p><p>A share too small to see is widened to a readable width, and the difference comes off the wider slices. Without that, a part would show in the legend and be missing from the bar, which reads as a bug. The <code>percent</code> in the tooltip and on the <code>select</code> event is still the true share — only the drawn width changes.</p>',3)),u(d,null,{default:h(()=>[u(i,{name:"Charts-PercentageStorage","self-layout":""},{code:h(()=>[...t[1]||(t[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"PercentageBarChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"PercentageBarSliceEvent"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_6am9cx"},"          Select a slice — Others carries every site it groups.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"        </"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"      </"),s("span",{class:"s_1uuh8p"},"p"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:h(()=>[u(Ws)]),_:1})]),_:1}),t[6]||(t[6]=S('<h2 id="thickness" tabindex="-1">Thickness <a class="header-anchor" href="#thickness" aria-label="Permalink to “Thickness”">​</a></h2><p><code>size</code> is <code>sm</code>, 8px and the default, or <code>md</code>, 12px. Use <code>sm</code> for a bar under a number or inside a table row, and <code>md</code> where the breakdown is what the card is about.</p><p>The corner rounds with the thickness: <code>md</code> uses the same corner as a donut slice, and <code>sm</code> uses a smaller one. A corner half the height would round each slice into a capsule, and a row of capsules reads as separate objects instead of one bar cut into parts.</p><p>Hovering a slice grows it and fades the others, the same pair <code>DonutChart</code> uses on the ring. The legend does it too, so hovering a name finds its slice in the bar.</p>',4)),u(d,null,{default:h(()=>[u(i,{name:"Charts-PercentageSizes","self-layout":""},{code:h(()=>[...t[2]||(t[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"PercentageBarChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"PercentageBarChartProps"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," sizes"),s("span",{class:"s_2ekfrt"},":"),s("span",{class:"s_euu481"}," PercentageBarChartProps"),s("span",{class:"s_13ahmt"},"["),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2575z4"},"size"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_13ahmt"},"][]"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," ["),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2575z4"},"sm"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"md"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  <"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"flex h-full min-h-52 w-full items-center justify-center"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:h(()=>[u(Ns)]),_:1})]),_:1}),t[7]||(t[7]=S(`<h2 id="hiding-a-part" tabindex="-1">Hiding a part <a class="header-anchor" href="#hiding-a-part" aria-label="Permalink to “Hiding a part”">​</a></h2><p>The legend switches parts off, and the remaining slices re-share the bar over the visible total. Bind <code>v-model:hiddenSlices</code> to control that from your app, or to keep what a reader hid across a reload. The last visible slice cannot be hidden, because an empty bar reads as a failure to load.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">PercentageBarChart</span></span>
<span class="line"><span class="s_1i4ay4">  v-model</span><span class="s_1jjt6x">:</span><span class="s_1i4ay4">hiddenSlices</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">hidden</span><span class="s_w1p9wo">&quot;</span></span>
...
<span class="line"><span class="s_6am9cx">/&gt;</span></span></code></pre></div><p>Each slice is a button. It takes focus, shows its tooltip there, and answers Enter with <code>select</code>. Its accessible name carries the share as well as the value, because the width is what a reader who can see the bar reads first.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2>`,5)),u(ts,{name:"PercentageBarChart",data:r},{code:h(()=>[...t[3]||(t[3]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
