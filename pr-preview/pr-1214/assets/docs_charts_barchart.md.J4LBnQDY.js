...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(V)]),_:1})]),_:1}),n[11]||(n[11]=s("h2",{id:"shares-instead-of-totals",tabindex:"-1"},[a("Shares instead of totals "),s("a",{class:"header-anchor",href:"#shares-instead-of-totals","aria-label":"Permalink to “Shares instead of totals”"},"​")],-1)),n[12]||(n[12]=s("p",null,[s("code",null,'stacked="normalized"'),a(" draws a 100% stacked chart. Each value is drawn as its share of its column, and the value axis is fixed at 0-100 so every column fills the plot. "),s("code",null,"maxSeries"),a(" limits how many series "),s("code",null,"splitBy"),a(' creates. The rest are added into one "Others" series, the same way '),s("code",null,"maxSlices"),a(" groups the smallest slices of a donut. The chart keeps the largest series, measured over every x, and keeps them in the order they appear in the data.")],-1)),l(d,null,{default:e(()=>[l(h,{name:"Charts-BarShares","self-layout":""},{code:e(()=>[...n[2]||(n[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"BarChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(F)]),_:1})]),_:1}),n[13]||(n[13]=y('<p>The data rows do not change, so the plot shows the share and the tooltip shows both the share and the measured number. <code>yAxis.format</code> formats that number in the tooltip. The axis ticks always show percentages, even if you set <code>yAxis.format</code> or an <code>axisLabel.formatter</code> in that axis&#39;s <code>echartOptions</code>.</p><p>Shares are computed per stack. Two stacks with different <code>stackName</code>s each reach 100, and a bar stack and an area stack are separate totals. A series that stacks with nothing (a line, or a bar or area on its own) keeps its own values. If its axis is fixed at 0-100, you get a warning in dev mode. Move it to <code>y2</code> to give it its own scale. A <code>min</code> or <code>max</code> on a fixed axis is ignored, also with a warning, because a column that stops short of the top no longer shows a whole.</p><p><code>maxSeries</code> applies to <code>splitBy</code> only. A <code>y</code> list names each column, so no column is dropped, and setting <code>maxSeries</code> gives a warning instead. The &quot;Others&quot; series has the reserved key <code>__others__</code>, so a group that is really named &quot;Others&quot; does not clash with it. A <code>seriesConfig.__others__</code> entry renames or recolors it like any other series.</p><h2 id="horizontal-bars" tabindex="-1">Horizontal bars <a class="header-anchor" href="#horizontal-bars" aria-label="Permalink to “Horizontal bars”">​</a></h2><p><code>horizontal</code> moves the category axis to Y, so long labels stay readable. <code>seriesConfig</code> sets the look of each series, keyed by series name. Here it prints the value on each bar. <code>showDataLabels</code> on the chart prints them on every series at once, and a <code>seriesConfig</code> entry overrides it for one.</p>',5)),l(d,null,{default:e(()=>[l(h,{name:"Charts-BarHorizontal","self-layout":""},{code:e(()=>[...n[3]||(n[3]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"BarChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(D)]),_:1})]),_:1}),n[15]||(n[15]=y('<p>The sequential ramp assigns colors by mark type, not by series order: lines get the dark end and bars get the light colors. A bar is large enough to see in a light color, but a 2px line in the same color disappears. The other palettes keep series order, because the order of a custom list, a diverging ramp or a categorical set has meaning.</p><p>Bars stack with bars and areas with areas. A line never stacks. <code>horizontal</code> draws bars only. A series set to another type is drawn as a bar, with a warning in dev mode.</p><h2 id="targets-and-thresholds" tabindex="-1">Targets and thresholds <a class="header-anchor" href="#targets-and-thresholds" aria-label="Permalink to “Targets and thresholds”">​</a></h2><p><code>referenceLines</code> draws a line across the plot at a fixed value, such as a quota, a break-even point or a release date. Each line takes a <code>value</code> and an optional <code>label</code>, <code>color</code> and <code>dashed</code>. Reference lines are not series: they have no legend entry and cannot be hidden.</p><p><code>labelPlacement</code> moves the label when it covers something. It names an end of the line and a side of it: <code>&#39;end-top&#39;</code> (the default), <code>&#39;end-bottom&#39;</code>, <code>&#39;start-top&#39;</code> or <code>&#39;start-bottom&#39;</code>. The ends follow the direction of the axis the line runs along, so an RTL chart swaps them. A vertical line has a rotated label, and its two sides are left and right.</p>',5)),l(d,null,{default:e(()=>[l(h,{name:"Charts-BarTarget","self-layout":""},{code:e(()=>[...n[5]||(n[5]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"BarChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(E)]),_:1})]),_:1}),n[16]||(n[16]=y('<p><code>axis</code> sets which axis <code>value</code> belongs to: <code>&#39;y&#39;</code> (the default) or <code>&#39;y2&#39;</code> for a horizontal line at a value, <code>&#39;x&#39;</code> for a vertical line at a category or date. <code>horizontal</code> swaps the two axes and the lines follow. A line outside the plotted range is not drawn, because the scale follows the data, not the lines. Set <code>yAxis.min</code> or <code>max</code> to bring a distant target into view.</p><h2 id="context-in-the-tooltip" tabindex="-1">Context in the tooltip <a class="header-anchor" href="#context-in-the-tooltip" aria-label="Permalink to “Context in the tooltip”">​</a></h2><p><code>tooltipColumns</code> names columns that show only in the tooltip. They get no mark, no legend entry, no color and no place on the value axis. See <a href="/pr-preview/pr-1214/docs/charts/linechart#context-in-the-tooltip">LineChart</a>.</p><h2 id="hiding-a-series" tabindex="-1">Hiding a series <a class="header-anchor" href="#hiding-a-series" aria-label="Permalink to “Hiding a series”">​</a></h2><p>A chart with more than one series draws a legend under the plot. Press an entry to hide that series, and the value axis rescales to the series that are left.</p><p>Bind <code>v-model:hiddenSeries</code> to start with a series hidden, or to hide series from your own control. It holds series keys: a <code>y</code> column name for wide data, a value of the <code>splitBy</code> column for long data, or <code>__others__</code> for the &quot;Others&quot; series. <code>LineChart</code>, <code>AreaChart</code> and <code>ScatterChart</code> take the same model.</p><h2 id="selecting-a-bar" tabindex="-1">Selecting a bar <a class="header-anchor" href="#selecting-a-bar" aria-label="Permalink to “Selecting a bar”">​</a></h2><p><code>select</code> reports the series, the value and the data row of the bar, so you can open the records behind it. It fires on click, and on Enter or Space when the keyboard cursor is on the bar.</p>',8)),l(d,null,{default:e(()=>[l(h,{name:"Charts-BarSelect","self-layout":""},{code:e(()=>[...n[6]||(n[6]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(v,{data:p}),l(b,{data:c}),l(z,{data:i})])}}});export{fs as __pageData,js as default};
