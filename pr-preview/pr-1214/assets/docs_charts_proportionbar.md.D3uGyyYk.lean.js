import{_ as ts}from"./chunks/PropsTable.CGAc7h40.js";import{_ as ps}from"./chunks/SlotsTable.CUNmAgfs.js";import{_ as cs}from"./chunks/EmitsTable.Bp11G1vJ.js";import"./chunks/theme.VPJp4lxG.js";import{t as is,B as rs}from"./chunks/axisChartCommon.DcUM-Srx.js";import{b as H,d as _s}from"./chunks/format.DrLjWwdn.js";import{p as os}from"./chunks/hiddenSeries.BGnbo1Bl.js";import{p as hs,a as ds,O as us,d as ys,u as fs}from"./chunks/tokens.xQgu7ODm.js";import{_ as ms}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.vcyqpYBB.js";import{_ as ws}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.Gqah68sb.js";import{_ as gs}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CYshPEXp.js";import{J as O,aV as vs,b1 as ks,b9 as bs,ae as g,p as zs,A as $,bf as h,ao as z,a2 as M,M as W,E as u,o as s,a1 as E,a3 as G,r as v,F as P,an as K,aG as A,Z as U,ak as D,l as w,ah as xs,aw as T,D as a,ap as Y,B as S}from"./chunks/framework.C2OQK7pm.js";const js=6,Cs=2,Ss="categorical",Ts=1.5;function Ps(p,{tokens:r,hiddenSegments:l=[]}){const e=As(p),_=hs(p.palette,r,e.length,Ss),t=e.reduce((y,c)=>l.includes(c.name)?y:y+c.value,0),i=e.map(y=>l.includes(y.name)||!t?0:y.value/t*100),d=Os(i);return e.map((y,c)=>({...y,color:_[c],hidden:l.includes(y.name),percent:i[c],width:d[c]}))}function Os(p,r=Ts){const l=p.map(i=>i>0&&i<r?r:i),_=l.reduce((i,d)=>i+d,0)-100;if(_<=0)return l;const t=l.reduce((i,d)=>i+Math.max(0,d-r),0);return _>=t?p:l.map(i=>{const d=Math.max(0,i-r);return i-d*(_/t)})}function As(p){const l=(p.data??[]).map(c=>({row:c,value:is(c[p.valueColumn])})).filter(c=>c.value!==null&&c.value>=0),e=Math.max(Cs,p.maxSegments??js),_=l.length>e?e-1:l.length,t=Rs(l,_),i=new Set,d=[],y=[];return l.forEach((c,x)=>{if(!t.has(x)){y.push(c);return}const j=Es(c.row[p.categoryColumn]);d.push({name:Ds(j,i),label:j,value:c.value,rows:[c.row],isOthers:!1})}),y.length?[...d,{name:us,label:ds,value:y.reduce((c,x)=>c+x.value,0),rows:y.map(c=>c.row),isOthers:!0}]:d}function Rs(p,r){if(r>=p.length)return new Set(p.map((e,_)=>_));const l=p.map((e,_)=>({value:e.value,index:_}));return l.sort((e,_)=>_.value-e.value||e.index-_.index),new Set(l.slice(0,r).map(e=>e.index))}function Es(p){return p==null||p===""?"(Blank)":String(p)}function Ds(p,r){let l=p,e=2;for(;r.has(l);)l=`${p} (${e++})`;return r.add(l),l}const Bs=["data-size"],Ls=["data-state","aria-label","onMouseenter","onFocus","onClick"],qs=3,B=O({__name:"ProportionBar",props:U({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},category:{},value:{},maxSegments:{},size:{},hiddenSegments:{},format:{type:Function},palette:{}},{hiddenSegments:{default:()=>[]},hiddenSegmentsModifiers:{}}),emits:U(["select"],["update:hiddenSegments"]),setup(p,{emit:r}){const l=p,e=vs(p,"hiddenSegments"),_=r,t=D(),i=w(()=>l.dir??ys()),d={sm:{track:"h-2",hovered:"h-2.5",radius:3},md:{track:"h-3",hovered:"h-3.5",radius:4}},y=w(()=>l.size??"sm"),c=w(()=>d[y.value]),x=ks(),j=w(()=>!!(l.title||l.subtitle||x.actions)),X=w(()=>({data:l.data,categoryColumn:l.category,valueColumn:l.value,maxSegments:l.maxSegments,palette:l.palette,dir:i.value})),{tokens:J}=fs(t),R=w(()=>Ps(X.value,{tokens:J.value,hiddenSegments:e.value})),C=w(()=>R.value.filter(n=>!n.hidden&&n.width>0)),Z=w(()=>!C.value.length),k=D(null),L=w(()=>C.value.some(n=>n.name===k.value)?k.value:null),Q=n=>L.value!==null&&L.value!==n.name,f=xs({open:!1,x:0,y:0,items:[],rows:[]});function ss(n,m){q(n),I(m),f.open=!0}function as(n,m){q(n);const o=m.currentTarget.getBoundingClientRect();f.x=o.left+o.width/2,f.y=o.bottom,f.open=!0}function q(n){k.value=n.name,f.items=[{name:n.name,label:n.label,color:n.color,value:n.value,formattedValue:N(n.value),percent:n.percent,kind:"series"}],f.rows=n.rows}function I(n){f.open&&(f.x=n.clientX,f.y=n.clientY)}function F(){k.value=null,f.open=!1}function ns(n){_("select",{name:n.label,value:n.value,percent:n.percent,rows:n.rows})}function ls(n){return`${n.label}, ${N(n.value)}, ${H(n.percent)}`}function N(n){return l.format?l.format(n):_s(n)}const V=w(()=>R.value.map(n=>({name:n.name,label:n.label,color:n.color,hidden:n.hidden,hint:n.hidden?void 0:H(n.percent)})));function es(n){const m=e.value;if(m.includes(n)){e.value=m.filter(o=>o!==n);return}C.value.length<=1||(e.value=[...m,n])}return bs(()=>R.value.map(n=>n.name),n=>{e.value=os(e.value,n)}),(n,m)=>(g(),zs(ms,{title:p.title,subtitle:p.subtitle,loading:p.loading,error:p.error,empty:Z.value,dir:i.value},$({default:h(()=>[s("div",{ref_key:"root",ref:t,class:E(["flex h-full w-full items-center",j.value&&"pt-2"])},[s("div",{"data-slot":"chart-track","data-size":y.value,class:E(["flex w-full items-center",c.value.track]),style:G({gap:`${qs}px`})},[(g(!0),v(P,null,K(C.value,o=>(g(),v("button",{key:o.name,type:"button","data-slot":"chart-segment","data-state":k.value===o.name?"active":void 0,class:E(["transition-[height,width,opacity] duration-150 focus-visible:focus-ring motion-reduce:transition-none",k.value===o.name?c.value.hovered:c.value.track]),style:G({width:`${o.width}%`,backgroundColor:o.color,borderRadius:`${c.value.radius}px`,opacity:Q(o)?A(rs):void 0}),"aria-label":ls(o),onMouseenter:b=>ss(o,b),onMousemove:m[0]||(m[0]=b=>I(b)),onMouseleave:F,onFocus:b=>as(o,b),onBlur:F,onClick:b=>ns(o)},null,46,Ls))),128))],14,Bs)],2),u(gs,{open:f.open,x:f.x,y:f.y,items:f.items,rows:f.rows,dir:i.value},$({_:2},[n.$slots.tooltip?{name:"default",fn:h(o=>[z(n.$slots,"tooltip",M(W(o)))]),key:"0"}:void 0]),1032,["open","x","y","items","rows","dir"])]),_:2},[n.$slots["title-suffix"]?{name:"title-suffix",fn:h(()=>[z(n.$slots,"title-suffix")]),key:"0"}:void 0,n.$slots.actions?{name:"actions",fn:h(()=>[z(n.$slots,"actions")]),key:"1"}:void 0,n.$slots.loading?{name:"loading",fn:h(()=>[z(n.$slots,"loading")]),key:"2"}:void 0,n.$slots.error?{name:"error",fn:h(o=>[z(n.$slots,"error",M(W(o)))]),key:"3"}:void 0,n.$slots.empty?{name:"empty",fn:h(()=>[z(n.$slots,"empty")]),key:"4"}:void 0,V.value.length>1?{name:"legend",fn:h(()=>[u(ws,{items:V.value,onChange:es,onHighlight:m[1]||(m[1]=o=>k.value=o)},null,8,["items"])]),key:"5"}:void 0]),1032,["title","subtitle","loading","error","empty","dir"]))}}),Is={class:"flex h-full min-h-52 w-full items-center justify-center"},Fs={class:"flex w-full max-w-md flex-col gap-8"},Ns={class:"text-p-xs text-ink-gray-5"},Vs=O({__name:"ProportionSizes",setup(p){const r=[{source:"Organic",sessions:4820},{source:"Referral",sessions:2140},{source:"Paid",sessions:980}],l=["sm","md"];return(e,_)=>(g(),v("div",Is,[s("div",Fs,[(g(),v(P,null,K(l,t=>s("div",{key:t,class:"flex flex-col gap-2"},[s("span",Ns,'size="'+T(t)+'"',1),u(A(B),{data:r,category:"source",value:"sessions",size:t},null,8,["size"])])),64))])]))}}),Hs={class:"flex h-full min-h-52 w-full items-center justify-center"},$s={class:"flex w-full max-w-lg flex-col gap-3"},Ms={class:"text-p-sm text-ink-gray-5"},Ws=O({__name:"ProportionStorage",setup(p){const r=[{site:"shop.example.com",gb:214},{site:"crm.example.com",gb:96},{site:"docs.example.com",gb:41},{site:"staging.example.com",gb:12},{site:"blog.example.com",gb:7},{site:"status.example.com",gb:3},{site:"links.example.com",gb:1}],l=_=>`${_} GB`,e=D(null);return(_,t)=>(g(),v("div",Hs,[s("div",$s,[u(A(B),{data:r,category:"site",value:"gb","max-segments":4,format:l,title:"Disk used",subtitle:"374 GB of 500 GB",onSelect:t[0]||(t[0]=i=>e.value=i)}),s("p",Ms,[e.value?(g(),v(P,{key:0},[a(" Selected "+T(e.value.name)+" · "+T(Math.round(e.value.percent))+"% · "+T(e.value.rows.length)+" site(s) behind it ",1)],64)):(g(),v(P,{key:1},[a(" Select a segment — Others carries every site it groups. ")],64))])])]))}}),Gs={class:"flex h-full min-h-52 w-full items-center justify-center"},Us={class:"w-full max-w-md"},Ys=O({__name:"ProportionTickets",setup(p){const r=[{state:"Open",tickets:128},{state:"Waiting on customer",tickets:64},{state:"Resolved",tickets:412}],l=e=>`${e.toLocaleString("en-US")} tickets`;return(e,_)=>(g(),v("div",Gs,[s("div",Us,[u(A(B),{data:r,category:"state",value:"tickets",format:l,title:"Support queue",subtitle:"604 tickets this week"})])]))}}),ia=JSON.parse('{"title":"ProportionBar","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/proportionbar.md","filePath":"docs/charts/proportionbar.md","lastUpdated":0}'),Ks={name:"docs/charts/proportionbar.md"},ra=Object.assign(Ks,{setup(p){const r=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:h(()=>[u(Ws)]),_:1})]),_:1}),t[6]||(t[6]=S("",4)),u(d,null,{default:h(()=>[u(i,{name:"Charts-ProportionSizes","self-layout":""},{code:h(()=>[...t[2]||(t[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ProportionBar"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
