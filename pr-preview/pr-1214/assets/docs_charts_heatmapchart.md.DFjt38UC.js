import{_ as k}from"./chunks/PropsTable.CGAc7h40.js";import{_ as g}from"./chunks/SlotsTable.CUNmAgfs.js";import{_ as b}from"./chunks/EmitsTable.Bp11G1vJ.js";import{_ as x}from"./chunks/ExposedTable.BTdNP0SL.js";import"./chunks/theme.VPJp4lxG.js";import{_ as f}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.Ie0IWP4G.js";import{J as w,ae as d,r as u,E as l,aG as h,ap as v,B as z,bf as c,o as s,D as a}from"./chunks/framework.C2OQK7pm.js";import"./chunks/useChart.DwXBz_MP.js";import"./chunks/tokens.xQgu7ODm.js";import"./chunks/usePlotKeyboard.wgRk-9GN.js";import"./chunks/useTooltipDismiss.BobUQTP8.js";import"./chunks/axisChartCommon.DcUM-Srx.js";import"./chunks/format.DrLjWwdn.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.vcyqpYBB.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CYshPEXp.js";import"./chunks/installLabelLayout.BPyCKjNh.js";import"./chunks/axisAlignTicks.DRXqlV7m.js";import"./chunks/labelLayoutHelper.D6oI67rw.js";import"./chunks/dataStackHelper.DeIu8w5K.js";import"./chunks/labelGuideHelper.DHVXm03j.js";import"./chunks/createSeriesData.CN4VCuS3.js";import"./chunks/VisualMapping.SJ0KYTCS.js";const j={class:"h-72 w-full"},C=w({__name:"HeatmapDemand",setup(y){const _=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],r=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],o=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],i=[8,52,38,34,20,15,20,9],p=o.flatMap((n,t)=>n.map((e,m)=>({day:r[t],hour:_[m],deviation:Math.round((e-i[m])/i[m]*100)})));return(n,t)=>(d(),u("div",j,[l(h(f),{data:h(p),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:e=>`${e>0?"+":""}${e}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),S={class:"h-72 w-full"},O=w({__name:"HeatmapSignups",setup(y){const _=["Free","Pro","Team"],r=[[420,455,512,498,540,601],[86,92,104,118,131,147],[12,15,14,21,26,33]],o=_.flatMap((p,n)=>r[n].map((t,e)=>({plan:p,month:new Date(Date.UTC(2024,e,1)),signups:t}))),i=p=>p.toLocaleString("en-US",{month:"short",timeZone:"UTC"});return(p,n)=>(d(),u("div",S,[l(h(f),{data:h(o),x:"month",y:"plan",value:"signups","x-axis":{format:i},"show-data-labels":"",title:"Signups by plan",subtitle:"First half of 2024"},null,8,["data","x-axis"])]))}}),T={class:"h-72 w-full"},A=w({__name:"HeatmapTickets",setup(y){const _=["9am","11am","1pm","3pm","5pm","7pm"],r=["Mon","Tue","Wed","Thu","Fri"],o=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],i=r.flatMap((p,n)=>_.map((t,e)=>({day:p,hour:t,tickets:o[n][e]})));return(p,n)=>(d(),u("div",T,[l(h(f),{data:h(i),x:"hour",y:"day",value:"tickets","show-data-labels":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),ss=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmapchart.md","filePath":"docs/charts/heatmapchart.md","lastUpdated":0}'),R={name:"docs/charts/heatmapchart.md"},as=Object.assign(R,{setup(y){const _=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:c(()=>[l(A)]),_:1})]),_:1}),n[5]||(n[5]=s("h2",{id:"printing-the-categories",tabindex:"-1"},[a("Printing the categories "),s("a",{class:"header-anchor",href:"#printing-the-categories","aria-label":"Permalink to “Printing the categories”"},"​")],-1)),n[6]||(n[6]=s("p",null,[s("code",null,"xAxis.format"),a(" and "),s("code",null,"yAxis.format"),a(" format the categories of their axis, on the axis and in the tooltip. Each gets the raw value from the row, not the category string, so a date column can print as "),s("code",null,"Mar"),a(".")],-1)),n[7]||(n[7]=s("p",null,[a("They change how a category prints, not what it is. Two categories that print the same stay two cells, and "),s("code",null,"select"),a(" still reports the raw value.")],-1)),l(e,null,{default:c(()=>[l(t,{name:"Charts-HeatmapSignups","self-layout":""},{code:c(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"HeatmapChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:c(()=>[l(O)]),_:1})]),_:1}),n[8]||(n[8]=s("h2",{id:"signed-data",tabindex:"-1"},[a("Signed data "),s("a",{class:"header-anchor",href:"#signed-data","aria-label":"Permalink to “Signed data”"},"​")],-1)),n[9]||(n[9]=s("p",null,[a("Use the "),s("code",null,"diverging"),a(" ramp for data with positive and negative values. It is centered on zero. Set "),s("code",null,"min"),a(" and "),s("code",null,"max"),a(" to fix the scale, so the colors mean the same thing across reloads.")],-1)),l(e,null,{default:c(()=>[l(t,{name:"Charts-HeatmapDemand","self-layout":""},{code:c(()=>[...n[2]||(n[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"HeatmapChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(g,{data:r}),l(b,{data:o}),l(x,{data:i})])}}});export{ss as __pageData,as as default};
