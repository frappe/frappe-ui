import{_ as v}from"./chunks/PropsTable.CGAc7h40.js";import{_ as b}from"./chunks/SlotsTable.CUNmAgfs.js";import"./chunks/theme.VPJp4lxG.js";import{_ as z}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.vcyqpYBB.js";import{_ as x}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CYshPEXp.js";import{p as j,u as C}from"./chunks/tokens.xQgu7ODm.js";import{_ as S}from"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.D_AsfCOU.js";import{J as T,ae as u,p as O,bf as t,E as p,aG as o,o as s,r as m,F as A,an as R,aw as P,a3 as E,ak as D,l as L,ah as q,ap as y,B as f,D as a}from"./chunks/framework.C2OQK7pm.js";import"./chunks/format.DrLjWwdn.js";const B=["onMousemove"],I={class:"w-32 shrink-0 truncate text-p-xs text-ink-gray-5"},F=T({__name:"TooltipCustom",setup(w){const _=[{region:"India",signups:4820,trials:1240},{region:"Europe",signups:3610,trials:980},{region:"North America",signups:2970,trials:810},{region:"Southeast Asia",signups:1840,trials:470}],h=Math.max(..._.map(l=>l.signups)),d=D(),{tokens:e}=C(d),c=L(()=>j("categorical",e.value,2)),n=q({open:!1,x:0,y:0,label:"",items:[],rows:[]});function k(l,i){n.label=l.region,n.items=[{name:"signups",label:"Signups",color:c.value[0],value:l.signups,formattedValue:l.signups.toLocaleString(),kind:"series"},{name:"trials",label:"Trials started",color:c.value[1],value:l.trials,formattedValue:l.trials.toLocaleString(),percent:l.trials/l.signups*100,kind:"series"}],n.rows=[l],n.x=i.clientX,n.y=i.clientY,n.open=!0}return(l,i)=>(u(),O(o(S),{class:"h-72"},{default:t(()=>[p(o(z),{title:"Signups by region",subtitle:"Hover a bar — the tooltip is a component, not a canvas overlay"},{default:t(()=>[s("div",{ref_key:"plotEl",ref:d,class:"flex h-full w-full flex-col justify-center gap-2",onMouseleave:i[0]||(i[0]=r=>n.open=!1)},[(u(),m(A,null,R(_,r=>s("div",{key:r.region,class:"flex items-center gap-2",onMousemove:g=>k(r,g)},[s("span",I,P(r.region),1),s("span",{class:"h-5 rounded-2",style:E({width:`${r.signups/o(h)*100}%`,backgroundColor:c.value[0]})},null,4)],40,B)),64))],544),p(o(x),{open:n.open,x:n.x,y:n.y,label:n.label,items:n.items,rows:n.rows},null,8,["open","x","y","label","items","rows"])]),_:1})]),_:1}))}}),K=JSON.parse('{"title":"ChartTooltip","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/charttooltip.md","filePath":"docs/charts/charttooltip.md","lastUpdated":0}'),V={name:"docs/charts/charttooltip.md"},J=Object.assign(V,{setup(w){const _=[{name:"open",description:`Draws the tooltip. It is measured before it is placed, so it flips at the
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:t(()=>[p(F)]),_:1})]),_:1}),e[3]||(e[3]=f(`<h2 id="showing-it" tabindex="-1">Showing it <a class="header-anchor" href="#showing-it" aria-label="Permalink to “Showing it”">​</a></h2><p>The tooltip does not track the pointer itself. The plot tells it what to show and where:</p><ul><li><code>open</code> shows it. It draws nothing while <code>open</code> is false, or when <code>items</code> is empty.</li><li><code>x</code> and <code>y</code> are viewport coordinates, i.e. <code>clientX</code> and <code>clientY</code>.</li><li><code>label</code> heads the rows, e.g. the category or the date the pointer is over.</li><li><code>items</code> are the rows.</li><li><code>rows</code> are the data rows behind the values, passed on to the slot. One row for a point, cell, band or stage, every grouped row for a donut&#39;s &quot;Others&quot; slice, and none for a total that does not come from one row.</li><li><code>dir</code> sets the layout direction. It defaults to <code>document.documentElement.dir</code>.</li></ul><h2 id="rows" tabindex="-1">Rows <a class="header-anchor" href="#rows" aria-label="Permalink to “Rows”">​</a></h2><p>One <code>ChartTooltipItem</code> per row:</p><table tabindex="0"><thead><tr><th>Field</th><th>What it is</th></tr></thead><tbody><tr><td><code>name</code></td><td>Series identity.</td></tr><tr><td><code>label</code></td><td>The series name as it should read.</td></tr><tr><td><code>color</code></td><td>The color the series is drawn in, shown as a swatch.</td></tr><tr><td><code>value</code></td><td>The raw number.</td></tr><tr><td><code>formattedValue</code></td><td>That number as it should print, e.g. through <code>format</code>.</td></tr><tr><td><code>percent</code></td><td>Share of the total, printed after the value. Part-to-whole charts only.</td></tr><tr><td><code>kind</code></td><td><code>&#39;series&#39;</code> for a value the plot draws, <code>&#39;context&#39;</code> for one it does not. A <code>&#39;context&#39;</code> item has no color and prints below a divider.</td></tr></tbody></table><p>The tooltip prints <code>formattedValue</code>. <code>value</code> is for a slot that needs to do its own math.</p><h2 id="placement" tabindex="-1">Placement <a class="header-anchor" href="#placement" aria-label="Permalink to “Placement”">​</a></h2><p>The tooltip is teleported out of the chart and positioned against the viewport, so a card that clips its content cannot clip the tooltip.</p><p>It sits 12px past the pointer, and flips to the other side of it when that would run off the right edge or the bottom. Whatever is left is clamped to 4px inside the window, so a tooltip near a corner still fits.</p><p>The size is measured after render, because slot content can be any size. The tooltip stays hidden for the one frame the measurement takes, so it never shows at the previous position first.</p><h2 id="replacing-the-content" tabindex="-1">Replacing the content <a class="header-anchor" href="#replacing-the-content" aria-label="Permalink to “Replacing the content”">​</a></h2><p>The default slot replaces the whole body, with <code>label</code>, <code>items</code> and <code>rows</code> as slot props. Use it for content the rows cannot show, such as a sparkline, a second measure or a link to the records behind the point.</p><div class="language-vue"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_1zd9e2">&lt;</span><span class="s_1uuh8p">ChartTooltip</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">open</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">open</span><span class="s_w1p9wo">&quot;</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">x</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">x</span><span class="s_w1p9wo">&quot;</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">y</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">y</span><span class="s_w1p9wo">&quot;</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">label</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">label</span><span class="s_w1p9wo">&quot;</span><span class="s_1jjt6x"> :</span><span class="s_1i4ay4">items</span><span class="s_1jjt6x">=</span><span class="s_w1p9wo">&quot;</span><span class="s_22m8k2">items</span><span class="s_w1p9wo">&quot;</span><span class="s_1zd9e2">&gt;</span></span>
