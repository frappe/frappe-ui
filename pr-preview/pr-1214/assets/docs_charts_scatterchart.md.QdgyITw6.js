import{_ as xs}from"./chunks/PropsTable.CGAc7h40.js";import{_ as zs}from"./chunks/SlotsTable.CUNmAgfs.js";import{_ as js}from"./chunks/EmitsTable.Bp11G1vJ.js";import{_ as Cs}from"./chunks/ExposedTable.BTdNP0SL.js";import"./chunks/theme.VPJp4lxG.js";import{_ as $,dy as Ss,z as As,G as Ts,a as Ps,P as Os,aq as Rs,b8 as Ds,b9 as Es,b as Ls,dN as Is,cX as Bs,dO as Ns}from"./chunks/useChart.DwXBz_MP.js";import{u as Fs}from"./chunks/usePlotKeyboard.wgRk-9GN.js";import{u as Ms}from"./chunks/useTooltipDismiss.BobUQTP8.js";import{t as F,c as Vs,D as qs,B as J,A as $s,e as Hs}from"./chunks/axisChartCommon.DcUM-Srx.js";import{a as D,d as Ws}from"./chunks/format.DrLjWwdn.js";import{p as Us,j as os,C as Gs,c as Ys,d as Ks,u as Zs,k as Xs}from"./chunks/tokens.xQgu7ODm.js";import{p as _s,a as Js,d as Qs,b as sa,j as aa}from"./chunks/referenceLines.DAbxsv5P.js";import{t as na,p as ea}from"./chunks/hiddenSeries.BGnbo1Bl.js";import{_ as la}from"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.vcyqpYBB.js";import{_ as ta}from"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.Gqah68sb.js";import{_ as pa}from"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CYshPEXp.js";import{c as ca}from"./chunks/createSeriesData.CN4VCuS3.js";import{a as ia,i as ra,c as oa}from"./chunks/installLabelLayout.BPyCKjNh.js";import{J as E,aV as _a,b9 as Q,l as x,ae as P,p as ha,A as ss,bf as b,ao as C,a2 as as,M as ns,E as g,o as s,$ as da,aG as T,aw as ua,Z as es,ak as M,ah as ls,r as L,ap as ts,B as V,D as a}from"./chunks/framework.C2OQK7pm.js";import"./chunks/dataStackHelper.DeIu8w5K.js";import"./chunks/axisAlignTicks.DRXqlV7m.js";import"./chunks/labelLayoutHelper.D6oI67rw.js";import"./chunks/labelGuideHelper.DHVXm03j.js";var ya=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n.hasSymbolVisual=!0,n}return e.prototype.getInitialData=function(n,l){return ca(null,this,{useEncodeDefaulter:!0})},e.prototype.getProgressive=function(){var n=this.option.progressive;return n??(this.option.large?5e3:this.get("progressive"))},e.prototype.getProgressiveThreshold=function(){var n=this.option.progressiveThreshold;return n??(this.option.large?1e4:this.get("progressiveThreshold"))},e.prototype.brushSelector=function(n,l,p){return p.point(l.getItemLayout(n))},e.prototype.getZLevelKey=function(){return this.getData().count()>this.getProgressiveThreshold()?this.id:""},e.type="series.scatter",e.dependencies=["grid","polar","geo","singleAxis","calendar","matrix"],e.defaultOption={coordinateSystem:"cartesian2d",z:2,legendHoverLink:!0,symbolSize:10,large:!1,largeThreshold:2e3,itemStyle:{opacity:.8},emphasis:{scale:!0},clip:!0,select:{itemStyle:{borderColor:Ss.color.primary}},universalTransition:{divideShape:"clone"}},e})(As),hs=4,fa=(function(){function t(){}return t})(),ma=(function(t){$(e,t);function e(n){var l=t.call(this,n)||this;return l._off=0,l.hoverDataIdx=-1,l}return e.prototype.getDefaultShape=function(){return new fa},e.prototype.reset=function(){this.notClear=!1,this._off=0},e.prototype.beforeBrush=function(n){n&&!n.contentRetained&&this.reset()},e.prototype.buildPath=function(n,l){var p=l.points,r=l.size,i=this.symbolProxy,h=i.shape,_=n.getContext?n.getContext():n,d=_&&r[0]<hs,u=this.softClipShape,y;if(d){this._ctx=_;return}for(this._ctx=null,y=this._off;y<p.length;){var v=p[y++],k=p[y++];isNaN(v)||isNaN(k)||u&&!u.contain(v,k)||(h.x=v-r[0]/2,h.y=k-r[1]/2,h.width=r[0],h.height=r[1],i.buildPath(n,h,!0))}this.incremental&&(this._off=y,this.notClear=!0)},e.prototype.afterBrush=function(){var n=this.shape,l=n.points,p=n.size,r=this._ctx,i=this.softClipShape,h;if(r){for(h=this._off;h<l.length;){var _=l[h++],d=l[h++];isNaN(_)||isNaN(d)||i&&!i.contain(_,d)||r.fillRect(_-p[0]/2,d-p[1]/2,p[0],p[1])}this.incremental&&(this._off=h,this.notClear=!0)}},e.prototype.findDataIndex=function(n,l){for(var p=this.shape,r=p.points,i=p.size,h=Math.max(i[0],4),_=Math.max(i[1],4),d=r.length/2-1;d>=0;d--){var u=d*2,y=r[u]-h/2,v=r[u+1]-_/2;if(n>=y&&l>=v&&n<=y+h&&l<=v+_)return d}return-1},e.prototype.contain=function(n,l){var p=this.transformCoordToLocal(n,l),r=this.getBoundingRect();if(n=p[0],l=p[1],r.contain(n,l)){var i=this.hoverDataIdx=this.findDataIndex(n,l);return i>=0}return this.hoverDataIdx=-1,!1},e.prototype.getBoundingRect=function(){var n=this._rect;if(!n){for(var l=this.shape,p=l.points,r=l.size,i=r[0],h=r[1],_=1/0,d=1/0,u=-1/0,y=-1/0,v=0;v<p.length;){var k=p[v++],O=p[v++];_=Math.min(k,_),u=Math.max(k,u),d=Math.min(O,d),y=Math.max(O,y)}n=this._rect=new Ps(_-i/2,d-h/2,u-_+i,y-d+h)}return n},e})(Os),wa=(function(){function t(){this.group=new Ts}return t.prototype.updateData=function(e,n){this._clear(),this._data=e;var l=this._create();l.setShape({points:e.getLayout("points")}),this._setCommon(l,e,n)},t.prototype.updateLayout=function(e){var n=this._data;if(n){var l=n.getLayout("points");this.group.eachChild(function(p){if(p.startIndex!=null){var r=(p.endIndex-p.startIndex)*2,i=p.startIndex*4*2;l=new Float32Array(l.buffer,i,r)}p.setShape("points",l),p.reset(),p.stopAnimation()})}},t.prototype.incrementalPrepareUpdate=function(e){this._clear()},t.prototype.incrementalUpdate=function(e,n,l,p){var r=this._newAdded[0],i=n.getLayout("points"),h=r&&r.shape.points;if(h&&h.length<2e4){var _=h.length,d=new Float32Array(_+i.length);d.set(h),d.set(i,_),r.endIndex=e.end,r.setShape({points:d})}else{this._newAdded=[];var u=this._create();u.startIndex=e.start,u.endIndex=e.end,u.incremental=l,u.setShape({points:i}),this._setCommon(u,n,p)}},t.prototype.eachRendered=function(e){this._newAdded[0]&&e(this._newAdded[0])},t.prototype._create=function(){var e=new ma({cursor:"default"});return e.ignoreCoarsePointer=!0,this.group.add(e),this._newAdded.push(e),e},t.prototype._setCommon=function(e,n,l){var p=n.hostModel;l=l||{};var r=n.getVisual("symbolSize");e.setShape("size",r instanceof Array?r:[r,r]),e.softClipShape=l.clipShape||null,e.symbolProxy=Rs(n.getVisual("symbol"),0,0,0,0),e.setColor=e.symbolProxy.setColor;var i=e.shape.size[0]<hs;e.useStyle(p.getModel("itemStyle").getItemStyle(i?["color","shadowBlur","shadowColor"]:["color"]));var h=n.getVisual("style"),_=h&&h.fill;_&&e.setColor(_);var d=Ds(e);d.seriesIndex=p.seriesIndex,e.on("mousemove",function(u){d.dataIndex=null;var y=e.hoverDataIdx;y>=0&&(d.dataIndex=y+(e.startIndex||0))})},t.prototype.remove=function(){this._clear()},t.prototype._clear=function(){this._newAdded=[],this.group.removeAll()},t})(),va=(function(t){$(e,t);function e(){var n=t!==null&&t.apply(this,arguments)||this;return n.type=e.type,n}return e.prototype.render=function(n,l,p){var r=n.getData(),i=this._updateSymbolDraw(r,n);i.updateData(r,q(n)),this._finished=!0},e.prototype.incrementalPrepareRender=function(n,l,p){var r=n.getData(),i=this._updateSymbolDraw(r,n);i.incrementalPrepareUpdate(r),this._finished=!1},e.prototype.incrementalRender=function(n,l,p){this._symbolDraw.incrementalUpdate(n,l.getData(),Es(l),q(l)),this._finished=n.end===l.getData().count()},e.prototype.updateTransform=function(n,l,p){var r=n.getData();if(this.group.dirty(),this._finished){var i=_s("").reset(n,l,p);i.progress&&i.progress({start:0,end:r.count(),count:r.count()},r),this._symbolDraw.updateLayout(q(n))}else return{update:!0}},e.prototype.eachRendered=function(n){this._symbolDraw&&this._symbolDraw.eachRendered(n)},e.prototype._updateSymbolDraw=function(n,l){var p=this._symbolDraw,r=l.pipelineContext,i=r.large;return(!p||i!==this._isLargeDraw)&&(p&&p.remove(),p=this._symbolDraw=i?new wa:new Js,this._isLargeDraw=i,this.group.removeAll()),this.group.add(p.group),p},e.prototype.remove=function(n,l){this._symbolDraw&&this._symbolDraw.remove(!0),this._symbolDraw=null},e.prototype.dispose=function(){},e.type="scatter",e})(Ls);function q(t){return{clipShape:Qs(t)}}function ga(t){Is(ia),t.registerSeriesModel(ya),t.registerChartView(va),t.registerLayout(_s("scatter"))}const ba="categorical",A=10,ps=35,cs=.75,is="6%";function ds(t,{tokens:e}){const n=t.data??[],l=[],p=new Map,r=[];for(const _ of n){const d=F(_[t.xColumn]),u=F(_[t.yColumn]);if(d===null||u===null)continue;const y=xa(t,_);let v=p.get(y);v||(v=[],l.push(y),p.set(y,v));const k=t.sizeColumn?F(_[t.sizeColumn]):null;k!==null&&r.push(k),v.push({x:d,y:u,size:k,label:za(t,_),row:_})}const i=ja(r,!!t.sizeColumn),h=Us(t.palette,e,l.length,ba);return l.map((_,d)=>({name:_,label:D(_),color:h[d],points:p.get(_).map(u=>({...u,symbolSize:i(u.size)}))}))}const ka="(Blank)";function xa(t,e){if(!t.splitByColumn)return t.yColumn;const n=e[t.splitByColumn];return n==null||n===""?ka:String(n)}function za(t,e){if(!t.labelColumn)return;const n=e[t.labelColumn];return n==null?void 0:String(n)}function ja(t,e){if(!e)return()=>A;const n=Ca(t);return l=>l===null?A:n(l)}function Ca(t){let e=1/0,n=-1/0;for(const p of t)p<e&&(e=p),p>n&&(n=p);if(e===n){const p=(A+ps)/2;return()=>p}const l=ps-A;return p=>A+(p-e)/(n-e)*l}function Sa(t,e){const{tokens:n,hiddenSeries:l=[],format:p}=e,r=t.dir==="rtl",h=ds(t,e).filter(u=>!l.includes(u.name)),_=Ta(t),d={animation:!0,animationDuration:500,animationDurationUpdate:300,textStyle:{fontFamily:Gs},grid:Vs({horizontal:!1,isRTL:r,labelGutter:0}),xAxis:rs(t.xAxis,n,{horizontal:!0,isRTL:r,format:p?.x,name:t.xAxis?.title}),yAxis:rs(t.yAxis,n,{horizontal:!1,isRTL:r,format:p?.y}),series:[...h.map(u=>Pa(u,{tokens:n,isRTL:r,showLabels:_})),...sa(Aa(t),{tokens:n,horizontal:!1,hasSecondaryValueAxis:!1,hasCategoryAxis:!1,hostSeriesType:"scatter"})]};return os(d,t.echartOptions)}function Aa(t){const e=t.referenceLines;return e?.filter(n=>n.axis==="y2").length,e}function Ta(t){return t.showDataLabels?!!t.labelColumn:!1}function Pa(t,e){const{tokens:n,isRTL:l,showLabels:p}=e;return{type:"scatter",name:t.name,data:t.points.map(r=>({value:[r.x,r.y],symbolSize:r.symbolSize,...p?{name:r.label??""}:{}})),symbol:"circle",itemStyle:{color:t.color,opacity:cs,borderWidth:0},emphasis:{focus:"series",blurScope:"coordinateSystem"},blur:{itemStyle:{opacity:cs*J},label:{opacity:J}},...p?{label:{show:!0,position:l?"left":"right",color:n.dataLabel,fontSize:qs,formatter:r=>String(r?.name??"")},labelLayout:{hideOverlap:!0}}:{}}}function rs(t,e,n){const{horizontal:l,isRTL:p,format:r,name:i}=n,h=os({scale:!0,boundaryGap:[is,is],...i?{name:D(i),nameLocation:"end",nameGap:8,nameTextStyle:{color:e.axisTitle,fontSize:$s}}:{},...r?{axisLabel:{formatter:_=>r(Number(_))}}:{}},t?.echartOptions);return Hs({...t,echartOptions:h},e,{horizontal:l,isRTL:p})}const Oa=["aria-label"],Ra={class:"sr-only",role:"status"},H=E({__name:"ScatterChart",props:es({title:{},subtitle:{},dir:{},loading:{type:Boolean},error:{},data:{},x:{},y:{},size:{},splitBy:{},hiddenSeries:{},label:{},showDataLabels:{type:Boolean},xAxis:{},yAxis:{},palette:{},referenceLines:{},format:{type:Function},echartOptions:{}},{hiddenSeries:{default:()=>[]},hiddenSeriesModifiers:{}}),emits:es(["update:hiddenSeries","select"],["update:hiddenSeries"]),setup(t,{expose:e,emit:n}){Bs([ga,ra,aa,oa]);const l=t,p=_a(t,"hiddenSeries"),r=n,i=M(),h=x(()=>l.dir??Ks()),_=x(()=>l.xAxis?.format??l.format),d=x(()=>l.yAxis?.format??l.format),u=x(()=>({data:l.data,xColumn:l.x,yColumn:l.y,sizeColumn:l.size,splitByColumn:l.splitBy,labelColumn:l.label,showDataLabels:l.showDataLabels,xAxis:y(l.xAxis),yAxis:y(l.yAxis),referenceLines:l.referenceLines,palette:l.palette,dir:h.value,echartOptions:l.echartOptions}));function y(c){if(c)return{title:c.title,min:c.min,max:c.max,echartOptions:c.echartOptions}}const{tokens:v}=Zs(i),k=x(()=>ds(u.value,{tokens:v.value})),O=x(()=>k.value.every(c=>!c.points.length)),us=x(()=>l.yAxis?.title?D(l.yAxis.title):void 0),W=x(()=>{try{return{option:Sa(u.value,{tokens:v.value,hiddenSeries:p.value,format:{x:_.value,y:d.value}}),error:null}}catch(c){return{option:void 0,error:c?.message??String(c)}}}),ys=x(()=>W.value.error),j=ls({x:0,y:0}),f=ls({open:!1,x:0,y:0,label:void 0,items:[],rows:[]}),{chart:U,dispatch:R}=Ns({container:i,option:()=>W.value.option,events:{mouseover:c=>fs(c),mouseout:()=>f.open=!1,click:c=>{const o=G(c);o&&r("select",{name:o.series.name,x:o.point.x,y:o.point.y,size:o.point.size,label:o.point.label,row:o.point.row})}},onZrEvents:{mousemove:c=>{j.x=c.event?.clientX??j.x,j.y=c.event?.clientY??j.y,f.open&&(f.x=j.x,f.y=j.y)},globalout:()=>f.open=!1}});function G(c){const o=k.value.find(m=>m.name===c?.seriesName),w=o?.points[c?.dataIndex];return o&&w?{series:o,point:w}:void 0}function fs(c){const o=G(c);if(!o){f.open=!1;return}Y(o,j.x,j.y)}function Y(c,o,w){const{series:m,point:z}=c,ks=[z.label,l.splitBy?m.label:void 0].filter(Boolean).join(" · ");f.label=ks||void 0,f.items=[I(l.x,z.x,_.value,m.color),I(l.y,z.y,d.value,m.color),...l.size&&z.size!==null?[I(l.size,z.size,l.format,m.color)]:[]],f.rows=[z.row],f.x=o,f.y=w,f.open=!0}function I(c,o,w,m){return{name:c,label:D(c),color:m,value:o,formattedValue:w?w(o):Ws(o),kind:"series"}}const K=x(()=>k.value.map(c=>({name:c.name,label:c.label,color:c.color,hidden:p.value.includes(c.name)})));function ms(c){p.value=na(p.value,c,k.value.length)}const Z=M(null);function ws(c){Z.value=c}Q(Z,(c,o)=>{o&&R({type:"downplay",seriesName:o}),c&&!p.value.includes(c)&&R({type:"highlight",seriesName:c})});const B=M(""),S=x(()=>k.value.filter(c=>!p.value.includes(c.name)).flatMap((c,o)=>c.points.map((w,m)=>({entry:c,point:w,seriesIndex:o,dataIndex:m}))));function vs(c,o){const w=i.value;if(!w)return;const m=w.getBoundingClientRect(),z=U.value?.convertToPixel({gridIndex:0},[c,o]);return!z||z.some(N=>typeof N!="number"||isNaN(N))?{x:m.left+m.width/2,y:m.top+m.height/2}:{x:m.left+z[0],y:m.top+z[1]}}function gs(c){const o=S.value[c];if(!o)return;const w=vs(o.point.x,o.point.y);R({type:"highlight",seriesIndex:o.seriesIndex,dataIndex:o.dataIndex}),Y({series:o.entry,point:o.point},w?.x??j.x,w?.y??j.y),B.value=Xs(f.label,f.items.map(m=>({label:m.label,value:m.formattedValue})))}function X(c){const o=c===null?void 0:S.value[c];o&&R({type:"downplay",seriesIndex:o.seriesIndex,dataIndex:o.dataIndex})}Ms({plot:i,data:()=>S.value,close:()=>{f.open=!1}});const bs=Fs({marks:()=>S.value,key:c=>`${c.entry.name} ${c.point.x} ${c.point.y}`,move:(c,o)=>{X(o),gs(c)},activate:c=>{const o=S.value[c];o&&r("select",{name:o.entry.name,x:o.point.x,y:o.point.y,size:o.point.size,label:o.point.label,row:o.point.row})},clear:c=>{X(c),f.open=!1,B.value=""}}).attrs;return Q(()=>k.value.map(c=>c.name),c=>{p.value=ea(p.value,c)}),e({chart:x(()=>U.value)}),(c,o)=>(P(),ha(la,{title:t.title,subtitle:t.subtitle,"y-axis-title":us.value,loading:t.loading,error:t.error||ys.value,empty:O.value,dir:h.value},ss({default:b(()=>[s("div",da({ref_key:"plotEl",ref:i,class:"h-full w-full rounded-2 focus-visible:focus-ring",dir:"ltr",role:"img","aria-label":T(Ys)(t.title,t.subtitle)},T(bs)),null,16,Oa),s("span",Ra,ua(B.value),1),g(pa,{open:f.open,x:f.x,y:f.y,label:f.label,items:f.items,rows:f.rows,dir:h.value},ss({_:2},[c.$slots.tooltip?{name:"default",fn:b(w=>[C(c.$slots,"tooltip",as(ns(w)))]),key:"0"}:void 0]),1032,["open","x","y","label","items","rows","dir"])]),_:2},[c.$slots.actions?{name:"actions",fn:b(()=>[C(c.$slots,"actions")]),key:"0"}:void 0,c.$slots["title-suffix"]?{name:"title-suffix",fn:b(()=>[C(c.$slots,"title-suffix")]),key:"1"}:void 0,c.$slots.loading?{name:"loading",fn:b(()=>[C(c.$slots,"loading")]),key:"2"}:void 0,c.$slots.error?{name:"error",fn:b(w=>[C(c.$slots,"error",as(ns(w)))]),key:"3"}:void 0,c.$slots.empty?{name:"empty",fn:b(()=>[C(c.$slots,"empty")]),key:"4"}:void 0,K.value.length>1?{name:"legend",fn:b(()=>[g(ta,{items:K.value,onChange:ms,onHighlight:ws},null,8,["items"])]),key:"5"}:void 0]),1032,["title","subtitle","y-axis-title","loading","error","empty","dir"]))}}),Da={class:"h-80 w-full"},Ea=E({__name:"ScatterQuadrants",setup(t){const e=[{product:"Payroll",growth:34,margin:62},{product:"Invoicing",growth:12,margin:71},{product:"CRM",growth:41,margin:48},{product:"Helpdesk",growth:27,margin:55},{product:"Inventory",growth:8,margin:44},{product:"Insights",growth:52,margin:39},{product:"Field service",growth:6,margin:58},{product:"Point of sale",growth:19,margin:33}],n=l=>`${l}%`;return(l,p)=>(P(),L("div",Da,[g(T(H),{data:e,x:"growth",y:"margin",label:"product","show-data-labels":"","x-axis":{title:"Growth",format:n},"y-axis":{title:"Margin",format:n},"reference-lines":[{value:25,axis:"x",label:"Median growth",dashed:!0},{value:50,axis:"y",label:"Median margin",dashed:!0}],title:"Growth against margin",subtitle:"Median lines divide the plot into four"},null,8,["x-axis","y-axis"])]))}}),La={class:"h-96 w-full"},Ia=E({__name:"ScatterMarkets",setup(t){const e=[{market:"Germany",arpu:61,retention:88,seats:14200,region:"EMEA"},{market:"France",arpu:54,retention:82,seats:9100,region:"EMEA"},{market:"UAE",arpu:72,retention:79,seats:2600,region:"EMEA"},{market:"Nigeria",arpu:21,retention:74,seats:4800,region:"EMEA"},{market:"India",arpu:18,retention:91,seats:38400,region:"APAC"},{market:"Japan",arpu:68,retention:94,seats:7300,region:"APAC"},{market:"Australia",arpu:59,retention:85,seats:5200,region:"APAC"},{market:"Singapore",arpu:77,retention:81,seats:1900,region:"APAC"},{market:"United States",arpu:74,retention:87,seats:41500,region:"Americas"},{market:"Canada",arpu:63,retention:89,seats:8600,region:"Americas"},{market:"Brazil",arpu:26,retention:71,seats:12800,region:"Americas"},{market:"Mexico",arpu:31,retention:76,seats:6400,region:"Americas"}];return(n,l)=>(P(),L("div",La,[g(T(H),{data:e,x:"arpu",y:"retention",size:"seats","split-by":"region",label:"market","x-axis":{title:"ARPU",format:p=>`$${p}`},"y-axis":{title:"Retention",format:p=>`${p}%`},title:"Revenue per seat against retention",subtitle:"Bubble size is the number of seats"},null,8,["x-axis","y-axis"])]))}}),Ba={class:"h-80 w-full"},Na=E({__name:"ScatterSpend",setup(t){const e=[{account:"Acme",spend:4200,revenue:12400},{account:"Globex",spend:9100,revenue:24200},{account:"Initech",spend:2200,revenue:3100},{account:"Umbrella",spend:7400,revenue:9600},{account:"Soylent",spend:5600,revenue:18800},{account:"Hooli",spend:12800,revenue:21400},{account:"Vehement",spend:1800,revenue:6200},{account:"Massive Dynamic",spend:10400,revenue:34600},{account:"Stark",spend:6800,revenue:7400},{account:"Wayne",spend:3100,revenue:11200}],n=l=>`$${new Intl.NumberFormat("en-US").format(l)}`;return(l,p)=>(P(),L("div",Ba,[g(T(H),{data:e,x:"spend",y:"revenue",label:"account","x-axis":{title:"Acquisition spend"},"y-axis":{title:"Revenue"},format:n,title:"Spend against revenue",subtitle:"Ten largest accounts, last quarter"})]))}}),_n=JSON.parse('{"title":"ScatterChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/scatterchart.md","filePath":"docs/charts/scatterchart.md","lastUpdated":0}'),Fa={name:"docs/charts/scatterchart.md"},hn=Object.assign(Fa,{setup(t){const e=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
the chart cannot draw shows the empty state, not this one.`,required:!1,type:"string | null"},{name:"data",description:"One row per point.",required:!0,type:"Record<string, any>[]"},{name:"x",description:"Row key holding the horizontal measure.",required:!0,type:"string"},{name:"y",description:"Row key holding the vertical measure.",required:!0,type:"string"},{name:"size",description:"Row key holding the magnitude each point is sized by.",required:!1,type:"string"},{name:"splitBy",description:"Splits the points into one series per distinct value.",required:!1,type:"string"},{name:"hiddenSeries",description:"Groups the legend has switched off, by name. Bind it with\n`v-model:hiddenSeries` to drive the legend from the app. Left unbound, the\nlegend owns it.",required:!1,type:"string[]",default:"[]"},{name:"label",description:"Row key holding the point's own name, which heads its tooltip.",required:!1,type:"string"},{name:"showDataLabels",description:`Prints each point's own name beside it, the way an axis series prints its
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:b(()=>[g(Na)]),_:1})]),_:1}),i[5]||(i[5]=s("h2",{id:"a-third-measure-as-size",tabindex:"-1"},[a("A third measure as size "),s("a",{class:"header-anchor",href:"#a-third-measure-as-size","aria-label":"Permalink to “A third measure as size”"},"​")],-1)),i[6]||(i[6]=s("p",null,[s("code",null,"size"),a(" names a numeric column. Each point's diameter scales linearly with that value, within a readable range. The scale covers the whole plot, not each group, so a bubble size means the same thing everywhere. If every row has the same value, all bubbles are drawn at the middle size, because there is no difference to show and the smallest size would suggest they are the smallest values.")],-1)),i[7]||(i[7]=s("p",null,[s("code",null,"splitBy"),a(" splits the rows into one group per distinct value, each with its own color and legend entry. Press a legend entry to hide a group, or bind "),s("code",null,"v-model:hiddenSeries"),a(" to control that list yourself.")],-1)),g(_,null,{default:b(()=>[g(h,{name:"Charts-ScatterMarkets","self-layout":""},{code:b(()=>[...i[1]||(i[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ScatterChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"      split-by"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"region"),s("span",{class:"s_w1p9wo"},'"')]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:b(()=>[g(Ia)]),_:1})]),_:1}),i[8]||(i[8]=V('<h2 id="quadrants-and-other-reference-lines" tabindex="-1">Quadrants and other reference lines <a class="header-anchor" href="#quadrants-and-other-reference-lines" aria-label="Permalink to “Quadrants and other reference lines”">​</a></h2><p><code>referenceLines</code> draws a line across the plot at a fixed value, such as a target, a threshold or a median. Each line takes a <code>value</code> and an optional <code>label</code>, <code>color</code> and <code>dashed</code>. Reference lines are not series: they have no legend entry or tooltip entry and cannot be hidden, so they stay visible when you hide a group.</p><p><code>labelPlacement</code> moves the label when it covers something. See <a href="/pr-preview/pr-1214/docs/charts/barchart#targets-and-thresholds">BarChart</a>.</p><p><code>axis</code> sets which scale <code>value</code> belongs to. Both scales are numeric here, so <code>&#39;x&#39;</code> and <code>&#39;y&#39;</code> both take a number. On an axis chart, <code>&#39;x&#39;</code> takes a category or a date instead, unless <code>xAxis.type</code> is <code>&#39;value&#39;</code>. <code>&#39;y&#39;</code> (the default) draws a horizontal line and <code>&#39;x&#39;</code> a vertical one. A scatter has no second value axis, so <code>&#39;y2&#39;</code> is treated as <code>&#39;y&#39;</code>, with a warning in dev mode.</p><p>To split a scatter into quadrants, add one reference line per axis. There is no <code>quadrants</code> prop, because a quadrant divider is a reference line, and the axis charts already use <code>referenceLines</code> for that.</p>',5)),g(_,null,{default:b(()=>[g(h,{name:"Charts-ScatterQuadrants","self-layout":""},{code:b(()=>[...i[2]||(i[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ScatterChart"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:b(()=>[g(Ea)]),_:1})]),_:1}),i[9]||(i[9]=V('<p>A line outside the plotted range is not drawn, because each scale follows the data, not the lines. Set <code>xAxis.min</code> / <code>max</code> or <code>yAxis.min</code> / <code>max</code> to bring a distant line into view.</p><h2 id="naming-the-points" tabindex="-1">Naming the points <a class="header-anchor" href="#naming-the-points" aria-label="Permalink to “Naming the points”">​</a></h2><p><code>showDataLabels</code> prints each point&#39;s name beside it, as in the chart above, so you can see which quadrant each product is in without hovering. It prints the <code>label</code> column. If no <code>label</code> is set, nothing prints and you get a warning in dev mode. It does not print the x or y value, because the axes already show them.</p><p>Points often overlap, and so would their names. A name that overlaps a neighbor is hidden, so a dense plot shows only a few names.</p><h2 id="formatting" tabindex="-1">Formatting <a class="header-anchor" href="#formatting" aria-label="Permalink to “Formatting”">​</a></h2><p><code>format</code> formats every number the chart shows. <code>xAxis.format</code> and <code>yAxis.format</code> override it for their own axis, for a chart whose two measures are in different units. The size measure has no axis, so <code>format</code> formats it in the tooltip.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2>',7)),g(xs,{name:"ScatterChart",data:e},{code:b(()=>[...i[3]||(i[3]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),g(zs,{data:n}),g(js,{data:l}),g(Cs,{data:p})])}}});export{_n as __pageData,hn as default};
