import{_ as v}from"./chunks/PropsTable.CGAc7h40.js";import{_ as w}from"./chunks/SlotsTable.CUNmAgfs.js";import{_ as b}from"./chunks/EmitsTable.Bp11G1vJ.js";import"./chunks/theme.VPJp4lxG.js";import{_ as m}from"./chunks/FunnelChart.vue_vue_type_script_setup_true_lang.cIqtY8la.js";import{J as g,ae as i,r,o as s,E as l,aG as k,F as d,D as a,aw as y,ak as z,ap as f,B as x,bf as p}from"./chunks/framework.C2OQK7pm.js";import"./chunks/format.DrLjWwdn.js";import"./chunks/tokens.xQgu7ODm.js";import"./chunks/axisChartCommon.DcUM-Srx.js";import"./chunks/useTooltipDismiss.BobUQTP8.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.vcyqpYBB.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.CYshPEXp.js";const j={class:"flex h-96 w-full flex-col gap-2"},C={class:"min-h-0 flex-1"},S={class:"text-p-sm text-ink-gray-5"},O=g({__name:"FunnelDeals",setup(o){const t=[{stage:"Leads",count:563},{stage:"Qualified",count:385},{stage:"Quotation sent",count:291},{stage:"Ready to close",count:191},{stage:"Won",count:39}],e=z(null);return(c,_)=>(i(),r("div",j,[s("div",C,[l(k(m),{data:t,category:"stage",value:"count",title:"Deal pipeline",subtitle:"Open deals by stage, this quarter",onSelect:_[0]||(_[0]=n=>e.value=n)})]),s("p",S,[e.value?(i(),r(d,{key:0},[a(" Selected "+y(e.value.label)+" · "+y(e.value.value),1)],64)):(i(),r(d,{key:1},[a("Select a stage.")],64))])]))}}),R={class:"h-80 w-full"},A=g({__name:"FunnelStages",setup(o){const t=[{stage:"Visited the store",people:106200},{stage:"Viewed a plan",people:38400},{stage:"Started checkout",people:9860},{stage:"Entered payment details",people:3410},{stage:"Active subscription",people:2560}],e=c=>new Intl.NumberFormat("en-US",{notation:"compact"}).format(c);return(c,_)=>(i(),r("div",R,[l(k(m),{data:t,category:"stage",value:"people",format:e,title:"Store visit to subscription",subtitle:"July 2026"})]))}}),M=JSON.parse('{"title":"FunnelChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/funnelchart.md","filePath":"docs/charts/funnelchart.md","lastUpdated":0}'),P={name:"docs/charts/funnelchart.md"},U=Object.assign(P,{setup(o){const t=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
area, not just the shape it draws.`,type:"[event: FunnelStageEvent]"}];return(_,n)=>{const h=f("ComponentPreview"),u=f("ClientOnly");return i(),r("div",null,[n[3]||(n[3]=x('<h1 id="funnelchart" tabindex="-1">FunnelChart <a class="header-anchor" href="#funnelchart" aria-label="Permalink to “FunnelChart”">​</a></h1><p>Shows drop-off from one stage to the next. Drawn as plain SVG.</p><h2 id="stages" tabindex="-1">Stages <a class="header-anchor" href="#stages" aria-label="Permalink to “Stages”">​</a></h2><p>One row per stage, drawn in row order. Each stage shows its count and its share of the first stage. The first stage shows no share, because there is no stage before it. <code>format</code> formats the counts.</p><p>When the share of the previous stage is a different number, the tooltip shows it too, so you can see the drop-off at each step without doing the math. Both rates reach the <code>tooltip</code> slot as <code>&#39;context&#39;</code> items, named <code>ofFirst</code> and <code>ofPrevious</code>.</p>',5)),l(u,null,{default:p(()=>[l(h,{name:"Charts-FunnelStages","self-layout":""},{code:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(w,{data:e}),l(b,{data:c})])}}});export{M as __pageData,U as default};
