import{_ as z}from"./chunks/PropsTable.CGAc7h40.js";import{_ as j}from"./chunks/SlotsTable.CUNmAgfs.js";import{N as C}from"./chunks/theme.VPJp4lxG.js";import{_ as f}from"./chunks/NumberCard.vue_vue_type_script_setup_true_lang.Zp8cc_uk.js";import{J as k,ae as t,r as _,F as g,an as b,E as e,aG as r,$ as x,a2 as S,M as O,bf as p,o as s,aw as T,p as P,ak as A,ap as w,B as y,D as a}from"./chunks/framework.C2OQK7pm.js";import"./chunks/format.DrLjWwdn.js";import"./chunks/tokens.xQgu7ODm.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.D_AsfCOU.js";const R={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},D=k({__name:"NumberSparklines",setup(m){const l=[{title:"Signups",value:1284,delta:12.5,deltaSuffix:"%",deltaCaption:"vs last month",sparkline:{data:[842,906,971,1044,1123,1018,1067,1142,1196,1218,1247,1284]}},{title:"Orders shipped",value:2560,sparkline:{data:[1786,1852,1921,2094,2274,2064,2120,2222,2292,2378,2452,2560],type:"bar"}},{title:"Pipeline",value:1845e4,prefix:"$",format:i=>new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1}).format(i),sparkline:{data:[12.4,13.1,13.9,15.2,16,15.1,15.8,16.4,17.1,17.6,18,18.45]}},{title:"Storage used",value:61,suffix:"%",color:"#f59e0b",sparkline:{data:[42,44,46,49,51,52,54,56,57,59,60,61],color:"#f59e0b"}}];return(i,u)=>(t(),_("div",R,[(t(),_(g,null,b(l,v=>e(r(f),x({key:v.title},{ref_for:!0},v),null,16)),64))]))}}),E={class:"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"},B={type:"button",class:"-mx-1 flex h-5 min-w-0 items-center gap-1 rounded-sm px-1 text-sm text-ink-gray-5 outline-none hover:bg-surface-gray-2 hover:text-ink-gray-7 focus-visible:ring-2 focus-visible:ring-outline-gray-3"},N={class:"truncate"},L=k({__name:"NumberKpis",setup(m){const o=[{title:"Net revenue",value:220200,target:25e4,prefix:"$",format:l=>new Intl.NumberFormat("en-US",{notation:"compact",maximumFractionDigits:1}).format(l),delta:5.1,deltaSuffix:"%",sparkline:{data:[144500,150700,157400,172700,188600,171700,177100,186700,193600,202100,209500,220200]}},{title:"Monthly churn",value:2.1,suffix:"%",format:l=>l.toFixed(1),delta:-.4,deltaSuffix:"pts",deltaCaption:"vs last month",negativeIsBetter:!0},{title:"Orders shipped",value:2560},{title:"Refunds",value:null}],n=A("last month"),c=["last month","last quarter","last year"].map(l=>({label:`vs ${l}`,onClick:()=>n.value=l}));return(l,i)=>(t(),_("div",E,[e(r(f),S(O(o[0])),{caption:p(()=>[e(r(C),{options:r(c),placement:"left"},{default:p(()=>[s("button",B,[s("span",N,"vs "+T(n.value),1),i[0]||(i[0]=s("span",{class:"lucide-chevron-down size-3.5 shrink-0","aria-hidden":"true"},null,-1))])]),_:1},8,["options"])]),_:1},16),(t(!0),_(g,null,b(o.slice(1),u=>(t(),P(r(f),x({key:u.title},{ref_for:!0},u),null,16))),128))]))}}),Y=JSON.parse('{"title":"NumberCard","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/numbercard.md","filePath":"docs/charts/numbercard.md","lastUpdated":0}'),F={name:"docs/charts/numbercard.md"},G=Object.assign(F,{setup(m){const h=[{name:"title",description:`Heads the card. Left out, the chart draws no header row at all.
What the reading is, printed above the number.`,required:!0,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
the chart cannot draw shows the empty state, not this one.`,required:!1,type:"string | null"},{name:"value",description:"A string renders as given: the formatting props only apply to a number.",required:!0,type:"number | string | null"},{name:"color",description:`Ink the reading is printed in, e.g. the color of the series it summarizes
...
tone that says which way the number moved.`,required:!1,type:"string"},{name:"prefix",description:"Printed before the number, e.g. a currency sign.",required:!1,type:"string"},{name:"suffix",description:"Printed after the number, e.g. a unit.",required:!1,type:"string"},{name:"target",description:"What the reading is measured against, printed as a muted ` / target` in the value's own formatting.",required:!1,type:"number | string"},{name:"delta",description:"Change against the comparison period. Sign drives the arrow.",required:!1,type:"number | null"},{name:"deltaPrefix",description:"Unit printed before the delta, e.g. `'$'`.",required:!1,type:"string"},{name:"deltaSuffix",description:"Unit printed after the delta, e.g. `'%'`.",required:!1,type:"string"},{name:"deltaCaption",description:"What the delta is measured against, e.g. `'vs last month'`.",required:!1,type:"string"},{name:"negativeIsBetter",description:"Flips the delta colors, for metrics like churn or cost.",required:!1,type:"boolean"},{name:"format",description:"Prints the reading and the target: they are one measure, read against each other.",required:!1,type:"ChartValueFormatter"},{name:"deltaFormat",description:"Prints the delta. It takes the absolute value: the arrow beside it carries the sign.",required:!1,type:"ChartValueFormatter"},{name:"sparkline",description:"A trend across the bottom of the card: shape only, no axes to read against.",required:!1,type:"NumberCardSparkline"},{name:"card",description:"Draws the card surface: border, background, corner radius and padding. On\nby default. Set it to `false` for a chart the app has already placed inside\na card of its own, so a bordered box does not nest in a bordered box.",required:!1,type:"boolean",default:"true"}],d=[{name:"loading",description:"Replaces the whole placeholder, e.g. with a skeleton of the app's own.",type:"any"},{name:"error",description:"Replaces the message, e.g. to put a retry button beside it.",type:"{ error?: string | null | undefined; }"},{name:"empty",description:'Replaces the "no data" line, e.g. with a hint about the filters.',type:"any"},{name:"actions",description:"Controls at the top right of the card, e.g. a period Select or a Dropdown.",type:"any"},{name:"title-suffix",description:"A mark right after the title, on the same line. The title truncates\naround it and it keeps its width. It renders in the title's font size, so\ncontent sized in `em` is smaller on a NumberCard than on a chart.",type:"any"},{name:"caption",description:"Replaces `deltaCaption`, e.g. with a Dropdown that changes the period.",type:"{ caption?: string | undefined; }"}];return(o,n)=>{const c=w("ComponentPreview"),l=w("ClientOnly");return t(),_("div",null,[n[3]||(n[3]=y("",4)),e(l,null,{default:p(()=>[e(c,{name:"Charts-NumberKpis","self-layout":""},{code:p(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Dropdown"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"NumberCard"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"NumberCardProps"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," revenueTrend"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," [")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_40mev6"},"  144500"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 150700"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 157400"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 172700"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 188600"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 171700"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 177100"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 186700"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 193600"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_40mev6"},"  202100"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 209500"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 220200"),s("span",{class:"s_1jjt6x"},",")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    maximumFractionDigits"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 1"),s("span",{class:"s_1jjt6x"},",")]),a(`
...
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," cards"),s("span",{class:"s_2ekfrt"},":"),s("span",{class:"s_euu481"}," NumberCardProps"),s("span",{class:"s_13ahmt"},"[]"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," [")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Net revenue"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 220200"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    target"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 250000"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    prefix"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"$"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    format"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_11933w"}," compact"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    delta"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 5.1"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    deltaSuffix"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"%"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    sparkline"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_13ahmt"}," {"),s("span",{class:"s_r4oegk"}," data"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_11933w"}," revenueTrend"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Monthly churn"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 2.1"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    suffix"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"%"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_indoxt"},"    format"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_13ahmt"}," ("),s("span",{class:"s_fsg3al"},"value"),s("span",{class:"s_13ahmt"},")"),s("span",{class:"s_50ecpt"}," =>"),s("span",{class:"s_22m8k2"}," value"),s("span",{class:"s_1jjt6x"},"."),s("span",{class:"s_indoxt"},"toFixed"),s("span",{class:"s_13ahmt"},"("),s("span",{class:"s_40mev6"},"1"),s("span",{class:"s_13ahmt"},")"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    delta"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_2ekfrt"}," -"),s("span",{class:"s_40mev6"},"0.4"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    deltaSuffix"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"pts"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    deltaCaption"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vs last month"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"    // Churn falling is the good direction, so the arrow colors flip.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    negativeIsBetter"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," true"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Orders shipped"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 2560"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {"),s("span",{class:"s_r4oegk"}," title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Refunds"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," null"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"// The card states the comparison period; picking it is the app's business.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," period"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_indoxt"}," ref"),s("span",{class:"s_13ahmt"},"("),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2575z4"},"last month"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_13ahmt"},")")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," periodOptions"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," ["),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2575z4"},"last month"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"last quarter"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"last year"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_13ahmt"},"]"),s("span",{class:"s_1jjt6x"},"."),s("span",{class:"s_indoxt"},"map"),s("span",{class:"s_13ahmt"},"(")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  ("),s("span",{class:"s_fsg3al"},"label"),s("span",{class:"s_13ahmt"},")"),s("span",{class:"s_50ecpt"}," =>"),s("span",{class:"s_13ahmt"}," ({"),s("span",{class:"s_r4oegk"}," label"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," `"),s("span",{class:"s_2575z4"},"vs "),s("span",{class:"s_20l85h"},"${"),s("span",{class:"s_22m8k2"},"label"),s("span",{class:"s_20l85h"},"}"),s("span",{class:"s_w1p9wo"},"`"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_indoxt"}," onClick"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_13ahmt"}," ()"),s("span",{class:"s_50ecpt"}," =>"),s("span",{class:"s_13ahmt"}," ("),s("span",{class:"s_22m8k2"},"period"),s("span",{class:"s_1jjt6x"},"."),s("span",{class:"s_11933w"},"value"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_22m8k2"}," label"),s("span",{class:"s_13ahmt"},")"),s("span",{class:"s_13ahmt"}," })"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},")")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  <"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    <"),s("span",{class:"s_wac0bt"},"NumberCard"),s("span",{class:"s_1i4ay4"}," v-bind"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"cards[0]"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"      <"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1jjt6x"}," #"),s("span",{class:"s_1i4ay4"},"caption"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"        <"),s("span",{class:"s_wac0bt"},"Dropdown"),s("span",{class:"s_1i4ay4"}," :options"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"periodOptions"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1i4ay4"}," placement"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"left"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"          <!-- Not a Button: every Button size carries a fixed height and would")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"               push the 20px caption row open. -->")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"            class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"-mx-1 flex h-5 min-w-0 items-center gap-1 rounded-sm px-1 text-sm text-ink-gray-5 outline-none hover:bg-surface-gray-2 hover:text-ink-gray-7 focus-visible:ring-2 focus-visible:ring-outline-gray-3"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"          >")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"            <"),s("span",{class:"s_1uuh8p"},"span"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"truncate"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">"),s("span",{class:"s_6am9cx"},"vs {{ period }}"),s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"span"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"            <"),s("span",{class:"s_1uuh8p"},"span")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"              class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"lucide-chevron-down size-3.5 shrink-0"),s("span",{class:"s_w1p9wo"},'"')]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"      </"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_wac0bt"},"NumberCard"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    <"),s("span",{class:"s_wac0bt"},"NumberCard")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"      v-for"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"card in cards.slice(1)"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"      :key"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"card.title"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"      v-bind"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"card"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:p(()=>[e(L)]),_:1})]),_:1}),n[4]||(n[4]=y("",2)),e(l,null,{default:p(()=>[e(c,{name:"Charts-NumberSparklines","self-layout":""},{code:p(()=>[...n[1]||(n[1]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"NumberCard"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"NumberCardProps"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"frappe-ui/charts"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_40mev6"},"  842"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 906"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 971"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1044"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1123"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1018"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1067"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1142"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1196"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1218"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1247"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1284"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," ordersShipped"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," [")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_40mev6"},"  1786"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1852"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 1921"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2094"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2274"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2064"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2120"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2222"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2292"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2378"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2452"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 2560"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," pipeline"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," [")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_40mev6"},"  12.4"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 13.1"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 13.9"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 15.2"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 16.0"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 15.1"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 15.8"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 16.4"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 17.1"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 17.6"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 18.0"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 18.45"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," storageUsed"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," ["),s("span",{class:"s_40mev6"},"42"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 44"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 46"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 49"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 51"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 52"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 54"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 56"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 57"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 59"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 60"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_40mev6"}," 61"),s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_indoxt"}," compact"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," ("),s("span",{class:"s_fsg3al"},"value"),s("span",{class:"s_2ekfrt"},":"),s("span",{class:"s_i592pt"}," number"),s("span",{class:"s_13ahmt"},")"),s("span",{class:"s_50ecpt"}," =>")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_2ekfrt"},"  new"),s("span",{class:"s_22m8k2"}," Intl"),s("span",{class:"s_1jjt6x"},"."),s("span",{class:"s_indoxt"},"NumberFormat"),s("span",{class:"s_13ahmt"},"("),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2575z4"},"en-US"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_13ahmt"}," {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    notation"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"compact"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_252irl"},"const"),s("span",{class:"s_295sjd"}," cards"),s("span",{class:"s_2ekfrt"},":"),s("span",{class:"s_euu481"}," NumberCardProps"),s("span",{class:"s_13ahmt"},"[]"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_13ahmt"}," [")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Signups"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 1284"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    delta"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 12.5"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    deltaSuffix"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"%"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    deltaCaption"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vs last month"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    sparkline"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_13ahmt"}," {"),s("span",{class:"s_r4oegk"}," data"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_11933w"}," signups"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Orders shipped"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 2560"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    sparkline"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_13ahmt"}," {"),s("span",{class:"s_r4oegk"}," data"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_11933w"}," ordersShipped"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," type"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"bar"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Pipeline"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 18_450_000"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    prefix"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"$"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    format"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_11933w"}," compact"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    sparkline"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_13ahmt"}," {"),s("span",{class:"s_r4oegk"}," data"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_11933w"}," pipeline"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  {")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    title"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"Storage used"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    value"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_40mev6"}," 61"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    suffix"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"%"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"    // The reading in the ink of the trend under it: one mark, one color.")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    color"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"#f59e0b"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_r4oegk"},"    sparkline"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_13ahmt"}," {"),s("span",{class:"s_r4oegk"}," data"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_11933w"}," storageUsed"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_r4oegk"}," color"),s("span",{class:"s_1jjt6x"},":"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"#f59e0b"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"  }"),s("span",{class:"s_1jjt6x"},",")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"]")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  <"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"grid w-full grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    <"),s("span",{class:"s_wac0bt"},"NumberCard"),s("span",{class:"s_1i4ay4"}," v-for"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"card in cards"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1i4ay4"}," :key"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"card.title"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1i4ay4"}," v-bind"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"card"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"}," />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:p(()=>[e(D)]),_:1})]),_:1}),n[5]||(n[5]=y("",4)),e(z,{name:"NumberCard",data:h},{code:p(()=>[...n[2]||(n[2]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),e(j,{data:d})])}}});export{Y as __pageData,G as default};
