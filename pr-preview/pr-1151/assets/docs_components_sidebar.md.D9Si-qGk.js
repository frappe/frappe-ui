...
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** External URL. Used when `route` is absent; renders a plain anchor. */")]),a(`
