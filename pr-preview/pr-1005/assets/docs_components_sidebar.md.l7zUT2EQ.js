import{_ as m}from"./chunks/PropsTable.oekAQ2JA.js";import{_ as b}from"./chunks/SlotsTable.B7ltZtVl.js";import{_ as j}from"./chunks/EmitsTable.Bc3QiJJm.js";import{aI as x,Z as C,a0 as P,a1 as f,aJ as $,aK as M,ax as F,a9 as I,E as k}from"./chunks/theme.CGVzDAdp.js";import{I as z,ad as h,r as w,o as s,D as l,aE as p,p as U,aj as u,bf as e,B as a,F as A,am as L,q as R,au as T,a0 as N,ao as H,A as S}from"./chunks/framework.CcTGhpfp.js";const V={class:"flex w-full flex-wrap items-start gap-4"},J={class:"w-52 rounded-md bg-surface-gray-1 p-3"},Y={class:"w-52 rounded-md bg-surface-gray-1 p-3"},G={class:"w-52 rounded-md bg-surface-gray-1 p-3"},Z=z({__name:"Card",setup(g){const c=u(!0);return(r,d)=>(h(),w("div",V,[s("div",J,[l(p(x),{title:"Your trial ends soon!",description:"Upgrade to keep enjoying features.",action:{label:"Update now"}})]),s("div",Y,[c.value?(h(),U(p(x),{key:0,theme:"blue",dismissible:"",title:"New feature available",description:"Discover the new board view for your deals.",action:{label:"Explore now"},onDismiss:d[0]||(d[0]=t=>c.value=!1)})):(h(),w("button",{key:1,class:"text-sm text-ink-gray-5 underline",onClick:d[1]||(d[1]=t=>c.value=!0)}," Bring the card back "))]),s("div",G,[l(p(x),{theme:"amber",title:"Storage is almost full",description:"Free up space or upgrade your plan.",action:{label:"Manage storage"}})])]))}}),Q={class:"flex h-[360px] w-fit overflow-hidden rounded-md border"},X={class:"flex-1 overflow-y-auto px-2 pt-2"},ss=z({__name:"Section",setup(g){const c=u("leads"),r=u(!1);return(d,t)=>(h(),w("div",Q,[l(p(C),{"disable-collapse":"",width:"14rem"},{default:e(()=>[s("div",X,[l(p(P),null,{default:e(()=>[...t[5]||(t[5]=[a("Pipeline",-1)])]),_:1}),l(p(f),{label:"Leads",icon:"lucide-user-plus",active:c.value==="leads",onClick:t[0]||(t[0]=i=>c.value="leads")},null,8,["active"]),l(p(f),{label:"Deals",icon:"lucide-handshake",active:c.value==="deals",onClick:t[1]||(t[1]=i=>c.value="deals")},null,8,["active"]),l(p($),{label:"Views",collapsible:"",collapsed:r.value,"onUpdate:collapsed":t[4]||(t[4]=i=>r.value=i)},{default:e(()=>[l(p(f),{label:"My Open Deals",icon:"lucide-flame",active:c.value==="my-open-deals",onClick:t[2]||(t[2]=i=>c.value="my-open-deals")},null,8,["active"]),l(p(f),{label:"Unassigned",icon:"lucide-circle-dashed",active:c.value==="unassigned",onClick:t[3]||(t[3]=i=>c.value="unassigned")},null,8,["active"])]),_:1},8,["collapsed"])])]),_:1})]))}}),as={class:"flex h-[360px] w-fit overflow-hidden rounded-md border"},ns={class:"flex-1 overflow-y-auto px-2 pt-2"},ls={class:"mt-auto px-2 pb-2"},es=z({__name:"Collapsed",setup(g){const c=u(!0),r=u("inbox"),d=[{id:"inbox",label:"Inbox",icon:"lucide-inbox"},{id:"starred",label:"Starred",icon:"lucide-star"},{id:"sent",label:"Sent",icon:"lucide-send"}];return(t,i)=>(h(),w("div",as,[l(p(C),{collapsed:c.value,"onUpdate:collapsed":i[0]||(i[0]=_=>c.value=_)},{default:e(()=>[s("div",ns,[l(p(P),{divider:""},{default:e(()=>[...i[1]||(i[1]=[a("Mail",-1)])]),_:1}),(h(),w(A,null,L(d,_=>l(p(f),{key:_.id,icon:_.icon,label:_.label,active:r.value===_.id,onClick:o=>r.value=_.id},null,8,["icon","label","active","onClick"])),64))]),s("div",ls,[l(p(M))])]),_:1},8,["collapsed"])]))}}),ps={class:"flex h-[560px] w-fit overflow-hidden rounded-md border"},cs={class:"flex h-7 items-center justify-between"},ts={class:"flex items-center"},is={class:"mt-0.5 space-y-0.5"},_s={class:"flex-1 inline-flex items-center gap-1 truncate text-sm"},os={key:0,class:"lucide-lock size-3 shrink-0 text-ink-gray-5"},rs={class:"relative mr-1 flex size-7 shrink-0 items-center justify-end"},ds={key:0,class:"absolute right-1 text-xs text-ink-gray-5 transition-opacity group-hover/sidebar-item:opacity-0 group-focus-within/sidebar-item:opacity-0"},hs=z({__name:"Default",setup(g){const c=u("product"),r=u("Recent activity"),d=[{id:"product",title:"Product",icon:"lucide-rocket",unread:0,private:!1},{id:"design",title:"Design",icon:"lucide-palette",unread:3,private:!1},{id:"engineering",title:"Engineering",icon:"lucide-code",unread:12,private:!1},{id:"marketing",title:"Marketing",icon:"lucide-megaphone",unread:0,private:!1},{id:"sales",title:"Sales",icon:"lucide-trending-up",unread:1,private:!1},{id:"support",title:"Customer Support",icon:"lucide-headphones",unread:0,private:!1},{id:"people",title:"People & Culture",icon:"lucide-users",unread:0,private:!1},{id:"finance",title:"Finance",icon:"lucide-wallet",unread:0,private:!0},{id:"leadership",title:"Leadership",icon:"lucide-crown",unread:2,private:!0},{id:"design-system",title:"Design System",icon:"lucide-component",unread:0,private:!1},{id:"research",title:"User Research",icon:"lucide-microscope",unread:5,private:!1},{id:"ops",title:"Operations",icon:"lucide-settings-2",unread:0,private:!1},{id:"events",title:"Events",icon:"lucide-party-popper",unread:0,private:!1},{id:"data",title:"Data & Analytics",icon:"lucide-database",unread:8,private:!1},{id:"brand",title:"Brand",icon:"lucide-sparkles",unread:0,private:!1},{id:"partnerships",title:"Partnerships",icon:"lucide-handshake",unread:0,private:!1},{id:"security",title:"Security",icon:"lucide-shield",unread:0,private:!0},{id:"onboarding",title:"Onboarding",icon:"lucide-graduation-cap",unread:0,private:!1},{id:"random",title:"Random",icon:"lucide-shuffle",unread:0,private:!1}],t=[{group:"Sort by",options:["Recent activity","Alphabetical"].map(i=>({label:i,icon:r.value===i?"lucide-check":null,onClick:()=>r.value=i}))}];return(i,_)=>(h(),w("div",ps,[l(p(C),{"disable-collapse":"",width:"14rem"},{default:e(()=>[_[1]||(_[1]=s("div",{class:"flex shrink-0 items-center p-2"},[s("button",{class:"flex h-8 w-full items-center gap-2 rounded px-1 transition hover:bg-surface-gray-2"},[s("div",{class:"grid size-6 shrink-0 place-items-center rounded bg-surface-gray-7 text-xs font-medium text-ink-white"}," F "),s("span",{class:"flex-1 truncate text-left text-base text-ink-gray-8"},"Frappe"),s("span",{class:"lucide-chevrons-up-down size-4 shrink-0 text-ink-gray-5"})])],-1)),l(p(F),{class:"min-h-0 flex-1","viewport-class":"px-2 pt-0.5 pb-10"},{default:e(()=>[s("div",cs,[l(p(P),null,{default:e(()=>[..._[0]||(_[0]=[a("Spaces",-1)])]),_:1}),s("div",ts,[l(p(I),{options:t,align:"end"},{trigger:e(({open:o})=>[l(p(k),{variant:"ghost",size:"sm",icon:"lucide-arrow-up-down text-ink-gray-5",label:"Sort spaces",tooltip:"Sort spaces",active:o},null,8,["active"])]),_:1}),l(p(k),{variant:"ghost",size:"sm",icon:"lucide-plus text-ink-gray-5",label:"New space"})])]),s("nav",is,[(h(),w(A,null,L(d,o=>l(p(f),{key:o.id,icon:o.icon,active:c.value===o.id,onClick:y=>c.value=o.id},{suffix:e(()=>[s("div",rs,[o.unread>0?(h(),w("span",ds,T(o.unread),1)):R("",!0),l(p(I),{options:[{label:"Mark all as read"},{label:"Leave space"}],align:"start",side:"right"},{default:e(({open:y})=>[l(p(k),{variant:y?"subtle":"ghost",size:"xs",icon:"lucide-more-horizontal text-ink-gray-5",label:`${o.title} options`,class:N(["absolute right-0 -mr-0.5 opacity-0 group-hover/sidebar-item:opacity-100 group-focus-within/sidebar-item:opacity-100",y?"opacity-100":""])},null,8,["variant","label","class"])]),_:2},1024)])]),default:e(()=>[s("span",_s,[o.private?(h(),w("span",os)):R("",!0),a(" "+T(o.title),1)])]),_:2},1032,["icon","active","onClick"])),64))])]),_:1})]),_:1})]))}}),vs=JSON.parse('{"title":"Sidebar","description":"","frontmatter":{},"headers":[],"relativePath":"docs/components/sidebar.md","filePath":"docs/components/sidebar.md","lastUpdated":1779053387000}'),ws={name:"docs/components/sidebar.md"},zs=Object.assign(ws,{setup(g){const c=[{name:"disableCollapse",description:"Disables collapsing entirely (fixed width, no built-in toggle).",required:!1,type:"boolean"},{name:"width",description:"Expanded width as a CSS length. Applied inline so apps can override it.",required:!1,type:"string",default:'"15rem"'},{name:"collapsedWidth",description:"Collapsed width as a CSS length.",required:!1,type:"string",default:'"3rem"'},{name:"collapsed",description:"v-model. Whether the sidebar is collapsed. Left unset, it collapses automatically below the `sm` breakpoint.",required:!1,type:"boolean | null",default:"null"}],r=[{name:"default",description:"The sidebar body — header, scroll region, footer, all composed by the app.",type:"any"}],d=[{name:"update:collapsed",description:"Fired when the sidebar is collapsed or expanded.",type:"[value: boolean | null]"}],t=[{name:"label",description:"Row label. Used as the accessible name and the default slot fallback.",required:!1,type:"string"},{name:"accessKey",description:"`accesskey` attribute for a keyboard shortcut.",required:!1,type:"string"},{name:"icon",description:"Leading icon: a CSS class (e.g. `lucide-box`), plain text, or a component.\nIgnored when the `#prefix` slot is used.",required:!1,type:"string | Component"},{name:"suffix",description:"Trailing text. Ignored when the `#suffix` slot is used.",required:!1,type:"string"},{name:"to",description:"Navigation target. When set the row's main area renders as a router link;\notherwise it renders as a button. A click still invokes `onClick`.",required:!1,type:"string | kt | Tt"},{name:"active",description:'Marks the row active (`data-state="active"`). When omitted, active state is\ninferred by matching `to` against the current route.',required:!1,type:"boolean"},{name:"onClick",description:"Click handler. Bound from `@click`.",required:!1,type:"((event: MouseEvent) => void)"}],i=[{name:"prefix",description:"Leading icon or avatar. Overrides the `icon` prop.",type:"any"},{name:"default",description:"The label region. Overrides the `label` prop; put inline adornments here.",type:"any"},{name:"suffix",description:"The trailing zone — a sibling of the link/button, not nested inside it. Overrides the `suffix` prop.",type:"any"}],_=[{name:"divider",description:"When true, collapses to a horizontal divider while the sidebar is collapsed\n(matches the previous `SidebarSection` label behavior).",required:!1,type:"boolean"}],o=[{name:"default",description:"The label text.",type:"any"}],y=[{name:"title",description:"Workspace or app title.",required:!0,type:"string"},{name:"subtitle",description:"Secondary line under the title, e.g. a domain or workspace slug.",required:!1,type:"string"},{name:"logo",description:"Leading logo: an image URL, or a component. Overridden by the `#prefix` slot.",required:!1,type:"string | Component"},{name:"showLogo",description:"Whether to render the leading logo/avatar box. Defaults to `true`. Set to\n`false` when workspace identity is already shown elsewhere (e.g. a left\nrail) to avoid a duplicate avatar; the title then sits flush-left. Best\npaired with a non-collapsing sidebar, since a collapsed header with no logo\nhas nothing to show.",required:!1,type:"boolean",default:"true"},{name:"menuItems",description:"Options rendered in the trigger's dropdown — the same shape `Dropdown` itself takes.",required:!1,type:"{ label: string; icon?: string | Component; onClick?: (() => void) | undefined; }[] | undefined"}],q=[{name:"prefix",description:"Fills the default logo/initial box (a `size-7 overflow-hidden` frame — wide content clips). Falls back to the `logo` prop, then the title's first letter.",type:"any"}],W=[{name:"label",description:"Section label. Renders nothing when omitted (a label-less group).",required:!1,type:"string"},{name:"collapsible",description:"Whether clicking the label toggles the group's visibility.",required:!1,type:"boolean"},{name:"collapsed",description:"v-model. Whether the section is collapsed. Bind it to own the state (start a section collapsed, persist the choice); left unbound the section manages it internally, starting expanded.",required:!1,type:"boolean",default:"false"}],K=[{name:"default",description:"The group's rows — compose `SidebarItem` (or anything else) here.",type:"any"}],D=[{name:"update:collapsed",description:"Fired when the section is collapsed or expanded.",type:"[value: boolean]"}],B=[{name:"title",description:"Main heading text of the card",required:!0,type:"string"},{name:"description",description:"Supporting text below the title",required:!1,type:"string"},{name:"theme",description:"Color theme of the icon and the tinted action button; the white container never changes with theme",required:!1,type:"SidebarCardTheme",default:'"gray"'},{name:"icon",description:"Icon next to the title: unset shows the theme's auto icon (gray shows the info glyph in black ink), `false` hides it, a `lucide-*` string or Component renders a custom theme-colored glyph",required:!1,type:"boolean | string | Component"},{name:"action",description:"The full-width tinted action button (`ButtonProps` plus `onClick({ dismiss })`)",required:!1,type:"AlertAction"},{name:"dismissible",description:"Shows the dismiss (×) button, which emits `dismiss`",required:!1,type:"boolean",default:"false"}],E=[{name:"prefix",description:"Overrides the icon area next to the title",type:"any"},{name:"title",description:"Rich title content (overrides the `title` prop)",type:"any"},{name:"description",description:"Rich description content (overrides the `description` prop)",type:"any"},{name:"actions",description:"Replaces the auto-rendered action button; receives `{ dismiss }`",type:"SidebarCardActionsSlotProps"}],O=[{name:"dismiss",description:"Fired when the user dismisses the card — the × button or the action's `context.dismiss()`. The parent owns hiding.",type:"[]"}];return(us,n)=>{const v=H("ComponentPreview");return h(),w("div",null,[n[10]||(n[10]=s("h1",{id:"sidebar",tabindex:"-1"},[a("Sidebar "),s("a",{class:"header-anchor",href:"#sidebar","aria-label":"Permalink to “Sidebar”"},"​")],-1)),n[11]||(n[11]=s("p",null,[a("The wide navigation panel of an app shell. "),s("code",null,"Sidebar"),a(" is a bare frame — a fixed-width column with the collapse machinery and a single slot — and you compose the body from "),s("code",null,"SidebarItem"),a(", "),s("code",null,"SidebarLabel"),a(", and your own markup. The app owns its header, scroll region, and empty state; lay them out with plain flex utilities.")],-1)),l(v,{name:"Sidebar-Default"},{code:e(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  <"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"flex w-full flex-wrap items-start gap-4"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    <"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"w-52 rounded-md bg-surface-gray-1 p-3"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"        :action"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"{ label: 'Update now' }"),s("span",{class:"s_w1p9wo"},'"')]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"      />")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    </"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"    <"),s("span",{class:"s_1uuh8p"},"div"),s("span",{class:"s_1i4ay4"}," class"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"w-52 rounded-md bg-surface-gray-1 p-3"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1i4ay4"},"        :action"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"{ label: 'Explore now' }"),s("span",{class:"s_w1p9wo"},'"')]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"/** Color themes for the card's icon and tinted action button. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"export"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_euu481"}," SidebarCardTheme"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"gray"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"blue"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"green"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"amber"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"red"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"/**")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Main heading text of the card */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  title"),s("span",{class:"s_2ekfrt"},":"),s("span",{class:"s_i592pt"}," string")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  theme"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_euu481"}," SidebarCardTheme")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:r}),l(j,{data:d}),n[18]||(n[18]=s("h3",{id:"sidebaritem-1",tabindex:"-1"},[a("SidebarItem "),s("a",{class:"header-anchor",href:"#sidebaritem-1","aria-label":"Permalink to “SidebarItem”"},"​")],-1)),l(m,{name:"SidebarItem",data:t},{code:e(()=>[...n[5]||(n[5]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteLocationRaw"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue-router"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"/**")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:i}),n[19]||(n[19]=s("h3",{id:"sidebarlabel",tabindex:"-1"},[a("SidebarLabel "),s("a",{class:"header-anchor",href:"#sidebarlabel","aria-label":"Permalink to “SidebarLabel”"},"​")],-1)),l(m,{name:"SidebarLabel",data:_},{code:e(()=>[...n[6]||(n[6]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteLocationRaw"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue-router"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"/**")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:K}),l(j,{data:D}),n[22]||(n[22]=s("h3",{id:"sidebarcard-1",tabindex:"-1"},[a("SidebarCard "),s("a",{class:"header-anchor",href:"#sidebarcard-1","aria-label":"Permalink to “SidebarCard”"},"​")],-1)),l(m,{name:"SidebarCard",data:B},{code:e(()=>[...n[9]||(n[9]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"Component"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," ComputedRef"),s("span",{class:"s_1jjt6x"},","),s("span",{class:"s_4q1z3w"}," InjectionKey"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteLocationRaw"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue-router"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"AlertAction"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"../Alert"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"/**")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"  /** Whether clicking the label toggles the group's visibility. */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  collapsible"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_i592pt"}," boolean")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:E}),l(j,{data:O})])}}});export{vs as __pageData,zs as default};
