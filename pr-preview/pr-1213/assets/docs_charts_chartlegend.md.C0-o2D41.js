import{_ as o}from"./chunks/PropsTable.DnyBHFKF.js";import{_ as h}from"./chunks/EmitsTable.CDaAH4xV.js";import{_ as d}from"./chunks/CustomRadar.vue_vue_type_script_setup_true_lang.B-28YUOw.js";import{ap as p,ae as u,r as y,B as t,E as l,bf as e,o as s,D as a}from"./chunks/framework.C9_HTNcI.js";import"./chunks/theme.CD0atdaZ.js";import"./chunks/useChart.ByC6ee9f.js";import"./chunks/tokens.HUgm48ur.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.Cz77dxGS.js";import"./chunks/ChartLegend.vue_vue_type_script_setup_true_lang.BEXVBsg4.js";import"./chunks/ChartCard.vue_vue_type_script_setup_true_lang.DjQQBfUH.js";import"./chunks/LegendVisualProvider.ChfpBIy1.js";import"./chunks/axisAlignTicks.B6l8x592.js";import"./chunks/labelLayoutHelper.Bfd6vIDu.js";import"./chunks/dataStackHelper.ChA4DIkV.js";const E=JSON.parse('{"title":"ChartLegend","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/chartlegend.md","filePath":"docs/charts/chartlegend.md","lastUpdated":0}'),f={name:"docs/charts/chartlegend.md"},D=Object.assign(f,{setup(m){const c=[{name:"items",description:"One entry per series, in the order they are drawn.",required:!0,type:"ChartLegendItem[]"}],i=[{name:"change",description:"An entry was pressed: the named series' visibility flipped.",type:"[name: string]"},{name:"highlight",description:"The highlighted series, or null when the highlight clears.",type:"[name: string | null]"}];return(k,n)=>{const _=p("ComponentPreview"),r=p("ClientOnly");return u(),y("div",null,[n[2]||(n[2]=t('<h1 id="chartlegend" tabindex="-1">ChartLegend <a class="header-anchor" href="#chartlegend" aria-label="Permalink to “ChartLegend”">​</a></h1><p>The row of series names under a plot. Each entry shows a series name and its color, and hides or shows the series when pressed.</p><div class="language-js"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes tokyo-night github-light s_2cy0ei" tabindex="0" dir="ltr"><code><span class="line"><span class="s_edvzsf">import</span><span class="s_13ahmt"> { </span><span class="s_4q1z3w">ChartLegend</span><span class="s_13ahmt"> }</span><span class="s_edvzsf"> from</span><span class="s_w1p9wo"> &#39;</span><span class="s_2575z4">frappe-ui/charts</span><span class="s_w1p9wo">&#39;</span></span></code></pre></div><p>It holds no state. <code>items</code> is its only input, and its two events report what the user did. The chart that owns the series decides what to do. Put it in the <code>#legend</code> slot of <code>ChartContainer</code>.</p>',4)),l(r,null,{default:e(()=>[l(_,{name:"Charts-CustomRadar","self-layout":""},{code:e(()=>[...n[0]||(n[0]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(d)]),_:1})]),_:1}),n[3]||(n[3]=t('<h2 id="entries" tabindex="-1">Entries <a class="header-anchor" href="#entries" aria-label="Permalink to “Entries”">​</a></h2><p>One <code>ChartLegendItem</code> per series, in the order the series are drawn:</p><table tabindex="0"><thead><tr><th>Field</th><th>What it is</th></tr></thead><tbody><tr><td><code>name</code></td><td>Series identity, i.e. what <code>change</code> and <code>highlight</code> report.</td></tr><tr><td><code>label</code></td><td>The name as it should read.</td></tr><tr><td><code>color</code></td><td>The color the series is drawn in.</td></tr><tr><td><code>hidden</code></td><td>Whether the series is hidden.</td></tr><tr><td><code>hint</code></td><td>A muted note after the label, e.g. a donut slice&#39;s share.</td></tr></tbody></table><p>A hidden entry keeps its place in the row and dims: the swatch fades and the label turns gray. If the entry left the row, there would be no way to show the series again.</p><p>The row wraps and never scrolls. It takes as many lines as it needs and the plot gets shorter, which the chart&#39;s resize observer picks up. A scrolling legend would hide series names that most users never scroll to.</p><h2 id="toggling" tabindex="-1">Toggling <a class="header-anchor" href="#toggling" aria-label="Permalink to “Toggling”">​</a></h2><p><code>change</code> emits the <code>name</code> of the pressed entry. Toggle that series in your own hidden list and pass the new <code>items</code> back.</p><p>Every entry is a button. The visible text is the series label, but the accessible name says what pressing it does (&quot;Hide Signups&quot; or &quot;Show Signups&quot;). <code>aria-pressed</code> holds the current state.</p><h2 id="highlighting" tabindex="-1">Highlighting <a class="header-anchor" href="#highlighting" aria-label="Permalink to “Highlighting”">​</a></h2><p><code>highlight</code> emits the <code>name</code> of the entry under the pointer or with focus, and <code>null</code> when it leaves. Use it to emphasize that series in the plot and dim the rest. It fires on both hover and focus, so keyboard users get the same effect as mouse users.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2>',11)),l(o,{name:"ChartLegend",data:c},{code:e(()=>[...n[1]||(n[1]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
