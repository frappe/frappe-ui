import{_ as L}from"./chunks/PropsTable.DnyBHFKF.js";import{_ as z}from"./chunks/SlotsTable.DbGIicyw.js";import{_ as D}from"./chunks/EmitsTable.CDaAH4xV.js";import{_ as C,a as R,b as w}from"./chunks/ListCell.vue_vue_type_script_setup_true_lang.C6uIxcaG.js";import{_ as P}from"./chunks/ListRows.vue_vue_type_script_setup_true_lang.CpgtKWBG.js";import{J as q,ae as f,r as x,E as n,aG as p,bf as l,o as s,aw as i,p as F,D as a,F as M,an as E,a1 as j,ak as g,l as J,q as N,ap as $,B}from"./chunks/framework.C9_HTNcI.js";import{U as H,K as I,O as Q}from"./chunks/theme.CD0atdaZ.js";import{_ as G,a as T}from"./chunks/ListHeaderCell.vue_vue_type_script_setup_true_lang.L1_krF6j.js";import{_ as A}from"./chunks/ListHeaderCellSort.vue_vue_type_script_setup_true_lang.DuwRo9WE.js";const K={class:"h-72 w-full overflow-y-auto rounded-4 border"},Y={class:"text-sm text-ink-gray-4"},X={class:"truncate text-base text-ink-gray-8"},Z={class:"text-sm text-ink-gray-5"},ss=q({__name:"Virtual",setup(v){const u=Array.from({length:1e3},(d,c)=>({id:String(c+1),title:`Task ${c+1}`,status:c%3===0?"Done":c%3===1?"In progress":"Backlog"}));return(d,c)=>(f(),x("div",K,[n(p(C),{columns:["3rem","minmax(0,1fr)","6rem"],"row-height":44,class:"px-2"},{default:l(()=>[n(p(P),{items:p(u),virtual:""},{default:l(({item:o})=>[n(p(R),null,{default:l(()=>[n(p(w),null,{default:l(()=>[s("span",Y,"#"+i(o.id),1)]),_:2},1024),n(p(w),null,{default:l(()=>[s("span",X,i(o.title),1)]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("span",Z,i(o.status),1)]),_:2},1024)]),_:2},1024)]),_:1},8,["items"])]),_:1})]))}}),as={class:"ml-3 min-w-0"},ns={class:"truncate text-base text-ink-gray-8"},ls={class:"mt-0.5 truncate text-sm text-ink-gray-5"},es={class:"text-base text-ink-gray-7"},ps={class:"text-base text-ink-gray-6"},cs=q({__name:"Responsive",setup(v){const u=[{name:"Rosa Diaz",email:"rosa@example.com",role:"Admin",since:"2021-06"},{name:"Jake Peralta",email:"jake@example.com",role:"Member",since:"2022-01"},{name:"Amy Santiago",email:"amy@example.com",role:"Admin",since:"2020-11"},{name:"Terry Jeffords",email:"terry@example.com",role:"Member",since:"2023-03"}];return(d,c)=>(f(),F(p(C),{class:"w-full list-row-px-3",columns:{base:["minmax(0,1fr)","6.5rem"],md:["minmax(0,1fr)","7rem","6rem"],lg:["minmax(0,2fr)","9rem","8rem"]},"row-height":56},{default:l(()=>[n(p(G),null,{default:l(()=>[n(p(T),null,{default:l(()=>[...c[0]||(c[0]=[a("Member",-1)])]),_:1}),n(p(T),{class:"max-md:hidden"},{default:l(()=>[...c[1]||(c[1]=[a("Role",-1)])]),_:1}),n(p(T),{class:"justify-end"},{default:l(()=>[...c[2]||(c[2]=[a("Member since",-1)])]),_:1})]),_:1}),n(p(P),{items:u},{default:l(({item:o,value:h})=>[n(p(R),{value:h},{default:l(()=>[n(p(w),null,{default:l(()=>[n(p(H),{label:o.name,size:"xl"},null,8,["label"]),s("div",as,[s("div",ns,i(o.name),1),s("div",ls,i(o.email),1)])]),_:2},1024),n(p(w),{class:"max-md:hidden"},{default:l(()=>[s("span",es,i(o.role),1)]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("span",ps,i(o.since),1)]),_:2},1024)]),_:2},1032,["value"])]),_:1})]),_:1}))}}),ts={class:"w-full"},is={class:"mb-2 flex h-7 items-center justify-end text-sm text-ink-gray-5"},os=["aria-label","onClick"],_s={class:"truncate text-base text-ink-gray-8"},rs={class:"text-sm text-ink-gray-5"},ds=q({__name:"RowActions",setup(v){const u=[{id:"1",title:"Q3 launch brief",icon:"lucide-file-text",updated:"2 h"},{id:"2",title:"Hiring pipeline",icon:"lucide-file-spreadsheet",updated:"5 h"},{id:"3",title:"Onboarding flow",icon:"lucide-file-image",updated:"1 d"},{id:"4",title:"Retention report",icon:"lucide-file-chart-column",updated:"3 d"},{id:"5",title:"Support playbook",icon:"lucide-file-text",updated:"6 d"}],d=g(),c=g(["2"]);function o(h){c.value=c.value.includes(h)?c.value.filter(y=>y!==h):[...c.value,h]}return(h,y)=>(f(),x("div",ts,[s("div",is,[s("span",null,i(c.value.length)+" starred "+i(d.value?` · Opened: ${d.value}`:" · Click a row to open it"),1)]),n(p(C),{class:"list-row-px-3","row-height":48},{default:l(()=>[(f(),x(M,null,E(u,t=>n(p(R),{key:t.id,class:"active:bg-surface-gray-2 sm:rounded-[10px] sm:hover:bg-surface-gray-1"},{default:l(()=>[n(p(w),null,{default:l(()=>[s("span",{class:j([t.icon,"size-4 text-ink-gray-5"]),"aria-hidden":"true"},null,2)]),_:2},1024),n(p(w),null,{default:l(()=>[s("button",{type:"button",class:"absolute inset-0 sm:rounded-[10px]","aria-label":`Open ${t.title}`,onClick:k=>d.value=t.title},null,8,os),s("span",_s,i(t.title),1)]),_:2},1024),n(p(w),{class:"justify-end gap-3"},{default:l(()=>[s("span",rs,i(t.updated),1),n(p(I),{class:"relative",variant:"ghost",label:c.value.includes(t.id)?`Unstar ${t.title}`:`Star ${t.title}`,"aria-pressed":c.value.includes(t.id),onClick:k=>o(t.id)},{icon:l(()=>[s("span",{class:j(["lucide-star size-4",c.value.includes(t.id)?"text-ink-gray-9":"text-ink-gray-4"]),"aria-hidden":"true"},null,2)]),_:2},1032,["label","aria-pressed","onClick"])]),_:2},1024)]),_:2},1024)),64))]),_:1})]))}}),hs={class:"ml-3 min-w-0"},ws={class:"truncate text-base text-ink-gray-8"},ms={class:"mt-0.5 truncate text-sm text-ink-gray-5"},us={class:"text-base text-ink-gray-7"},ys={class:"text-base text-ink-gray-6"},fs=q({__name:"Columns",setup(v){const u=[{name:"Rosa Diaz",email:"rosa@example.com",role:"Admin",since:"2021-06"},{name:"Jake Peralta",email:"jake@example.com",role:"Member",since:"2022-01"},{name:"Amy Santiago",email:"amy@example.com",role:"Admin",since:"2020-11"},{name:"Terry Jeffords",email:"terry@example.com",role:"Member",since:"2023-03"},{name:"Raymond Holt",email:"holt@example.com",role:"Guest",since:"2024-08"}],d=g("Rosa Diaz");function c(m){return m?m==="asc"?"lucide-arrow-up":"lucide-arrow-down":"lucide-arrow-up-down"}const o=g("name"),h=g("asc");function y(m,_="asc"){o.value===m?h.value=h.value==="asc"?"desc":"asc":(o.value=m,h.value=_)}function t(m){return o.value===m?h.value:null}const k=J(()=>{const m=h.value==="desc"?-1:1;return[...u].sort((_,r)=>m*_[o.value].localeCompare(r[o.value]))});return(m,_)=>(f(),F(p(C),{active:d.value,"onUpdate:active":_[3]||(_[3]=r=>d.value=r),class:"w-full list-row-px-3",columns:["minmax(0,1fr)","7rem","8rem"],"row-height":56},{default:l(()=>[n(p(G),null,{default:l(()=>[n(p(A),{direction:t("name"),onClick:_[0]||(_[0]=r=>y("name"))},{"sort-indicator":l(({direction:r})=>[s("span",{class:j(["block size-3.5",c(r)])},null,2)]),default:l(()=>[_[4]||(_[4]=a(" Member ",-1))]),_:1},8,["direction"]),n(p(A),{direction:t("role"),onClick:_[1]||(_[1]=r=>y("role"))},{"sort-indicator":l(({direction:r})=>[s("span",{class:j(["block size-3.5",c(r)])},null,2)]),default:l(()=>[_[5]||(_[5]=a(" Role ",-1))]),_:1},8,["direction"]),n(p(A),{direction:t("since"),class:"justify-end",onClick:_[2]||(_[2]=r=>y("since","desc"))},{"sort-indicator":l(({direction:r})=>[s("span",{class:j(["block size-3.5",c(r)])},null,2)]),default:l(()=>[_[6]||(_[6]=a(" Member since ",-1))]),_:1},8,["direction"])]),_:1}),n(p(P),{items:k.value},{default:l(({item:r,value:S})=>[n(p(R),{value:S},{default:l(()=>[n(p(w),null,{default:l(()=>[n(p(H),{label:r.name,size:"xl"},null,8,["label"]),s("div",hs,[s("div",ws,i(r.name),1),s("div",ms,i(r.email),1)])]),_:2},1024),n(p(w),null,{default:l(()=>[s("span",us,i(r.role),1)]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("span",ys,i(r.since),1)]),_:2},1024)]),_:2},1032,["value"])]),_:1},8,["items"])]),_:1},8,["active"]))}}),zs={class:"w-full"},xs={class:"mb-2 flex h-7 items-center justify-end gap-3"},gs={key:0,class:"text-sm text-ink-gray-5"},js={class:"min-w-0"},vs={class:"mt-1 truncate text-base text-ink-gray-5"},ks={class:"flex flex-col items-end gap-1"},bs={class:"text-sm text-ink-gray-5"},Ls=q({__name:"Feed",setup(v){const u=[{name:"1",title:"Weekly sync notes",author:"Rosa Diaz",comment:"Sounds good, let us ship it on Monday",time:"2 h",comments:4,unread:!0},{name:"2",title:"Redesigning the onboarding flow",author:"Jake Peralta",comment:"I added the new mockups to the page",time:"5 h",comments:12,unread:!1},{name:"3",title:"Q3 hiring plan",author:"Amy Santiago",comment:"Two backend roles and one designer",time:"1 d",comments:7,unread:!0},{name:"4",title:"Incident review: search downtime",author:"Terry Jeffords",comment:"Root cause was the index rebuild",time:"2 d",comments:9,unread:!1},{name:"5",title:"Docs sprint retrospective",author:"Raymond Holt",comment:"Velocity was acceptable.",time:"4 d",comments:3,unread:!1}],d=g(!1),c=g([]);function o(){d.value=!d.value,c.value=[]}return(h,y)=>(f(),x("div",zs,[s("div",xs,[c.value.length?(f(),x("span",gs,i(c.value.length)+" selected ",1)):N("",!0),n(p(I),{onClick:o},{default:l(()=>[a(i(d.value?"Done":"Select"),1)]),_:1})]),n(p(C),{selectable:d.value,selection:c.value,"onUpdate:selection":y[0]||(y[0]=t=>c.value=t),"row-height":60},{default:l(()=>[(f(),x(M,null,E(u,t=>n(p(R),{key:t.name,value:t.name},{default:l(()=>[n(p(w),null,{default:l(()=>[n(p(H),{label:t.author,size:"2xl"},null,8,["label"])]),_:2},1024),n(p(w),null,{default:l(()=>[s("div",js,[s("div",{class:j(["truncate text-base text-ink-gray-8",t.unread&&"font-semibold"])},i(t.title),3),s("div",vs,i(t.author)+": "+i(t.comment),1)])]),_:2},1024),n(p(w),{class:"justify-end"},{default:l(()=>[s("div",ks,[s("span",bs,i(t.time),1),n(p(Q),null,{default:l(()=>[a(i(t.comments),1)]),_:2},1024)])]),_:2},1024)]),_:2},1032,["value"])),64))]),_:1},8,["selectable","selection"])]))}}),Fs=JSON.parse('{"title":"List","description":"","frontmatter":{},"headers":[],"relativePath":"docs/molecules/list.md","filePath":"docs/molecules/list.md","lastUpdated":1790365916000}'),Cs={name:"docs/molecules/list.md"},Ms=Object.assign(Cs,{setup(v){const u=[{name:"columns",description:"Grid track sizes shared by the header and every row. Defaults to the feed\ntemplate `['auto', 'minmax(0,1fr)', 'auto']` (leading media, content,\ntrailing). Table-style lists must pass deterministic track sizes — `auto`\ntracks size independently per row, so independent row grids can't agree.\n\nPass an array for one template at every width, or an object keyed by\nbreakpoint for a template that changes with the viewport:\n`{ base: ['minmax(0,1fr)', '80px'], md: ['minmax(0,2fr)', '140px', '100px'] }`.\n`base` is required, each breakpoint replaces the whole template, and an\nomitted breakpoint keeps the one below it. Breakpoints are the consuming\napp's own Tailwind `screens`, resolved in CSS — so `md` here and `md:hidden`\non a cell switch at the same width. A key that is not one of those screens\nis ignored: its template never applies, and a dev-mode warning names it.\nChanging the track count never hides a cell: pair it with matching\nvisibility classes on the header and the rows.",required:!1,type:"ListColumns"},{name:"divider",description:"Divider treatment between rows: `inset` starts at the content column\n(the text edge), `full` spans all columns. Defaults to `inset` with the\ndefault feed template, `full` when `columns` is set.",required:!1,type:"ListDivider"},{name:"selectable",description:"Reveals the animated checkbox column and switches row click from\nnavigate to toggle. Selected values surface via `v-model:selection`.",required:!1,type:"boolean"},{name:"rowHeight",description:`Fixed row height in px. Required for virtualization; without it rows size
...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"  </"),s("span",{class:"s_wac0bt"},"List"),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:l(()=>[n(fs)]),_:1}),e[13]||(e[13]=s("h3",{id:"documents-with-a-star-button",tabindex:"-1"},[a("Documents with a star button "),s("a",{class:"header-anchor",href:"#documents-with-a-star-button","aria-label":"Permalink to “Documents with a star button”"},"​")],-1)),e[14]||(e[14]=s("p",null,"Each row opens its document on click and has a star button. A row cannot be a link or button and also hold buttons, so the rows stay static and a stretched button covers each one.",-1)),n(b,{name:"List-RowActions"},{code:l(()=>[...e[2]||(e[2]=[s("div",{class:"language-vue"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"vue"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"<"),s("span",{class:"s_1uuh8p"},"script"),s("span",{class:"s_1i4ay4"}," setup"),s("span",{class:"s_1i4ay4"}," lang"),s("span",{class:"s_1jjt6x"},"="),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_2575z4"},"ts"),s("span",{class:"s_w1p9wo"},'"'),s("span",{class:"s_1zd9e2"},">")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ref"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  align"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"start"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"end"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),n(z,{data:h}),e[21]||(e[21]=s("h3",{id:"listcell",tabindex:"-1"},[a("ListCell "),s("a",{class:"header-anchor",href:"#listcell","aria-label":"Permalink to “ListCell”"},"​")],-1)),n(z,{data:y}),e[22]||(e[22]=s("h3",{id:"listheader",tabindex:"-1"},[a("ListHeader "),s("a",{class:"header-anchor",href:"#listheader","aria-label":"Permalink to “ListHeader”"},"​")],-1)),n(z,{data:t}),e[23]||(e[23]=s("h3",{id:"listheadercell",tabindex:"-1"},[a("ListHeaderCell "),s("a",{class:"header-anchor",href:"#listheadercell","aria-label":"Permalink to “ListHeaderCell”"},"​")],-1)),n(z,{data:k}),e[24]||(e[24]=s("h3",{id:"listheadercellsort",tabindex:"-1"},[a("ListHeaderCellSort "),s("a",{class:"header-anchor",href:"#listheadercellsort","aria-label":"Permalink to “ListHeaderCellSort”"},"​")],-1)),n(L,{name:"ListHeaderCellSort",data:m},{code:l(()=>[...e[7]||(e[7]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteLocationRaw"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue-router"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"export"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_euu481"}," ListDivider"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"inset"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"full"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"none"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"export"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_euu481"}," ListSortDirection"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"asc"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"desc"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  align"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"start"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"end"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),n(z,{data:_}),n(D,{data:r}),e[25]||(e[25]=s("h3",{id:"listrows",tabindex:"-1"},[a("ListRows "),s("a",{class:"header-anchor",href:"#listrows","aria-label":"Permalink to “ListRows”"},"​")],-1)),n(L,{name:"ListRows",data:S},{code:l(()=>[...e[8]||(e[8]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"RouteLocationRaw"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue-router"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"export"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_euu481"}," ListDivider"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"inset"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"full"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"none"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"export"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_euu481"}," ListSortDirection"),s("span",{class:"s_2ekfrt"}," ="),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"asc"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"desc"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"}),a(`
...
`),s("span",{class:"line"},[s("span",{class:"s_1th9sy"},"   */")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_bsv8nz"},"  align"),s("span",{class:"s_2ekfrt"},"?:"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"start"),s("span",{class:"s_w1p9wo"},"'"),s("span",{class:"s_2ekfrt"}," |"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"end"),s("span",{class:"s_w1p9wo"},"'")]),a(`
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),n(z,{data:W})])}}});export{Fs as __pageData,Ms as default};
