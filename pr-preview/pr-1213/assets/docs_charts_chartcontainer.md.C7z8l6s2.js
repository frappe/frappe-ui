...
`),s("span",{class:"line"},[s("span",{class:"s_1zd9e2"},"</"),s("span",{class:"s_1uuh8p"},"template"),s("span",{class:"s_1zd9e2"},">")])])])],-1)])]),default:e(()=>[l(d)]),_:1})]),_:1}),n[3]||(n[3]=t('<h2 id="title-and-actions" tabindex="-1">Title and actions <a class="header-anchor" href="#title-and-actions" aria-label="Permalink to “Title and actions”">​</a></h2><p><code>title</code> names the chart and <code>subtitle</code> captions it. The row is only drawn when one of them is set, or when something fills <code>#actions</code>.</p><p><code>#actions</code> sits at the end of that row, opposite the title. Use it for a period picker, a menu, or a link to the records behind the chart. It keeps its width and the title truncates, because a truncated title is still readable but a shrunk control is hard to press.</p><p>The header row is one title line tall. An action taller than that is centered on the title instead of making the row taller.</p><p><code>#title-suffix</code> goes right after the title text. Use it for an icon that belongs to the title, such as a lock on a chart whose rows are filtered per user. It keeps its width and the title truncates before it. It uses the title&#39;s font size, so an icon sized in <code>em</code> scales with the title, which is smaller on a <code>NumberCard</code>.</p><h2 id="value-axis-titles" tabindex="-1">Value-axis titles <a class="header-anchor" href="#value-axis-titles" aria-label="Permalink to “Value-axis titles”">​</a></h2><p><code>yAxisTitle</code> titles the primary value axis and <code>y2AxisTitle</code> the second one. They are drawn as a row above the plot, not as echarts axis names, because an axis name inside the plot has to be rotated to fit, which makes it hard to read.</p><p>Each title sits above the side its axis is on, so the row mirrors in RTL. <code>axisTitlePlacement</code> moves the row: <code>&#39;top&#39;</code> by default, or <code>&#39;bottom&#39;</code> for a chart whose value axis runs along the bottom. A horizontal <code>BarChart</code> uses <code>&#39;bottom&#39;</code> and puts the titles at the far end, because the near end is above the category labels, where a title would look like their heading.</p><p>The titles show only in the <code>ready</code> state, because there is no plot to title in the other states.</p><h2 id="states" tabindex="-1">States <a class="header-anchor" href="#states" aria-label="Permalink to “States”">​</a></h2><p><code>loading</code>, <code>error</code> and <code>empty</code> switch the container between four states (<code>ready</code> is the fourth). A non-empty <code>error</code> wins over <code>loading</code>, and <code>loading</code> wins over <code>empty</code>.</p><p>The plot stays mounted in all four states. Unmounting it would dispose the echarts instance and it would have to be built again, so it is hidden instead.</p><p>Each state has a slot that replaces its content: <code>#loading</code>, <code>#error</code> and <code>#empty</code>. <code>#error</code> gets the message as a slot prop, so you can show a retry button next to it. The loading placeholder fills the whole plot box, not a row in the middle, so while a dashboard loads, each card keeps its shape in the grid. See <a href="/pr-preview/pr-1213/docs/charts/states">States</a>.</p><h2 id="the-legend" tabindex="-1">The legend <a class="header-anchor" href="#the-legend" aria-label="Permalink to “The legend”">​</a></h2><p><code>#legend</code> is a row under the plot. Put <a href="/pr-preview/pr-1213/docs/charts/chartlegend"><code>ChartLegend</code></a> in it. When the slot is empty, the container adds padding in place of the row, so a chart with one series lines up with a chart that has several.</p><h2 id="direction" tabindex="-1">Direction <a class="header-anchor" href="#direction" aria-label="Permalink to “Direction”">​</a></h2><p><code>dir</code> sets the layout direction to <code>&#39;ltr&#39;</code> or <code>&#39;rtl&#39;</code>. It defaults to <code>document.documentElement.dir</code>.</p><h2 id="api-reference" tabindex="-1">API Reference <a class="header-anchor" href="#api-reference" aria-label="Permalink to “API Reference”">​</a></h2>',18)),l(o,{name:"ChartContainer",data:c},{code:e(()=>[...n[1]||(n[1]=[s("div",{class:"language-typescript"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"typescript"),s("pre",{class:"shiki shiki-themes tokyo-night github-light s_2cy0ei",tabindex:"0",dir:"ltr"},[s("code",null,[s("span",{class:"line"},[s("span",{class:"s_edvzsf"},"import"),s("span",{class:"s_50ecpt"}," type"),s("span",{class:"s_13ahmt"}," { "),s("span",{class:"s_4q1z3w"},"ComputedRef"),s("span",{class:"s_13ahmt"}," }"),s("span",{class:"s_edvzsf"}," from"),s("span",{class:"s_w1p9wo"}," '"),s("span",{class:"s_2575z4"},"vue"),s("span",{class:"s_w1p9wo"},"'")]),a(`
