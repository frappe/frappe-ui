import{_ as k}from"./chunks/PropsTable.DnyBHFKF.js";import{_ as b}from"./chunks/SlotsTable.DbGIicyw.js";import{_ as g}from"./chunks/EmitsTable.CDaAH4xV.js";import{_ as x}from"./chunks/ExposedTable.BqqhXppp.js";import"./chunks/theme.CD0atdaZ.js";import{_ as f}from"./chunks/HeatmapChart.vue_vue_type_script_setup_true_lang.CeF04j4K.js";import{J as w,ae as d,r as u,E as l,aG as h,ap as v,B as z,bf as c,o as s,D as a}from"./chunks/framework.C9_HTNcI.js";import"./chunks/useChart.ByC6ee9f.js";import"./chunks/tokens.HUgm48ur.js";import"./chunks/usePlotKeyboard.YtgC1Fmi.js";import"./chunks/axisChartCommon.DnMtfrMn.js";import"./chunks/format.CBtw5xUd.js";import"./chunks/ChartContainer.vue_vue_type_script_setup_true_lang.Cz77dxGS.js";import"./chunks/ChartTooltip.vue_vue_type_script_setup_true_lang.Cm1uHUzC.js";import"./chunks/installLabelLayout.CcMCRk-I.js";import"./chunks/axisAlignTicks.B6l8x592.js";import"./chunks/labelLayoutHelper.Bfd6vIDu.js";import"./chunks/dataStackHelper.ChA4DIkV.js";import"./chunks/labelGuideHelper.C3ozfrsJ.js";import"./chunks/createSeriesData.BEVKlt24.js";import"./chunks/VisualMapping.CsYMdc-E.js";const j={class:"h-72 w-full"},C=w({__name:"HeatmapDemand",setup(y){const _=["6am","8am","10am","12pm","2pm","4pm","6pm","8pm"],r=["Mon","Tue","Wed","Thu","Fri","Sat","Sun"],o=[[6,45,35,29,18,14,22,10],[6,47,36,30,18,15,23,10],[6,46,35,29,18,14,22,10],[7,48,37,31,19,15,23,11],[7,50,38,32,20,16,26,12],[2,12,48,55,28,21,22,9],[2,10,44,50,25,18,18,7]],i=[8,52,38,34,20,15,20,9],p=o.flatMap((n,t)=>n.map((e,m)=>({day:r[t],hour:_[m],deviation:Math.round((e-i[m])/i[m]*100)})));return(n,t)=>(d(),u("div",j,[l(h(f),{data:h(p),x:"hour",y:"day",value:"deviation",palette:"diverging",min:-60,max:60,format:e=>`${e>0?"+":""}${e}%`,title:"Demand vs typical week",subtitle:"Orders against the same hour's four-week average"},null,8,["data","format"])]))}}),S={class:"h-72 w-full"},T=w({__name:"HeatmapSignups",setup(y){const _=["Free","Pro","Team"],r=[[420,455,512,498,540,601],[86,92,104,118,131,147],[12,15,14,21,26,33]],o=_.flatMap((p,n)=>r[n].map((t,e)=>({plan:p,month:new Date(Date.UTC(2024,e,1)),signups:t}))),i=p=>p.toLocaleString("en-US",{month:"short",timeZone:"UTC"});return(p,n)=>(d(),u("div",S,[l(h(f),{data:h(o),x:"month",y:"plan",value:"signups","x-axis":{format:i},"show-data-labels":"",title:"Signups by plan",subtitle:"First half of 2024"},null,8,["data","x-axis"])]))}}),O={class:"h-72 w-full"},A=w({__name:"HeatmapTickets",setup(y){const _=["9am","11am","1pm","3pm","5pm","7pm"],r=["Mon","Tue","Wed","Thu","Fri"],o=[[34,48,29,41,26,11],[37,52,31,44,28,13],[35,55,33,46,27,12],[39,58,36,49,31,15],[30,43,25,38,22,9]],i=r.flatMap((p,n)=>_.map((t,e)=>({day:p,hour:t,tickets:o[n][e]})));return(p,n)=>(d(),u("div",O,[l(h(f),{data:h(i),x:"hour",y:"day",value:"tickets","show-data-labels":"",title:"Support load",subtitle:"Tickets opened by hour of the working week"},null,8,["data"])]))}}),Q=JSON.parse('{"title":"HeatmapChart","description":"","frontmatter":{},"headers":[],"relativePath":"docs/charts/heatmapchart.md","filePath":"docs/charts/heatmapchart.md","lastUpdated":0}'),R={name:"docs/charts/heatmapchart.md"},ss=Object.assign(R,{setup(y){const _=[{name:"title",description:"Heads the card. Left out, the chart draws no header row at all.",required:!1,type:"string"},{name:"subtitle",description:"A second line under the title, e.g. the period the numbers cover.",required:!1,type:"string"},{name:"dir",description:"Forces layout direction; defaults to document.documentElement.dir",required:!1,type:"ChartDir"},{name:"loading",description:"Draws the placeholder in place of the plot, for data still on its way.",required:!1,type:"boolean"},{name:"error",description:`Puts the chart in its error state and prints this message under it. Data
...
`),s("span",{class:"line"},[s("span",{class:"s_13ahmt"},"}")])])])],-1)])]),_:1}),l(b,{data:r}),l(g,{data:o}),l(x,{data:i})])}}});export{Q as __pageData,ss as default};
