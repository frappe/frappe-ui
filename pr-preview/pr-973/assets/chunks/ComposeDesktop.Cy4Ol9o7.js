import{b2 as x,ad as k,r as v,D as e,bg as n,aE as t,o as i,B as y,bh as T,bi as c,bk as h,b8 as I,aj as m}from"./framework.CtAYvYhc.js";import{aK as S,ay as $,au as u,bO as R,aJ as B}from"./theme.5SyUd_uB.js";import{r as D,w as F,u as O,P as V,H as A,f as H,g as L,S as o,c as N,p as z,t as C,d as U,O as q,a as K,A as P,b as j,F as E,l as M,o as W,m as J,B as Y,I as G,i as Q,n as X,U as Z,R as ee,v as te}from"./kits.4-uLMcc9.js";const se={class:"h-screen w-full bg-surface-base text-ink-gray-9"},ae={class:"flex shrink-0 items-center space-x-2"},oe={class:"w-full overflow-x-auto"},ne={class:"mx-auto w-full max-w-[770px] px-3 pt-4 sm:px-5"},ie=["onKeydown"],ce={__name:"ComposeDesktop",setup(le){const f=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],w=[D.configure({mention:{items:f}})],b=[V,A,H,L,o,N,z,C,o,U,q,o,K,P,j,E,o,M,W,J,Y,G,Q,o,X,o,Z,ee],l=m("Design review: new onboarding flow"),d=m(`
