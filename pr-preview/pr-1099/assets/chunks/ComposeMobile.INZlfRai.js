import{aj as m,a9 as T,a5 as I,b8 as S,b1 as B,ad as O,p as R,be as r,D as o,aE as t,B as $,o as l,bf as F,bg as f,bi as b,b6 as V}from"./framework.4CtSrvEl.js";import{bp as w,au as z,J as g,at as A}from"./theme.EAqzxhOf.js";import{u as C,z as H,x as L,P as N,H as U,g as M,h as q,S as a,c as D,q as j,w as E,d as K,O as P,a as W,A as J,b as Y,F as G,m as Q,p as X,n as Z,B as ee,I as te,j as se,o as oe,U as ae,R as ne,y as re}from"./kits.CfFOtW7Z.js";import"./index.Vcq4gwWv.js";import"./marked.esm.BaswSlok.js";const ie={class:"sticky top-0 z-10 border-b bg-surface-base"},le={class:"overflow-x-auto px-2 py-1"},pe={class:"px-4 pb-40 pt-4"},de=["onKeydown"],we={__name:"ComposeMobile",setup(ce){const v=[{id:"evan",label:"Evan You"},{id:"priya",label:"Priya Nair"},{id:"sam",label:"Sam Rivera"},{id:"ana",label:"Ana Costa"}],k=[C.configure({mention:{items:v}})],_=[N,U,M,q,a,D,j,E,a,K,P,a,W,J,Y,G,a,Q,X,Z,ee,te,se,a,oe,a,ae,ne],p={light:"/recipes/compose-dashboard-light.png",dark:"/recipes/compose-dashboard-dark.png"},d=m(w()),c=m("Design review: new onboarding flow"),i=m(`
...
`);let h;T(()=>{h=new MutationObserver(()=>{d.value=w()}),h.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme"]})}),I(()=>h?.disconnect()),S(d,(n,e)=>{i.value=i.value.replace(p[e],p[n])});const y=async n=>({file_url:URL.createObjectURL(n),file_name:n.name}),{textarea:x}=B({input:c});return(n,e)=>(O(),R(t(A),null,{default:r(()=>[o(t(H),{modelValue:i.value,"onUpdate:modelValue":e[1]||(e[1]=s=>i.value=s),extensions:k,"upload-function":y,placeholder:"Type '/' for commands or select text to format"},{default:r(({editor:s})=>[o(t(z),{title:"New discussion"},{prefix:r(()=>[o(t(g),{variant:"ghost",icon:"lucide-chevron-left",label:"Back"})]),suffix:r(()=>[o(t(g),{variant:"solid"},{default:r(()=>[...e[2]||(e[2]=[$("Publish",-1)])]),_:1})]),_:1}),l("div",ie,[l("div",le,[o(t(L),{editor:s,items:_},null,8,["editor"])])]),l("div",pe,[F(l("textarea",{ref_key:"titleTextarea",ref:x,class:"w-full resize-none border-0 bg-transparent px-0 py-0.5 text-3xl-semibold text-ink-gray-8 placeholder-ink-gray-3 focus:ring-0","onUpdate:modelValue":e[0]||(e[0]=u=>c.value=u),placeholder:"Title",rows:"1",wrap:"soft",maxlength:"140",onKeydown:[f(b(u=>s.commands.focus(),["prevent"]),["enter"]),f(b(u=>s.commands.focus(),["prevent"]),["down"])]},null,40,de),[[V,c.value]]),o(t(re),{editor:s,class:"prose-v3 mt-1 max-w-[unset] overflow-auto"},null,8,["editor"])])]),_:1},8,["modelValue"])]),_:1}))}};export{we as default};
