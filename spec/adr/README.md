...
| [0013 — Chart props are flat and name the columns](./0013-flat-props-name-columns.md) | Accepted | One tag, plain-data props, no `config` object — a saved chart is spread with `v-bind`. Rejects composition and grammar-of-graphics. |
| [0014 — What enters the chart family](./0014-what-enters-charts.md) | Accepted | How the 2026-08-05 Insights audit was decided, case by case. Conventions and the rule live in [`charts.md`](../charts.md). |
