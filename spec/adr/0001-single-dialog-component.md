...
When designing the v1 Dialog API and the imperative `dialog.confirm/danger/prompt` helpers, we had to choose whether to expose this split:
...
- Imperative helpers (`dialog.confirm/danger/prompt`) always render `role="dialog"`. This is a deliberate accessibility trade-off.
