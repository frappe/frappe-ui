  ...
  >
    <template #trigger>
      <!-- A row is a pill lying down: the same tinted block the grid views
           ...
           happen to agree. The block carries its own edges, which is what lets
           the hairlines go — between rows, and down the gutter's side — and
           lets the rows stand 4px apart instead of flush.
           ...
           a cramped card. -->
      <div
        class="calendar-row flex w-full gap-1.5 pl-1.5 pr-3 text-left"
        :class="{
          narrow: props.narrow,
      ...
      >
        <!-- The bar, as the pill draws it: 2px, rounded, stretched to the
             ...
             beside it. -->
        <span
          class="calendar-row-bar my-px w-[2px] shrink-0 self-stretch rounded-4"
        ...
        <div
          ...
          :class="
            props.narrow ? 'items-center gap-3' : 'items-baseline gap-2.5'
          "
        >
          ...
          >
            ...
            >
              ...
              <span
                ...
                class="calendar-row-description calendar-row-muted min-w-0 truncate text-xs leading-4"
              >
            ...
            <span
              v-if="props.narrow"
              class="calendar-row-muted flex min-w-0 items-baseline gap-1.5 text-sm leading-4"
            >
          ...
          <span
            ...
            class="calendar-row-participant calendar-row-muted flex shrink-0 items-center gap-1.5 self-center whitespace-nowrap text-xs leading-4"
          >
