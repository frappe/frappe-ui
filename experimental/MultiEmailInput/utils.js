...
export { inputFontSizeClasses, itemClasses, itemRootSizeClasses, toItemListSize, } from '../../src/components/shared/selection/utils';
/**
 ...
 */
export function splitEmailTokens(input) {
    const parts = [];
    let current = '';
    let inQuotes = false;
