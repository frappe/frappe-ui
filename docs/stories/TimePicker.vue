...
import type { Placement, Variant } from "frappe-ui/components/TimePicker/types";
...
<template>
  <div class="grid gap-4 grid-cols-2">
    ...
    <Story title="24 Hour Format">
      ...
      <div class="mt-2 text-xs text-gray-500">Value: {{ value24 }}</div>
    </Story>
    ...
    <Story title="Custom Options">
      <TimePicker
        ...
        :allowCustom="false"
      />
      <div class="mt-2 text-xs text-gray-500">Value: {{ valueCustomOpts }}</div>
    </Story>
    ...
    <Story title="Min / Max Range">
      ...
      />
      <div class="mt-2 text-xs text-gray-500">Value: {{ valueRange }}</div>
    </Story>
  </div>
</template>
