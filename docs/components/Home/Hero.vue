...
<template>
  <div
    class="grid xl:grid-cols-2 gap-5 min-h-[calc(100vh-200px)] max-w-7xl mx-auto xl:py-20"
  >
    <section class="flex">
      <div class="my-auto p-7 flex flex-col gap-5">
        ...
        <h1 class="text-[2rem] xl:text-[2.7rem]  font-bold tracing-tight leading-tight">
