...
<template>
  <div class="break-inside-avoid mb-5 rounded border p-5 h-fit prose prose-sm">
    <Progress
    ...
    <div class="mt-3 flex justify-between gap-3 border-t rounded pt-3">
      <Button size="sm" @click="decProgress">Back</Button>
      <Button size="sm" @click="incProgress" variant="solid">Next</Button>
    </div>
  </div>

  <div
    class="break-inside-avoid mb-5 rounded border p-4 pt-3 flex flex-col gap-3"
  >
    <div class="flex items-center gap-2 justify-between">
      ...
      <Badge size="sm" class="rounded-sm">
  ...
  <div class="break-inside-avoid mb-5 rounded border grid p-5 gap-y-3 gap-x-4">
  ...
  <div
    class="break-inside-avoid mb-5 rounded border p-5 transition-all duration-200"
  ...
  <div
    class="break-inside-avoid mb-5 rounded border p-4 grid"
  ...
  >
    ...
    <div class="flex items-center gap-2 pt-2">
      ...
      <Button size="sm" theme="blue" class="ml-auto">
        <template #prefix>
