...
const componentGroups = {
  ...
  'Navigation': {
    ...
    list: ['Breadcrumbs', 'Tabs', 'TabButtons', 'Sidebar'],
  },
  'Forms': {
    component: Forms,
    list: [
  ...
  'Overlays': {
    component: Overlays,
    list: ['Dialog', 'Dropdown', 'Popover', 'Tooltip'],
  },
  'Feedback': {
    component: Feedback,
    list: ['Alert', 'ErrorMessage', 'Progress', 'CircularProgressBar'],
  },
...
<template>
  <div class="grid grid-cols-2 gap-6 not-prose">
    <div
