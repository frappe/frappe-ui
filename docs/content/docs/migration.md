...
(`shortcuts-v1`, see [The shortcuts codemod](#the-shortcuts-codemod)), and the
EditorFixedMenu prop rename (`editor-v1`, see [Editor](#editor)).
...
Other family sections name their mechanical tools and remaining hand edits.
