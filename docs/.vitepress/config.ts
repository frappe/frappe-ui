...
// shiki.css is generated by transformerStyleToClass at buildEnd, but
// theme/index.ts imports it eagerly — Vite needs the file to exist
// before module resolution. On fresh checkouts (CI) the file is absent
// because it's gitignored, so write an empty stub if it's missing.
