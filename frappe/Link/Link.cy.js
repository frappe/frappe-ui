...
describe('Link', () => {
    ...
    describe('rendering', () => {
        ...
        it('forwards id/label/description/required to the underlying Combobox (P5)', () => {
            ...
            cy.get('[role="combobox"]#user-picker').should('have.attr', 'aria-required', 'true');
        ...
        it('forwards `error` and wires aria-invalid', () => {
            ...
            cy.get('[role="combobox"]#user-picker').should('have.attr', 'aria-invalid', 'true');
    ...
    describe('#suffix slot', () => {
        it('replaces the default clear button', () => {
            cy.mount(Link, {
                ...
                slots: {
                    suffix: () => h('button', { 'data-slot': 'redirect', type: 'button' }, 'Go'),
                },
            });
            cy.get('[data-slot="clear"]').should('not.exist');
