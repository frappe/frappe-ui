...
export const getValueControl = (row) => {
...
export const reverseOperatorMap = Object.fromEntries(Object.entries(operatorMap).map(([key, value]) => [value, key]));
