<template>
  <div class="mx-auto flex h-full w-[85%] flex-col space-y-8 pt-12 text-base lg:w-[700px]">
    <div class="flex flex-col space-y-1 text-ink-gray-7">
      ...
      <div class="leading-5">Import data into your system using CSV files or Google Sheets.</div>
    </div>
    ...
    <div class="space-y-4">
      ...
      >
        <div v-if="showFileSelector && !uploading" class="w-4/5 text-center lg:w-2/5">
          <FeatherIcon
            name="upload-cloud"
            class="stroke-1.5 mx-auto mb-2.5 size-6 text-ink-gray-6"
          />
          <input
            ref="fileInput"
            type="file"
      ...
      >
        <div
          class="flex w-4/5 items-center justify-between rounded-md border bg-surface-white p-2 lg:w-2/5"
        >
          <div class="space-y-2">
          ...
          <FeatherIcon
            name="trash-2"
            class="stroke-1.5 size-4 cursor-pointer text-ink-red-3"
            @click="deleteFile"
          />
        </div>
      </div>
      ...
      >
        ...
        <div
          class="mx-auto flex w-[95%] flex-1 flex-col items-center justify-center space-y-3 lg:w-[400px]"
        >
          <input
            v-model="googleSheet"
            type="text"
        ...
        >
          <template v-slot="{ open }">
            <Button variant="ghost">
              <template #prefix>
                <FeatherIcon name="download" class="stroke-1.5 size-4" />
              </template>
              ...
              <template #suffix>
                <FeatherIcon
                  name="chevron-down"
                  :class="[
                    'stroke-1.5 ml-1 h-4 w-4 transform transition-transform',
                    open ? 'rotate-180' : '',
                  ]"
                />
              </template>
