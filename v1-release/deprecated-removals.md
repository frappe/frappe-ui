...
| --------------------------------- | -------------------------------------------------------------------- | -------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| ~~`Card`~~                        | removed in the display/feedback sweep (#881)                         | layout markup, or a domain-specific component in the app       | —                                                                                                                  |
| ~~`ConfirmDialog`~~               | removed in [#960](https://github.com/frappe/frappe-ui/pull/960)      | `dialog.confirm(...)`                                          | —                                                                                                                  |
| ~~`confirmDialog`~~               | removed in [#960](https://github.com/frappe/frappe-ui/pull/960)      | `dialog.confirm(...)`                                          | —                                                                                                                  |
| ~~`FeatherIcon`~~                 | removed in the display/feedback sweep (#881)                         | a `lucide-*` string, or the `Icon` component                   | —                                                                                                                  |
| `Input`                           | `src/components/Input.vue`                                           | `TextInput` or `FormControl`                                   | yes                                                                                                               |
| ~~`ListItem`~~                    | removed in the display/feedback sweep (#881)                         | list primitives from `frappe-ui/list`, or app-owned row markup | —                                                                                                                  |
| `MonthPicker` (whole barrel)      | `src/components/MonthPicker/`                                        | `Select`                                                       | no                                                                                                                |
| ~~`Toast` (the SFC)~~             | removed in the display/feedback sweep (#881)                         | the imperative `toast(...)` API                                | —                                                                                                                  |
