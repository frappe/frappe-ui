export { inputFontSizeClasses, itemClasses, itemRootSizeClasses, toItemListSize, triggerSizeClasses, } from '../shared/selection/utils';
 ...
 */
export function triggerContentPaddingClasses(size) {
    return {
        sm: 'px-2',
        md: 'px-2.5',
        lg: 'px-3',
 ...
 */
export const triggerBaseClasses = 'relative inline-flex items-center gap-2 text-left transition-[background-color,border-color,box-shadow] duration-150 ease-[cubic-bezier(0.23,1,0.32,1)] data-[state=open]:outline-none text-ink-gray-7 data-[placeholder]:text-ink-gray-4 data-[disabled]:text-ink-gray-4';
