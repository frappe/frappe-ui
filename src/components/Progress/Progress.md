...
## Hint
<ComponentPreview name="Progress-Hint" />

## Intervals
<ComponentPreview name="Progress-Intervals"  />

## Sizes
<ComponentPreview name="Progress-Sizes" css='grid grid-cols-2 *:bordr *:rounded  *:p-3' />
