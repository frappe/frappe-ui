...
const dropdownOptions = [
  ...
  { label: 'Option 3', onClick: () => (selectedOption.value = 'Option 3') },
  {
    ...
    items: [
      { label: 'Advanced Option A', icon: LucideSettings, onClick: () => (selectedOption.value = 'Advanced Option A') },
      { label: 'Advanced Option B', icon: LucideStar, onClick: () => (selectedOption.value = 'Advanced Option B') },
    ],
  },
]

const createPromise = (): Promise<void> => new Promise((resolve) => setTimeout(resolve, 2000))
</script>
    ...
    <div>
      ...
      <Dialog
        :options="{
          ...
          actions: [{ label: 'Confirm', variant: 'solid', onClick: () => createPromise() }],
        }"
        v-model="dialog1"
      />
    </div>
        ...
        <template #body-content>
          <div class="space-y-4">
            ...
            <div class="bg-blue-50 p-4 rounded-lg">
              <p class="text-blue-800">You can put any content here including forms, lists, or other components.</p>
            </div>
          </div>
        </template>
      ...
      <Dialog v-model="dialog6">
        ...
        <template #body-content>
          <div class="space-y-6 text-base">
            <p class="text-gray-700">This dialog contains interactive elements to test proper layering.</p>
            <Autocomplete
              :options="[
            ...
            <div class="bg-gray-50 text-p-sm p-4 text-ink-gray-6 rounded-lg">
              ...
              <p class="mt-1">Interactive components should work properly within dialogs.</p>
            </div>
          </div>
        </template>
        <template #actions="{ close }">
