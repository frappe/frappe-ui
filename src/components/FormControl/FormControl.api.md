...
<script setup>
  ...
  },
  {
    ...
    required: false,
    type: 'TextInputTypes | "textarea" | "select" | "checkbox" | "combobox" | "multiselect" | "daterange" | "datetime"',
    default: '"text"'
  },
  {
    name: 'size',
  ...
  {
    name: 'item-prefix',
    description: 'Per-item prefix content, forwarded to the combobox/multiselect rows',
    type: '{ item: any; }'
  },
  {
    name: 'default',
