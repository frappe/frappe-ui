...
describe('FormControl', () => {
    ...
    it('errors when the removed type="autocomplete" is used', () => {
        ...
        cy.get('@consoleError').should('have.been.calledWithMatch', /type="autocomplete" was removed in 1\.0\.0.*type="combobox"/);
    });
    it('does not error for supported types', () => {
        ...
        cy.get('@consoleError').should('not.have.been.calledWithMatch', /FormControl/);
    });
    describe('dispatcher delegation', () => {
        ...
        it('forwards error to Select and suppresses description', () => {
            ...
            cy.get('[data-slot="trigger"]').should('have.attr', 'aria-invalid', 'true');
        ...
        it('renders bare select with w-full so it fills its container (ListFilter pattern)', () => {
            ...
            cy.mount({
                render: () => h('div', { style: 'width: 240px; padding: 16px;' }, [
