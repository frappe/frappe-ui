...
const buttonClasses = computed(() => {
  let solidClasses = {
    ...
    blue: 'text-ink-white bg-blue-500 hover:bg-surface-blue-5 active:bg-blue-700',
    green:
      'text-ink-white bg-surface-green-5 hover:bg-green-700 active:bg-green-800',
    red: 'text-ink-white bg-surface-red-5 hover:bg-surface-red-6 active:bg-surface-red-7',
  }[props.theme]

  let subtleClasses = {
    gray: 'text-ink-gray-7 bg-surface-gray-2 hover:bg-surface-gray-3 active:bg-surface-gray-4',
    blue: 'text-ink-blue-4 bg-surface-blue-2 hover:bg-blue-200 active:bg-blue-300',
    green:
  ...
  let outlineClasses = {
    gray: 'text-ink-gray-7 bg-surface-white bg-surface-white border border-outline-gray-2 hover:border-outline-gray-3 active:border-outline-gray-3 active:bg-surface-gray-4',
    blue: 'text-ink-blue-4 bg-surface-white border border-outline-blue-2 hover:border-blue-400 active:border-blue-400 active:bg-blue-300',
    green:
      'text-green-800 bg-surface-white border border-outline-green-3 hover:border-green-500 active:border-green-500 active:bg-green-300',
    red: 'text-red-700 bg-surface-white border border-outline-red-2 hover:border-outline-red-3 active:border-outline-red-3 active:bg-surface-red-3',
  }[props.theme]

  let ghostClasses = {
    gray: 'text-ink-gray-7 bg-transparent hover:bg-surface-gray-3 active:bg-surface-gray-4',
    blue: 'text-ink-blue-4 bg-transparent hover:bg-blue-200 active:bg-blue-300',
    green:
  ...
  let focusClasses = {
    ...
    green: 'focus-visible:ring focus-visible:ring-outline-green-3',
    red: 'focus-visible:ring focus-visible:ring-outline-red-3',
  }[props.theme]
  ...
  let disabledClassesMap: Record<ThemeVariant, string> = {
    ...
    'blue-outline':
      'bg-surface-blue-2 text-ink-blue-link border border-outline-blue-2',
    'blue-ghost': 'text-ink-blue-link',

    'green-solid': 'bg-surface-green-2 text-ink-green-3',
    'green-subtle': 'bg-surface-green-2 text-ink-green-3',
    'green-outline':
      'bg-surface-green-2 text-ink-green-3 border border-outline-green-3',
    'green-ghost': 'text-ink-green-3',

    'red-solid': 'bg-surface-red-2 text-ink-red-2',
    'red-subtle': 'bg-surface-red-2 text-ink-red-2',
    'red-outline':
      'bg-surface-red-2 text-ink-red-2 border border-outline-red-2',
