...
const trigger = () => h('div', { 'data-cy': 'trigger', style: 'padding: 20px; display: inline-block' }, 'Right-click me');
const simpleOptions = [
...
describe('ContextMenu', () => {
    ...
    it('accepts an explicit #trigger slot as the right-clickable area', () => {
        cy.mount(ContextMenu, {
            ...
            slots: {
                trigger: () => h('div', { 'data-cy': 'named-trigger', style: 'padding: 20px' }, 'Named trigger'),
            },
        });
    ...
    it('opens without an enter/exit animation (instant motion)', () => {
        ...
        cy.get('[data-cy=trigger]').rightclick();
        cy.get('[data-slot="content"]').should('have.attr', 'data-motion', 'instant');
    });
            ...
            setup() {
                return () => h('div', [
                    ...
                    h(ContextMenu, {
                        ...
                        default: () => h('div', { 'data-cy': 'trigger', style: 'padding: 20px' }, 'Right-click me'),
                    }),
                ]);
            },
        }));
    ...
    it('supports arrow keys, Enter, and Escape', () => {
        ...
        cy.contains('[role=menuitem]', 'Rename').should('have.attr', 'data-highlighted');
