...
const emit = defineEmits(['update:modelValue', 'update:selectedOption', 'focus', 'blur', 'input'])
...
<template>
	<div class="relative">
		<ComboboxRoot
			...
			:open="isOpen"
		>
			<ComboboxAnchor :class="getThemeClasses(variant, disabled)" @click="handleClick">
