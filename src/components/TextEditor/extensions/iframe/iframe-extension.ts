...
declare module '@tiptap/core' {
  interface Commands<ReturnType> {
    iframe: {
      ...
      // `platform` is consumed by the molecules editor's implementation; this
      // legacy one ignores it. The signature must match — both editors augment
      // the same `Commands.iframe` group, and divergence is a TS2717 error.
