  ...
  <MultiSelect v-model="tags" :options="tagOptions">
    <template #trigger="{ open, selectedOptions, toggleOpen }">
      <button
        ...
        class="flex w-96 min-h-8 cursor-pointer items-center gap-1.5 rounded border border-[--surface-gray-2] px-1.5 py-1 text-left outline-none transition-colors hover:border-outline-elevation-2 focus-visible:focus-ring data-[state=open]:focus-ring"
        @click="toggleOpen"
      >
