 ...
 */
import { PALETTE_COLORS, } from '#molecules/editor/extensions/shared/color-palette';
const TEXT_CLASS = {
...
function toSwatch(color, classMap) {
    return {
        value: color.name,
...
const DEFAULT_TEXT_SWATCH = {
    value: null,
    label: 'Default',
    class: 'text-ink-gray-9',
};
const DEFAULT_HIGHLIGHT_SWATCH = {
    value: null,
    label: 'Default',
...
export const highlightSwatches = [
