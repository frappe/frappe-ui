 ...
 */
import { Node as NodeExtension, mergeAttributes, } from '@tiptap/core';
...
export const AttachmentExtension = NodeExtension.create({
        ...
        return {
            ...
            fileName: {
                ...
                parseHTML: (element) => element.getAttribute('data-file-name') ||
                    ...
                    null,
                renderHTML: (attributes) => attributes.fileName
            ...
            fileSize: {
                ...
                renderHTML: (attributes) => attributes.fileSize != null
            ...
            mimeType: {
                ...
                parseHTML: (element) => element.getAttribute('data-mime-type') ||
                    ...
                    null,
                renderHTML: (attributes) => attributes.mimeType
    ...
    addCommands() {
        const resolve = (editor) => resolveUploadOptions({ ...this.options, editor });
        return {
            ...
            reuploadAttachment: (uploadId) => ({ editor }) => {
