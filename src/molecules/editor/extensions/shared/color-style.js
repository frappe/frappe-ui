...
function extractPropertyValue(style, property) {
 ...
 */
function resolveColorValue(rawValue, variant, allowed) {
 ...
 */
export function extractColorFromStyle(style, variant, allowed) {
...
export function extractTextColorFromStyle(style, allowed) {
    return extractColorFromStyle(style, 'text', allowed);
}
/** Extract a named HIGHLIGHT color from an inline `style` string. */
export function extractHighlightColorFromStyle(style, allowed) {
