...
export const PALETTE_NAMES = PALETTE_COLORS.map((c) => c.name);
/**
...
export const highlightColorHexMap = {
    red: '#fecaca',
    orange: '#fed7aa',
    yellow: '#fef08a',
    green: '#bbf7d0',
 ...
 */
export const EXCLUDE_FROM_PASTE = ['gray'];
/**
 ...
 */
export const legacyTextColorMap = {
    '#1F272E': 'gray',
    '#ca8a04': 'yellow',
    '#ea580c': 'orange',
    '#dc2626': 'red',
...
export const legacyHighlightColorMap = {
    '#fef9c3': 'yellow',
    '#ffedd5': 'orange',
    '#fee2e2': 'red',
    '#dcfce7': 'green',
